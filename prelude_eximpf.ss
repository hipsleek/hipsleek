...
int divs___(int a, int b) 
  case {
    a = 0 -> case {
      b >= 1 -> ensures res = 0 & res <E a # b;
      b <= -1 -> ensures res = 0 & res <E a # b;
      -1 < b < 1 -> ensures true & flow __DivByZeroErr;
    }
    a > 0 -> case {
      b = 1 -> ensures res = a & res <E a # b;
      b = -1 -> ensures res = -a & res <E a # b;
      b > 1 -> case {
        a < b -> ensures res = 0 & res <E a # b;
        a >= b -> ensures res >= 1 & res < a & res <E a # b;
      }
      b < -1 -> case {
        -a > b -> ensures res = 0 & res <E a # b;
        -a <= b -> ensures res <= 1 & a + res > 0 & res <E a # b;
      }
      /* -1 < b < 1 -> requires false ensures false; */
      -1 < b < 1 -> ensures true & flow __DivByZeroErr;
    }
    a < 0 -> case {
      b = 1 -> ensures res = a & res <E a # b;
      b = -1 -> ensures res = -a & res <E a # b;
      b > 1 -> ensures res <= 0 & res > a & res <E a # b;
      b < -1 -> ensures res >= 0 & a + res < 0 & res <E a # b;
      /* -1 < b < 1 -> requires false ensures false; */
      -1 < b < 1 -> ensures true & flow __DivByZeroErr;
    }
  }
...
int div2(int a, int b)
 requires true 
 case {
  b != 0 -> ensures true & res <E a # b;
  b = 0 -> ensures true & flow __DivByZeroErr; 
 }

int div3(int a, int b) 
 case {
  b = 0 -> requires false ensures false & res <E a # b;
  b != 0 -> ensures true & res <E a # b;
 }

int div4(int a, int b) 
  requires b != 0
  ensures true & res <E a # b;
