...
For red, why are there two identical prune invariants?
 ...
 Did this cause specialization to fail for red? NO. 
...
void simple2(node r)
  requires r::rbd<n,cl,d,bh> 
  ensures r::rbd<n,cl,d,bh>;
// this seems to pick the invariant but not red<..> with
// a single clause.

void simple3(node r)
  requires r::red<n,bh> 
  ensures r::red<n+1,bh>;
// pure from initial inv not progated to pre/post 

void simple4(node r)
  requires r::red<n,bh> 
  ensures r::red<n+1,bh> & n>=0;
...
//r equires h::node<v3,c1,l,t4> * l::node<v2,c3,ll,t3> * ll::node<v1,c2,t1,t2>
// ensures res::node<v2,c1,l2,ll2> * l2::node<v1,c2,t1,t2> * ll2::node<v3,c3,t3,t4> ;
  requires h::node<v3,1,l,t4> * l::node<v2,0,ll,t3> * ll::node<v1,0,t1,t2>
  ensures res::node<v2,1,l2,ll2> * l2::node<v1,0,t1,t2> * ll2::node<v3,0,t3,t4> ;
...
node insert_aux(node h, int v)
  ...
  h=null -> ensures res::node<v,0,null,null>;
   h!=null -> requires h::rbd<n,c,d,bh>
    case {
     c=1 -> case {
       d=0 ->  ensures res::rbd<n+1,0,1,bh>  ; // R
