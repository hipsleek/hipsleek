...
type sleek_token =
  ...
  | LT | LTE | MINUS | NEQ | NOT | NOTINLIST | OBRACE |OLIST | OPAREN | OP_ADD_ASSIGN | OP_DEC | OP_DIV_ASSIGN | POW | SQRT | ABS
...
module Token = struct
  ...
  (*operators*)
    ...
    | POW -> "__pow" | SQRT -> "__sqrt" | ABS -> "__abs"
