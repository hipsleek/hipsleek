...
type sleek_token =
  ...
  | INFER_AT_PRE | INFER_AT_POST | INFER_AT_IMM | INFER_AT_SHAPE | INFER_AT_SHAPE_PRE | INFER_AT_SHAPE_POST | INFER_AT_SHAPE_PRE_POST | INFER_AT_BOUND | INFER_AT_ARRBA | INFER_AT_EN | INFER_AT_ENFR
...
module Token = struct
  ...
  let to_string k = match k with 
    ...
    | INFER_AT_DFA -> "@dfa"
    | INFER_AT_TERM -> "@term"
    | INFER_AT_BOUND -> "@bound"
    | INFER_AT_ARRBA -> "@arr_ba"
    | INFER_AT_EN -> "@arr_en"
    | INFER_AT_ENFR -> "@arr_enfr"
