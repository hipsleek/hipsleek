...
type sleek_token =
  ...
  (*operators*)  
  | ACCS | AND |ANDAND | ANDSTAR | UNIONSTAR | STARMINUS | AT | ATAT | LEND | IMM | MUT | DERV | CBRACE | CLIST | COLON | COLONCOLON | COLONCOLONCOLON | COMMA | CPAREN | CSQUARE | DOLLAR  | VAL | REC
