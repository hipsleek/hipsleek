...
and attributevalue = | AttributeValSpecConst of pd * specconstant | AttributeValSymbol of pd * symbol | AttributeValSexpr of pd * attributevalsexpr_attributevalue_sexpr5 | AttributeValSexpr1 of pd * attributevalsexpr1_attributevalue_sexpr7
and command = | CommandSetLogic of pd * symbol | CommandSetOption of pd * an_option | CommandSetInfo of pd * attribute | CommandDeclareSort of pd * symbol * string | CommandDefineSort of pd * symbol * commanddefinesort_command_symbol13 * sort | CommandDeclareFun of pd * symbol * commanddeclarefun_command_sort15 * sort | CommandDefineFun of pd * symbol * commanddefinefun_command_sortedvar17 * sort * term | CommandPush of pd * string | CommandPop of pd * string | CommandAssert of pd * term | CommandCheckSat of pd | CommandGetAssert of pd | CommandGetProof of pd | CommandGetUnsatCore of pd | CommandGetValue of pd * commandgetvalue_command_term26 | CommandGetAssign of pd | CommandGetOption of pd * string | CommandGetInfo of pd * infoflag | CommandExit of pd
and commands = | Commands of pd * commands_commands_command32
and identifier = | IdSymbol of pd * symbol | IdUnderscoreSymNum of pd * symbol * idunderscoresymnum_identifier_numeral35
...
and commands_commands_command32 = pd * ( command) list
and commandgetvalue_command_term26 = pd * ( term) list
and commanddefinefun_command_sortedvar17 = pd * ( sortedvar) list
and commanddeclarefun_command_sort15 = pd * ( sort) list
and commanddefinesort_command_symbol13 = pd * ( symbol) list
and attributevalsexpr1_attributevalue_sexpr7 = pd * ( sexpr) list
...
and pd_sortidsortmulti_sort_sort46 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_sexprinparen_sexpr_sexpr43 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_idunderscoresymnum_identifier_numeral35 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_commands_commands_command32 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_commandgetvalue_command_term26 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_commanddefinefun_command_sortedvar17 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_commanddeclarefun_command_sort15 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_commanddefinesort_command_symbol13 = function 
  | (d,[]) -> d

  | (d,( _ )::f1239o2) -> d

and pd_attributevalsexpr1_attributevalue_sexpr7 = function 
  | (d,[]) -> d
