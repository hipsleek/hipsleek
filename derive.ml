 ...
 *)
  (**********************************)
  (*spec process*)
  let spec_fs,_ = (* Gen.BList.split3 *) List.split spec_view.Cast.view_un_struc_formula in
 ...
 *)
  ...
  (*find data fields anns*)
  let ls_dname_pos = Iast.look_up_field_ann prog orig_view.Cast.view_data_name extn_props in
  let orig_fs,labels = List.split (* Gen.BList.split3 *) orig_view.Cast.view_un_struc_formula in
