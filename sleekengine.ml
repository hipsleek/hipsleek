...
(*  let _ = flush stdout in*)
  ...
  let (n_tl,conseq) = if (!Globals.allow_field_ann) then meta_to_struc_formula iconseq0 false fv_idents n_tl
      else meta_to_struc_formula iconseq0 false fv_idents  n_tl in
