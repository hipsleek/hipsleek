...
(assert 
(exists ((v_1081 int)(q_1082 node)) (tobool (ssep (pto xprm (sref (ref val v_1081) (ref next q_1082) )) (ll q_1082))))

)

(assert (not 
(exists ((v_1084 int)(q_1085 node)) (tobool (ssep (pto xprm (sref (ref val val_22_998prm) (ref next next_22_999prm) )) (ll q_1085))))
