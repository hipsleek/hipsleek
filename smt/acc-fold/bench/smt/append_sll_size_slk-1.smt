...
(assert (not 
(exists ((flted_7_1019 int)(Anon_1020 int)(q_1021 node)) (tobool (ssep (ssep (pto xprm (sref (ref val val_15_979') (ref next next_15_980') )) (ll q_1021 flted_7_1019)) (ll y n2)))
