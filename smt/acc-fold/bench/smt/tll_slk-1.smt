...
(define-fun tll ((?in node) (?p node) (?ll node) (?lr node)) Space
 (tospace (or
...
(assert (not (and 
(tobool (ssep 
(pto xprm (sref (ref parent parent_36_1074prm) (ref left left_36_1075prm) (ref right right_36_1076prm) (ref next next_36_1077prm) ))
emp
) )
)
))
