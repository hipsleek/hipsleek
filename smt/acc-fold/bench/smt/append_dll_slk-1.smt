...
(assert (not 
(exists ((self_1030 node2)(Anon_1031 int)(p_1029 node2)(q_1032 node2)) (tobool (ssep (ssep (pto xprm (sref (ref val val_20_979') (ref prev prev_20_980') (ref next next_20_981') )) (dll q_1032 self_1030)) (dll y p)))
