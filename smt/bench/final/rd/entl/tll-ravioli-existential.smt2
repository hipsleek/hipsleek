...
(assert (not (exists ((?root0 TLL_t) (?ll0 TLL_t) (?tr0 TLL_t)
		      (?root1 TLL_t) (?ll1 TLL_t) (?tr1 TLL_t)
		      (?root2 TLL_t) (?ll2 TLL_t) (?tr2 TLL_t)
		      (?root3 TLL_t) (?ll3 TLL_t) (?tr3 TLL_t)
		      (?root4 TLL_t) (?ll4 TLL_t) (?tr4 TLL_t)
		      (?root5 TLL_t) (?ll5 TLL_t) (?tr5 TLL_t)
		      (?root6 TLL_t) (?ll6 TLL_t) (?tr6 TLL_t)
		      (?root7 TLL_t) (?ll7 TLL_t) (?tr7 TLL_t)
		      (?root8 TLL_t) (?ll8 TLL_t) (?tr8 TLL_t)
		      (?root9 TLL_t) (?ll9 TLL_t) (?tr9 TLL_t)
		      (?root10 TLL_t) (?ll10 TLL_t) (?tr10 TLL_t)
		      (?root11 TLL_t) (?ll11 TLL_t) (?tr11 TLL_t)
		      (?root12 TLL_t) (?ll12 TLL_t) (?tr12 TLL_t)
		      (?root13 TLL_t) (?ll13 TLL_t) (?tr13 TLL_t)
		      (?root14 TLL_t) (?ll14 TLL_t) (?tr14 TLL_t)
		      (?root15 TLL_t) (?ll15 TLL_t) (?tr15 TLL_t)
		      (?root16 TLL_t) (?ll16 TLL_t) (?tr16 TLL_t)
		      (?root17 TLL_t) (?ll17 TLL_t) (?tr17 TLL_t)
		      (?root18 TLL_t) (?ll18 TLL_t) (?tr18 TLL_t)
		      (?root19 TLL_t) (?ll19 TLL_t) (?tr19 TLL_t)
		      )
	 (tobool (ssep 
