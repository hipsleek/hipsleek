...
(tospace (or 
	...
	(exists ((?x1 GenTyp) (?x2 GenTyp) (?x3 GenTyp) (?x4 GenTyp) (?x5 GenTyp) (?x6 GenTyp))
		
		 (tobool 
	(sep (succ6rec ?x1 ?x2 ?x3 ?x4 ?x5 ?x6 ?y1 ?y2 ?y3 ?y4 ?y5 ?y6)
		(Q ?x1 ?x2 ?x3 ?x4 ?x5 ?x6)
	)
...
;;(define-fun x4 () GenTyp)
;;(define-fun x5 () GenTyp)
;;(assert (tobool (index alpha1 (P  x0 x1 x2 x3 x4 x5))))
(define-fun x0 () GenTyp)
(define-fun x1 () GenTyp)
(define-fun x2 () GenTyp)
(define-fun x3 () GenTyp)
(define-fun x4 () GenTyp)
(define-fun x5 () GenTyp)
(assert (tobool (index alpha1 (Q  x0 x1 x2 x3 x4 x5))))
