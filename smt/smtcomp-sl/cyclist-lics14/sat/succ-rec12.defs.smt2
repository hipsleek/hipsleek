...
(tospace (or 
	...
	(exists ((?x1 GenTyp) (?x2 GenTyp) (?x3 GenTyp) (?x4 GenTyp) (?x5 GenTyp) (?x6 GenTyp) (?x7 GenTyp) (?x8 GenTyp) (?x9 GenTyp) (?x10 GenTyp) (?x11 GenTyp) (?x12 GenTyp))
		
		 (tobool 
	(sep (succ12rec ?x1 ?x2 ?x3 ?x4 ?x5 ?x6 ?x7 ?x8 ?x9 ?x10 ?x11 ?x12 ?y1 ?y2 ?y3 ?y4 ?y5 ?y6 ?y7 ?y8 ?y9 ?y10 ?y11 ?y12)
		(Q ?x1 ?x2 ?x3 ?x4 ?x5 ?x6 ?x7 ?x8 ?x9 ?x10 ?x11 ?x12)
	)
...
;;(define-fun x10 () GenTyp)
;;(define-fun x11 () GenTyp)
;;(assert (tobool (index alpha1 (P  x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11))))
(define-fun x0 () GenTyp)
(define-fun x1 () GenTyp)
(define-fun x2 () GenTyp)
(define-fun x3 () GenTyp)
...
(define-fun x10 () GenTyp)
(define-fun x11 () GenTyp)
(assert (tobool (index alpha1 (Q  x0 x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11))))
