...
node put_sensitive1_safe(node p, int x)
  requires p::pub_dll<n,prev> & n>0 & x <E @Lo
  ensures res::node<x,q,prev> * q::pub_dll<n-1,res> & res <E @Lo & x <E @Lo;
{
  p.v = x;
  return p;
}
...
node put_sensitive2_safe(node p, int x)
  requires p::pub_dll<n,prev> & n>0 & x <E @Lo
  ensures res::node<x,q,prev> * q::pub_dll<n-1,res> & res <E @Hi & x <E @Hi;
{
  p.v = x;
  return p;
}
...
node put_sensitive3_fail(node p, int x)
  requires p::pub_dll<n,prev> & n>0 & x <E @Hi
  ensures res::node<x,q,prev> * q::pub_dll<n-1,res> & res <E @Lo & x <E @Lo;
{
  p.v = x;
  return p;
...
node put_sensitiveS_safe(node p, int x)
  ...
  ensures res::node<x,q,prev> * q::pub_dll<n-1,res> & res <E @Lo;
{
  p.v = x;
  return p;
}
