...
pred pub_ll<n> == self=null & n=0 & self<E@Lo
  or self::ll_node<v,q> * q::pub_ll<m> & n>0 & m=n-1 & self<E@Lo & v<E@Lo
  inv n>=0;
pred fpri_ll<n> == self=null & n=0 & self<E@Hi
  or self::ll_node<v,q> * q::pub_ll<m> & n>0 & m=n-1 & self<E@Hi & v<E@Hi
  inv n>=0;
...
pred pub_dll<n,p> == self=null & n=0 & self <E @Lo
  or self::dll_node<v,q,p> * q::pub_dll<m,self> & n>0 & m=n-1 & self <E @Lo & v <E @Lo
  inv n>=0;
pred fpri_dll<n,p> == self=null & n=0 & self <E @Hi
  or self::dll_node<v,q,p> * q::pub_dll<m,self> & n>0 & m=n-1 & self <E @Hi & v <E @Hi
  inv n>=0;
pred pri_dll<n,p> == self=null & n=0 & self <E @Hi
  or self::dll_node<v,q,p> * q::pri_dll<m,self> & n>0 & m=n-1 & self <E @Hi & v <E @Hi
  inv n>=0;
...
pred pub_tree<n> == self=null & n=0 & self<E@Lo
  or self::tree_node<v,l,r> * l::pub_tree<n1> * r::pub_tree<n2>
     & n=n1+n2+1 & n>0 & self<E@Lo & v<E@Lo
  inv n>=0;

pred pri_tree<n> == self=null & n=0 & self<E@Hi
  or self::tree_node<v,l,r> * l::pri_tree<n1> * r::pri_tree<n2>
     & n=n1+n2+1 & n>0 & self<E@Hi & v<E@Hi
  inv n>=0;
...
pred lpub_tree<n> == self=null & n=0 & self<E@Lo
  or self::tree_node<v,l,r> * l::pub_tree<n1> * r::pri_tree<n2>
  & n=n1+n2+1 & n>0 & self<E@Lo & v<E@Lo
  inv n>=0;

pred rpub_tree<n> == self=null & n=0 & self<E@Lo
...
pred lpub_tree_par<n,p> == self=null & n=0 & self <E @Lo
  or self::tree_node_par<v,l,r,p> * l::pub_tree_par<ln,self> * r::pri_tree_par<rn,self>
  & n>0 & n=ln+rn+1 & self <E @Lo & v <E @Lo
  inv n>=0;

pred rpub_tree_par<n,p> == self=null & n=0 & self <E @Lo
