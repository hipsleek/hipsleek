...
pred fpri_ll<n> == self=null & n=0 & self<E@Hi
  or self::node<v,q> * q::pub_ll<m> & n>0 & m=n-1 & self<E@Hi & v<E@Hi
  inv n>=0;
...
pred pub_dll<p,n> == self=null & n=0 & self<E@Lo
  or self::node2<v,p,q> * q::pub_dll<q1,m> & n>0 & m=n-1 & self=q1 & self<E@Lo & v<E@Lo
  inv n>=0;
pred pri_dll<p,n> == self=null & n=0 & self<E@Hi
  or self::node2<v,p,q> * q::pri_dll<q1,m> & n>0 & m=n-1 & self=q1 & self<E@Hi & v<E@Hi
  inv n>=0;
