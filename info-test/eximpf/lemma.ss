...
pred pub_dll<p,n> == self=null & n=0 & self<E@Lo
  ...
  inv n>=0;
pred pri_dll<p,n> == self=null & n=0 & self<E@Hi
  or self::dll_node<v,p,q> * q::pri_dll<q1,m> & n>0 & m=n-1 & self=q1 & self<E@Hi & v<E@Hi
  inv n>=0;
