          ...
          | None   -> 
            begin
              ...
              | None  ->
                ...
                let () =  y_dinfo_hp (add_str "same_base" string_of_bool) same_base  in
                if true (* same_base *) (* !Globals.adhoc_flag_6 || same_base *)  then
                  ...
                  let () =  y_dinfo_hp (add_str "lhs_w_rhs_inst" !CP.print_formula) lhs_w_rhs_inst  in
                  let () =  y_dinfo_hp (add_str "rhs" !CP.print_formula) rhs  in
                  let () =  y_dinfo_hp (add_str "r" string_of_bool) r  in
