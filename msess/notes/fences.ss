...
lemma_norm "CONi" self::Chan{@S Fm2<id,pppp1,qq,mm> ;; %R}<> * qq::Fp<id,ppp2> & pppp1=ppp2 -> self::Chan{@S %R}<> * qq::Fm<id,pppp1,1.0-mm>.
/* lemma_norm "CON"  self::Chan{@S Fm2<id,ppp1,qq,mm> ;; %R}<> * qq::Fm<id,ppp1,nn> & nn>=mm-> self::Chan{@S %R}<> * qq::Fm<id,ppp1,nn-mm>. */
lemma_norm "CON"  self::Chan{@S Fm2<id,ppp1,qq,mm> ;; %R}<> * qq::Fm<id,ppp1,nn> -> self::Chan{@S %R}<> * qq::Fm<id,ppp1,nn-mm>.
