...
#	["2-3trees.ss",4,"make_node","SUCCESS","insert_left","SUCCESS","insert_middle","SUCCESS","insert_right","SUCCESS","insert","SUCCESS"],
	...
	"slicing" => [
		...
		["avl_size_height_bags_0_link.ss", 13, "",  
			"height", "SUCCESS",
			"rotate_left", "SUCCESS",
			"rotate_right", "SUCCESS",
			"get_max", "SUCCESS",
	...
	"plink_all" => [
		...
		["avl_size_height_bal_4_links.ss", 7, "",  
			"height", "SUCCESS",
			"get_max", "SUCCESS",
			"insert", "SUCCESS",
			"double_left_child", "SUCCESS",
		...
		["bst_size_height_bags_1_link.ss", 6, "",  
			"delete", "SUCCESS",
			"remove_min", "SUCCESS",
			"insert", "SUCCESS",
			"flatten", "SUCCESS",
		...
		["perfect_size_height_1_link.ss", 5, "",  
			"insert", "SUCCESS",
			"height", "SUCCESS",
			"maxim", "SUCCESS",
			"create", "SUCCESS",
		...
		["perfect_size_height_bags_1_link.ss", 5, "",  
			"insert", "SUCCESS",
			"height", "SUCCESS",
			"maxim", "SUCCESS",
			"create", "SUCCESS",
...
sub hip_process_file {
    foreach $param (@param_list)
    {
        if ("$param" =~ "hip") {
            ...
            $exempl_path_full = "$exempl_path/pldi_benchs/pomega";
            print "Starting automatic slicing experiment for PLDI paper with Omega:\n";
		}elsif ("$param" =~ "pz3") {
            $exempl_path_full = "$exempl_path/pomega";
            print "Starting automatic slicing experiment for PLDI paper with Z3:\n";
		}elsif ("$param" =~ "pmona_b") {
            $exempl_path_full = "$exempl_path/pldi_benchs/pmona";
            print "Starting automatic slicing experiment for PLDI paper with Mona on bag examples:\n";
		}elsif ("$param" =~ "pmona_a") {
            $exempl_path_full = "$exempl_path/pldi_benchs/pmona";
            print "Starting automatic slicing experiment for PLDI paper with Mona on arithmetic examples:\n";
		}elsif ("$param" =~ "pmona") {
            $exempl_path_full = "$exempl_path/pldi_benchs/pmona";
            print "Starting automatic slicing experiment for PLDI paper with Mona:\n";
		}elsif ("$param" =~ "plink") {
            $exempl_path_full = "$exempl_path/plink";
            print "Starting annotated slicing experiment for PLDI paper:\n";
		}elsif ("$param" =~ "SIR") {
            $exempl_path_full = "$exempl_path/SIR";
            print "Starting annotated slicing experiment for PLDI paper:\n";
		}
