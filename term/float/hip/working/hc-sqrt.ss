...
void foo_term1(float x)
    case
    {
      ...
      x > 1  -> requires Term[Seq{x, (1.0, +infinity), 1.1}] ensures true;
    }
{
  if (x > 1.1)
  {
...
void foo_term1a(float x)
    case
    {
      ...
      x > 2.0  -> requires Term[Seq{x, (1.0, +infinity), 1.1}] ensures true;
    }
{
  if (x > 1.1)
  {
...
void foo_term2(float x)
    case
    {
      ...
      x > 0  -> requires Term[Seq{-x, (-1.0, 0.0), -0.9}] ensures true;
    }
{
  if ((x > 0) && (x < 0.9))
  {
