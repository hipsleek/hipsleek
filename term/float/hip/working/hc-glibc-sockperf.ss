...
void loop1(float z)
  case
  {
    2.0 < z < 4.0 -> requires Term[SeqDec{-z*z, (-infinity, -4.0), -infinity, __abs(z) >= 4.0}] ensures true;
    //-4.0 < z < -2.0 -> requires Term[SeqDec{-__abs(z), (-infinity, -2.0), -infinity, __abs(z) >= 4.0}] ensures true;
