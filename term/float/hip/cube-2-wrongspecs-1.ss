...
void foo1(float x)
    case
    {
      ...
      0.1 < x < 1.1 -> requires Term[Seq{x, (0.0, 1.0), 0.1}] ensures true; // wrong specs, should be 0.1 < x < 1.0
...
void foo2(float x)
    case
    {
      ...
      0.1 < x < 0.9 -> requires Term[Seq{x, (0.0, 1.0), 0.1}] ensures true;
      x <= 0.1    -> requires Term ensures true;
    }
{
  if (x > 0.1)
...
void foo4(float x)
    ...
    {
      x >= 1.0      -> requires Loop ensures false;
      0.1 < x < 1.0 -> requires Term[Seq{x, (0.0, 1.1), 0.1}] ensures true; // domain should be (0.0, 1.0)
      x <= 0.1    -> requires Term ensures true;
    }
{
  if (x > 0.1)
...
void foo5(float x)
    ...
    {
      x >= 1.0      -> requires Loop ensures false;
      0.1 < x < 1.0 -> requires Term[Seq{x, (0.01, 1.0), 0.1}] ensures true; // domain should be (0.0, 1.0)
      x <= 0.1    -> requires Term ensures true;
    }
{
  if (x > 0.1)
...
void foo8(float x)
    ...
    {
      x >= 1.0      -> requires Loop ensures false;
      0.1 < x < 1.0 -> requires Term[Seq{x, (0.0, 1.0), 0.1}] ensures true; // limit should be 0.0
      x <= 0.1    -> requires Term ensures true;
    }
{
  if (x > 0.1)
