...
node add_one_digit(node x, int c)
  requires x::bigint<v> & 0 <= c <= 9 & Term[v]
...
node add_c(node x, node y, int c)
  requires x::bigint<v1> * y::bigint<v2> & 0 <= c <= 1 & Term[v1]
...
node add(node x, node y)
  requires x::bigint<v1> * y::bigint<v2> & Term
...
node sub_one_digit(node x, int c)
  requires x::bigint<v> & 0 <= c <= 9 & c <= v & Term[v]
  ensures res::bigint<v-c> * x::bigint<v>;
{
...
node sub_c(node x, node y, int c)
  requires x::bigint<v1> * y::bigint<v2> & 0 <= c <= 1 & v1 >= v2+c & Term[v1]
  ensures res::bigint<v1-v2-c> * x::bigint<v1> * y::bigint<v2>;
{
  if (x == null) return null;
...
node sub(node x, node y)
  requires x::bigint<v1> * y::bigint<v2> & v1 >= v2 & Term
  ensures res::bigint<v1-v2> * x::bigint<v1> * y::bigint<v2>;
{
  return sub_c(x, y, 0);
}
...
node mult_c(node x, int d, int c)
  requires x::bigint<v> & 0 <= c <= 9 & 0 <= d <= 9 & Term[v] 
...
node mult(node x, node y)
  requires x::bigint<v1> * y::bigint<v2> & Term[v2]
  ensures res::bigint<v1*v2> * x::bigint<v1> * y::bigint<v2>;
{
  if (x == null || y == null) {
    return null;
...
node karatsuba_mult(node x, node y)
  requires x::bigint<v1> * y::bigint<v2> & Term[v1]
  ensures res::bigint<v1*v2> * x::bigint<v1> * y::bigint<v2>;
{
