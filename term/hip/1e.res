...
Checking procedure foo$int... OLD SPECS:  EInfer [p1,p2]
   ECase case {
          ...
          ;
          x=0 -> EBase true & Term[p1,x+1] & {FLOW,(20,21)=__norm}
                         EAssume 2::
                           true & res=0 & {FLOW,(20,21)=__norm}
          ;
          0<x -> EBase true & Term[p2,x] & {FLOW,(20,21)=__norm}
                         EAssume 3::
...
(9)->(15) (ERR: not decreasing) Term[p2; x]->Term[p2_550; v_int_15_474']
(9)->(15) (ERR: not decreasing) Term[p2; x]->Term[p1_549; v_int_15_474'+1]
(7)->(15) (ERR: not bounded) 

Stop Omega... 106 invocations 
8 false contexts at: ( (15,17)  (15,15)  (15,11)  (15,9)  (15,2)  (15,9)  (13,2)  (13,9) )

Total verification time: 0.428025 second(s)
	Time spent in main process: 0.288017 second(s)
	Time spent in child processes: 0.140008 second(s)
