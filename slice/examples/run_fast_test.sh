...
./run-fast-tests.pl slicing -log-timings -tp om -flags "--eps --enable-slicing --opt-imply 2"

# HIP with forced slicing (with heuristic)
./run-fast-tests.pl slicing -log-timings -tp om -flags "--eps --enable-slicing --opt-imply 3"