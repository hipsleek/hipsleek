...
do
	...
	# echo "[spass][.slc] spaguetti-$i" >> timeout.out
	# kill_proc
	# time (../../../../sleek --ufdp -tp spass spaguetti-$i.slk --eps --dis-provers-timeout --sleek-timeout $SLEEK_TIMEOUT) 1> spaguetti-$i.spass.imm.slc.to 2>> timeout.out

	# echo "[spass][.ineq] spaguetti-$i"
	# echo "[spass][.ineq] spaguetti-$i" >> timeout.out
	# kill_proc
	# time (../../../../sleek --ufdp -tp spass spaguetti-$i.slk --eps --enable-slicing --slc-opt-ineq --dis-provers-timeout --sleek-timeout $SLEEK_TIMEOUT) 1> spaguetti-$i.spass.imm.ineq.to 2>> timeout.out
