...
#	["2-3trees.ss",4,"make_node","SUCCESS","insert_left","SUCCESS","insert_middle","SUCCESS","insert_right","SUCCESS","insert","SUCCESS"],
	...
	"SIR" => [
		...
		["schedule.c", 20, "-tp redlog --dis-oc",
			"new_ele", "SUCCESS",
			"new_process", "SUCCESS",
			"add_process", "SUCCESS",
			"find_nth_helper", "SUCCESS",
		...
		["schedule2.c", 17, "-tp redlog --dis-oc",
			"lput_end", "SUCCESS",
			"put_end", "SUCCESS",
			"do_get_process", "SUCCESS",
			"get_current", "SUCCESS",
...
sub hip_process_file {
    foreach $param (@param_list)
    {
        if ("$param" =~ "hip") {
            ...
            $exempl_path_full = "$exempl_path/pldi_benchs/pomega";
            print "Starting automatic slicing experiment for PLDI paper with Redlog:\n";
		}elsif ("$param" =~ "pmona_b") {
            ...
            print "Starting SIR benchmark for PLDI paper:\n";
		}
