...
type command =
  ...
  | RelAssume of (cond_path_type * meta_formula * meta_formula option * meta_formula)
  | RelDefn of (cond_path_type * meta_formula * meta_formula * (((ident*ident list)*(ident*ident list*ident list) * int list) list))
  ...
  | ShapeConquer of (ident list * cond_path_type list)
