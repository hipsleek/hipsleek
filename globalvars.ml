...
let rec check_and_change (global_vars : IdentSet.t) (exp : I.exp) : I.exp =
  ...
  | I.Catch e -> 
		...
		let new_exp2 = Typeinfer.rename_exp renlist e.I.exp_catch_body in
	I.Catch {e with 
	  ...
	  begin
		match e.I.exp_seq_exp1 with
		  I.VarDecl e1 -> 
			...
			let new_exp2 = Typeinfer.rename_exp renlist e.I.exp_seq_exp2 in
...
let resolve_name_conflict (proc : I.proc_decl) : I.proc_decl =
  ...
  | Some e ->
	  begin
		...
		let new_exp2 = Typeinfer.rename_exp renlist new_exp1 in
