...
EXTRA_TAGS = {
  ...
  "<xml/*.*>" => "not_hygienic",
  "<ppx/*.*>" => "not_hygienic",
  "<omega_modified/omega_lib/obj/*.*>" => "not_hygienic",
  "<omega_modified/code_gen/obj/*.*>" => "not_hygienic",
  "<omega_modified/omega_calc/obj/*.*>" => "not_hygienic",
  "<omega_modified/petit/obj/*.*>" => "not_hygienic",
  "<omega_modified/uniform/obj/*.*>" => "not_hygienic",
