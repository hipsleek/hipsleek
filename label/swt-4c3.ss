...
/*
requires cur::tx<a,sent> * prev::tx<b,sent> & cur != null & a=null & b=sent
ensures prev'::tx<null,sent>  & cur' = sent; 
requires cur::tx<a,sent> * prev::tx<b,sent> & cur != sent & a=sent & b=null 
ensures prev'::tx<null,sent>  & cur' = sent; 
*/
requires cur::tx<a,sent> * prev::tx<b,sent> & 
        (cur!=a & a=null & b=sent | cur!=a & a=sent & b=null)
ensures prev'::tx<null,sent>  & cur' = sent;
