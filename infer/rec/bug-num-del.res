...
NEW RELS: [ (a=1 & res=n-1 & 2<=n) --> B(n,a,res), ((v_int_27_547=res-1 & v_int_27_543=a-1 & v_int_27_542=n-1 & 1<=n & 2<=a | 
  v_int_27_547=res-1 & v_int_27_543=a-1 & v_int_27_542=n-1 & a<=0 & 1<=n) & 
