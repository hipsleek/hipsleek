...
NEW SPECS:  EBase true & 1<=a & a<n & MayLoop & {FLOW,(1,23)=__flow}
         EAssume 1::
           true & B(n,a,res) & {FLOW,(20,21)=__norm}
NEW RELS: [ ( a=1 & res=n - 1 & 2<=n) -->  B(n,a,res), ( (v_int_14_544=res - 1 & v_int_14_540=a - 1 & v_int_14_539=n - 1 & 1<=n & 
2<=a | v_int_14_544=res - 1 & v_int_14_540=a - 1 & v_int_14_539=n - 1 & 
a<=0 & 1<=n) & B(v_int_14_539,v_int_14_540,v_int_14_544)) -->  B(n,a,res)]
