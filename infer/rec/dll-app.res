...
C(t_650,m_623,n_625)) -->  C(t,m,n), ( t_646=0 & t=1 & n_625=n & m_623=m - 1 & 0<=n & 1<=m & C(t_646,m_623,n_625)) -->  C(t,m,n)]
       ...
       y::dll<p,n>@M[Orig][LHSCase] & true & {FLOW,(20,21)=__norm}
         EBase true & 1<=m & 0<=n & MayLoop & {FLOW,(1,23)=__flow}
                 EAssume 9::
                   ...
                   0<=n & {FLOW,(20,21)=__norm}
NEW RELS: [ ( q=r & m=1 & t=n+1 & 1<=n) -->  D(t,m,n,r,p,q), ( m=1 & n=0 & r=q & t=1) -->  D(t,m,n,r,p,q), ( p=p_841 & r=q & t=t_919+1 & n_842=n & m_840=m - 1 & r_920=q_839 & 
1<=t_919 & 0<=n & 1<=m & q_839!=null & D(t_919,m_840,n_842,r_920,p_841,q_839)) -->  D(t,m,n,r,p,q)]
