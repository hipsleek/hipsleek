       ...
       {FLOW,(20,21)=__norm}
         EBase true & sm<=lg & MayLoop & {FLOW,(1,23)=__flow}
                 EAssume 2::ref [x]
                   ...
                   {FLOW,(20,21)=__norm}
NEW RELS: [ ( s=sm & sm<=l & l<=lg) -->  B(sm,s,l,lg), ( sm=s & l=lg & s<=lg) -->  B(sm,s,l,lg), ( s=sm & l=l_893 & lg_621=lg & sm<=sm_620 & sm_620<=s_892 & s_892<=l_893 & 
sm_620<=lg & B(sm_620,s_892,l_893,lg_621)) -->  B(sm,s,l,lg), ( s=s_959 & l=lg & sm_640=sm & s_959<=l_960 & l_960<=lg_641 & lg_641<=lg & 
sm<=lg_641 & B(sm_640,s_959,l_960,lg_641)) -->  B(sm,s,l,lg), ( s=sm & l=lg & sm<=lg) -->  B(sm,s,l,lg)]
...
Total verification time: 2.16 second(s)
	Time spent in main process: 0.85 second(s)
	Time spent in child processes: 1.31 second(s)
