...
NEW SPECS:  EBase exists (Expl)(Impl)[sm; lg](ex)x::bst<sm,lg>@M[Orig][LHSCase]&true&
       {FLOW,(20,21)=__norm}
         EBase true&MayLoop&{FLOW,(1,23)=__flow}
                 EAssume 1::
                   res::bst<mi,ma>@M[Orig][LHSCase]&res!=null & A(mi,sm,a) & 
                   ma=max(lg,a) & sm<=lg&{FLOW,(20,21)=__norm}
...
Total verification time: 1.96 second(s)
	Time spent in main process: 0.74 second(s)
	Time spent in child processes: 1.22 second(s)
