...
PRE :  2<=n
OLD SPECS:  EInfer [B]
   EBase exists (Expl)(Impl)[p; n](ex)x::dll<p,n>@M[Orig][LHSCase] & a<n & 
         0<a & {FLOW,(20,21)=__norm}
           EBase true & MayLoop & {FLOW,(1,23)=__flow}
                   EAssume 1::
                     EXISTS(p_28,m: x::dll<p_28,m>@M[Orig][LHSCase] &
                     B(m,n) & p_28=p & {FLOW,(20,21)=__norm})
NEW SPECS:  EBase exists (Expl)(Impl)[p; n](ex)x::dll<p,n>@M[Orig][LHSCase] & 1<=a & 
       a<n & {FLOW,(20,21)=__norm}
