...
node find_nth(node f_list, int j)
  ...
  ensures f_list::lseg1<res,j-1,S1> * res::node<_,_,q>
...
void schedule1(ref node cur_proc, ref node pq1, ref node pq2,ref node pq3)
 ...
 case{
  n3 > 0 ->
    ensures pq1'::ll1<n1,S4> * pq2'::ll1<n2,S5> * pq3'::ll1<n3-1,S6> * cur_proc'::node<_,_,null>;
  n3<=0 -> case {
    n2>0 -> ensures  pq1'::ll1<n1,S4> * pq3'::ll1<n3,S6> * pq2'::ll1<n2-1,S5> * cur_proc'::node<_,_,null>;
    n2<=0 -> case{
      n1>0 -> ensures pq3'::ll1<n3,S6> * pq2'::ll1<n2,S5> * pq1'::ll1<n1-1,S4> * cur_proc'::node<_,_,null>;
      n1<=0 -> ensures pq1'=null &  pq2'= null & pq3'= null & cur_proc' = null;
    }
  }
}
