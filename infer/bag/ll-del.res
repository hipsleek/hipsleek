...
!!! NEW RELS:[ (S1= & S= & S1=S) --> A(a,S,S1),
 ...
 (exists(v_node_28_539':exists(v_node_28_646:exists(v_bool_24_541':exists(v_bool_27_540':exists(x:exists(q_648:exists(res:exists(S1_662:exists(v_661:exists(S1_649:exists(v_647:exists(S1_585:exists(v_583:(S1_645= & 
  ...
  S1_645=S1_649 & !(v_bool_24_541') & a<v_647 & !(v_bool_27_540') & 
  q_648=null & x!=null & res!=null & true | S1_585=S_606 & 
  v_node_28_539'=res & v_583=v_647 & v_node_28_646=q_648 & S1_645=S1_649 & 
  !(v_bool_24_541') & !(v_bool_27_540') & q_648=null & v_647<a & x!=null & 
  res!=null & true) | (S1_585=S_606 & v_node_28_539'=res & v_583=v_647 & 
  v_node_28_646=q_648 & S1_645=S1_649 & !(v_bool_24_541') & a<v_647 & 
  !(v_bool_27_540') & x!=null & q_648!=null & res!=null & true | 
  S1_585=S_606 & v_node_28_539'=res & v_583=v_647 & v_node_28_646=q_648 & 
  S1_645=S1_649 & !(v_bool_24_541') & !(v_bool_27_540') & v_647<a & 
  x!=null & q_648!=null & res!=null & true) & S1_645=union(S1_662,
  {v_661})) & S1=union(S1_649,{v_647}) & S=union(S1_585,
  {v_583})))))))))))))) & A(a,S_606,S1_645)) --> A(a,S,S1)]
!!! NEW ASSUME:[]
!!! NEW RANK:[]
