data node1 { int val; node1 next; }

ll<n> == self=null & n=0 or self::node1<_,p> * p::ll<m> & n=m+1 inv n>=0;

sll<n,xs,xl> == self::node1<xs,null> & n=1 & xs=xl or self::node1<xs,p> * p::sll<m,k,xl> & n=m+1 & xs<=k inv xs<=xl & n>=1;
