                  ...
                  ([x!=null][1<=n]))&{FLOW,(20,21)=__norm}
                    EBase true&(([MayLoop][1<=n]))&{FLOW,(1,23)=__flow}
                            EAssume 36::
                              ...
                              (
                              ([0<=m_2542 & 0<=n & -1+n=m_2542 & 1<=n]
                               [x!=null][null=flted_222_2538]
                               [null=flted_222_2539]))&
                              {FLOW,(20,21)=__norm}))
                  ...
                  ([0<=n]))&{FLOW,(20,21)=__norm}
                    EBase true&(([MayLoop][0<=n]))&{FLOW,(1,23)=__flow}
                            EAssume 105::
                              ...
                              (
                              ([m_3735<=n & 0<=n & (-1+n)<=m_3735 & 0<=m_3735]
                               [p=p_3734]))&
                              {FLOW,(20,21)=__norm}))
                    ...
                    EBase true&(([MayLoop][1<=a & a<=n]))&
                          {FLOW,(1,23)=__flow}
                            EAssume 84::ref [x]
                              ...
                              (
                              ([a=n1_4934 & 0<=n2_4935 & 0<=n & n=a+
                                 n2_4935 & 1<=a & 0<=n1_4934 & a<=n]
                               [p=p_4932]))&
                              {FLOW,(20,21)=__norm}))
...
Stop Omega... 2176 invocations 
7 false contexts at: ( (546,6)  (252,13)  (252,4)  (41,17)  (41,24)  (42,7)  (42,14) )

Total verification time: 4.44 second(s)
