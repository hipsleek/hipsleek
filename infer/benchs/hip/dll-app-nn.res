...
!!! Inferred constraints:[ m!=0, m!=0, m!=0]
Inferred Heap:[]
Inferred Pure:[ m!=0, m!=0, m!=0]

INF-POST-FLAG: false
REL :  D(t,m,n,r,p,q)
POST:  m>=1 & t>=m & r=q & t=n+m
PRE :  1<=m & 0<=n
...
NEW SPECS:  EBase exists (Expl)(Impl)[q; m; p; n](ex)x::dll<q,m>@M[Orig][LHSCase] * 
       y::dll<p,n>@M[Orig][LHSCase] & true & {FLOW,(20,21)=__norm}
         EBase true & 1<=m & 0<=n & MayLoop & {FLOW,(1,23)=__flow}
                 EAssume 1::
                   x::dll<r,t>@M[Orig][LHSCase] & D(t,m,n,r,p,q) & 0<=m & 
                   0<=n & {FLOW,(20,21)=__norm}
NEW RELS: [ ( q=r & m=1 & t=n+1 & 1<=n) -->  D(t,m,n,r,p,q), ( m=1 & n=0 & r=q & t=1) -->  D(t,m,n,r,p,q), ( p=p_633 & r=q & t=t_711+1 & n_634=n & m_632=m - 1 & r_712=q_631 & 
1<=t_711 & 0<=n & 1<=m & q_631!=null & D(t_711,m_632,n_634,r_712,p_633,q_631)) -->  D(t,m,n,r,p,q)]
