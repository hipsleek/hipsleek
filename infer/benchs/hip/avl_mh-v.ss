...
//infer[x]
  ...
  ensures res::avl1<k> & k=1 + nx1 & res!=null;
//1+nx1=k & 0<=nx1 & 2<=k
{
	int v = 0;
	int tmp;
...
/*
case {
  n=0 -> ensures res::avl1<n1> &  INSI1(n,n1);//n<= n1 <= n+1;
  n!=0 -> ensures res::avl1<n1> &  INSI2(n,n1);//n<= n1 <= n+1;
}
 */
...
/*
[res!=null][null=x][0=n & 0<=n][1=n1_2690] or
[n=n1_2691 & 2<=n & 0<=n][x!=null] [res!=null]
 */
{
...
case {
  t1=null -> requires t2::avl1<h2> ensures res::avl1<h2> ;//& MRG1(h2,h3);
      //h2=h3 & 0<=h3
