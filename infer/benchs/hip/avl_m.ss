...
!!! Inferred Pure :[ inf_ann_1559<=1, inf_ann_1560<=1, inf_ann_1549<=1, inf_ann_1550<=1]
 */
...
case {
      t1=null -> requires t2::avl1<> ensures res::avl1<>;
      t1!=null -> requires t1::avl1<> * t2::avl1<> ensures res::avl1<>;
}
