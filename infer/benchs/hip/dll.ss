...
*/
relation B(int m, int n).
void delete1(node2 x, int a)
  infer[B,n,a]
  requires x::dll<p, n> //& n > a > 0
  ensures x::dll<p, n-1> & B(n,a);
...
/* append 2 doubly linked lists */
void append2_f(node2 x, node2 y)
