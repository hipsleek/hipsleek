       ...
       {FLOW,(20,21)=__norm}
         EBase true&x!=null & MayLoop&{FLOW,(1,23)=__flow}
                 EAssume 1::
                   ...
                   q_536::ll<flted_7_534>@M[Orig]&n=flted_7_534+1 & 
                   res=Anon_535 & 0<=n&{FLOW,(20,21)=__norm}
NEW RELS: []
...
OLD SPECS:  EInfer [x]
   EBase true&true&{FLOW,(20,21)=__norm}
           EBase true&MayLoop&{FLOW,(1,23)=__flow}
                   EAssume 4::
                     true&true&{FLOW,(20,21)=__norm}
NEW SPECS:  EBase x::node<inf_val_38_542,inf_next_38_543>@L[Orig]&MayLoop&
       {FLOW,(1,23)=__flow}
         EAssume 4::
...
OLD SPECS:  EInfer [x]
   EBase true&true&{FLOW,(20,21)=__norm}
           EBase true&MayLoop&{FLOW,(1,23)=__flow}
                   EAssume 2::ref [x]
                     true&true&{FLOW,(20,21)=__norm}
NEW SPECS:  EBase inf_inf_next_38_553::ll<inf_n_559>@M[Orig][LHSCase] * 
       ...
       inf_inf_next_38_553!=null & MayLoop&{FLOW,(1,23)=__flow}
         EAssume 2::ref [x]
           ...
           inf_ann_558<=0 & inf_inf_next_38_553=x' & flted_7_534=inf_n_559-
           1 & res=Anon_535 & x'!=null & 0<=inf_n_559 & 0<=inf_n_559&
           {FLOW,(20,21)=__norm}
NEW RELS: []
