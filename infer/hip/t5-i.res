...
Residual Post :  true & res=inf_next_32_511 & {FLOW,(20,21)=__norm}
OLD SPECS:  EInfer [x]
...
Residual Post :  true & res=inf_val_24_517 & {FLOW,(20,21)=__norm}
OLD SPECS:  EInfer [x]
   EBase true & true & {FLOW,(20,21)=__norm}
           EAssume 3::
             true & true & {FLOW,(20,21)=__norm}
...
Residual Post :  true & x'=inf_inf_next_32_526 & res=inf_inf_val_24_533 &
{FLOW,(20,21)=__norm}
OLD SPECS:  EInfer [x]
   EBase true & true & {FLOW,(20,21)=__norm}
           EAssume 1::ref [x]
...
Total verification time: 0.252015 second(s)
