...
NEW SPECS:  EBase exists (Expl)(Impl)[v; n](ex)x::llf<v,n>@M[Orig][LHSCase]&true&
       {FLOW,(20,21)=__norm}
         EBase true&(1<=n | n<=(0-1)) & MayLoop&{FLOW,(1,23)=__flow}
                 EAssume 1::
                   x::node<v_530,q_532>@M[Orig] * 
                   q_532::llf<Anon_533,flted_8_531>@M[Orig]&n=flted_8_531+
                   1 & v_530=v & res=v & 0<=n&{FLOW,(20,21)=__norm}
NEW RELS: []
