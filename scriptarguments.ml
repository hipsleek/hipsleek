...
linput.rl");
  ...
  ("--old-keep-triv-hprel", Arg.Set Globals.old_keep_triv_hprel,"Keep trivial HP_REL during inference");
  ("--new-keep-triv-hprel", Arg.Clear Globals.old_keep_triv_hprel,"Remove trivial HP_REL during inference");
