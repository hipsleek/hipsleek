...
let common_arguments = [
  ...
  ("-dfp", Arg.Clear Globals.prune_false_entail_state, "Disable pruning of false entail states");
  ...
  ("-dcsl", Arg.Clear Globals.prune_false_entail_state, "Disable combining security labels in conditionals");
