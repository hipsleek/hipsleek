...
void giveRightToVote(address voter)
     requires  [vt0] voters::Map<vt0> * msg::message<_,sender,_> & sender = chairperson & !vt0[voter].voted & vt0[voter].weight = 0
     ensures   (exists vt1: voters'::Map<vt1> & vt1[voter].weight = 1);
{
     voters[voter].weight = 1;
