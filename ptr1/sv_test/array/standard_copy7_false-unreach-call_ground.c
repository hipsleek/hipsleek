...
int main( ) {
  ...
  for ( i = 0 ; i < N ; i++ ) 
    /*@
      requires a6::arr_seg<i,100000>*a8::arr_seg<i,100000>
      ensures a6::arr_seg<i,100000>*a8::arr_seg<i,100000>;
    */
  {
    a8[i] = a6[i];
  }
  ...
  for ( x = 0 ; x < N ; x++ ) 
    /*@
      requires a1::arr_seg<x,100000>*a8::arr_seg<x,100000>
      ensures a1::arr_seg<x,100000>*a8::arr_seg<x,100000>;
    */
  {
