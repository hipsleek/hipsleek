...
int main( ) {
  ...
  for ( i = 0 ; i < N ; i++ ) 
    /*@
      requires a9::arr_seg<i,100000>*a0::arr_seg<i,100000>
      ensures a9::arr_seg<i,100000>*a0::arr_seg<i,100000>;
    */
  {
    a0[i] = a9[i];
  }
  ...
  for ( x = 0 ; x < N ; x++ ) 
    /*@
      requires a1::arr_seg<x,100000>*a0::arr_seg<x,100000>
      ensures a1::arr_seg<x,100000>*a0::arr_seg<x,100000>;
    */
  {
