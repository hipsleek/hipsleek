...
s/Util.\(list_last\)/Gen.Profiling.\1/p
s/Util.\(add_index\)/Gen.Profiling.\1/p

s/Util.restart/Gen.Basic.restart/p
s/Util.split_by/Gen.split_by/p
s/Util.\(empty\)/Gen.is_\1/p
...
s/Util.difference/Gen.BList.difference_eq =/p
...
s/Util.\(get_equiv\)_eq_raw/Gen.EqMap(Slices.SV).\1/p
s/Util.\(get_elems\)_eq_raw/Gen.EqMap(Slices.SV).\1/p
...
s/Util.\(un_partition\)/Gen.EqMap(Slices.SV).\1/p

s/Util.empty_a_set_eq \<.*\>/Gen.EqMap(Slices.SV).mkEmpty/p
...
s/spec_var Util.eq_set/Gen.EqMap(Slices.SV).emap/p
...
s/Util.\(is_sat_dset\)/Gen.DisjSet(Slices.PtrSV).\1/p
s/Util.\(empty_dset\)/Gen.DisjSet(Slices.PtrSV).mkEmpty/p
s/CP.spec_var Util.d_set/Gen.DisjSet(Slices.PtrSV).dlist/p
s/spec_var Util.d_set/Gen.DisjSet(Slices.PtrSV).dlist/p


s/Util.\(empty_baga\)/Gen.Baga(Slices.PtrSV).mkEmpty/p
s/Util.\(is_sat_baga\)/Gen.Baga(Slices.PtrSV).\1/p
s/Util.\(or_baga\)/Gen.Baga(Slices.PtrSV).\1/p
s/Util.\(conj_baga\)/Gen.Baga(Slices.PtrSV).\1/p
s/Util.\(star_baga\)/Gen.Baga(Slices.PtrSV).\1/p
s/CP.spec_var Util.baga/Gen.Baga(Slices.PtrSV).baga\1/p
s/spec_var Util.baga/Gen.Baga(Slices.PtrSV).baga\1/p
s/P.spec_var Util.baga/Gen.Baga(Slices.PtrSV).baga\1/p


s/Util.\(c_h\)/Gen.ExcNumbering.\1/p
s/Util.\(get_closest\)/Gen.ExcNumbering.\1/p
s/Util.\(has_cycles\)/Gen.ExcNumbering.\1/p
s/Util.\(clean_duplicates\)/Gen.ExcNumbering.\1/p
s/Util.\(add_edge\)/Gen.ExcNumbering.\1/p
s/Util.\(get_hash_of_exc\)/Gen.ExcNumbering.\1/p
s/Util.\(exc_sub_type\)/Gen.ExcNumbering.\1/p


s/Util.\(tag_list\)/Gen.Stackable.\1/p
