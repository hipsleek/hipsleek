...
/*@
  ...
  ensures q::pair_star<r>*r::pair<a,b+2> & res=b+2;
*/
{
  (*q)->y=((*q)->y)+2;
  int t = (*q)->y;
...
{local: int t
int t;
{member access member access q~~>deref~~>y = (int)member access member access q~~>deref~~>y + 2;
t = member access member access q~~>deref~~>y;
q = (84, ):cast_int_to_pair_star(0); // null??
(85, ):return t}}
}
*/
