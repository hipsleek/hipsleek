%{
  ...
  let rec trans_null (b:formula):formula = 
    let rec trans_p_f_null pf =
      ...
      | _ -> pf in
    match b with
      | BForm ((pf,il),l,fo) -> BForm (((trans_p_f_null pf), il),l,fo)
...
| TRUE { (BForm ((BConst (true, get_pos 1), None), None, None), None) }
| FALSE { (BForm ((BConst (false, get_pos 1), None), None, None), None) }
;
