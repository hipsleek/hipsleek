...
and checkeq_p_formula_x (hvars: ident list)(p1: CP.formula) (p2: CP.formula)(mtl: map_table list): (bool * (map_table list))=
  ...
  | Forall _
  | Exists _
  | SecurityForm _ -> false,mtl (* report_error no_pos "not handle checkeq 2 formula that have forall and exists yet" *)
...
and checkeq_p_formula_with_diff_x (hvars: ident list)(p1: CP.formula) (p2: CP.formula)(mtl: map_table list): (bool * (map_table * CP.formula) list)=
  ...
  | Forall _
  | Exists _
  | SecurityForm _ -> (false,[]) (* report_error no_pos "not handle checkeq 2 formula that have forall and exists yet" *)
