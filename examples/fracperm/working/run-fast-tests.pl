...
if($root){
	$exempl_path = "$root/examples/fracperm/working";
	$exec_path = "$root";
}
else
	{
...
if($home21){
	...
	$exempl_path = "$target_dir/examples/fracperm/working";
	if($root){
...
%sleek_files=(
		"sleek"=>[["sleek.slk","Valid.Valid.Valid.Fail."],
				  ...
				  ["sleek8.slk","Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Fail.Valid.Valid.Valid.Valid.Fail.Valid.Fail."],
					...
					["combine_simple.slk","Valid.Valid.Fail.Valid.Valid.Valid.Valid."],
					["split-combine.slk","Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid."],
					["combine2.slk","Valid.Valid.Valid.Valid."]
                  #,
