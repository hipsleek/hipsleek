...
echo "======= threadpool.ss ======"
../../../hip --en-thrd-resource --en-para -tp parahip --en-lsmu-infer threadhip/threadpool.ss | grep -E 'Proc|assert:' >  test-cases/threadpool.n

echo "======= multicast.ss ======"
../../../hip --en-thrd-resource --en-para -tp parahip --en-lsmu-infer threadhip/multicast.ss | grep -E 'Proc|assert:' >  test-cases/multicast.n
...
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/others/forkjoin.ss | grep -E 'Proc|assert:' > test-cases/threadhip/forkjoin.n
...
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/others/cell4.ss | grep -E 'Proc|assert:' > test-cases/threadhip/cell4.n
...
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/others/ls-bind.ss | grep -E 'Proc|assert:' > test-cases/threadhip/ls-bind.n
...
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/no-deadlock1.ss | grep -E 'Proc|assert:' > test-cases/threadhip/no-deadlock1.n
echo "======= threadhip/no-deadlock2.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/no-deadlock2.ss | grep -E 'Proc|assert:' > test-cases/threadhip/no-deadlock2.n
echo "======= threadhip/no-deadlock3.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/no-deadlock3.ss | grep -E 'Proc|assert:' > test-cases/threadhip/no-deadlock3.n
echo "======= threadhip/deadlock1.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/deadlock1.ss | grep -E 'Proc|assert:' > test-cases/threadhip/deadlock1.n
echo "======= threadhip/deadlock2.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/deadlock2.ss | grep -E 'Proc|assert:' > test-cases/threadhip/deadlock2.n
echo "======= threadhip/deadlock3.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/deadlock3.ss | grep -E 'Proc|assert:' > test-cases/threadhip/deadlock3.n
echo "======= threadhip/disj-no-deadlock1.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/disj-no-deadlock1.ss | grep -E 'Proc|assert:' > test-cases/threadhip/disj-no-deadlock1.n
echo "======= threadhip/disj-no-deadlock2.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/disj-no-deadlock2.ss | grep -E 'Proc|assert:' > test-cases/threadhip/disj-no-deadlock2.n
echo "======= threadhip/disj-no-deadlock3.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/disj-no-deadlock3.ss | grep -E 'Proc|assert:' > test-cases/threadhip/disj-no-deadlock3.n
echo "======= threadhip/disj-deadlock.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/disj-deadlock.ss | grep -E 'Proc|assert:' > test-cases/threadhip/disj-deadlock.n
echo "======= threadhip/ordered-locking.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/ordered-locking.ss | grep -E 'Proc|assert:' > test-cases/threadhip/ordered-locking.n
echo "======= threadhip/unordered-locking.ss ======"
../../../hip --en-para --en-thrd-resource -tp parahip --en-lsmu-infer threadhip/parahip-benchmark/unordered-locking.ss | grep -E 'Proc|assert:' > test-cases/threadhip/unordered-locking.n
