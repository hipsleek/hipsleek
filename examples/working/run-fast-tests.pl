...
#		 "karatsuba_mult", "SUCCESS",
        ...
        "get_tail","SUCCESS","insertion_sort","SUCCESS","id","SUCCESS"],
        ["lltree.ss",1,"-tp om --mem ","delete_request","SUCCESS"],
        ...
        "insert_llt","SUCCESS","insert_dcll","SUCCESS"],
        ["process_scheduler.ss",4,"-tp om --mem ","insert_process","SUCCESS","insert_rll","SUCCESS",
        "insert_pll","SUCCESS","insert_sll","SUCCESS"],
        ["process_scheduler_infer.ss",4,"-tp om --mem  --infer-mem","insert_process","SUCCESS","insert_rll","SUCCESS",
        "insert_pll","SUCCESS","insert_sll","SUCCESS"],
        ...
        ["compatible_pairs.ss",1,"--mem ","sum","SUCCESS"],
...
#	["2-3trees.ss",4,"make_node","SUCCESS","insert_left","SUCCESS","insert_middle","SUCCESS","insert_right","SUCCESS","insert","SUCCESS"],
        ...
        # goes into a loop with combined-lemma-heuristics still
				...
				["classic/classic1.ss",2, "", "foo1", "FAIL", "foo2", "SUCCESS"],
				["classic/classic1a.ss",2, "", "foo1", "SUCCESS", "foo2", "SUCCESS"],
				["classic/classic1a.ss",2, "", "foo1", "SUCCESS", "foo2", "FAIL"],
...
# TODO : why are spaces so important in " --imm "?
                      ...
                      ["classic/classic1.slk", " ", "", "Fail.Valid.Valid.Valid.Fail.Valid.Fail.Fail."],
