...
#	["2-3trees.ss",4,"make_node","SUCCESS","insert_left","SUCCESS","insert_middle","SUCCESS","insert_right","SUCCESS","insert","SUCCESS"],
	...
	"bags" =>[
		...
		["benchs/hip/qsort.ss", 3, "",  
			"qsort1", "SUCCESS",
			"append_bll", "SUCCESS",
			"partition1", "SUCCESS"
		],
		["benchs/hip/isort.ss", 2, "",  
			"insertion_sort", "SUCCESS", "insert", "SUCCESS"
		],
		["benchs/hip/ssort.ss", 3, "",  
			"selection_sort", "SUCCESS",
			"delete_min", "SUCCESS",
		  "find_min", "SUCCESS"
		],
		["benchs/hip/msort.ss", 5, "",  
			"insert1", "SUCCESS",
			"merge1", "SUCCESS",
			"merge_sort1", "SUCCESS",
		  "split1", "SUCCESS",
		...
		["benchs/hip/bigint-unique-zero.ss", 18, "--eps -tp redlog",
		 "div_with_remainder", "SUCCESS",
		 "compare_int", "SUCCESS",
		 "compare", "SUCCESS",
		 "is_equal", "SUCCESS",
