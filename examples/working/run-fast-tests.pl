...
# TODO : why are spaces so important in " --imm "?
                      ...
                      ["imm/imm9-early-inst.slk", " --etcsu1 ", (), "Valid.Valid.Fail.Fail.Fail.Valid.Fail.Fail.Fail.Fail.Valid.Fail."],
                      ["imm/imm9-early-inst.slk", " --etcsu1 --field-imm ", (), "Valid.Valid.Fail.Fail.Fail.Valid.Fail.Fail.Fail.Fail.Valid.Fail."],
