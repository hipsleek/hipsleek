...
# slow in threads/owicki-gries.ss due to search. Could modify search heuristics.
	...
	"hip_veribsync" =>[
				["veribsync/while-loop.ss",4,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/while-loop2.ss",8,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/hip-bperm1.ss",6,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/bperm-exp.ss",4,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS",
                                "thread3","SUCCESS"
								],
				["veribsync/barrier-static-primitives.ss",1,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS"
								],
				["veribsync/barrier-static-exp1.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS"
								],
				["veribsync/barrier-static-exp2.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","FAIL",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS"
								],
				["veribsync/barrier-static-exp3.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","FAIL",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS"
								],
				["veribsync/barrier-static-complex.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/barrier-static-complex2.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/barrier-static-complex3.ss",2,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                # "f_r_923_while_16_2","SUCCESS",
                                "main","SUCCESS",
                                "thread","SUCCESS"
								],
				["veribsync/barrier-static-multiple.ss",4,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "main_fail","SUCCESS",
                                "participant","SUCCESS",
                                "participant_fail","FAIL"
								],
				["veribsync/barrier-static-consistency.ss",5,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "main_fail","FAIL",
                                "participant","SUCCESS",
				...
				["veribsync/barrier-dynamic-exp1.ss",4,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS",
                                "thread3","SUCCESS"
				...
				["veribsync/barrier-dynamic-exp3.ss",4,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","FAIL",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS",
                                "thread3","SUCCESS"
								],
				["veribsync/barrier-dynamic-exp4.ss",5,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/barrier-dynamic-exp5.ss",2,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "thread","SUCCESS"
								],
				["veribsync/barrier-dynamic-exp6.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "main","SUCCESS",
                                "thread1","SUCCESS",
                                "thread2","SUCCESS"
								],
				["veribsync/barrier-dynamic-exp7.ss",2,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "CalculationInTask","SUCCESS",
                                "main","SUCCESS"
								],
				["veribsync/benchmark/barnes.ss",16,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/fmm.ss",22,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/ocean.ss",5,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                "gets","SUCCESS","main","SUCCESS",
                                "multig","SUCCESS","slave2","SUCCESS",
                                "slave","SUCCESS"
								],
				["veribsync/benchmark/raytrace.ss",7,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/volrend.ss",20,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/water-nsquared.ss",11,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/water-spatial.ss",11,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/cholesky.ss",9,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/fft.ss",5,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
				...
				["veribsync/benchmark/lu.ss",5,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                # "f_r_1088_while_27_2","SUCCESS",
                                "lu","SUCCESS","OneSolve","SUCCESS",
                                "SlaveStart","SUCCESS","gets","SUCCESS",
                                "main","SUCCESS"
								],
				["veribsync/benchmark/radix.ss",3,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
                                # "f_r_989_while_39_2","SUCCESS",
                                "getNumProcs","SUCCESS","main","SUCCESS",
                                "slave_sort","SUCCESS"
								],
				["veribsync/benchmark/radiosity.ss",8,  "--en-para -perm bperm -tp redlog --en-thrd-resource",
