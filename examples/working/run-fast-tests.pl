...
%sleek_files=(
    "sleek"=>[["sleek.slk", "","", "Valid.Valid.Valid.Fail."],
                      ...
                      ["infer/infer7.slk", "", "", "Valid.Valid.Valid.Valid.Fail.Valid.Valid.Fail.Fail.Valid."],
                      ...
                      ["infer/infer10.slk", "", "", "Valid.Valid.Valid.Valid.Valid.Valid.Valid.Valid.Fail.Fail.Fail.Fail.Fail.Fail.Fail.Valid."],
                      ["infer/infer11.slk", "", "", "Fail."],
                      ["infer/infer12.slk", "", "", "Fail.Fail.Valid.Fail.Fail.Valid.Valid.Valid.Valid.Fail.Fail.Valid.Fail.Fail.Fail.Valid.Valid.Valid."],
