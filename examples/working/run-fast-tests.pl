...
# slow in threads/owicki-gries.ss due to search. Could modify search heuristics.
    ...
    "maps" => [
        ...
        ["test-map-4.ss", 26, " -tp z3", "foo", "FAIL", "foo1", "SUCCESS", "foo11", "SUCCESS", "foo2", "FAIL", "foo3", "SUCCESS", "foo4", "SUCCESS", "foo5", "FAIL", "foo6", "SUCCESS", "foo7", "SUCCESS", "foo8", "SUCCESS", "foo9", "SUCCESS", "foo10", "SUCCESS", "foo13", "SUCCESS", "foo14", "FAIL", "foo12", "FAIL", "foo16", "SUCCESS", "foo17", "FAIL", "foo18", "SUCCESS", "foo19", "SUCCESS", "foo20", "SUCCESS", "foo21", "FAIL", "foo22", "SUCCESS", "foo23", "SUCCESS", "foo24", "SUCCESS", "foo25", "SUCCESS", "foo26", "SUCCESS"]
        ],
    "session" => [
