...
if($prover){
	%provers = ('cvcl' => 'cvcl', 'cvc3' => 'cvc3', 'z3' => 'z3', 'omega' => 'omega', 
	...
	if (!exists($provers{$prover})){
		...
		print "\twhere name_of_prover should be one of the followings: 'cvcl', 'cvc3', 'z3', 'omega', 'co', 'isabelle', 'coq', 'mona', 'om', 'oi', 'set', 'cm', 'redlog', 'rm' or 'prm' \n";
		exit(0);
	}
}
else{
