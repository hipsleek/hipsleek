...
if($prover){
	%provers = ('cvcl' => 'cvcl', 'cvc3' => 'cvc3', 'oc' => 'oc','oc-2.1.6' => 'oc-2.1.6', 
		...
		'z3' => 'z3', 'z3-2.19' => 'z3-2.19', 'zm' => 'zm', 'spass' => 'spass');
	if (!exists($provers{$prover})){
		...
		print "\twhere name_of_prover should be one of the followings: 'cvcl', 'cvc3', 'omega', 'co', 'isabelle', 'coq', 'mona', 'om', 'oi', 'set', 'cm', 'redlog', 'rm', 'prm', 'z3', 'zm' or 'spass'\n";
		exit(0);
	}
}
else{
