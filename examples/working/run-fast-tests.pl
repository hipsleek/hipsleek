...
# slow in threads/owicki-gries.ss due to search. Could modify search heuristics.
    ...
    "maps" => [
        ...
        ["test-map-4.ss", 25, " -tp z3", "foo", "FAIL", "foo1", "SUCCESS", "foo11", "SUCCESS", "foo2", "FAIL", "foo3", "SUCCESS", "foo4", "SUCCESS", "foo5", "FAIL", "foo6", "SUCCESS", "foo7", "SUCCESS", "foo8", "SUCCESS", "foo9", "SUCCESS", "foo10", "SUCCESS", "foo13", "SUCCESS", "foo14", "FAIL", "foo16", "SUCCESS", "foo17", "FAIL", "foo18", "SUCCESS", "foo19", "SUCCESS", "foo20", "SUCCESS", "foo21", "FAIL", "foo22", "SUCCESS", "foo23", "SUCCESS", "foo24", "SUCCESS", "foo25", "SUCCESS", "foo26", "SUCCESS"],
        ["test-map-5-rec.ss", 1, "-tp z3", "foo1", "SUCCESS"]
        ],
    "session" => [
        ...
        ["ex12a-AB.ss", 1, " -tp z3 ", "B","SUCCESS"],
        ["ex12b-ABCD.ss", 4, " -tp z3 ", "B","SUCCESS","B_F1","FAIL","B_F2","FAIL","B_F3","FAIL"],
        ...
        ["ex4b-audio-cloud-SR-SR-par.ss", 13, " --sess --ann-vp ", "Server_helper","SUCCESS","Server_helper_seq1","SUCCESS","Server_helper_seq2","SUCCESS","Server_helper_seq3","SUCCESS","Server_helper_seq4","FAIL","Server_helper_seq_fail","FAIL","Server_helper_par1","SUCCESS","Server_helper_par2","SUCCESS","Server_helper_par3","SUCCESS","Server_seq1","SUCCESS","Server_seq2","SUCCESS","Server_par1","SUCCESS","Client","SUCCESS"],
    ],
    # "lemmas"=>[
...
%sleek_files=(
    "sleek"=>[["sleek.slk", "",(), "Valid.Valid.Valid.Fail."],
              ...
              ["session/ex3e-lbl-rel.slk", "--sess", (), "Valid.Valid.Fail.Valid.Fail.Valid.Valid.Valid.Fail."],
              ["session/ex5d-ent.slk", "--sess", (), "Valid.Fail.Fail.Valid.Valid.Valid.Fail.Fail.Valid.Valid.Fail.Valid.Valid.Fail.Valid.Valid"],
