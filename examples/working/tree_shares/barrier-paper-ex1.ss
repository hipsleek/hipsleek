...
requires x1::cl(@@R)<1>*x2::cl(@@R)<1>*y1::cl(@@R)<_>*y2::cl(@@R)<_>*i::cl(@@R)<1>*b::bn(@@R)<0,x1,x2,y1,y2,i> 
 ensures x1::cl(@@R)<v>*x2::cl(@@R)<v>*b::bn(@@R)<3,x1,x2,y1,y2,i>& v=2*q-1 & q>=30;
{                                 // stage 0
  Barrier b;                      // stage 0->1
...
requires x1::cl(@@R)<v>*x2::cl(@@R)<v>*y2::cl<_>*i::cl(@@R)<a>*b::bn(@@R)<1,x1,x2,y1,y2,i> & v=2*a -1
  ensures x1::cl(@@R)<v1>*x2::cl(@@R)<v1>*b::bn(@@R)<3,x1,x2,y1,y2,i>& v1=2*q-1 & q>=30;
{
  if (i.val<30)
  {                               // stage 1
...
requires x1::cl(@@L)<1>*x2::cl(@@L)<1>*y1::cl(@@L)<_>*y2::cl(@@L)<_>*i::cl(@@L)<1>*b::bn(@@L)<0,x1,x2,y1,y2,i> 
 ensures x1::cl(@@L)<v>*x2::cl(@@L)<v>*b::bn(@@L)<3,x1,x2,y1,y2,i>& v=2*q-1 & q>=30;
{                                 // stage 0
  Barrier b;                      // stage 0->1
...
requires x1::cl(@@L)<v>*x2::cl(@@L)<v>*y1::cl<_>*i::cl(@@L)<a>*b::bn(@@L)<1,x1,x2,y1,y2,i> & v=2*a -1
  ensures x1::cl(@@L)<v1>*x2::cl(@@L)<v1>*b::bn(@@L)<3,x1,x2,y1,y2,i>& v1=2*q-1 & q>=30;
{
  if (i.val<30)
  {                               // stage 1
