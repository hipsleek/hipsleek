...
Barrier bn[6]<int state, cl i> == [
 (0,1,[ requires i::cl(@@C)<T1>*self::bn(@@C)<0,i> ensures i::cl(@@C)<T1>*self::bn(@@C)<1,i> ;,
		...
		requires i::cl(@@W5)<T2>*self::bn(@@W5)<0,i> ensures i::cl(@@W5)<T2>*self::bn(@@W5)<1,i>;
		]),	
 (1,2,[ requires i::cl(@@C)<T> *self::bn(@@C)<1,i> & T<30  ensures i::cl<T>* self::bn(@@C)<2,i> & T<30 ;,
		...
		requires i::cl(@@W5)<T> *self::bn(@@W5)<1,i> & T<30  ensures 			self::bn(@@W5)<2,i>;
		]),
 (2,1,[ requires i::cl<T>*self::bn(@@C)<2,i>  		   ensures i::cl(@@C)<T>*self::bn(@@C)<1,i>;,
		...
		requires 	      self::bn(@@W5)<2,i>		   ensures i::cl(@@W5)<T>*self::bn(@@W5)<1,i>;
		]) ,
 (1,3,[ requires i::cl(@@C)<T> *self::bn(@@C)<1,i> & T>=30 ensures i::cl<T>*self::bn(@@C)<3,i>& T>=30;, 
		...
		requires i::cl(@@W5)<T> *self::bn(@@W5)<1,i> & T>=30 ensures self::bn(@@W5)<3,i>;
		])];
...
requires i::cl(@@W5)<_>*b::bn(@@W5)<0,i>  ensures b::bn(@@W5)<3,i>;
{                                 // stage 0
  Barrier b;                      // stage 0->1
  thl (i,b);
}
...
requires i::cl(@@W5)<_>*b::bn(@@W5)<1,i> ensures b::bn(@@W5)<3,i>;
{
  int x ;
  if (i.val<30)
  {                               // stage 1
