...
requires x::cl(@@W2)<_>*y::cl(@@W2)<_>*i::cl(@@W2)<_>*b::bn(@@W2)<0,x,y,i> ensures y::cl<_>*b::bn(@@W2)<3,x,y,i>;
{                                 // stage 0
  Barrier b;                      // stage 0->1
  thl2 (y,i,b);
}
...
requires y::cl(@@W12)<_>*i::cl(@@W2)<_>*b::bn(@@W2)<1,x,y,i> ensures y::cl<_>*b::bn(@@W2)<3,x,y,i>;
{
  int a;
  if (i.val<30)
  {                               // stage 1
