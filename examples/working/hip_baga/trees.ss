...
tree1<m> == self = null & m = 0
  ...
  /* inv m >= 0 */
  inv_exact BG([],self=null & m=0) | BG([self],m>0)
  /* inv_sat BG([],self=null & m=0) | BG([self],m>0) */
  ;
...
tree<m, n> == self = null & m = 0 & n = 0
  ...
  /* inv m >= 0 & n >= 0 */
  inv_exact BG([],self=null & m=0 & n=0) | BG([self],m>0 & n>0)
  /* inv_sat BG([],self=null & m=0 & n=0) | BG([self],m>0 & n>0) */
  ;
...
bst <sm, lg> == self = null & sm <= lg
  ...
  /* inv sm <= lg */
  inv_exact BG([],self=null & sm<=lg) | BG([self],sm<=lg)
  /* inv_sat BG([],self=null & sm<=lg) | BG([self],sm<=lg) */
  ;
