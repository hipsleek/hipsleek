...
graph<v,M> == self = null & M = {}
	or self::node<0,_@A,l@L,r@L> U* (l::graph<_,Ml> U* r::graph<_,Mr>) & M = union(Ml,Mr,{self}) & v = 0
	or self::node<1@I,_@A,l@L,r@L> U* (l::graph<1,Ml> U* r::graph<1,Mr>) & M = union(Ml,Mr,{self}) & v = 1
	inv true
