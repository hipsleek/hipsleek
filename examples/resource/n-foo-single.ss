...
void add_stk(int n)
  ...
  ensures stk::RS<m> * mx::RS_mark<m> * mn::RS_mark<m> & m=a+n;
...
void g() 
  requires stk::RS<n> 
  ensures  stk::RS<n> * mn::RS_mark<m> * mx::RS_mark<h> & m>=n+3 & h<=n+5 ;

void h() 
  requires stk::RS<n> 
  ensures  stk::RS<n> * mn::RS_mark<m> * mx::RS_mark<h> & m>=n+2 & h<=n+6;
