...
dll<p,n> == self = null & n = 0 
	...
	inv n >= 0;
rdll<q,n> == self = null & n = 0 
	or self::node2<_ ,p , q> * p::rdll<q1, n-1> & self = q1 
	inv n >= 0;
ptr<n,m> == self=null & n=0 & m=0
	or self::node2<_ ,p , q> * q::dll<self, n-1> * p::rdll<self,m>
	inv n >= 0 & m>=0;
...
void back(node2 x)
         requires x::rdll<q,n> & x!=null
         ensures x::rdll<q,n>;
         requires x::ptr<n,m> & x!=null
         ensures x::ptr<n,m> ;
 {          if (x.prev != null) {
                  //dprint;
                  back(x.prev);
