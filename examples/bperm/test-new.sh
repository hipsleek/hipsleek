...
#================SLEEK==========================
echo "======= bperm1.slk ======"
../../sleek --en-para -tp parahip -perm bperm bperm1.slk | grep Entail > test-cases/bperm1.n
echo "======= bperm-split.slk ======"
../../sleek --en-para -tp parahip -perm bperm bperm-split.slk | grep Entail > test-cases/bperm-split.n
echo "======= bperm-combine.slk ======"
../../sleek --en-para -tp parahip -perm bperm bperm-combine.slk | grep Entail > test-cases/bperm-combine.n
echo "======= bperm-split-combine.slk ======"
../../sleek --en-para -tp parahip -perm bperm bperm-split-combine.slk | grep Entail > test-cases/bperm-split-combine.n
echo "======= barrier1.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier1.slk | grep Entail > test-cases/barrier1.n
echo "======= barrier-split.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-split.slk | grep Entail > test-cases/barrier-split.n
echo "======= barrier-combine.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-combine.slk | grep Entail > test-cases/barrier-combine.n
echo "======= barrier-sep.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-sep.slk | grep Entail > test-cases/barrier-sep.n
echo "======= barrier-static.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-static.slk | grep Entail > test-cases/barrier-static.n
echo "======= barrier-dynamic.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-dynamic.slk | grep Entail > test-cases/barrier-dynamic.n
echo "======= barrier-dynamic2.slk ======"
../../sleek --en-para -tp parahip -perm bperm barrier-dynamic2.slk | grep Entail > test-cases/barrier-dynamic2.n
# #================HIP==========================
# #================HIP==========================
# echo "======= while-loop.ss ======"
...
# ../../hip barrier-dynamic-exp4.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp4.n
# echo "======= barrier-dynamic-exp5.ss (slow) ======"
# ../../hip barrier-dynamic-exp5.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp5.n
