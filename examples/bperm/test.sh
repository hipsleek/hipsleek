...
../../sleek barrier-dynamic2.slk | grep Entail > test-cases/barrier-dynamic2.res
#================HIP==========================
#================HIP==========================
echo "======= while-loop.ss ======"
...
../../hip barrier-static-consistency.ss | grep -E 'Proc|assert:' > test-cases/barrier-static-consistency.res
...
../../hip barrier-dynamic-exp4.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp4.res
echo "======= barrier-dynamic-exp5.ss (slow) ======"
../../hip barrier-dynamic-exp5.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp5.res
echo "======= barrier-dynamic-exp6.ss ======"
../../hip barrier-dynamic-exp6.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp6.res
echo "======= barrier-dynamic-exp7.ss ======"
../../hip barrier-dynamic-exp7.ss | grep -E 'Proc|assert:' > test-cases/barrier-dynamic-exp7.res
#================BENCHMARK==========================
#================BENCHMARK==========================
...
../../hip benchmark/our-splash2/code/kernels/radix/radix.ss | grep -E 'Proc|assert:' > test-cases/splash2/radix.res
echo "======= splash2/code/apps/radiosity/ ======"
#NOT YET VERIFIABLE
../../hip benchmark/our-splash2/code/apps/radiosity/radiosity.ss | grep -E 'Proc|assert:' > test-cases/splash2/radiosity.res
