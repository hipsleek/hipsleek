...
rb1<cl, "b":bh, "s":S> == 
	self = null & cl = 0 & ["b":bh = 1; "s":S={}] or
	self::node<v, 1, l, r> * l::rb1<0, bhl, S1> * r::rb1<0, bhr, S2> & cl = 1 & ["b":bhl = bh & bhr = bh; "s":S = union(S1, S2, {v})] or
	self::node<v, 0, l, r> * l::rb1<_, bhl, S1> * r::rb1<_, bhr, S2> & cl = 0 & ["b":bhl = bhr & bh = 1 + bhl; "s":S = union(S1, S2, {v})]
	inv 0 <= cl <= 1 & ["b":bh >= 1];
...
node rotate_case_3_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<1, bha, S1> * b::rb1<0, bhb, S2> * c::rb1<0, bhc, S3> & ["b":bha=bhb & bha=bhc]
	ensures res::rb1<0, bhr, S4> & ["b":bhr=bha+1; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
node case_2_1(node a, node b, node c, node d, int v1, int v2, int v3)
	...
	requires a::rb1<0, bha, S1> * b::rb1<0, bhb, S2> * c::rb1<0, bhc, S3> * d::rb1<0, bhd, S4> & ["b":bha=bhb & bha=bhc & bha=bhd]
	ensures res::rb1<0, bhr, S5> & ["b":bhr=bha+1; "s":S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3})];
...
node rotate_case_3r_1(node a, node b, node c, int v1, int v2)
	...
	//ensures res::rb1<0, bha + 1, S4> & S4 = union(S1, S2, S3, {v1}, {v2});
	requires a::rb1<0, bha, S1> * b::rb1<0, bhb, S2> * c::rb1<1, bhc, S3> & ["b":bha=bhb & bha=bhc]
	ensures res::rb1<0, bhr, S4> & ["b":bhr=bha+1; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
node del_6_1(node a, node b, node c, int color, int v1, int v2)
	...
	requires a::rb1<0, ha, S1> * b::rb1<_, hb, S2> * c::rb1<1, hc, S3> & color = 0 & ["b":ha=hb & ha=hc] or 
		 a::rb1<0, ha, S1> * b::rb1<_, hb, S2> * c::rb1<1, hc, S3> & color = 1 & ["b":ha=hb & ha=hc]
	ensures res::rb1<0, hr, S4> & color = 0 & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {v1}, {v2})] or 
		res::rb1<1, hr, S5> & color = 1 & ["b":hr=ha+1; "s":S5 = union(S1, S2, S3, {v1}, {v2})];
...
node del_6r_1(node a, node b, node c, int color, int v1, int v2)
	...
	requires a::rb1<1, ha, S1> * b::rb1<_, hb, S2> * c::rb1<0, hc, S3> & color = 0 & ["b":ha=hb & ha=hc] or 
		 a::rb1<1, ha, S1> * b::rb1<_, hb, S2> * c::rb1<0, hc, S3> & color = 1 & ["b":ha=hb & ha=hc]
	ensures res::rb1<0, hr, S4> & color = 0 & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {v1}, {v2})] or 
		res::rb1<1, hr, S4> & color = 1 & ["b":hr=ha+1; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
node del_5_1(node a, node b, node c, node d, int color, int v1, int v2, int v3)
	...
	requires a::rb1<0, ha, S1> * b::rb1<0, hb, S2> * c::rb1<0, hc, S3> * d::rb1<0, hd, S4> & color = 0 & ["b":ha=hb & ha=hc & ha=hd] or 
		 a::rb1<0, ha, S1> * b::rb1<0, hb, S2> * c::rb1<0, hc, S3> * d::rb1<0, hd, S4> & color = 1 & ["b":ha=hb & ha=hc & ha=hd]
	ensures res::rb1<0, hr, S5> & color = 0 & ["b":hr=ha+2; "s":S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3})] or 
		res::rb1<1, hr, S5> & color = 1 & ["b":hr=ha+1; "s":S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3})];
...
node del_4_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<0, ha, S1> * b::rb1<0, hb, S2> * c::rb1<0, hc, S3> & ["b":ha=hb & ha=hc] 
	ensures res::rb1<0, hr, S4> & ["b":hr=ha+1; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
node del_2_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<0, ha, S1> * b::rb1<0, hb, S2> * c::rb1<0, hc, S3> & b != null & c != null & ["b":hb=ha+1 & hc=ha+1]
	ensures res::rb1<0, hr, S4> & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
node del_2r_1(node a, node b, node c, int v1, int v2)
	...
	//ensures res::rb1<0, h+2, S4> & S4 = union(S1, S2, S3, {v1}, {v2});
	requires a::rb1<0, ha, S1> * b::rb1<0, hb, S2> * c::rb1<0, hc, S3> & b != null & ["b":ha=hc+1 & hb=hc+1]//& a != null
	ensures res::rb1<0, hr, S4> & ["b":hr=hc+2; "s":S4 = union(S1, S2, S3, {v1}, {v2})];
...
int remove_min_1(ref node x)
	...
	requires x::rb1<cl, bh, S1> & x != null & 0 <= cl <= 1
	ensures x'::rb1<cl2, bh, S2> & cl = 1 & 0 <= cl2 <= 1 & ["s":S1 = union(S2, {res})] or
		x'::rb1<0, bh2, S3> & cl = 0 & ["b":bh-1 <= bh2 <= bh; "s":S1 = union(S3, {res})];
...
void del_1(ref node  x, int a)
	...
	//or x'::rb1<cl, bh, S1>;
	requires x::rb1<cl, bh, S1> & 0 <= cl <= 1
	ensures  x'::rb1<cl2, bh, S2> & cl = 1 & 0 <= cl2 <= 1 & ["s":S1 = union(S2, {a})] or
		 x'::rb1<0, bh2, S2> & cl = 0 & ["b":bh-1 <= bh2 <= h; "s":S1 = union(S2, {a})] or 
		 x'::rb1<cl, bh, S1>;
...
node insert_1(node x, int v)
	...
	requires x::rb1<_, bh, S>
	ensures res::rb1< _, bh1, S1> & res != null & ["b":bh <= bh1 <= bh; "s":S1 = union(S, {v})];
