...
rb1<cl, bh, S, n> == 
	self = null & bh = 1 & cl = 0 & S={} & n=0 or
	self::node<v, 1, l, r> * l::rb1<0, bhl, S1, n1> * r::rb1<0, bhr, S2, n2> & cl = 1 & bhl = bh & bhr = bh & S = union(S1, S2, {v}) & forall (x : (x notin S1 | x <= v)) & forall (y : (y notin S2 | y >= v)) & n=n1+n2+1
	or self::node<v, 0, l, r> * l::rb1<_, bhl, S1, n1> * r::rb1<_, bhr, S2, n2> & cl = 0 & bhl = bhr & bh = 1 + bhl & S = union(S1, S2, {v}) & forall (x1 : (x1 notin S1 | x1 <= v)) & forall (y1 : (y1 notin S2 | y1 >= v)) & n=n1+n2+1
	inv bh >= 1 & 0 <= cl <= 1 & n>=0;

/* rotation case 3 */
node rotate_case_3_1(node a, node b, node c, int v1, int v2)

	requires a::rb1<1, bha, S1, n1> * b::rb1<0, bha, S2, n2> * c::rb1<0, bha, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2
	ensures res::rb1<0, bha + 1, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2;
...
node case_2_1(node a, node b, node c, node d, int v1, int v2, int v3)
	requires a::rb1<0, bha, S1, n1> * b::rb1<0, bha, S2, n2> * c::rb1<0, bha, S3, n3> * d::rb1<0, bha, S4, n4> & forall (x1 : (x1 notin S1 | x1 <= v1)) & forall (x2 : (x2 notin S2 | x2 >= v1)) & forall (x3 : (x3 notin S2 | x3 <= v2)) & forall (x4 : (x4 notin S3 | x4 >= v2)) & forall (x5 : (x5 notin S3 | x5 <= v3)) & forall (x6 : (x6 notin S4 | x6 >= v3)) & v1<=v2 & v2<=v3
	ensures res::rb1<0, bha + 1, S5, n5> & S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3}) & n5=n1+n2+n3+n4+3;
...
node rotate_case_3r_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<0, bha, S1, n1> * b::rb1<0, bha, S2, n2> * c::rb1<1, bha, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2
	ensures res::rb1<0, bha + 1, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2;
...
*/
	requires a::rb1<0, h, S1, n1> * b::rb1<_, h, S2, n2> * c::rb1<1, h, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2 & color = 0 or 
		 a::rb1<0, h, S1, n1> * b::rb1<_, h, S2, n2> * c::rb1<1, h, S3, n3> & forall (x1 : (x1 notin S1 | x1 <= v1)) & forall (y1 : (y1 notin S2 | y1 >= v1)) & forall (z1 : (z1 notin S2 | z1 <= v2)) & forall (w1 : (w1 notin S3 | w1 >= v2)) & v1<=v2 & color = 1  
	ensures res::rb1<0, h + 2, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2 & color = 0 or 
		res::rb1<1, h + 1, S5, n4> & S5 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2 & color = 1;
{
	node tmp; 
...
node del_6r_1(node a, node b, node c, int color, int v1, int v2)
	...
	requires a::rb1<1, ha, S1, n1> * b::rb1<_, ha, S2, n2> * c::rb1<0, ha, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2 & color = 0 or 
		 a::rb1<1, ha, S1, n1> * b::rb1<_, ha, S2, n2> * c::rb1<0, ha, S3, n3> & forall (x1 : (x1 notin S1 | x1 <= v1)) & forall (y1 : (y1 notin S2 | y1 >= v1)) & forall (z1 : (z1 notin S2 | z1 <= v2)) & forall (w1 : (w1 notin S3 | w1 >= v2)) & v1<=v2 & color = 1 
	ensures res::rb1<0, ha + 2, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2 & color = 0 or 
		res::rb1<1, ha + 1, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2 & color = 1;
...
node del_5_1(node a, node b, node c, node d, int color, int v1, int v2, int v3)
	...
	requires a::rb1<0, h, S1, n1> * b::rb1<0, h, S2, n2> * c::rb1<0, h, S3, n3> * d::rb1<0, h, S4, n4> & forall (x1 : (x1 notin S1 | x1 <= v1)) & forall (x2 : (x2 notin S2 | x2 >= v1)) & forall (x3 : (x3 notin S2 | x3 <= v2)) & forall (x4 : (x4 notin S3 | x4 >= v2)) & forall (x5 : (x5 notin S3 | x5 <= v3)) & forall (x6 : (x6 notin S4 | x6 >= v3)) & v1<=v2 & v2<=v3 & color = 0 or 
		 a::rb1<0, h, S1, n1> * b::rb1<0, h, S2, n2> * c::rb1<0, h, S3, n3> * d::rb1<0, h, S4, n4> & forall (x11 : (x11 notin S1 | x11 <= v1)) & forall (x21 : (x21 notin S2 | x21 >= v1)) & forall (x31 : (x31 notin S2 | x31 <= v2)) & forall (x41 : (x41 notin S3 | x41 >= v2)) & forall (x51 : (x51 notin S3 | x51 <= v3)) & forall (x61 : (x61 notin S4 | x61 >= v3)) & v1<=v2 & v2<=v3 & color = 1 
	ensures res::rb1<0, h + 2, S5, n5> & S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3}) & n5=n1+n2+n3+n4+3 & color = 0 or 
		res::rb1<1, h + 1, S5, n5> & S5 = union(S1, S2, S3, S4, {v1}, {v2}, {v3}) & n5=n1+n2+n3+n4+3 & color = 1;
...
node del_4_1(node a, node b, node c, int v1, int v2)
	requires a::rb1<0, ha, S1, n1> * b::rb1<0, ha, S2, n2> * c::rb1<0, ha, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2  
	ensures res::rb1<0, ha + 1, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2;
...
node del_2_1(node a, node b, node c, int v1, int v2)
	requires a::rb1<0, h, S1, n1> * b::rb1<0, h+1, S2, n2> * c::rb1<0, h+1, S3, n3> & forall (x : (x notin S1 | x <= v1)) & forall (y : (y notin S2 | y >= v1)) & forall (z : (z notin S2 | z <= v2)) & forall (w : (w notin S3 | w >= v2)) & v1<=v2 & b != null & c != null
	ensures res::rb1<0, h + 2, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2;
...
node del_2r_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<0, h+1, S1, n1> * b::rb1<0, h+1, S2, n2> * c::rb1<0, h, S3, n3> //& b != null //& a != null
	ensures res::rb1<0, h+2, S4, n4> & S4 = union(S1, S2, S3, {v1}, {v2}) & n4=n1+n2+n3+2;
...
int remove_min_1(ref node x)
	...
	requires x::rb1<cl, bh, S1, n1> & x != null & 0 <= cl <= 1
	ensures x'::rb1<cl2, bh, S2, n2> & S1 = union(S2, {res}) & forall (xx : (xx notin S2 | xx >= res)) & cl = 1 & 0 <= cl2 <= 1 & n1=n2+1
		or x'::rb1<0, bh2, S3, n3> & S1 = union(S3, {res}) & forall (xx1 : (xx1 notin S2 | xx1 >= res)) & bh-1 <= bh2 <= bh & cl = 0 & n1=n3+1;
...
void del_1(ref node  x, int a)
	requires x::rb1<cl, bh, S1, n1> & 0 <= cl <= 1
	ensures  
		x'::rb1<cl2, bh, S2, n2> & S1 = union(S2, {a}) & S2 subset S & forall (xx : (xx notin S1 | xx = a | xx in S2)) & n1=n2+1 & cl = 1 & 0 <= cl2 <= 1 or
	x'::rb1<0, bh2, S2, n2> & S1 = union(S2, {a}) & S2 subset S & forall (xx1 : (xx1 notin S1 | xx1 = a | xx1 in S2)) & n1=n2+1 & bh-1 <= bh2 <= h & cl = 0 
	or x'::rb1<cl, bh, S1, n1>;
