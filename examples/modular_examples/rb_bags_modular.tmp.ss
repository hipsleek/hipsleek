...
node rotate_case_3_1(node a, node b, node c)
	...
	ensures res::rb1<0, bhr, S4> & ["b":bhr=bha+1; "s":S4 = union(S1, S2, S3, {0}, {0})];
...
node case_2_1(node a, node b, node c, node d)
	...
	ensures res::rb1<0, bhr, S5> & ["b":bhr=bha+1; "s":S5 = union(S1, S2, S3, S4, {0}, {0}, {0})];
...
bool is_red_1(node x)
	...
	ensures x::rb1<cl, bh, S> & cl = 1 & res or
		x::rb1<cl, bh, S> & cl = 0 & !res;
...
node del_6_1(node a, node b, node c, int color)
	...
	ensures res::rb1<0, hr, S4> & color = 0 & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {0}, {0})] or 
		res::rb1<1, hr, S5> & color = 1 & ["b":hr=ha+1; "s":S5 = union(S1, S2, S3, {0}, {0})];
...
node del_6r_1(node a, node b, node c, int color)
	...
	ensures res::rb1<0, hr, S4> & color = 0 & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {0}, {0})] or 
		res::rb1<1, hr, S4> & color = 1 & ["b":hr=ha+1; "s":S4 = union(S1, S2, S3, {0}, {0})];
...
node del_5_1(node a, node b, node c, node d, int color)
	...
	ensures res::rb1<0, hr, S5> & color = 0 & ["b":hr=ha+2; "s":S5 = union(S1, S2, S3, S4, {0}, {0}, {0})] or 
		res::rb1<1, hr, S5> & color = 1 & ["b":hr=ha+1; "s":S5 = union(S1, S2, S3, S4, {0}, {0}, {0})];
...
node del_4_1(node a, node b, node c)
	...
	ensures res::rb1<0, hr, S4> & ["b":hr=ha+1; "s":S4 = union(S1, S2, S3, {0}, {0})];
...
node del_2_1(node a, node b, node c)
	...
	ensures res::rb1<0, hr, S4> & ["b":hr=ha+2; "s":S4 = union(S1, S2, S3, {0}, {0})];
...
node del_2r_1(node a, node b, node c)
	...
	ensures res::rb1<0, hr, S4> & ["b":hr=hc+2; "s":S4 = union(S1, S2, S3, {0}, {0})];
