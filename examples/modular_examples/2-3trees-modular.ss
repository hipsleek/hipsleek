...
tree2_3<"n":n> == 	
	self = null & ["n":n = 0] or 
	self::node3<_, _, l, m, r> * l::tree2_3<ln> * m::tree2_3<mn> * r::tree2_3<rn> & r != null & ["n":ln = mn & ln = rn & n = ln + 1] or
	self::node3<_, _, l, m, r> * l::tree2_3<ln> * m::tree2_3<mn> & r = null & ["n":ln = mn & n = ln + 1]
	inv true & ["n":n >= 0];
