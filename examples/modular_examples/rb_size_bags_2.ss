...
/*
rb1<cl, bh, n, S> == 
	self = null & n = 0 & bh = 1 & cl = 0 & S={} or
	self::node<v, 1, l, r> * l::rb1<0, bhl, n1> * r::rb1<0, bhr, n2> & cl = 1 & bhl = bh & bhr = bh & n=n1+n2+1 & S=union(S1, S2, {v}) or
	self::node<v, 0, l, r> * l::rb1<_, bhl, S1> * r::rb1<_, bhr, S2> & cl = 0 & bhl = bhr & bh = 1 + bhl & n=n1+n2+1 & S=union(S1, S2, {v})
	inv bh >= 1 & 0 <= cl <= 1 & n >= 0;
*/
...
node rotate_case_3_1(node a, node b, node c, int v1, int v2)
	...
	requires a::rb1<1, bha, n1, S1> * b::rb1<0, bha, n2, S2> * c::rb1<0, bha, n3, S3>
...
node del_6_1(node a, node b, node c, int color, int v1, int v2)
	...
	requires a::rb1<0, h, n1, S1> * b::rb1<_, h, n2, S2> * c::rb1<1, h, n3, S3> & color = 0 or 
		 a::rb1<0, h, n1, S1> * b::rb1<_, h, n2, S2> * c::rb1<1, h, n3, S3> & color = 1
	ensures res::rb1<0, h + 2, n, S> & n=n1+n2+n3+2 & S = union(S1, S2, S3, {v1, v2}) & color = 0 or 
		res::rb1<1, h + 1, n, S> & n=n1+n2+n3+2 & S = union(S1, S2, S3, {v1, v2}) & color = 1;
{
	node tmp; 
...
node del_2_1(node a, node b, node c, int v1, int v2)
	requires a::rb1<0, h, n1, S1> * b::rb1<0, h+1, n2, S2> * c::rb1<0, h+1, n3, S3> & b != null & c != null
