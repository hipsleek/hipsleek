...
cexp_w:
  ...
  | "gen" 
    ...
    | `NONZERO; `OPAREN; c=SELF; `CPAREN -> apply_cexp_form1 (fun c ->  P.NonZero (c, get_pos_camlp4 _loc 1)) c
    | `ENDZERO; `OPAREN; c=SELF; `CPAREN -> apply_cexp_form1 (fun c ->  P.EndZero (c, get_pos_camlp4 _loc 1)) c
