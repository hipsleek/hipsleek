...
field_list2:[[ 
  ...
  | t = typ; `IDENTIFIER n ; anns=field_anns -> [((t,n),get_pos_camlp4 _loc 1,false, anns)]
  ...
  |  t=typ; `IDENTIFIER n; anns=field_anns ; peek_try; `SEMICOLON; fl = SELF ->(  
	  if List.mem n (List.map get_field_name fl) then
		report_error (get_pos_camlp4 _loc 4) (n ^ " is duplicated")
	  else
		((t, n), get_pos_camlp4 _loc 3, false,anns) :: fl )
  ...
  | [`MINUS; c=SELF               -> apply_cexp_form1 (fun c-> P.mkSubtract (P.IConst (0, get_pos_camlp4 _loc 1)) c (get_pos_camlp4 _loc 1)) c]
   ...
   | "una"
     ...
     (* | *) `NULL                                     -> Pure_c (P.Null (get_pos_camlp4 _loc 1))
      ...
      | `MAX; `OPAREN; c1=SELF; `CPAREN 
        -> apply_cexp_form2 (fun c1 c2-> P.mkMax c1 c2 (get_pos_camlp4 _loc 1)) c1 c1
      | `MAX; `OPAREN; c1=SELF; `COMMA; c2=SELF; `CPAREN 
        -> apply_cexp_form2 (fun c1 c2-> P.mkMax c1 c2 (get_pos_camlp4 _loc 1)) c1 c2
      | `MIN; `OPAREN; c1=SELF; `CPAREN 
        -> apply_cexp_form2 (fun c1 c2-> P.mkMin c1 c2 (get_pos_camlp4 _loc 1)) c1 c1
