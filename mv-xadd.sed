s/= Solver.heap_entail_init/= x_add Solver.heap_entail_init/
s/= Cvutil.xpure_heap_symbolic/= x_add Cvutil.xpure_heap_symbolic/
s/(Cvutil.xpure_heap/(x_add Cvutil.xpure_heap/
s/(xpure_heap/(x_add xpure_heap/
s/= xpure_heap/= x_add xpure_heap/
s/= xpure /= x_add xpure /
# rename_exp defined in both iastUtil.ml and astsimpl.ml
