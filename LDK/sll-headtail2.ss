...
//  requires x::sll_tail<n, t, sm, lg>
  ...
  case {
  /* r=null -> ensures x::sll_tail<_, _, _, _> & res=x; */
  /* r!=null -> ensures true; */
  r=null -> ensures res=x;
  r!=null -> ensures true; //res::sll_tail<_, _, _, _>;//r::sll_tail<n, t, sm1, lg1>
  /* case */
  /*   { */
  /*     v<sm -> ensures res=x; */
  /*     v=sm -> ensures res=r; */
  /*     v>sm -> ensures r::sll_tail<_,_,_,_>; */
  /*       //    case{ */
  /*       //n=0 -> ; */
  /*       //n>0 -> ensures res::sll_tail<_, _, _, _>;// & n-1 <= n1 <= n; */
  /*       //n<0 -> false; */
  /*       //} */
  /*   } */
   //ensures res::sll_tail<_, _, _, _> ; // & n-1 <= n1 <= n;
  //n<0 -> ensures false;

  /*  n=1 -> requires x::node<sm, r> * r::sll_tail<n-1, t, _, _> & r!=null  & sm=lg
      case{
      v<sm -> ensures res=x;
      v=sm -> ensures res=r;
      v>sm -> ensures res=r;
      }
      n>1 -> requires x::node<sm, r> * r::sll_tail<n-1, t, sm1, lg> & r!=null & sm<=sm1
      case{
      v<sm -> ensures res=x;
      v=sm -> ensures res=r;
      v>sm -> ensures false;
