...
ell<n> == self = null & n = 0 
	or self::node<_, q1> * q1::node<_, q2> * q2::ell<n-2> 
...
void append2(node x, node y)
  requires x::ell<n1> * y::ell<n2> & x!=null & n1=5 // & n1>0 //x!=null // & n1>0 & x != null
  ensures x::ell<n1+n2>;
{    
	if (x.next == null) 
           x.next = y;
...
void append(node x, node y)
  requires x::ell<n1> * y::ell<n2> & n1=5 // & x!=null // & n1>0 & x != null
  ensures x::ell<n1+n2>;
{
	if (x.next == null)
	  x.next = y;
...
node get_next(node x)
	...
	requires x::ell<n> & n =5
	ensures x::ell<1> * res::ell<n-1>; 
