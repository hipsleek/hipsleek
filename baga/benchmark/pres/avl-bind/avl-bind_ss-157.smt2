...
(assert (<= 0 n_3048))
(assert (exists ((max_3093 Int)) (and (= n_3048 (+ 1 max_3093)) (or (and (= max_3093 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3093 n2_3057) (< n1_3054 n2_3057))))))
