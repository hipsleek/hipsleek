...
(assert (= ln_3187 ln))
(assert (exists ((max_3241 Int)) (and (= n1_3214 (+ 1 max_3241)) (or (and (= max_3241 n1_3227) (>= n1_3227 n2_3230)) (and (= max_3241 n2_3230) (< n1_3227 n2_3230))))))
...
(assert (not (or (and (= n1_3214 (+ n1_3227 1)) (<= n2_3230 n1_3227)) (and (= n1_3214 (+ n2_3230 1)) (< n1_3227 n2_3230)))))
(check-sat)