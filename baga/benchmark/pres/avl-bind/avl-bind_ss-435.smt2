...
(assert (exists ((max_3749 Int)) (and (= n (+ 1 max_3749)) (or (and (= max_3749 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3749 n2_3374) (< n1_3371 n2_3374))))))
(assert (<= 0 n_3651))
(assert (<= 0 n_3717))
(assert (<= 0 n1_3703))
...
(assert (exists ((max_3750 Int)) (and (= n_3641 (+ 1 max_3750)) (or (and (= max_3750 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3750 n2_3706) (< n1_3703 n2_3706))))))
