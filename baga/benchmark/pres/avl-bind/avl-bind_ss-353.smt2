...
(assert (exists ((max_3720 Int)) (and (= n (+ 1 max_3720)) (or (and (= max_3720 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3720 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3721 Int)) (and (= n_3641 (+ 1 max_3721)) (or (and (= max_3721 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3721 n2_3706) (< n1_3703 n2_3706))))))
(assert (= xrightleft_primed p_3701))
(assert (or (and (and (< p_3701 1) (= m1_3702 0)) (= n1_3703 0)) (and (and (<= 1 n1_3703) (<= 1 m1_3702)) (> p_3701 0))))
;Negation of Consequence
(assert (not (or (= m1_3702 0) (or (= n1_3703 0) (< p_3701 1)))))
(check-sat)