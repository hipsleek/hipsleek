...
(declare-fun n1_3560 () Int)
(declare-fun m1_3559 () Int)
(declare-fun p_3558 () Int)
(declare-fun n2_3563 () Int)
(declare-fun m2_3562 () Int)
(declare-fun q_3561 () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= m_3515 (+ (+ m2_3562 1) m1_3559)))
(assert (<= (+ 0 n2_3563) (+ n1_3560 1)))
(assert (<= n1_3560 (+ 1 n2_3563)))
(assert (exists ((max_32 Int)) (and (= n_3516 (+ 1 max_32)) (or (and (= max_32 n1_3560) (>= n1_3560 n2_3563)) (and (= max_32 n2_3563) (< n1_3560 n2_3563))))))
(assert (= n_3556 n_3516))
...
(assert (or (and (and (< p_3558 1) (= m1_3559 0)) (= n1_3560 0)) (and (and (<= 1 n1_3560) (<= 1 m1_3559)) (> p_3558 0))))
(assert (or (and (and (< q_3561 1) (= m2_3562 0)) (= n2_3563 0)) (and (and (<= 1 n2_3563) (<= 1 m2_3562)) (> q_3561 0))))
