...
(declare-fun n_3776 () Int)
(declare-fun m_3775 () Int)
...
(assert (<= 0 n_3708))
(assert (= res n_3770))
(assert (= m_3775 m_3769))
(assert (= n_3776 n_3770))
(assert (<= 0 m_3769))
(assert (<= 0 n_3770))
...
(assert (or (and (and (< xrightright_primed 1) (= m_3775 0)) (= n_3776 0)) (and (and (<= 1 n_3776) (<= 1 m_3775)) (> xrightright_primed 0))))
