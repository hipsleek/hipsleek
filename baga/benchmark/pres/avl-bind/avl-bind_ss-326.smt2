...
(declare-fun n_3475 () Int)
(declare-fun m_3474 () Int)
...
(assert (<= 0 n2_3458))
(assert (= res n_3469))
(assert (= m_3474 m_3468))
(assert (= n_3475 n_3469))
(assert (<= 0 m_3468))
(assert (<= 0 n_3469))
...
(assert (or (and (and (< xleftright_primed 1) (= m_3474 0)) (= n_3475 0)) (and (and (<= 1 n_3475) (<= 1 m_3474)) (> xleftright_primed 0))))
