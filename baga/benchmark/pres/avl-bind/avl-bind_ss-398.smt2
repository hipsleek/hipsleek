...
(declare-fun right_208_1685_primed () Int)
(declare-fun left_208_1684_primed () Int)
(declare-fun height_208_1683_primed () Int)
(declare-fun val_208_1682_primed () Int)
(declare-fun Anon_3822 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_208_1685_primed q_3826))
(assert (= left_208_1684_primed p_3823))
(assert (= height_208_1683_primed n_3821))
(assert (= val_208_1682_primed Anon_3822))
(assert (<= 0 n_3770))
(assert (<= 0 m_3769))
(assert (<= 0 n_3708))
(assert (<= 0 m_3707))
