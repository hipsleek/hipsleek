...
(declare-fun v_int_178_1418_primed () Int)
...
(assert (exists ((max_3472 Int)) (and (= n (+ 1 max_3472)) (or (and (= max_3472 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3472 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (<= 0 n_3460))
(assert (<= 0 m_3459))
(assert (= v_int_178_1418_primed n_3460))
(assert (<= 0 n1_3455))
(assert (<= 0 m1_3454))
...
(assert (exists ((max_3473 Int)) (and (= n_3393 (+ 1 max_3473)) (or (and (= max_3473 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3473 n2_3458) (< n1_3455 n2_3458))))))
(assert (= xleftright_primed q_3456))
(assert (or (and (and (< q_3456 1) (= m2_3457 0)) (= n2_3458 0)) (and (and (<= 1 n2_3458) (<= 1 m2_3457)) (> q_3456 0))))
;Negation of Consequence
(assert (not (or (= m2_3457 0) (or (= n2_3458 0) (< q_3456 1)))))
(check-sat)