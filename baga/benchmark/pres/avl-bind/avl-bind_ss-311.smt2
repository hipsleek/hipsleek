...
(declare-fun res () Int)
(declare-fun v_int_175_1380_primed () Int)
(declare-fun v_int_175_1379_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_175_1379_primed 2))
(assert (= (+ v_int_175_1380_primed n_3403) n_3393))
(assert (<= 0 n_3403))
(assert (<= 0 m_3402))
(assert (<= 0 n2_3374))
(assert (<= 0 m2_3373))
...
(assert (not (> res 0)))
(assert (not (= v_int_175_1380_primed v_int_175_1379_primed)))
