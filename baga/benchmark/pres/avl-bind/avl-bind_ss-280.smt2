...
(assert (exists ((max_3501 Int)) (and (= n (+ 1 max_3501)) (or (and (= max_3501 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3501 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3502 Int)) (and (= n_3393 (+ 1 max_3502)) (or (and (= max_3502 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3502 n2_3458) (< n1_3455 n2_3458))))))
