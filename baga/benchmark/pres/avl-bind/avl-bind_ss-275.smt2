...
(assert (<= 0 n))
(assert (exists ((max_3323 Int)) (and (= n2_3295 (+ 1 max_3323)) (or (and (= max_3323 n1_3305) (>= n1_3305 n2_3308)) (and (= max_3323 n2_3308) (< n1_3305 n2_3308))))))
...
(assert (exists ((max_3324 Int)) (and (= h_3286 (+ 1 max_3324)) (or (and (= max_3324 n1_3292) (>= n1_3292 n2_3295)) (and (= max_3324 n2_3295) (< n1_3292 n2_3295))))))
(assert (= n1_3292 lln))
