...
(assert (exists ((max_3097 Int)) (and (= n_3048 (+ 1 max_3097)) (or (and (= max_3097 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3097 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (<= 0 cn))
(assert (= n_3022 cn))
(assert (exists ((max_3098 Int)) (and (= n_3071 (+ 1 max_3098)) (or (and (= max_3098 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3098 n2_3080) (< n1_3077 n2_3080))))))
...
(assert (not (or (and (= n_3071 (+ n1_3077 1)) (<= n2_3080 n1_3077)) (and (= n_3071 (+ n2_3080 1)) (< n1_3077 n2_3080)))))
(check-sat)