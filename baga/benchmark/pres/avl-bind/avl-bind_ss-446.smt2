...
(assert (exists ((max_3773 Int)) (and (= n (+ 1 max_3773)) (or (and (= max_3773 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3773 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3774 Int)) (and (= n_3641 (+ 1 max_3774)) (or (and (= max_3774 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3774 n2_3706) (< n1_3703 n2_3706))))))
