...
(declare-fun right_185_1487_primed () Int)
(declare-fun left_185_1486_primed () Int)
(declare-fun height_185_1485_primed () Int)
(declare-fun val_185_1484_primed () Int)
(declare-fun Anon_3566 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_185_1487_primed q_3570))
(assert (= left_185_1486_primed p_3567))
(assert (= height_185_1485_primed n_3565))
(assert (= val_185_1484_primed Anon_3566))
