...
(declare-fun n_3648 () Int)
(declare-fun m_3647 () Int)
...
(assert (<= 0 Anon_3645))
(assert (= res n_3641))
(assert (= m_3647 m_3640))
(assert (= n_3648 n_3641))
(assert (<= 0 m_3640))
(assert (<= 0 n_3641))
(assert (or (and (and (< p_3369 1) (= m1_3370 0)) (= n1_3371 0)) (and (and (<= 1 n1_3371) (<= 1 m1_3370)) (> p_3369 0))))
(assert (or (and (and (< xright_primed 1) (= m_3647 0)) (= n_3648 0)) (and (and (<= 1 n_3648) (<= 1 m_3647)) (> xright_primed 0))))
