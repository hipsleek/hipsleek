...
(assert (<= 0 n2_2494))
(assert (<= 0 nx_2495))
(assert (exists ((max_2575 Int)) (and (= n1_2512 (+ 1 max_2575)) (or (and (= max_2575 n1_2528) (>= n1_2528 n2_2531)) (and (= max_2575 n2_2531) (< n1_2528 n2_2531))))))
...
(assert (exists ((max_2577 Int)) (and (= tmp_2506 (+ 1 max_2577)) (or (and (= max_2577 n1_2512) (>= n1_2512 n2_2515)) (and (= max_2577 n2_2515) (< n1_2512 n2_2515))))))
(assert (= tmp_2506 (+ 1 tmp_2503)))
(assert (exists ((max_2576 Int)) (and (= nx (+ 1 max_2576)) (or (and (= max_2576 n1_2491) (>= n1_2491 n2_2494)) (and (= max_2576 n2_2494) (< n1_2491 n2_2494))))))
(assert (= n_2487 nx))
(assert (= nx_2495 nx))
;Negation of Consequence
(assert (not (= tmp_2506 (+ 1 nx))))
(check-sat)