...
(declare-fun n1_3816 () Int)
(declare-fun m1_3815 () Int)
(declare-fun p_3814 () Int)
(declare-fun n2_3819 () Int)
(declare-fun m2_3818 () Int)
(declare-fun q_3817 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_3754 (+ (+ m2_3818 1) m1_3815)))
(assert (<= (+ 0 n2_3819) (+ n1_3816 1)))
(assert (<= n1_3816 (+ 1 n2_3819)))
(assert (exists ((max_32 Int)) (and (= n_3755 (+ 1 max_32)) (or (and (= max_32 n1_3816) (>= n1_3816 n2_3819)) (and (= max_32 n2_3819) (< n1_3816 n2_3819))))))
(assert (= n_3812 n_3755))
...
(assert (or (and (and (< p_3814 1) (= m1_3815 0)) (= n1_3816 0)) (and (and (<= 1 n1_3816) (<= 1 m1_3815)) (> p_3814 0))))
(assert (or (and (and (< q_3817 1) (= m2_3818 0)) (= n2_3819 0)) (and (and (<= 1 n2_3819) (<= 1 m2_3818)) (> q_3817 0))))
