...
(assert (exists ((max_3711 Int)) (and (= n (+ 1 max_3711)) (or (and (= max_3711 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3711 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3712 Int)) (and (= n_3641 (+ 1 max_3712)) (or (and (= max_3712 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3712 n2_3706) (< n1_3703 n2_3706))))))
(assert (= xrightright_primed q_3704))
(assert (or (and (and (< q_3704 1) (= m2_3705 0)) (= n2_3706 0)) (and (and (<= 1 n2_3706) (<= 1 m2_3705)) (> q_3704 0))))
;Negation of Consequence
(assert (not (or (= m2_3705 0) (or (= n2_3706 0) (< q_3704 1)))))
(check-sat)