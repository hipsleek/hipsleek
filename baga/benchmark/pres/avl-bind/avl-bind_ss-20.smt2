...
(assert (exists ((max_2558 Int)) (and (= nx (+ 1 max_2558)) (or (and (= max_2558 n1_2491) (>= n1_2491 n2_2494)) (and (= max_2558 n2_2494) (< n1_2491 n2_2494))))))
(assert (= n_2487 nx))
(assert (= nx_2495 nx))
...
(assert (exists ((max_2559 Int)) (and (= n1_2512 (+ 1 max_2559)) (or (and (= max_2559 n1_2528) (>= n1_2528 n2_2531)) (and (= max_2559 n2_2531) (< n1_2528 n2_2531))))))
