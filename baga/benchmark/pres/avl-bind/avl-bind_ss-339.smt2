...
(assert (= n_3367 n))
(assert (exists ((max_3496 Int)) (and (= n (+ 1 max_3496)) (or (and (= max_3496 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3496 n2_3374) (< n1_3371 n2_3374))))))
(assert (<= n1_3371 (+ 1 n2_3374)))
(assert (<= (+ 0 n2_3374) (+ n1_3371 1)))
(assert (= m (+ (+ m2_3373 1) m1_3370)))
(assert (= n_3451 n_3393))
(assert (exists ((max_3497 Int)) (and (= n_3393 (+ 1 max_3497)) (or (and (= max_3497 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3497 n2_3458) (< n1_3455 n2_3458))))))
...
(assert (not (or (= m_3402 0) (or (= n_3403 0) (< xright_primed 1)))))
(check-sat)