...
(assert (exists ((max_3600 Int)) (and (= n (+ 1 max_3600)) (or (and (= max_3600 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3600 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3601 Int)) (and (= n_3393 (+ 1 max_3601)) (or (and (= max_3601 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3601 n2_3458) (< n1_3455 n2_3458))))))
...
(assert (exists ((max_3602 Int)) (and (= n_3516 (+ 1 max_3602)) (or (and (= max_3602 n1_3569) (>= n1_3569 n2_3572)) (and (= max_3602 n2_3572) (< n1_3569 n2_3572))))))
...
(assert (not (or (= m1_3568 0) (or (= n1_3569 0) (< p_3567 1)))))
(check-sat)