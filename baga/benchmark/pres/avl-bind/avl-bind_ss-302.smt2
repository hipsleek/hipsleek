...
(declare-fun n_3408 () Int)
(declare-fun m_3407 () Int)
...
(assert (<= 0 n2_3374))
(assert (= res n_3403))
(assert (= m_3407 m_3402))
(assert (= n_3408 n_3403))
(assert (<= 0 m_3402))
(assert (<= 0 n_3403))
(assert (or (and (and (< xleft_primed 1) (= m_3392 0)) (= n_3393 0)) (and (and (<= 1 n_3393) (<= 1 m_3392)) (> xleft_primed 0))))
(assert (or (and (and (< xright_primed 1) (= m_3407 0)) (= n_3408 0)) (and (and (<= 1 n_3408) (<= 1 m_3407)) (> xright_primed 0))))
