...
;Axioms assertions
;Antecedent
(assert (exists ((max_3247 Int)) (and (= h_3208 (+ 1 max_3247)) (or (and (= max_3247 n1_3214) (>= n1_3214 n2_3217)) (and (= max_3247 n2_3217) (< n1_3214 n2_3217))))))
(assert (= h_3208 (+ 1 h_3204)))
(assert (<= 0 n))
(assert (<= 0 ln_3187))
(assert (<= 0 flted_32_3188))
(assert (exists ((max_3246 Int)) (and (= n1_3214 (+ 1 max_3246)) (or (and (= max_3246 n1_3227) (>= n1_3227 n2_3230)) (and (= max_3246 n2_3230) (< n1_3227 n2_3230))))))
