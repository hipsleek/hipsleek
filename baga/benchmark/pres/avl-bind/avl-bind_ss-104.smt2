...
(assert (exists ((max_2960 Int)) (and (= n_2860 (+ 1 max_2960)) (or (and (= max_2960 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2960 n2_2869) (< n1_2866 n2_2869))))))
...
(assert (exists ((max_2961 Int)) (and (= n_2883 (+ 1 max_2961)) (or (and (= max_2961 n1_2889) (>= n1_2889 n2_2892)) (and (= max_2961 n2_2892) (< n1_2889 n2_2892))))))
