...
(declare-fun n_2838 () Int)
(declare-fun m_2837 () Int)
...
(assert (<= 0 cn))
(assert (= res n_2834))
(assert (= m_2837 m_2833))
(assert (= n_2838 n_2834))
(assert (<= 0 m_2833))
(assert (<= 0 n_2834))
...
(assert (or (and (and (< c_primed 1) (= m_2837 0)) (= n_2838 0)) (and (and (<= 1 n_2838) (<= 1 m_2837)) (> c_primed 0))))
