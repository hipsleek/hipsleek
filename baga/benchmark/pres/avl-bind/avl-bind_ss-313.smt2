...
(assert (exists ((max_3612 Int)) (and (= n_3516 (+ 1 max_3612)) (or (and (= max_3612 n1_3569) (>= n1_3569 n2_3572)) (and (= max_3612 n2_3572) (< n1_3569 n2_3572))))))
...
(assert (= n_3367 n))
(assert (exists ((max_3610 Int)) (and (= n (+ 1 max_3610)) (or (and (= max_3610 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3610 n2_3374) (< n1_3371 n2_3374))))))
(assert (<= n1_3371 (+ 1 n2_3374)))
(assert (<= (+ 0 n2_3374) (+ n1_3371 1)))
(assert (= n_3451 n_3393))
(assert (exists ((max_3611 Int)) (and (= n_3393 (+ 1 max_3611)) (or (and (= max_3611 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3611 n2_3458) (< n1_3455 n2_3458))))))
(assert (= n_3403 n2_3374))
(assert (= (+ 2 n_3403) n_3393))
(assert (= an n_3507))
(assert (<= 0 n_3403))
;Negation of Consequence
(assert (not (= n_3403 an)))
(check-sat)