...
(declare-fun bn () Int)
(declare-fun res () Int)
(declare-fun v_int_87_2135_primed () Int)
...
(assert (<= 0 m_2814))
(assert (<= 0 n_2815))
(assert (or (and (= h_primed n) (>= n n_2815)) (and (= h_primed n_2815) (< n n_2815))))
(assert (= v_int_87_2135_primed 1))
(assert (= res (+ v_int_87_2135_primed h_primed)))
