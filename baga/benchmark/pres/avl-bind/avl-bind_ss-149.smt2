...
(declare-fun n_3007 () Int)
(declare-fun m_3006 () Int)
...
(assert (<= 0 bn))
(assert (= res n_3003))
(assert (= m_3006 m_3002))
(assert (= n_3007 n_3003))
(assert (<= 0 m_3002))
(assert (<= 0 n_3003))
...
(assert (or (and (and (< b_primed 1) (= m_3006 0)) (= n_3007 0)) (and (and (<= 1 n_3007) (<= 1 m_3006)) (> b_primed 0))))
