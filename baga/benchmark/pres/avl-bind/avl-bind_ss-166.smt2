...
(declare-fun v_int_119_2023_primed () Int)
...
(assert (<= 0 n_3071))
(assert (<= 0 m_3070))
(assert (= v_int_119_2023_primed n_3071))
...
(assert (or (and (= h_primed (+ n1_3077 1)) (<= n2_3080 n1_3077)) (and (= h_primed (+ n2_3080 1)) (< n1_3077 n2_3080))))
(assert (= h_primed n_3071))
