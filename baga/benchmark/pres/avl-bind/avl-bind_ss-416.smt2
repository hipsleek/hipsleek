...
(declare-fun n_3714 () Int)
(declare-fun m_3713 () Int)
...
(assert (<= 0 n2_3706))
(assert (= res n_3708))
(assert (= m_3713 m_3707))
(assert (= n_3714 n_3708))
(assert (<= 0 m_3707))
(assert (<= 0 n_3708))
...
(assert (or (and (and (< xrightright_primed 1) (= m_3713 0)) (= n_3714 0)) (and (and (<= 1 n_3714) (<= 1 m_3713)) (> xrightright_primed 0))))
