...
(declare-fun rrm () Int)
(declare-fun res () Int)
(declare-fun flted_33_3751 () Int)
(declare-fun flted_33_3752 () Int)
...
(assert (<= 0 m_3650))
(assert (<= 0 n_3651))
(assert (= flted_33_3752 (+ (+ (+ rrm lm) 2) rlm)))
(assert (= flted_33_3751 (+ ln 2)))
...
(assert (or (and (and (< v_node_203_1629_primed 1) (= flted_33_3752 0)) (= flted_33_3751 0)) (and (and (<= 1 flted_33_3751) (<= 1 flted_33_3752)) (> v_node_203_1629_primed 0))))
(assert (= xright_primed 1))
(assert (= x_primed 2))
(assert (not (= xright_primed x_primed)))
