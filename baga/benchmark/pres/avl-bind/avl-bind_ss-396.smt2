...
(declare-fun n_3656 () Int)
(declare-fun m_3655 () Int)
...
(assert (<= 0 n1_3371))
(assert (= res n_3651))
(assert (= m_3655 m_3650))
(assert (= n_3656 n_3651))
(assert (<= 0 m_3650))
(assert (<= 0 n_3651))
(assert (or (and (and (< xright_primed 1) (= m_3640 0)) (= n_3641 0)) (and (and (<= 1 n_3641) (<= 1 m_3640)) (> xright_primed 0))))
(assert (or (and (and (< xleft_primed 1) (= m_3655 0)) (= n_3656 0)) (and (and (<= 1 n_3656) (<= 1 m_3655)) (> xleft_primed 0))))
