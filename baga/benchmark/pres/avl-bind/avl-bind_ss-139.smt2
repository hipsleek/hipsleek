...
(assert (<= 0 n_2860))
(assert (<= 0 n_2883))
(assert (exists ((max_2986 Int)) (and (= n_2883 (+ 1 max_2986)) (or (and (= max_2986 n1_2889) (>= n1_2889 n2_2892)) (and (= max_2986 n2_2892) (< n1_2889 n2_2892))))))
(assert (= h_2920 n_2883))
(assert (exists ((max_2987 Int)) (and (= n_2860 (+ 1 max_2987)) (or (and (= max_2987 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2987 n2_2869) (< n1_2866 n2_2869))))))
(assert (= h_2851 n_2860))
(assert (or (and (= h_2926 n_2860) (>= n_2860 n_2883)) (and (= h_2926 n_2883) (< n_2860 n_2883))))
(assert (exists ((max_2988 Int)) (and (= h_2930 (+ 1 max_2988)) (or (and (= max_2988 n1_2936) (>= n1_2936 n2_2939)) (and (= max_2988 n2_2939) (< n1_2936 n2_2939))))))
(assert (= n2_2939 n_2883))
(assert (= n1_2936 n_2860))
(assert (= h_2930 (+ 1 h_2926)))
;Negation of Consequence
(assert (not (or (and (= h_2930 (+ 1 n1_2936)) (<= n2_2939 n1_2936)) (and (= h_2930 (+ 1 n2_2939)) (< n1_2936 n2_2939)))))
(check-sat)