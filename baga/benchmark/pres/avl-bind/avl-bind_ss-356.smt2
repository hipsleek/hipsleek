...
(declare-fun n_3723 () Int)
(declare-fun m_3722 () Int)
...
(assert (<= 0 n1_3703))
(assert (= res n_3717))
(assert (= m_3722 m_3716))
(assert (= n_3723 n_3717))
(assert (<= 0 m_3716))
(assert (<= 0 n_3717))
...
(assert (or (and (and (< xrightleft_primed 1) (= m_3722 0)) (= n_3723 0)) (and (and (<= 1 n_3723) (<= 1 m_3722)) (> xrightleft_primed 0))))
