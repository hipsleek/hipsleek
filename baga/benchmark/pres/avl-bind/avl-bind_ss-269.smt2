...
(assert (exists ((max_3316 Int)) (and (= n2_3295 (+ 1 max_3316)) (or (and (= max_3316 n1_3305) (>= n1_3305 n2_3308)) (and (= max_3316 n2_3308) (< n1_3305 n2_3308))))))
(assert (= h_3282 n2_3295))
(assert (= n1_3292 lln))
;Negation of Consequence
(assert (not (<= n1_3292 (+ n2_3295 1))))
(check-sat)