...
(assert (exists ((max_3862 Int)) (and (= n (+ 1 max_3862)) (or (and (= max_3862 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3862 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3863 Int)) (and (= n_3641 (+ 1 max_3863)) (or (and (= max_3863 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3863 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (exists ((max_3864 Int)) (and (= n_3755 (+ 1 max_3864)) (or (and (= max_3864 n1_3825) (>= n1_3825 n2_3828)) (and (= max_3864 n2_3828) (< n1_3825 n2_3828))))))
...
(assert (not (or (= m_3769 0) (or (= n_3770 0) (< xrightright_primed 1)))))
(check-sat)