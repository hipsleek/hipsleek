...
(assert (exists ((max_32 Int)) (and (= h_2930 (+ 1 max_32)) (or (and (= max_32 n1_2936) (>= n1_2936 n2_2939)) (and (= max_32 n2_2939) (< n1_2936 n2_2939))))))
