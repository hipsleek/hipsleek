...
(declare-fun res () Int)
(declare-fun v_int_91_2178_primed () Int)
...
(assert (<= 0 m_2840))
(assert (<= 0 n_2841))
(assert (or (and (= h_primed n_2834) (>= n_2834 n_2841)) (and (= h_primed n_2841) (< n_2834 n_2841))))
(assert (= v_int_91_2178_primed 1))
(assert (= res (+ v_int_91_2178_primed h_primed)))
