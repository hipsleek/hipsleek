...
(assert (exists ((max_2542 Int)) (and (= nx (+ 1 max_2542)) (or (and (= max_2542 n1_2491) (>= n1_2491 n2_2494)) (and (= max_2542 n2_2494) (< n1_2491 n2_2494))))))
(assert (= q_2529 q_2492))
(assert (or (and (and (< q_2492 1) (= m2_2493 0)) (= n2_2494 0)) (and (and (<= 1 n2_2494) (<= 1 m2_2493)) (> q_2492 0))))
;Negation of Consequence
(assert (not (or (= m2_2493 0) (or (= n2_2494 0) (< q_2492 1)))))
(check-sat)