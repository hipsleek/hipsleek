...
(assert (<= 0 n_3048))
(assert (exists ((max_3092 Int)) (and (= n_3048 (+ 1 max_3092)) (or (and (= max_3092 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3092 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (not (<= (+ n2_3080 0) (+ 1 n1_3077))))
(check-sat)