...
(declare-fun n_2914 () Int)
(declare-fun m_2913 () Int)
...
(assert (= res n_2883))
(assert (= m_2913 m_2882))
(assert (= n_2914 n_2883))
(assert (<= 0 m_2882))
(assert (<= 0 n_2883))
(assert (or (and (and (< tmp1_primed 1) (= m_2859 0)) (= n_2860 0)) (and (and (<= 1 n_2860) (<= 1 m_2859)) (> tmp1_primed 0))))
(assert (or (and (and (< tmp2_primed 1) (= m_2913 0)) (= n_2914 0)) (and (and (<= 1 n_2914) (<= 1 m_2913)) (> tmp2_primed 0))))
