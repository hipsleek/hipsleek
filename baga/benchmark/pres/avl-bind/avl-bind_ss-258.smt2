...
(assert (exists ((max_3463 Int)) (and (= n (+ 1 max_3463)) (or (and (= max_3463 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3463 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3464 Int)) (and (= n_3393 (+ 1 max_3464)) (or (and (= max_3464 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3464 n2_3458) (< n1_3455 n2_3458))))))
(assert (= xleftleft_primed p_3453))
(assert (or (and (and (< p_3453 1) (= m1_3454 0)) (= n1_3455 0)) (and (and (<= 1 n1_3455) (<= 1 m1_3454)) (> p_3453 0))))
;Negation of Consequence
(assert (not (or (= m1_3454 0) (or (= n1_3455 0) (< p_3453 1)))))
(check-sat)