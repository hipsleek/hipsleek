...
(assert (exists ((max_3148 Int)) (and (= n_3048 (+ 1 max_3148)) (or (and (= max_3148 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3148 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (exists ((max_3149 Int)) (and (= n_3071 (+ 1 max_3149)) (or (and (= max_3149 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3149 n2_3080) (< n1_3077 n2_3080))))))
(assert (= h_3118 (+ 1 h_3114)))
(assert (= n1_3124 n_3048))
(assert (= n2_3127 n_3071))
;Negation of Consequence
(assert (not (or (and (= h_3118 (+ 1 n1_3124)) (<= n2_3127 n1_3124)) (and (= h_3118 (+ 1 n2_3127)) (< n1_3124 n2_3127)))))
(check-sat)