...
(assert (exists ((max_3519 Int)) (and (= n (+ 1 max_3519)) (or (and (= max_3519 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3519 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3520 Int)) (and (= n_3393 (+ 1 max_3520)) (or (and (= max_3520 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3520 n2_3458) (< n1_3455 n2_3458))))))
...
(assert (not (or (= m_3468 0) (or (= n_3469 0) (< xleftright_primed 1)))))
(check-sat)