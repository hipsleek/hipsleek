...
(declare-fun n1_3446 () Int)
(declare-fun m1_3445 () Int)
(declare-fun p_3444 () Int)
(declare-fun n2_3449 () Int)
(declare-fun m2_3448 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_3392 (+ (+ m2_3448 1) m1_3445)))
(assert (<= (+ 0 n2_3449) (+ n1_3446 1)))
(assert (<= n1_3446 (+ 1 n2_3449)))
(assert (exists ((max_32 Int)) (and (= n_3393 (+ 1 max_32)) (or (and (= max_32 n1_3446) (>= n1_3446 n2_3449)) (and (= max_32 n2_3449) (< n1_3446 n2_3449))))))
(assert (= n_3442 n_3393))
...
(assert (= xleft_primed 1))
(assert (or (and (and (< p_3444 1) (= m1_3445 0)) (= n1_3446 0)) (and (and (<= 1 n1_3446) (<= 1 m1_3445)) (> p_3444 0))))
(assert (or (and (and (< q_3447 1) (= m2_3448 0)) (= n2_3449 0)) (and (and (<= 1 n2_3449) (<= 1 m2_3448)) (> q_3447 0))))
