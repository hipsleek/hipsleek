...
(declare-fun n_3513 () Int)
(declare-fun m_3512 () Int)
...
(assert (<= 0 n_3460))
(assert (= res n_3507))
(assert (= m_3512 m_3506))
(assert (= n_3513 n_3507))
(assert (<= 0 m_3506))
(assert (<= 0 n_3507))
...
(assert (or (and (and (< xleftleft_primed 1) (= m_3512 0)) (= n_3513 0)) (and (and (<= 1 n_3513) (<= 1 m_3512)) (> xleftleft_primed 0))))
