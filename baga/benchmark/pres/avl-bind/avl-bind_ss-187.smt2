...
(assert (exists ((max_3091 Int)) (and (= n_3048 (+ 1 max_3091)) (or (and (= max_3091 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3091 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (not (or (= m_3028 0) (or (= n_3029 0) (< d_primed 1)))))
(check-sat)