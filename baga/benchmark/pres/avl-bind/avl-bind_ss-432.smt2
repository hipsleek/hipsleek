...
(assert (exists ((max_3741 Int)) (and (= n (+ 1 max_3741)) (or (and (= max_3741 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3741 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3742 Int)) (and (= n_3641 (+ 1 max_3742)) (or (and (= max_3742 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3742 n2_3706) (< n1_3703 n2_3706))))))
