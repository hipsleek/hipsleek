...
;Axioms assertions
;Antecedent
(assert (exists ((max_3155 Int)) (and (= h_3118 (+ 1 max_3155)) (or (and (= max_3155 n1_3124) (>= n1_3124 n2_3127)) (and (= max_3155 n2_3127) (< n1_3124 n2_3127))))))
...
(assert (<= 0 n_3048))
(assert (<= 0 n_3071))
(assert (exists ((max_3153 Int)) (and (= n_3071 (+ 1 max_3153)) (or (and (= max_3153 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3153 n2_3080) (< n1_3077 n2_3080))))))
...
(assert (exists ((max_3154 Int)) (and (= n_3048 (+ 1 max_3154)) (or (and (= max_3154 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3154 n2_3057) (< n1_3054 n2_3057))))))
