...
(assert (exists ((max_3315 Int)) (and (= n2_3295 (+ 1 max_3315)) (or (and (= max_3315 n1_3305) (>= n1_3305 n2_3308)) (and (= max_3315 n2_3308) (< n1_3305 n2_3308))))))
(assert (= h_3282 n2_3295))
(assert (= n1_3292 lln))
;Negation of Consequence
(assert (not (<= (+ n2_3295 0) (+ 1 n1_3292))))
(check-sat)