...
(declare-fun n_3522 () Int)
(declare-fun m_3521 () Int)
...
(assert (<= 0 n_3469))
(assert (= res n_3516))
(assert (= m_3521 m_3515))
(assert (= n_3522 n_3516))
(assert (<= 0 m_3515))
(assert (<= 0 n_3516))
...
(assert (or (and (and (< xleftright_primed 1) (= m_3521 0)) (= n_3522 0)) (and (and (<= 1 n_3522) (<= 1 m_3521)) (> xleftright_primed 0))))
