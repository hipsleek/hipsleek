...
(assert (exists ((max_3238 Int)) (and (= n1_3214 (+ 1 max_3238)) (or (and (= max_3238 n1_3227) (>= n1_3227 n2_3230)) (and (= max_3238 n2_3230) (< n1_3227 n2_3230))))))
(assert (= h_3204 n1_3214))
(assert (= n2_3217 flted_32_3188))
;Negation of Consequence
(assert (not (<= (+ n2_3217 0) (+ 1 n1_3214))))
(check-sat)