...
(assert (exists ((max_2956 Int)) (and (= n_2860 (+ 1 max_2956)) (or (and (= max_2956 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2956 n2_2869) (< n1_2866 n2_2869))))))
...
(assert (exists ((max_2957 Int)) (and (= n_2883 (+ 1 max_2957)) (or (and (= max_2957 n1_2889) (>= n1_2889 n2_2892)) (and (= max_2957 n2_2892) (< n1_2889 n2_2892))))))
(assert (= n1_2936 n_2860))
(assert (= n2_2939 n_2883))
;Negation of Consequence
(assert (not (<= (+ n2_2939 0) (+ 1 n1_2936))))
(check-sat)