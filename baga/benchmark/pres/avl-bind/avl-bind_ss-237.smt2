...
(declare-fun n_3400 () Int)
(declare-fun m_3399 () Int)
...
(assert (<= 0 Anon_3397))
(assert (= res n_3393))
(assert (= m_3399 m_3392))
(assert (= n_3400 n_3393))
(assert (<= 0 m_3392))
(assert (<= 0 n_3393))
(assert (or (and (and (< q_3372 1) (= m2_3373 0)) (= n2_3374 0)) (and (and (<= 1 n2_3374) (<= 1 m2_3373)) (> q_3372 0))))
(assert (or (and (and (< xleft_primed 1) (= m_3399 0)) (= n_3400 0)) (and (and (<= 1 n_3400) (<= 1 m_3399)) (> xleft_primed 0))))
