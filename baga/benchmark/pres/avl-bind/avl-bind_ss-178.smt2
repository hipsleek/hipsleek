...
(assert (exists ((max_3146 Int)) (and (= n_3048 (+ 1 max_3146)) (or (and (= max_3146 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3146 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (exists ((max_3147 Int)) (and (= n_3071 (+ 1 max_3147)) (or (and (= max_3147 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3147 n2_3080) (< n1_3077 n2_3080))))))
(assert (= n1_3124 n_3048))
(assert (= n2_3127 n_3071))
;Negation of Consequence
(assert (not (<= n1_3124 (+ n2_3127 1))))
(check-sat)