...
(declare-fun v_int_86_2123_primed () Int)
(declare-fun cn () Int)
(declare-fun cm () Int)
(declare-fun c () Int)
...
(assert (<= 0 bm))
(assert (<= 0 bn))
(assert (= v_int_86_2123_primed n_2815))
(assert (<= 0 m_2814))
(assert (<= 0 n_2815))
(assert (or (and (= res v_int_86_2124_primed) (>= v_int_86_2124_primed v_int_86_2123_primed)) (and (= res v_int_86_2123_primed) (< v_int_86_2124_primed v_int_86_2123_primed))))
