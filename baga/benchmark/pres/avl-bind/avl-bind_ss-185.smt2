...
(assert (<= 0 n_3048))
(assert (<= 0 n_3071))
(assert (exists ((max_3174 Int)) (and (= n_3071 (+ 1 max_3174)) (or (and (= max_3174 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3174 n2_3080) (< n1_3077 n2_3080))))))
(assert (= h_3108 n_3071))
(assert (exists ((max_3175 Int)) (and (= n_3048 (+ 1 max_3175)) (or (and (= max_3175 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3175 n2_3057) (< n1_3054 n2_3057))))))
(assert (= h_3039 n_3048))
(assert (or (and (= h_3114 n_3048) (>= n_3048 n_3071)) (and (= h_3114 n_3071) (< n_3048 n_3071))))
(assert (exists ((max_3176 Int)) (and (= h_3118 (+ 1 max_3176)) (or (and (= max_3176 n1_3124) (>= n1_3124 n2_3127)) (and (= max_3176 n2_3127) (< n1_3124 n2_3127))))))
