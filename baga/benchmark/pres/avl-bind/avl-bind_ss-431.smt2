...
(assert (= n_3367 n))
(assert (exists ((max_3739 Int)) (and (= n (+ 1 max_3739)) (or (and (= max_3739 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3739 n2_3374) (< n1_3371 n2_3374))))))
(assert (<= n1_3371 (+ 1 n2_3374)))
(assert (<= (+ 0 n2_3374) (+ n1_3371 1)))
(assert (= m (+ (+ m2_3373 1) m1_3370)))
(assert (= n_3699 n_3641))
(assert (exists ((max_3740 Int)) (and (= n_3641 (+ 1 max_3740)) (or (and (= max_3740 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3740 n2_3706) (< n1_3703 n2_3706))))))
