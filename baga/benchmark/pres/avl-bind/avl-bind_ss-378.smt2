...
(declare-fun n_3761 () Int)
(declare-fun m_3760 () Int)
...
(assert (<= 0 n_3717))
(assert (= res n_3755))
(assert (= m_3760 m_3754))
(assert (= n_3761 n_3755))
(assert (<= 0 m_3754))
(assert (<= 0 n_3755))
...
(assert (or (and (and (< xrightleft_primed 1) (= m_3760 0)) (= n_3761 0)) (and (and (<= 1 n_3761) (<= 1 m_3760)) (> xrightleft_primed 0))))
