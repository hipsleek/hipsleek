...
(assert (exists ((max_3493 Int)) (and (= n (+ 1 max_3493)) (or (and (= max_3493 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3493 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3494 Int)) (and (= n_3393 (+ 1 max_3494)) (or (and (= max_3494 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3494 n2_3458) (< n1_3455 n2_3458))))))
