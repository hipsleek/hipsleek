...
(assert (exists ((max_3869 Int)) (and (= n (+ 1 max_3869)) (or (and (= max_3869 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3869 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3870 Int)) (and (= n_3641 (+ 1 max_3870)) (or (and (= max_3870 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3870 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (exists ((max_3871 Int)) (and (= n_3755 (+ 1 max_3871)) (or (and (= max_3871 n1_3825) (>= n1_3825 n2_3828)) (and (= max_3871 n2_3828) (< n1_3825 n2_3828))))))
