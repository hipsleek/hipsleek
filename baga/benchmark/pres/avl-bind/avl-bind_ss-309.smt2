...
(assert (exists ((max_3597 Int)) (and (= n (+ 1 max_3597)) (or (and (= max_3597 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3597 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3598 Int)) (and (= n_3393 (+ 1 max_3598)) (or (and (= max_3598 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3598 n2_3458) (< n1_3455 n2_3458))))))
...
(assert (exists ((max_3599 Int)) (and (= n_3516 (+ 1 max_3599)) (or (and (= max_3599 n1_3569) (>= n1_3569 n2_3572)) (and (= max_3599 n2_3572) (< n1_3569 n2_3572))))))
...
(assert (not (or (= m_3506 0) (or (= n_3507 0) (< xleftleft_primed 1)))))
(check-sat)