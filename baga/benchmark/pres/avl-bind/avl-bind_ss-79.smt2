...
(assert (exists ((max_2902 Int)) (and (= n_2860 (+ 1 max_2902)) (or (and (= max_2902 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2902 n2_2869) (< n1_2866 n2_2869))))))
...
(assert (not (or (= m_2833 0) (or (= n_2834 0) (< c_primed 1)))))
(check-sat)