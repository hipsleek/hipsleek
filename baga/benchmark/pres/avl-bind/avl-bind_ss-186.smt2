...
(assert (<= 0 n_3048))
(assert (<= 0 n_3071))
(assert (exists ((max_3177 Int)) (and (= n_3071 (+ 1 max_3177)) (or (and (= max_3177 n1_3077) (>= n1_3077 n2_3080)) (and (= max_3177 n2_3080) (< n1_3077 n2_3080))))))
...
(assert (exists ((max_3178 Int)) (and (= n_3048 (+ 1 max_3178)) (or (and (= max_3178 n1_3054) (>= n1_3054 n2_3057)) (and (= max_3178 n2_3057) (< n1_3054 n2_3057))))))
...
(assert (exists ((max_3179 Int)) (and (= h_3118 (+ 1 max_3179)) (or (and (= max_3179 n1_3124) (>= n1_3124 n2_3127)) (and (= max_3179 n2_3127) (< n1_3124 n2_3127))))))
