...
(assert (<= 0 an))
(assert (= n an))
(assert (exists ((max_2877 Int)) (and (= n_2860 (+ 1 max_2877)) (or (and (= max_2877 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2877 n2_2869) (< n1_2866 n2_2869))))))
...
(assert (not (or (and (= n_2860 (+ n1_2866 1)) (<= n2_2869 n1_2866)) (and (= n_2860 (+ n2_2869 1)) (< n1_2866 n2_2869)))))
(check-sat)