...
(assert (exists ((max_3491 Int)) (and (= n (+ 1 max_3491)) (or (and (= max_3491 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3491 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3492 Int)) (and (= n_3393 (+ 1 max_3492)) (or (and (= max_3492 n1_3455) (>= n1_3455 n2_3458)) (and (= max_3492 n2_3458) (< n1_3455 n2_3458))))))
