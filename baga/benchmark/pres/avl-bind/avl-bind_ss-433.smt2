...
(assert (exists ((max_3744 Int)) (and (= n (+ 1 max_3744)) (or (and (= max_3744 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3744 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3745 Int)) (and (= n_3641 (+ 1 max_3745)) (or (and (= max_3745 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3745 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (not (or (= m_3707 0) (or (= n_3708 0) (< xrightright_primed 1)))))
(check-sat)