...
(declare-fun n_3466 () Int)
(declare-fun m_3465 () Int)
...
(assert (<= 0 n1_3455))
(assert (= res n_3460))
(assert (= m_3465 m_3459))
(assert (= n_3466 n_3460))
(assert (<= 0 m_3459))
(assert (<= 0 n_3460))
...
(assert (or (and (and (< xleftleft_primed 1) (= m_3465 0)) (= n_3466 0)) (and (and (<= 1 n_3466) (<= 1 m_3465)) (> xleftleft_primed 0))))
