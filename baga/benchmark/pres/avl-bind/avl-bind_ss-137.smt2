...
;Axioms assertions
;Antecedent
(assert (exists ((max_2979 Int)) (and (= h_2930 (+ 1 max_2979)) (or (and (= max_2979 n1_2936) (>= n1_2936 n2_2939)) (and (= max_2979 n2_2939) (< n1_2936 n2_2939))))))
...
(assert (<= 0 n_2860))
(assert (<= 0 n_2883))
(assert (exists ((max_2977 Int)) (and (= n_2883 (+ 1 max_2977)) (or (and (= max_2977 n1_2889) (>= n1_2889 n2_2892)) (and (= max_2977 n2_2892) (< n1_2889 n2_2892))))))
...
(assert (exists ((max_2978 Int)) (and (= n_2860 (+ 1 max_2978)) (or (and (= max_2978 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2978 n2_2869) (< n1_2866 n2_2869))))))
