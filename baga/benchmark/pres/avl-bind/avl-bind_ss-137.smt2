...
(assert (<= 0 m_3028))
(assert (<= 0 n_3029))
(assert (or (and (= res v_int_115_1981_primed) (>= v_int_115_1981_primed v_int_115_1980_primed)) (and (= res v_int_115_1980_primed) (< v_int_115_1981_primed v_int_115_1980_primed))))
