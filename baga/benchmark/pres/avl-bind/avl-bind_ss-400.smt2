...
(assert (exists ((max_3855 Int)) (and (= n_3755 (+ 1 max_3855)) (or (and (= max_3855 n1_3825) (>= n1_3825 n2_3828)) (and (= max_3855 n2_3828) (< n1_3825 n2_3828))))))
...
(assert (= n_3367 n))
(assert (exists ((max_3853 Int)) (and (= n (+ 1 max_3853)) (or (and (= max_3853 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3853 n2_3374) (< n1_3371 n2_3374))))))
(assert (<= n1_3371 (+ 1 n2_3374)))
(assert (<= (+ 0 n2_3374) (+ n1_3371 1)))
(assert (= m (+ (+ m2_3373 1) m1_3370)))
(assert (= n_3699 n_3641))
(assert (exists ((max_3854 Int)) (and (= n_3641 (+ 1 max_3854)) (or (and (= max_3854 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3854 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (not (or (= m_3650 0) (or (= n_3651 0) (< xleft_primed 1)))))
(check-sat)