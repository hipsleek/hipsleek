...
(declare-fun n_3068 () Int)
(declare-fun m_3067 () Int)
...
(assert (= res n_3048))
(assert (= m_3067 m_3047))
(assert (= n_3068 n_3048))
(assert (<= 0 m_3047))
(assert (<= 0 n_3048))
...
(assert (or (and (and (< tmp1_primed 1) (= m_3067 0)) (= n_3068 0)) (and (and (<= 1 n_3068) (<= 1 m_3067)) (> tmp1_primed 0))))
