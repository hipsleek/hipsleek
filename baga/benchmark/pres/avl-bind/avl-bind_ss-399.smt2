...
(declare-fun right_208_1689_primed () Int)
(declare-fun left_208_1688_primed () Int)
(declare-fun height_208_1687_primed () Int)
(declare-fun val_208_1686_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_208_1689_primed q_3826))
(assert (= left_208_1688_primed p_3823))
(assert (= height_208_1687_primed n_3821))
(assert (= val_208_1686_primed Anon_3822))
