...
(assert (or (and (and (< v_node_180_1431_primed 1) (= flted_50_3504 0)) (= flted_50_3503 0)) (and (and (<= 1 flted_50_3503) (<= 1 flted_50_3504)) (> v_node_180_1431_primed 0))))
(assert (= xleft_primed 1))
(assert (= x_primed 2))
(assert (not (= xleft_primed x_primed)))
