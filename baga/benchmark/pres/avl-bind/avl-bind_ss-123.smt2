...
(assert (<= 0 m_3002))
(assert (<= 0 n_3003))
(assert (or (and (= res v_int_111_1938_primed) (>= v_int_111_1938_primed v_int_111_1937_primed)) (and (= res v_int_111_1937_primed) (< v_int_111_1938_primed v_int_111_1937_primed))))
