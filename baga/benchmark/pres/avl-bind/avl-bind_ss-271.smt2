...
(assert (exists ((max_3318 Int)) (and (= n2_3295 (+ 1 max_3318)) (or (and (= max_3318 n1_3305) (>= n1_3305 n2_3308)) (and (= max_3318 n2_3308) (< n1_3305 n2_3308))))))
...
(assert (not (or (and (= n2_3295 (+ n1_3305 1)) (<= n2_3308 n1_3305)) (and (= n2_3295 (+ n2_3308 1)) (< n1_3305 n2_3308)))))
(check-sat)