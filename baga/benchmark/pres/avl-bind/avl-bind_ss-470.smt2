...
(assert (exists ((max_3872 Int)) (and (= n (+ 1 max_3872)) (or (and (= max_3872 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3872 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3873 Int)) (and (= n_3641 (+ 1 max_3873)) (or (and (= max_3873 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3873 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (exists ((max_3874 Int)) (and (= n_3755 (+ 1 max_3874)) (or (and (= max_3874 n1_3825) (>= n1_3825 n2_3828)) (and (= max_3874 n2_3828) (< n1_3825 n2_3828))))))
