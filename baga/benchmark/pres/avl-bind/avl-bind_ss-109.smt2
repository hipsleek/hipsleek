...
(assert (<= 0 n_2860))
(assert (exists ((max_2904 Int)) (and (= n_2860 (+ 1 max_2904)) (or (and (= max_2904 n1_2866) (>= n1_2866 n2_2869)) (and (= max_2904 n2_2869) (< n1_2866 n2_2869))))))
...
(assert (not (<= (+ n2_2892 0) (+ 1 n1_2889))))
(check-sat)