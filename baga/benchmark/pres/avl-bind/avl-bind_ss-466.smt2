...
(assert (exists ((max_3859 Int)) (and (= n (+ 1 max_3859)) (or (and (= max_3859 n1_3371) (>= n1_3371 n2_3374)) (and (= max_3859 n2_3374) (< n1_3371 n2_3374))))))
...
(assert (exists ((max_3860 Int)) (and (= n_3641 (+ 1 max_3860)) (or (and (= max_3860 n1_3703) (>= n1_3703 n2_3706)) (and (= max_3860 n2_3706) (< n1_3703 n2_3706))))))
...
(assert (exists ((max_3861 Int)) (and (= n_3755 (+ 1 max_3861)) (or (and (= max_3861 n1_3825) (>= n1_3825 n2_3828)) (and (= max_3861 n2_3828) (< n1_3825 n2_3828))))))
...
(assert (not (or (= m2_3827 0) (or (= n2_3828 0) (< q_3826 1)))))
(check-sat)