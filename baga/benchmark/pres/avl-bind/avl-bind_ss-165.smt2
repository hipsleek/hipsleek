...
(declare-fun n_3102 () Int)
(declare-fun m_3101 () Int)
...
(assert (= res n_3071))
(assert (= m_3101 m_3070))
(assert (= n_3102 n_3071))
(assert (<= 0 m_3070))
(assert (<= 0 n_3071))
(assert (or (and (and (< tmp1_primed 1) (= m_3047 0)) (= n_3048 0)) (and (and (<= 1 n_3048) (<= 1 m_3047)) (> tmp1_primed 0))))
(assert (or (and (and (< tmp2_primed 1) (= m_3101 0)) (= n_3102 0)) (and (and (<= 1 n_3102) (<= 1 m_3101)) (> tmp2_primed 0))))
