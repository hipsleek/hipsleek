...
(assert (exists ((min_2284 Int)) (and (= nmin (+ 1 min_2284)) (or (and (= min_2284 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2284 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
