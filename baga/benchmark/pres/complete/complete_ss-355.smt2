...
(assert (exists ((min_2393 Int)) (and (= nmin (+ 1 min_2393)) (or (and (= min_2393 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2393 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
...
(assert (not (= (+ 1 n_2176) (+ 2 flted_25_2114))))
(check-sat)