...
(assert (exists ((min_2633 Int)) (and (= nmin (+ 1 min_2633)) (or (and (= min_2633 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2633 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (= (+ 1 n_2301) (+ 1 flted_79_2361))))
(check-sat)