...
(assert (<= 0 nmin1_1899))
(assert (exists ((min_2042 Int)) (and (= nmin (+ 1 min_2042)) (or (and (= min_2042 nmin1_1899) (< nmin1_1899 nmin2_1901)) (and (= min_2042 nmin2_1901) (>= nmin1_1899 nmin2_1901))))))
...
(assert (not (or (= n_1905 0) (or (= nmin_1906 0) (< l_1898 1)))))
(check-sat)