...
(assert (exists ((min_1772 Int)) (or (and (= min_1772 nmin1_1724) (< nmin1_1724 nmin2_1726)) (and (= min_1772 nmin2_1726) (>= nmin1_1724 nmin2_1726)))))
(assert (= nmin2_1726 nmin_1693))
(assert (= nmin1_1724 nmin_1675))
(assert (exists ((min_1771 Int)) (and (= nmin (+ 1 min_1771)) (or (and (= min_1771 nmin1_1660) (< nmin1_1660 nmin2_1662)) (and (= min_1771 nmin2_1662) (>= nmin1_1660 nmin2_1662))))))
;Negation of Consequence
(assert (not (or (and (= (+ nmin2_1726 1) nmin) (<= nmin (+ 1 nmin1_1724))) (and (= nmin (+ 1 nmin1_1724)) (< nmin1_1724 nmin2_1726)))))
(check-sat)