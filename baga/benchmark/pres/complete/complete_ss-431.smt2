...
(assert (exists ((min_2527 Int)) (or (and (= min_2527 nmin1_2481) (< nmin1_2481 nmin2_2483)) (and (= min_2527 nmin2_2483) (>= nmin1_2481 nmin2_2483)))))
(assert (= nmin2_2483 nmin1_2289))
(assert (= nmin1_2481 nmin_2151))
(assert (exists ((min_2526 Int)) (and (= nmin (+ 1 min_2526)) (or (and (= min_2526 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2526 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
;Negation of Consequence
(assert (not (or (and (and (<= nmin (+ nmin1_2481 1)) (<= nmin1_2481 nmin)) (< nmin1_2481 nmin2_2483)) (and (and (<= nmin (+ nmin2_2483 1)) (<= nmin2_2483 nmin)) (<= nmin2_2483 nmin1_2481)))))
(check-sat)