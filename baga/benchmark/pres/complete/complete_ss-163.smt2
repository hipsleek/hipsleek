...
(declare-fun right_91_1353_primed () Int)
(declare-fun left_91_1352_primed () Int)
(declare-fun l_2125 () Int)
(declare-fun val_91_1351_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_91_1353_primed r_2127))
(assert (= left_91_1352_primed l_2125))
(assert (= val_91_1351_primed Anon_2124))
...
(assert (or (and (and (<= 1 nmin1_2207) (<= nmin1_2207 n_2176)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2176 0)) (= nmin1_2207 0)) (and (and (<= 1 nmin1_2207) (< nmin1_2207 n_2176)) (> aux_primed 0)))))
