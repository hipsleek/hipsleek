...
;Axioms assertions
;Antecedent
(assert (exists ((min_2531 Int)) (or (and (= min_2531 nmin1_2481) (< nmin1_2481 nmin2_2483)) (and (= min_2531 nmin2_2483) (>= nmin1_2481 nmin2_2483)))))
...
(assert (exists ((min_2530 Int)) (and (= nmin (+ 1 min_2530)) (or (and (= min_2530 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2530 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
