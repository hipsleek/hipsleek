...
(declare-fun v_int_71_1473_primed () Int)
(declare-fun v_int_71_1474_primed () Int)
(declare-fun t () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_71_1473_primed 1))
(assert (or (<= nmin_1924 nmin_1906) (= v_int_71_1474_primed nmin_1906)))
(assert (or (< nmin_1906 nmin_1924) (= v_int_71_1474_primed nmin_1924)))
