...
(declare-fun nmin_1698 () Int)
(declare-fun n_1697 () Int)
...
(assert (= res n_1692))
(assert (= n_1697 n_1692))
(assert (= nmin_1698 nmin_1693))
(assert (<= 0 nmin_1693))
...
(assert (or (and (and (<= 1 nmin_1698) (<= nmin_1698 n_1697)) (> v_node2_62_1515_primed 0)) (or (and (and (< v_node2_62_1515_primed 1) (= n_1697 0)) (= nmin_1698 0)) (and (and (<= 1 nmin_1698) (< nmin_1698 n_1697)) (> v_node2_62_1515_primed 0)))))
