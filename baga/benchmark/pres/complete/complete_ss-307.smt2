...
(declare-fun nmin2_2490 () Int)
(declare-fun nmin1_2488 () Int)
(declare-fun n () Int)
...
(assert (<= 0 nmin_2151))
(assert (<= 0 nmin1_2289))
(assert (= nmin2_2490 nmin1_2289))
(assert (= nmin1_2488 nmin_2151))
(assert (< nmin_2217 n_2234))
(assert (= (+ flted_25_2115 1) n))
(assert (= (+ flted_25_2114 2) n))
(assert (exists ((min_2512 Int)) (and (= nmin (+ 1 min_2512)) (or (and (= min_2512 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2512 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
