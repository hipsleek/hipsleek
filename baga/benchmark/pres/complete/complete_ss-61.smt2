...
;Axioms assertions
;Antecedent
(assert (exists ((min_1768 Int)) (or (and (= min_1768 nmin1_1724) (< nmin1_1724 nmin2_1726)) (and (= min_1768 nmin2_1726) (>= nmin1_1724 nmin2_1726)))))
...
(assert (exists ((min_1767 Int)) (and (= nmin (+ 1 min_1767)) (or (and (= min_1767 nmin1_1660) (< nmin1_1660 nmin2_1662)) (and (= min_1767 nmin2_1662) (>= nmin1_1660 nmin2_1662))))))
