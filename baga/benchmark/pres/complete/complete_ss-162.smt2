...
;Axioms assertions
;Antecedent
(assert (= right_91_1353_primed r_2119))
(assert (= left_91_1352_primed l_2117))
(assert (= val_91_1351_primed Anon_2116))
...
(assert (or (and (and (<= 1 nmin1_2206) (<= nmin1_2206 n_2176)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2176 0)) (= nmin1_2206 0)) (and (and (<= 1 nmin1_2206) (< nmin1_2206 n_2176)) (> aux_primed 0)))))
