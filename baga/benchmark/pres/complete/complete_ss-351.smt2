...
;Antecedent
(assert (< nmin n))
(assert (exists ((min_2585 Int)) (or (and (= min_2585 nmin1_2544) (< nmin1_2544 nmin2_2546)) (and (= min_2585 nmin2_2546) (>= nmin1_2544 nmin2_2546)))))
(assert (= (+ flted_26_2123 1) n))
(assert (= (+ flted_26_2122 1) n))
(assert (exists ((min_2584 Int)) (and (= nmin (+ 1 min_2584)) (or (and (= min_2584 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2584 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
