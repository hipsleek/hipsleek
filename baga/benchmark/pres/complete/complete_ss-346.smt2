...
(assert (exists ((min_2353 Int)) (and (= nmin (+ 1 min_2353)) (or (and (= min_2353 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2353 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
