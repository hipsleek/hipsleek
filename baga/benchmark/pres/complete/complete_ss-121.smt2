...
(declare-fun nmin_2156 () Int)
(declare-fun n_2155 () Int)
...
(assert (= res n_2150))
(assert (= n_2155 n_2150))
(assert (= nmin_2156 nmin_2151))
(assert (<= 0 nmin_2151))
...
(assert (or (and (and (<= 1 nmin_2156) (<= nmin_2156 n_2155)) (> v_node2_88_1339_primed 0)) (or (and (and (< v_node2_88_1339_primed 1) (= n_2155 0)) (= nmin_2156 0)) (and (and (<= 1 nmin_2156) (< nmin_2156 n_2155)) (> v_node2_88_1339_primed 0)))))
