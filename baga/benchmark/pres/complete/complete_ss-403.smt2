...
(assert (exists ((min_2471 Int)) (or (and (= min_2471 nmin1_2432) (< nmin1_2432 nmin2_2434)) (and (= min_2471 nmin2_2434) (>= nmin1_2432 nmin2_2434)))))
(assert (= nmin2_2434 nmin2_2128))
(assert (= nmin1_2432 nmin1_2207))
(assert (exists ((min_2470 Int)) (and (= nmin (+ 1 min_2470)) (or (and (= min_2470 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2470 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
(assert (< nmin n))
;Negation of Consequence
(assert (not (or (and (and (<= nmin (+ nmin1_2432 1)) (<= nmin1_2432 nmin)) (< nmin1_2432 nmin2_2434)) (and (and (<= nmin (+ nmin2_2434 1)) (<= nmin2_2434 nmin)) (<= nmin2_2434 nmin1_2432)))))
(check-sat)