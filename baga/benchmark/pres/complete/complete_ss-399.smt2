...
(declare-fun nmin_2738 () Int)
(declare-fun n_2737 () Int)
...
(assert (= res nmin_2733))
(assert (= n_2737 n_2732))
(assert (= nmin_2738 nmin_2733))
(assert (<= 0 nmin_2733))
...
(assert (or (and (and (<= 1 nmin_2738) (<= nmin_2738 n_2737)) (> v_node2_95_1360_primed 0)) (or (and (and (< v_node2_95_1360_primed 1) (= n_2737 0)) (= nmin_2738 0)) (and (and (<= 1 nmin_2738) (< nmin_2738 n_2737)) (> v_node2_95_1360_primed 0)))))
