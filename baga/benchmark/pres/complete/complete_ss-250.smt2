...
(declare-fun nmin1_2197 () Int)
(declare-fun n_2196 () Int)
...
(assert (= aux_2195 l_2125))
(assert (= n_2176 n_2150))
(assert (= nmin_2177 nmin_2151))
(assert (<= 0 nmin_2151))
(assert (<= nmin_2151 n_2150))
(assert (or (= nmin1_2197 nmin_2177) (= nmin1_2197 (+ 1 nmin_2177))))
(assert (= n_2196 n_2176))
(assert (<= 0 nmin_2177))
...
(assert (or (and (and (<= 1 nmin1_2197) (<= nmin1_2197 n_2196)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2196 0)) (= nmin1_2197 0)) (and (and (<= 1 nmin1_2197) (< nmin1_2197 n_2196)) (> aux_primed 0)))))
