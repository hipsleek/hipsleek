...
;Axioms assertions
;Antecedent
(assert (exists ((min_1834 Int)) (or (and (= min_1834 nmin1_1789) (< nmin1_1789 nmin2_1791)) (and (= min_1834 nmin2_1791) (>= nmin1_1789 nmin2_1791)))))
(assert (= nmin2_1791 nmin_1693))
(assert (= res v_int_62_1522_primed))
(assert (<= 0 nmin_1675))
(assert (<= nmin_1693 n_1692))
(assert (<= 0 nmin_1693))
(assert (exists ((min_1833 Int)) (and (= nmin (+ 1 min_1833)) (or (and (= min_1833 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1833 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
