...
(assert (exists ((min_2051 Int)) (and (= nmin (+ 1 min_2051)) (or (and (= min_2051 nmin1_1899) (< nmin1_1899 nmin2_1901)) (and (= min_2051 nmin2_1901) (>= nmin1_1899 nmin2_1901))))))
...
(assert (not (or (= n_1923 0) (or (= nmin_1924 0) (< r_1900 1)))))
(check-sat)