...
(assert (exists ((min_2931 Int)) (and (= nmin (+ 1 min_2931)) (or (and (= min_2931 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2931 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
...
(assert (not (= (+ 1 flted_79_2825) (+ 1 n_2787))))
(check-sat)