...
;Axioms assertions
;Antecedent
(assert (exists ((min_2581 Int)) (or (and (= min_2581 nmin1_2544) (< nmin1_2544 nmin2_2546)) (and (= min_2581 nmin2_2546) (>= nmin1_2544 nmin2_2546)))))
...
(assert (exists ((min_2580 Int)) (and (= nmin (+ 1 min_2580)) (or (and (= min_2580 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2580 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
(assert (< nmin n))
