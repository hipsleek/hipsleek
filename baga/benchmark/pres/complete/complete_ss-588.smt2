...
(assert (exists ((min_2938 Int)) (or (and (= min_2938 nmin1_2892) (< nmin1_2892 nmin2_2894)) (and (= min_2938 nmin2_2894) (>= nmin1_2892 nmin2_2894)))))
(assert (= nmin2_2894 nmin_2788))
(assert (= nmin1_2892 nmin1_2826))
(assert (exists ((min_2937 Int)) (and (= nmin (+ 1 min_2937)) (or (and (= min_2937 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2937 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
(assert (= nmin n))
;Negation of Consequence
(assert (not (or (and (and (<= nmin (+ nmin1_2892 1)) (<= nmin1_2892 nmin)) (< nmin1_2892 nmin2_2894)) (and (and (<= nmin (+ nmin2_2894 1)) (<= nmin2_2894 nmin)) (<= nmin2_2894 nmin1_2892)))))
(check-sat)