...
;Axioms assertions
;Antecedent
(assert (exists ((min_2419 Int)) (or (and (= min_2419 nmin1_2369) (< nmin1_2369 nmin2_2371)) (and (= min_2419 nmin2_2371) (>= nmin1_2369 nmin2_2371)))))
...
(assert (exists ((min_2418 Int)) (and (= nmin (+ 1 min_2418)) (or (and (= min_2418 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2418 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
