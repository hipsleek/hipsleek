...
(declare-fun nmin_2793 () Int)
(declare-fun n_2792 () Int)
...
(assert (= res n_2787))
(assert (= n_2792 n_2787))
(assert (= nmin_2793 nmin_2788))
(assert (<= 0 nmin_2788))
...
(assert (or (and (and (<= 1 nmin_2793) (<= nmin_2793 n_2792)) (> v_node2_103_1400_primed 0)) (or (and (and (< v_node2_103_1400_primed 1) (= n_2792 0)) (= nmin_2793 0)) (and (and (<= 1 nmin_2793) (< nmin_2793 n_2792)) (> v_node2_103_1400_primed 0)))))
