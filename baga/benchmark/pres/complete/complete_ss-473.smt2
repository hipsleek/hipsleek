...
(assert (exists ((min_2622 Int)) (and (= nmin (+ 1 min_2622)) (or (and (= min_2622 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2622 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
