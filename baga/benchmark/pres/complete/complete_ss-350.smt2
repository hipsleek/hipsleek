...
(declare-fun right_112_1426_primed () Int)
(declare-fun left_112_1425_primed () Int)
(declare-fun val_112_1424_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_112_1426_primed r_2119))
(assert (= left_112_1425_primed l_2117))
(assert (= val_112_1424_primed Anon_2116))
...
(assert (or (and (and (<= 1 nmin1_2362) (<= nmin1_2362 flted_79_2361)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= flted_79_2361 0)) (= nmin1_2362 0)) (and (and (<= 1 nmin1_2362) (< nmin1_2362 flted_79_2361)) (> aux_primed 0)))))
