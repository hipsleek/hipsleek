...
(assert (exists ((min_2189 Int)) (and (= nmin (+ 1 min_2189)) (or (and (= min_2189 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2189 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (or (= n_2150 0) (or (= nmin_2151 0) (< l_2117 1)))))
(check-sat)