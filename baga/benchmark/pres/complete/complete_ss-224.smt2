...
(declare-fun right_98_1381_primed () Int)
(declare-fun r_2119 () Int)
(declare-fun left_98_1380_primed () Int)
(declare-fun val_98_1379_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_98_1381_primed r_2119))
(assert (= left_98_1380_primed l_2117))
(assert (= val_98_1379_primed Anon_2116))
...
(assert (or (and (and (<= 1 nmin1_2289) (<= nmin1_2289 n_2259)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2259 0)) (= nmin1_2289 0)) (and (and (<= 1 nmin1_2289) (< nmin1_2289 n_2259)) (> aux_primed 0)))))
