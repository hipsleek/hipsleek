...
(assert (exists ((min_1977 Int)) (and (= nmin (+ 1 min_1977)) (or (and (= min_1977 nmin1_1891) (< nmin1_1891 nmin2_1893)) (and (= min_1977 nmin2_1893) (>= nmin1_1891 nmin2_1893))))))
...
(assert (not (or (= n_1923 0) (or (= nmin_1924 0) (< r_1892 1)))))
(check-sat)