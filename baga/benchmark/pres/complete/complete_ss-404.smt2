...
;Axioms assertions
;Antecedent
(assert (exists ((min_2473 Int)) (or (and (= min_2473 nmin1_2432) (< nmin1_2432 nmin2_2434)) (and (= min_2473 nmin2_2434) (>= nmin1_2432 nmin2_2434)))))
(assert (<= 0 nmin1_2207))
(assert (<= 0 nmin2_2128))
(assert (<= 0 nmin_2177))
...
(assert (< nmin n))
(assert (exists ((min_2472 Int)) (and (= nmin (+ 1 min_2472)) (or (and (= min_2472 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2472 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
...
(assert (not (= (+ 1 flted_26_2122) (+ 1 n_2176))))
(check-sat)