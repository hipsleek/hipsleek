...
(declare-fun nmin1_2356 () Int)
(declare-fun flted_79_2355 () Int)
...
(assert (= aux_2354 r_2119))
(assert (= n_2342 n_2313))
(assert (= nmin_2343 nmin_2314))
(assert (<= 0 nmin_2314))
(assert (<= nmin_2314 n_2313))
(assert (= flted_79_2355 (+ 1 n_2342)))
(assert (or (= nmin1_2356 nmin_2343) (= nmin1_2356 (+ 1 nmin_2343))))
(assert (<= 0 nmin_2343))
...
(assert (or (and (and (<= 1 nmin1_2356) (<= nmin1_2356 flted_79_2355)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= flted_79_2355 0)) (= nmin1_2356 0)) (and (and (<= 1 nmin1_2356) (< nmin1_2356 flted_79_2355)) (> aux_primed 0)))))
