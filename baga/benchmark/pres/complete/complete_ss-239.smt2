...
(declare-fun nmin1_2188 () Int)
(declare-fun n_2187 () Int)
...
(assert (= aux_2186 l_2117))
(assert (= n_2176 n_2150))
(assert (= nmin_2177 nmin_2151))
(assert (<= 0 nmin_2151))
(assert (<= nmin_2151 n_2150))
(assert (or (= nmin1_2188 nmin_2177) (= nmin1_2188 (+ 1 nmin_2177))))
(assert (= n_2187 n_2176))
(assert (<= 0 nmin_2177))
...
(assert (or (and (and (<= 1 nmin1_2188) (<= nmin1_2188 n_2187)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2187 0)) (= nmin1_2188 0)) (and (and (<= 1 nmin1_2188) (< nmin1_2188 n_2187)) (> aux_primed 0)))))
