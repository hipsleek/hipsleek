...
(assert (exists ((min_2618 Int)) (and (= nmin (+ 1 min_2618)) (or (and (= min_2618 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2618 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (= (+ 1 n_2301) (+ 2 flted_79_2361))))
(check-sat)