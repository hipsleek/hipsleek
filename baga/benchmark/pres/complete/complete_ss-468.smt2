...
(declare-fun Anon_2890 () Int)
(declare-fun Anon_2686 () Int)
(declare-fun l_2891 () Int)
(declare-fun aux_2887 () Int)
(declare-fun r_2893 () Int)
...
(assert (= Anon_2890 Anon_2686))
(assert (= l_2891 aux_2887))
(assert (= r_2893 r_2689))
(assert (= nmin1_2892 nmin1_2826))
(assert (= nmin2_2894 nmin_2788))
(assert (= (+ flted_79_2825 1) (+ n_2787 2)))
(assert (exists ((min_30 Int)) (or (and (= min_30 nmin1_2892) (< nmin1_2892 nmin2_2894)) (and (= min_30 nmin2_2894) (>= nmin1_2892 nmin2_2894)))))
