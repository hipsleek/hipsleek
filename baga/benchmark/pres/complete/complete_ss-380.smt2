...
;Axioms assertions
;Antecedent
(assert (exists ((min_2643 Int)) (or (and (= min_2643 nmin1_2600) (< nmin1_2600 nmin2_2602)) (and (= min_2643 nmin2_2602) (>= nmin1_2600 nmin2_2602)))))
...
(assert (exists ((min_2642 Int)) (and (= nmin (+ 1 min_2642)) (or (and (= min_2642 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2642 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
