...
(declare-fun right_103_1387_primed () Int)
(declare-fun left_103_1386_primed () Int)
(declare-fun val_103_1385_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_103_1387_primed r_2119))
(assert (= left_103_1386_primed l_2117))
(assert (= val_103_1385_primed Anon_2116))
