...
(declare-fun nmin_2243 () Int)
(declare-fun n_2242 () Int)
...
(assert (= res n_2234))
(assert (= n_2242 n_2234))
(assert (= nmin_2243 nmin_2235))
(assert (<= 0 nmin_2235))
...
(assert (or (and (and (<= 1 nmin_2243) (<= nmin_2243 n_2242)) (> v_node2_95_1367_primed 0)) (or (and (and (< v_node2_95_1367_primed 1) (= n_2242 0)) (= nmin_2243 0)) (and (and (<= 1 nmin_2243) (< nmin_2243 n_2242)) (> v_node2_95_1367_primed 0)))))
