...
;Axioms assertions
;Antecedent
(assert (exists ((min_1832 Int)) (or (and (= min_1832 nmin1_1789) (< nmin1_1789 nmin2_1791)) (and (= min_1832 nmin2_1791) (>= nmin1_1789 nmin2_1791)))))
(assert (= res v_int_62_1522_primed))
(assert (<= 0 nmin_1675))
(assert (<= 0 nmin_1693))
(assert (= (+ flted_26_1665 1) n))
(assert (= (+ flted_26_1664 1) n))
(assert (exists ((min_1831 Int)) (and (= nmin (+ 1 min_1831)) (or (and (= min_1831 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1831 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
