...
(declare-fun right_89_1347_primed () Int)
(declare-fun left_89_1346_primed () Int)
(declare-fun val_89_1345_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_89_1347_primed r_2127))
(assert (= left_89_1346_primed l_2125))
(assert (= val_89_1345_primed Anon_2124))
