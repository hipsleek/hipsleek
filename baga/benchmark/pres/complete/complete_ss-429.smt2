...
;Axioms assertions
;Antecedent
(assert (exists ((min_2523 Int)) (or (and (= min_2523 nmin1_2481) (< nmin1_2481 nmin2_2483)) (and (= min_2523 nmin2_2483) (>= nmin1_2481 nmin2_2483)))))
...
(assert (exists ((min_2522 Int)) (and (= nmin (+ 1 min_2522)) (or (and (= min_2522 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2522 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
