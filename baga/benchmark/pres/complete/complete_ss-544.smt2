...
(assert (exists ((min_2813 Int)) (and (= nmin (+ 1 min_2813)) (or (and (= min_2813 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2813 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
