...
;Axioms assertions
;Antecedent
(assert (exists ((min_2001 Int)) (or (and (= min_2001 nmin1_1955) (< nmin1_1955 nmin2_1957)) (and (= min_2001 nmin2_1957) (>= nmin1_1955 nmin2_1957)))))
...
(assert (exists ((min_2000 Int)) (and (= nmin (+ 1 min_2000)) (or (and (= min_2000 nmin1_1891) (< nmin1_1891 nmin2_1893)) (and (= min_2000 nmin2_1893) (>= nmin1_1891 nmin2_1893))))))
