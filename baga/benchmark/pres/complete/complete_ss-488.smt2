...
(assert (<= 0 nmin2_2120))
(assert (< nmin n))
(assert (exists ((min_2641 Int)) (or (and (= min_2641 nmin1_2600) (< nmin1_2600 nmin2_2602)) (and (= min_2641 nmin2_2602) (>= nmin1_2600 nmin2_2602)))))
(assert (<= n_2234 nmin_2217))
(assert (= (+ flted_25_2115 1) n))
(assert (= (+ flted_25_2114 2) n))
(assert (exists ((min_2640 Int)) (and (= nmin (+ 1 min_2640)) (or (and (= min_2640 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2640 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (= (+ 1 flted_79_2361) (+ 1 n_2301))))
(check-sat)