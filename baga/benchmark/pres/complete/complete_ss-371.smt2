...
(assert (exists ((min_2629 Int)) (and (= nmin (+ 1 min_2629)) (or (and (= min_2629 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2629 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (or (= n_2301 0) (or (= nmin_2302 0) (< l_2117 1)))))
(check-sat)