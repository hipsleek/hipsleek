...
;Axioms assertions
;Antecedent
(assert (exists ((min_2942 Int)) (or (and (= min_2942 nmin1_2892) (< nmin1_2892 nmin2_2894)) (and (= min_2942 nmin2_2894) (>= nmin1_2892 nmin2_2894)))))
...
(assert (exists ((min_2941 Int)) (and (= nmin (+ 1 min_2941)) (or (and (= min_2941 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2941 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
...
(assert (not (= (+ 1 flted_79_2825) (+ n 1))))
(check-sat)