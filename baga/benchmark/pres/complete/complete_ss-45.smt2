...
(assert (exists ((min_1809 Int)) (and (= nmin (+ 1 min_1809)) (or (and (= min_1809 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1809 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
...
(assert (not (or (= n_1692 0) (or (= nmin_1693 0) (< r_1669 1)))))
(check-sat)