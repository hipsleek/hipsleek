...
(declare-fun v_int_71_1470_primed () Int)
(declare-fun res () Int)
...
(assert (= v_int_71_1470_primed nmin_1924))
(assert (<= 0 nmin_1924))
(assert (<= nmin_1924 n_1923))
(assert (or (< v_int_71_1471_primed v_int_71_1470_primed) (= res v_int_71_1470_primed)))
(assert (or (<= v_int_71_1470_primed v_int_71_1471_primed) (= res v_int_71_1471_primed)))
(assert (= t_primed 1))
