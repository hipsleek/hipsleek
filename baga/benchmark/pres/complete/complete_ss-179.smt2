...
(declare-fun nmin_2240 () Int)
(declare-fun n_2239 () Int)
...
(assert (= res n_2234))
(assert (= n_2239 n_2234))
(assert (= nmin_2240 nmin_2235))
(assert (<= 0 nmin_2235))
...
(assert (or (and (and (<= 1 nmin_2240) (<= nmin_2240 n_2239)) (> v_node2_95_1367_primed 0)) (or (and (and (< v_node2_95_1367_primed 1) (= n_2239 0)) (= nmin_2240 0)) (and (and (<= 1 nmin_2240) (< nmin_2240 n_2239)) (> v_node2_95_1367_primed 0)))))
