...
;Axioms assertions
;Antecedent
(assert (exists ((min_1828 Int)) (or (and (= min_1828 nmin1_1789) (< nmin1_1789 nmin2_1791)) (and (= min_1828 nmin2_1791) (>= nmin1_1789 nmin2_1791)))))
...
(assert (<= 0 nmin_1693))
(assert (exists ((min_1827 Int)) (and (= nmin (+ 1 min_1827)) (or (and (= min_1827 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1827 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
