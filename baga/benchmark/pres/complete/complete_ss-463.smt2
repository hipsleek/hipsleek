...
;Axioms assertions
;Antecedent
(assert (exists ((min_2934 Int)) (or (and (= min_2934 nmin1_2892) (< nmin1_2892 nmin2_2894)) (and (= min_2934 nmin2_2894) (>= nmin1_2892 nmin2_2894)))))
...
(assert (exists ((min_2933 Int)) (and (= nmin (+ 1 min_2933)) (or (and (= min_2933 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2933 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
(assert (= nmin n))
