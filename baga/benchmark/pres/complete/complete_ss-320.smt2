...
;Axioms assertions
;Antecedent
(assert (= right_98_1381_primed r_2127))
(assert (= left_98_1380_primed l_2125))
(assert (= val_98_1379_primed Anon_2124))
...
(assert (or (and (and (<= 1 nmin1_2290) (<= nmin1_2290 n_2259)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= n_2259 0)) (= nmin1_2290 0)) (and (and (<= 1 nmin1_2290) (< nmin1_2290 n_2259)) (> aux_primed 0)))))
