...
(assert (exists ((min_2277 Int)) (and (= nmin (+ 1 min_2277)) (or (and (= min_2277 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2277 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
