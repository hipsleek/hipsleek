...
;Axioms assertions
;Antecedent
(assert (exists ((min_2057 Int)) (or (and (= min_2057 nmin1_2020) (< nmin1_2020 nmin2_2022)) (and (= min_2057 nmin2_2022) (>= nmin1_2020 nmin2_2022)))))
...
(assert (exists ((min_2056 Int)) (and (= nmin (+ 1 min_2056)) (or (and (= min_2056 nmin1_1899) (< nmin1_1899 nmin2_1901)) (and (= min_2056 nmin2_1901) (>= nmin1_1899 nmin2_1901))))))
