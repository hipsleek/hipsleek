...
(declare-fun right_103_1395_primed () Int)
(declare-fun left_103_1394_primed () Int)
(declare-fun val_103_1393_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_103_1395_primed r_2689))
(assert (= left_103_1394_primed l_2687))
(assert (= val_103_1393_primed Anon_2686))
