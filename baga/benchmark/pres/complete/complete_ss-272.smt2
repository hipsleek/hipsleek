...
;Axioms assertions
;Antecedent
(assert (exists ((min_2413 Int)) (or (and (= min_2413 nmin1_2369) (< nmin1_2369 nmin2_2371)) (and (= min_2413 nmin2_2371) (>= nmin1_2369 nmin2_2371)))))
...
(assert (exists ((min_2412 Int)) (and (= nmin (+ 1 min_2412)) (or (and (= min_2412 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2412 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
