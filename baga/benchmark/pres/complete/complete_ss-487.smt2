...
(assert (exists ((min_2639 Int)) (or (and (= min_2639 nmin1_2600) (< nmin1_2600 nmin2_2602)) (and (= min_2639 nmin2_2602) (>= nmin1_2600 nmin2_2602)))))
(assert (= nmin2_2602 nmin1_2362))
(assert (= nmin1_2600 nmin_2302))
(assert (exists ((min_2638 Int)) (and (= nmin (+ 1 min_2638)) (or (and (= min_2638 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2638 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
;Negation of Consequence
(assert (not (or (and (and (<= nmin (+ nmin1_2600 1)) (<= nmin1_2600 nmin)) (< nmin1_2600 nmin2_2602)) (and (and (<= nmin (+ nmin2_2602 1)) (<= nmin2_2602 nmin)) (<= nmin2_2602 nmin1_2600)))))
(check-sat)