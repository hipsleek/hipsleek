...
(declare-fun nmin_2307 () Int)
(declare-fun n_2306 () Int)
...
(assert (= res n_2301))
(assert (= n_2306 n_2301))
(assert (= nmin_2307 nmin_2302))
(assert (<= 0 nmin_2302))
...
(assert (or (and (and (<= 1 nmin_2307) (<= nmin_2307 n_2306)) (> v_node2_103_1392_primed 0)) (or (and (and (< v_node2_103_1392_primed 1) (= n_2306 0)) (= nmin_2307 0)) (and (and (<= 1 nmin_2307) (< nmin_2307 n_2306)) (> v_node2_103_1392_primed 0)))))
