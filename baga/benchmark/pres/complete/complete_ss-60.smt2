...
;Axioms assertions
;Antecedent
(assert (exists ((min_1766 Int)) (or (and (= min_1766 nmin1_1724) (< nmin1_1724 nmin2_1726)) (and (= min_1766 nmin2_1726) (>= nmin1_1724 nmin2_1726)))))
...
(assert (exists ((min_1765 Int)) (and (= nmin (+ 1 min_1765)) (or (and (= min_1765 nmin1_1660) (< nmin1_1660 nmin2_1662)) (and (= min_1765 nmin2_1662) (>= nmin1_1660 nmin2_1662))))))
