...
(declare-fun right_106_1416_primed () Int)
(declare-fun left_106_1415_primed () Int)
(declare-fun l_2687 () Int)
(declare-fun val_106_1414_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_106_1416_primed r_2689))
(assert (= left_106_1415_primed l_2687))
(assert (= val_106_1414_primed Anon_2686))
...
(assert (or (and (and (<= 1 nmin1_2826) (<= nmin1_2826 flted_79_2825)) (> aux_primed 0)) (or (and (and (< aux_primed 1) (= flted_79_2825 0)) (= nmin1_2826 0)) (and (and (<= 1 nmin1_2826) (< nmin1_2826 flted_79_2825)) (> aux_primed 0)))))
