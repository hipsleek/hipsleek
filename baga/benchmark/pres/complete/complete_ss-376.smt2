...
;Axioms assertions
;Antecedent
(assert (exists ((min_2635 Int)) (or (and (= min_2635 nmin1_2600) (< nmin1_2600 nmin2_2602)) (and (= min_2635 nmin2_2602) (>= nmin1_2600 nmin2_2602)))))
...
(assert (exists ((min_2634 Int)) (and (= nmin (+ 1 min_2634)) (or (and (= min_2634 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2634 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
