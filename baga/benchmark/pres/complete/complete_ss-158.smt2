...
;Axioms assertions
;Antecedent
(assert (exists ((min_2005 Int)) (or (and (= min_2005 nmin1_1955) (< nmin1_1955 nmin2_1957)) (and (= min_2005 nmin2_1957) (>= nmin1_1955 nmin2_1957)))))
...
(assert (exists ((min_2004 Int)) (and (= nmin (+ 1 min_2004)) (or (and (= min_2004 nmin1_1891) (< nmin1_1891 nmin2_1893)) (and (= min_2004 nmin2_1893) (>= nmin1_1891 nmin2_1893))))))
