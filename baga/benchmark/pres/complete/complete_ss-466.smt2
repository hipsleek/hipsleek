...
(assert (<= 0 nmin1_2688))
(assert (= nmin n))
(assert (exists ((min_2940 Int)) (or (and (= min_2940 nmin1_2892) (< nmin1_2892 nmin2_2894)) (and (= min_2940 nmin2_2894) (>= nmin1_2892 nmin2_2894)))))
(assert (<= n_2705 nmin_2694))
(assert (= (+ flted_26_2685 1) n))
(assert (= (+ flted_26_2684 1) n))
(assert (exists ((min_2939 Int)) (and (= nmin (+ 1 min_2939)) (or (and (= min_2939 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2939 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
...
(assert (not (= (+ 2 n_2787) (+ 1 flted_79_2825))))
(check-sat)