...
(assert (exists ((min_2465 Int)) (and (= nmin (+ 1 min_2465)) (or (and (= min_2465 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2465 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
(assert (< nmin n))
...
(assert (not (= (+ 1 n_2176) (+ 1 flted_26_2122))))
(check-sat)