...
(assert (exists ((min_2348 Int)) (and (= nmin (+ 1 min_2348)) (or (and (= min_2348 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2348 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (or (= n_2313 0) (or (= nmin_2314 0) (< r_2119 1)))))
(check-sat)