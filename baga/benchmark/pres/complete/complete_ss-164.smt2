...
(declare-fun right_95_1356_primed () Int)
(declare-fun left_95_1355_primed () Int)
(declare-fun val_95_1354_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_95_1356_primed r_2119))
(assert (= left_95_1355_primed l_2117))
(assert (= val_95_1354_primed Anon_2116))
