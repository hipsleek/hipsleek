...
(declare-fun nmin_2781 () Int)
(declare-fun n_2780 () Int)
...
(assert (= res n_2775))
(assert (= n_2780 n_2775))
(assert (= nmin_2781 nmin_2776))
(assert (<= 0 nmin_2776))
...
(assert (or (and (and (<= 1 nmin_2781) (<= nmin_2781 n_2780)) (> v_node2_103_1392_primed 0)) (or (and (and (< v_node2_103_1392_primed 1) (= n_2780 0)) (= nmin_2781 0)) (and (and (<= 1 nmin_2781) (< nmin_2781 n_2780)) (> v_node2_103_1392_primed 0)))))
