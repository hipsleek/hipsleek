...
;Axioms assertions
;Antecedent
(assert (exists ((min_2525 Int)) (or (and (= min_2525 nmin1_2481) (< nmin1_2481 nmin2_2483)) (and (= min_2525 nmin2_2483) (>= nmin1_2481 nmin2_2483)))))
(assert (= (+ n_2150 1) (+ n_2259 2)))
...
(assert (exists ((min_2524 Int)) (and (= nmin (+ 1 min_2524)) (or (and (= min_2524 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2524 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
(assert (< nmin n))
