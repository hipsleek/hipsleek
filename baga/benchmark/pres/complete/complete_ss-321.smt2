...
(declare-fun right_102_1384_primed () Int)
(declare-fun left_102_1383_primed () Int)
(declare-fun val_102_1382_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_102_1384_primed r_2119))
(assert (= left_102_1383_primed l_2117))
(assert (= val_102_1382_primed Anon_2116))
