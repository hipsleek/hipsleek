...
;Axioms assertions
;Antecedent
(assert (exists ((min_1824 Int)) (or (and (= min_1824 nmin1_1789) (< nmin1_1789 nmin2_1791)) (and (= min_1824 nmin2_1791) (>= nmin1_1789 nmin2_1791)))))
...
(assert (exists ((min_1823 Int)) (and (= nmin (+ 1 min_1823)) (or (and (= min_1823 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1823 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
