...
(declare-fun right_110_1419_primed () Int)
(declare-fun left_110_1418_primed () Int)
(declare-fun val_110_1417_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_110_1419_primed r_2119))
(assert (= left_110_1418_primed l_2117))
(assert (= val_110_1417_primed Anon_2116))
