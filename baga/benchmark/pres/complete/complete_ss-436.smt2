...
(assert (exists ((min_2817 Int)) (and (= nmin (+ 1 min_2817)) (or (and (= min_2817 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2817 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
