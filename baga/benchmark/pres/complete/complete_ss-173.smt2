...
(declare-fun nmin_2225 () Int)
(declare-fun n_2224 () Int)
...
(assert (= res nmin_2217))
(assert (= n_2224 n_2216))
(assert (= nmin_2225 nmin_2217))
(assert (<= 0 nmin_2217))
...
(assert (or (and (and (<= 1 nmin_2225) (<= nmin_2225 n_2224)) (> v_node2_95_1360_primed 0)) (or (and (and (< v_node2_95_1360_primed 1) (= n_2224 0)) (= nmin_2225 0)) (and (and (<= 1 nmin_2225) (< nmin_2225 n_2224)) (> v_node2_95_1360_primed 0)))))
