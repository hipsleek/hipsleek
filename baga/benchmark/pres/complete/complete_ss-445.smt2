...
(assert (exists ((min_2916 Int)) (and (= nmin (+ 1 min_2916)) (or (and (= min_2916 nmin1_2688) (< nmin1_2688 nmin2_2690)) (and (= min_2916 nmin2_2690) (>= nmin1_2688 nmin2_2690))))))
...
(assert (not (= (+ 1 flted_79_2825) (+ 2 n_2787))))
(check-sat)