...
(assert (exists ((min_2566 Int)) (and (= nmin (+ 1 min_2566)) (or (and (= min_2566 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2566 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
...
(assert (not (or (= n_2150 0) (or (= nmin_2151 0) (< l_2125 1)))))
(check-sat)