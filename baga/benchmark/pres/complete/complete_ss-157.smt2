...
(assert (exists ((min_2003 Int)) (or (and (= min_2003 nmin1_1955) (< nmin1_1955 nmin2_1957)) (and (= min_2003 nmin2_1957) (>= nmin1_1955 nmin2_1957)))))
(assert (= nmin2_1957 nmin_1924))
(assert (= nmin1_1955 nmin_1906))
(assert (exists ((min_2002 Int)) (and (= nmin (+ 1 min_2002)) (or (and (= min_2002 nmin1_1891) (< nmin1_1891 nmin2_1893)) (and (= min_2002 nmin2_1893) (>= nmin1_1891 nmin2_1893))))))
;Negation of Consequence
(assert (not (or (and (= (+ nmin2_1957 1) nmin) (<= nmin (+ 1 nmin1_1955))) (and (= nmin (+ 1 nmin1_1955)) (< nmin1_1955 nmin2_1957)))))
(check-sat)