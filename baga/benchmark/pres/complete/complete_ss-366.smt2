...
(assert (exists ((min_2405 Int)) (and (= nmin (+ 1 min_2405)) (or (and (= min_2405 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2405 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (or (= n_2176 0) (or (= nmin1_2206 0) (< aux_2364 1)))))
(check-sat)