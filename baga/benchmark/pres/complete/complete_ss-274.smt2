...
;Axioms assertions
;Antecedent
(assert (exists ((min_2417 Int)) (or (and (= min_2417 nmin1_2369) (< nmin1_2369 nmin2_2371)) (and (= min_2417 nmin2_2371) (>= nmin1_2369 nmin2_2371)))))
(assert (<= 0 nmin1_2206))
(assert (<= 0 nmin2_2120))
(assert (<= 0 nmin_2177))
...
(assert (< nmin n))
(assert (exists ((min_2416 Int)) (and (= nmin (+ 1 min_2416)) (or (and (= min_2416 nmin1_2118) (< nmin1_2118 nmin2_2120)) (and (= min_2416 nmin2_2120) (>= nmin1_2118 nmin2_2120))))))
...
(assert (not (= (+ 2 flted_25_2114) (+ 1 n_2176))))
(check-sat)