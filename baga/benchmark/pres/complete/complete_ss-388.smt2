...
(declare-fun nmin_2711 () Int)
(declare-fun n_2710 () Int)
...
(assert (= res n_2705))
(assert (= n_2710 n_2705))
(assert (= nmin_2711 nmin_2706))
(assert (<= 0 nmin_2706))
...
(assert (or (and (and (<= 1 nmin_2711) (<= nmin_2711 n_2710)) (> v_node2_88_1339_primed 0)) (or (and (and (< v_node2_88_1339_primed 1) (= n_2710 0)) (= nmin_2711 0)) (and (and (<= 1 nmin_2711) (< nmin_2711 n_2710)) (> v_node2_88_1339_primed 0)))))
