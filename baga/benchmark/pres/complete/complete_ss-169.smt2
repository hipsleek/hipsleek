...
(declare-fun nmin_2222 () Int)
(declare-fun n_2221 () Int)
...
(assert (= n_2221 n_2216))
(assert (= nmin_2222 nmin_2217))
(assert (<= 0 nmin_2217))
...
(assert (or (and (and (<= 1 nmin_2222) (<= nmin_2222 n_2221)) (> v_node2_95_1360_primed 0)) (or (and (and (< v_node2_95_1360_primed 1) (= n_2221 0)) (= nmin_2222 0)) (and (and (<= 1 nmin_2222) (< nmin_2222 n_2221)) (> v_node2_95_1360_primed 0)))))
