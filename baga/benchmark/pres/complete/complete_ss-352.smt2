...
;Axioms assertions
;Antecedent
(assert (exists ((min_2587 Int)) (or (and (= min_2587 nmin1_2544) (< nmin1_2544 nmin2_2546)) (and (= min_2587 nmin2_2546) (>= nmin1_2544 nmin2_2546)))))
...
(assert (exists ((min_2586 Int)) (and (= nmin (+ 1 min_2586)) (or (and (= min_2586 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2586 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
