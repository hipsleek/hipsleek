...
(assert (= res n_2150))
(assert (= n_2158 n_2150))
(assert (= nmin_2159 nmin_2151))
(assert (<= 0 nmin_2151))
...
(assert (or (and (and (<= 1 nmin_2159) (<= nmin_2159 n_2158)) (> v_node2_88_1339_primed 0)) (or (and (and (< v_node2_88_1339_primed 1) (= n_2158 0)) (= nmin_2159 0)) (and (and (<= 1 nmin_2159) (< nmin_2159 n_2158)) (> v_node2_88_1339_primed 0)))))
