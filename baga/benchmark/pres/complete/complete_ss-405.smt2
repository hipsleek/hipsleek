...
;Axioms assertions
;Antecedent
(assert (exists ((min_2475 Int)) (or (and (= min_2475 nmin1_2432) (< nmin1_2432 nmin2_2434)) (and (= min_2475 nmin2_2434) (>= nmin1_2432 nmin2_2434)))))
...
(assert (exists ((min_2474 Int)) (and (= nmin (+ 1 min_2474)) (or (and (= min_2474 nmin1_2126) (< nmin1_2126 nmin2_2128)) (and (= min_2474 nmin2_2128) (>= nmin1_2126 nmin2_2128))))))
