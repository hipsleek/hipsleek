...
(declare-fun nmin_2138 () Int)
(declare-fun n_2137 () Int)
...
(assert (= n_2137 n_2132))
(assert (= nmin_2138 nmin_2133))
(assert (<= 0 nmin_2133))
...
(assert (or (and (and (<= 1 nmin_2138) (<= nmin_2138 n_2137)) (> v_node2_88_1332_primed 0)) (or (and (and (< v_node2_88_1332_primed 1) (= n_2137 0)) (= nmin_2138 0)) (and (and (<= 1 nmin_2138) (< nmin_2138 n_2137)) (> v_node2_88_1332_primed 0)))))
