...
(assert (exists ((min_1830 Int)) (or (and (= min_1830 nmin1_1789) (< nmin1_1789 nmin2_1791)) (and (= min_1830 nmin2_1791) (>= nmin1_1789 nmin2_1791)))))
(assert (= nmin2_1791 nmin_1693))
(assert (= nmin1_1789 nmin_1675))
(assert (exists ((min_1829 Int)) (and (= nmin (+ 1 min_1829)) (or (and (= min_1829 nmin1_1668) (< nmin1_1668 nmin2_1670)) (and (= min_1829 nmin2_1670) (>= nmin1_1668 nmin2_1670))))))
;Negation of Consequence
(assert (not (or (and (= (+ nmin2_1791 1) nmin) (<= nmin (+ 1 nmin1_1789))) (and (= nmin (+ 1 nmin1_1789)) (< nmin1_1789 nmin2_1791)))))
(check-sat)