...
;Axioms assertions
;Antecedent
(assert (exists ((min_2055 Int)) (or (and (= min_2055 nmin1_2020) (< nmin1_2020 nmin2_2022)) (and (= min_2055 nmin2_2022) (>= nmin1_2020 nmin2_2022)))))
...
(assert (exists ((min_2054 Int)) (and (= nmin (+ 1 min_2054)) (or (and (= min_2054 nmin1_1899) (< nmin1_1899 nmin2_1901)) (and (= min_2054 nmin2_1901) (>= nmin1_1899 nmin2_1901))))))
