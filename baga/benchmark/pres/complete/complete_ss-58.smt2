...
(declare-fun right_71_1466_primed () Int)
(declare-fun left_71_1465_primed () Int)
(declare-fun val_71_1464_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_71_1466_primed r_1892))
(assert (= left_71_1465_primed l_1890))
(assert (= val_71_1464_primed Anon_1889))
