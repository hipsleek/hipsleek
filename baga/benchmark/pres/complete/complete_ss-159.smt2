...
;Axioms assertions
;Antecedent
(assert (exists ((min_2007 Int)) (or (and (= min_2007 nmin1_1955) (< nmin1_1955 nmin2_1957)) (and (= min_2007 nmin2_1957) (>= nmin1_1955 nmin2_1957)))))
...
(assert (<= 0 nmin_1924))
(assert (exists ((min_2006 Int)) (and (= nmin (+ 1 min_2006)) (or (and (= min_2006 nmin1_1891) (< nmin1_1891 nmin2_1893)) (and (= min_2006 nmin2_1893) (>= nmin1_1891 nmin2_1893))))))
