...
(declare-fun sm_2333 () Int)
(declare-fun bg_2334 () Int)
(declare-fun n_2332 () Int)
...
(assert (> xs_primed 0))
(assert (= res n_2312))
(assert (= n_2332 n_2312))
(assert (= sm_2333 sm_2313))
(assert (= bg_2334 bg_2314))
(assert (<= 0 n_2312))
(assert (or (and (< xs_primed 1) (= n_2332 0)) (and (and (<= sm_2333 bg_2334) (<= 1 n_2332)) (> xs_primed 0))))
