...
(declare-fun smres_2361 () Int)
(declare-fun bgres_2362 () Int)
(declare-fun n_2360 () Int)
(declare-fun res () Int)
...
(assert (<= 0 n2_2359))
(assert (<= sm_2355 smres_2361))
(assert (<= bgres_2362 bg_2356))
(assert (= n_2360 n_2354))
(assert (<= 0 n_2354))
(assert (or (and (< xs_primed 1) (= middle_primed 0)) (and (and (<= sm_2340 bg_2341) (<= 1 middle_primed)) (> xs_primed 0))))
(assert (or (and (and (= bgres_2362 smres_2361) (= n_2360 1)) (> res 0)) (and (and (<= smres_2361 bgres_2362) (<= 2 n_2360)) (> res 0))))
