...
(assert (or (and (= s3_2382 s1) (< s1 s2_primed)) (and (= s3_2382 s2_primed) (>= s1 s2_primed))))
...
(assert (<= s2_primed b2))
(assert (> s3_primed 0))
(assert (or (and (and (= b3_2383 s3_2382) (= flted_90_2381 1)) (> res 0)) (and (and (<= s3_2382 b3_2383) (<= 2 flted_90_2381)) (> res 0))))
