...
(declare-fun flted_19_1612 () Int)
(declare-fun tx_1611 () Int)
(declare-fun y () Int)
(declare-fun r_1614 () Int)
(declare-fun tx_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= (+ flted_19_1612 1) m))
(assert (> r_1614 0))
(assert (= tx_1611 ty_1403))
...
(assert (= y 1))
(assert (or (and (and (= flted_19_1612 1) (= r_1614 tx_1611)) (> tx_1611 0)) (and (and (<= 2 flted_19_1612) (> tx_1611 0)) (> r_1614 0))))
(assert (= tx_primed 2))
(assert (not (= y tx_primed)))
(assert (not (= y r_1614)))
(assert (not (= r_1614 tx_primed)))
