...
(declare-fun flted_19_1712 () Int)
(declare-fun tx_1711 () Int)
(declare-fun y () Int)
(declare-fun r_1714 () Int)
(declare-fun tx_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= (+ flted_19_1712 1) m))
(assert (> r_1714 0))
(assert (= tx_1711 ty_1403))
...
(assert (= n2_1642 0))
(assert (= y 1))
(assert (or (and (and (= flted_19_1712 1) (= r_1714 tx_1711)) (> tx_1711 0)) (and (and (<= 2 flted_19_1712) (> tx_1711 0)) (> r_1714 0))))
(assert (= tx_primed 2))
(assert (not (= y tx_primed)))
(assert (not (= y r_1714)))
(assert (not (= r_1714 tx_primed)))
