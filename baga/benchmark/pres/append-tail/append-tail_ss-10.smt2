...
(assert (not (= r_1722 tx_primed)))
(assert (not (= r_1722 x)))
(assert (not (= y r_1722)))
(assert (> r_1722 0))
(assert (= tx_1719 ty_1403))
(assert (= (+ flted_19_1720 1) m))
(assert (or (and (and (= flted_19_1720 1) (= r_1722 tx_1719)) (> tx_1719 0)) (and (and (<= 2 flted_19_1720) (> tx_1719 0)) (> r_1722 0))))
;Negation of Consequence
(assert (not (= flted_19_1720 1)))
(check-sat)