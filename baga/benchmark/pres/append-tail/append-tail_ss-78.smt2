...
;Axioms assertions
;Antecedent
(assert (= (+ flted_23_1733 1) flted_19_1720))
(assert (< flted_23_1732 1))
(assert (= n2_1642 0))
...
(assert (or (and (= tx_1719 r_1722) (= flted_23_1733 0)) (and (<= 1 flted_23_1733) (> r_1722 0))))
(assert (= tx_1719 1))
(assert (= y 2))
(assert (= tx_primed 3))
(assert (not (= tx_1719 tx_primed)))
(assert (not (= tx_1719 y)))
