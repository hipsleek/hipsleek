...
(assert (exists ((mi_1894 Int)) (and (and (< mi_1894 l_1793) (<= s_1792 mi_1894)) (or (and (= mi_1894 d_1864) (< d_1864 tmi_1866)) (and (= mi_1894 tmi_1866) (>= d_1864 tmi_1866))))))
(assert (< mi l))
(assert (<= s mi))
