...
(assert (exists ((mi_1932 Int)) (and (and (< mi_1932 l_1793) (<= s_1792 mi_1932)) (or (and (= mi_1932 d_1904) (< d_1904 tmi_1906)) (and (= mi_1932 tmi_1906) (>= d_1904 tmi_1906))))))
(assert (<= s_1792 d_1904))
(assert (= d_1904 d_1773))
(assert (= s_1792 sm_1770))
(assert (<= s_1792 mi_1794))
;Negation of Consequence
(assert (not (<= s_1792 d_1904)))
(check-sat)