...
(assert (exists ((mi_1890 Int)) (and (and (< mi_1890 l_1793) (<= s_1792 mi_1890)) (or (and (= mi_1890 d_1864) (< d_1864 tmi_1866)) (and (= mi_1890 tmi_1866) (>= d_1864 tmi_1866))))))
(assert (<= s_1792 d_1864))
(assert (= d_1864 d_1773))
(assert (= l_1793 bg_1771))
(assert (< mi_1794 l_1793))
;Negation of Consequence
(assert (not (< d_1864 l_1793)))
(check-sat)