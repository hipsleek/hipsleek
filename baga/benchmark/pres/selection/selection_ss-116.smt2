...
(assert (exists ((mi_1936 Int)) (and (and (< mi_1936 l_1793) (<= s_1792 mi_1936)) (or (and (= mi_1936 d_1904) (< d_1904 tmi_1906)) (and (= mi_1936 tmi_1906) (>= d_1904 tmi_1906))))))
...
(assert (not (or (and (= mi d_1904) (< d_1904 tmi_1906)) (and (= mi tmi_1906) (>= d_1904 tmi_1906)))))
(check-sat)