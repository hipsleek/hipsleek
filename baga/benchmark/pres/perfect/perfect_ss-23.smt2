...
(declare-fun right_50_1387_primed () Int)
(declare-fun left_50_1386_primed () Int)
(declare-fun flag_50_1385_primed () Int)
(declare-fun val_50_1384_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_50_1387_primed r_1594))
(assert (= left_50_1386_primed l_1593))
(assert (= flag_50_1385_primed Anon_1592))
(assert (= val_50_1384_primed Anon_1591))
(assert (= t_primed t))
(assert (= a_primed a))
(assert (> t_primed 0))
