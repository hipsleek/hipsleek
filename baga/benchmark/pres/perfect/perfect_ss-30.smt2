...
(declare-fun n_1633 () Int)
(declare-fun v_node2_53_1398_primed () Int)
...
(assert (= v_node2_53_1398_primed r_1594))
(assert (= n_1628 flted_28_1589))
(assert (<= 0 flted_28_1589))
(assert (= n_1633 n_1628))
(assert (<= 0 n_1628))
(assert (= t_primed 1))
(assert (or (and (< l_1593 1) (= n_1616 0)) (and (<= 1 n_1616) (> l_1593 0))))
(assert (or (and (< v_node2_53_1398_primed 1) (= n_1633 0)) (and (<= 1 n_1633) (> v_node2_53_1398_primed 0))))
