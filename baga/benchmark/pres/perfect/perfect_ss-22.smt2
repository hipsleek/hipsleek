...
(declare-fun right_46_1382_primed () Int)
(declare-fun left_46_1381_primed () Int)
(declare-fun flag_46_1380_primed () Int)
(declare-fun val_46_1379_primed () Int)
(declare-fun v_int_46_1378_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_46_1382_primed r_1594))
(assert (= left_46_1381_primed l_1593))
(assert (= flag_46_1380_primed Anon_1592))
(assert (= val_46_1379_primed a_primed))
(assert (= v_int_46_1378_primed 1))
