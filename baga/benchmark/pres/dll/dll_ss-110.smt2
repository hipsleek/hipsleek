...
(declare-fun next_41_1647_primed () Int)
(declare-fun prev_41_1646_primed () Int)
(declare-fun val_41_1645_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= next_41_1647_primed q_2380))
(assert (= prev_41_1646_primed p_2376))
(assert (= val_41_1645_primed Anon_2379))
...
(assert (= self_2377 v_node2_41_1644_primed))
