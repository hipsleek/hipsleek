...
(declare-fun next_163_1457_primed () Int)
(declare-fun prev_163_1456_primed () Int)
(declare-fun val_163_1455_primed () Int)
(declare-fun Anon_1808 () Int)
(declare-fun v_null_type_163_1454_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= next_163_1457_primed q_1809))
(assert (= prev_163_1456_primed p_1805))
(assert (= val_163_1455_primed Anon_1808))
(assert (< v_null_type_163_1454_primed 1))
(assert (<= 0 n_1816))
(assert (<= 0 m_1814))
