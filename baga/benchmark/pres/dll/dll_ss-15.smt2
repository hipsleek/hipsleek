...
(declare-fun p_1849 () Int)
(declare-fun Anon_1829 () Int)
(declare-fun self_1850 () Int)
...
(declare-fun flted_12_1851 () Int)
(declare-fun q_1853 () Int)
(declare-fun tmp_primed () Int)
(declare-fun x_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= (+ flted_12_1851 1) flted_144_1828))
(assert (= p_1849 Anon_1829))
(assert (= self_1850 tmp_primed))
...
(assert (= tmp_primed 1))
(assert (or (and (< q_1853 1) (= flted_12_1851 0)) (and (<= 1 flted_12_1851) (> q_1853 0))))
(assert (= x_primed 2))
(assert (not (= tmp_primed x_primed)))
