...
(declare-fun next_184_1414_primed () Int)
(declare-fun q_1948 () Int)
(declare-fun prev_184_1413_primed () Int)
(declare-fun val_184_1412_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= next_184_1414_primed q_1948))
(assert (= prev_184_1413_primed p_1944))
(assert (= val_184_1412_primed Anon_1947))
