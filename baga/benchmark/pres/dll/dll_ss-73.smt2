...
(declare-fun p_2153 () Int)
(declare-fun self_2154 () Int)
(declare-fun n () Int)
...
(declare-fun flted_12_2155 () Int)
(declare-fun q_2157 () Int)
(declare-fun q_2079 () Int)
(declare-fun x_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= (+ flted_12_2155 1) flted_12_2077))
(assert (= p_2153 self_2076))
(assert (= self_2154 q_2079))
(assert (= n 0))
(assert (< y_primed 1))
...
(assert (= q_2079 1))
(assert (or (and (< q_2157 1) (= flted_12_2155 0)) (and (<= 1 flted_12_2155) (> q_2157 0))))
(assert (= x_primed 2))
