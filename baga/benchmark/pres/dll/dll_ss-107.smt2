...
(declare-fun next_41_1643_primed () Int)
(declare-fun prev_41_1642_primed () Int)
(declare-fun val_41_1641_primed () Int)
(declare-fun Anon_2336 () Int)
(declare-fun v_node2_41_1640_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= next_41_1643_primed q_2337))
(assert (= prev_41_1642_primed p_2333))
(assert (= val_41_1641_primed Anon_2336))
(assert (= v_node2_41_1640_primed q_2309))
