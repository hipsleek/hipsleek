...
(declare-fun next_160_1453_primed () Int)
(declare-fun prev_160_1452_primed () Int)
(declare-fun val_160_1451_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= next_160_1453_primed q_1859))
(assert (= prev_160_1452_primed p_1855))
(assert (= val_160_1451_primed Anon_1858))
