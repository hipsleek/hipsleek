...
(declare-fun v_null_type_163_1897 () Int)
(declare-fun next_163_1864 () Int)
(declare-fun q_1809 () Int)
(declare-fun res () Int)
(declare-fun x_primed () Int)
(declare-fun flted_144_1826 () Int)
(declare-fun tmp_1898 () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= q_1902 v_null_type_163_1897))
(assert (= Anon_1901 Anon_1808))
...
(assert (<= 0 m_1814))
(assert (<= 0 n_1816))
(assert (< v_null_type_163_1897 1))
(assert (= next_163_1864 q_1809))
(assert (= res x_primed))
(assert (or (and (< tmp_1898 1) (= flted_144_1826 0)) (and (<= 1 flted_144_1826) (> tmp_1898 0))))
