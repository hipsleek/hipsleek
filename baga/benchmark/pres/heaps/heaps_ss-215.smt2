...
(declare-fun right_166_1515_primed () Int)
(declare-fun left_166_1514_primed () Int)
(declare-fun nright_166_1513_primed () Int)
(declare-fun nleft_166_1512_primed () Int)
(declare-fun val_166_1511_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_166_1515_primed r_2532))
(assert (= left_166_1514_primed l_2529))
(assert (= nright_166_1513_primed m2_2533))
(assert (= nleft_166_1512_primed m1_2530))
(assert (= val_166_1511_primed d_2528))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
(assert (= m2_primed m2))
