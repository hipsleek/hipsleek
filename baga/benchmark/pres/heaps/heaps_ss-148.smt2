...
(declare-fun right_171_1527_primed () Int)
(declare-fun left_171_1526_primed () Int)
(declare-fun nright_171_1525_primed () Int)
(declare-fun nleft_171_1524_primed () Int)
(declare-fun val_171_1523_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_171_1527_primed r_2532))
(assert (= left_171_1526_primed l_2529))
(assert (= nright_171_1525_primed m2_2533))
(assert (= nleft_171_1524_primed m1_2530))
(assert (= val_171_1523_primed d_2528))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
(assert (= m2_primed m2))
