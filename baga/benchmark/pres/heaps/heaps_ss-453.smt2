...
(declare-fun right_53_1881_primed () Int)
(declare-fun left_53_1880_primed () Int)
(declare-fun nright_53_1879_primed () Int)
(declare-fun nleft_53_1878_primed () Int)
(declare-fun val_53_1877_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_53_1881_primed r_3853))
(assert (= left_53_1880_primed l_3850))
(assert (= nright_53_1879_primed m2_3854))
(assert (= nleft_53_1878_primed m1_3851))
(assert (= val_53_1877_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
