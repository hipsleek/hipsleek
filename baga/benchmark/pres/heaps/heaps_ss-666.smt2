...
(declare-fun right_62_1931_primed () Int)
(declare-fun left_62_1930_primed () Int)
(declare-fun nright_62_1929_primed () Int)
(declare-fun nleft_62_1928_primed () Int)
(declare-fun val_62_1927_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_62_1931_primed r_3853))
(assert (= left_62_1930_primed l_3850))
(assert (= nright_62_1929_primed m2_3854))
(assert (= nleft_62_1928_primed m1_3851))
(assert (= val_62_1927_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
