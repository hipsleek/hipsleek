...
;Axioms assertions
;Antecedent
(assert (= right_48_1876_primed v_node_44_3944))
(assert (= left_48_1875_primed l_3850))
(assert (= nright_48_1874_primed v_int_46_3961))
(assert (= nleft_48_1873_primed m1_3851))
(assert (= val_48_1872_primed d_3849))
(assert (= nright_46_3955 m2_3854))
(assert (= v_int_46_3961 (+ 1 tmpv_primed)))
