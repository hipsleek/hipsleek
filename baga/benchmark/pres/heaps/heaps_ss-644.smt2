...
(declare-fun right_53_1886_primed () Int)
(declare-fun left_53_1885_primed () Int)
(declare-fun nright_53_1884_primed () Int)
(declare-fun nleft_53_1883_primed () Int)
(declare-fun val_53_1882_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_53_1886_primed r_3853))
(assert (= left_53_1885_primed l_3850))
(assert (= nright_53_1884_primed m2_3854))
(assert (= nleft_53_1883_primed m1_3851))
(assert (= val_53_1882_primed d_3849))
