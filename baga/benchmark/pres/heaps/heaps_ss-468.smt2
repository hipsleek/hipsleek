...
(declare-fun ma_3989 () Int)
(declare-fun n1_3988 () Int)
(declare-fun res () Int)
...
(assert (<= 0 m1_3846))
(assert (<= 0 mx1_3852))
(assert (= n1_3988 (+ 1 n_3982)))
(assert (or (and (<= mx_3983 v_primed) (= ma_3989 v_primed)) (= ma_3989 mx_3983)))
(assert (<= 0 n_3982))
(assert (<= 0 mx_3983))
(assert (= t_primed 1))
(assert (or (and (and (< r_3853 1) (= m2_3847 0)) (= mx2_3855 0)) (and (and (<= 0 mx2_3855) (<= 1 m2_3847)) (> r_3853 0))))
(assert (or (and (and (< res 1) (= n1_3988 0)) (= ma_3989 0)) (and (and (<= 0 ma_3989) (<= 1 n1_3988)) (> res 0))))
