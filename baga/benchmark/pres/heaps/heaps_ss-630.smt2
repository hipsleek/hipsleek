...
(declare-fun right_43_1842_primed () Int)
(declare-fun left_43_1841_primed () Int)
(declare-fun nright_43_1840_primed () Int)
(declare-fun nleft_43_1839_primed () Int)
(declare-fun val_43_1838_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_43_1842_primed r_3853))
(assert (= left_43_1841_primed l_3850))
(assert (= nright_43_1840_primed m2_3854))
(assert (= nleft_43_1839_primed m1_3851))
(assert (= val_43_1838_primed d_3849))
