...
(declare-fun right_144_1420_primed () Int)
(declare-fun left_144_1419_primed () Int)
(declare-fun nright_144_1418_primed () Int)
(declare-fun nleft_144_1417_primed () Int)
(declare-fun val_144_1416_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_144_1420_primed r_2424))
(assert (= left_144_1419_primed l_2421))
(assert (= nright_144_1418_primed m2_2425))
(assert (= nleft_144_1417_primed m1_2422))
(assert (= val_144_1416_primed d_2420))
(assert (= m2_primed 0))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
