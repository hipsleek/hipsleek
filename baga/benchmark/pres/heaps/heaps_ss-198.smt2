...
(declare-fun right_161_1483_primed () Int)
(declare-fun left_161_1482_primed () Int)
(declare-fun nright_161_1481_primed () Int)
(declare-fun nleft_161_1480_primed () Int)
(declare-fun val_161_1479_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1483_primed r_2485))
(assert (= left_161_1482_primed l_2482))
(assert (= nright_161_1481_primed m2_2486))
(assert (= nleft_161_1480_primed m1_2483))
(assert (= val_161_1479_primed d_2481))
