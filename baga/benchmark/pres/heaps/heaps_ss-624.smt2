...
(declare-fun right_37_1820_primed () Int)
(declare-fun left_37_1819_primed () Int)
(declare-fun nright_37_1818_primed () Int)
(declare-fun nleft_37_1817_primed () Int)
(declare-fun val_37_1816_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_37_1820_primed r_3853))
(assert (= left_37_1819_primed v_node_36_3905))
(assert (= nright_37_1818_primed m2_3854))
(assert (= nleft_37_1817_primed m1_3851))
(assert (= val_37_1816_primed d_3849))
