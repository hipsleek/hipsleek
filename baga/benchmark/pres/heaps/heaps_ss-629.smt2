...
(declare-fun right_42_1837_primed () Int)
(declare-fun left_42_1836_primed () Int)
(declare-fun nright_42_1835_primed () Int)
(declare-fun nleft_42_1834_primed () Int)
(declare-fun val_42_1833_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_42_1837_primed r_3853))
(assert (= left_42_1836_primed l_3850))
(assert (= nright_42_1835_primed m2_3854))
(assert (= nleft_42_1834_primed m1_3851))
(assert (= val_42_1833_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
