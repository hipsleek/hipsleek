...
(declare-fun right_172_1537_primed () Int)
(declare-fun left_172_1536_primed () Int)
(declare-fun nright_172_1535_primed () Int)
(declare-fun nleft_172_1534_primed () Int)
(declare-fun val_172_1533_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_1537_primed r_2532))
(assert (= left_172_1536_primed l_2529))
(assert (= nright_172_1535_primed m2_2533))
(assert (= nleft_172_1534_primed m1_2530))
(assert (= val_172_1533_primed d_2528))
