...
(declare-fun right_191_1310_primed () Int)
(declare-fun left_191_1309_primed () Int)
(declare-fun nright_191_1308_primed () Int)
(declare-fun nleft_191_1307_primed () Int)
(declare-fun val_191_1306_primed () Int)
...
(declare-fun v_boolean_189_3286 () Int)
(declare-fun v_boolean_189_3285 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_191_1310_primed r_3247))
(assert (= left_191_1309_primed l_3244))
(assert (= nright_191_1308_primed m2_3248))
(assert (= nleft_191_1307_primed m1_3245))
(assert (= val_191_1306_primed d_3243))
(assert (= m2_3248 0))
(assert (< 0 n))
(assert (= t_primed t))
...
(assert (= m1_3245 0))
(assert (> v_boolean_189_3286 0))
(assert (> v_boolean_189_3285 0))
(assert (> v_bool_189_1327_primed 0))
