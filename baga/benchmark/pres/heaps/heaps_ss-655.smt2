...
(declare-fun right_55_1898_primed () Int)
(declare-fun left_55_1897_primed () Int)
(declare-fun nright_55_1896_primed () Int)
(declare-fun nleft_55_1895_primed () Int)
(declare-fun val_55_1894_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_55_1898_primed r_3853))
(assert (= left_55_1897_primed l_3850))
(assert (= nright_55_1896_primed m2_3854))
(assert (= nleft_55_1895_primed m1_3851))
(assert (= val_55_1894_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
