...
(declare-fun right_82_1703_primed () Int)
(declare-fun left_82_1702_primed () Int)
(declare-fun nright_82_1701_primed () Int)
(declare-fun nleft_82_1700_primed () Int)
(declare-fun val_82_1699_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_82_1703_primed r_2051))
(assert (= left_82_1702_primed l_2048))
(assert (= nright_82_1701_primed m2_2052))
(assert (= nleft_82_1700_primed m1_2049))
(assert (= val_82_1699_primed d_2047))
