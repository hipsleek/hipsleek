...
(declare-fun right_161_1478_primed () Int)
(declare-fun left_161_1477_primed () Int)
(declare-fun nright_161_1476_primed () Int)
(declare-fun nleft_161_1475_primed () Int)
(declare-fun val_161_1474_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1478_primed r_2485))
(assert (= left_161_1477_primed l_2482))
(assert (= nright_161_1476_primed m2_2486))
(assert (= nleft_161_1475_primed m1_2483))
(assert (= val_161_1474_primed d_2481))
