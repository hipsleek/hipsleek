...
(declare-fun right_34_1799_primed () Int)
(declare-fun left_34_1798_primed () Int)
(declare-fun nright_34_1797_primed () Int)
(declare-fun nleft_34_1796_primed () Int)
(declare-fun val_34_1795_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_34_1799_primed r_3853))
(assert (= left_34_1798_primed l_3850))
(assert (= nright_34_1797_primed m2_3854))
(assert (= nleft_34_1796_primed m1_3851))
(assert (= val_34_1795_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
