...
(declare-fun right_172_1552_primed () Int)
(declare-fun left_172_1551_primed () Int)
(declare-fun nright_172_1550_primed () Int)
(declare-fun nleft_172_1549_primed () Int)
(declare-fun val_172_1548_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_1552_primed r_2532))
(assert (= left_172_1551_primed l_2529))
(assert (= nright_172_1550_primed m2_2533))
(assert (= nleft_172_1549_primed m1_2530))
(assert (= val_172_1548_primed d_2528))
