...
(declare-fun right_48_1876_primed () Int)
(declare-fun left_48_1875_primed () Int)
(declare-fun nright_48_1874_primed () Int)
(declare-fun nleft_48_1873_primed () Int)
(declare-fun val_48_1872_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_48_1876_primed r_3853))
(assert (= left_48_1875_primed v_node_36_3905))
(assert (= nright_48_1874_primed m2_3854))
(assert (= nleft_48_1873_primed v_int_38_3960))
(assert (= val_48_1872_primed d_3849))
(assert (= nleft_38_3916 m1_3851))
(assert (= v_int_38_3960 (+ 1 tmpv_primed)))
