...
(declare-fun right_63_1942_primed () Int)
(declare-fun left_63_1941_primed () Int)
(declare-fun nright_63_1940_primed () Int)
(declare-fun nleft_63_1939_primed () Int)
(declare-fun val_63_1938_primed () Int)
...
(declare-fun v_node_63_1937_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_63_1942_primed r_3853))
(assert (= left_63_1941_primed l_3850))
(assert (= nright_63_1940_primed m2_3854))
(assert (= nleft_63_1939_primed m1_3851))
(assert (= val_63_1938_primed d_3849))
(assert (<= 0 mx_4018))
(assert (<= 0 n_4017))
...
(assert (or (and (and (< v_node_63_1937_primed 1) (= n1_4030 0)) (= ma_4031 0)) (and (and (<= 0 ma_4031) (<= 1 n1_4030)) (> v_node_63_1937_primed 0))))
