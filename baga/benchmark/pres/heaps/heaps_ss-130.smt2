...
(declare-fun right_161_1493_primed () Int)
(declare-fun left_161_1492_primed () Int)
(declare-fun nright_161_1491_primed () Int)
(declare-fun nleft_161_1490_primed () Int)
(declare-fun val_161_1489_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1493_primed r_2485))
(assert (= left_161_1492_primed l_2482))
(assert (= nright_161_1491_primed m2_2486))
(assert (= nleft_161_1490_primed m1_2483))
(assert (= val_161_1489_primed d_2481))
