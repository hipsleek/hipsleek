...
(declare-fun right_149_1437_primed () Int)
(declare-fun left_149_1436_primed () Int)
(declare-fun nright_149_1435_primed () Int)
(declare-fun nleft_149_1434_primed () Int)
(declare-fun val_149_1433_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_149_1437_primed r_2424))
(assert (= left_149_1436_primed l_2421))
(assert (= nright_149_1435_primed m2_2425))
(assert (= nleft_149_1434_primed m1_2422))
(assert (= val_149_1433_primed d_2420))
