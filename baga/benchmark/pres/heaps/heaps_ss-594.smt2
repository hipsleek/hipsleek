...
(declare-fun right_30_1771_primed () Int)
(declare-fun left_30_1770_primed () Int)
(declare-fun nright_30_1769_primed () Int)
(declare-fun nleft_30_1768_primed () Int)
(declare-fun val_30_1767_primed () Int)
(declare-fun t () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_30_1771_primed r_3853))
(assert (= left_30_1770_primed l_3850))
(assert (= nright_30_1769_primed m2_3854))
(assert (= nleft_30_1768_primed m1_3851))
(assert (= val_30_1767_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
