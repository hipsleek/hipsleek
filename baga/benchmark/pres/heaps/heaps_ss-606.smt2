...
(declare-fun right_32_1787_primed () Int)
(declare-fun left_32_1786_primed () Int)
(declare-fun nright_32_1785_primed () Int)
(declare-fun nleft_32_1784_primed () Int)
(declare-fun val_32_1783_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_32_1787_primed r_3853))
(assert (= left_32_1786_primed l_3850))
(assert (= nright_32_1785_primed m2_3854))
(assert (= nleft_32_1784_primed m1_3851))
(assert (= val_32_1783_primed d_3849))
