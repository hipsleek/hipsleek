...
(assert (= m1_3394 tnleft_primed))
(assert (= m2_3395 tnright_primed))
(assert (exists ((m2_65 Int)) (<= 0 m2_65)))
(assert (exists ((m1_64 Int)) (<= 0 m1_64)))
(assert (<= 0 mx1_3340))
(assert (<= 0 mx2_3341))
(assert (or (and (and (< tleft_primed 1) (= m1_3394 0)) (= mx3_3398 0)) (and (and (<= 0 mx3_3398) (<= 1 m1_3394)) (> tleft_primed 0))))
(assert (or (and (and (< tright_primed 1) (= m2_3395 0)) (= mx4_3399 0)) (and (and (<= 0 mx4_3399) (<= 1 m2_3395)) (> tright_primed 0))))
