...
(declare-fun right_58_1926_primed () Int)
(declare-fun left_58_1925_primed () Int)
(declare-fun nright_58_1924_primed () Int)
(declare-fun nleft_58_1923_primed () Int)
(declare-fun val_58_1922_primed () Int)
(declare-fun v_int_58_1921_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_58_1926_primed r_3853))
(assert (= left_58_1925_primed v_node_56_4001))
(assert (= nright_58_1924_primed m2_3854))
(assert (= nleft_58_1923_primed m1_3851))
(assert (= val_58_1922_primed d_3849))
(assert (= v_int_58_1921_primed (+ 1 tmpv_primed)))
