...
(declare-fun right_161_1498_primed () Int)
(declare-fun left_161_1497_primed () Int)
(declare-fun nright_161_1496_primed () Int)
(declare-fun nleft_161_1495_primed () Int)
(declare-fun val_161_1494_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1498_primed r_2485))
(assert (= left_161_1497_primed l_2482))
(assert (= nright_161_1496_primed m2_2486))
(assert (= nleft_161_1495_primed m1_2483))
(assert (= val_161_1494_primed d_2481))
