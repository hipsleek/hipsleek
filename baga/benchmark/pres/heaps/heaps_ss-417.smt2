...
(declare-fun right_32_1782_primed () Int)
(declare-fun left_32_1781_primed () Int)
(declare-fun nright_32_1780_primed () Int)
(declare-fun nleft_32_1779_primed () Int)
(declare-fun val_32_1778_primed () Int)
(declare-fun t () Int)
(declare-fun v () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_32_1782_primed r_3853))
(assert (= left_32_1781_primed l_3850))
(assert (= nright_32_1780_primed m2_3854))
(assert (= nleft_32_1779_primed m1_3851))
(assert (= val_32_1778_primed d_3849))
(assert (= t_primed t))
(assert (= v_primed v))
(assert (<= 0 v))
