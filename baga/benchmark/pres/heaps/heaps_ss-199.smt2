...
(declare-fun right_161_1488_primed () Int)
(declare-fun left_161_1487_primed () Int)
(declare-fun nright_161_1486_primed () Int)
(declare-fun nleft_161_1485_primed () Int)
(declare-fun val_161_1484_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1488_primed r_2485))
(assert (= left_161_1487_primed l_2482))
(assert (= nright_161_1486_primed m2_2486))
(assert (= nleft_161_1485_primed m1_2483))
(assert (= val_161_1484_primed d_2481))
