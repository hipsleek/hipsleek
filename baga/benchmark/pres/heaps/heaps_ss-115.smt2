...
(declare-fun right_156_1461_primed () Int)
(declare-fun left_156_1460_primed () Int)
(declare-fun nright_156_1459_primed () Int)
(declare-fun nleft_156_1458_primed () Int)
(declare-fun val_156_1457_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_156_1461_primed r_2485))
(assert (= left_156_1460_primed l_2482))
(assert (= nright_156_1459_primed m2_2486))
(assert (= nleft_156_1458_primed m1_2483))
(assert (= val_156_1457_primed d_2481))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
(assert (= m2_primed m2))
