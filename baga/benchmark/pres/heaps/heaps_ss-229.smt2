...
(declare-fun right_172_1542_primed () Int)
(declare-fun left_172_1541_primed () Int)
(declare-fun nright_172_1540_primed () Int)
(declare-fun nleft_172_1539_primed () Int)
(declare-fun val_172_1538_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_1542_primed r_2532))
(assert (= left_172_1541_primed l_2529))
(assert (= nright_172_1540_primed m2_2533))
(assert (= nleft_172_1539_primed m1_2530))
(assert (= val_172_1538_primed d_2528))
