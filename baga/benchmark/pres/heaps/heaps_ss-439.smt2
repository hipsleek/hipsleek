...
(declare-fun right_38_1832_primed () Int)
(declare-fun left_38_1831_primed () Int)
(declare-fun nright_38_1830_primed () Int)
(declare-fun nleft_38_1829_primed () Int)
(declare-fun val_38_1828_primed () Int)
(declare-fun v_int_38_1827_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_38_1832_primed r_3853))
(assert (= left_38_1831_primed v_node_36_3905))
(assert (= nright_38_1830_primed m2_3854))
(assert (= nleft_38_1829_primed m1_3851))
(assert (= val_38_1828_primed d_3849))
(assert (= v_int_38_1827_primed (+ 1 tmpv_primed)))
