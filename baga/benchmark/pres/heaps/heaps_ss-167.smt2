...
(declare-fun right_148_1432_primed () Int)
(declare-fun left_148_1431_primed () Int)
(declare-fun nright_148_1430_primed () Int)
(declare-fun nleft_148_1429_primed () Int)
(declare-fun val_148_1428_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_148_1432_primed r_2424))
(assert (= left_148_1431_primed l_2421))
(assert (= nright_148_1430_primed m2_2425))
(assert (= nleft_148_1429_primed m1_2422))
(assert (= val_148_1428_primed d_2420))
(assert (= m2_primed 0))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
