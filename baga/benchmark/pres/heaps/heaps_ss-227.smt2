...
(declare-fun right_172_1532_primed () Int)
(declare-fun left_172_1531_primed () Int)
(declare-fun nright_172_1530_primed () Int)
(declare-fun nleft_172_1529_primed () Int)
(declare-fun val_172_1528_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_1532_primed r_2532))
(assert (= left_172_1531_primed l_2529))
(assert (= nright_172_1530_primed m2_2533))
(assert (= nleft_172_1529_primed m1_2530))
(assert (= val_172_1528_primed d_2528))
