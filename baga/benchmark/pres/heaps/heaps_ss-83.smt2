...
(assert (<= 0 mx1))
(assert (<= 0 mx2))
(assert (or (and (and (< tleft_primed 1) (= tnleft_primed 0)) (= mx3_2137 0)) (and (and (<= 0 mx3_2137) (<= 1 tnleft_primed)) (> tleft_primed 0))))
(assert (or (and (and (< tright_primed 1) (= tnright_primed 0)) (= mx4_2138 0)) (and (and (<= 0 mx4_2138) (<= 1 tnright_primed)) (> tright_primed 0))))
(assert (= t_primed 1))
