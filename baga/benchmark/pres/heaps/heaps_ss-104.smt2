...
(declare-fun right_154_1448_primed () Int)
(declare-fun left_154_1447_primed () Int)
(declare-fun nright_154_1446_primed () Int)
(declare-fun nleft_154_1445_primed () Int)
(declare-fun val_154_1444_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_154_1448_primed r_2532))
(assert (= left_154_1447_primed l_2529))
(assert (= nright_154_1446_primed m2_2533))
(assert (= nleft_154_1445_primed m1_2530))
(assert (= val_154_1444_primed d_2528))
