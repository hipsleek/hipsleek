...
(declare-fun right_160_1473_primed () Int)
(declare-fun left_160_1472_primed () Int)
(declare-fun nright_160_1471_primed () Int)
(declare-fun nleft_160_1470_primed () Int)
(declare-fun val_160_1469_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_160_1473_primed r_2485))
(assert (= left_160_1472_primed l_2482))
(assert (= nright_160_1471_primed m2_2486))
(assert (= nleft_160_1470_primed m1_2483))
(assert (= val_160_1469_primed d_2481))
(assert (= d_primed d))
(assert (= v_primed v))
(assert (= m1_primed m1))
(assert (= m2_primed m2))
