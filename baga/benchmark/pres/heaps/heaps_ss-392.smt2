...
(assert (<= 0 mx2_3341))
(assert (= res d_3243))
(assert (or (and (and (< tleft_primed 1) (= tnleft_primed 0)) (= mx3_3432 0)) (and (and (<= 0 mx3_3432) (<= 1 tnleft_primed)) (> tleft_primed 0))))
(assert (or (and (and (< tright_primed 1) (= tnright_primed 0)) (= mx4_3433 0)) (and (and (<= 0 mx4_3433) (<= 1 tnright_primed)) (> tright_primed 0))))
(assert (= t_primed 1))
