...
(declare-fun right_57_1914_primed () Int)
(declare-fun left_57_1913_primed () Int)
(declare-fun nright_57_1912_primed () Int)
(declare-fun nleft_57_1911_primed () Int)
(declare-fun val_57_1910_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_57_1914_primed r_3853))
(assert (= left_57_1913_primed v_node_56_4001))
(assert (= nright_57_1912_primed m2_3854))
(assert (= nleft_57_1911_primed m1_3851))
(assert (= val_57_1910_primed d_3849))
