...
(declare-fun n () Int)
(declare-fun res () Int)
(declare-fun v_int_189_1290_primed () Int)
(declare-fun v_int_189_1289_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_189_1289_primed 0))
(assert (= v_int_189_1290_primed m1_3245))
...
(assert (< 0 n))
(assert (> res 0))
(assert (= v_int_189_1290_primed v_int_189_1289_primed))
(assert (= t_primed 1))
