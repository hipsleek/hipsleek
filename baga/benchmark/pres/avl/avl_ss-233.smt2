...
(declare-fun right_173_2485_primed () Int)
(declare-fun left_173_2484_primed () Int)
(declare-fun height_173_2483_primed () Int)
(declare-fun val_173_2482_primed () Int)
...
(declare-fun v_node_173_2481_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_173_2485_primed q_4550))
(assert (= left_173_2484_primed p_4547))
(assert (= height_173_2483_primed height_4545))
(assert (= val_173_2482_primed Anon_4546))
(assert (<= 0 n_4566))
(assert (<= 0 m_4565))
...
(assert (or (and (and (< v_node_173_2481_primed 1) (= flted_161_4579 0)) (= Anon_4580 0)) (and (and (<= 1 Anon_4580) (<= 1 flted_161_4579)) (> v_node_173_2481_primed 0))))
