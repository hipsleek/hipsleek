...
(declare-fun v_int_326_2320_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_326_2320_primed 1))
(assert (or (and (= h_primed hl_primed) (>= hl_primed hr_primed)) (and (= h_primed hr_primed) (< hl_primed hr_primed))))
(assert (<= 0 n_6309))
(assert (<= 0 m_6308))
