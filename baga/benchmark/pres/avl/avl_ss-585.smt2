...
(declare-fun right_255_1730_primed () Int)
(declare-fun left_255_1729_primed () Int)
(declare-fun height_255_1728_primed () Int)
(declare-fun val_255_1727_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_255_1730_primed q_5542))
(assert (= left_255_1729_primed p_5539))
(assert (= height_255_1728_primed height_5537))
(assert (= val_255_1727_primed Anon_5538))
