...
(declare-fun right_241_1616_primed () Int)
(declare-fun left_241_1615_primed () Int)
(declare-fun height_241_1614_primed () Int)
(declare-fun val_241_1613_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_241_1616_primed q_5542))
(assert (= left_241_1615_primed p_5539))
(assert (= height_241_1614_primed height_5537))
(assert (= val_241_1613_primed Anon_5538))
(assert (or (and (= h_primed n_5587) (>= n_5587 n_5600)) (and (= h_primed n_5600) (< n_5587 n_5600))))
(assert (<= 0 n_5600))
(assert (<= 0 m_5599))
(assert (<= 0 n_5477))
(assert (<= 0 m_5476))
