...
(assert (exists ((max_6696 Int)) (and (= n_5834 (+ 1 max_6696)) (or (and (= max_6696 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6696 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6695 Int)) (and (= n_5670 (+ 1 max_6695)) (or (and (= max_6695 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6695 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6694 Int)) (and (= n_5465 (+ 1 max_6694)) (or (and (= max_6694 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6694 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6693 Int)) (and (= n (+ 1 max_6693)) (or (and (= max_6693 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6693 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (<= height2_6666 (+ height1_6663 1))))
(check-sat)