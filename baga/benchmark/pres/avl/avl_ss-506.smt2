...
(declare-fun right_205_2859_primed () Int)
(declare-fun left_205_2858_primed () Int)
(declare-fun height_205_2857_primed () Int)
(declare-fun val_205_2856_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_205_2855_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2859_primed q_5018))
(assert (= left_205_2858_primed p_5015))
(assert (= height_205_2857_primed height_5013))
(assert (= val_205_2856_primed Anon_5014))
(assert (= v_node_205_2855_primed v_node_195_4937))
