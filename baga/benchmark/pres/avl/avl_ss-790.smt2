...
(declare-fun n_6299 () Int)
(declare-fun m_6298 () Int)
...
(assert (= res n_6292))
(assert (= m_6298 m_6291))
(assert (= n_6299 n_6292))
(assert (<= 0 m_6291))
(assert (<= 0 n_6292))
...
(assert (= k2_primed 3))
(assert (or (and (and (< v_node_321_2280_primed 1) (= m_6298 0)) (= n_6299 0)) (and (and (<= 1 n_6299) (<= 1 m_6298)) (> v_node_321_2280_primed 0))))
