...
(assert (exists ((max_6750 Int)) (and (= n_5670 (+ 1 max_6750)) (or (and (= max_6750 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6750 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6749 Int)) (and (= n_5465 (+ 1 max_6749)) (or (and (= max_6749 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6749 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6748 Int)) (and (= n (+ 1 max_6748)) (or (and (= max_6748 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6748 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6751 Int)) (and (= n_5834 (+ 1 max_6751)) (or (and (= max_6751 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6751 height2_5843) (< height1_5840 height2_5843))))))
(assert (exists ((max_6752 Int)) (and (= h_6628 (+ 1 max_6752)) (or (and (= max_6752 height1_6634) (>= height1_6634 height2_6637)) (and (= max_6752 height2_6637) (< height1_6634 height2_6637))))))
(assert (= height1_6634 n_5834))
(assert (= h_6628 (+ 1 h_5903)))
(assert (= h_5897 height2_6637))
(assert (exists ((max_6747 Int)) (and (= height2_6637 (+ 1 max_6747)) (or (and (= max_6747 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6747 height2_6666) (< height1_6663 height2_6666))))))
;Negation of Consequence
(assert (not (or (and (= h_6628 (+ 1 height1_6634)) (<= height2_6637 height1_6634)) (and (= h_6628 (+ 1 height2_6637)) (< height1_6634 height2_6637)))))
(check-sat)