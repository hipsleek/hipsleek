...
(declare-fun n_6344 () Int)
(declare-fun m_6343 () Int)
...
(assert (<= 0 n_6195))
(assert (= res n_6337))
(assert (= m_6343 m_6336))
(assert (= n_6344 n_6337))
(assert (<= 0 m_6336))
(assert (<= 0 n_6337))
(assert (= k1_primed 1))
...
(assert (= x_primed 3))
(assert (or (and (and (< v_node_329_2339_primed 1) (= m_6343 0)) (= n_6344 0)) (and (and (<= 1 n_6344) (<= 1 m_6343)) (> v_node_329_2339_primed 0))))
