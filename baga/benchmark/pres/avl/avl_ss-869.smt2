...
(declare-fun right_319_2250_primed () Int)
(declare-fun left_319_2249_primed () Int)
(declare-fun height_319_2248_primed () Int)
(declare-fun val_319_2247_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_319_2250_primed q_6255))
(assert (= left_319_2249_primed p_6252))
(assert (= height_319_2248_primed height_6250))
(assert (= val_319_2247_primed Anon_6251))
