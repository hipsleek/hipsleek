...
(assert (exists ((max_6445 Int)) (and (= n_6361 (+ 1 max_6445)) (or (and (= max_6445 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6445 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6448 Int)) (and (= n (+ 1 max_6448)) (or (and (= max_6448 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6448 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6446 Int)) (and (= n_6176 (+ 1 max_6446)) (or (and (= max_6446 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6446 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6447 Int)) (and (= n_5939 (+ 1 max_6447)) (or (and (= max_6447 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6447 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (not (or (= m_6291 0) (or (= n_6292 0) (< q_6255 1)))))
(check-sat)