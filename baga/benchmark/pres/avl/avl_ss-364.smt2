...
(declare-fun right_183_2602_primed () Int)
(declare-fun left_183_2601_primed () Int)
(declare-fun height_183_2600_primed () Int)
(declare-fun val_183_2599_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_183_2598_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_183_2602_primed q_4666))
(assert (= left_183_2601_primed p_4663))
(assert (= height_183_2600_primed height_4661))
(assert (= val_183_2599_primed Anon_4662))
(assert (= v_node_183_2598_primed v_node_173_4585))
(assert (<= 0 n_4755))
(assert (<= 0 m_4754))
