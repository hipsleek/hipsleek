...
(assert (exists ((max_4418 Int)) (and (= height1_4392 (+ 1 max_4418)) (or (and (= max_4418 height1_4405) (>= height1_4405 height2_4408)) (and (= max_4418 height2_4408) (< height1_4405 height2_4408))))))
...
(assert (not (= h_4382 height1_4392)))
(check-sat)