...
(declare-fun v_int_253_1726_primed () Int)
...
(declare-fun v_node_253_1702_primed () Int)
...
(assert (exists ((max_5673 Int)) (and (= n (+ 1 max_5673)) (or (and (= max_5673 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5673 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (<= 0 n_5657))
(assert (<= 0 m_5656))
(assert (= v_int_253_1726_primed n_5657))
(assert (<= 0 n_5548))
(assert (<= 0 m_5547))
...
(assert (exists ((max_5674 Int)) (and (= n_5465 (+ 1 max_5674)) (or (and (= max_5674 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5674 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (<= 0 m_5560))
(assert (<= 0 n_5561))
(assert (= v_node_253_1702_primed q_5542))
