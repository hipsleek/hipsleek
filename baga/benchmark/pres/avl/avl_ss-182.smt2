...
;Axioms assertions
;Antecedent
(assert (exists ((max_4333 Int)) (and (= h_4296 (+ 1 max_4333)) (or (and (= max_4333 height1_4302) (>= height1_4302 height2_4305)) (and (= max_4333 height2_4305) (< height1_4302 height2_4305))))))
...
(assert (<= 0 n_4226))
(assert (<= 0 n_4249))
(assert (exists ((max_4331 Int)) (and (= n_4249 (+ 1 max_4331)) (or (and (= max_4331 height1_4255) (>= height1_4255 height2_4258)) (and (= max_4331 height2_4258) (< height1_4255 height2_4258))))))
...
(assert (exists ((max_4332 Int)) (and (= n_4226 (+ 1 max_4332)) (or (and (= max_4332 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4332 height2_4235) (< height1_4232 height2_4235))))))
