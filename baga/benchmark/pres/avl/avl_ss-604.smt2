...
(declare-fun right_263_1790_primed () Int)
(declare-fun left_263_1789_primed () Int)
(declare-fun height_263_1788_primed () Int)
(declare-fun val_263_1787_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_263_1790_primed p_5725))
(assert (= left_263_1789_primed p_5539))
(assert (= height_263_1788_primed height_5537))
(assert (= val_263_1787_primed Anon_5538))
