...
(declare-fun right_322_2284_primed () Int)
(declare-fun left_322_2283_primed () Int)
(declare-fun height_322_2282_primed () Int)
(declare-fun val_322_2281_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_322_2284_primed q_6255))
(assert (= left_322_2283_primed x_primed))
(assert (= height_322_2282_primed height_6250))
(assert (= val_322_2281_primed Anon_6251))
(assert (<= 0 n_6292))
(assert (<= 0 m_6291))
