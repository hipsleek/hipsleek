...
(assert (exists ((max_4275 Int)) (and (= n_4226 (+ 1 max_4275)) (or (and (= max_4275 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4275 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (<= 0 cn))
(assert (= n_4200 cn))
(assert (exists ((max_4276 Int)) (and (= n_4249 (+ 1 max_4276)) (or (and (= max_4276 height1_4255) (>= height1_4255 height2_4258)) (and (= max_4276 height2_4258) (< height1_4255 height2_4258))))))
(assert (= h_primed n_4249))
(assert (or (and (= h_primed (+ height1_4255 1)) (<= height2_4258 height1_4255)) (and (= h_primed (+ height2_4258 1)) (< height1_4255 height2_4258))))
...
(assert (not (or (and (= n_4249 (+ height1_4255 1)) (<= height2_4258 height1_4255)) (and (= n_4249 (+ height2_4258 1)) (< height1_4255 height2_4258)))))
(check-sat)