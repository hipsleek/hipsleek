...
(declare-fun right_239_1565_primed () Int)
(declare-fun left_239_1564_primed () Int)
(declare-fun height_239_1563_primed () Int)
(declare-fun val_239_1562_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_239_1565_primed q_5542))
(assert (= left_239_1564_primed p_5539))
(assert (= height_239_1563_primed height_5537))
(assert (= val_239_1562_primed Anon_5538))
(assert (<= 0 n_5561))
(assert (<= 0 m_5560))
