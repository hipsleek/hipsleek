...
(declare-fun right_266_1826_primed () Int)
(declare-fun left_266_1825_primed () Int)
(declare-fun height_266_1824_primed () Int)
(declare-fun val_266_1823_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_266_1826_primed p_5725))
(assert (= left_266_1825_primed p_5539))
(assert (= height_266_1824_primed height_5537))
(assert (= val_266_1823_primed Anon_5538))
