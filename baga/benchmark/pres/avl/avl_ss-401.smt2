...
(declare-fun an () Int)
(declare-fun am () Int)
(declare-fun v_int_184_2665_primed () Int)
(declare-fun v_int_184_2666_primed () Int)
(declare-fun v_int_184_2667_primed () Int)
...
(assert (= an n_4755))
(assert (= am m_4754))
(assert (= v_int_184_2665_primed 1))
(assert (= v_int_184_2666_primed 1))
(assert (= v_int_184_2667_primed 1))
