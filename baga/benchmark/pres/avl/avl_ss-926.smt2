...
(assert (exists ((max_6866 Int)) (and (= n_6417 (+ 1 max_6866)) (or (and (= max_6866 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6866 height2_6426) (< height1_6423 height2_6426))))))
...
(assert (exists ((max_6868 Int)) (and (= n_6176 (+ 1 max_6868)) (or (and (= max_6868 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6868 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6869 Int)) (and (= n_5939 (+ 1 max_6869)) (or (and (= max_6869 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6869 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6870 Int)) (and (= n (+ 1 max_6870)) (or (and (= max_6870 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6870 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6867 Int)) (and (= n_6361 (+ 1 max_6867)) (or (and (= max_6867 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6867 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (not (or (= m_6360 0) (or (= n_6361 0) (< x_primed 1)))))
(check-sat)