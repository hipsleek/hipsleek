...
(declare-fun n_6028 () Int)
(declare-fun m_6027 () Int)
...
(assert (= res n_6022))
(assert (= m_6027 m_6021))
(assert (= n_6028 n_6022))
(assert (<= 0 m_6021))
(assert (<= 0 n_6022))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_293_2024_primed 1) (= m_6027 0)) (= n_6028 0)) (and (and (<= 1 n_6028) (<= 1 m_6027)) (> v_node_293_2024_primed 0))))
