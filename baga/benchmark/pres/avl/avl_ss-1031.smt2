...
(assert (exists ((max_6917 Int)) (and (= n_6176 (+ 1 max_6917)) (or (and (= max_6917 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6917 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6916 Int)) (and (= n_5939 (+ 1 max_6916)) (or (and (= max_6916 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6916 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (exists ((max_6918 Int)) (and (= n_6361 (+ 1 max_6918)) (or (and (= max_6918 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6918 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6919 Int)) (and (= n_6417 (+ 1 max_6919)) (or (and (= max_6919 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6919 height2_6426) (< height1_6423 height2_6426))))))
(assert (= height1_6841 n_6361))
(assert (= height2_6844 n_6417))
(assert (exists ((max_6920 Int)) (and (= h_6835 (+ 1 max_6920)) (or (and (= max_6920 height1_6841) (>= height1_6841 height2_6844)) (and (= max_6920 height2_6844) (< height1_6841 height2_6844))))))
(assert (exists ((max_6915 Int)) (and (= n (+ 1 max_6915)) (or (and (= max_6915 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6915 height2_5428) (< height1_5425 height2_5428))))))
