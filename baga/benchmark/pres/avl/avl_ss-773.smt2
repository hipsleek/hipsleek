...
(declare-fun right_315_2228_primed () Int)
(declare-fun left_315_2227_primed () Int)
(declare-fun height_315_2226_primed () Int)
(declare-fun val_315_2225_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_315_2228_primed q_6016))
(assert (= left_315_2227_primed p_6013))
(assert (= height_315_2226_primed height_6011))
(assert (= val_315_2225_primed Anon_6012))
(assert (<= 0 n_6195))
(assert (<= 0 m_6194))
(assert (<= 0 n_6022))
(assert (<= 0 m_6021))
