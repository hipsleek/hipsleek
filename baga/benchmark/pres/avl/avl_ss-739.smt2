...
(assert (exists ((max_6152 Int)) (and (= n_5939 (+ 1 max_6152)) (or (and (= max_6152 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6152 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6151 Int)) (and (= n (+ 1 max_6151)) (or (and (= max_6151 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6151 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6153 Int)) (and (= n_6113 (+ 1 max_6153)) (or (and (= max_6153 height1_6119) (>= height1_6119 height2_6122)) (and (= max_6153 height2_6122) (< height1_6119 height2_6122))))))
