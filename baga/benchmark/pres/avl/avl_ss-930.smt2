...
(assert (exists ((max_6888 Int)) (and (= n_6176 (+ 1 max_6888)) (or (and (= max_6888 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6888 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6889 Int)) (and (= n_5939 (+ 1 max_6889)) (or (and (= max_6889 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6889 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6890 Int)) (and (= n (+ 1 max_6890)) (or (and (= max_6890 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6890 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (<= 0 n_6361))
(assert (<= 0 n_6417))
(assert (exists ((max_6886 Int)) (and (= n_6417 (+ 1 max_6886)) (or (and (= max_6886 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6886 height2_6426) (< height1_6423 height2_6426))))))
(assert (= h_6487 n_6417))
(assert (exists ((max_6887 Int)) (and (= n_6361 (+ 1 max_6887)) (or (and (= max_6887 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6887 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (not (or (and (= h_6835 (+ 1 height1_6841)) (<= height2_6844 height1_6841)) (and (= h_6835 (+ 1 height2_6844)) (< height1_6841 height2_6844)))))
(check-sat)