...
(declare-fun n1_5449 () Int)
(declare-fun flted_220_5448 () Int)
(declare-fun res () Int)
...
(assert (= flted_220_5448 (+ 1 m_5441)))
(assert (<= n_5442 n1_5449))
(assert (<= n1_5449 (+ 1 n_5442)))
(assert (<= 0 m_5441))
(assert (<= 0 n_5442))
(assert (= x_primed 1))
(assert (or (and (and (< q_5426 1) (= size2_5427 0)) (= height2_5428 0)) (and (and (<= 1 height2_5428) (<= 1 size2_5427)) (> q_5426 0))))
(assert (or (and (and (< res 1) (= flted_220_5448 0)) (= n1_5449 0)) (and (and (<= 1 n1_5449) (<= 1 flted_220_5448)) (> res 0))))
