...
(declare-fun right_253_1691_primed () Int)
(declare-fun left_253_1690_primed () Int)
(declare-fun height_253_1689_primed () Int)
(declare-fun val_253_1688_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_253_1691_primed q_5542))
(assert (= left_253_1690_primed p_5539))
(assert (= height_253_1689_primed height_5537))
(assert (= val_253_1688_primed Anon_5538))
(assert (<= 0 n_5657))
(assert (<= 0 m_5656))
