...
(declare-fun right_175_2489_primed () Int)
(declare-fun left_175_2488_primed () Int)
(declare-fun height_175_2487_primed () Int)
(declare-fun val_175_2486_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_175_2489_primed q_4550))
(assert (= left_175_2488_primed v_node_173_4585))
(assert (= height_175_2487_primed height_4545))
(assert (= val_175_2486_primed Anon_4546))
