...
(declare-fun right_195_2698_primed () Int)
(declare-fun left_195_2697_primed () Int)
(declare-fun height_195_2696_primed () Int)
(declare-fun val_195_2695_primed () Int)
...
(declare-fun v_node_195_2694_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_195_2698_primed q_4550))
(assert (= left_195_2697_primed p_4547))
(assert (= height_195_2696_primed height_4545))
(assert (= val_195_2695_primed Anon_4546))
(assert (<= 0 n_4918))
(assert (<= 0 m_4917))
...
(assert (or (and (and (< v_node_195_2694_primed 1) (= flted_161_4931 0)) (= Anon_4932 0)) (and (and (<= 1 Anon_4932) (<= 1 flted_161_4931)) (> v_node_195_2694_primed 0))))
