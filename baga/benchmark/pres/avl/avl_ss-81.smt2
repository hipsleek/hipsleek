...
(assert (<= 0 n_4038))
(assert (exists ((max_4082 Int)) (and (= n_4038 (+ 1 max_4082)) (or (and (= max_4082 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4082 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (not (<= height2_4070 (+ height1_4067 1))))
(check-sat)