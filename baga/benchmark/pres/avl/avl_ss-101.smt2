...
(assert (exists ((max_4132 Int)) (and (= n_4038 (+ 1 max_4132)) (or (and (= max_4132 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4132 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (exists ((max_4133 Int)) (and (= n_4061 (+ 1 max_4133)) (or (and (= max_4133 height1_4067) (>= height1_4067 height2_4070)) (and (= max_4133 height2_4070) (< height1_4067 height2_4070))))))
...
(assert (not (or (= m_4060 0) (or (= n_4061 0) (< tmp2_4106 1)))))
(check-sat)