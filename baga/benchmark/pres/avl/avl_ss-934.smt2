...
(declare-fun n_6481 () Int)
(declare-fun m_6480 () Int)
...
(assert (> k1_primed 0))
(assert (= res n_6417))
(assert (= m_6480 m_6416))
(assert (= n_6481 n_6417))
(assert (<= 0 m_6416))
(assert (<= 0 n_6417))
(assert (= k2_primed 1))
(assert (or (and (and (< x_primed 1) (= m_6360 0)) (= n_6361 0)) (and (and (<= 1 n_6361) (<= 1 m_6360)) (> x_primed 0))))
(assert (or (and (and (< k1_primed 1) (= m_6480 0)) (= n_6481 0)) (and (and (<= 1 n_6481) (<= 1 m_6480)) (> k1_primed 0))))
