...
(assert (exists ((max_6901 Int)) (and (= n_6417 (+ 1 max_6901)) (or (and (= max_6901 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6901 height2_6426) (< height1_6423 height2_6426))))))
(assert (= height2_6844 n_6417))
(assert (exists ((max_6902 Int)) (and (= h_6835 (+ 1 max_6902)) (or (and (= max_6902 height1_6841) (>= height1_6841 height2_6844)) (and (= max_6902 height2_6844) (< height1_6841 height2_6844))))))
(assert (= height1_6841 n_6361))
(assert (exists ((max_6900 Int)) (and (= n_6361 (+ 1 max_6900)) (or (and (= max_6900 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6900 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6899 Int)) (and (= n_6176 (+ 1 max_6899)) (or (and (= max_6899 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6899 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6898 Int)) (and (= n_5939 (+ 1 max_6898)) (or (and (= max_6898 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6898 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (exists ((max_6897 Int)) (and (= n (+ 1 max_6897)) (or (and (= max_6897 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6897 height2_5428) (< height1_5425 height2_5428))))))
