...
(assert (<= 0 m_3992))
(assert (<= 0 n_3993))
(assert (or (and (= res v_int_87_3290_primed) (>= v_int_87_3290_primed v_int_87_3289_primed)) (and (= res v_int_87_3289_primed) (< v_int_87_3290_primed v_int_87_3289_primed))))
