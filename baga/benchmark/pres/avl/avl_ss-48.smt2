...
(assert (exists ((max_3876 Int)) (and (= ny (+ 1 max_3876)) (or (and (= max_3876 height1_3809) (>= height1_3809 height2_3812)) (and (= max_3876 height2_3812) (< height1_3809 height2_3812))))))
...
(assert (exists ((max_3877 Int)) (and (= height1_3830 (+ 1 max_3877)) (or (and (= max_3877 height1_3846) (>= height1_3846 height2_3849)) (and (= max_3877 height2_3849) (< height1_3846 height2_3849))))))
