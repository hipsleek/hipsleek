...
(declare-fun right_184_2646_primed () Int)
(declare-fun left_184_2645_primed () Int)
(declare-fun height_184_2644_primed () Int)
(declare-fun val_184_2643_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2646_primed q_4550))
(assert (= left_184_2645_primed v_node_173_4585))
(assert (= height_184_2644_primed height_4545))
(assert (= val_184_2643_primed Anon_4546))
