...
(declare-fun right_205_2868_primed () Int)
(declare-fun left_205_2867_primed () Int)
(declare-fun height_205_2866_primed () Int)
(declare-fun val_205_2865_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2868_primed v_node_195_4937))
(assert (= left_205_2867_primed p_4547))
(assert (= height_205_2866_primed height_4545))
(assert (= val_205_2865_primed Anon_4546))
