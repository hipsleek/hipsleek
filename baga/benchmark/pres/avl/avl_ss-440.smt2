...
(declare-fun right_198_2737_primed () Int)
(declare-fun left_198_2736_primed () Int)
(declare-fun height_198_2735_primed () Int)
(declare-fun val_198_2734_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_198_2733_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_198_2737_primed q_5018))
(assert (= left_198_2736_primed p_5015))
(assert (= height_198_2735_primed height_5013))
(assert (= val_198_2734_primed Anon_5014))
(assert (= v_node_198_2733_primed v_node_195_4937))
