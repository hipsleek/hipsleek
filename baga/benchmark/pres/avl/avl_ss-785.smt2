...
(declare-fun right_320_2265_primed () Int)
(declare-fun left_320_2264_primed () Int)
(declare-fun height_320_2263_primed () Int)
(declare-fun val_320_2262_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_320_2265_primed q_6255))
(assert (= left_320_2264_primed p_6252))
(assert (= height_320_2263_primed height_6250))
(assert (= val_320_2262_primed Anon_6251))
(assert (<= 0 n_6275))
(assert (<= 0 m_6274))
