...
(declare-fun right_256_1734_primed () Int)
(declare-fun left_256_1733_primed () Int)
(declare-fun height_256_1732_primed () Int)
(declare-fun val_256_1731_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_256_1734_primed q_5728))
(assert (= left_256_1733_primed p_5725))
(assert (= height_256_1732_primed height_5723))
(assert (= val_256_1731_primed Anon_5724))
