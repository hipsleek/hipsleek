...
(assert (<= 0 ny_3763))
(assert (exists ((max_3893 Int)) (and (= height1_3830 (+ 1 max_3893)) (or (and (= max_3893 height1_3846) (>= height1_3846 height2_3849)) (and (= max_3893 height2_3849) (< height1_3846 height2_3849))))))
...
(assert (exists ((max_3895 Int)) (and (= v_int_152_3824 (+ 1 max_3895)) (or (and (= max_3895 height1_3830) (>= height1_3830 height2_3833)) (and (= max_3895 height2_3833) (< height1_3830 height2_3833))))))
(assert (exists ((max_3894 Int)) (and (= ny (+ 1 max_3894)) (or (and (= max_3894 height1_3809) (>= height1_3809 height2_3812)) (and (= max_3894 height2_3812) (< height1_3809 height2_3812))))))
(assert (= height_3805 ny))
(assert (= ny_3763 ny))
(assert (= v_int_152_3824 (+ 1 height_3805)))
;Negation of Consequence
(assert (not (= v_int_152_3824 (+ 1 ny))))
(check-sat)