...
(declare-fun right_200_2784_primed () Int)
(declare-fun left_200_2783_primed () Int)
(declare-fun height_200_2782_primed () Int)
(declare-fun val_200_2781_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_200_2780_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_200_2784_primed q_5018))
(assert (= left_200_2783_primed p_5015))
(assert (= height_200_2782_primed height_5013))
(assert (= val_200_2781_primed Anon_5014))
(assert (= v_node_200_2780_primed v_node_195_4937))
