...
(assert (exists ((max_6692 Int)) (and (= n_5834 (+ 1 max_6692)) (or (and (= max_6692 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6692 height2_5843) (< height1_5840 height2_5843))))))
...
(assert (exists ((max_6691 Int)) (and (= n_5670 (+ 1 max_6691)) (or (and (= max_6691 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6691 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6690 Int)) (and (= n_5465 (+ 1 max_6690)) (or (and (= max_6690 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6690 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_6689 Int)) (and (= n (+ 1 max_6689)) (or (and (= max_6689 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6689 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (or (= m_5809 0) (or (= n_5810 0) (< q_5426 1)))))
(check-sat)