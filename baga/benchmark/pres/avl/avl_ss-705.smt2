...
(declare-fun n_5817 () Int)
(declare-fun m_5816 () Int)
...
(assert (<= 0 n_5477))
(assert (= res n_5810))
(assert (= m_5816 m_5809))
(assert (= n_5817 n_5810))
(assert (<= 0 m_5809))
(assert (<= 0 n_5810))
(assert (= x_primed 1))
...
(assert (= k1_primed 3))
(assert (or (and (and (< v_node_268_1841_primed 1) (= m_5816 0)) (= n_5817 0)) (and (and (<= 1 n_5817) (<= 1 m_5816)) (> v_node_268_1841_primed 0))))
