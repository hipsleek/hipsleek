...
(declare-fun right_297_2079_primed () Int)
(declare-fun left_297_2078_primed () Int)
(declare-fun height_297_2077_primed () Int)
(declare-fun val_297_2076_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_297_2079_primed q_6016))
(assert (= left_297_2078_primed p_6013))
(assert (= height_297_2077_primed height_6011))
(assert (= val_297_2076_primed Anon_6012))
(assert (<= 0 n_6061))
(assert (<= 0 m_6060))
