...
(declare-fun right_179_2571_primed () Int)
(declare-fun left_179_2570_primed () Int)
(declare-fun height_179_2569_primed () Int)
(declare-fun val_179_2568_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_179_2571_primed q_4550))
(assert (= left_179_2570_primed v_node_173_4585))
(assert (= height_179_2569_primed height_4545))
(assert (= val_179_2568_primed Anon_4546))
