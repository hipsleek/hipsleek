...
(declare-fun right_290_1970_primed () Int)
(declare-fun left_290_1969_primed () Int)
(declare-fun height_290_1968_primed () Int)
(declare-fun val_290_1967_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_290_1970_primed v_node_289_5935))
(assert (= left_290_1969_primed p_5423))
(assert (= height_290_1968_primed height_5421))
(assert (= val_290_1967_primed Anon_5422))
(assert (<= 0 n_5939))
(assert (<= 0 m_5938))
