...
(assert (<= 0 n_6361))
(assert (exists ((max_6453 Int)) (and (= n_6361 (+ 1 max_6453)) (or (and (= max_6453 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6453 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6456 Int)) (and (= n (+ 1 max_6456)) (or (and (= max_6456 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6456 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6454 Int)) (and (= n_6176 (+ 1 max_6454)) (or (and (= max_6454 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6454 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6455 Int)) (and (= n_5939 (+ 1 max_6455)) (or (and (= max_6455 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6455 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (not (<= height2_6426 (+ height1_6423 1))))
(check-sat)