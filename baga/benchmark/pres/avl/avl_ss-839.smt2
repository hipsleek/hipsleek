...
(declare-fun right_313_2174_primed () Int)
(declare-fun left_313_2173_primed () Int)
(declare-fun height_313_2172_primed () Int)
(declare-fun val_313_2171_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_313_2174_primed q_6016))
(assert (= left_313_2173_primed p_6013))
(assert (= height_313_2172_primed height_6011))
(assert (= val_313_2171_primed Anon_6012))
(assert (<= 0 n_6035))
(assert (<= 0 m_6034))
