...
(declare-fun right_259_1767_primed () Int)
(declare-fun left_259_1766_primed () Int)
(declare-fun height_259_1765_primed () Int)
(declare-fun val_259_1764_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_259_1767_primed q_5728))
(assert (= left_259_1766_primed p_5725))
(assert (= height_259_1765_primed height_5723))
(assert (= val_259_1764_primed Anon_5724))
(assert (<= 0 n_5748))
(assert (<= 0 m_5747))
