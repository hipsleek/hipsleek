...
(declare-fun right_205_2864_primed () Int)
(declare-fun left_205_2863_primed () Int)
(declare-fun height_205_2862_primed () Int)
(declare-fun val_205_2861_primed () Int)
(declare-fun Anon_5194 () Int)
(declare-fun v_node_205_2860_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2864_primed q_5198))
(assert (= left_205_2863_primed p_5195))
(assert (= height_205_2862_primed height_5193))
(assert (= val_205_2861_primed Anon_5194))
(assert (= v_node_205_2860_primed p_5015))
