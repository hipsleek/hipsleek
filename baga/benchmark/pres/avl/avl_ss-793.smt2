...
(declare-fun right_295_2060_primed () Int)
(declare-fun left_295_2059_primed () Int)
(declare-fun height_295_2058_primed () Int)
(declare-fun val_295_2057_primed () Int)
(declare-fun v_node_295_2056_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_295_2060_primed v_node_289_5935))
(assert (= left_295_2059_primed p_5423))
(assert (= height_295_2058_primed height_5421))
(assert (= val_295_2057_primed Anon_5422))
(assert (= v_node_295_2056_primed p_6013))
(assert (<= 0 n_6035))
(assert (<= 0 m_6034))
