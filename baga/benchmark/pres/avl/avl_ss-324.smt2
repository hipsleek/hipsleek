...
(assert (exists ((max_4675 Int)) (and (= n (+ 1 max_4675)) (or (and (= max_4675 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4675 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_4676 Int)) (and (= n_4589 (+ 1 max_4676)) (or (and (= max_4676 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4676 height2_4668) (< height1_4665 height2_4668))))))
...
(assert (not (or (= size1_4664 0) (or (= height1_4665 0) (< p_4663 1)))))
(check-sat)