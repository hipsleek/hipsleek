...
(declare-fun n_5606 () Int)
(declare-fun m_5605 () Int)
...
(assert (<= 0 n_5477))
(assert (= res n_5600))
(assert (= m_5605 m_5599))
(assert (= n_5606 n_5600))
(assert (<= 0 m_5599))
(assert (<= 0 n_5600))
(assert (= k1_primed 1))
...
(assert (or (and (and (< v_node_240_1600_primed 1) (= m_5605 0)) (= n_5606 0)) (and (and (<= 1 n_5606) (<= 1 m_5605)) (> v_node_240_1600_primed 0))))
