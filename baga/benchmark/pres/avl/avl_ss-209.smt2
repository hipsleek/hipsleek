...
(assert (exists ((max_4322 Int)) (and (= n_4226 (+ 1 max_4322)) (or (and (= max_4322 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4322 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (exists ((max_4323 Int)) (and (= n_4249 (+ 1 max_4323)) (or (and (= max_4323 height1_4255) (>= height1_4255 height2_4258)) (and (= max_4323 height2_4258) (< height1_4255 height2_4258))))))
(assert (= height1_4302 n_4226))
(assert (= height2_4305 n_4249))
;Negation of Consequence
(assert (not (<= height2_4305 (+ height1_4302 1))))
(check-sat)