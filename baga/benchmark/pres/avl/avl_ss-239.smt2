...
(assert (exists ((max_4416 Int)) (and (= height1_4392 (+ 1 max_4416)) (or (and (= max_4416 height1_4405) (>= height1_4405 height2_4408)) (and (= max_4416 height2_4408) (< height1_4405 height2_4408))))))
(assert (= h_4382 height1_4392))
(assert (= height2_4395 flted_33_4366))
;Negation of Consequence
(assert (not (<= height2_4395 (+ height1_4392 1))))
(check-sat)