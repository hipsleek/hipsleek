...
(declare-fun height1_5532 () Int)
(declare-fun size1_5531 () Int)
(declare-fun p_5530 () Int)
(declare-fun height2_5535 () Int)
(declare-fun size2_5534 () Int)
(declare-fun q_5533 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_5464 (+ (+ size2_5534 1) size1_5531)))
(assert (<= height2_5535 (+ 1 height1_5532)))
(assert (<= height1_5532 (+ 1 height2_5535)))
(assert (exists ((max_33 Int)) (and (= n_5465 (+ 1 max_33)) (or (and (= max_33 height1_5532) (>= height1_5532 height2_5535)) (and (= max_33 height2_5535) (< height1_5532 height2_5535))))))
(assert (= height_5528 n_5465))
...
(assert (= x_primed 1))
(assert (= k1_primed 2))
(assert (or (and (and (< p_5530 1) (= size1_5531 0)) (= height1_5532 0)) (and (and (<= 1 height1_5532) (<= 1 size1_5531)) (> p_5530 0))))
(assert (or (and (and (< q_5533 1) (= size2_5534 0)) (= height2_5535 0)) (and (and (<= 1 height2_5535) (<= 1 size2_5534)) (> q_5533 0))))
