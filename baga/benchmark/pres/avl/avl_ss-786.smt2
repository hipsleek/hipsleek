...
(declare-fun right_321_2269_primed () Int)
(declare-fun left_321_2268_primed () Int)
(declare-fun height_321_2267_primed () Int)
(declare-fun val_321_2266_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_321_2269_primed q_6255))
(assert (= left_321_2268_primed x_primed))
(assert (= height_321_2267_primed height_6250))
(assert (= val_321_2266_primed Anon_6251))
