...
(assert (exists ((max_7054 Int)) (and (= h1 (+ 1 max_7054)) (or (and (= max_7054 height1_6998) (>= height1_6998 height2_7001)) (and (= max_7054 height2_7001) (< height1_6998 height2_7001))))))
(assert (or (and (and (< q_6999 1) (= size2_7000 0)) (= height2_7001 0)) (and (and (<= 1 height2_7001) (<= 1 size2_7000)) (> q_6999 0))))
;Negation of Consequence
(assert (not (or (= size2_7000 0) (or (= height2_7001 0) (< q_6999 1)))))
(check-sat)