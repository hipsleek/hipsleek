...
(declare-fun v_int_112_3103_primed () Int)
(declare-fun cn () Int)
(declare-fun cm () Int)
(declare-fun c () Int)
...
(assert (<= 0 bm))
(assert (<= 0 bn))
(assert (= v_int_112_3103_primed n_4181))
(assert (<= 0 m_4180))
(assert (<= 0 n_4181))
(assert (or (and (= res v_int_112_3104_primed) (>= v_int_112_3104_primed v_int_112_3103_primed)) (and (= res v_int_112_3103_primed) (< v_int_112_3104_primed v_int_112_3103_primed))))
