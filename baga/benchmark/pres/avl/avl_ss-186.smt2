...
(assert (exists ((max_4268 Int)) (and (= n_4226 (+ 1 max_4268)) (or (and (= max_4268 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4268 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (not (or (= m_4199 0) (or (= n_4200 0) (< c_primed 1)))))
(check-sat)