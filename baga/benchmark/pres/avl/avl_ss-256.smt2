...
(declare-fun right_177_2519_primed () Int)
(declare-fun left_177_2518_primed () Int)
(declare-fun height_177_2517_primed () Int)
(declare-fun val_177_2516_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_177_2519_primed q_4550))
(assert (= left_177_2518_primed v_node_173_4585))
(assert (= height_177_2517_primed height_4545))
(assert (= val_177_2516_primed Anon_4546))
