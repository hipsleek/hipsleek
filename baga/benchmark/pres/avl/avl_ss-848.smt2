...
(declare-fun v_int_334_2395_primed () Int)
...
(assert (<= 0 n_6292))
(assert (> k1_primed 0))
(assert (= v_int_334_2395_primed n_6417))
(assert (<= 0 m_6416))
(assert (<= 0 n_6417))
(assert (or (and (= res v_int_334_2396_primed) (>= v_int_334_2396_primed v_int_334_2395_primed)) (and (= res v_int_334_2395_primed) (< v_int_334_2396_primed v_int_334_2395_primed))))
(assert (= k2_primed 1))
