...
(assert (exists ((max_6762 Int)) (and (= n_5670 (+ 1 max_6762)) (or (and (= max_6762 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6762 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6761 Int)) (and (= n_5465 (+ 1 max_6761)) (or (and (= max_6761 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6761 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (<= 0 n_5765))
(assert (<= 0 n_5810))
(assert (exists ((max_6759 Int)) (and (= height2_6637 (+ 1 max_6759)) (or (and (= max_6759 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6759 height2_6666) (< height1_6663 height2_6666))))))
...
(assert (exists ((max_6763 Int)) (and (= n_5834 (+ 1 max_6763)) (or (and (= max_6763 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6763 height2_5843) (< height1_5840 height2_5843))))))
(assert (= height1_6634 n_5834))
(assert (exists ((max_6764 Int)) (and (= h_6628 (+ 1 max_6764)) (or (and (= max_6764 height1_6634) (>= height1_6634 height2_6637)) (and (= max_6764 height2_6637) (< height1_6634 height2_6637))))))
(assert (exists ((max_6760 Int)) (and (= n (+ 1 max_6760)) (or (and (= max_6760 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6760 height2_5428) (< height1_5425 height2_5428))))))
