...
(assert (exists ((max_5861 Int)) (and (= n (+ 1 max_5861)) (or (and (= max_5861 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5861 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5859 Int)) (and (= n_5670 (+ 1 max_5859)) (or (and (= max_5859 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5859 height2_5730) (< height1_5727 height2_5730))))))
...
(assert (exists ((max_5860 Int)) (and (= n_5465 (+ 1 max_5860)) (or (and (= max_5860 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5860 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (not (or (= m_5781 0) (or (= n_5782 0) (< p_5539 1)))))
(check-sat)