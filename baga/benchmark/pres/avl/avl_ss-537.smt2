...
(declare-fun right_240_1589_primed () Int)
(declare-fun left_240_1588_primed () Int)
(declare-fun height_240_1587_primed () Int)
(declare-fun val_240_1586_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_240_1589_primed q_5426))
(assert (= left_240_1588_primed q_5542))
(assert (= height_240_1587_primed height_5421))
(assert (= val_240_1586_primed Anon_5422))
(assert (<= 0 n_5587))
(assert (<= 0 m_5586))
