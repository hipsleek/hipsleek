...
(declare-fun right_172_2476_primed () Int)
(declare-fun left_172_2475_primed () Int)
(declare-fun height_172_2474_primed () Int)
(declare-fun val_172_2473_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_2476_primed q_4550))
(assert (= left_172_2475_primed p_4547))
(assert (= height_172_2474_primed height_4545))
(assert (= val_172_2473_primed Anon_4546))
(assert (= x_primed x))
(assert (= a_primed a))
