...
(declare-fun right_184_2623_primed () Int)
(declare-fun left_184_2622_primed () Int)
(declare-fun height_184_2621_primed () Int)
(declare-fun val_184_2620_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2623_primed q_4550))
(assert (= left_184_2622_primed v_node_173_4585))
(assert (= height_184_2621_primed height_4545))
(assert (= val_184_2620_primed Anon_4546))
