...
(declare-fun n_5047 () Int)
(declare-fun m_5046 () Int)
...
(assert (= res n_5041))
(assert (= m_5046 m_5040))
(assert (= n_5047 n_5041))
(assert (<= 0 m_5040))
(assert (<= 0 n_5041))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_198_2756_primed 1) (= m_5046 0)) (= n_5047 0)) (and (and (<= 1 n_5047) (<= 1 m_5046)) (> v_node_198_2756_primed 0))))
