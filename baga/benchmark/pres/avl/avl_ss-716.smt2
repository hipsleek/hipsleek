...
(declare-fun n_6083 () Int)
(declare-fun m_6082 () Int)
...
(assert (<= 0 n_5951))
(assert (= res n_6077))
(assert (= m_6082 m_6076))
(assert (= n_6083 n_6077))
(assert (<= 0 m_6076))
(assert (<= 0 n_6077))
...
(assert (= k1_primed 2))
(assert (or (and (and (< v_node_299_2094_primed 1) (= m_6082 0)) (= n_6083 0)) (and (and (<= 1 n_6083) (<= 1 m_6082)) (> v_node_299_2094_primed 0))))
