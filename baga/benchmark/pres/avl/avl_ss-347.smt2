...
(declare-fun right_179_2567_primed () Int)
(declare-fun left_179_2566_primed () Int)
(declare-fun height_179_2565_primed () Int)
(declare-fun val_179_2564_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_179_2563_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_179_2567_primed q_4666))
(assert (= left_179_2566_primed p_4663))
(assert (= height_179_2565_primed height_4661))
(assert (= val_179_2564_primed Anon_4662))
(assert (= v_node_179_2563_primed v_node_173_4585))
