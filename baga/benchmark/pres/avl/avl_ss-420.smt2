...
(declare-fun n_5136 () Int)
(declare-fun m_5135 () Int)
...
(assert (<= 0 n_5024))
(assert (= res n_5130))
(assert (= m_5135 m_5129))
(assert (= n_5136 n_5130))
(assert (<= 0 m_5129))
(assert (<= 0 n_5130))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_204_2826_primed 1) (= m_5135 0)) (= n_5136 0)) (and (and (<= 1 n_5136) (<= 1 m_5135)) (> v_node_204_2826_primed 0))))
