...
(declare-fun right_179_2553_primed () Int)
(declare-fun left_179_2552_primed () Int)
(declare-fun height_179_2551_primed () Int)
(declare-fun val_179_2550_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_179_2553_primed q_4550))
(assert (= left_179_2552_primed v_node_173_4585))
(assert (= height_179_2551_primed height_4545))
(assert (= val_179_2550_primed Anon_4546))
(assert (<= 0 n_4689))
(assert (<= 0 m_4688))
