...
(declare-fun Anon_7033 () Int)
(declare-fun flted_455_7032 () Int)
(declare-fun res () Int)
...
(assert (<= 0 Anon_7017))
(assert (= flted_455_7032 (+ s2_7024 s1_7022)))
(assert (> tmp_primed 0))
(assert (<= 0 s1_7022))
(assert (<= 0 h1_7023))
(assert (<= 0 s2_7024))
...
(assert (or (and (and (< res 1) (= flted_455_7032 0)) (= Anon_7033 0)) (and (and (<= 1 Anon_7033) (<= 1 flted_455_7032)) (> res 0))))
