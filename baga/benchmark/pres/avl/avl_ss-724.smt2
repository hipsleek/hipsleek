...
(assert (exists ((max_5882 Int)) (and (= n (+ 1 max_5882)) (or (and (= max_5882 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5882 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5884 Int)) (and (= n_5670 (+ 1 max_5884)) (or (and (= max_5884 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5884 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_5883 Int)) (and (= n_5465 (+ 1 max_5883)) (or (and (= max_5883 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5883 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_5885 Int)) (and (= n_5834 (+ 1 max_5885)) (or (and (= max_5885 height1_5840) (>= height1_5840 height2_5843)) (and (= max_5885 height2_5843) (< height1_5840 height2_5843))))))
