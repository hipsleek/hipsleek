...
(assert (exists ((max_4741 Int)) (and (= n (+ 1 max_4741)) (or (and (= max_4741 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4741 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_4742 Int)) (and (= n_4589 (+ 1 max_4742)) (or (and (= max_4742 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4742 height2_4668) (< height1_4665 height2_4668))))))
