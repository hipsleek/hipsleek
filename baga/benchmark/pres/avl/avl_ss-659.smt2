...
(declare-fun res () Int)
(declare-fun v_int_253_1713_primed () Int)
(declare-fun v_int_253_1714_primed () Int)
...
(assert (<= 0 m_5560))
(assert (<= 0 n_5561))
(assert (= v_int_253_1714_primed n_5670))
(assert (<= 0 m_5669))
(assert (<= 0 n_5670))
(assert (= v_int_253_1713_primed 1))
(assert (= (+ res v_int_253_1713_primed) v_int_253_1714_primed))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< q_5542 1) (= m_5669 0)) (= n_5670 0)) (and (and (<= 1 n_5670) (<= 1 m_5669)) (> q_5542 0))))
