...
(declare-fun n_5113 () Int)
(declare-fun m_5112 () Int)
(declare-fun v_node_204_2806_primed () Int)
...
(assert (= v_node_204_2806_primed p_5015))
(assert (= m_5106 m_5040))
(assert (= n_5107 n_5041))
(assert (<= 0 m_5040))
(assert (<= 0 n_5041))
(assert (= res n_5107))
(assert (= m_5112 m_5106))
(assert (= n_5113 n_5107))
(assert (<= 0 m_5106))
(assert (<= 0 n_5107))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_204_2806_primed 1) (= m_5112 0)) (= n_5113 0)) (and (and (<= 1 n_5113) (<= 1 m_5112)) (> v_node_204_2806_primed 0))))
