...
(assert (<= 0 n_4038))
(assert (exists ((max_4084 Int)) (and (= n_4038 (+ 1 max_4084)) (or (and (= max_4084 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4084 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (not (or (and (= h_primed (+ 1 height1_4067)) (<= height2_4070 height1_4067)) (and (= h_primed (+ 1 height2_4070)) (< height1_4067 height2_4070)))))
(check-sat)