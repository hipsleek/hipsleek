...
(declare-fun right_293_2028_primed () Int)
(declare-fun left_293_2027_primed () Int)
(declare-fun height_293_2026_primed () Int)
(declare-fun val_293_2025_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_293_2028_primed q_6016))
(assert (= left_293_2027_primed p_6013))
(assert (= height_293_2026_primed height_6011))
(assert (= val_293_2025_primed Anon_6012))
(assert (<= 0 n_6022))
(assert (<= 0 m_6021))
