...
(declare-fun right_196_2702_primed () Int)
(declare-fun left_196_2701_primed () Int)
(declare-fun height_196_2700_primed () Int)
(declare-fun val_196_2699_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_196_2702_primed v_node_195_4937))
(assert (= left_196_2701_primed p_4547))
(assert (= height_196_2700_primed height_4545))
(assert (= val_196_2699_primed Anon_4546))
