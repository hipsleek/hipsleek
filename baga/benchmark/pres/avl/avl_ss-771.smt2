...
(declare-fun height1_6006 () Int)
(declare-fun size1_6005 () Int)
(declare-fun p_6004 () Int)
(declare-fun height2_6009 () Int)
(declare-fun size2_6008 () Int)
(declare-fun q_6007 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_5938 (+ (+ size2_6008 1) size1_6005)))
(assert (<= height2_6009 (+ 1 height1_6006)))
(assert (<= height1_6006 (+ 1 height2_6009)))
(assert (exists ((max_33 Int)) (and (= n_5939 (+ 1 max_33)) (or (and (= max_33 height1_6006) (>= height1_6006 height2_6009)) (and (= max_33 height2_6009) (< height1_6006 height2_6009))))))
(assert (= height_6002 n_5939))
...
(assert (= x_primed 1))
(assert (= k1_primed 2))
(assert (or (and (and (< p_6004 1) (= size1_6005 0)) (= height1_6006 0)) (and (and (<= 1 height1_6006) (<= 1 size1_6005)) (> p_6004 0))))
(assert (or (and (and (< q_6007 1) (= size2_6008 0)) (= height2_6009 0)) (and (and (<= 1 height2_6009) (<= 1 size2_6008)) (> q_6007 0))))
