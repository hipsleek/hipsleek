...
(assert (exists ((max_6804 Int)) (and (= n (+ 1 max_6804)) (or (and (= max_6804 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6804 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (<= 0 n_6113))
(assert (<= 0 n_6104))
(assert (exists ((max_6802 Int)) (and (= n_6113 (+ 1 max_6802)) (or (and (= max_6802 height1_6119) (>= height1_6119 height2_6122)) (and (= max_6802 height2_6122) (< height1_6119 height2_6122))))))
(assert (= h_6161 n_6113))
(assert (< n_6035 n_6022))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6803 Int)) (and (= n_5939 (+ 1 max_6803)) (or (and (= max_6803 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6803 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (not (<= height2_6780 (+ height1_6777 1))))
(check-sat)