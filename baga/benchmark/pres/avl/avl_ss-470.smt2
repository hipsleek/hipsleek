...
(assert (exists ((max_5093 Int)) (and (= n (+ 1 max_5093)) (or (and (= max_5093 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5093 height2_4552) (< height1_4549 height2_4552))))))
(assert (<= 0 n_4953))
(assert (<= 0 n_5041))
...
(assert (exists ((max_5094 Int)) (and (= n_4941 (+ 1 max_5094)) (or (and (= max_5094 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5094 height2_5020) (< height1_5017 height2_5020))))))
