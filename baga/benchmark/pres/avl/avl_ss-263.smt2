...
(declare-fun n_4678 () Int)
(declare-fun m_4677 () Int)
...
(assert (= res n_4672))
(assert (= m_4677 m_4671))
(assert (= n_4678 n_4672))
(assert (<= 0 m_4671))
(assert (<= 0 n_4672))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_177_2529_primed 1) (= m_4677 0)) (= n_4678 0)) (and (and (<= 1 n_4678) (<= 1 m_4677)) (> v_node_177_2529_primed 0))))
