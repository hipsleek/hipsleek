...
(declare-fun n_6316 () Int)
(declare-fun m_6315 () Int)
(declare-fun v_node_324_2299_primed () Int)
...
(assert (= v_node_324_2299_primed p_5423))
(assert (= m_6308 m_5950))
(assert (= n_6309 n_5951))
(assert (<= 0 m_5950))
(assert (<= 0 n_5951))
(assert (= res n_6309))
(assert (= m_6315 m_6308))
(assert (= n_6316 n_6309))
(assert (<= 0 m_6308))
(assert (<= 0 n_6309))
...
(assert (= k2_primed 3))
(assert (or (and (and (< v_node_324_2299_primed 1) (= m_6315 0)) (= n_6316 0)) (and (and (<= 1 n_6316) (<= 1 m_6315)) (> v_node_324_2299_primed 0))))
