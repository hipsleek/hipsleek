...
(declare-fun bn () Int)
(declare-fun res () Int)
(declare-fun v_int_113_3115_primed () Int)
...
(assert (<= 0 m_4180))
(assert (<= 0 n_4181))
(assert (or (and (= h_primed n) (>= n n_4181)) (and (= h_primed n_4181) (< n n_4181))))
(assert (= v_int_113_3115_primed 1))
(assert (= res (+ v_int_113_3115_primed h_primed)))
