...
(declare-fun right_275_1907_primed () Int)
(declare-fun left_275_1906_primed () Int)
(declare-fun height_275_1905_primed () Int)
(declare-fun val_275_1904_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_275_1907_primed x_primed))
(assert (= left_275_1906_primed k1_primed))
(assert (= height_275_1905_primed height_5723))
(assert (= val_275_1904_primed Anon_5724))
(assert (= h_primed (+ 1 h_5903)))
