...
(declare-fun right_271_1866_primed () Int)
(declare-fun left_271_1865_primed () Int)
(declare-fun height_271_1864_primed () Int)
(declare-fun val_271_1863_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_271_1866_primed q_5426))
(assert (= left_271_1865_primed q_5728))
(assert (= height_271_1864_primed height_5421))
(assert (= val_271_1863_primed Anon_5422))
