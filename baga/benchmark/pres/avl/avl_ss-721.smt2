...
(declare-fun v_int_301_2115_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_301_2115_primed 1))
(assert (or (and (= h_primed hr_primed) (>= hr_primed hl_primed)) (and (= h_primed hl_primed) (< hr_primed hl_primed))))
(assert (<= 0 n_6077))
(assert (<= 0 m_6076))
