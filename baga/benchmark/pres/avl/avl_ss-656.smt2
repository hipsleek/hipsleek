...
(declare-fun n_5676 () Int)
(declare-fun m_5675 () Int)
...
(assert (<= 0 n_5561))
(assert (= res n_5670))
(assert (= m_5675 m_5669))
(assert (= n_5676 n_5670))
(assert (<= 0 m_5669))
(assert (<= 0 n_5670))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_253_1702_primed 1) (= m_5675 0)) (= n_5676 0)) (and (and (<= 1 n_5676) (<= 1 m_5675)) (> v_node_253_1702_primed 0))))
