...
(declare-fun res () Int)
(declare-fun v_int_274_1903_primed () Int)
...
(assert (<= 0 m_5833))
(assert (<= 0 n_5834))
(assert (or (and (= h_primed n_5834) (>= n_5834 h_5897)) (and (= h_primed h_5897) (< n_5834 h_5897))))
(assert (= v_int_274_1903_primed 1))
(assert (= res (+ v_int_274_1903_primed h_primed)))
