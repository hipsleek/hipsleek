...
(assert (exists ((max_6141 Int)) (and (= n_5939 (+ 1 max_6141)) (or (and (= max_6141 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6141 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6142 Int)) (and (= n (+ 1 max_6142)) (or (and (= max_6142 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6142 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (<= height1_6119 (+ height2_6122 1))))
(check-sat)