...
(assert (exists ((max_5751 Int)) (and (= n (+ 1 max_5751)) (or (and (= max_5751 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5751 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5752 Int)) (and (= n_5465 (+ 1 max_5752)) (or (and (= max_5752 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5752 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_5753 Int)) (and (= n_5670 (+ 1 max_5753)) (or (and (= max_5753 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5753 height2_5730) (< height1_5727 height2_5730))))))
(assert (= v_node_258_1763_primed p_5725))
(assert (or (and (and (< p_5725 1) (= size1_5726 0)) (= height1_5727 0)) (and (and (<= 1 height1_5727) (<= 1 size1_5726)) (> p_5725 0))))
;Negation of Consequence
(assert (not (or (= size1_5726 0) (or (= height1_5727 0) (< p_5725 1)))))
(check-sat)