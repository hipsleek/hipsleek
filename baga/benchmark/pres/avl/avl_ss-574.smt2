...
(declare-fun right_234_1480_primed () Int)
(declare-fun left_234_1479_primed () Int)
(declare-fun height_234_1478_primed () Int)
(declare-fun val_234_1477_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_234_1480_primed q_5426))
(assert (= left_234_1479_primed v_node_233_5461))
(assert (= height_234_1478_primed height_5421))
(assert (= val_234_1477_primed Anon_5422))
(assert (<= 0 n_5465))
(assert (<= 0 m_5464))
