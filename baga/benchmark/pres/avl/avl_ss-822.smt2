...
(assert (exists ((max_6398 Int)) (and (= n_6176 (+ 1 max_6398)) (or (and (= max_6398 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6398 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6399 Int)) (and (= n_5939 (+ 1 max_6399)) (or (and (= max_6399 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6399 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6400 Int)) (and (= n (+ 1 max_6400)) (or (and (= max_6400 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6400 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (or (and (= h_6350 (+ 1 height1_6367)) (<= height2_6370 height1_6367)) (and (= h_6350 (+ 1 height2_6370)) (< height1_6367 height2_6370)))))
(check-sat)