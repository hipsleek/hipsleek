...
(declare-fun right_177_2524_primed () Int)
(declare-fun left_177_2523_primed () Int)
(declare-fun height_177_2522_primed () Int)
(declare-fun val_177_2521_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_177_2524_primed q_4666))
(assert (= left_177_2523_primed p_4663))
(assert (= height_177_2522_primed height_4661))
(assert (= val_177_2521_primed Anon_4662))
...
(assert (= x_primed 1))
(assert (or (and (and (< p_4663 1) (= size1_4664 0)) (= height1_4665 0)) (and (and (<= 1 height1_4665) (<= 1 size1_4664)) (> p_4663 0))))
