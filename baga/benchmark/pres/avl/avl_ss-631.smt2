...
(assert (exists ((max_5864 Int)) (and (= n (+ 1 max_5864)) (or (and (= max_5864 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5864 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5862 Int)) (and (= n_5670 (+ 1 max_5862)) (or (and (= max_5862 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5862 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_5863 Int)) (and (= n_5465 (+ 1 max_5863)) (or (and (= max_5863 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5863 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (not (or (= m_5747 0) (or (= n_5748 0) (< p_5725 1)))))
(check-sat)