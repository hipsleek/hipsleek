...
(declare-fun right_184_2628_primed () Int)
(declare-fun left_184_2627_primed () Int)
(declare-fun height_184_2626_primed () Int)
(declare-fun val_184_2625_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_184_2624_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2628_primed q_4666))
(assert (= left_184_2627_primed p_4663))
(assert (= height_184_2626_primed height_4661))
(assert (= val_184_2625_primed Anon_4662))
(assert (= v_node_184_2624_primed v_node_173_4585))
...
(assert (or (and (and (< q_4666 1) (= m_4771 0)) (= n_4772 0)) (and (and (<= 1 n_4772) (<= 1 m_4771)) (> q_4666 0))))
