...
(assert (exists ((max_5244 Int)) (and (= n (+ 1 max_5244)) (or (and (= max_5244 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5244 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5245 Int)) (and (= n_4941 (+ 1 max_5245)) (or (and (= max_5245 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5245 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (exists ((max_5246 Int)) (and (= n_5107 (+ 1 max_5246)) (or (and (= max_5246 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5246 height2_5200) (< height1_5197 height2_5200))))))
...
(assert (not (or (= size1_5196 0) (or (= height1_5197 0) (< p_5195 1)))))
(check-sat)