...
(assert (exists ((max_5551 Int)) (and (= n (+ 1 max_5551)) (or (and (= max_5551 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5551 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5552 Int)) (and (= n_5465 (+ 1 max_5552)) (or (and (= max_5552 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5552 height2_5544) (< height1_5541 height2_5544))))))
(assert (= v_node_237_1534_primed p_5539))
(assert (or (and (and (< p_5539 1) (= size1_5540 0)) (= height1_5541 0)) (and (and (<= 1 height1_5541) (<= 1 size1_5540)) (> p_5539 0))))
;Negation of Consequence
(assert (not (or (= size1_5540 0) (or (= height1_5541 0) (< p_5539 1)))))
(check-sat)