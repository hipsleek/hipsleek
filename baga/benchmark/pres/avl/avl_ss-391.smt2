...
(declare-fun right_184_2656_primed () Int)
(declare-fun left_184_2655_primed () Int)
(declare-fun height_184_2654_primed () Int)
(declare-fun val_184_2653_primed () Int)
(declare-fun Anon_4838 () Int)
(declare-fun v_node_184_2652_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2656_primed q_4842))
(assert (= left_184_2655_primed p_4839))
(assert (= height_184_2654_primed height_4837))
(assert (= val_184_2653_primed Anon_4838))
(assert (= v_node_184_2652_primed q_4666))
