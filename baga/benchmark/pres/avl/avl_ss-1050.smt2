...
(assert (exists ((max_7053 Int)) (and (= h1 (+ 1 max_7053)) (or (and (= max_7053 height1_6998) (>= height1_6998 height2_7001)) (and (= max_7053 height2_7001) (< height1_6998 height2_7001))))))
(assert (= m s2))
...
(assert (not (or (= flted_455_7039 0) (or (= Anon_7040 0) (< tmp1_primed 1)))))
(check-sat)