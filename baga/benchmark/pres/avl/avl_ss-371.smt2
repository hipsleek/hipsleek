...
(declare-fun height1_5008 () Int)
(declare-fun size1_5007 () Int)
(declare-fun p_5006 () Int)
(declare-fun height2_5011 () Int)
(declare-fun size2_5010 () Int)
(declare-fun q_5009 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_4940 (+ (+ size2_5010 1) size1_5007)))
(assert (<= height2_5011 (+ 1 height1_5008)))
(assert (<= height1_5008 (+ 1 height2_5011)))
(assert (exists ((max_33 Int)) (and (= n_4941 (+ 1 max_33)) (or (and (= max_33 height1_5008) (>= height1_5008 height2_5011)) (and (= max_33 height2_5011) (< height1_5008 height2_5011))))))
(assert (= height_5004 n_4941))
...
(assert (= x_primed 1))
(assert (= v_node_198_2733_primed 2))
(assert (or (and (and (< p_5006 1) (= size1_5007 0)) (= height1_5008 0)) (and (and (<= 1 height1_5008) (<= 1 size1_5007)) (> p_5006 0))))
(assert (or (and (and (< q_5009 1) (= size2_5010 0)) (= height2_5011 0)) (and (and (<= 1 height2_5011) (<= 1 size2_5010)) (> q_5009 0))))
(assert (or (and (and (< p_4547 1) (= m_4952 0)) (= n_4953 0)) (and (and (<= 1 n_4953) (<= 1 m_4952)) (> p_4547 0))))
(assert (not (= x_primed v_node_198_2733_primed)))
