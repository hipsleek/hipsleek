...
(declare-fun right_200_2775_primed () Int)
(declare-fun left_200_2774_primed () Int)
(declare-fun height_200_2773_primed () Int)
(declare-fun val_200_2772_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_200_2771_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_200_2775_primed q_5018))
(assert (= left_200_2774_primed p_5015))
(assert (= height_200_2773_primed height_5013))
(assert (= val_200_2772_primed Anon_5014))
(assert (= v_node_200_2771_primed v_node_195_4937))
