...
(declare-fun right_137_3010_primed () Int)
(declare-fun left_137_3009_primed () Int)
(declare-fun height_137_3008_primed () Int)
(declare-fun val_137_3007_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_137_3010_primed q_3670))
(assert (= left_137_3009_primed p_3667))
(assert (= height_137_3008_primed height_3665))
(assert (= val_137_3007_primed Anon_3666))
