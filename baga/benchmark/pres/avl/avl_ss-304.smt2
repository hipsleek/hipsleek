...
(declare-fun n_4778 () Int)
(declare-fun m_4777 () Int)
...
(assert (<= 0 n_4689))
(assert (= res n_4772))
(assert (= m_4777 m_4771))
(assert (= n_4778 n_4772))
(assert (<= 0 m_4771))
(assert (<= 0 n_4772))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_183_2607_primed 1) (= m_4777 0)) (= n_4778 0)) (and (and (<= 1 n_4778) (<= 1 m_4777)) (> v_node_183_2607_primed 0))))
