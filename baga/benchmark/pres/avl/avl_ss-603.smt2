...
(declare-fun right_261_1786_primed () Int)
(declare-fun left_261_1785_primed () Int)
(declare-fun height_261_1784_primed () Int)
(declare-fun val_261_1783_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_261_1786_primed q_5728))
(assert (= left_261_1785_primed k1_primed))
(assert (= height_261_1784_primed height_5723))
(assert (= val_261_1783_primed Anon_5724))
(assert (<= 0 n_5765))
(assert (<= 0 m_5764))
