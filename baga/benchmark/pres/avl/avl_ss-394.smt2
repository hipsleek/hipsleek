...
(assert (exists ((max_4884 Int)) (and (= n (+ 1 max_4884)) (or (and (= max_4884 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4884 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_4885 Int)) (and (= n_4589 (+ 1 max_4885)) (or (and (= max_4885 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4885 height2_4668) (< height1_4665 height2_4668))))))
...
(assert (exists ((max_4886 Int)) (and (= n_4772 (+ 1 max_4886)) (or (and (= max_4886 height1_4841) (>= height1_4841 height2_4844)) (and (= max_4886 height2_4844) (< height1_4841 height2_4844))))))
...
(assert (not (or (= size1_4840 0) (or (= height1_4841 0) (< p_4839 1)))))
(check-sat)