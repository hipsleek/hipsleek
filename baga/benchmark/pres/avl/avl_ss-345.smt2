...
(declare-fun right_179_2558_primed () Int)
(declare-fun left_179_2557_primed () Int)
(declare-fun height_179_2556_primed () Int)
(declare-fun val_179_2555_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_179_2554_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_179_2558_primed q_4666))
(assert (= left_179_2557_primed p_4663))
(assert (= height_179_2556_primed height_4661))
(assert (= val_179_2555_primed Anon_4662))
(assert (= v_node_179_2554_primed v_node_173_4585))
(assert (<= 0 n_4689))
(assert (<= 0 m_4688))
