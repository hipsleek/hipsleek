...
(assert (exists ((max_6878 Int)) (and (= n_6176 (+ 1 max_6878)) (or (and (= max_6878 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6878 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6879 Int)) (and (= n_5939 (+ 1 max_6879)) (or (and (= max_6879 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6879 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6880 Int)) (and (= n (+ 1 max_6880)) (or (and (= max_6880 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6880 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (<= 0 n_6361))
(assert (<= 0 n_6417))
(assert (exists ((max_6876 Int)) (and (= n_6417 (+ 1 max_6876)) (or (and (= max_6876 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6876 height2_6426) (< height1_6423 height2_6426))))))
(assert (= h_6487 n_6417))
(assert (exists ((max_6877 Int)) (and (= n_6361 (+ 1 max_6877)) (or (and (= max_6877 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6877 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (not (<= height2_6844 (+ height1_6841 1))))
(check-sat)