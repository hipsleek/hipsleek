...
(declare-fun v_int_290_1993_primed () Int)
...
(declare-fun v_node_290_1981_primed () Int)
...
(assert (<= 0 n_5939))
(assert (<= 0 m_5938))
(assert (= v_int_290_1993_primed n_5939))
(assert (<= 0 n1_5930))
...
(assert (exists ((max_5954 Int)) (and (= n (+ 1 max_5954)) (or (and (= max_5954 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5954 height2_5428) (< height1_5425 height2_5428))))))
(assert (= v_node_290_1981_primed p_5423))
