...
(declare-fun height1_4832 () Int)
(declare-fun size1_4831 () Int)
(declare-fun p_4830 () Int)
(declare-fun height2_4835 () Int)
(declare-fun size2_4834 () Int)
(declare-fun q_4833 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_4771 (+ (+ size2_4834 1) size1_4831)))
(assert (<= height2_4835 (+ 1 height1_4832)))
(assert (<= height1_4832 (+ 1 height2_4835)))
(assert (exists ((max_33 Int)) (and (= n_4772 (+ 1 max_33)) (or (and (= max_33 height1_4832) (>= height1_4832 height2_4835)) (and (= max_33 height2_4835) (< height1_4832 height2_4835))))))
(assert (= height_4828 n_4772))
...
(assert (= v_node_184_2638_primed 3))
(assert (or (and (and (< p_4830 1) (= size1_4831 0)) (= height1_4832 0)) (and (and (<= 1 height1_4832) (<= 1 size1_4831)) (> p_4830 0))))
(assert (or (and (and (< q_4833 1) (= size2_4834 0)) (= height2_4835 0)) (and (and (<= 1 height2_4835) (<= 1 size2_4834)) (> q_4833 0))))
(assert (not (= x_primed v_node_184_2638_primed)))
(assert (not (= x_primed v_node_173_4585)))
(assert (not (= v_node_173_4585 v_node_184_2638_primed)))
