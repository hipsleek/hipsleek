...
(assert (exists ((max_6411 Int)) (and (= n_6176 (+ 1 max_6411)) (or (and (= max_6411 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6411 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6410 Int)) (and (= n_5939 (+ 1 max_6410)) (or (and (= max_6410 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6410 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6409 Int)) (and (= n (+ 1 max_6409)) (or (and (= max_6409 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6409 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6412 Int)) (and (= n_6361 (+ 1 max_6412)) (or (and (= max_6412 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6412 height2_6370) (< height1_6367 height2_6370))))))
