...
(declare-fun n_6182 () Int)
(declare-fun m_6181 () Int)
...
(assert (<= 0 n_6035))
(assert (= res n_6176))
(assert (= m_6181 m_6175))
(assert (= n_6182 n_6176))
(assert (<= 0 m_6175))
(assert (<= 0 n_6176))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_313_2185_primed 1) (= m_6181 0)) (= n_6182 0)) (and (and (<= 1 n_6182) (<= 1 m_6181)) (> v_node_313_2185_primed 0))))
