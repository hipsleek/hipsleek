...
(declare-fun v_node_268_1841_primed () Int)
...
(assert (exists ((max_5815 Int)) (and (= n_5670 (+ 1 max_5815)) (or (and (= max_5815 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5815 height2_5730) (< height1_5727 height2_5730))))))
...
(assert (exists ((max_5813 Int)) (and (= n (+ 1 max_5813)) (or (and (= max_5813 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5813 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5814 Int)) (and (= n_5465 (+ 1 max_5814)) (or (and (= max_5814 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5814 height2_5544) (< height1_5541 height2_5544))))))
(assert (= m_5476 size2_5427))
(assert (= n_5477 height2_5428))
(assert (<= 0 m_5476))
(assert (<= 0 n_5477))
(assert (= (+ 2 n_5477) n_5465))
(assert (= v_node_268_1841_primed q_5426))
