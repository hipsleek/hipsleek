...
(declare-fun height1_4656 () Int)
(declare-fun size1_4655 () Int)
(declare-fun p_4654 () Int)
(declare-fun height2_4659 () Int)
(declare-fun size2_4658 () Int)
(declare-fun q_4657 () Int)
(declare-fun n_4601 () Int)
(declare-fun m_4600 () Int)
(declare-fun q_4550 () Int)
(declare-fun x_primed () Int)
(declare-fun v_node_177_2520_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= m_4588 (+ (+ size2_4658 1) size1_4655)))
(assert (<= height2_4659 (+ 1 height1_4656)))
(assert (<= height1_4656 (+ 1 height2_4659)))
(assert (exists ((max_33 Int)) (and (= n_4589 (+ 1 max_33)) (or (and (= max_33 height1_4656) (>= height1_4656 height2_4659)) (and (= max_33 height2_4659) (< height1_4656 height2_4659))))))
(assert (= height_4652 n_4589))
...
(assert (= v_node_177_2520_primed v_node_173_4585))
(assert (= x_primed 1))
(assert (= v_node_177_2520_primed 2))
(assert (or (and (and (< p_4654 1) (= size1_4655 0)) (= height1_4656 0)) (and (and (<= 1 height1_4656) (<= 1 size1_4655)) (> p_4654 0))))
(assert (or (and (and (< q_4657 1) (= size2_4658 0)) (= height2_4659 0)) (and (and (<= 1 height2_4659) (<= 1 size2_4658)) (> q_4657 0))))
(assert (or (and (and (< q_4550 1) (= m_4600 0)) (= n_4601 0)) (and (and (<= 1 n_4601) (<= 1 m_4600)) (> q_4550 0))))
(assert (not (= x_primed v_node_177_2520_primed)))
