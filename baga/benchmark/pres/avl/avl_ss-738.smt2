...
(assert (exists ((max_6149 Int)) (and (= n_5939 (+ 1 max_6149)) (or (and (= max_6149 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6149 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6148 Int)) (and (= n (+ 1 max_6148)) (or (and (= max_6148 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6148 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6150 Int)) (and (= n_6113 (+ 1 max_6150)) (or (and (= max_6150 height1_6119) (>= height1_6119 height2_6122)) (and (= max_6150 height2_6122) (< height1_6119 height2_6122))))))
...
(assert (not (or (and (= n_6113 (+ height1_6119 1)) (<= height2_6122 height1_6119)) (and (= n_6113 (+ height2_6122 1)) (< height1_6119 height2_6122)))))
(check-sat)