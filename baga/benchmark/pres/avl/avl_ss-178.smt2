...
(assert (exists ((max_4324 Int)) (and (= n_4226 (+ 1 max_4324)) (or (and (= max_4324 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4324 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (exists ((max_4325 Int)) (and (= n_4249 (+ 1 max_4325)) (or (and (= max_4325 height1_4255) (>= height1_4255 height2_4258)) (and (= max_4325 height2_4258) (< height1_4255 height2_4258))))))
(assert (= height1_4302 n_4226))
(assert (= height2_4305 n_4249))
;Negation of Consequence
(assert (not (<= height1_4302 (+ height2_4305 1))))
(check-sat)