...
(declare-fun right_335_2412_primed () Int)
(declare-fun left_335_2411_primed () Int)
(declare-fun height_335_2410_primed () Int)
(declare-fun val_335_2409_primed () Int)
(declare-fun Anon_6251 () Int)
(declare-fun v_int_335_2408_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_335_2412_primed k1_primed))
(assert (= left_335_2411_primed x_primed))
(assert (= height_335_2410_primed height_6250))
(assert (= val_335_2409_primed Anon_6251))
(assert (= v_int_335_2408_primed h_primed))
(assert (= h_primed (+ 1 h_6493)))
...
(assert (or (and (and (< k1_primed 1) (= m_6416 0)) (= n_6417 0)) (and (and (<= 1 n_6417) (<= 1 m_6416)) (> k1_primed 0))))
