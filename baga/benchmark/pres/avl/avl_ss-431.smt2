...
(declare-fun right_205_2836_primed () Int)
(declare-fun left_205_2835_primed () Int)
(declare-fun height_205_2834_primed () Int)
(declare-fun val_205_2833_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2836_primed v_node_195_4937))
(assert (= left_205_2835_primed p_4547))
(assert (= height_205_2834_primed height_4545))
(assert (= val_205_2833_primed Anon_4546))
(assert (<= 0 n_5130))
(assert (<= 0 m_5129))
(assert (<= 0 n_5024))
(assert (<= 0 m_5023))
