...
(assert (<= 0 n_5765))
(assert (<= 0 n_5810))
(assert (exists ((max_6705 Int)) (and (= n_5834 (+ 1 max_6705)) (or (and (= max_6705 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6705 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6706 Int)) (and (= n_5670 (+ 1 max_6706)) (or (and (= max_6706 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6706 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6707 Int)) (and (= n_5465 (+ 1 max_6707)) (or (and (= max_6707 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6707 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6708 Int)) (and (= n (+ 1 max_6708)) (or (and (= max_6708 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6708 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6709 Int)) (and (= height2_6637 (+ 1 max_6709)) (or (and (= max_6709 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6709 height2_6666) (< height1_6663 height2_6666))))))
(assert (= h_5897 height2_6637))
(assert (= height1_6634 n_5834))
;Negation of Consequence
(assert (not (<= height2_6637 (+ height1_6634 1))))
(check-sat)