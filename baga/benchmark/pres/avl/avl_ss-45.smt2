...
(assert (exists ((max_3868 Int)) (and (= ny (+ 1 max_3868)) (or (and (= max_3868 height1_3809) (>= height1_3809 height2_3812)) (and (= max_3868 height2_3812) (< height1_3809 height2_3812))))))
...
(assert (exists ((max_3869 Int)) (and (= height1_3830 (+ 1 max_3869)) (or (and (= max_3869 height1_3846) (>= height1_3846 height2_3849)) (and (= max_3869 height2_3849) (< height1_3846 height2_3849))))))
(assert (= height_3805 height1_3830))
(assert (= height2_3833 ny_3763))
;Negation of Consequence
(assert (not (<= height1_3830 (+ height2_3833 1))))
(check-sat)