...
(declare-fun right_196_2711_primed () Int)
(declare-fun left_196_2710_primed () Int)
(declare-fun height_196_2709_primed () Int)
(declare-fun val_196_2708_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_196_2711_primed v_node_195_4937))
(assert (= left_196_2710_primed p_4547))
(assert (= height_196_2709_primed height_4545))
(assert (= val_196_2708_primed Anon_4546))
(assert (<= 0 n_4941))
(assert (<= 0 m_4940))
