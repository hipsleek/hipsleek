...
(declare-fun n_5663 () Int)
(declare-fun m_5662 () Int)
...
(assert (<= 0 n_5548))
(assert (= res n_5657))
(assert (= m_5662 m_5656))
(assert (= n_5663 n_5657))
(assert (<= 0 m_5656))
(assert (<= 0 n_5657))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_253_1687_primed 1) (= m_5662 0)) (= n_5663 0)) (and (and (<= 1 n_5663) (<= 1 m_5662)) (> v_node_253_1687_primed 0))))
