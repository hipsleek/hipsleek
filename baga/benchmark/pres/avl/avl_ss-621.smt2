...
(declare-fun n_5593 () Int)
(declare-fun m_5592 () Int)
...
(assert (<= 0 n_5561))
(assert (= res n_5587))
(assert (= m_5592 m_5586))
(assert (= n_5593 n_5587))
(assert (<= 0 m_5586))
(assert (<= 0 n_5587))
(assert (= k1_primed 1))
...
(assert (= x_primed 2))
(assert (or (and (and (< v_node_240_1585_primed 1) (= m_5592 0)) (= n_5593 0)) (and (and (<= 1 n_5593) (<= 1 m_5592)) (> v_node_240_1585_primed 0))))
