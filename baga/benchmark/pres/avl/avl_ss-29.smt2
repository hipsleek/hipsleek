...
(assert (exists ((max_3859 Int)) (and (= ny (+ 1 max_3859)) (or (and (= max_3859 height1_3809) (>= height1_3809 height2_3812)) (and (= max_3859 height2_3812) (< height1_3809 height2_3812))))))
...
(assert (not (or (= size1_3808 0) (or (= height1_3809 0) (< p_3807 1)))))
(check-sat)