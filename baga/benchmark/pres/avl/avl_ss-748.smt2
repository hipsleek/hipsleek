...
(declare-fun res () Int)
(declare-fun v_int_306_2166_primed () Int)
...
(assert (<= 0 m_6112))
(assert (<= 0 n_6113))
(assert (or (and (= h_primed n_6113) (>= n_6113 hr_primed)) (and (= h_primed hr_primed) (< n_6113 hr_primed))))
(assert (= v_int_306_2166_primed 1))
(assert (= res (+ v_int_306_2166_primed h_primed)))
(assert (= k1_primed 1))
