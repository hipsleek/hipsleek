...
(declare-fun right_237_1538_primed () Int)
(declare-fun left_237_1537_primed () Int)
(declare-fun height_237_1536_primed () Int)
(declare-fun val_237_1535_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_237_1538_primed q_5542))
(assert (= left_237_1537_primed p_5539))
(assert (= height_237_1536_primed height_5537))
(assert (= val_237_1535_primed Anon_5538))
(assert (<= 0 n_5548))
(assert (<= 0 m_5547))
