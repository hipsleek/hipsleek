...
(declare-fun n_5030 () Int)
(declare-fun m_5029 () Int)
...
(assert (= res n_5024))
(assert (= m_5029 m_5023))
(assert (= n_5030 n_5024))
(assert (<= 0 m_5023))
(assert (<= 0 n_5024))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_198_2742_primed 1) (= m_5029 0)) (= n_5030 0)) (and (and (<= 1 n_5030) (<= 1 m_5029)) (> v_node_198_2742_primed 0))))
