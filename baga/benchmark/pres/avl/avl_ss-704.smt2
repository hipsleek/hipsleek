...
(declare-fun right_295_2055_primed () Int)
(declare-fun left_295_2054_primed () Int)
(declare-fun height_295_2053_primed () Int)
(declare-fun val_295_2052_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_295_2055_primed q_6016))
(assert (= left_295_2054_primed p_6013))
(assert (= height_295_2053_primed height_6011))
(assert (= val_295_2052_primed Anon_6012))
(assert (<= 0 n_6035))
(assert (<= 0 m_6034))
