...
(assert (exists ((max_5878 Int)) (and (= n (+ 1 max_5878)) (or (and (= max_5878 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5878 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5880 Int)) (and (= n_5670 (+ 1 max_5880)) (or (and (= max_5880 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5880 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_5879 Int)) (and (= n_5465 (+ 1 max_5879)) (or (and (= max_5879 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5879 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_5881 Int)) (and (= n_5834 (+ 1 max_5881)) (or (and (= max_5881 height1_5840) (>= height1_5840 height2_5843)) (and (= max_5881 height2_5843) (< height1_5840 height2_5843))))))
...
(assert (not (or (and (= n_5834 (+ height1_5840 1)) (<= height2_5843 height1_5840)) (and (= n_5834 (+ height2_5843 1)) (< height1_5840 height2_5843)))))
(check-sat)