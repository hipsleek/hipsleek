...
(declare-fun v_node_296_2075_primed () Int)
...
(assert (exists ((max_6064 Int)) (and (= n (+ 1 max_6064)) (or (and (= max_6064 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6064 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6065 Int)) (and (= n_5939 (+ 1 max_6065)) (or (and (= max_6065 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6065 height2_6018) (< height1_6015 height2_6018))))))
