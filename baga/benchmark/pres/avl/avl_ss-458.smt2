...
(assert (exists ((max_5306 Int)) (and (= n (+ 1 max_5306)) (or (and (= max_5306 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5306 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5305 Int)) (and (= n_4589 (+ 1 max_5305)) (or (and (= max_5305 height1_4665) (>= height1_4665 height2_4668)) (and (= max_5305 height2_4668) (< height1_4665 height2_4668))))))
...
(assert (or (and (and (< v_node_179_2579_primed 1) (= flted_51_5301 0)) (= flted_51_5302 0)) (and (and (<= 1 flted_51_5302) (<= 1 flted_51_5301)) (> v_node_179_2579_primed 0))))
;Negation of Consequence
(assert (not (or (= flted_51_5301 0) (or (= flted_51_5302 0) (< v_node_179_2579_primed 1)))))
(check-sat)