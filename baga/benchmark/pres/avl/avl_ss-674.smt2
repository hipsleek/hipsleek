...
(declare-fun right_256_1739_primed () Int)
(declare-fun left_256_1738_primed () Int)
(declare-fun height_256_1737_primed () Int)
(declare-fun val_256_1736_primed () Int)
(declare-fun v_node_256_1735_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_256_1739_primed q_5426))
(assert (= left_256_1738_primed v_node_233_5461))
(assert (= height_256_1737_primed height_5421))
(assert (= val_256_1736_primed Anon_5422))
(assert (= v_node_256_1735_primed q_5728))
