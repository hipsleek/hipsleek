...
(assert (exists ((max_6137 Int)) (and (= n_5939 (+ 1 max_6137)) (or (and (= max_6137 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6137 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6138 Int)) (and (= n (+ 1 max_6138)) (or (and (= max_6138 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6138 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (or (= m_6060 0) (or (= n_6061 0) (< p_6013 1)))))
(check-sat)