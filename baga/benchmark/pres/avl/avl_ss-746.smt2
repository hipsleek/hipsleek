...
(declare-fun right_290_1955_primed () Int)
(declare-fun left_290_1954_primed () Int)
(declare-fun height_290_1953_primed () Int)
(declare-fun val_290_1952_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_290_1955_primed v_node_289_5935))
(assert (= left_290_1954_primed p_5423))
(assert (= height_290_1953_primed height_5421))
(assert (= val_290_1952_primed Anon_5422))
