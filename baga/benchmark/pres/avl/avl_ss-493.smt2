...
(declare-fun n_5482 () Int)
(declare-fun m_5481 () Int)
...
(assert (= res n_5477))
(assert (= m_5481 m_5476))
(assert (= n_5482 n_5477))
(assert (<= 0 m_5476))
(assert (<= 0 n_5477))
(assert (= x_primed 1))
(assert (or (and (and (< v_node_233_5461 1) (= m_5464 0)) (= n_5465 0)) (and (and (<= 1 n_5465) (<= 1 m_5464)) (> v_node_233_5461 0))))
(assert (or (and (and (< v_node_234_1491_primed 1) (= m_5481 0)) (= n_5482 0)) (and (and (<= 1 n_5482) (<= 1 m_5481)) (> v_node_234_1491_primed 0))))
