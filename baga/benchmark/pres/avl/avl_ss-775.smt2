...
(declare-fun height1_6245 () Int)
(declare-fun size1_6244 () Int)
(declare-fun p_6243 () Int)
(declare-fun height2_6248 () Int)
(declare-fun size2_6247 () Int)
(declare-fun q_6246 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_6175 (+ (+ size2_6247 1) size1_6244)))
(assert (<= height2_6248 (+ 1 height1_6245)))
(assert (<= height1_6245 (+ 1 height2_6248)))
(assert (exists ((max_33 Int)) (and (= n_6176 (+ 1 max_33)) (or (and (= max_33 height1_6245) (>= height1_6245 height2_6248)) (and (= max_33 height2_6248) (< height1_6245 height2_6248))))))
(assert (= height_6241 n_6176))
...
(assert (= k2_primed 3))
(assert (or (and (and (< p_6243 1) (= size1_6244 0)) (= height1_6245 0)) (and (and (<= 1 height1_6245) (<= 1 size1_6244)) (> p_6243 0))))
(assert (or (and (and (< q_6246 1) (= size2_6247 0)) (= height2_6248 0)) (and (and (<= 1 height2_6248) (<= 1 size2_6247)) (> q_6246 0))))
