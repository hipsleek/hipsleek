...
(declare-fun v_node_198_2742_primed () Int)
...
(assert (exists ((max_5027 Int)) (and (= n (+ 1 max_5027)) (or (and (= max_5027 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5027 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (or (and (and (< p_5015 1) (= size1_5016 0)) (= height1_5017 0)) (and (and (<= 1 height1_5017) (<= 1 size1_5016)) (> p_5015 0))))
...
(assert (exists ((max_5028 Int)) (and (= n_4941 (+ 1 max_5028)) (or (and (= max_5028 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5028 height2_5020) (< height1_5017 height2_5020))))))
(assert (= v_node_198_2742_primed q_5018))
(assert (or (and (and (< q_5018 1) (= size2_5019 0)) (= height2_5020 0)) (and (and (<= 1 height2_5020) (<= 1 size2_5019)) (> q_5018 0))))
;Negation of Consequence
(assert (not (or (= size2_5019 0) (or (= height2_5020 0) (< q_5018 1)))))
(check-sat)