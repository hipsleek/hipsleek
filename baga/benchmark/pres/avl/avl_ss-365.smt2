...
(declare-fun v_int_183_2619_primed () Int)
...
(declare-fun v_node_183_2607_primed () Int)
...
(assert (exists ((max_4775 Int)) (and (= n (+ 1 max_4775)) (or (and (= max_4775 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4775 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (<= 0 n_4755))
(assert (<= 0 m_4754))
(assert (= v_int_183_2619_primed n_4755))
(assert (<= 0 n_4672))
(assert (<= 0 m_4671))
...
(assert (exists ((max_4776 Int)) (and (= n_4589 (+ 1 max_4776)) (or (and (= max_4776 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4776 height2_4668) (< height1_4665 height2_4668))))))
