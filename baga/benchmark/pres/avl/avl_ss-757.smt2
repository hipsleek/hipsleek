...
(declare-fun res () Int)
(declare-fun v_int_313_2196_primed () Int)
(declare-fun v_int_313_2197_primed () Int)
...
(assert (<= 0 m_6034))
(assert (<= 0 n_6035))
(assert (= v_int_313_2197_primed n_6176))
(assert (<= 0 m_6175))
(assert (<= 0 n_6176))
(assert (= v_int_313_2196_primed 1))
(assert (= (+ res v_int_313_2196_primed) v_int_313_2197_primed))
(assert (= x_primed 1))
(assert (= k1_primed 2))
