...
(declare-fun n_6414 () Int)
(declare-fun m_6413 () Int)
...
(assert (> x_primed 0))
(assert (= res n_6361))
(assert (= m_6413 m_6360))
(assert (= n_6414 n_6361))
(assert (<= 0 m_6360))
(assert (<= 0 n_6361))
...
(assert (= k1_primed 2))
(assert (or (and (and (< x_primed 1) (= m_6413 0)) (= n_6414 0)) (and (and (<= 1 n_6414) (<= 1 m_6413)) (> x_primed 0))))
