...
(assert (exists ((max_6746 Int)) (and (= h_6628 (+ 1 max_6746)) (or (and (= max_6746 height1_6634) (>= height1_6634 height2_6637)) (and (= max_6746 height2_6637) (< height1_6634 height2_6637))))))
(assert (= height1_6634 n_5834))
(assert (exists ((max_6745 Int)) (and (= n_5834 (+ 1 max_6745)) (or (and (= max_6745 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6745 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6744 Int)) (and (= n_5670 (+ 1 max_6744)) (or (and (= max_6744 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6744 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6743 Int)) (and (= n_5465 (+ 1 max_6743)) (or (and (= max_6743 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6743 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (= n_5765 height2_5730))
(assert (<= 0 n_5834))
(assert (<= 0 n_5765))
(assert (<= 0 n_5810))
(assert (exists ((max_6741 Int)) (and (= height2_6637 (+ 1 max_6741)) (or (and (= max_6741 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6741 height2_6666) (< height1_6663 height2_6666))))))
...
(assert (exists ((max_6742 Int)) (and (= n (+ 1 max_6742)) (or (and (= max_6742 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6742 height2_5428) (< height1_5425 height2_5428))))))
