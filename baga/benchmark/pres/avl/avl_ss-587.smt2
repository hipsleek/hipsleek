...
(declare-fun height1_5718 () Int)
(declare-fun size1_5717 () Int)
(declare-fun p_5716 () Int)
(declare-fun height2_5721 () Int)
(declare-fun size2_5720 () Int)
(declare-fun q_5719 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m_5669 (+ (+ size2_5720 1) size1_5717)))
(assert (<= height2_5721 (+ 1 height1_5718)))
(assert (<= height1_5718 (+ 1 height2_5721)))
(assert (exists ((max_33 Int)) (and (= n_5670 (+ 1 max_33)) (or (and (= max_33 height1_5718) (>= height1_5718 height2_5721)) (and (= max_33 height2_5721) (< height1_5718 height2_5721))))))
(assert (= height_5714 n_5670))
...
(assert (= k2_primed 3))
(assert (or (and (and (< p_5716 1) (= size1_5717 0)) (= height1_5718 0)) (and (and (<= 1 height1_5718) (<= 1 size1_5717)) (> p_5716 0))))
(assert (or (and (and (< q_5719 1) (= size2_5720 0)) (= height2_5721 0)) (and (and (<= 1 height2_5721) (<= 1 size2_5720)) (> q_5719 0))))
