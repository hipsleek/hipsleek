...
(declare-fun v_int_120_3189_primed () Int)
...
(assert (<= 0 n_4249))
(assert (<= 0 m_4248))
(assert (= v_int_120_3189_primed n_4249))
...
(assert (or (and (and (< tmp2_primed 1) (= m_4248 0)) (= n_4249 0)) (and (and (<= 1 n_4249) (<= 1 m_4248)) (> tmp2_primed 0))))
