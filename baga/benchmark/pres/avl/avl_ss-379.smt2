...
(declare-fun v_node_198_2756_primed () Int)
...
(assert (exists ((max_5044 Int)) (and (= n (+ 1 max_5044)) (or (and (= max_5044 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5044 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5045 Int)) (and (= n_4941 (+ 1 max_5045)) (or (and (= max_5045 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5045 height2_5020) (< height1_5017 height2_5020))))))
(assert (= v_node_198_2756_primed p_5015))
(assert (or (and (and (< p_5015 1) (= size1_5016 0)) (= height1_5017 0)) (and (and (<= 1 height1_5017) (<= 1 size1_5016)) (> p_5015 0))))
;Negation of Consequence
(assert (not (or (= size1_5016 0) (or (= height1_5017 0) (< p_5015 1)))))
(check-sat)