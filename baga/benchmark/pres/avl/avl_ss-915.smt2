...
(assert (exists ((max_6407 Int)) (and (= n_6176 (+ 1 max_6407)) (or (and (= max_6407 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6407 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6406 Int)) (and (= n_5939 (+ 1 max_6406)) (or (and (= max_6406 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6406 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6405 Int)) (and (= n (+ 1 max_6405)) (or (and (= max_6405 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6405 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6408 Int)) (and (= n_6361 (+ 1 max_6408)) (or (and (= max_6408 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6408 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (not (or (and (= n_6361 (+ height1_6367 1)) (<= height2_6370 height1_6367)) (and (= n_6361 (+ height2_6370 1)) (< height1_6367 height2_6370)))))
(check-sat)