...
(assert (exists ((max_6139 Int)) (and (= n_5939 (+ 1 max_6139)) (or (and (= max_6139 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6139 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6140 Int)) (and (= n (+ 1 max_6140)) (or (and (= max_6140 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6140 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (<= height2_6122 (+ height1_6119 1))))
(check-sat)