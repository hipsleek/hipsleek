...
(declare-fun right_317_2232_primed () Int)
(declare-fun left_317_2231_primed () Int)
(declare-fun height_317_2230_primed () Int)
(declare-fun val_317_2229_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_317_2232_primed q_6255))
(assert (= left_317_2231_primed p_6252))
(assert (= height_317_2230_primed height_6250))
(assert (= val_317_2229_primed Anon_6251))
