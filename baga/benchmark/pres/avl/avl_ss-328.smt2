...
(declare-fun right_177_2533_primed () Int)
(declare-fun left_177_2532_primed () Int)
(declare-fun height_177_2531_primed () Int)
(declare-fun val_177_2530_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_177_2533_primed q_4550))
(assert (= left_177_2532_primed v_node_173_4585))
(assert (= height_177_2531_primed height_4545))
(assert (= val_177_2530_primed Anon_4546))
(assert (<= 0 n_4672))
(assert (<= 0 m_4671))
