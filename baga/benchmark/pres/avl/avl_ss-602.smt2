...
(declare-fun n_5772 () Int)
(declare-fun m_5771 () Int)
(declare-fun v_node_260_1782_primed () Int)
...
(assert (= v_node_260_1782_primed q_5728))
(assert (= m_5764 size2_5729))
(assert (= n_5765 height2_5730))
(assert (<= 0 size2_5729))
(assert (<= 0 height2_5730))
(assert (= res n_5765))
(assert (= m_5771 m_5764))
(assert (= n_5772 n_5765))
(assert (<= 0 m_5764))
(assert (<= 0 n_5765))
...
(assert (= k2_primed 3))
(assert (or (and (and (< v_node_260_1782_primed 1) (= m_5771 0)) (= n_5772 0)) (and (and (<= 1 n_5772) (<= 1 m_5771)) (> v_node_260_1782_primed 0))))
