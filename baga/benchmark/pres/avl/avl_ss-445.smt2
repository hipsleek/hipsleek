...
(assert (exists ((max_5250 Int)) (and (= n (+ 1 max_5250)) (or (and (= max_5250 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5250 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5251 Int)) (and (= n_4941 (+ 1 max_5251)) (or (and (= max_5251 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5251 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (exists ((max_5252 Int)) (and (= n_5107 (+ 1 max_5252)) (or (and (= max_5252 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5252 height2_5200) (< height1_5197 height2_5200))))))
...
(assert (not (or (= m_5129 0) (or (= n_5130 0) (< q_5018 1)))))
(check-sat)