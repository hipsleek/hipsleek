...
(declare-fun right_198_2746_primed () Int)
(declare-fun left_198_2745_primed () Int)
(declare-fun height_198_2744_primed () Int)
(declare-fun val_198_2743_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_198_2746_primed v_node_195_4937))
(assert (= left_198_2745_primed p_4547))
(assert (= height_198_2744_primed height_4545))
(assert (= val_198_2743_primed Anon_4546))
(assert (<= 0 n_5024))
(assert (<= 0 m_5023))
