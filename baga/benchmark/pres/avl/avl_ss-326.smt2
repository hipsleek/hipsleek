...
(declare-fun right_184_2651_primed () Int)
(declare-fun left_184_2650_primed () Int)
(declare-fun height_184_2649_primed () Int)
(declare-fun val_184_2648_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_184_2647_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2651_primed q_4666))
(assert (= left_184_2650_primed p_4663))
(assert (= height_184_2649_primed height_4661))
(assert (= val_184_2648_primed Anon_4662))
(assert (= v_node_184_2647_primed v_node_173_4585))
