...
(assert (exists ((max_4136 Int)) (and (= n_4038 (+ 1 max_4136)) (or (and (= max_4136 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4136 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (exists ((max_4137 Int)) (and (= n_4061 (+ 1 max_4137)) (or (and (= max_4137 height1_4067) (>= height1_4067 height2_4070)) (and (= max_4137 height2_4070) (< height1_4067 height2_4070))))))
(assert (= height1_4114 n_4038))
(assert (= height2_4117 n_4061))
;Negation of Consequence
(assert (not (<= height1_4114 (+ height2_4117 1))))
(check-sat)