...
(declare-fun right_292_2009_primed () Int)
(declare-fun left_292_2008_primed () Int)
(declare-fun height_292_2007_primed () Int)
(declare-fun val_292_2006_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_292_2009_primed v_node_289_5935))
(assert (= left_292_2008_primed p_5423))
(assert (= height_292_2007_primed height_5421))
(assert (= val_292_2006_primed Anon_5422))
