...
(declare-fun n_4023 () Int)
(declare-fun m_4022 () Int)
...
(assert (<= 0 an_3988))
(assert (= res n_4019))
(assert (= m_4022 m_4018))
(assert (= n_4023 n_4019))
(assert (<= 0 m_4018))
(assert (<= 0 n_4019))
...
(assert (or (and (and (< d_primed 1) (= m_4022 0)) (= n_4023 0)) (and (and (<= 1 n_4023) (<= 1 m_4022)) (> d_primed 0))))
