...
(declare-fun res () Int)
(declare-fun v_node_97_3388_primed () Int)
(declare-fun Anon_4111 () Int)
...
(assert (= res v_node_97_3388_primed))
(assert (= Anon_4111 v2_primed))
...
(assert (exists ((max_33 Int)) (and (= h_4108 (+ 1 max_33)) (or (and (= max_33 height1_4114) (>= height1_4114 height2_4117)) (and (= max_33 height2_4117) (< height1_4114 height2_4117))))))
