...
(declare-fun n_4211 () Int)
(declare-fun m_4210 () Int)
...
(assert (<= 0 an_4176))
(assert (= res n_4207))
(assert (= m_4210 m_4206))
(assert (= n_4211 n_4207))
(assert (<= 0 m_4206))
(assert (<= 0 n_4207))
...
(assert (or (and (and (< d_primed 1) (= m_4210 0)) (= n_4211 0)) (and (and (<= 1 n_4211) (<= 1 m_4210)) (> d_primed 0))))
