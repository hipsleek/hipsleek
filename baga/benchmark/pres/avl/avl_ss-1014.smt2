...
(assert (exists ((max_6824 Int)) (and (= n_5939 (+ 1 max_6824)) (or (and (= max_6824 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6824 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (exists ((max_6825 Int)) (and (= n_6113 (+ 1 max_6825)) (or (and (= max_6825 height1_6119) (>= height1_6119 height2_6122)) (and (= max_6825 height2_6122) (< height1_6119 height2_6122))))))
(assert (= height1_6777 n_6113))
(assert (= height2_6780 n_6104))
(assert (exists ((max_6826 Int)) (and (= h_6771 (+ 1 max_6826)) (or (and (= max_6826 height1_6777) (>= height1_6777 height2_6780)) (and (= max_6826 height2_6780) (< height1_6777 height2_6780))))))
(assert (exists ((max_6823 Int)) (and (= n (+ 1 max_6823)) (or (and (= max_6823 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6823 height2_5428) (< height1_5425 height2_5428))))))
(assert (= height_5421 n))
(assert (= h_6771 (+ 1 h_6167)))
;Negation of Consequence
(assert (not (<= h_6771 (+ n 1))))
(check-sat)