...
(assert (exists ((max_6703 Int)) (and (= n_5670 (+ 1 max_6703)) (or (and (= max_6703 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6703 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6702 Int)) (and (= n_5465 (+ 1 max_6702)) (or (and (= max_6702 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6702 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6701 Int)) (and (= n (+ 1 max_6701)) (or (and (= max_6701 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6701 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6704 Int)) (and (= n_5834 (+ 1 max_6704)) (or (and (= max_6704 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6704 height2_5843) (< height1_5840 height2_5843))))))
...
(assert (not (or (and (= h_5897 (+ 1 height1_6663)) (<= height2_6666 height1_6663)) (and (= h_5897 (+ 1 height2_6666)) (< height1_6663 height2_6666)))))
(check-sat)