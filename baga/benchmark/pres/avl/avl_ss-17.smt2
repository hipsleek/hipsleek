...
(assert (exists ((max_3728 Int)) (and (= nx (+ 1 max_3728)) (or (and (= max_3728 height1_3669) (>= height1_3669 height2_3672)) (and (= max_3728 height2_3672) (< height1_3669 height2_3672))))))
...
(assert (exists ((max_3729 Int)) (and (= height1_3690 (+ 1 max_3729)) (or (and (= max_3729 height1_3706) (>= height1_3706 height2_3709)) (and (= max_3729 height2_3709) (< height1_3706 height2_3709))))))
(assert (= height_3665 height1_3690))
(assert (= height2_3693 nx_3673))
;Negation of Consequence
(assert (not (<= height1_3690 (+ height2_3693 1))))
(check-sat)