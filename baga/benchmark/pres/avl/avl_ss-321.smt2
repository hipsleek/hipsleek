...
(declare-fun right_184_2637_primed () Int)
(declare-fun left_184_2636_primed () Int)
(declare-fun height_184_2635_primed () Int)
(declare-fun val_184_2634_primed () Int)
(declare-fun Anon_4662 () Int)
(declare-fun v_node_184_2633_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2637_primed q_4666))
(assert (= left_184_2636_primed p_4663))
(assert (= height_184_2635_primed height_4661))
(assert (= val_184_2634_primed Anon_4662))
(assert (= v_node_184_2633_primed v_node_173_4585))
