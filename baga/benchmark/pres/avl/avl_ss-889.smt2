...
(assert (exists ((max_6700 Int)) (and (= n_5834 (+ 1 max_6700)) (or (and (= max_6700 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6700 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6699 Int)) (and (= n_5670 (+ 1 max_6699)) (or (and (= max_6699 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6699 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6698 Int)) (and (= n_5465 (+ 1 max_6698)) (or (and (= max_6698 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6698 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6697 Int)) (and (= n (+ 1 max_6697)) (or (and (= max_6697 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6697 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (<= height1_6663 (+ height2_6666 1))))
(check-sat)