...
(declare-fun right_327_2324_primed () Int)
(declare-fun left_327_2323_primed () Int)
(declare-fun height_327_2322_primed () Int)
(declare-fun val_327_2321_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_327_2324_primed p_6252))
(assert (= left_327_2323_primed p_5423))
(assert (= height_327_2322_primed height_5421))
(assert (= val_327_2321_primed Anon_5422))
