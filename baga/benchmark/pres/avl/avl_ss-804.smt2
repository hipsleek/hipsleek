...
(declare-fun right_329_2328_primed () Int)
(declare-fun left_329_2327_primed () Int)
(declare-fun height_329_2326_primed () Int)
(declare-fun val_329_2325_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_329_2328_primed q_6016))
(assert (= left_329_2327_primed q_6255))
(assert (= height_329_2326_primed height_6011))
(assert (= val_329_2325_primed Anon_6012))
