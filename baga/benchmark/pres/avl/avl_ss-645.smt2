...
(declare-fun res () Int)
(declare-fun v_int_246_1668_primed () Int)
...
(assert (<= 0 m_5629))
(assert (<= 0 n_5630))
(assert (or (and (= h_primed n_5630) (>= n_5630 h_5642)) (and (= h_primed h_5642) (< n_5630 h_5642))))
(assert (= v_int_246_1668_primed 1))
(assert (= res (+ v_int_246_1668_primed h_primed)))
