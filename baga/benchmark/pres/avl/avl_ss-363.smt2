...
(declare-fun right_183_2597_primed () Int)
(declare-fun left_183_2596_primed () Int)
(declare-fun height_183_2595_primed () Int)
(declare-fun val_183_2594_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_183_2597_primed q_4550))
(assert (= left_183_2596_primed v_node_173_4585))
(assert (= height_183_2595_primed height_4545))
(assert (= val_183_2594_primed Anon_4546))
(assert (<= 0 n_4755))
(assert (<= 0 m_4754))
