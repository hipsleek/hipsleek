...
(declare-fun v_node_263_1801_primed () Int)
...
(assert (exists ((max_5785 Int)) (and (= n (+ 1 max_5785)) (or (and (= max_5785 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5785 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5786 Int)) (and (= n_5465 (+ 1 max_5786)) (or (and (= max_5786 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5786 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_5787 Int)) (and (= n_5670 (+ 1 max_5787)) (or (and (= max_5787 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5787 height2_5730) (< height1_5727 height2_5730))))))
(assert (= m_5656 m_5547))
(assert (= n_5657 n_5548))
(assert (<= 0 m_5656))
(assert (<= 0 n_5657))
(assert (= (+ n_5657 1) n_5670))
(assert (= v_node_263_1801_primed p_5539))
(assert (or (and (and (< p_5539 1) (= m_5656 0)) (= n_5657 0)) (and (and (<= 1 n_5657) (<= 1 m_5656)) (> p_5539 0))))
;Negation of Consequence
(assert (not (or (= m_5656 0) (or (= n_5657 0) (< p_5539 1)))))
(check-sat)