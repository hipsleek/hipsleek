...
(declare-fun n_6201 () Int)
(declare-fun m_6200 () Int)
...
(assert (<= 0 n_6022))
(assert (= res n_6195))
(assert (= m_6200 m_6194))
(assert (= n_6201 n_6195))
(assert (<= 0 m_6194))
(assert (<= 0 n_6195))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_313_2212_primed 1) (= m_6200 0)) (= n_6201 0)) (and (and (<= 1 n_6201) (<= 1 m_6200)) (> v_node_313_2212_primed 0))))
