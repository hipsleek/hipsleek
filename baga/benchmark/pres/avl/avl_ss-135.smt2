...
;Axioms assertions
;Antecedent
(assert (exists ((max_4145 Int)) (and (= h_4108 (+ 1 max_4145)) (or (and (= max_4145 height1_4114) (>= height1_4114 height2_4117)) (and (= max_4145 height2_4117) (< height1_4114 height2_4117))))))
...
(assert (<= 0 n_4038))
(assert (<= 0 n_4061))
(assert (exists ((max_4143 Int)) (and (= n_4061 (+ 1 max_4143)) (or (and (= max_4143 height1_4067) (>= height1_4067 height2_4070)) (and (= max_4143 height2_4070) (< height1_4067 height2_4070))))))
...
(assert (exists ((max_4144 Int)) (and (= n_4038 (+ 1 max_4144)) (or (and (= max_4144 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4144 height2_4047) (< height1_4044 height2_4047))))))
