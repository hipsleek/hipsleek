...
(declare-fun right_204_2796_primed () Int)
(declare-fun left_204_2795_primed () Int)
(declare-fun height_204_2794_primed () Int)
(declare-fun val_204_2793_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_204_2796_primed v_node_195_4937))
(assert (= left_204_2795_primed p_4547))
(assert (= height_204_2794_primed height_4545))
(assert (= val_204_2793_primed Anon_4546))
(assert (<= 0 n_5041))
(assert (<= 0 m_5040))
