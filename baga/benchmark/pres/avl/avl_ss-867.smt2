...
(declare-fun right_318_2241_primed () Int)
(declare-fun left_318_2240_primed () Int)
(declare-fun height_318_2239_primed () Int)
(declare-fun val_318_2238_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_318_2241_primed q_6255))
(assert (= left_318_2240_primed p_6252))
(assert (= height_318_2239_primed height_6250))
(assert (= val_318_2238_primed Anon_6251))
