...
(declare-fun right_198_2732_primed () Int)
(declare-fun left_198_2731_primed () Int)
(declare-fun height_198_2730_primed () Int)
(declare-fun val_198_2729_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_198_2732_primed v_node_195_4937))
(assert (= left_198_2731_primed p_4547))
(assert (= height_198_2730_primed height_4545))
(assert (= val_198_2729_primed Anon_4546))
