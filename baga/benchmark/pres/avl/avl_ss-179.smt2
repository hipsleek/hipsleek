...
(assert (<= 0 an))
(assert (= n an))
(assert (exists ((max_4243 Int)) (and (= n_4226 (+ 1 max_4243)) (or (and (= max_4243 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4243 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (not (or (and (= n_4226 (+ height1_4232 1)) (<= height2_4235 height1_4232)) (and (= n_4226 (+ height2_4235 1)) (< height1_4232 height2_4235)))))
(check-sat)