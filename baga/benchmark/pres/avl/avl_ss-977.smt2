...
(assert (exists ((max_6657 Int)) (and (= n_5670 (+ 1 max_6657)) (or (and (= max_6657 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6657 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6658 Int)) (and (= n_5465 (+ 1 max_6658)) (or (and (= max_6658 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6658 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6659 Int)) (and (= n (+ 1 max_6659)) (or (and (= max_6659 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6659 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6656 Int)) (and (= n_5834 (+ 1 max_6656)) (or (and (= max_6656 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6656 height2_5843) (< height1_5840 height2_5843))))))
...
(assert (not (or (= m_5833 0) (or (= n_5834 0) (< v_node_233_5461 1)))))
(check-sat)