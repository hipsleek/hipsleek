...
(assert (exists ((max_6314 Int)) (and (= n_6176 (+ 1 max_6314)) (or (and (= max_6314 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6314 height2_6257) (< height1_6254 height2_6257))))))
...
(assert (exists ((max_6312 Int)) (and (= n (+ 1 max_6312)) (or (and (= max_6312 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6312 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6313 Int)) (and (= n_5939 (+ 1 max_6313)) (or (and (= max_6313 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6313 height2_6018) (< height1_6015 height2_6018))))))
