...
(declare-fun right_183_2583_primed () Int)
(declare-fun left_183_2582_primed () Int)
(declare-fun height_183_2581_primed () Int)
(declare-fun val_183_2580_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_183_2583_primed q_4550))
(assert (= left_183_2582_primed v_node_173_4585))
(assert (= height_183_2581_primed height_4545))
(assert (= val_183_2580_primed Anon_4546))
(assert (<= 0 n_4689))
(assert (<= 0 m_4688))
