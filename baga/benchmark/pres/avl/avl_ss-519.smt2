...
(declare-fun n_5567 () Int)
(declare-fun m_5566 () Int)
...
(assert (= res n_5561))
(assert (= m_5566 m_5560))
(assert (= n_5567 n_5561))
(assert (<= 0 m_5560))
(assert (<= 0 n_5561))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_237_1549_primed 1) (= m_5566 0)) (= n_5567 0)) (and (and (<= 1 n_5567) (<= 1 m_5566)) (> v_node_237_1549_primed 0))))
