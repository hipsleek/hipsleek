...
(declare-fun n_4280 () Int)
(declare-fun m_4279 () Int)
...
(assert (= res n_4249))
(assert (= m_4279 m_4248))
(assert (= n_4280 n_4249))
(assert (<= 0 m_4248))
(assert (<= 0 n_4249))
(assert (or (and (and (< tmp1_primed 1) (= m_4225 0)) (= n_4226 0)) (and (and (<= 1 n_4226) (<= 1 m_4225)) (> tmp1_primed 0))))
(assert (or (and (and (< tmp2_primed 1) (= m_4279 0)) (= n_4280 0)) (and (and (<= 1 n_4280) (<= 1 m_4279)) (> tmp2_primed 0))))
