...
(declare-fun n_5636 () Int)
(declare-fun m_5635 () Int)
...
(assert (<= 0 n_5548))
(assert (= res n_5630))
(assert (= m_5635 m_5629))
(assert (= n_5636 n_5630))
(assert (<= 0 m_5629))
(assert (<= 0 n_5630))
...
(assert (= k1_primed 1))
(assert (= x_primed 2))
(assert (or (and (and (< v_node_245_1646_primed 1) (= m_5635 0)) (= n_5636 0)) (and (and (<= 1 n_5636) (<= 1 m_5635)) (> v_node_245_1646_primed 0))))
