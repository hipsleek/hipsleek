...
(assert (<= 0 n_4226))
(assert (exists ((max_4270 Int)) (and (= n_4226 (+ 1 max_4270)) (or (and (= max_4270 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4270 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (not (<= height2_4258 (+ height1_4255 1))))
(check-sat)