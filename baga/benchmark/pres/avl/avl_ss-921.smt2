...
(assert (exists ((max_6828 Int)) (and (= n_5939 (+ 1 max_6828)) (or (and (= max_6828 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6828 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (exists ((max_6829 Int)) (and (= n_6113 (+ 1 max_6829)) (or (and (= max_6829 height1_6119) (>= height1_6119 height2_6122)) (and (= max_6829 height2_6122) (< height1_6119 height2_6122))))))
(assert (= height1_6777 n_6113))
(assert (= height2_6780 n_6104))
(assert (exists ((max_6830 Int)) (and (= h_6771 (+ 1 max_6830)) (or (and (= max_6830 height1_6777) (>= height1_6777 height2_6780)) (and (= max_6830 height2_6780) (< height1_6777 height2_6780))))))
(assert (exists ((max_6827 Int)) (and (= n (+ 1 max_6827)) (or (and (= max_6827 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6827 height2_5428) (< height1_5425 height2_5428))))))
