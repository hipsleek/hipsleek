...
(declare-fun right_239_1570_primed () Int)
(declare-fun left_239_1569_primed () Int)
(declare-fun height_239_1568_primed () Int)
(declare-fun val_239_1567_primed () Int)
(declare-fun v_node_239_1566_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_239_1570_primed q_5426))
(assert (= left_239_1569_primed v_node_233_5461))
(assert (= height_239_1568_primed height_5421))
(assert (= val_239_1567_primed Anon_5422))
(assert (= v_node_239_1566_primed q_5542))
(assert (<= 0 n_5561))
(assert (<= 0 m_5560))
