...
(declare-fun n_4761 () Int)
(declare-fun m_4760 () Int)
...
(assert (<= 0 n_4672))
(assert (= res n_4755))
(assert (= m_4760 m_4754))
(assert (= n_4761 n_4755))
(assert (<= 0 m_4754))
(assert (<= 0 n_4755))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_183_2593_primed 1) (= m_4760 0)) (= n_4761 0)) (and (and (<= 1 n_4761) (<= 1 m_4760)) (> v_node_183_2593_primed 0))))
