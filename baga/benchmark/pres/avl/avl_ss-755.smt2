...
(declare-fun n_5956 () Int)
(declare-fun m_5955 () Int)
...
(assert (= res n_5951))
(assert (= m_5955 m_5950))
(assert (= n_5956 n_5951))
(assert (<= 0 m_5950))
(assert (<= 0 n_5951))
(assert (= x_primed 1))
(assert (or (and (and (< v_node_289_5935 1) (= m_5938 0)) (= n_5939 0)) (and (and (<= 1 n_5939) (<= 1 m_5938)) (> v_node_289_5935 0))))
(assert (or (and (and (< v_node_290_1981_primed 1) (= m_5955 0)) (= n_5956 0)) (and (and (<= 1 n_5956) (<= 1 m_5955)) (> v_node_290_1981_primed 0))))
