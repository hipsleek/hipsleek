...
(assert (exists ((max_4087 Int)) (and (= n_4038 (+ 1 max_4087)) (or (and (= max_4087 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4087 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (<= 0 cn))
(assert (= n_4012 cn))
(assert (exists ((max_4088 Int)) (and (= n_4061 (+ 1 max_4088)) (or (and (= max_4088 height1_4067) (>= height1_4067 height2_4070)) (and (= max_4088 height2_4070) (< height1_4067 height2_4070))))))
...
(assert (not (or (and (= n_4061 (+ height1_4067 1)) (<= height2_4070 height1_4067)) (and (= n_4061 (+ height2_4070 1)) (< height1_4067 height2_4070)))))
(check-sat)