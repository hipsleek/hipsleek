...
(assert (exists ((max_5870 Int)) (and (= n (+ 1 max_5870)) (or (and (= max_5870 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5870 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5868 Int)) (and (= n_5670 (+ 1 max_5868)) (or (and (= max_5868 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5868 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_5869 Int)) (and (= n_5465 (+ 1 max_5869)) (or (and (= max_5869 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5869 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (not (<= height1_5840 (+ height2_5843 1))))
(check-sat)