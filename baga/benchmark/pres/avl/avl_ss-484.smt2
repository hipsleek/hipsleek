...
(declare-fun right_204_2821_primed () Int)
(declare-fun left_204_2820_primed () Int)
(declare-fun height_204_2819_primed () Int)
(declare-fun val_204_2818_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_204_2817_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_204_2821_primed q_5018))
(assert (= left_204_2820_primed p_5015))
(assert (= height_204_2819_primed height_5013))
(assert (= val_204_2818_primed Anon_5014))
(assert (= v_node_204_2817_primed v_node_195_4937))
