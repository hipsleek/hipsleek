...
(assert (exists ((max_5867 Int)) (and (= n (+ 1 max_5867)) (or (and (= max_5867 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5867 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5865 Int)) (and (= n_5670 (+ 1 max_5865)) (or (and (= max_5865 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5865 height2_5730) (< height1_5727 height2_5730))))))
(assert (= height_5723 n_5670))
(assert (<= n_5548 n_5561))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_5866 Int)) (and (= n_5465 (+ 1 max_5866)) (or (and (= max_5866 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5866 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (not (<= height2_5843 (+ height1_5840 1))))
(check-sat)