...
(assert (exists ((max_5371 Int)) (and (= n_5107 (+ 1 max_5371)) (or (and (= max_5371 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5371 height2_5200) (< height1_5197 height2_5200))))))
...
(assert (exists ((max_5372 Int)) (and (= n_4941 (+ 1 max_5372)) (or (and (= max_5372 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5372 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (exists ((max_5373 Int)) (and (= n (+ 1 max_5373)) (or (and (= max_5373 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5373 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (or (and (and (< v_node_205_2885_primed 1) (= flted_106_5368 0)) (= flted_106_5367 0)) (and (and (<= 1 flted_106_5367) (<= 1 flted_106_5368)) (> v_node_205_2885_primed 0))))
;Negation of Consequence
(assert (not (or (= flted_106_5368 0) (or (= flted_106_5367 0) (< v_node_205_2885_primed 1)))))
(check-sat)