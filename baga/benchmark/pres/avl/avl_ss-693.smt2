...
(declare-fun n_6041 () Int)
(declare-fun m_6040 () Int)
...
(assert (= res n_6035))
(assert (= m_6040 m_6034))
(assert (= n_6041 n_6035))
(assert (<= 0 m_6034))
(assert (<= 0 n_6035))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_293_2039_primed 1) (= m_6040 0)) (= n_6041 0)) (and (and (<= 1 n_6041) (<= 1 m_6040)) (> v_node_293_2039_primed 0))))
