...
(declare-fun n_5789 () Int)
(declare-fun m_5788 () Int)
...
(assert (<= 0 n_5657))
(assert (= res n_5782))
(assert (= m_5788 m_5781))
(assert (= n_5789 n_5782))
(assert (<= 0 m_5781))
(assert (<= 0 n_5782))
...
(assert (= k2_primed 3))
(assert (or (and (and (< v_node_263_1801_primed 1) (= m_5788 0)) (= n_5789 0)) (and (and (<= 1 n_5789) (<= 1 m_5788)) (> v_node_263_1801_primed 0))))
