...
(assert (exists ((max_6386 Int)) (and (= n_6176 (+ 1 max_6386)) (or (and (= max_6386 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6386 height2_6257) (< height1_6254 height2_6257))))))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6387 Int)) (and (= n_5939 (+ 1 max_6387)) (or (and (= max_6387 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6387 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (exists ((max_6388 Int)) (and (= n (+ 1 max_6388)) (or (and (= max_6388 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6388 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (not (or (= m_6308 0) (or (= n_6309 0) (< p_5423 1)))))
(check-sat)