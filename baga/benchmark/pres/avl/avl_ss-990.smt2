...
(assert (exists ((max_6720 Int)) (and (= n_5834 (+ 1 max_6720)) (or (and (= max_6720 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6720 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6721 Int)) (and (= n_5670 (+ 1 max_6721)) (or (and (= max_6721 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6721 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6722 Int)) (and (= n_5465 (+ 1 max_6722)) (or (and (= max_6722 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6722 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6723 Int)) (and (= n (+ 1 max_6723)) (or (and (= max_6723 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6723 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6724 Int)) (and (= height2_6637 (+ 1 max_6724)) (or (and (= max_6724 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6724 height2_6666) (< height1_6663 height2_6666))))))
...
(assert (not (or (and (= height2_6637 (+ height1_6663 1)) (<= height2_6666 height1_6663)) (and (= height2_6637 (+ height2_6666 1)) (< height1_6663 height2_6666)))))
(check-sat)