...
(declare-fun right_244_1631_primed () Int)
(declare-fun left_244_1630_primed () Int)
(declare-fun height_244_1629_primed () Int)
(declare-fun val_244_1628_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_244_1631_primed q_5426))
(assert (= left_244_1630_primed q_5542))
(assert (= height_244_1629_primed height_5421))
(assert (= val_244_1628_primed Anon_5422))
