...
(declare-fun right_184_2660_primed () Int)
(declare-fun left_184_2659_primed () Int)
(declare-fun height_184_2658_primed () Int)
(declare-fun val_184_2657_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_184_2660_primed q_4550))
(assert (= left_184_2659_primed v_node_173_4585))
(assert (= height_184_2658_primed height_4545))
(assert (= val_184_2657_primed Anon_4546))
