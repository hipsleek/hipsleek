...
(assert (exists ((max_5260 Int)) (and (= n (+ 1 max_5260)) (or (and (= max_5260 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5260 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5261 Int)) (and (= n_4941 (+ 1 max_5261)) (or (and (= max_5261 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5261 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (exists ((max_5262 Int)) (and (= n_5107 (+ 1 max_5262)) (or (and (= max_5262 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5262 height2_5200) (< height1_5197 height2_5200))))))
(assert (<= height1_5197 (+ 1 height2_5200)))
(assert (<= height2_5200 (+ 1 height1_5197)))
(assert (= bn height1_5197))
(assert (= cn height2_5200))
;Negation of Consequence
(assert (not (<= (+ bn 0) (+ 1 cn))))
(check-sat)