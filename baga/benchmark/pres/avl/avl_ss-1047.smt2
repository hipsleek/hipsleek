...
(declare-fun right_469_1381_primed () Int)
(declare-fun left_469_1380_primed () Int)
(declare-fun p_6996 () Int)
(declare-fun height_469_1379_primed () Int)
(declare-fun val_469_1378_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_469_1381_primed q_6999))
(assert (= left_469_1380_primed p_6996))
(assert (= height_469_1379_primed height_6994))
(assert (= val_469_1378_primed Anon_6995))
(assert (<= 0 h2_7025))
(assert (<= 0 s2_7024))
(assert (<= 0 h1_7023))
(assert (<= 0 s1_7022))
