...
(declare-fun right_318_2246_primed () Int)
(declare-fun left_318_2245_primed () Int)
(declare-fun height_318_2244_primed () Int)
(declare-fun val_318_2243_primed () Int)
(declare-fun Anon_6012 () Int)
(declare-fun v_node_318_2242_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_318_2246_primed q_6016))
(assert (= left_318_2245_primed p_6013))
(assert (= height_318_2244_primed height_6011))
(assert (= val_318_2243_primed Anon_6012))
(assert (= v_node_318_2242_primed q_6255))
