...
(assert (exists ((max_3720 Int)) (and (= nx (+ 1 max_3720)) (or (and (= max_3720 height1_3669) (>= height1_3669 height2_3672)) (and (= max_3720 height2_3672) (< height1_3669 height2_3672))))))
...
(assert (not (or (= size2_3671 0) (or (= height2_3672 0) (< q_3670 1)))))
(check-sat)