...
(declare-fun right_200_2766_primed () Int)
(declare-fun left_200_2765_primed () Int)
(declare-fun height_200_2764_primed () Int)
(declare-fun val_200_2763_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_200_2766_primed v_node_195_4937))
(assert (= left_200_2765_primed p_4547))
(assert (= height_200_2764_primed height_4545))
(assert (= val_200_2763_primed Anon_4546))
(assert (<= 0 n_5041))
(assert (<= 0 m_5040))
