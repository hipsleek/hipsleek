...
(declare-fun n_5944 () Int)
(declare-fun m_5943 () Int)
...
(assert (<= 0 n1_5930))
(assert (= res n_5939))
(assert (= m_5943 m_5938))
(assert (= n_5944 n_5939))
(assert (<= 0 m_5938))
(assert (<= 0 n_5939))
(assert (or (and (and (< p_5423 1) (= size1_5424 0)) (= height1_5425 0)) (and (and (<= 1 height1_5425) (<= 1 size1_5424)) (> p_5423 0))))
(assert (= x_primed 1))
(assert (or (and (and (< v_node_290_1966_primed 1) (= m_5943 0)) (= n_5944 0)) (and (and (<= 1 n_5944) (<= 1 m_5943)) (> v_node_290_1966_primed 0))))
