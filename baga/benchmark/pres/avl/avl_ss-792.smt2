...
(declare-fun right_324_2288_primed () Int)
(declare-fun left_324_2287_primed () Int)
(declare-fun height_324_2286_primed () Int)
(declare-fun val_324_2285_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_324_2288_primed p_6252))
(assert (= left_324_2287_primed p_5423))
(assert (= height_324_2286_primed height_5421))
(assert (= val_324_2285_primed Anon_5422))
