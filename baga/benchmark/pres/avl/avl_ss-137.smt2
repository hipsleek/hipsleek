...
;Axioms assertions
;Antecedent
(assert (exists ((max_4157 Int)) (and (= h_4108 (+ 1 max_4157)) (or (and (= max_4157 height1_4114) (>= height1_4114 height2_4117)) (and (= max_4157 height2_4117) (< height1_4114 height2_4117))))))
...
(assert (<= 0 n_4038))
(assert (<= 0 n_4061))
(assert (exists ((max_4155 Int)) (and (= n_4061 (+ 1 max_4155)) (or (and (= max_4155 height1_4067) (>= height1_4067 height2_4070)) (and (= max_4155 height2_4070) (< height1_4067 height2_4070))))))
...
(assert (exists ((max_4156 Int)) (and (= n_4038 (+ 1 max_4156)) (or (and (= max_4156 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4156 height2_4047) (< height1_4044 height2_4047))))))
