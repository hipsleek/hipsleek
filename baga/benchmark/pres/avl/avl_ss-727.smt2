...
(declare-fun n_5887 () Int)
(declare-fun m_5886 () Int)
...
(assert (> k1_primed 0))
(assert (= res n_5834))
(assert (= m_5886 m_5833))
(assert (= n_5887 n_5834))
(assert (<= 0 m_5833))
(assert (<= 0 n_5834))
...
(assert (= x_primed 2))
(assert (or (and (and (< k1_primed 1) (= m_5886 0)) (= n_5887 0)) (and (and (<= 1 n_5887) (<= 1 m_5886)) (> k1_primed 0))))
