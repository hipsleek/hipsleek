...
(assert (<= 0 n_6361))
(assert (exists ((max_6461 Int)) (and (= n_6361 (+ 1 max_6461)) (or (and (= max_6461 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6461 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6464 Int)) (and (= n (+ 1 max_6464)) (or (and (= max_6464 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6464 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6462 Int)) (and (= n_6176 (+ 1 max_6462)) (or (and (= max_6462 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6462 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6463 Int)) (and (= n_5939 (+ 1 max_6463)) (or (and (= max_6463 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6463 height2_6018) (< height1_6015 height2_6018))))))
...
(assert (not (or (and (= h_primed (+ 1 height1_6423)) (<= height2_6426 height1_6423)) (and (= h_primed (+ 1 height2_6426)) (< height1_6423 height2_6426)))))
(check-sat)