...
(declare-fun right_204_2816_primed () Int)
(declare-fun left_204_2815_primed () Int)
(declare-fun height_204_2814_primed () Int)
(declare-fun val_204_2813_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_204_2816_primed v_node_195_4937))
(assert (= left_204_2815_primed p_4547))
(assert (= height_204_2814_primed height_4545))
(assert (= val_204_2813_primed Anon_4546))
