...
(declare-fun right_194_2689_primed () Int)
(declare-fun left_194_2688_primed () Int)
(declare-fun height_194_2687_primed () Int)
(declare-fun val_194_2686_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_194_2689_primed q_4550))
(assert (= left_194_2688_primed p_4547))
(assert (= height_194_2687_primed height_4545))
(assert (= val_194_2686_primed Anon_4546))
(assert (= x_primed x))
(assert (= a_primed a))
