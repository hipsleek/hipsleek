...
(declare-fun right_237_1523_primed () Int)
(declare-fun left_237_1522_primed () Int)
(declare-fun height_237_1521_primed () Int)
(declare-fun val_237_1520_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_237_1523_primed q_5542))
(assert (= left_237_1522_primed p_5539))
(assert (= height_237_1521_primed height_5537))
(assert (= val_237_1520_primed Anon_5538))
