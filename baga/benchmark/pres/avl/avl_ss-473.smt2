...
(declare-fun rlm () Int)
(declare-fun rrm () Int)
(declare-fun flted_34_5095 () Int)
(declare-fun flted_34_5096 () Int)
(declare-fun res () Int)
...
(assert (<= 0 m_4952))
(assert (<= 0 n_4953))
(assert (= flted_34_5096 (+ (+ (+ rrm lm) 2) rlm)))
(assert (= flted_34_5095 (+ ln 2)))
...
(assert (or (and (and (< res 1) (= flted_34_5096 0)) (= flted_34_5095 0)) (and (and (<= 1 flted_34_5095) (<= 1 flted_34_5096)) (> res 0))))
