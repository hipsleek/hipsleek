...
(declare-fun res () Int)
(declare-fun v_int_175_2515_primed () Int)
(declare-fun v_int_175_2514_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_175_2514_primed 2))
(assert (= (+ v_int_175_2515_primed n_4601) n_4589))
(assert (<= 0 n_4601))
(assert (<= 0 m_4600))
...
(assert (> res 0))
(assert (= v_int_175_2515_primed v_int_175_2514_primed))
(assert (= x_primed 1))
