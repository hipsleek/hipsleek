...
(assert (<= 0 n_4226))
(assert (exists ((max_4271 Int)) (and (= n_4226 (+ 1 max_4271)) (or (and (= max_4271 height1_4232) (>= height1_4232 height2_4235)) (and (= max_4271 height2_4235) (< height1_4232 height2_4235))))))
...
(assert (not (<= height1_4255 (+ height2_4258 1))))
(check-sat)