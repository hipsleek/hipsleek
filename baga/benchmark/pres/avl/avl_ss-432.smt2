...
(declare-fun right_205_2840_primed () Int)
(declare-fun left_205_2839_primed () Int)
(declare-fun height_205_2838_primed () Int)
(declare-fun val_205_2837_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2840_primed v_node_195_4937))
(assert (= left_205_2839_primed p_4547))
(assert (= height_205_2838_primed height_4545))
(assert (= val_205_2837_primed Anon_4546))
