...
(declare-fun right_200_2779_primed () Int)
(declare-fun left_200_2778_primed () Int)
(declare-fun height_200_2777_primed () Int)
(declare-fun val_200_2776_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_200_2779_primed v_node_195_4937))
(assert (= left_200_2778_primed p_4547))
(assert (= height_200_2777_primed height_4545))
(assert (= val_200_2776_primed Anon_4546))
