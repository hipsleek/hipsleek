...
(declare-fun res () Int)
(declare-fun v_int_121_3201_primed () Int)
...
(assert (<= 0 m_4248))
(assert (<= 0 n_4249))
(assert (or (and (= h_primed n_4226) (>= n_4226 n_4249)) (and (= h_primed n_4249) (< n_4226 n_4249))))
(assert (= v_int_121_3201_primed 1))
(assert (= res (+ v_int_121_3201_primed h_primed)))
