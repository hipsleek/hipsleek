...
(assert (exists ((max_5264 Int)) (and (= n_4941 (+ 1 max_5264)) (or (and (= max_5264 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5264 height2_5020) (< height1_5017 height2_5020))))))
(assert (= height_5013 n_4941))
(assert (<= height2_4552 (+ 1 height1_4549)))
(assert (<= height1_4549 (+ 1 height2_4552)))
(assert (exists ((max_5263 Int)) (and (= n (+ 1 max_5263)) (or (and (= max_5263 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5263 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5265 Int)) (and (= n_5107 (+ 1 max_5265)) (or (and (= max_5265 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5265 height2_5200) (< height1_5197 height2_5200))))))
