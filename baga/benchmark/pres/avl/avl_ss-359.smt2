...
(declare-fun v_node_183_2593_primed () Int)
...
(assert (exists ((max_4758 Int)) (and (= n (+ 1 max_4758)) (or (and (= max_4758 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4758 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_4759 Int)) (and (= n_4589 (+ 1 max_4759)) (or (and (= max_4759 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4759 height2_4668) (< height1_4665 height2_4668))))))
