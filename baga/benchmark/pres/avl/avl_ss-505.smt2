...
(declare-fun right_205_2854_primed () Int)
(declare-fun left_205_2853_primed () Int)
(declare-fun height_205_2852_primed () Int)
(declare-fun val_205_2851_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_205_2854_primed v_node_195_4937))
(assert (= left_205_2853_primed p_4547))
(assert (= height_205_2852_primed height_4545))
(assert (= val_205_2851_primed Anon_4546))
