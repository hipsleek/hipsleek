...
(assert (exists ((max_5243 Int)) (and (= n_5107 (+ 1 max_5243)) (or (and (= max_5243 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5243 height2_5200) (< height1_5197 height2_5200))))))
...
(assert (exists ((max_5241 Int)) (and (= n (+ 1 max_5241)) (or (and (= max_5241 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5241 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5242 Int)) (and (= n_4941 (+ 1 max_5242)) (or (and (= max_5242 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5242 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (not (or (= m_4952 0) (or (= n_4953 0) (< p_4547 1)))))
(check-sat)