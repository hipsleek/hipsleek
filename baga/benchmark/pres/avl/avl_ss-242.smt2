...
(declare-fun n_4606 () Int)
(declare-fun m_4605 () Int)
...
(assert (= res n_4601))
(assert (= m_4605 m_4600))
(assert (= n_4606 n_4601))
(assert (<= 0 m_4600))
(assert (<= 0 n_4601))
(assert (= x_primed 1))
(assert (or (and (and (< v_node_173_4585 1) (= m_4588 0)) (= n_4589 0)) (and (and (<= 1 n_4589) (<= 1 m_4588)) (> v_node_173_4585 0))))
(assert (or (and (and (< v_node_175_2503_primed 1) (= m_4605 0)) (= n_4606 0)) (and (and (<= 1 n_4606) (<= 1 m_4605)) (> v_node_175_2503_primed 0))))
