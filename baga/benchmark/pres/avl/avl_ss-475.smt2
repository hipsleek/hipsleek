...
(declare-fun right_204_2801_primed () Int)
(declare-fun left_204_2800_primed () Int)
(declare-fun height_204_2799_primed () Int)
(declare-fun val_204_2798_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_204_2797_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_204_2801_primed q_5018))
(assert (= left_204_2800_primed p_5015))
(assert (= height_204_2799_primed height_5013))
(assert (= val_204_2798_primed Anon_5014))
(assert (= v_node_204_2797_primed v_node_195_4937))
(assert (<= 0 n_5041))
(assert (<= 0 m_5040))
