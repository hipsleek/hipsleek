...
(assert (exists ((max_6905 Int)) (and (= n_6176 (+ 1 max_6905)) (or (and (= max_6905 height1_6254) (>= height1_6254 height2_6257)) (and (= max_6905 height2_6257) (< height1_6254 height2_6257))))))
(assert (= height_6250 n_6176))
(assert (<= n_6022 n_6035))
(assert (<= height2_6018 (+ 1 height1_6015)))
(assert (<= height1_6015 (+ 1 height2_6018)))
(assert (exists ((max_6904 Int)) (and (= n_5939 (+ 1 max_6904)) (or (and (= max_6904 height1_6015) (>= height1_6015 height2_6018)) (and (= max_6904 height2_6018) (< height1_6015 height2_6018))))))
(assert (= height_6011 n_5939))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6903 Int)) (and (= n (+ 1 max_6903)) (or (and (= max_6903 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6903 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6906 Int)) (and (= n_6361 (+ 1 max_6906)) (or (and (= max_6906 height1_6367) (>= height1_6367 height2_6370)) (and (= max_6906 height2_6370) (< height1_6367 height2_6370))))))
...
(assert (exists ((max_6907 Int)) (and (= n_6417 (+ 1 max_6907)) (or (and (= max_6907 height1_6423) (>= height1_6423 height2_6426)) (and (= max_6907 height2_6426) (< height1_6423 height2_6426))))))
(assert (exists ((max_6908 Int)) (and (= h_6835 (+ 1 max_6908)) (or (and (= max_6908 height1_6841) (>= height1_6841 height2_6844)) (and (= max_6908 height2_6844) (< height1_6841 height2_6844))))))
