...
(assert (exists ((max_5247 Int)) (and (= n (+ 1 max_5247)) (or (and (= max_5247 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5247 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5248 Int)) (and (= n_4941 (+ 1 max_5248)) (or (and (= max_5248 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5248 height2_5020) (< height1_5017 height2_5020))))))
...
(assert (exists ((max_5249 Int)) (and (= n_5107 (+ 1 max_5249)) (or (and (= max_5249 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5249 height2_5200) (< height1_5197 height2_5200))))))
...
(assert (not (or (= size2_5199 0) (or (= height2_5200 0) (< q_5198 1)))))
(check-sat)