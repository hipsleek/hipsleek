...
(assert (exists ((max_4896 Int)) (and (= n_4772 (+ 1 max_4896)) (or (and (= max_4896 height1_4841) (>= height1_4841 height2_4844)) (and (= max_4896 height2_4844) (< height1_4841 height2_4844))))))
...
(assert (exists ((max_4894 Int)) (and (= n (+ 1 max_4894)) (or (and (= max_4894 height1_4549) (>= height1_4549 height2_4552)) (and (= max_4894 height2_4552) (< height1_4549 height2_4552))))))
(assert (<= height1_4549 (+ 1 height2_4552)))
(assert (<= height2_4552 (+ 1 height1_4549)))
(assert (= height_4661 n_4589))
(assert (exists ((max_4895 Int)) (and (= n_4589 (+ 1 max_4895)) (or (and (= max_4895 height1_4665) (>= height1_4665 height2_4668)) (and (= max_4895 height2_4668) (< height1_4665 height2_4668))))))
(assert (= n_4601 height2_4552))
(assert (= (+ 2 n_4601) n_4589))
(assert (= an n_4755))
(assert (<= 0 n_4601))
;Negation of Consequence
(assert (not (= n_4601 an)))
(check-sat)