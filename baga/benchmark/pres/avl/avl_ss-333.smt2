...
(declare-fun n_4695 () Int)
(declare-fun m_4694 () Int)
...
(assert (= res n_4689))
(assert (= m_4694 m_4688))
(assert (= n_4695 n_4689))
(assert (<= 0 m_4688))
(assert (<= 0 n_4689))
(assert (= x_primed 1))
...
(assert (or (and (and (< v_node_177_2543_primed 1) (= m_4694 0)) (= n_4695 0)) (and (and (<= 1 n_4695) (<= 1 m_4694)) (> v_node_177_2543_primed 0))))
