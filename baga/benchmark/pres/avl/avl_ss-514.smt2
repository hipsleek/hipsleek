...
(declare-fun n_5554 () Int)
(declare-fun m_5553 () Int)
...
(assert (= res n_5548))
(assert (= m_5553 m_5547))
(assert (= n_5554 n_5548))
(assert (<= 0 m_5547))
(assert (<= 0 n_5548))
(assert (= x_primed 1))
(assert (= k1_primed 2))
...
(assert (or (and (and (< v_node_237_1534_primed 1) (= m_5553 0)) (= n_5554 0)) (and (and (<= 1 n_5554) (<= 1 m_5553)) (> v_node_237_1534_primed 0))))
