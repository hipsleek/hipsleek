...
(assert (exists ((max_4081 Int)) (and (= n_4038 (+ 1 max_4081)) (or (and (= max_4081 height1_4044) (>= height1_4044 height2_4047)) (and (= max_4081 height2_4047) (< height1_4044 height2_4047))))))
...
(assert (not (or (= m_4018 0) (or (= n_4019 0) (< d_primed 1)))))
(check-sat)