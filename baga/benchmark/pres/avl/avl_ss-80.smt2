...
(declare-fun n_4016 () Int)
(declare-fun m_4015 () Int)
...
(assert (<= 0 cn))
(assert (= res n_4012))
(assert (= m_4015 m_4011))
(assert (= n_4016 n_4012))
(assert (<= 0 m_4011))
(assert (<= 0 n_4012))
...
(assert (or (and (and (< c_primed 1) (= m_4015 0)) (= n_4016 0)) (and (and (<= 1 n_4016) (<= 1 m_4015)) (> c_primed 0))))
