...
(declare-fun n_6067 () Int)
(declare-fun m_6066 () Int)
...
(assert (<= 0 n_6035))
(assert (= res n_6061))
(assert (= m_6066 m_6060))
(assert (= n_6067 n_6061))
(assert (<= 0 m_6060))
(assert (<= 0 n_6061))
(assert (= k1_primed 1))
...
(assert (= x_primed 2))
(assert (or (and (and (< v_node_296_2075_primed 1) (= m_6066 0)) (= n_6067 0)) (and (and (<= 1 n_6067) (<= 1 m_6066)) (> v_node_296_2075_primed 0))))
