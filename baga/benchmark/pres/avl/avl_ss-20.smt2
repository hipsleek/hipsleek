...
(assert (exists ((max_3736 Int)) (and (= nx (+ 1 max_3736)) (or (and (= max_3736 height1_3669) (>= height1_3669 height2_3672)) (and (= max_3736 height2_3672) (< height1_3669 height2_3672))))))
...
(assert (exists ((max_3737 Int)) (and (= height1_3690 (+ 1 max_3737)) (or (and (= max_3737 height1_3706) (>= height1_3706 height2_3709)) (and (= max_3737 height2_3709) (< height1_3706 height2_3709))))))
