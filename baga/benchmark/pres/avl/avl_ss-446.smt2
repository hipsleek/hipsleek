...
(assert (exists ((max_5255 Int)) (and (= n_4941 (+ 1 max_5255)) (or (and (= max_5255 height1_5017) (>= height1_5017 height2_5020)) (and (= max_5255 height2_5020) (< height1_5017 height2_5020))))))
(assert (= height_5013 n_4941))
(assert (<= height2_4552 (+ 1 height1_4549)))
(assert (<= height1_4549 (+ 1 height2_4552)))
(assert (exists ((max_5254 Int)) (and (= n (+ 1 max_5254)) (or (and (= max_5254 height1_4549) (>= height1_4549 height2_4552)) (and (= max_5254 height2_4552) (< height1_4549 height2_4552))))))
...
(assert (exists ((max_5256 Int)) (and (= n_5107 (+ 1 max_5256)) (or (and (= max_5256 height1_5197) (>= height1_5197 height2_5200)) (and (= max_5256 height2_5200) (< height1_5197 height2_5200))))))
(assert (= (+ n_5130 1) n_5107))
(assert (= n_5130 n_5024))
(assert (= an n_4953))
(assert (<= 0 n_5130))
;Negation of Consequence
(assert (not (= n_5130 an)))
(check-sat)