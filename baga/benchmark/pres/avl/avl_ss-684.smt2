...
(assert (exists ((max_5768 Int)) (and (= n (+ 1 max_5768)) (or (and (= max_5768 height1_5425) (>= height1_5425 height2_5428)) (and (= max_5768 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_5769 Int)) (and (= n_5465 (+ 1 max_5769)) (or (and (= max_5769 height1_5541) (>= height1_5541 height2_5544)) (and (= max_5769 height2_5544) (< height1_5541 height2_5544))))))
...
(assert (exists ((max_5770 Int)) (and (= n_5670 (+ 1 max_5770)) (or (and (= max_5770 height1_5727) (>= height1_5727 height2_5730)) (and (= max_5770 height2_5730) (< height1_5727 height2_5730))))))
...
(assert (not (or (= size2_5729 0) (or (= height2_5730 0) (< q_5728 1)))))
(check-sat)