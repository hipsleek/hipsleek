...
(declare-fun right_293_2013_primed () Int)
(declare-fun left_293_2012_primed () Int)
(declare-fun height_293_2011_primed () Int)
(declare-fun val_293_2010_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_293_2013_primed q_6016))
(assert (= left_293_2012_primed p_6013))
(assert (= height_293_2011_primed height_6011))
(assert (= val_293_2010_primed Anon_6012))
