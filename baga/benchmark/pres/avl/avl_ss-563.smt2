...
(declare-fun right_232_1446_primed () Int)
(declare-fun left_232_1445_primed () Int)
(declare-fun height_232_1444_primed () Int)
(declare-fun val_232_1443_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_232_1446_primed q_5426))
(assert (= left_232_1445_primed p_5423))
(assert (= height_232_1444_primed height_5421))
(assert (= val_232_1443_primed Anon_5422))
(assert (= x_primed x))
(assert (= a_primed a))
