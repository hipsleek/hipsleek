...
(declare-fun right_247_1672_primed () Int)
(declare-fun left_247_1671_primed () Int)
(declare-fun height_247_1670_primed () Int)
(declare-fun val_247_1669_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_247_1672_primed x_primed))
(assert (= left_247_1671_primed p_5539))
(assert (= height_247_1670_primed height_5537))
(assert (= val_247_1669_primed Anon_5538))
(assert (= h_primed (+ 1 h_5648)))
