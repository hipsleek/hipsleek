...
(declare-fun res () Int)
(declare-fun v_int_245_1657_primed () Int)
...
(assert (<= 0 m_5547))
(assert (<= 0 n_5548))
(assert (= v_int_245_1657_primed n_5630))
(assert (<= 0 m_5629))
(assert (<= 0 n_5630))
(assert (or (and (= res v_int_245_1657_primed) (>= v_int_245_1657_primed h_primed)) (and (= res h_primed) (< v_int_245_1657_primed h_primed))))
