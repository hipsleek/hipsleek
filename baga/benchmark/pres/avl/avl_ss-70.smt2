...
(declare-fun n_3997 () Int)
(declare-fun m_3996 () Int)
...
(assert (<= 0 bn))
(assert (= res n_3993))
(assert (= m_3996 m_3992))
(assert (= n_3997 n_3993))
(assert (<= 0 m_3992))
(assert (<= 0 n_3993))
...
(assert (or (and (and (< b_primed 1) (= m_3996 0)) (= n_3997 0)) (and (and (<= 1 n_3997) (<= 1 m_3996)) (> b_primed 0))))
