...
(declare-fun Anon_7010 () Int)
(declare-fun flted_161_7009 () Int)
(declare-fun res () Int)
...
(assert (or (and (and (< res 1) (= flted_161_7009 0)) (= Anon_7010 0)) (and (and (<= 1 Anon_7010) (<= 1 flted_161_7009)) (> res 0))))
