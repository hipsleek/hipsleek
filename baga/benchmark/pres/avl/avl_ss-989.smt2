...
(assert (exists ((max_6715 Int)) (and (= n_5834 (+ 1 max_6715)) (or (and (= max_6715 height1_5840) (>= height1_5840 height2_5843)) (and (= max_6715 height2_5843) (< height1_5840 height2_5843))))))
(assert (= h_5823 n_5834))
(assert (<= height2_5730 (+ 1 height1_5727)))
(assert (<= height1_5727 (+ 1 height2_5730)))
(assert (exists ((max_6716 Int)) (and (= n_5670 (+ 1 max_6716)) (or (and (= max_6716 height1_5727) (>= height1_5727 height2_5730)) (and (= max_6716 height2_5730) (< height1_5727 height2_5730))))))
(assert (<= height2_5544 (+ 1 height1_5541)))
(assert (<= height1_5541 (+ 1 height2_5544)))
(assert (exists ((max_6717 Int)) (and (= n_5465 (+ 1 max_6717)) (or (and (= max_6717 height1_5541) (>= height1_5541 height2_5544)) (and (= max_6717 height2_5544) (< height1_5541 height2_5544))))))
(assert (= height_5537 n_5465))
(assert (<= height2_5428 (+ 1 height1_5425)))
(assert (<= height1_5425 (+ 1 height2_5428)))
(assert (exists ((max_6718 Int)) (and (= n (+ 1 max_6718)) (or (and (= max_6718 height1_5425) (>= height1_5425 height2_5428)) (and (= max_6718 height2_5428) (< height1_5425 height2_5428))))))
...
(assert (exists ((max_6719 Int)) (and (= height2_6637 (+ 1 max_6719)) (or (and (= max_6719 height1_6663) (>= height1_6663 height2_6666)) (and (= max_6719 height2_6666) (< height1_6663 height2_6666))))))
...
(assert (not (= h_5897 height2_6637)))
(check-sat)