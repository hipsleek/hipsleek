...
(declare-fun right_198_2751_primed () Int)
(declare-fun left_198_2750_primed () Int)
(declare-fun height_198_2749_primed () Int)
(declare-fun val_198_2748_primed () Int)
(declare-fun Anon_5014 () Int)
(declare-fun v_node_198_2747_primed () Int)
(declare-fun v_node_195_4937 () Int)
(declare-fun v_int_198_2762_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_198_2751_primed q_5018))
(assert (= left_198_2750_primed p_5015))
(assert (= height_198_2749_primed height_5013))
(assert (= val_198_2748_primed Anon_5014))
(assert (= v_node_198_2747_primed v_node_195_4937))
(assert (<= 0 n_5024))
(assert (<= 0 m_5023))
(assert (= v_int_198_2762_primed n_5024))
