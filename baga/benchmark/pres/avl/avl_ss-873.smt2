...
(declare-fun n_6282 () Int)
(declare-fun m_6281 () Int)
...
(assert (= res n_6275))
(assert (= m_6281 m_6274))
(assert (= n_6282 n_6275))
(assert (<= 0 m_6274))
(assert (<= 0 n_6275))
...
(assert (= x_primed 2))
(assert (= k1_primed 3))
(assert (or (and (and (< v_node_319_2261_primed 1) (= m_6281 0)) (= n_6282 0)) (and (and (<= 1 n_6282) (<= 1 m_6281)) (> v_node_319_2261_primed 0))))
