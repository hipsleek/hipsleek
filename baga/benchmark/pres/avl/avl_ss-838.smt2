...
(declare-fun right_307_2170_primed () Int)
(declare-fun left_307_2169_primed () Int)
(declare-fun height_307_2168_primed () Int)
(declare-fun val_307_2167_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_307_2170_primed q_6016))
(assert (= left_307_2169_primed x_primed))
(assert (= height_307_2168_primed height_6011))
(assert (= val_307_2167_primed Anon_6012))
(assert (= h_primed (+ 1 h_6167)))
(assert (or (and (= h_6167 n_6113) (>= n_6113 hr_primed)) (and (= h_6167 hr_primed) (< n_6113 hr_primed))))
(assert (<= 0 n_6113))
(assert (<= 0 m_6112))
(assert (> x_primed 0))
(assert (<= 0 n_6077))
