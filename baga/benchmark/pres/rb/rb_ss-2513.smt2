...
(declare-fun right_440_2633_primed () Int)
(declare-fun left_440_2632_primed () Int)
(declare-fun color_440_2631_primed () Int)
(declare-fun val_440_2630_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_440_2633_primed r_14920))
(assert (= left_440_2632_primed l_14916))
(assert (= color_440_2631_primed flted_13_14914))
(assert (= val_440_2630_primed v_14915))
(assert (= x_primed x))
(assert (= a_primed a))
(assert (<= 0 cl))
(assert (<= cl 1))
