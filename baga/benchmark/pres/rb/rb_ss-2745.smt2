...
(assert (not (or (and (and (and (= flted_12_16438 0) (<= 2 bhr_16420)) (<= 1 nr_16419)) (> r_16418 0)) (or (and (and (and (< r_16418 1) (= nr_16419 0)) (= bhr_16420 1)) (= flted_12_16438 0)) (and (and (and (= flted_12_16438 1) (<= 1 bhr_16420)) (<= 1 nr_16419)) (> r_16418 0))))))
(check-sat)