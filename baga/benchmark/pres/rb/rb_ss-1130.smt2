...
(assert (= bhl_10283 bhl_9858))
(assert (= nl_10282 nl_9857))
(assert (= flted_12_9852 0))
(assert (= bhl_9858 ha))
(assert (= bhr_9861 ha))
(assert (= na (+ (+ nr_9860 1) nl_9857)))
(assert (= r_10284 r_9859))
