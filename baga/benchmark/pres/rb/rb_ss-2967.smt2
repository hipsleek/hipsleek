...
;Axioms assertions
;Antecedent
(assert (= right_542_1777_primed r_16674))
(assert (= left_542_1776_primed l_16670))
(assert (= color_542_1775_primed flted_13_16668))
(assert (= val_542_1774_primed v_16669))
(assert (<= Anon_16696 1))
(assert (<= 0 Anon_16696))
(assert (<= 1 bh_16697))
(assert (<= 0 n_16695))
...
(assert (or (and (and (and (= Anon_16722 0) (<= 2 bh1_16723)) (<= 1 flted_529_16721)) (> v_node_542_1773_primed 0)) (or (and (and (and (< v_node_542_1773_primed 1) (= flted_529_16721 0)) (= bh1_16723 1)) (= Anon_16722 0)) (and (and (and (= Anon_16722 1) (<= 1 bh1_16723)) (<= 1 flted_529_16721)) (> v_node_542_1773_primed 0)))))
