...
(declare-fun l_7579 () Int)
(declare-fun c_primed () Int)
(declare-fun nl_7580 () Int)
(declare-fun Anon_7581 () Int)
...
(declare-fun nb () Int)
(declare-fun b () Int)
(declare-fun bhl_7582 () Int)
(declare-fun h_7285 () Int)
(declare-fun r_7583 () Int)
...
(assert (= l_7579 c_primed))
(assert (= nl_7580 nc))
(assert (= Anon_7581 flted_154_7525))
