...
(declare-fun cl_13934 () Int)
(declare-fun bh_13935 () Int)
(declare-fun n_13933 () Int)
...
(assert (= cl_13922 0))
(assert (not (> res 0)))
(assert (= n_13933 n_13921))
(assert (= cl_13934 cl_13922))
(assert (= bh_13935 bh_13923))
(assert (<= 0 n_13921))
(assert (<= 1 bh_13923))
(assert (<= 0 cl_13922))
(assert (<= cl_13922 1))
...
(assert (or (and (and (and (= cl_13934 0) (<= 2 bh_13935)) (<= 1 n_13933)) (> v_node_314_3269_primed 0)) (or (and (and (and (< v_node_314_3269_primed 1) (= n_13933 0)) (= bh_13935 1)) (= cl_13934 0)) (and (and (and (= cl_13934 1) (<= 1 bh_13935)) (<= 1 n_13933)) (> v_node_314_3269_primed 0)))))
