...
(declare-fun bh () Int)
(declare-fun cl () Int)
(declare-fun v_int_273_3671_primed () Int)
...
(assert (= v_int_273_3671_primed 1))
...
(assert (= b_primed 1))
(assert (= r_11748 2))
(assert (or (and (and (and (= flted_171_12063 0) (<= 2 flted_171_12062)) (<= 1 flted_171_12064)) (> res 0)) (or (and (and (and (< res 1) (= flted_171_12064 0)) (= flted_171_12062 1)) (= flted_171_12063 0)) (and (and (and (= flted_171_12063 1) (<= 1 flted_171_12062)) (<= 1 flted_171_12064)) (> res 0)))))
