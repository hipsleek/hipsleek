...
(declare-fun right_322_3288_primed () Int)
(declare-fun left_322_3287_primed () Int)
(declare-fun color_322_3286_primed () Int)
(declare-fun val_322_3285_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_322_3288_primed r_13896))
(assert (= left_322_3287_primed l_13892))
(assert (= color_322_3286_primed flted_13_13890))
(assert (= val_322_3285_primed v_13891))
