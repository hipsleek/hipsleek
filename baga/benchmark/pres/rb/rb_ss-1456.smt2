...
(declare-fun r_11307 () Int)
(declare-fun b_primed () Int)
(declare-fun nr_11308 () Int)
(declare-fun Anon_11309 () Int)
...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun bhr_11310 () Int)
(declare-fun l_11303 () Int)
...
(assert (= r_11307 b_primed))
(assert (= nr_11308 nb))
(assert (= Anon_11309 flted_169_11175))
