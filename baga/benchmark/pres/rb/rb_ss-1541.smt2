...
(declare-fun right_273_3647_primed () Int)
(declare-fun left_273_3646_primed () Int)
(declare-fun color_273_3645_primed () Int)
(declare-fun val_273_3644_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_273_3647_primed r_11748))
(assert (= left_273_3646_primed l_11744))
(assert (= color_273_3645_primed flted_13_11742))
(assert (= val_273_3644_primed v_11743))
