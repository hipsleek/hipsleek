...
(assert (<= 0 cl))
(assert (<= cl 1))
(assert (not (> v_bool_547_1975_primed 0)))
...
(assert (= x_primed 1))
(assert (or (and (and (and (= cl 0) (<= 2 bh_16749)) (<= 1 n_16748)) (> v_node_542_16732 0)) (or (and (and (and (< v_node_542_16732 1) (= n_16748 0)) (= bh_16749 1)) (= cl 0)) (and (and (and (= cl 1) (<= 1 bh_16749)) (<= 1 n_16748)) (> v_node_542_16732 0)))))
