...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun cl_11765 () Int)
(declare-fun bh_11766 () Int)
(declare-fun n_11764 () Int)
...
(assert (or (and (and (and (= cl_11765 0) (<= 2 bh_11766)) (<= 1 n_11764)) (> v_node_268_3618_primed 0)) (or (and (and (and (< v_node_268_3618_primed 1) (= n_11764 0)) (= bh_11766 1)) (= cl_11765 0)) (and (and (and (= cl_11765 1) (<= 1 bh_11766)) (<= 1 n_11764)) (> v_node_268_3618_primed 0)))))
