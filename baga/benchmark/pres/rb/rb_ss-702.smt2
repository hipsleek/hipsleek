...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun cl_8368 () Int)
(declare-fun bh_8369 () Int)
(declare-fun n_8367 () Int)
...
(assert (or (and (and (and (= cl_8368 0) (<= 2 bh_8369)) (<= 1 n_8367)) (> v_node_244_3814_primed 0)) (or (and (and (and (< v_node_244_3814_primed 1) (= n_8367 0)) (= bh_8369 1)) (= cl_8368 0)) (and (and (and (= cl_8368 1) (<= 1 bh_8369)) (<= 1 n_8367)) (> v_node_244_3814_primed 0)))))
