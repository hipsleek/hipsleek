...
(declare-fun cl_17210 () Int)
(declare-fun bh_17211 () Int)
(declare-fun n_17209 () Int)
...
(assert (= cl_17205 1))
(assert (> res 0))
(assert (= n_17209 n_17204))
(assert (= cl_17210 cl_17205))
(assert (= bh_17211 bh_17206))
(assert (<= 0 n_17204))
(assert (<= 1 bh_17206))
(assert (<= 0 cl_17205))
(assert (<= cl_17205 1))
...
(assert (or (and (and (and (= cl_17210 0) (<= 2 bh_17211)) (<= 1 n_17209)) (> v_node_613_2120_primed 0)) (or (and (and (and (< v_node_613_2120_primed 1) (= n_17209 0)) (= bh_17211 1)) (= cl_17210 0)) (and (and (and (= cl_17210 1) (<= 1 bh_17211)) (<= 1 n_17209)) (> v_node_613_2120_primed 0)))))
