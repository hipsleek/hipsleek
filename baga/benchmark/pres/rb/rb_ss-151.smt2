...
(declare-fun right_127_4722_primed () Int)
(declare-fun left_127_4721_primed () Int)
(declare-fun color_127_4720_primed () Int)
(declare-fun val_127_4719_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_127_4722_primed r_6229))
(assert (= left_127_4721_primed l_6226))
(assert (= color_127_4720_primed flted_12_6224))
(assert (= val_127_4719_primed v_6225))
