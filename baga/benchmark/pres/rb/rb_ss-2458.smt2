...
(declare-fun flted_13_15056 () Int)
...
(declare-fun Anon_15060 () Int)
(declare-fun bhl_15061 () Int)
(declare-fun nl_15059 () Int)
(declare-fun l_15058 () Int)
(declare-fun Anon_15064 () Int)
(declare-fun bhr_15065 () Int)
(declare-fun nr_15063 () Int)
(declare-fun r_15062 () Int)
(declare-fun v_node_402_2341_primed () Int)
(declare-fun x_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_13_15056 0))
(assert (= cl_14954 0))
(assert (= n_14953 (+ (+ nr_15063 1) nl_15059)))
(assert (= bhl_15061 bhr_15065))
(assert (= bh_14955 (+ bhl_15061 1)))
...
(assert (or (and (and (and (= Anon_15060 0) (<= 2 bhl_15061)) (<= 1 nl_15059)) (> l_15058 0)) (or (and (and (and (< l_15058 1) (= nl_15059 0)) (= bhl_15061 1)) (= Anon_15060 0)) (and (and (and (= Anon_15060 1) (<= 1 bhl_15061)) (<= 1 nl_15059)) (> l_15058 0)))))
(assert (or (and (and (and (= Anon_15064 0) (<= 2 bhr_15065)) (<= 1 nr_15063)) (> r_15062 0)) (or (and (and (and (< r_15062 1) (= nr_15063 0)) (= bhr_15065 1)) (= Anon_15064 0)) (and (and (and (= Anon_15064 1) (<= 1 bhr_15065)) (<= 1 nr_15063)) (> r_15062 0)))))
(assert (= x_primed 2))
