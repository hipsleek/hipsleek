...
(declare-fun cl_16753 () Int)
(declare-fun bh_16754 () Int)
(declare-fun n_16752 () Int)
...
(assert (= cl 1))
(assert (> res 0))
(assert (= n_16752 n_16748))
(assert (= cl_16753 cl))
(assert (= bh_16754 bh_16749))
(assert (<= 0 n_16748))
(assert (<= 1 bh_16749))
(assert (<= 0 cl))
(assert (<= cl 1))
...
(assert (= x_primed 1))
(assert (or (and (and (and (= cl_16753 0) (<= 2 bh_16754)) (<= 1 n_16752)) (> v_node_547_1796_primed 0)) (or (and (and (and (< v_node_547_1796_primed 1) (= n_16752 0)) (= bh_16754 1)) (= cl_16753 0)) (and (and (and (= cl_16753 1) (<= 1 bh_16754)) (<= 1 n_16752)) (> v_node_547_1796_primed 0)))))
