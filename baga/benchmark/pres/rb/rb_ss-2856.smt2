...
;Antecedent
(assert (= bhl_15073 1))
(assert (= bhr_16420 bhr_15076))
(assert (= nr_16419 nr_15075))
...
(assert (not (or (and (and (and (= flted_12_16439 0) (<= 2 bhl_16417)) (<= 1 nl_16416)) (> l_16415 0)) (or (and (and (and (< l_16415 1) (= nl_16416 0)) (= bhl_16417 1)) (= flted_12_16439 0)) (and (and (and (= flted_12_16439 1) (<= 1 bhl_16417)) (<= 1 nl_16416)) (> l_16415 0))))))
(check-sat)