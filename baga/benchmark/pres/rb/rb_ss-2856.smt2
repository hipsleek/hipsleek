...
(declare-fun right_542_1777_primed () Int)
(declare-fun left_542_1776_primed () Int)
(declare-fun color_542_1775_primed () Int)
(declare-fun val_542_1774_primed () Int)
...
(declare-fun v_node_542_1773_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_542_1777_primed r_16664))
(assert (= left_542_1776_primed l_16661))
(assert (= color_542_1775_primed flted_12_16659))
(assert (= val_542_1774_primed v_16660))
(assert (<= Anon_16696 1))
(assert (<= 0 Anon_16696))
(assert (<= 1 bh_16697))
(assert (<= 0 n_16695))
...
(assert (> v_node_542_1773_primed 0))
...
(assert (or (and (and (and (= Anon_16719 0) (<= 2 bh1_16720)) (<= 1 flted_529_16718)) (> v_node_542_1773_primed 0)) (or (and (and (and (< v_node_542_1773_primed 1) (= flted_529_16718 0)) (= bh1_16720 1)) (= Anon_16719 0)) (and (and (and (= Anon_16719 1) (<= 1 bh1_16720)) (<= 1 flted_529_16718)) (> v_node_542_1773_primed 0)))))
