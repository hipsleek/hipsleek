...
(declare-fun cl_17134 () Int)
(declare-fun bh_17135 () Int)
(declare-fun n_17133 () Int)
...
(assert (= cl_17129 1))
(assert (> res 0))
(assert (= n_17133 n_17128))
(assert (= cl_17134 cl_17129))
(assert (= bh_17135 bh_17130))
(assert (<= 0 n_17128))
(assert (<= 1 bh_17130))
(assert (<= 0 cl_17129))
(assert (<= cl_17129 1))
...
(assert (or (and (and (and (= cl_17134 0) (<= 2 bh_17135)) (<= 1 n_17133)) (> v_node_599_2027_primed 0)) (or (and (and (and (< v_node_599_2027_primed 1) (= n_17133 0)) (= bh_17135 1)) (= cl_17134 0)) (and (and (and (= cl_17134 1) (<= 1 bh_17135)) (<= 1 n_17133)) (> v_node_599_2027_primed 0)))))
