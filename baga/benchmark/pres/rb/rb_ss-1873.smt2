...
(assert (or (and (and (and (and (and (and (and (and (and (and (and (exists ((flted_168_12891 Int)) (and (<= 0 flted_168_12891) (<= flted_168_12891 1))) (exists ((flted_168_12890 Int)) (and (<= 0 flted_168_12890) (<= flted_168_12890 1)))) (exists ((flted_168_12889 Int)) (and (<= 0 flted_168_12889) (<= flted_168_12889 1)))) (exists ((flted_168_12888 Int)) (and (<= 0 flted_168_12888) (<= flted_168_12888 1)))) (exists ((h_12887 Int)) (<= 1 h_12887))) (exists ((h_12886 Int)) (<= 1 h_12886))) (exists ((h_12885 Int)) (<= 1 h_12885))) (<= 0 na_11912)) (<= 1 h_11915)) (<= 0 nb_11913)) (<= 0 nc_11914)) (<= 0 nd)) (and (and (and (and (and (and (and (and (and (and (and (exists ((flted_169_12884 Int)) (and (<= 0 flted_169_12884) (<= flted_169_12884 1))) (exists ((flted_169_12883 Int)) (and (<= 0 flted_169_12883) (<= flted_169_12883 1)))) (exists ((flted_169_12882 Int)) (and (<= 0 flted_169_12882) (<= flted_169_12882 1)))) (exists ((flted_169_12881 Int)) (and (<= 0 flted_169_12881) (<= flted_169_12881 1)))) (exists ((h_12880 Int)) (<= 1 h_12880))) (exists ((h_12879 Int)) (<= 1 h_12879))) (exists ((h_12878 Int)) (<= 1 h_12878))) (<= 0 na_11912)) (<= 1 h_11915)) (<= 0 nb_11913)) (<= 0 nc_11914)) (<= 0 nd))))
