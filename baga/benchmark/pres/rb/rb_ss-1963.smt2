...
(declare-fun Anon_13802 () Int)
(declare-fun flted_12_13627 () Int)
(declare-fun l_13630 () Int)
(declare-fun bhl_13803 () Int)
(declare-fun nl_13801 () Int)
...
(assert (= Anon_13802 flted_12_13627))
...
(assert (= bhl_13803 bhl_13632))
(assert (= nl_13801 nl_13631))
