...
(declare-fun flted_12_17097 () Int)
...
(declare-fun flted_12_17096 () Int)
(declare-fun bhl_17101 () Int)
(declare-fun nl_17100 () Int)
(declare-fun l_17099 () Int)
(declare-fun flted_12_17095 () Int)
(declare-fun bhr_17104 () Int)
(declare-fun nr_17103 () Int)
(declare-fun r_17102 () Int)
(declare-fun x_primed () Int)
(declare-fun v_node_599_2018_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_12_17097 1))
(assert (= flted_12_17096 0))
(assert (= flted_12_17095 0))
(assert (= n_17034 (+ (+ nr_17103 1) nl_17100)))
(assert (= bhl_17101 bh_17035))
(assert (= bhr_17104 bh_17035))
...
(assert (or (and (and (and (= flted_12_17096 0) (<= 2 bhl_17101)) (<= 1 nl_17100)) (> l_17099 0)) (or (and (and (and (< l_17099 1) (= nl_17100 0)) (= bhl_17101 1)) (= flted_12_17096 0)) (and (and (and (= flted_12_17096 1) (<= 1 bhl_17101)) (<= 1 nl_17100)) (> l_17099 0)))))
(assert (or (and (and (and (= flted_12_17095 0) (<= 2 bhr_17104)) (<= 1 nr_17103)) (> r_17102 0)) (or (and (and (and (< r_17102 1) (= nr_17103 0)) (= bhr_17104 1)) (= flted_12_17095 0)) (and (and (and (= flted_12_17095 1) (<= 1 bhr_17104)) (<= 1 nr_17103)) (> r_17102 0)))))
