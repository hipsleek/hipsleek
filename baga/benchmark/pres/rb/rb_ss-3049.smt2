...
(declare-fun cl_17042 () Int)
(declare-fun bh_17043 () Int)
(declare-fun n_17041 () Int)
...
(assert (= cl 0))
(assert (not (> res 0)))
(assert (= n_17041 n_17034))
(assert (= cl_17042 cl))
(assert (= bh_17043 bh_17035))
(assert (<= 0 n_17034))
(assert (<= 1 bh_17035))
(assert (<= 0 cl))
(assert (<= cl 1))
...
(assert (= x_primed 1))
(assert (or (and (and (and (= cl_17042 0) (<= 2 bh_17043)) (<= 1 n_17041)) (> v_node_597_2013_primed 0)) (or (and (and (and (< v_node_597_2013_primed 1) (= n_17041 0)) (= bh_17043 1)) (= cl_17042 0)) (and (and (and (= cl_17042 1) (<= 1 bh_17043)) (<= 1 n_17041)) (> v_node_597_2013_primed 0)))))
