...
(assert (= n nr_8352))
(assert (= h_8518 h))
(assert (or (and (and (and (and (and (and (and (and (and (and (and (exists ((flted_153_8993 Int)) (and (<= 0 flted_153_8993) (<= flted_153_8993 1))) (exists ((flted_153_8992 Int)) (and (<= 0 flted_153_8992) (<= flted_153_8992 1)))) (exists ((flted_153_8991 Int)) (and (<= 0 flted_153_8991) (<= flted_153_8991 1)))) (exists ((flted_153_8990 Int)) (and (<= 0 flted_153_8990) (<= flted_153_8990 1)))) (exists ((h_8989 Int)) (<= 1 h_8989))) (exists ((h_8988 Int)) (<= 1 h_8988))) (exists ((h_8987 Int)) (<= 1 h_8987))) (<= 0 na_8515)) (<= 1 h_8518)) (<= 0 nb_8516)) (<= 0 nc_8517)) (<= 0 nd)) (and (and (and (and (and (and (and (and (and (and (and (exists ((flted_154_8986 Int)) (and (<= 0 flted_154_8986) (<= flted_154_8986 1))) (exists ((flted_154_8985 Int)) (and (<= 0 flted_154_8985) (<= flted_154_8985 1)))) (exists ((flted_154_8984 Int)) (and (<= 0 flted_154_8984) (<= flted_154_8984 1)))) (exists ((flted_154_8983 Int)) (and (<= 0 flted_154_8983) (<= flted_154_8983 1)))) (exists ((h_8982 Int)) (<= 1 h_8982))) (exists ((h_8981 Int)) (<= 1 h_8981))) (exists ((h_8980 Int)) (<= 1 h_8980))) (<= 0 na_8515)) (<= 1 h_8518)) (<= 0 nb_8516)) (<= 0 nc_8517)) (<= 0 nd))))
