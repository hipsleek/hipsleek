...
(declare-fun cl_14963 () Int)
(declare-fun bh_14964 () Int)
(declare-fun n_14962 () Int)
...
(assert (= cl_14954 1))
(assert (> res 0))
(assert (= n_14962 n_14953))
(assert (= cl_14963 cl_14954))
(assert (= bh_14964 bh_14955))
(assert (<= 0 n_14953))
(assert (<= 1 bh_14955))
(assert (<= 0 cl_14954))
(assert (<= cl_14954 1))
...
(assert (or (and (and (and (= cl_14963 0) (<= 2 bh_14964)) (<= 1 n_14962)) (> v_node_401_2335_primed 0)) (or (and (and (and (< v_node_401_2335_primed 1) (= n_14962 0)) (= bh_14964 1)) (= cl_14963 0)) (and (and (and (= cl_14963 1) (<= 1 bh_14964)) (<= 1 n_14962)) (> v_node_401_2335_primed 0)))))
