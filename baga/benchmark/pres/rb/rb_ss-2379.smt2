...
(declare-fun v_node_408_15419 () Int)
...
(declare-fun flted_299_15420 () Int)
(declare-fun bh2_15422 () Int)
(declare-fun flted_299_15421 () Int)
...
(assert (= v_node_408_15419 r_14920))
...
(assert (<= 0 Anon_14922))
(assert (<= Anon_14922 1))
(assert (= (+ flted_299_15421 1) n_15402))
(assert (= flted_299_15420 0))
(assert (<= bh_15404 (+ bh2_15422 1)))
(assert (<= bh2_15422 bh_15404))
(assert (= cl_15403 0))
(assert (<= 0 n_15402))
(assert (<= 1 bh_15404))
(assert (<= 0 cl_15403))
...
(assert (or (and (and (and (= flted_299_15420 0) (<= 2 bh2_15422)) (<= 1 flted_299_15421)) (> v_node_408_2358_primed 0)) (or (and (and (and (< v_node_408_2358_primed 1) (= flted_299_15421 0)) (= bh2_15422 1)) (= flted_299_15420 0)) (and (and (and (= flted_299_15420 1) (<= 1 bh2_15422)) (<= 1 flted_299_15421)) (> v_node_408_2358_primed 0)))))
