...
(declare-fun right_276_3683_primed () Int)
(declare-fun left_276_3682_primed () Int)
(declare-fun color_276_3681_primed () Int)
(declare-fun val_276_3680_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_276_3683_primed r_11748))
(assert (= left_276_3682_primed l_11744))
(assert (= color_276_3681_primed flted_13_11742))
(assert (= val_276_3680_primed v_11743))
