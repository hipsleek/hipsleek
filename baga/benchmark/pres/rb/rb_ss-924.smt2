...
(declare-fun bhr_8765 () Int)
(declare-fun Anon_8764 () Int)
(declare-fun nr_8763 () Int)
(declare-fun nc () Int)
...
;Axioms assertions
;Antecedent
(assert (= bhr_8765 flted_238_8355))
(assert (= Anon_8764 flted_238_8356))
(assert (= nr_8763 nc))
