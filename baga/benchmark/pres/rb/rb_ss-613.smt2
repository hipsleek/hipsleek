...
(declare-fun flted_122_7752 () Int)
(declare-fun flted_122_7751 () Int)
(declare-fun flted_122_7753 () Int)
(declare-fun res () Int)
...
(assert (= flted_122_7753 (+ (+ (+ 2 nb_7283) na_7282) nc_7284)))
(assert (= flted_122_7752 1))
(assert (= flted_122_7751 (+ 1 h_7285)))
...
(assert (or (and (and (and (= flted_122_7752 0) (<= 2 flted_122_7751)) (<= 1 flted_122_7753)) (> res 0)) (or (and (and (and (< res 1) (= flted_122_7753 0)) (= flted_122_7751 1)) (= flted_122_7752 0)) (and (and (and (= flted_122_7752 1) (<= 1 flted_122_7751)) (<= 1 flted_122_7753)) (> res 0)))))
