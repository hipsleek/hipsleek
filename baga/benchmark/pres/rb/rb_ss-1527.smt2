...
(declare-fun cl_11782 () Int)
(declare-fun bh_11783 () Int)
(declare-fun n_11781 () Int)
(declare-fun v_node_270_3628_primed () Int)
...
(assert (> b 0))
(assert (= v_node_270_3628_primed r_11748))
...
(assert (= cl_11774 0))
(assert (> res 0))
(assert (= n_11781 n_11773))
(assert (= cl_11782 cl_11774))
(assert (= bh_11783 bh_11775))
(assert (<= 0 n_11773))
(assert (<= 1 bh_11775))
(assert (<= 0 cl_11774))
(assert (<= cl_11774 1))
...
(assert (or (and (and (and (= cl_11782 0) (<= 2 bh_11783)) (<= 1 n_11781)) (> v_node_270_3628_primed 0)) (or (and (and (and (< v_node_270_3628_primed 1) (= n_11781 0)) (= bh_11783 1)) (= cl_11782 0)) (and (and (and (= cl_11782 1) (<= 1 bh_11783)) (<= 1 n_11781)) (> v_node_270_3628_primed 0)))))
