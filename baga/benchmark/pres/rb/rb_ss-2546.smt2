...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_469_15965 () Int)
...
(declare-fun cl_15967 () Int)
(declare-fun bh_15968 () Int)
(declare-fun n_15966 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_469_15965 l_14907))
...
(assert (= n_15966 n_15949))
(assert (= cl_15967 cl_15950))
(assert (= bh_15968 bh_15951))
(assert (<= 0 n_15949))
(assert (<= 1 bh_15951))
(assert (<= 0 cl_15950))
(assert (<= cl_15950 1))
...
(assert (or (and (and (and (= cl_15967 0) (<= 2 bh_15968)) (<= 1 n_15966)) (> v_node_469_2907_primed 0)) (or (and (and (and (< v_node_469_2907_primed 1) (= n_15966 0)) (= bh_15968 1)) (= cl_15967 0)) (and (and (and (= cl_15967 1) (<= 1 bh_15968)) (<= 1 n_15966)) (> v_node_469_2907_primed 0)))))
