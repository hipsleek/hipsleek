...
(assert (not (or (and (and (and (= flted_12_16247 0) (<= 2 bhr_16229)) (<= 1 nr_16228)) (> r_16227 0)) (or (and (and (and (< r_16227 1) (= nr_16228 0)) (= bhr_16229 1)) (= flted_12_16247 0)) (and (and (and (= flted_12_16247 1) (<= 1 bhr_16229)) (<= 1 nr_16228)) (> r_16227 0))))))
(check-sat)