...
(declare-fun right_597_2008_primed () Int)
(declare-fun left_597_2007_primed () Int)
(declare-fun color_597_2006_primed () Int)
(declare-fun val_597_2005_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_597_2008_primed v_node_592_17018))
(assert (= left_597_2007_primed l_16670))
(assert (= color_597_2006_primed flted_13_16668))
(assert (= val_597_2005_primed v_16669))
