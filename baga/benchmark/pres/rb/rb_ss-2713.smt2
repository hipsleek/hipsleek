...
(assert (not (or (and (and (and (= flted_12_16343 0) (<= 2 bhr_16325)) (<= 1 nr_16324)) (> r_16323 0)) (or (and (and (and (< r_16323 1) (= nr_16324 0)) (= bhr_16325 1)) (= flted_12_16343 0)) (and (and (and (= flted_12_16343 1) (<= 1 bhr_16325)) (<= 1 nr_16324)) (> r_16323 0))))))
(check-sat)