...
(declare-fun r_7618 () Int)
(declare-fun d_primed () Int)
(declare-fun nr_7619 () Int)
(declare-fun Anon_7620 () Int)
...
(declare-fun nd () Int)
(declare-fun d () Int)
(declare-fun bhr_7621 () Int)
(declare-fun h_7285 () Int)
(declare-fun l_7614 () Int)
...
(assert (= r_7618 d_primed))
(assert (= nr_7619 nd))
(assert (= Anon_7620 flted_154_7524))
