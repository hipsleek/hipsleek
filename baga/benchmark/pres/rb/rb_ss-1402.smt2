...
(declare-fun flted_139_11171 () Int)
(declare-fun flted_139_11170 () Int)
(declare-fun flted_139_11172 () Int)
(declare-fun res () Int)
...
(assert (> tmp_primed 0))
(assert (= flted_139_11172 (+ (+ (+ 2 nb_10927) na_10926) nc_10928)))
(assert (= flted_139_11171 1))
(assert (= flted_139_11170 (+ 1 ha)))
...
(assert (or (and (and (and (= flted_139_11171 0) (<= 2 flted_139_11170)) (<= 1 flted_139_11172)) (> res 0)) (or (and (and (and (< res 1) (= flted_139_11172 0)) (= flted_139_11170 1)) (= flted_139_11171 0)) (and (and (and (= flted_139_11171 1) (<= 1 flted_139_11170)) (<= 1 flted_139_11172)) (> res 0)))))
