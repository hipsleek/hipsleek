...
(declare-fun flted_12_8470 () Int)
(declare-fun bhl_8475 () Int)
(declare-fun nl_8474 () Int)
(declare-fun l_8473 () Int)
(declare-fun flted_12_8469 () Int)
(declare-fun bhr_8478 () Int)
(declare-fun nr_8477 () Int)
(declare-fun r_8476 () Int)
(declare-fun b_primed () Int)
(declare-fun v_node_249_3842_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_12_8471 1))
(assert (= flted_12_8470 0))
(assert (= flted_12_8469 0))
(assert (= n_8376 (+ (+ nr_8477 1) nl_8474)))
(assert (= bhl_8475 bh_8378))
(assert (= bhr_8478 bh_8378))
...
(assert (= v_node_249_3842_primed l_8347))
...
(assert (= v_node_249_3842_primed 2))
(assert (or (and (and (and (= flted_12_8470 0) (<= 2 bhl_8475)) (<= 1 nl_8474)) (> l_8473 0)) (or (and (and (and (< l_8473 1) (= nl_8474 0)) (= bhl_8475 1)) (= flted_12_8470 0)) (and (and (and (= flted_12_8470 1) (<= 1 bhl_8475)) (<= 1 nl_8474)) (> l_8473 0)))))
(assert (or (and (and (and (= flted_12_8469 0) (<= 2 bhr_8478)) (<= 1 nr_8477)) (> r_8476 0)) (or (and (and (and (< r_8476 1) (= nr_8477 0)) (= bhr_8478 1)) (= flted_12_8469 0)) (and (and (and (= flted_12_8469 1) (<= 1 bhr_8478)) (<= 1 nr_8477)) (> r_8476 0)))))
(assert (not (= b_primed v_node_249_3842_primed)))
