...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun flted_122_8726 () Int)
(declare-fun flted_122_8725 () Int)
(declare-fun flted_122_8727 () Int)
...
(assert (= flted_122_8727 (+ (+ (+ 2 nb_8679) na_8678) nc_8680)))
(assert (= flted_122_8726 1))
(assert (= flted_122_8725 (+ 1 h_8681)))
(assert (= 1 1))
...
(assert (or (and (and (and (= flted_122_8726 0) (<= 2 flted_122_8725)) (<= 1 flted_122_8727)) (> tmp_primed 0)) (or (and (and (and (< tmp_primed 1) (= flted_122_8727 0)) (= flted_122_8725 1)) (= flted_122_8726 0)) (and (and (and (= flted_122_8726 1) (<= 1 flted_122_8725)) (<= 1 flted_122_8727)) (> tmp_primed 0)))))
