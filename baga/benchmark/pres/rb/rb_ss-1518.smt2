...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun cl_11762 () Int)
(declare-fun bh_11763 () Int)
(declare-fun n_11761 () Int)
(declare-fun v_node_268_3618_primed () Int)
...
(assert (= v_node_268_3618_primed l_11744))
(assert (= n nl_11745))
...
(assert (or (and (and (and (= cl_11762 0) (<= 2 bh_11763)) (<= 1 n_11761)) (> v_node_268_3618_primed 0)) (or (and (and (and (< v_node_268_3618_primed 1) (= n_11761 0)) (= bh_11763 1)) (= cl_11762 0)) (and (and (and (= cl_11762 1) (<= 1 bh_11763)) (<= 1 n_11761)) (> v_node_268_3618_primed 0)))))
