...
(declare-fun right_401_2331_primed () Int)
(declare-fun left_401_2330_primed () Int)
(declare-fun color_401_2329_primed () Int)
(declare-fun val_401_2328_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_401_2331_primed r_14920))
(assert (= left_401_2330_primed l_14916))
(assert (= color_401_2329_primed flted_13_14914))
(assert (= val_401_2328_primed v_14915))
