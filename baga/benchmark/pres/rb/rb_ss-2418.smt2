...
(declare-fun flted_381_15684 () Int)
(declare-fun bh2_15686 () Int)
(declare-fun flted_381_15685 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_440_15683 r_14910))
...
(assert (= (+ flted_381_15685 1) n_15672))
(assert (= flted_381_15684 0))
(assert (<= bh_15674 (+ bh2_15686 1)))
(assert (<= bh2_15686 h_15687))
(assert (= cl_15673 0))
(assert (<= 0 n_15672))
(assert (<= 1 bh_15674))
(assert (<= 0 cl_15673))
...
(assert (or (and (and (and (= flted_381_15684 0) (<= 2 bh2_15686)) (<= 1 flted_381_15685)) (> v_node_440_2637_primed 0)) (or (and (and (and (< v_node_440_2637_primed 1) (= flted_381_15685 0)) (= bh2_15686 1)) (= flted_381_15684 0)) (and (and (and (= flted_381_15684 1) (<= 1 bh2_15686)) (<= 1 flted_381_15685)) (> v_node_440_2637_primed 0)))))
