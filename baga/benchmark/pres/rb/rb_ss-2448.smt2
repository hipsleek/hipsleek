...
(declare-fun cl_14969 () Int)
(declare-fun bh_14970 () Int)
(declare-fun n_14968 () Int)
...
(assert (= cl_14954 1))
(assert (> res 0))
(assert (= n_14968 n_14953))
(assert (= cl_14969 cl_14954))
(assert (= bh_14970 bh_14955))
(assert (<= 0 n_14953))
(assert (<= 1 bh_14955))
(assert (<= 0 cl_14954))
(assert (<= cl_14954 1))
...
(assert (or (and (and (and (= cl_14969 0) (<= 2 bh_14970)) (<= 1 n_14968)) (> v_node_401_2335_primed 0)) (or (and (and (and (< v_node_401_2335_primed 1) (= n_14968 0)) (= bh_14970 1)) (= cl_14969 0)) (and (and (and (= cl_14969 1) (<= 1 bh_14970)) (<= 1 n_14968)) (> v_node_401_2335_primed 0)))))
