...
(assert (or (and (and (and (= cl_14954 0) (<= 2 bh_14955)) (<= 1 n_14953)) (> l_14907 0)) (or (and (and (and (< l_14907 1) (= n_14953 0)) (= bh_14955 1)) (= cl_14954 0)) (and (and (and (= cl_14954 1) (<= 1 bh_14955)) (<= 1 n_14953)) (> l_14907 0)))))
