...
(assert (= bhl_10509 bhl_9872))
(assert (= nl_10508 nl_9871))
(assert (= flted_12_9866 0))
(assert (= bhl_9872 ha))
(assert (= bhr_9875 ha))
(assert (= na (+ (+ nr_9874 1) nl_9871)))
(assert (= r_10510 r_9873))
