...
(assert (= bhl_10319 bhl_9858))
(assert (= nl_10318 nl_9857))
(assert (= flted_12_9852 0))
(assert (= bhl_9858 ha))
(assert (= bhr_9861 ha))
(assert (= na (+ (+ nr_9860 1) nl_9857)))
(assert (= r_10320 r_9859))
