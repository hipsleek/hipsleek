...
(declare-fun right_273_3656_primed () Int)
(declare-fun left_273_3655_primed () Int)
(declare-fun color_273_3654_primed () Int)
(declare-fun val_273_3653_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_273_3656_primed r_11898))
(assert (= left_273_3655_primed l_11895))
(assert (= color_273_3654_primed flted_12_11893))
(assert (= val_273_3653_primed v_11894))
