...
(declare-fun right_443_2641_primed () Int)
(declare-fun r_14920 () Int)
(declare-fun left_443_2640_primed () Int)
(declare-fun color_443_2639_primed () Int)
(declare-fun val_443_2638_primed () Int)
...
(declare-fun v_node_440_15740 () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_443_2641_primed r_14920))
(assert (= left_443_2640_primed l_14916))
(assert (= color_443_2639_primed flted_13_14914))
(assert (= val_443_2638_primed v_14915))
(assert (<= cl_15673 1))
(assert (<= 0 cl_15673))
(assert (<= 1 bh_15674))
(assert (<= 0 n_15672))
...
(assert (or (and (and (and (= cl_15673 0) (<= 2 bh_15674)) (<= 1 n_15672)) (> v_node_440_15740 0)) (or (and (and (and (< v_node_440_15740 1) (= n_15672 0)) (= bh_15674 1)) (= cl_15673 0)) (and (and (and (= cl_15673 1) (<= 1 bh_15674)) (<= 1 n_15672)) (> v_node_440_15740 0)))))
