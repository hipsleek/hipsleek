...
(declare-fun right_271_3632_primed () Int)
(declare-fun left_271_3631_primed () Int)
(declare-fun color_271_3630_primed () Int)
(declare-fun val_271_3629_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_271_3632_primed r_11748))
(assert (= left_271_3631_primed l_11744))
(assert (= color_271_3630_primed flted_13_11742))
(assert (= val_271_3629_primed v_11743))
