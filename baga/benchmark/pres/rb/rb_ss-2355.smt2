...
(declare-fun right_402_2340_primed () Int)
(declare-fun left_402_2339_primed () Int)
(declare-fun color_402_2338_primed () Int)
(declare-fun val_402_2337_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_402_2340_primed r_14920))
(assert (= left_402_2339_primed l_14916))
(assert (= color_402_2338_primed flted_13_14914))
(assert (= val_402_2337_primed v_14915))
