...
(declare-fun flted_139_12122 () Int)
(declare-fun flted_139_12121 () Int)
(declare-fun flted_139_12123 () Int)
(declare-fun res () Int)
...
(assert (<= 0 cl))
(assert (<= cl 1))
(assert (= flted_139_12123 (+ (+ (+ 2 nb_12076) na_12075) nc_12077)))
(assert (= flted_139_12122 1))
(assert (= flted_139_12121 (+ 1 ha)))
...
(assert (= b_primed 1))
(assert (or (and (and (and (= flted_139_12122 0) (<= 2 flted_139_12121)) (<= 1 flted_139_12123)) (> res 0)) (or (and (and (and (< res 1) (= flted_139_12123 0)) (= flted_139_12121 1)) (= flted_139_12122 0)) (and (and (and (= flted_139_12122 1) (<= 1 flted_139_12121)) (<= 1 flted_139_12123)) (> res 0)))))
