...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_469_15969 () Int)
...
(declare-fun cl2_15972 () Int)
(declare-fun bh_15970 () Int)
(declare-fun flted_380_15971 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_469_15969 l_14916))
...
(assert (<= 0 Anon_14918))
(assert (<= Anon_14918 1))
(assert (= (+ flted_380_15971 1) n_15949))
(assert (= cl_15950 1))
(assert (<= 0 cl2_15972))
(assert (<= cl2_15972 1))
(assert (= bh_15970 bh_15951))
(assert (<= 0 n_15949))
(assert (<= 1 bh_15951))
(assert (<= 0 cl_15950))
(assert (<= cl_15950 1))
...
(assert (or (and (and (and (= cl2_15972 0) (<= 2 bh_15970)) (<= 1 flted_380_15971)) (> v_node_469_2907_primed 0)) (or (and (and (and (< v_node_469_2907_primed 1) (= flted_380_15971 0)) (= bh_15970 1)) (= cl2_15972 0)) (and (and (and (= cl2_15972 1) (<= 1 bh_15970)) (<= 1 flted_380_15971)) (> v_node_469_2907_primed 0)))))
