...
(declare-fun right_249_3841_primed () Int)
(declare-fun left_249_3840_primed () Int)
(declare-fun color_249_3839_primed () Int)
(declare-fun val_249_3838_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_249_3841_primed r_8351))
(assert (= left_249_3840_primed l_8347))
(assert (= color_249_3839_primed flted_13_8345))
(assert (= val_249_3838_primed v_8346))
