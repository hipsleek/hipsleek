...
(declare-fun cl_16848 () Int)
(declare-fun bh_16849 () Int)
(declare-fun n_16847 () Int)
...
(assert (= cl_16843 1))
(assert (> res 0))
(assert (= n_16847 n_16842))
(assert (= cl_16848 cl_16843))
(assert (= bh_16849 bh_16844))
(assert (<= 0 n_16842))
(assert (<= 1 bh_16844))
(assert (<= 0 cl_16843))
(assert (<= cl_16843 1))
...
(assert (or (and (and (and (= cl_16848 0) (<= 2 bh_16849)) (<= 1 n_16847)) (> v_node_549_1810_primed 0)) (or (and (and (and (< v_node_549_1810_primed 1) (= n_16847 0)) (= bh_16849 1)) (= cl_16848 0)) (and (and (and (= cl_16848 1) (<= 1 bh_16849)) (<= 1 n_16847)) (> v_node_549_1810_primed 0)))))
