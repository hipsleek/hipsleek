...
(declare-fun cl_13940 () Int)
(declare-fun bh_13941 () Int)
(declare-fun n_13939 () Int)
...
(assert (= cl_13922 0))
(assert (not (> res 0)))
(assert (= n_13939 n_13921))
(assert (= cl_13940 cl_13922))
(assert (= bh_13941 bh_13923))
(assert (<= 0 n_13921))
(assert (<= 1 bh_13923))
(assert (<= 0 cl_13922))
(assert (<= cl_13922 1))
...
(assert (or (and (and (and (= cl_13940 0) (<= 2 bh_13941)) (<= 1 n_13939)) (> v_node_314_3269_primed 0)) (or (and (and (and (< v_node_314_3269_primed 1) (= n_13939 0)) (= bh_13941 1)) (= cl_13940 0)) (and (and (and (= cl_13940 1) (<= 1 bh_13941)) (<= 1 n_13939)) (> v_node_314_3269_primed 0)))))
