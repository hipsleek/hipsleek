...
(declare-fun cl_17137 () Int)
(declare-fun bh_17138 () Int)
(declare-fun n_17136 () Int)
...
(assert (= cl_17129 0))
(assert (not (> res 0)))
(assert (= n_17136 n_17128))
(assert (= cl_17137 cl_17129))
(assert (= bh_17138 bh_17130))
(assert (<= 0 n_17128))
(assert (<= 1 bh_17130))
(assert (<= 0 cl_17129))
(assert (<= cl_17129 1))
...
(assert (or (and (and (and (= cl_17137 0) (<= 2 bh_17138)) (<= 1 n_17136)) (> v_node_599_2027_primed 0)) (or (and (and (and (< v_node_599_2027_primed 1) (= n_17136 0)) (= bh_17138 1)) (= cl_17137 0)) (and (and (and (= cl_17137 1) (<= 1 bh_17138)) (<= 1 n_17136)) (> v_node_599_2027_primed 0)))))
