...
(declare-fun cl_8385 () Int)
(declare-fun bh_8386 () Int)
(declare-fun n_8384 () Int)
...
(assert (= cl_8377 0))
(assert (> res 0))
(assert (= n_8384 n_8376))
(assert (= cl_8385 cl_8377))
(assert (= bh_8386 bh_8378))
(assert (<= 0 n_8376))
(assert (<= 1 bh_8378))
(assert (<= 0 cl_8377))
(assert (<= cl_8377 1))
...
(assert (or (and (and (and (= cl_8385 0) (<= 2 bh_8386)) (<= 1 n_8384)) (> v_node_246_3823_primed 0)) (or (and (and (and (< v_node_246_3823_primed 1) (= n_8384 0)) (= bh_8386 1)) (= cl_8385 0)) (and (and (and (= cl_8385 1) (<= 1 bh_8386)) (<= 1 n_8384)) (> v_node_246_3823_primed 0)))))
