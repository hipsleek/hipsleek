...
(declare-fun right_271_3636_primed () Int)
(declare-fun left_271_3635_primed () Int)
(declare-fun color_271_3634_primed () Int)
(declare-fun val_271_3633_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_271_3636_primed r_11748))
(assert (= left_271_3635_primed l_11744))
(assert (= color_271_3634_primed flted_13_11742))
(assert (= val_271_3633_primed v_11743))
