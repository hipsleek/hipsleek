...
(declare-fun Anon_16703 () Int)
(declare-fun bh1_16704 () Int)
(declare-fun flted_529_16702 () Int)
(declare-fun res () Int)
...
(assert (= flted_529_16702 (+ 1 n_16695)))
(assert (> res 0))
(assert (<= bh_16697 bh1_16704))
(assert (<= bh1_16704 bh_16697))
(assert (<= 0 n_16695))
(assert (<= 1 bh_16697))
(assert (<= 0 Anon_16696))
(assert (<= Anon_16696 1))
...
(assert (or (and (and (and (= Anon_16703 0) (<= 2 bh1_16704)) (<= 1 flted_529_16702)) (> res 0)) (or (and (and (and (< res 1) (= flted_529_16702 0)) (= bh1_16704 1)) (= Anon_16703 0)) (and (and (and (= Anon_16703 1) (<= 1 bh1_16704)) (<= 1 flted_529_16702)) (> res 0)))))
