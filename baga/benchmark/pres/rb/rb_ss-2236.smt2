...
;Antecedent
(assert (= bhl_14041 1))
(assert (= bhr_14724 bhr_14044))
(assert (= nr_14723 nr_14043))
...
(assert (not (or (and (and (and (= flted_12_14743 0) (<= 2 bhl_14721)) (<= 1 nl_14720)) (> l_14719 0)) (or (and (and (and (< l_14719 1) (= nl_14720 0)) (= bhl_14721 1)) (= flted_12_14743 0)) (and (and (and (= flted_12_14743 1) (<= 1 bhl_14721)) (<= 1 nl_14720)) (> l_14719 0))))))
(check-sat)