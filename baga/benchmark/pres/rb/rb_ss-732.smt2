...
(declare-fun right_249_3855_primed () Int)
(declare-fun left_249_3854_primed () Int)
(declare-fun color_249_3853_primed () Int)
(declare-fun val_249_3852_primed () Int)
(declare-fun v_8493 () Int)
(declare-fun v_node_249_3851_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_249_3855_primed r_8497))
(assert (= left_249_3854_primed l_8494))
(assert (= color_249_3853_primed flted_12_8492))
(assert (= val_249_3852_primed v_8493))
(assert (= v_node_249_3851_primed l_8347))
