...
(declare-fun flted_381_16011 () Int)
(declare-fun bh2_16013 () Int)
(declare-fun flted_381_16012 () Int)
(declare-fun v_node_469_16015 () Int)
...
(assert (<= 0 n_15949))
(assert (= cl_15950 0))
(assert (<= bh2_16013 h_16014))
(assert (<= bh_15951 (+ bh2_16013 1)))
(assert (= flted_381_16011 0))
(assert (= (+ flted_381_16012 1) n_15949))
(assert (<= Anon_14918 1))
(assert (<= 0 Anon_14918))
(assert (<= 1 bhl_14919))
(assert (<= 0 nl_14917))
...
(assert (or (and (and (and (= flted_381_16011 0) (<= 2 bh2_16013)) (<= 1 flted_381_16012)) (> v_node_469_16015 0)) (or (and (and (and (< v_node_469_16015 1) (= flted_381_16012 0)) (= bh2_16013 1)) (= flted_381_16011 0)) (and (and (and (= flted_381_16011 1) (<= 1 bh2_16013)) (<= 1 flted_381_16012)) (> v_node_469_16015 0)))))
