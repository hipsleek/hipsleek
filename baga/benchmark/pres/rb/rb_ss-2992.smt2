...
(declare-fun right_549_1800_primed () Int)
(declare-fun left_549_1799_primed () Int)
(declare-fun color_549_1798_primed () Int)
(declare-fun val_549_1797_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_549_1800_primed r_16674))
(assert (= left_549_1799_primed v_node_542_16732))
(assert (= color_549_1798_primed flted_13_16668))
(assert (= val_549_1797_primed v_16669))
