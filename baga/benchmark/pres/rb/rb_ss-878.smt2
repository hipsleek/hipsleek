...
(declare-fun right_252_3872_primed () Int)
(declare-fun left_252_3871_primed () Int)
(declare-fun color_252_3870_primed () Int)
(declare-fun val_252_3869_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_252_3872_primed r_8351))
(assert (= left_252_3871_primed l_8347))
(assert (= color_252_3870_primed flted_13_8345))
(assert (= val_252_3869_primed v_8346))
(assert (> c 0))
(assert (> b 0))
