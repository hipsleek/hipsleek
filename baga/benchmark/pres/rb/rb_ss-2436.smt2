...
(declare-fun flted_381_15734 () Int)
(declare-fun bh2_15736 () Int)
(declare-fun flted_381_15735 () Int)
(declare-fun v_node_440_15738 () Int)
...
(assert (<= 0 n_15672))
(assert (= cl_15673 0))
(assert (<= bh2_15736 h_15737))
(assert (<= bh_15674 (+ bh2_15736 1)))
(assert (= flted_381_15734 0))
(assert (= (+ flted_381_15735 1) n_15672))
(assert (<= Anon_14922 1))
(assert (<= 0 Anon_14922))
(assert (<= 1 bhr_14923))
(assert (<= 0 nr_14921))
...
(assert (or (and (and (and (= flted_381_15734 0) (<= 2 bh2_15736)) (<= 1 flted_381_15735)) (> v_node_440_15738 0)) (or (and (and (and (< v_node_440_15738 1) (= flted_381_15735 0)) (= bh2_15736 1)) (= flted_381_15734 0)) (and (and (and (= flted_381_15734 1) (<= 1 bh2_15736)) (<= 1 flted_381_15735)) (> v_node_440_15738 0)))))
