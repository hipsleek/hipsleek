...
(declare-fun right_402_2345_primed () Int)
(declare-fun left_402_2344_primed () Int)
(declare-fun color_402_2343_primed () Int)
(declare-fun val_402_2342_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_402_2345_primed r_15074))
(assert (= left_402_2344_primed l_15071))
(assert (= color_402_2343_primed flted_12_15069))
(assert (= val_402_2342_primed v_15070))
