...
(declare-fun right_315_3279_primed () Int)
(declare-fun left_315_3278_primed () Int)
(declare-fun color_315_3277_primed () Int)
(declare-fun val_315_3276_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_315_3279_primed r_14042))
(assert (= left_315_3278_primed l_14039))
(assert (= color_315_3277_primed flted_12_14037))
(assert (= val_315_3276_primed v_14038))
