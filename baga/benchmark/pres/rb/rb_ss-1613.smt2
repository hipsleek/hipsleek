...
(declare-fun flted_12_11872 () Int)
...
(declare-fun flted_12_11871 () Int)
(declare-fun bhl_11876 () Int)
(declare-fun nl_11875 () Int)
(declare-fun l_11874 () Int)
(declare-fun flted_12_11870 () Int)
(declare-fun bhr_11879 () Int)
(declare-fun nr_11878 () Int)
(declare-fun r_11877 () Int)
(declare-fun b_primed () Int)
(declare-fun v_node_273_3652_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_12_11872 1))
(assert (= flted_12_11871 0))
(assert (= flted_12_11870 0))
(assert (= n_11773 (+ (+ nr_11878 1) nl_11875)))
(assert (= bhl_11876 bh_11775))
(assert (= bhr_11879 bh_11775))
...
(assert (or (and (and (and (= flted_12_11871 0) (<= 2 bhl_11876)) (<= 1 nl_11875)) (> l_11874 0)) (or (and (and (and (< l_11874 1) (= nl_11875 0)) (= bhl_11876 1)) (= flted_12_11871 0)) (and (and (and (= flted_12_11871 1) (<= 1 bhl_11876)) (<= 1 nl_11875)) (> l_11874 0)))))
(assert (or (and (and (and (= flted_12_11870 0) (<= 2 bhr_11879)) (<= 1 nr_11878)) (> r_11877 0)) (or (and (and (and (< r_11877 1) (= nr_11878 0)) (= bhr_11879 1)) (= flted_12_11870 0)) (and (and (and (= flted_12_11870 1) (<= 1 bhr_11879)) (<= 1 nr_11878)) (> r_11877 0)))))
