...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_440_15692 () Int)
...
(declare-fun cl2_15695 () Int)
(declare-fun bh_15693 () Int)
(declare-fun flted_380_15694 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_440_15692 r_14920))
...
(assert (<= 0 Anon_14922))
(assert (<= Anon_14922 1))
(assert (= (+ flted_380_15694 1) n_15672))
(assert (= cl_15673 1))
(assert (<= 0 cl2_15695))
(assert (<= cl2_15695 1))
(assert (= bh_15693 bh_15674))
(assert (<= 0 n_15672))
(assert (<= 1 bh_15674))
(assert (<= 0 cl_15673))
(assert (<= cl_15673 1))
...
(assert (or (and (and (and (= cl2_15695 0) (<= 2 bh_15693)) (<= 1 flted_380_15694)) (> v_node_440_2637_primed 0)) (or (and (and (and (< v_node_440_2637_primed 1) (= flted_380_15694 0)) (= bh_15693 1)) (= cl2_15695 0)) (and (and (and (= cl2_15695 1) (<= 1 bh_15693)) (<= 1 flted_380_15694)) (> v_node_440_2637_primed 0)))))
