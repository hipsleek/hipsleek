...
(declare-fun right_545_1781_primed () Int)
(declare-fun left_545_1780_primed () Int)
(declare-fun color_545_1779_primed () Int)
(declare-fun val_545_1778_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_545_1781_primed r_16674))
(assert (= left_545_1780_primed v_node_542_16732))
(assert (= color_545_1779_primed flted_13_16668))
(assert (= val_545_1778_primed v_16669))
