...
(declare-fun right_244_3809_primed () Int)
(declare-fun left_244_3808_primed () Int)
(declare-fun color_244_3807_primed () Int)
(declare-fun val_244_3806_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_244_3809_primed r_8351))
(assert (= left_244_3808_primed l_8347))
(assert (= color_244_3807_primed flted_13_8345))
(assert (= val_244_3806_primed v_8346))
