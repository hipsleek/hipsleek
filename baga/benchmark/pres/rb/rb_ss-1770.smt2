...
(declare-fun flted_196_12359 () Int)
(declare-fun flted_196_12358 () Int)
(declare-fun flted_196_12360 () Int)
...
(assert (<= 0 cl))
(assert (<= cl 1))
(assert (= flted_196_12360 (+ (+ (+ 2 nb_11795) na_11794) nc_11796)))
(assert (= flted_196_12359 0))
(assert (= flted_196_12358 (+ 1 ha)))
...
(assert (<= 0 nc_11796))
(assert (= b_primed 1))
(assert (or (and (and (and (= flted_196_12359 0) (<= 2 flted_196_12358)) (<= 1 flted_196_12360)) (> tmp_primed 0)) (or (and (and (and (< tmp_primed 1) (= flted_196_12360 0)) (= flted_196_12358 1)) (= flted_196_12359 0)) (and (and (and (= flted_196_12359 1) (<= 1 flted_196_12358)) (<= 1 flted_196_12360)) (> tmp_primed 0)))))
