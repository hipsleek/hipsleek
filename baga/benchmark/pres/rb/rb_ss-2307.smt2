...
(declare-fun right_399_2323_primed () Int)
(declare-fun left_399_2322_primed () Int)
(declare-fun color_399_2321_primed () Int)
(declare-fun val_399_2320_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_399_2323_primed r_14910))
(assert (= left_399_2322_primed l_14907))
(assert (= color_399_2321_primed flted_12_14905))
(assert (= val_399_2320_primed v_14906))
