...
(declare-fun v_bool_613_2185_primed () Int)
...
(assert (= cl_17205 0))
(assert (not (> v_bool_613_2185_primed 0)))
(assert (<= 0 n_17204))
(assert (<= 1 bh_17206))
(assert (<= 0 cl_17205))
(assert (<= cl_17205 1))
(assert (> v_bool_613_2185_primed 0))
...
(assert (or (and (and (and (= cl_17205 0) (<= 2 bh_17206)) (<= 1 n_17204)) (> r_17123 0)) (or (and (and (and (< r_17123 1) (= n_17204 0)) (= bh_17206 1)) (= cl_17205 0)) (and (and (and (= cl_17205 1) (<= 1 bh_17206)) (<= 1 n_17204)) (> r_17123 0)))))
