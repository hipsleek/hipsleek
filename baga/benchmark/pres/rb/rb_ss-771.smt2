...
(declare-fun right_247_3831_primed () Int)
(declare-fun left_247_3830_primed () Int)
(declare-fun color_247_3829_primed () Int)
(declare-fun val_247_3828_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_247_3831_primed r_8351))
(assert (= left_247_3830_primed l_8347))
(assert (= color_247_3829_primed flted_13_8345))
(assert (= val_247_3828_primed v_8346))
