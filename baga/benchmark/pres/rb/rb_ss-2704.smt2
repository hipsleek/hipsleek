...
(assert (not (or (and (and (and (= flted_12_16344 0) (<= 2 bhl_16322)) (<= 1 nl_16321)) (> l_16320 0)) (or (and (and (and (< l_16320 1) (= nl_16321 0)) (= bhl_16322 1)) (= flted_12_16344 0)) (and (and (and (= flted_12_16344 1) (<= 1 bhl_16322)) (<= 1 nl_16321)) (> l_16320 0))))))
(check-sat)