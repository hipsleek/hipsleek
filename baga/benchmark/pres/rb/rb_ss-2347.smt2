...
(declare-fun cl_14972 () Int)
(declare-fun bh_14973 () Int)
(declare-fun n_14971 () Int)
...
(assert (= v_node_401_2335_primed l_14916))
...
(assert (= cl_14954 0))
(assert (not (> res 0)))
(assert (= n_14971 n_14953))
(assert (= cl_14972 cl_14954))
(assert (= bh_14973 bh_14955))
(assert (<= 0 n_14953))
(assert (<= 1 bh_14955))
(assert (<= 0 cl_14954))
(assert (<= cl_14954 1))
...
(assert (or (and (and (and (= cl_14972 0) (<= 2 bh_14973)) (<= 1 n_14971)) (> v_node_401_2335_primed 0)) (or (and (and (and (< v_node_401_2335_primed 1) (= n_14971 0)) (= bh_14973 1)) (= cl_14972 0)) (and (and (and (= cl_14972 1) (<= 1 bh_14973)) (<= 1 n_14971)) (> v_node_401_2335_primed 0)))))
