...
(assert (= bhl_10869 bhl_9872))
(assert (= nl_10868 nl_9871))
(assert (= flted_12_9866 0))
(assert (= bhl_9872 ha))
(assert (= bhr_9875 ha))
(assert (= na (+ (+ nr_9874 1) nl_9871)))
(assert (= r_10870 r_9873))
