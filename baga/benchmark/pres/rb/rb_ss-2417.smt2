...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_440_15688 () Int)
...
(declare-fun cl_15690 () Int)
(declare-fun bh_15691 () Int)
(declare-fun n_15689 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_440_15688 r_14910))
...
(assert (= n_15689 n_15672))
(assert (= cl_15690 cl_15673))
(assert (= bh_15691 bh_15674))
(assert (<= 0 n_15672))
(assert (<= 1 bh_15674))
(assert (<= 0 cl_15673))
(assert (<= cl_15673 1))
...
(assert (or (and (and (and (= cl_15690 0) (<= 2 bh_15691)) (<= 1 n_15689)) (> v_node_440_2637_primed 0)) (or (and (and (and (< v_node_440_2637_primed 1) (= n_15689 0)) (= bh_15691 1)) (= cl_15690 0)) (and (and (and (= cl_15690 1) (<= 1 bh_15691)) (<= 1 n_15689)) (> v_node_440_2637_primed 0)))))
