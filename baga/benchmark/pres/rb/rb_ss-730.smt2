...
(declare-fun right_249_3846_primed () Int)
(declare-fun left_249_3845_primed () Int)
(declare-fun color_249_3844_primed () Int)
(declare-fun val_249_3843_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_249_3846_primed r_8497))
(assert (= left_249_3845_primed l_8494))
(assert (= color_249_3844_primed flted_12_8492))
(assert (= val_249_3843_primed v_8493))
