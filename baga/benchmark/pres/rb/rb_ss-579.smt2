...
(declare-fun r_7551 () Int)
(declare-fun d_primed () Int)
(declare-fun nr_7552 () Int)
(declare-fun Anon_7553 () Int)
...
(declare-fun nd () Int)
(declare-fun d () Int)
(declare-fun bhr_7554 () Int)
(declare-fun h_7285 () Int)
(declare-fun l_7547 () Int)
...
(assert (= r_7551 d_primed))
(assert (= nr_7552 nd))
(assert (= Anon_7553 flted_154_7524))
