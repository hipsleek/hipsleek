...
;Axioms assertions
;Antecedent
(assert (= right_545_1781_primed r_16664))
(assert (= left_545_1780_primed v_node_542_16730))
(assert (= color_545_1779_primed flted_12_16659))
(assert (= val_545_1778_primed v_16660))
