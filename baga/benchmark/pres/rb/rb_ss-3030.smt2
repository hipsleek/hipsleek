...
;Axioms assertions
;Antecedent
(assert (= right_592_1994_primed r_16674))
(assert (= left_592_1993_primed l_16670))
(assert (= color_592_1992_primed flted_13_16668))
(assert (= val_592_1991_primed v_16669))
(assert (<= Anon_16982 1))
(assert (<= 0 Anon_16982))
(assert (<= 1 bh_16983))
(assert (<= 0 n_16981))
...
(assert (or (and (and (and (= Anon_17008 0) (<= 2 bh1_17009)) (<= 1 flted_529_17007)) (> v_node_592_1990_primed 0)) (or (and (and (and (< v_node_592_1990_primed 1) (= flted_529_17007 0)) (= bh1_17009 1)) (= Anon_17008 0)) (and (and (and (= Anon_17008 1) (<= 1 bh1_17009)) (<= 1 flted_529_17007)) (> v_node_592_1990_primed 0)))))
