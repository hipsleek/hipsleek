...
(assert (not (or (and (and (and (= cl2_16530 0) (<= 2 bh_16528)) (<= 1 flted_380_16529)) (> x_primed 0)) (or (and (and (and (< x_primed 1) (= flted_380_16529 0)) (= bh_16528 1)) (= cl2_16530 0)) (and (and (and (= cl2_16530 1) (<= 1 bh_16528)) (<= 1 flted_380_16529)) (> x_primed 0))))))
(check-sat)