...
(declare-fun right_438_2625_primed () Int)
(declare-fun left_438_2624_primed () Int)
(declare-fun color_438_2623_primed () Int)
(declare-fun val_438_2622_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_438_2625_primed r_14920))
(assert (= left_438_2624_primed l_14916))
(assert (= color_438_2623_primed flted_13_14914))
(assert (= val_438_2622_primed v_14915))
(assert (= x_primed x))
(assert (= a_primed a))
(assert (<= 0 cl))
(assert (<= cl 1))
