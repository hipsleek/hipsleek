...
(declare-fun right_268_3612_primed () Int)
(declare-fun left_268_3611_primed () Int)
(declare-fun color_268_3610_primed () Int)
(declare-fun val_268_3609_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_268_3612_primed r_11748))
(assert (= left_268_3611_primed l_11744))
(assert (= color_268_3610_primed flted_13_11742))
(assert (= val_268_3609_primed v_11743))
...
(assert (or (and (and (and (= Anon_11746 0) (<= 2 bhl_11747)) (<= 1 nl_11745)) (> l_11744 0)) (or (and (and (and (< l_11744 1) (= nl_11745 0)) (= bhl_11747 1)) (= Anon_11746 0)) (and (and (and (= Anon_11746 1) (<= 1 bhl_11747)) (<= 1 nl_11745)) (> l_11744 0)))))
