...
(declare-fun right_539_1759_primed () Int)
(declare-fun left_539_1758_primed () Int)
(declare-fun color_539_1757_primed () Int)
(declare-fun val_539_1756_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_539_1759_primed r_16674))
(assert (= left_539_1758_primed l_16670))
(assert (= color_539_1757_primed flted_13_16668))
(assert (= val_539_1756_primed v_16669))
(assert (= x_primed x))
(assert (= v_primed v))
