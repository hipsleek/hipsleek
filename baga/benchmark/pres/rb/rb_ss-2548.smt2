...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_469_15956 () Int)
...
(declare-fun cl2_15959 () Int)
(declare-fun bh_15957 () Int)
(declare-fun flted_380_15958 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_469_15956 l_14907))
...
(assert (= (+ flted_380_15958 1) n_15949))
(assert (= cl_15950 1))
(assert (<= 0 cl2_15959))
(assert (<= cl2_15959 1))
(assert (= bh_15957 bh_15951))
(assert (<= 0 n_15949))
(assert (<= 1 bh_15951))
(assert (<= 0 cl_15950))
(assert (<= cl_15950 1))
...
(assert (or (and (and (and (= cl2_15959 0) (<= 2 bh_15957)) (<= 1 flted_380_15958)) (> v_node_469_2907_primed 0)) (or (and (and (and (< v_node_469_2907_primed 1) (= flted_380_15958 0)) (= bh_15957 1)) (= cl2_15959 0)) (and (and (and (= cl2_15959 1) (<= 1 bh_15957)) (<= 1 flted_380_15958)) (> v_node_469_2907_primed 0)))))
