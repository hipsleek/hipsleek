...
(declare-fun right_547_1791_primed () Int)
(declare-fun left_547_1790_primed () Int)
(declare-fun color_547_1789_primed () Int)
(declare-fun val_547_1788_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_547_1791_primed r_16674))
(assert (= left_547_1790_primed v_node_542_16732))
(assert (= color_547_1789_primed flted_13_16668))
(assert (= val_547_1788_primed v_16669))
