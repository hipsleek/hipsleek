...
(declare-fun a () Int)
(declare-fun x () Int)
(declare-fun v_node_469_15978 () Int)
...
(declare-fun cl_15980 () Int)
(declare-fun bh_15981 () Int)
(declare-fun n_15979 () Int)
...
(assert (= a_primed a))
(assert (= x_primed x))
(assert (= v_node_469_15978 l_14916))
...
(assert (<= 0 Anon_14918))
(assert (<= Anon_14918 1))
(assert (= n_15979 n_15949))
(assert (= cl_15980 cl_15950))
(assert (= bh_15981 bh_15951))
(assert (<= 0 n_15949))
(assert (<= 1 bh_15951))
(assert (<= 0 cl_15950))
(assert (<= cl_15950 1))
...
(assert (or (and (and (and (= cl_15980 0) (<= 2 bh_15981)) (<= 1 n_15979)) (> v_node_469_2907_primed 0)) (or (and (and (and (< v_node_469_2907_primed 1) (= n_15979 0)) (= bh_15981 1)) (= cl_15980 0)) (and (and (and (= cl_15980 1) (<= 1 bh_15981)) (<= 1 n_15979)) (> v_node_469_2907_primed 0)))))
