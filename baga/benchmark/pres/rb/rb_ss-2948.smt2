...
(declare-fun right_599_2022_primed () Int)
(declare-fun left_599_2021_primed () Int)
(declare-fun color_599_2020_primed () Int)
(declare-fun val_599_2019_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_599_2022_primed r_17123))
(assert (= left_599_2021_primed l_17120))
(assert (= color_599_2020_primed flted_12_17118))
(assert (= val_599_2019_primed v_17119))
