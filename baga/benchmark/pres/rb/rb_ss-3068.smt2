...
(declare-fun right_613_2115_primed () Int)
(declare-fun left_613_2114_primed () Int)
(declare-fun color_613_2113_primed () Int)
(declare-fun val_613_2112_primed () Int)
(declare-fun v_17119 () Int)
(declare-fun v_node_613_2111_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_613_2115_primed r_17123))
(assert (= left_613_2114_primed l_17120))
(assert (= color_613_2113_primed flted_12_17118))
(assert (= val_613_2112_primed v_17119))
(assert (= v_node_613_2111_primed v_node_592_17018))
