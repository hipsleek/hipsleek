...
(declare-fun right_469_2903_primed () Int)
(declare-fun left_469_2902_primed () Int)
(declare-fun color_469_2901_primed () Int)
(declare-fun val_469_2900_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_469_2903_primed r_14910))
(assert (= left_469_2902_primed l_14907))
(assert (= color_469_2901_primed flted_12_14905))
(assert (= val_469_2900_primed v_14906))
(assert (= x_primed x))
(assert (= a_primed a))
(assert (<= 0 cl))
(assert (<= cl 1))
