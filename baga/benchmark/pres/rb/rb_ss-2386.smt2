...
(declare-fun right_397_2315_primed () Int)
(declare-fun left_397_2314_primed () Int)
(declare-fun color_397_2313_primed () Int)
(declare-fun val_397_2312_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_397_2315_primed r_14920))
(assert (= left_397_2314_primed l_14916))
(assert (= color_397_2313_primed flted_13_14914))
(assert (= val_397_2312_primed v_14915))
(assert (= x_primed x))
(assert (= a_primed a))
(assert (<= 0 cl))
(assert (<= cl 1))
