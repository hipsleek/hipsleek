...
(declare-fun nc () Int)
(declare-fun c () Int)
(declare-fun cl_8365 () Int)
(declare-fun bh_8366 () Int)
(declare-fun n_8364 () Int)
...
(assert (or (and (and (and (= cl_8365 0) (<= 2 bh_8366)) (<= 1 n_8364)) (> v_node_244_3814_primed 0)) (or (and (and (and (< v_node_244_3814_primed 1) (= n_8364 0)) (= bh_8366 1)) (= cl_8365 0)) (and (and (and (= cl_8365 1) (<= 1 bh_8366)) (<= 1 n_8364)) (> v_node_244_3814_primed 0)))))
