...
(declare-fun cl () Int)
(declare-fun bh () Int)
(declare-fun cl2_16530 () Int)
(declare-fun bh_16528 () Int)
(declare-fun flted_380_16529 () Int)
...
(assert (<= 0 cl))
(assert (= x_15394 x))
(assert (= (+ flted_380_16529 1) n))
(assert (= cl 1))
(assert (<= 0 cl2_16530))
(assert (<= cl2_16530 1))
(assert (= bh_16528 bh))
(assert (or (and (and (and (= cl2_16530 0) (<= 2 bh_16528)) (<= 1 flted_380_16529)) (> x_primed 0)) (or (and (and (and (< x_primed 1) (= flted_380_16529 0)) (= bh_16528 1)) (= cl2_16530 0)) (and (and (and (= cl2_16530 1) (<= 1 bh_16528)) (<= 1 flted_380_16529)) (> x_primed 0)))))
