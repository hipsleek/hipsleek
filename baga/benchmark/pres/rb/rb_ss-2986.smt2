...
(declare-fun cl_16756 () Int)
(declare-fun bh_16757 () Int)
(declare-fun n_16755 () Int)
...
(assert (= cl 0))
(assert (not (> res 0)))
(assert (= n_16755 n_16748))
(assert (= cl_16756 cl))
(assert (= bh_16757 bh_16749))
(assert (<= 0 n_16748))
(assert (<= 1 bh_16749))
(assert (<= 0 cl))
(assert (<= cl 1))
...
(assert (= x_primed 1))
(assert (or (and (and (and (= cl_16756 0) (<= 2 bh_16757)) (<= 1 n_16755)) (> v_node_547_1796_primed 0)) (or (and (and (and (< v_node_547_1796_primed 1) (= n_16755 0)) (= bh_16757 1)) (= cl_16756 0)) (and (and (and (= cl_16756 1) (<= 1 bh_16757)) (<= 1 n_16755)) (> v_node_547_1796_primed 0)))))
