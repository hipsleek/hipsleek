...
(declare-fun Anon_8483 () Int)
(declare-fun bhl_8484 () Int)
(declare-fun nl_8482 () Int)
(declare-fun l_8481 () Int)
(declare-fun Anon_8487 () Int)
(declare-fun bhr_8488 () Int)
(declare-fun nr_8486 () Int)
(declare-fun r_8485 () Int)
(declare-fun b_primed () Int)
(declare-fun v_node_249_3842_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_13_8479 0))
(assert (= cl_8377 0))
(assert (= n_8376 (+ (+ nr_8486 1) nl_8482)))
(assert (= bhl_8484 bhr_8488))
(assert (= bh_8378 (+ bhl_8484 1)))
...
(assert (or (and (and (and (= Anon_8483 0) (<= 2 bhl_8484)) (<= 1 nl_8482)) (> l_8481 0)) (or (and (and (and (< l_8481 1) (= nl_8482 0)) (= bhl_8484 1)) (= Anon_8483 0)) (and (and (and (= Anon_8483 1) (<= 1 bhl_8484)) (<= 1 nl_8482)) (> l_8481 0)))))
(assert (or (and (and (and (= Anon_8487 0) (<= 2 bhr_8488)) (<= 1 nr_8486)) (> r_8485 0)) (or (and (and (and (< r_8485 1) (= nr_8486 0)) (= bhr_8488 1)) (= Anon_8487 0)) (and (and (and (= Anon_8487 1) (<= 1 bhr_8488)) (<= 1 nr_8486)) (> r_8485 0)))))
