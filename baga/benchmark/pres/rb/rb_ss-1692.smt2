...
(declare-fun na () Int)
(declare-fun a () Int)
(declare-fun flted_170_12060 () Int)
(declare-fun flted_170_12059 () Int)
(declare-fun flted_170_12061 () Int)
(declare-fun res () Int)
...
(assert (<= 0 cl))
(assert (<= cl 1))
(assert (= flted_170_12061 (+ (+ (+ (+ 3 nc_11914) na_11912) nb_11913) nd)))
(assert (= flted_170_12060 0))
(assert (= flted_170_12059 (+ 2 h_11915)))
(assert (= v_int_273_3671_primed 0))
...
(assert (= b_primed 1))
(assert (= r_11748 2))
(assert (or (and (and (and (= flted_170_12060 0) (<= 2 flted_170_12059)) (<= 1 flted_170_12061)) (> res 0)) (or (and (and (and (< res 1) (= flted_170_12061 0)) (= flted_170_12059 1)) (= flted_170_12060 0)) (and (and (and (= flted_170_12060 1) (<= 1 flted_170_12059)) (<= 1 flted_170_12061)) (> res 0)))))
