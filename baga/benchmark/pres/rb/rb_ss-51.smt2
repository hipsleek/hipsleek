...
(assert (<= 0 nb_5521))
(assert (<= 0 nc_5522))
(assert (or (and (and (and (= flted_22_5578 0) (<= 2 flted_22_5577)) (<= 1 flted_22_5579)) (> res 0)) (or (and (and (and (< res 1) (= flted_22_5579 0)) (= flted_22_5577 1)) (= flted_22_5578 0)) (and (and (and (= flted_22_5578 1) (<= 1 flted_22_5577)) (<= 1 flted_22_5579)) (> res 0)))))
