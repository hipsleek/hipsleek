...
(declare-fun right_315_3274_primed () Int)
(declare-fun left_315_3273_primed () Int)
(declare-fun color_315_3272_primed () Int)
(declare-fun val_315_3271_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_315_3274_primed r_13896))
(assert (= left_315_3273_primed l_13892))
(assert (= color_315_3272_primed flted_13_13890))
(assert (= val_315_3271_primed v_13891))
