...
(declare-fun right_273_3660_primed () Int)
(declare-fun left_273_3659_primed () Int)
(declare-fun color_273_3658_primed () Int)
(declare-fun val_273_3657_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_273_3660_primed r_11748))
(assert (= left_273_3659_primed l_11744))
(assert (= color_273_3658_primed flted_13_11742))
(assert (= val_273_3657_primed v_11743))
