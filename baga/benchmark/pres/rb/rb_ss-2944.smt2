...
(declare-fun right_599_2017_primed () Int)
(declare-fun left_599_2016_primed () Int)
(declare-fun color_599_2015_primed () Int)
(declare-fun val_599_2014_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_599_2017_primed v_node_592_17018))
(assert (= left_599_2016_primed l_16670))
(assert (= color_599_2015_primed flted_13_16668))
(assert (= val_599_2014_primed v_16669))
...
(assert (or (and (and (and (= cl 0) (<= 2 bh_17035)) (<= 1 n_17034)) (> v_node_592_17018 0)) (or (and (and (and (< v_node_592_17018 1) (= n_17034 0)) (= bh_17035 1)) (= cl 0)) (and (and (and (= cl 1) (<= 1 bh_17035)) (<= 1 n_17034)) (> v_node_592_17018 0)))))
