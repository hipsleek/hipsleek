...
(declare-fun right_273_3651_primed () Int)
(declare-fun left_273_3650_primed () Int)
(declare-fun color_273_3649_primed () Int)
(declare-fun val_273_3648_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_273_3651_primed r_11748))
(assert (= left_273_3650_primed l_11744))
(assert (= color_273_3649_primed flted_13_11742))
(assert (= val_273_3648_primed v_11743))
