...
(declare-fun right_403_2350_primed () Int)
(declare-fun left_403_2349_primed () Int)
(declare-fun color_403_2348_primed () Int)
(declare-fun val_403_2347_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_403_2350_primed r_14920))
(assert (= left_403_2349_primed l_14916))
(assert (= color_403_2348_primed flted_13_14914))
(assert (= val_403_2347_primed v_14915))
