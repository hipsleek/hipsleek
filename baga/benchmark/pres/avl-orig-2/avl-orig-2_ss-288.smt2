...
(declare-fun n_3844 () Int)
(declare-fun b_3845 () Int)
(declare-fun m_3843 () Int)
...
(assert (<= Anon_3759 2))
(assert (= res n_3834))
(assert (= m_3843 m_3833))
(assert (= n_3844 n_3834))
(assert (= b_3845 b_3835))
(assert (<= 0 m_3833))
(assert (<= 0 n_3834))
(assert (<= 0 b_3835))
(assert (<= b_3835 2))
...
(assert (or (and (and (and (< v_node_89_2083_primed 1) (= m_3843 0)) (= n_3844 0)) (= b_3845 1)) (and (and (and (and (and (<= 0 b_3845) (<= (+ (- 0 n_3844) 2) b_3845)) (<= b_3845 n_3844)) (<= b_3845 2)) (<= 1 m_3843)) (> v_node_89_2083_primed 0))))
