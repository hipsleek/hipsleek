...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5334 Int)) (= (+ flted_76_5334 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5333 Int)) (and (= v_int_118_5295 (+ max_5333 1)) (or (and (= max_5333 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5333 n2_5306) (< n1_5302 n2_5306))))))
...
(assert (exists ((max_5332 Int)) (and (= tn (+ max_5332 1)) (or (and (= max_5332 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5332 n2_3758) (< n1_3754 n2_3758))))))
