...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((flted_76_6205 Int)) (= (+ flted_76_6205 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6204 Int)) (and (= v_int_118_6157 (+ max_6204 1)) (or (and (= max_6204 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6204 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6203 Int)) (and (= tn (+ max_6203 1)) (or (and (= max_6203 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6203 n2_3758) (< n1_3754 n2_3758))))))
