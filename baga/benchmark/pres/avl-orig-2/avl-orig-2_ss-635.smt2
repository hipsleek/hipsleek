...
(assert (<= 0 n1_3754))
(assert (= n_3750 tn))
(assert (exists ((max_4985 Int)) (and (= tn (+ max_4985 1)) (or (and (= max_4985 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4985 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4983 Int)) (and (= n_4598 (+ max_4983 1)) (or (and (= max_4983 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4983 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4984 Int)) (and (= n (+ max_4984 1)) (or (and (= max_4984 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4984 n2_3921) (< n1_3917 n2_3921))))))
