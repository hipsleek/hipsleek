...
(declare-fun right_109_2175_primed () Int)
(declare-fun left_109_2174_primed () Int)
(declare-fun height_109_2173_primed () Int)
(declare-fun ele_109_2172_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_109_2175_primed v_node_107_4102))
(assert (= left_109_2174_primed p_3752))
(assert (= height_109_2173_primed n_3750))
(assert (= ele_109_2172_primed Anon_3751))
(assert (= (+ 2 n_4128) n))
(assert (<= b_4129 2))
(assert (<= 0 b_4129))
(assert (<= 0 n_4128))
