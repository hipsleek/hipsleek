...
(assert (exists ((max_6439 Int)) (and (= tn (+ max_6439 1)) (or (and (= max_6439 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6439 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= n_4598 n))
(assert (exists ((flted_76_6441 Int)) (= (+ flted_76_6441 n2_6414) (+ 1 n1_6410))))
(assert (exists ((max_6440 Int)) (and (= v_int_118_6403 (+ max_6440 1)) (or (and (= max_6440 n1_6410) (>= n1_6410 n2_6414)) (and (= max_6440 n2_6414) (< n1_6410 n2_6414))))))
