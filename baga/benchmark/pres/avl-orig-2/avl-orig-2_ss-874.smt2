...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5728 Int)) (and (= tn (+ max_5728 1)) (or (and (= max_5728 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5728 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5726 Int)) (and (= n_4487 (+ max_5726 1)) (or (and (= max_5726 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5726 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5727 Int)) (and (= n (+ max_5727 1)) (or (and (= max_5727 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5727 n2_4215) (< n1_4211 n2_4215))))))
