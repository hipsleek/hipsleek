...
(assert (exists ((max_6457 Int)) (and (= tn (+ max_6457 1)) (or (and (= max_6457 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6457 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= n_4598 n))
(assert (<= 0 n_4598))
(assert (exists ((flted_76_6459 Int)) (= (+ flted_76_6459 n2_6414) (+ 1 n1_6410))))
(assert (exists ((max_6458 Int)) (and (= v_int_118_6403 (+ max_6458 1)) (or (and (= max_6458 n1_6410) (>= n1_6410 n2_6414)) (and (= max_6458 n2_6414) (< n1_6410 n2_6414))))))
