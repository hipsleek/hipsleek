...
(declare-fun n1_4014 () Int)
(declare-fun Anon_4015 () Int)
(declare-fun m1_4013 () Int)
(declare-fun p_4012 () Int)
(declare-fun n2_4018 () Int)
(declare-fun Anon_4019 () Int)
(declare-fun m2_4017 () Int)
(declare-fun q_4016 () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= m_3944 (+ (+ m2_4017 1) m1_4013)))
(assert (exists ((max_79 Int)) (and (= n_3945 (+ max_79 1)) (or (and (= max_79 n1_4014) (>= n1_4014 n2_4018)) (and (= max_79 n2_4018) (< n1_4014 n2_4018))))))
(assert (<= (+ 0 n2_4018) (+ n1_4014 1)))
(assert (<= n1_4014 (+ 1 n2_4018)))
(assert (= (+ b_3946 n2_4018) (+ 1 n1_4014)))
(assert (= n_4010 n_3945))
...
(assert (= q_3919 1))
(assert (or (and (and (and (< p_4012 1) (= m1_4013 0)) (= n1_4014 0)) (= Anon_4015 1)) (and (and (and (and (and (<= 0 Anon_4015) (<= (+ (- 0 n1_4014) 2) Anon_4015)) (<= Anon_4015 n1_4014)) (<= Anon_4015 2)) (<= 1 m1_4013)) (> p_4012 0))))
(assert (or (and (and (and (< q_4016 1) (= m2_4017 0)) (= n2_4018 0)) (= Anon_4019 1)) (and (and (and (and (and (<= 0 Anon_4019) (<= (+ (- 0 n2_4018) 2) Anon_4019)) (<= Anon_4019 n2_4018)) (<= Anon_4019 2)) (<= 1 m2_4017)) (> q_4016 0))))
