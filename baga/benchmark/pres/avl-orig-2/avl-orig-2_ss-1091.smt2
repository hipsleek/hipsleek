...
(assert (exists ((resb_6251 Int)) (= (+ resb_6251 n2_6229) (+ 1 n1_6225))))
(assert (exists ((max_6250 Int)) (and (= v_int_118_6218 (+ max_6250 1)) (or (and (= max_6250 n1_6225) (>= n1_6225 n2_6229)) (and (= max_6250 n2_6229) (< n1_6225 n2_6229))))))
...
(assert (exists ((max_6249 Int)) (and (= tn (+ max_6249 1)) (or (and (= max_6249 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6249 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
