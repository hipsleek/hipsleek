...
(assert (exists ((resb_5407 Int)) (= (+ resb_5407 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5406 Int)) (and (= v_int_118_5356 (+ max_5406 1)) (or (and (= max_5406 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5406 n2_5367) (< n1_5363 n2_5367))))))
(assert (= n2_5367 n_4598))
(assert (= n1_5363 n_4487))
(assert (exists ((max_5405 Int)) (and (= tn (+ max_5405 1)) (or (and (= max_5405 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5405 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_5356 (+ 1 n_4598)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5367 n1_5363)) (= (+ 1 tn) v_int_118_5356)) (= tn v_int_118_5356))))
(check-sat)