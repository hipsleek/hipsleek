...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5637 Int)) (and (= tn (+ max_5637 1)) (or (and (= max_5637 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5637 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5635 Int)) (and (= n_4487 (+ max_5635 1)) (or (and (= max_5635 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5635 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5636 Int)) (and (= n (+ max_5636 1)) (or (and (= max_5636 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5636 n2_4215) (< n1_4211 n2_4215))))))
