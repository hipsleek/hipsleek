...
(declare-fun right_86_2050_primed () Int)
(declare-fun left_86_2049_primed () Int)
(declare-fun height_86_2048_primed () Int)
(declare-fun ele_86_2047_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_86_2050_primed q_3756))
(assert (= left_86_2049_primed p_3752))
(assert (= height_86_2048_primed n_3750))
(assert (= ele_86_2047_primed Anon_3751))
(assert (= t_primed t))
(assert (= x_primed x))
(assert (< tmp_primed 1))
(assert (> t_primed 0))
