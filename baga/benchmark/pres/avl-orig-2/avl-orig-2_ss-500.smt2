...
(assert (exists ((max_4644 Int)) (and (= n (+ max_4644 1)) (or (and (= max_4644 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4644 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4643 Int)) (and (= tn (+ max_4643 1)) (or (and (= max_4643 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4643 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4645 Int)) (and (= n_4598 (+ max_4645 1)) (or (and (= max_4645 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4645 n2_4609) (< n1_4605 n2_4609))))))
