...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6196 Int)) (= (+ flted_76_6196 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6195 Int)) (and (= v_int_118_6157 (+ max_6195 1)) (or (and (= max_6195 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6195 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6194 Int)) (and (= tn (+ max_6194 1)) (or (and (= max_6194 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6194 n2_3758) (< n1_3754 n2_3758))))))
