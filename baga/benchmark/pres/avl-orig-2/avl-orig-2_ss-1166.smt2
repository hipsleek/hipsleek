...
(assert (exists ((flted_76_6444 Int)) (= (+ flted_76_6444 n2_6414) (+ 1 n1_6410))))
(assert (exists ((max_6443 Int)) (and (= v_int_118_6403 (+ max_6443 1)) (or (and (= max_6443 n1_6410) (>= n1_6410 n2_6414)) (and (= max_6443 n2_6414) (< n1_6410 n2_6414))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_6442 Int)) (and (= tn (+ max_6442 1)) (or (and (= max_6442 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6442 n2_3758) (< n1_3754 n2_3758))))))
