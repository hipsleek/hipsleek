...
(assert (<= 0 n1_3754))
(assert (= n_3750 tn))
(assert (exists ((max_4988 Int)) (and (= tn (+ max_4988 1)) (or (and (= max_4988 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4988 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4986 Int)) (and (= n_4598 (+ max_4986 1)) (or (and (= max_4986 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4986 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4987 Int)) (and (= n (+ max_4987 1)) (or (and (= max_4987 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4987 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (not (or (and (= v_int_118_4945 (+ 1 n1_4952)) (<= n2_4956 n1_4952)) (and (= v_int_118_4945 (+ 1 n2_4956)) (< n1_4952 n2_4956)))))
(check-sat)