...
(declare-fun n_4647 () Int)
(declare-fun b_4648 () Int)
(declare-fun m_4646 () Int)
...
(assert (> resr_4417 0))
(assert (= res n_4598))
(assert (= m_4646 m_4597))
(assert (= n_4647 n_4598))
(assert (= b_4648 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4646 0)) (= n_4647 0)) (= b_4648 1)) (and (and (and (and (and (<= 0 b_4648) (<= (+ (- 0 n_4647) 2) b_4648)) (<= b_4648 n_4647)) (<= b_4648 2)) (<= 1 m_4646)) (> v_node_118_2227_primed 0))))
