...
(declare-fun right_237_1468_primed () Int)
(declare-fun left_237_1467_primed () Int)
(declare-fun height_237_1466_primed () Int)
(declare-fun Anon_60 () Int)
(declare-fun ele_237_1465_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_237_1468_primed rr))
(assert (= left_237_1467_primed rl))
(assert (= height_237_1466_primed Anon_60))
(assert (= ele_237_1465_primed Anon_59))
(assert (= k2_primed r))
(assert (= k1_primed k1))
(assert (= k1 1))
