...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5447 Int)) (= (+ flted_76_5447 n2_5425) (+ 1 n1_5421))))
(assert (exists ((max_5446 Int)) (and (= v_int_118_5414 (+ max_5446 1)) (or (and (= max_5446 n1_5421) (>= n1_5421 n2_5425)) (and (= max_5446 n2_5425) (< n1_5421 n2_5425))))))
...
(assert (exists ((max_5445 Int)) (and (= tn (+ max_5445 1)) (or (and (= max_5445 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5445 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
