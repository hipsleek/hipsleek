...
(assert (exists ((max_5625 Int)) (and (= tn (+ max_5625 1)) (or (and (= max_5625 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5625 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5624 Int)) (and (= n (+ max_5624 1)) (or (and (= max_5624 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5624 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5623 Int)) (and (= n_4487 (+ max_5623 1)) (or (and (= max_5623 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5623 n2_4517) (< n1_4513 n2_4517))))))
