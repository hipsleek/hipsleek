...
(assert (exists ((resb_5526 Int)) (= (+ resb_5526 n2_5486) (+ 1 n1_5482))))
(assert (exists ((max_5525 Int)) (and (= v_int_118_5475 (+ max_5525 1)) (or (and (= max_5525 n1_5482) (>= n1_5482 n2_5486)) (and (= max_5525 n2_5486) (< n1_5482 n2_5486))))))
(assert (= n2_5486 n_4598))
(assert (= n1_5482 n_4487))
(assert (exists ((max_5524 Int)) (and (= tn (+ max_5524 1)) (or (and (= max_5524 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5524 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_5475 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5486 n1_5482)) (= (+ 1 tn) v_int_118_5475)) (= tn v_int_118_5475))))
(check-sat)