...
(assert (= n_3750 tn))
(assert (exists ((flted_76_5581 Int)) (= (+ flted_76_5581 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5580 Int)) (and (= v_int_118_5533 (+ max_5580 1)) (or (and (= max_5580 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5580 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5579 Int)) (and (= tn (+ max_5579 1)) (or (and (= max_5579 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5579 n2_3758) (< n1_3754 n2_3758))))))
