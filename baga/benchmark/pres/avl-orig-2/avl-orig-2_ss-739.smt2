...
(assert (exists ((max_5320 Int)) (and (= tn (+ max_5320 1)) (or (and (= max_5320 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5320 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5306 0) (+ 1 n1_5302))))
(check-sat)