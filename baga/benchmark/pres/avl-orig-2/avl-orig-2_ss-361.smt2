...
(declare-fun right_107_2145_primed () Int)
(declare-fun left_107_2144_primed () Int)
(declare-fun height_107_2143_primed () Int)
(declare-fun ele_107_2142_primed () Int)
...
(declare-fun v_node_107_2141_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= right_107_2145_primed q_3756))
(assert (= left_107_2144_primed p_3752))
(assert (= height_107_2143_primed n_3750))
(assert (= ele_107_2142_primed Anon_3751))
(assert (<= b_4068 2))
(assert (<= 0 b_4068))
(assert (<= 0 tn_4067))
(assert (<= 0 tm_4066))
...
(assert (or (and (and (and (< v_node_107_2141_primed 1) (= flted_74_4090 0)) (= resn_4091 0)) (= resb_4092 1)) (and (and (and (and (and (<= 0 resb_4092) (<= (+ (- 0 resn_4091) 2) resb_4092)) (<= resb_4092 resn_4091)) (<= resb_4092 2)) (<= 1 flted_74_4090)) (> v_node_107_2141_primed 0))))
