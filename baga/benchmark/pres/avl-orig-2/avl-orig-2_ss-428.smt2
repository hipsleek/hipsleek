...
(assert (exists ((max_4257 Int)) (and (= tn (+ max_4257 1)) (or (and (= max_4257 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4257 n2_3758) (< n1_3754 n2_3758))))))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (= n_4207 n))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (exists ((max_4258 Int)) (and (= n (+ max_4258 1)) (or (and (= max_4258 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4258 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (or (= m_4127 0) (or (= n_4128 0) (< p_3752 1)))))
(check-sat)