...
(declare-fun tmp1_3298 () Int)
(declare-fun resn_3299 () Int)
(declare-fun tmp2_3300 () Int)
(declare-fun resrn_3301 () Int)
(declare-fun Anon_46 () Int)
(declare-fun Anon_49 () Int)
(declare-fun Anon_50 () Int)
(declare-fun an_3256 () Int)
(declare-fun Anon_3291 () Int)
(declare-fun am_3255 () Int)
(declare-fun resl_3290 () Int)
(declare-fun bn_3258 () Int)
(declare-fun Anon_3295 () Int)
(declare-fun bm_3257 () Int)
(declare-fun resrl_3294 () Int)
(declare-fun cn_3253 () Int)
(declare-fun Anon_3297 () Int)
(declare-fun cm_3252 () Int)
(declare-fun resrr_3296 () Int)
(declare-fun res () Int)
(declare-fun resr_3292 () Int)
...
(assert (<= Anon_20 2))
(assert (> k3_primed 0))
(assert (= resrn_3301 (+ 1 tmp1_3298)))
(assert (or (and (= tmp1_3298 cn_3253) (>= cn_3253 bn_3258)) (and (= tmp1_3298 bn_3258) (< cn_3253 bn_3258))))
(assert (= resn_3299 (+ 1 tmp2_3300)))
(assert (or (and (= tmp2_3300 an_3256) (>= an_3256 resrn_3301)) (and (= tmp2_3300 resrn_3301) (< an_3256 resrn_3301))))
(assert (<= 0 cm_3252))
(assert (<= 0 cn_3253))
(assert (<= 0 Anon_46))
(assert (<= Anon_46 2))
...
(assert (<= Anon_50 2))
(assert (= res 1))
(assert (or (and (and (and (< resl_3290 1) (= am_3255 0)) (= an_3256 0)) (= Anon_3291 1)) (and (and (and (and (and (<= 0 Anon_3291) (<= (+ (- 0 an_3256) 2) Anon_3291)) (<= Anon_3291 an_3256)) (<= Anon_3291 2)) (<= 1 am_3255)) (> resl_3290 0))))
(assert (= resr_3292 2))
(assert (or (and (and (and (< resrl_3294 1) (= bm_3257 0)) (= bn_3258 0)) (= Anon_3295 1)) (and (and (and (and (and (<= 0 Anon_3295) (<= (+ (- 0 bn_3258) 2) Anon_3295)) (<= Anon_3295 bn_3258)) (<= Anon_3295 2)) (<= 1 bm_3257)) (> resrl_3294 0))))
(assert (or (and (and (and (< resrr_3296 1) (= cm_3252 0)) (= cn_3253 0)) (= Anon_3297 1)) (and (and (and (and (and (<= 0 Anon_3297) (<= (+ (- 0 cn_3253) 2) Anon_3297)) (<= Anon_3297 cn_3253)) (<= Anon_3297 2)) (<= 1 cm_3252)) (> resrr_3296 0))))
(assert (not (= res resr_3292)))
