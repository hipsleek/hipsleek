...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_4047 Int)) (and (= tn (+ max_4047 1)) (or (and (= max_4047 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4047 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4045 Int)) (and (= n_3945 (+ max_4045 1)) (or (and (= max_4045 n1_4024) (>= n1_4024 n2_4028)) (and (= max_4045 n2_4028) (< n1_4024 n2_4028))))))
...
(assert (exists ((max_4046 Int)) (and (= n (+ max_4046 1)) (or (and (= max_4046 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4046 n2_3921) (< n1_3917 n2_3921))))))
