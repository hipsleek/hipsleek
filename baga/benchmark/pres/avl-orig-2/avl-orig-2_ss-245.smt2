...
(declare-fun right_87_2058_primed () Int)
(declare-fun left_87_2057_primed () Int)
(declare-fun height_87_2056_primed () Int)
(declare-fun ele_87_2055_primed () Int)
(declare-fun t () Int)
(declare-fun x () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_87_2058_primed q_3756))
(assert (= left_87_2057_primed p_3752))
(assert (= height_87_2056_primed n_3750))
(assert (= ele_87_2055_primed Anon_3751))
(assert (= t_primed t))
(assert (= x_primed x))
(assert (< tmp_primed 1))
(assert (> t_primed 0))
