...
(assert (exists ((flted_76_5231 Int)) (= (+ flted_76_5231 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5230 Int)) (and (= v_int_118_5138 (+ max_5230 1)) (or (and (= max_5230 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5230 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5227 Int)) (and (= n_3945 (+ max_5227 1)) (or (and (= max_5227 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5227 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5228 Int)) (and (= n (+ max_5228 1)) (or (and (= max_5228 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5228 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_5229 Int)) (and (= tn (+ max_5229 1)) (or (and (= max_5229 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5229 n2_3758) (< n1_3754 n2_3758))))))
