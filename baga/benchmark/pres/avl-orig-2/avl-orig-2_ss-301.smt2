...
(declare-fun right_90_2110_primed () Int)
(declare-fun left_90_2109_primed () Int)
(declare-fun height_90_2108_primed () Int)
(declare-fun ele_90_2107_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_90_2110_primed q_3756))
(assert (= left_90_2109_primed v_node_87_3808))
(assert (= height_90_2108_primed n_3750))
(assert (= ele_90_2107_primed Anon_3751))
(assert (<= b_3927 2))
(assert (<= 0 b_3927))
(assert (<= 0 n_3926))
(assert (<= 0 m_3925))
