...
(assert (exists ((max_6433 Int)) (and (= tn (+ max_6433 1)) (or (and (= max_6433 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6433 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6414 0) (+ 1 n1_6410))))
(check-sat)