...
(assert (exists ((flted_76_5584 Int)) (= (+ flted_76_5584 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5583 Int)) (and (= v_int_118_5533 (+ max_5583 1)) (or (and (= max_5583 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5583 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5582 Int)) (and (= tn (+ max_5582 1)) (or (and (= max_5582 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5582 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
