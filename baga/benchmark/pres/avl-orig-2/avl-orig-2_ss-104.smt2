...
(declare-fun right_239_1504_primed () Int)
(declare-fun left_239_1503_primed () Int)
(declare-fun height_239_1502_primed () Int)
(declare-fun Anon_57 () Int)
(declare-fun ele_239_1501_primed () Int)
(declare-fun Anon_56 () Int)
(declare-fun v_int_239_1500_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_239_1504_primed rl))
(assert (= left_239_1503_primed l))
(assert (= height_239_1502_primed Anon_57))
(assert (= ele_239_1501_primed Anon_56))
(assert (= v_int_239_1500_primed (+ 1 n_2923)))
(assert (< n n_2923))
(assert (<= b_2924 2))
(assert (<= 0 b_2924))
(assert (<= 0 n_2923))
