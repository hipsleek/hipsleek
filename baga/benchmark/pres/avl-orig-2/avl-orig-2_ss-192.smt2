...
;Axioms assertions
;Antecedent
(assert (exists ((Anon_3423 Int)) (= (+ Anon_3423 n2_3344) (+ 1 n1_3340))))
(assert (<= Anon_49 2))
(assert (<= 0 Anon_49))
(assert (<= 0 dn))
(assert (<= 0 cn_3199))
...
(assert (exists ((max_3422 Int)) (and (= resrn_3315 (+ max_3422 1)) (or (and (= max_3422 n1_3340) (>= n1_3340 n2_3344)) (and (= max_3422 n2_3344) (< n1_3340 n2_3344))))))
...
(assert (exists ((max_3421 Int)) (and (= an_3256 (+ max_3421 1)) (or (and (= max_3421 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3421 n2_3269) (< n1_3265 n2_3269))))))
(assert (<= 0 an_3256))
;Negation of Consequence
(assert (not (or (and (= (+ an 1) an_3256) (< bn an_3256)) (and (= (+ bn 1) an_3256) (<= (+ an 2) an_3256)))))
(check-sat)