...
(assert (exists ((flted_76_5013 Int)) (= (+ flted_76_5013 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5012 Int)) (and (= v_int_118_4945 (+ max_5012 1)) (or (and (= max_5012 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5012 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5011 Int)) (and (= n_4598 (+ max_5011 1)) (or (and (= max_5011 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5011 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5010 Int)) (and (= n (+ max_5010 1)) (or (and (= max_5010 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5010 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_5009 Int)) (and (= tn (+ max_5009 1)) (or (and (= max_5009 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5009 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
