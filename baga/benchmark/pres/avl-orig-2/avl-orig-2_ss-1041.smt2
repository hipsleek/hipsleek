...
(assert (exists ((max_6124 Int)) (and (= tn (+ max_6124 1)) (or (and (= max_6124 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6124 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6110 0) (+ 1 n1_6106))))
(check-sat)