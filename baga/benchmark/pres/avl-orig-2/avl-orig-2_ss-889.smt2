...
(assert (exists ((max_79 Int)) (and (= v_int_118_5688 (+ max_79 1)) (or (and (= max_79 n1_5695) (>= n1_5695 n2_5699)) (and (= max_79 n2_5699) (< n1_5695 n2_5699))))))
(assert (exists ((flted_76_5689 Int)) (= (+ flted_76_5689 n2_5699) (+ 1 n1_5695))))
(assert (= (+ n2_5699 1) (+ n1_5695 1)))
(assert (= v_int_118_5688 1))
(assert (or (and (= v_int_118_5688 (+ 1 n1_5695)) (<= n2_5699 n1_5695)) (and (= v_int_118_5688 (+ 1 n2_5699)) (< n1_5695 n2_5699))))
