...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6092 Int)) (= (+ flted_76_6092 n2_6049) (+ 1 n1_6045))))
(assert (exists ((max_6091 Int)) (and (= v_int_118_6038 (+ max_6091 1)) (or (and (= max_6091 n1_6045) (>= n1_6045 n2_6049)) (and (= max_6091 n2_6049) (< n1_6045 n2_6049))))))
...
(assert (exists ((max_6090 Int)) (and (= tn (+ max_6090 1)) (or (and (= max_6090 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6090 n2_3758) (< n1_3754 n2_3758))))))
