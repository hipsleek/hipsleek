...
(assert (exists ((Anon_3402 Int)) (= (+ Anon_3402 n2_3344) (+ 1 n1_3340))))
(assert (exists ((max_3401 Int)) (and (= resrn_3315 (+ max_3401 1)) (or (and (= max_3401 n1_3340) (>= n1_3340 n2_3344)) (and (= max_3401 n2_3344) (< n1_3340 n2_3344))))))
...
(assert (<= 0 bn_3258))
(assert (<= 0 cn_3253))
(assert (exists ((max_3400 Int)) (and (= an_3256 (+ max_3400 1)) (or (and (= max_3400 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3400 n2_3269) (< n1_3265 n2_3269))))))
