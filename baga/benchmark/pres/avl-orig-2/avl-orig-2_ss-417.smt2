...
(assert (<= Anon_4212 2))
(assert (= res n_4239))
(assert (= m_4245 m_4238))
(assert (= n_4246 n_4239))
(assert (= b_4247 b_4240))
(assert (<= 0 m_4238))
(assert (<= 0 n_4239))
(assert (<= 0 b_4240))
(assert (<= b_4240 2))
...
(assert (or (and (and (and (< v_node_109_2197_primed 1) (= m_4245 0)) (= n_4246 0)) (= b_4247 1)) (and (and (and (and (and (<= 0 b_4247) (<= (+ (- 0 n_4246) 2) b_4247)) (<= b_4247 n_4246)) (<= b_4247 2)) (<= 1 m_4245)) (> v_node_109_2197_primed 0))))
