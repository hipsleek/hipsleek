...
(assert (exists ((max_5826 Int)) (and (= n (+ max_5826 1)) (or (and (= max_5826 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5826 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_5825 Int)) (and (= tn (+ max_5825 1)) (or (and (= max_5825 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5825 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5827 Int)) (and (= n_4239 (+ max_5827 1)) (or (and (= max_5827 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5827 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
