...
(assert (exists ((flted_76_6333 Int)) (= (+ flted_76_6333 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6332 Int)) (and (= v_int_118_6276 (+ max_6332 1)) (or (and (= max_6332 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6332 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6331 Int)) (and (= tn (+ max_6331 1)) (or (and (= max_6331 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6331 n2_3758) (< n1_3754 n2_3758))))))
