...
(assert (= Anon_5241 Anon_3751))
(assert (= p_5242 v_node_87_3808))
(assert (= q_5246 q_3756))
(assert (= m1_5243 m_4486))
(assert (= n1_5244 n_4487))
(assert (= Anon_5245 b_4488))
(assert (= m2_5247 m_4597))
(assert (= n2_5248 n_4598))
(assert (= Anon_5249 b_4599))
(assert (exists ((max_79 Int)) (and (= v_int_118_5237 (+ max_79 1)) (or (and (= max_79 n1_5244) (>= n1_5244 n2_5248)) (and (= max_79 n2_5248) (< n1_5244 n2_5248))))))
(assert (exists ((resb_5240 Int)) (= (+ resb_5240 n2_5248) (+ 1 n1_5244))))
