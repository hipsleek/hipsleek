...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5404 Int)) (= (+ resb_5404 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5403 Int)) (and (= v_int_118_5356 (+ max_5403 1)) (or (and (= max_5403 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5403 n2_5367) (< n1_5363 n2_5367))))))
...
(assert (exists ((max_5402 Int)) (and (= tn (+ max_5402 1)) (or (and (= max_5402 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5402 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
