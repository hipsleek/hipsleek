...
(assert (exists ((max_6301 Int)) (and (= tn (+ max_6301 1)) (or (and (= max_6301 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6301 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6287 0) (+ 1 n1_6283))))
(check-sat)