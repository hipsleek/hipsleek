...
(assert (exists ((resb_6257 Int)) (= (+ resb_6257 n2_6229) (+ 1 n1_6225))))
(assert (exists ((max_6256 Int)) (and (= v_int_118_6218 (+ max_6256 1)) (or (and (= max_6256 n1_6225) (>= n1_6225 n2_6229)) (and (= max_6256 n2_6229) (< n1_6225 n2_6229))))))
...
(assert (exists ((max_6255 Int)) (and (= tn (+ max_6255 1)) (or (and (= max_6255 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6255 n2_3758) (< n1_3754 n2_3758))))))
