...
(assert (exists ((max_5674 Int)) (and (= n (+ max_5674 1)) (or (and (= max_5674 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5674 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5675 Int)) (and (= n_4487 (+ max_5675 1)) (or (and (= max_5675 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5675 n2_4517) (< n1_4513 n2_4517))))))
(assert (exists ((resb_5677 Int)) (= (+ resb_5677 n2_5605) (+ 1 n1_5601))))
(assert (exists ((max_5676 Int)) (and (= v_int_118_5594 (+ max_5676 1)) (or (and (= max_5676 n1_5601) (>= n1_5601 n2_5605)) (and (= max_5676 n2_5605) (< n1_5601 n2_5605))))))
(assert (= n2_5605 n_4598))
(assert (= n1_5601 n_4487))
(assert (exists ((max_5673 Int)) (and (= tn (+ max_5673 1)) (or (and (= max_5673 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5673 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_5594 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5605 n1_5601)) (= (+ 1 tn) v_int_118_5594)) (= tn v_int_118_5594))))
(check-sat)