...
(assert (exists ((max_3930 Int)) (and (= tn (+ max_3930 1)) (or (and (= max_3930 n1_3754) (>= n1_3754 n2_3758)) (and (= max_3930 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_3931 Int)) (and (= n (+ max_3931 1)) (or (and (= max_3931 n1_3917) (>= n1_3917 n2_3921)) (and (= max_3931 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (not (or (= m1_3916 0) (or (= n1_3917 0) (< p_3915 1)))))
(check-sat)