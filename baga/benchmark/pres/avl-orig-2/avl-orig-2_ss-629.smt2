...
(assert (= Anon_4855 Anon_4414))
(assert (= p_4856 resl_4415))
(assert (= q_4860 resr_4417))
(assert (= m1_4857 m_4486))
(assert (= n1_4858 n_4487))
(assert (= Anon_4859 b_4488))
(assert (= m2_4861 m_4597))
(assert (= n2_4862 n_4598))
(assert (= Anon_4863 b_4599))
(assert (exists ((max_79 Int)) (and (= v_int_118_4851 (+ max_79 1)) (or (and (= max_79 n1_4858) (>= n1_4858 n2_4862)) (and (= max_79 n2_4862) (< n1_4858 n2_4862))))))
(assert (exists ((resb_4854 Int)) (= (+ resb_4854 n2_4862) (+ 1 n1_4858))))
