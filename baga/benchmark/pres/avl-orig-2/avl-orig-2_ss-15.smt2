...
(declare-fun right_201_1648_primed () Int)
(declare-fun left_201_1647_primed () Int)
(declare-fun height_201_1646_primed () Int)
(declare-fun Anon_48 () Int)
(declare-fun ele_201_1645_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_201_1648_primed lr))
(assert (= left_201_1647_primed ll))
(assert (= height_201_1646_primed Anon_48))
(assert (= ele_201_1645_primed Anon_47))
