...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5934 Int)) (= (+ flted_76_5934 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5933 Int)) (and (= v_int_118_5881 (+ max_5933 1)) (or (and (= max_5933 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5933 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5930 Int)) (and (= n_4239 (+ max_5930 1)) (or (and (= max_5930 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5930 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5931 Int)) (and (= n (+ max_5931 1)) (or (and (= max_5931 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5931 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5932 Int)) (and (= tn (+ max_5932 1)) (or (and (= max_5932 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5932 n2_3758) (< n1_3754 n2_3758))))))
