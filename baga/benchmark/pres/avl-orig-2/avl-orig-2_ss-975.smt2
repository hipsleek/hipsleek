...
(assert (exists ((flted_76_5974 Int)) (= (+ flted_76_5974 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5973 Int)) (and (= v_int_118_5881 (+ max_5973 1)) (or (and (= max_5973 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5973 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5970 Int)) (and (= n_4239 (+ max_5970 1)) (or (and (= max_5970 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5970 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5971 Int)) (and (= n (+ max_5971 1)) (or (and (= max_5971 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5971 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_5972 Int)) (and (= tn (+ max_5972 1)) (or (and (= max_5972 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5972 n2_3758) (< n1_3754 n2_3758))))))
