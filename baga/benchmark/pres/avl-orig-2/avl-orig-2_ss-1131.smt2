...
(assert (exists ((max_6361 Int)) (and (= tn (+ max_6361 1)) (or (and (= max_6361 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6361 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (= m_4597 0) (or (= n_4598 0) (< v_node_107_4104 1)))))
(check-sat)