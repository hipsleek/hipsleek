...
(assert (exists ((max_4540 Int)) (and (= n (+ max_4540 1)) (or (and (= max_4540 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4540 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_4541 Int)) (and (= tn (+ max_4541 1)) (or (and (= max_4541 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4541 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= resln_4458 (+ 1 n1_4513)) (<= n2_4517 n1_4513)) (and (= resln_4458 (+ 1 n2_4517)) (< n1_4513 n2_4517)))))
(check-sat)