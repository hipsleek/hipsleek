...
(assert (exists ((resb_6396 Int)) (= (+ resb_6396 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6395 Int)) (and (= v_int_118_6337 (+ max_6395 1)) (or (and (= max_6395 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6395 n2_6348) (< n1_6344 n2_6348))))))
(assert (= n2_6348 n_4598))
(assert (= v_int_118_6337 (+ 1 n_4598)))
(assert (= n_3750 tn))
(assert (exists ((max_6394 Int)) (and (= tn (+ max_6394 1)) (or (and (= max_6394 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6394 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n1_6344 0))
;Negation of Consequence
(assert (not (or (and (not (= n2_6348 n1_6344)) (= (+ 1 tn) v_int_118_6337)) (= tn v_int_118_6337))))
(check-sat)