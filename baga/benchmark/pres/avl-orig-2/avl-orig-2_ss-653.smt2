...
(assert (exists ((resb_4914 Int)) (= (+ resb_4914 n2_4862) (+ 1 n1_4858))))
(assert (exists ((max_4913 Int)) (and (= v_int_118_4851 (+ max_4913 1)) (or (and (= max_4913 n1_4858) (>= n1_4858 n2_4862)) (and (= max_4913 n2_4862) (< n1_4858 n2_4862))))))
(assert (= Anon_4863 b_4599))
(assert (= n2_4862 n_4598))
(assert (exists ((max_4912 Int)) (and (= n_4598 (+ max_4912 1)) (or (and (= max_4912 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4912 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4911 Int)) (and (= n (+ max_4911 1)) (or (and (= max_4911 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4911 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4910 Int)) (and (= tn (+ max_4910 1)) (or (and (= max_4910 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4910 n2_3758) (< n1_3754 n2_3758))))))
