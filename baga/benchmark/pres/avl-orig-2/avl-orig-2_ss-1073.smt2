...
(assert (exists ((flted_76_6321 Int)) (= (+ flted_76_6321 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6320 Int)) (and (= v_int_118_6276 (+ max_6320 1)) (or (and (= max_6320 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6320 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6319 Int)) (and (= tn (+ max_6319 1)) (or (and (= max_6319 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6319 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
