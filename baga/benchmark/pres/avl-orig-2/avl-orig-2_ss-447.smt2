...
(declare-fun h_4349 () Int)
(declare-fun t_4350 () Int)
(declare-fun t1_4352 () Int)
(declare-fun t2_4354 () Int)
(declare-fun am () Int)
(declare-fun an () Int)
...
(declare-fun res () Int)
(declare-fun h1_4351 () Int)
(declare-fun Anon_4346 () Int)
(declare-fun flted_174_4343 () Int)
(declare-fun ss1_4345 () Int)
(declare-fun h2_4353 () Int)
(declare-fun Anon_4348 () Int)
(declare-fun flted_175_4342 () Int)
(declare-fun ss3_4347 () Int)
...
(assert (<= b_4129 2))
(assert (> t_primed 0))
(assert (= flted_174_4343 (+ (+ 1 am) bm)))
(assert (= flted_175_4342 (+ (+ 1 cm) dm)))
(assert (= h_4349 (+ t_4350 1)))
(assert (or (and (= t_4350 h1_4351) (>= h1_4351 h2_4353)) (and (= t_4350 h2_4353) (< h1_4351 h2_4353))))
(assert (= h1_4351 (+ t1_4352 1)))
(assert (or (and (= t1_4352 an) (>= an bn)) (and (= t1_4352 bn) (< an bn))))
(assert (= h2_4353 (+ t2_4354 1)))
(assert (or (and (= t2_4354 cn) (>= cn dn)) (and (= t2_4354 dn) (< cn dn))))
(assert (<= 0 am))
(assert (<= 0 an))
(assert (<= 0 Anon_33))
(assert (<= Anon_33 2))
...
(assert (<= Anon_40 2))
(assert (= res 1))
(assert (or (and (and (and (< ss1_4345 1) (= flted_174_4343 0)) (= h1_4351 0)) (= Anon_4346 1)) (and (and (and (and (and (<= 0 Anon_4346) (<= (+ (- 0 h1_4351) 2) Anon_4346)) (<= Anon_4346 h1_4351)) (<= Anon_4346 2)) (<= 1 flted_174_4343)) (> ss1_4345 0))))
(assert (or (and (and (and (< ss3_4347 1) (= flted_175_4342 0)) (= h2_4353 0)) (= Anon_4348 1)) (and (and (and (and (and (<= 0 Anon_4348) (<= (+ (- 0 h2_4353) 2) Anon_4348)) (<= Anon_4348 h2_4353)) (<= Anon_4348 2)) (<= 1 flted_175_4342)) (> ss3_4347 0))))
