...
(assert (exists ((max_4288 Int)) (and (= tn (+ max_4288 1)) (or (and (= max_4288 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4288 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4289 Int)) (and (= n (+ max_4289 1)) (or (and (= max_4289 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4289 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (or (= m_4219 0) (or (= n_4220 0) (< q_4213 1)))))
(check-sat)