...
(assert (= bn_3197 bn))
(assert (= an_3195 an))
(assert (exists ((max_3280 Int)) (and (= an_3256 (+ max_3280 1)) (or (and (= max_3280 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3280 n2_3269) (< n1_3265 n2_3269))))))
...
(assert (not (or (and (= an_3256 (+ n1_3265 1)) (<= n2_3269 n1_3265)) (and (= an_3256 (+ n2_3269 1)) (< n1_3265 n2_3269)))))
(check-sat)