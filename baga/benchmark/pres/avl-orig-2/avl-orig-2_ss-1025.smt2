...
(assert (exists ((max_6184 Int)) (and (= tn (+ max_6184 1)) (or (and (= max_6184 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6184 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_6157 (+ 1 n1_6164)) (<= n2_6168 n1_6164)) (and (= v_int_118_6157 (+ 1 n2_6168)) (< n1_6164 n2_6168)))))
(check-sat)