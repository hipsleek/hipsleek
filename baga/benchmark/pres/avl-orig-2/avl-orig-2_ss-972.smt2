...
(assert (exists ((max_5956 Int)) (and (= n (+ max_5956 1)) (or (and (= max_5956 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5956 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_5957 Int)) (and (= tn (+ max_5957 1)) (or (and (= max_5957 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5957 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5955 Int)) (and (= n_4239 (+ max_5955 1)) (or (and (= max_5955 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5955 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
...
(assert (<= 0 m2_4321))
(assert (= cm m2_4321))
(assert (exists ((flted_76_5959 Int)) (= (+ flted_76_5959 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5958 Int)) (and (= v_int_118_5881 (+ max_5958 1)) (or (and (= max_5958 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5958 n2_5892) (< n1_5888 n2_5892))))))
