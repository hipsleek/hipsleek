...
(assert (exists ((max_6032 Int)) (and (= tn (+ max_6032 1)) (or (and (= max_6032 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6032 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((resb_6034 Int)) (= (+ resb_6034 n2_5991) (+ 1 n1_5987))))
(assert (exists ((max_6033 Int)) (and (= v_int_118_5980 (+ max_6033 1)) (or (and (= max_6033 n1_5987) (>= n1_5987 n2_5991)) (and (= max_6033 n2_5991) (< n1_5987 n2_5991))))))
