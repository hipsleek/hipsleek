...
(assert (exists ((max_5289 Int)) (and (= tn (+ max_5289 1)) (or (and (= max_5289 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5289 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (<= 0 n))
(assert (= n_4487 n))
(assert (exists ((resb_5291 Int)) (= (+ resb_5291 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5290 Int)) (and (= v_int_118_5237 (+ max_5290 1)) (or (and (= max_5290 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5290 n2_5248) (< n1_5244 n2_5248))))))
