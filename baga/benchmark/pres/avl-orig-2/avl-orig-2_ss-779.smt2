...
(assert (<= 0 n1_3754))
(assert (= n_3750 tn))
(assert (exists ((flted_76_5343 Int)) (= (+ flted_76_5343 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5342 Int)) (and (= v_int_118_5295 (+ max_5342 1)) (or (and (= max_5342 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5342 n2_5306) (< n1_5302 n2_5306))))))
...
(assert (exists ((max_5341 Int)) (and (= tn (+ max_5341 1)) (or (and (= max_5341 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5341 n2_3758) (< n1_3754 n2_3758))))))
