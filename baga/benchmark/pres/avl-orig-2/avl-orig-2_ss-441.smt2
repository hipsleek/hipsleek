...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_4332 Int)) (and (= tn (+ max_4332 1)) (or (and (= max_4332 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4332 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4330 Int)) (and (= n_4239 (+ max_4330 1)) (or (and (= max_4330 n1_4318) (>= n1_4318 n2_4322)) (and (= max_4330 n2_4322) (< n1_4318 n2_4322))))))
...
(assert (exists ((max_4331 Int)) (and (= n (+ max_4331 1)) (or (and (= max_4331 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4331 n2_4215) (< n1_4211 n2_4215))))))
