...
(assert (exists ((max_3357 Int)) (and (= an_3256 (+ max_3357 1)) (or (and (= max_3357 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3357 n2_3269) (< n1_3265 n2_3269))))))
...
(assert (not (or (= cm_3252 0) (or (= cn_3253 0) (< resrr_3310 1)))))
(check-sat)