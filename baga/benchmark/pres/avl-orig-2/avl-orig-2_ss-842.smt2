...
(assert (exists ((max_5499 Int)) (and (= tn (+ max_5499 1)) (or (and (= max_5499 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5499 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (= m_4597 0) (or (= n_4598 0) (< q_3756 1)))))
(check-sat)