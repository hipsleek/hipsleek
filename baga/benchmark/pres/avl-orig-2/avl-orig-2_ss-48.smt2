...
(declare-fun res () Int)
(declare-fun v_int_203_1689_primed () Int)
...
(assert (<= 0 b_2665))
(assert (<= b_2665 2))
(assert (= v_int_203_1689_primed v_int_202_2659))
(assert (= res v_int_203_1690_primed))
(assert (<= v_int_203_1689_primed v_int_203_1690_primed))
(assert (= k1_primed 1))
