...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5107 Int)) (= (+ resb_5107 n2_5055) (+ 1 n1_5051))))
(assert (exists ((max_5106 Int)) (and (= v_int_118_5044 (+ max_5106 1)) (or (and (= max_5106 n1_5051) (>= n1_5051 n2_5055)) (and (= max_5106 n2_5055) (< n1_5051 n2_5055))))))
...
(assert (exists ((max_5103 Int)) (and (= n_3945 (+ max_5103 1)) (or (and (= max_5103 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5103 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5104 Int)) (and (= n (+ max_5104 1)) (or (and (= max_5104 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5104 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_5105 Int)) (and (= tn (+ max_5105 1)) (or (and (= max_5105 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5105 n2_3758) (< n1_3754 n2_3758))))))
