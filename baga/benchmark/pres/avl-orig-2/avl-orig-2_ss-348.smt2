...
(assert (<= 0 n2_4028))
(assert (= bn n1_4024))
(assert (exists ((max_4036 Int)) (and (= n_3945 (+ max_4036 1)) (or (and (= max_4036 n1_4024) (>= n1_4024 n2_4028)) (and (= max_4036 n2_4028) (< n1_4024 n2_4028))))))
(assert (<= (+ 0 n2_4028) (+ n1_4024 1)))
(assert (<= n1_4024 (+ 1 n2_4028)))
(assert (= (+ b_3946 n2_4028) (+ 1 n1_4024)))
(assert (exists ((max_4037 Int)) (and (= n (+ max_4037 1)) (or (and (= max_4037 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4037 n2_3921) (< n1_3917 n2_3921))))))
(assert (= n_3913 n))
(assert (exists ((max_4038 Int)) (and (= tn (+ max_4038 1)) (or (and (= max_4038 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4038 n2_3758) (< n1_3754 n2_3758))))))
