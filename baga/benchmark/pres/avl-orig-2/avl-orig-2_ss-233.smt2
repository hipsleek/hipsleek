...
(assert (exists ((max_3614 Int)) (and (= cn_3521 (+ max_3614 1)) (or (and (= max_3614 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3614 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (or (= am_3515 0) (or (= an_3516 0) (< resll_3570 1)))))
(check-sat)