...
(declare-fun right_90_2102_primed () Int)
(declare-fun left_90_2101_primed () Int)
(declare-fun height_90_2100_primed () Int)
(declare-fun ele_90_2099_primed () Int)
(declare-fun Anon_3914 () Int)
(declare-fun v_node_90_2098_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_90_2102_primed q_3919))
(assert (= left_90_2101_primed p_3915))
(assert (= height_90_2100_primed n_3913))
(assert (= ele_90_2099_primed Anon_3914))
(assert (= v_node_90_2098_primed v_node_87_3808))
(assert (= (+ 2 n_3834) n))
(assert (<= b_3835 2))
(assert (<= 0 b_3835))
(assert (<= 0 n_3834))
...
(assert (= t_primed 1))
(assert (or (and (and (and (< p_3915 1) (= m1_3916 0)) (= n1_3917 0)) (= Anon_3918 1)) (and (and (and (and (and (<= 0 Anon_3918) (<= (+ (- 0 n1_3917) 2) Anon_3918)) (<= Anon_3918 n1_3917)) (<= Anon_3918 2)) (<= 1 m1_3916)) (> p_3915 0))))
