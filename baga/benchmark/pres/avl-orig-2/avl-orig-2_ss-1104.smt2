...
(assert (exists ((max_6303 Int)) (and (= tn (+ max_6303 1)) (or (and (= max_6303 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6303 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_6276 (+ 1 n1_6283)) (<= n2_6287 n1_6283)) (and (= v_int_118_6276 (+ 1 n2_6287)) (< n1_6283 n2_6287)))))
(check-sat)