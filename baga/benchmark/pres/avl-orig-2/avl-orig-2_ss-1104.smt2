...
(assert (exists ((resb_6378 Int)) (= (+ resb_6378 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6377 Int)) (and (= v_int_118_6337 (+ max_6377 1)) (or (and (= max_6377 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6377 n2_6348) (< n1_6344 n2_6348))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_6376 Int)) (and (= tn (+ max_6376 1)) (or (and (= max_6376 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6376 n2_3758) (< n1_3754 n2_3758))))))
