...
(declare-fun right_240_1508_primed () Int)
(declare-fun left_240_1507_primed () Int)
(declare-fun height_240_1506_primed () Int)
(declare-fun Anon_60 () Int)
(declare-fun ele_240_1505_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_240_1508_primed rr))
(assert (= left_240_1507_primed k1_primed))
(assert (= height_240_1506_primed Anon_60))
(assert (= ele_240_1505_primed Anon_59))
