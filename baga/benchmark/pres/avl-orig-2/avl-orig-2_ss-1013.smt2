...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6135 Int)) (= (+ resb_6135 n2_6110) (+ 1 n1_6106))))
(assert (exists ((max_6134 Int)) (and (= v_int_118_6099 (+ max_6134 1)) (or (and (= max_6134 n1_6106) (>= n1_6106 n2_6110)) (and (= max_6134 n2_6110) (< n1_6106 n2_6110))))))
...
(assert (exists ((max_6133 Int)) (and (= tn (+ max_6133 1)) (or (and (= max_6133 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6133 n2_3758) (< n1_3754 n2_3758))))))
