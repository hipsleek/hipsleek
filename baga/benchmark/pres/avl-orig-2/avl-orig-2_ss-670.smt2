...
(assert (exists ((flted_76_4998 Int)) (= (+ flted_76_4998 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_4997 Int)) (and (= v_int_118_4945 (+ max_4997 1)) (or (and (= max_4997 n1_4952) (>= n1_4952 n2_4956)) (and (= max_4997 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_4996 Int)) (and (= n_4598 (+ max_4996 1)) (or (and (= max_4996 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4996 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4995 Int)) (and (= n (+ max_4995 1)) (or (and (= max_4995 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4995 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4994 Int)) (and (= tn (+ max_4994 1)) (or (and (= max_4994 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4994 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
