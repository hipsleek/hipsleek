...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5276 Int)) (= (+ resb_5276 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5275 Int)) (and (= v_int_118_5237 (+ max_5275 1)) (or (and (= max_5275 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5275 n2_5248) (< n1_5244 n2_5248))))))
...
(assert (exists ((max_5274 Int)) (and (= tn (+ max_5274 1)) (or (and (= max_5274 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5274 n2_3758) (< n1_3754 n2_3758))))))
