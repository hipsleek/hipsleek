...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5270 Int)) (= (+ resb_5270 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5269 Int)) (and (= v_int_118_5237 (+ max_5269 1)) (or (and (= max_5269 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5269 n2_5248) (< n1_5244 n2_5248))))))
...
(assert (exists ((max_5268 Int)) (and (= tn (+ max_5268 1)) (or (and (= max_5268 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5268 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
