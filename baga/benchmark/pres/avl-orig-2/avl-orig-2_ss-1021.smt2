...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6083 Int)) (= (+ flted_76_6083 n2_6049) (+ 1 n1_6045))))
(assert (exists ((max_6082 Int)) (and (= v_int_118_6038 (+ max_6082 1)) (or (and (= max_6082 n1_6045) (>= n1_6045 n2_6049)) (and (= max_6082 n2_6049) (< n1_6045 n2_6049))))))
...
(assert (exists ((max_6081 Int)) (and (= tn (+ max_6081 1)) (or (and (= max_6081 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6081 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
