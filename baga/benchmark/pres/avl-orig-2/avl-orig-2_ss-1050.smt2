...
(assert (exists ((resb_6150 Int)) (= (+ resb_6150 n2_6110) (+ 1 n1_6106))))
(assert (exists ((max_6149 Int)) (and (= v_int_118_6099 (+ max_6149 1)) (or (and (= max_6149 n1_6106) (>= n1_6106 n2_6110)) (and (= max_6149 n2_6110) (< n1_6106 n2_6110))))))
(assert (= n2_6110 n_4598))
(assert (= n1_6106 n_4487))
(assert (exists ((max_6148 Int)) (and (= tn (+ max_6148 1)) (or (and (= max_6148 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6148 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_6099 (+ 1 n_4598)))
;Negation of Consequence
(assert (not (or (and (not (= n2_6110 n1_6106)) (= (+ 1 tn) v_int_118_6099)) (= tn v_int_118_6099))))
(check-sat)