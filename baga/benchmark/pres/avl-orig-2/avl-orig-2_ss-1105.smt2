...
(assert (exists ((resb_6381 Int)) (= (+ resb_6381 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6380 Int)) (and (= v_int_118_6337 (+ max_6380 1)) (or (and (= max_6380 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6380 n2_6348) (< n1_6344 n2_6348))))))
...
(assert (= tn_4067 0))
(assert (= n_3750 tn))
(assert (exists ((max_6379 Int)) (and (= tn (+ max_6379 1)) (or (and (= max_6379 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6379 n2_3758) (< n1_3754 n2_3758))))))
