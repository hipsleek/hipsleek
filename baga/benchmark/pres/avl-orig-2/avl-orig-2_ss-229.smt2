...
(declare-fun cn_3546 () Int)
(declare-fun Anon_3555 () Int)
(declare-fun cm_3545 () Int)
(declare-fun resr_3554 () Int)
(declare-fun an_3548 () Int)
(declare-fun Anon_3557 () Int)
(declare-fun am_3547 () Int)
(declare-fun resll_3556 () Int)
(declare-fun bn_3550 () Int)
(declare-fun Anon_3559 () Int)
(declare-fun bm_3549 () Int)
...
(assert (= cm_3545 cm_3520))
(assert (= cn_3546 cn_3521))
(assert (= am_3547 am_3515))
(assert (= an_3548 an_3516))
(assert (= bm_3549 bm_3518))
(assert (= bn_3550 bn_3519))
(assert (<= 0 am_3515))
(assert (<= 0 an_3516))
(assert (<= 0 Anon_58))
(assert (<= Anon_58 2))
...
(assert (= res 1))
(assert (= resl_3552 2))
(assert (or (and (and (and (< resr_3554 1) (= cm_3545 0)) (= cn_3546 0)) (= Anon_3555 1)) (and (and (and (and (and (<= 0 Anon_3555) (<= (+ (- 0 cn_3546) 2) Anon_3555)) (<= Anon_3555 cn_3546)) (<= Anon_3555 2)) (<= 1 cm_3545)) (> resr_3554 0))))
(assert (or (and (and (and (< resll_3556 1) (= am_3547 0)) (= an_3548 0)) (= Anon_3557 1)) (and (and (and (and (and (<= 0 Anon_3557) (<= (+ (- 0 an_3548) 2) Anon_3557)) (<= Anon_3557 an_3548)) (<= Anon_3557 2)) (<= 1 am_3547)) (> resll_3556 0))))
(assert (or (and (and (and (< reslr_3558 1) (= bm_3549 0)) (= bn_3550 0)) (= Anon_3559 1)) (and (and (and (and (and (<= 0 Anon_3559) (<= (+ (- 0 bn_3550) 2) Anon_3559)) (<= Anon_3559 bn_3550)) (<= Anon_3559 2)) (<= 1 bm_3549)) (> reslr_3558 0))))
