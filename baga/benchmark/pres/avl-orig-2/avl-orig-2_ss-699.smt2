...
(assert (exists ((max_5080 Int)) (and (= n (+ max_5080 1)) (or (and (= max_5080 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5080 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_5079 Int)) (and (= tn (+ max_5079 1)) (or (and (= max_5079 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5079 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5081 Int)) (and (= n_3945 (+ max_5081 1)) (or (and (= max_5081 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5081 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (not (<= (+ n2_5055 0) (+ 1 n1_5051))))
(check-sat)