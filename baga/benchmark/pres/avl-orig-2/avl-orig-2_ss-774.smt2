...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5392 Int)) (= (+ resb_5392 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5391 Int)) (and (= v_int_118_5356 (+ max_5391 1)) (or (and (= max_5391 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5391 n2_5367) (< n1_5363 n2_5367))))))
...
(assert (exists ((max_5390 Int)) (and (= tn (+ max_5390 1)) (or (and (= max_5390 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5390 n2_3758) (< n1_3754 n2_3758))))))
