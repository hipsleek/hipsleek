...
(assert (exists ((max_5408 Int)) (and (= tn (+ max_5408 1)) (or (and (= max_5408 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5408 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (<= 0 n))
(assert (= n_4487 n))
(assert (exists ((resb_5410 Int)) (= (+ resb_5410 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5409 Int)) (and (= v_int_118_5356 (+ max_5409 1)) (or (and (= max_5409 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5409 n2_5367) (< n1_5363 n2_5367))))))
(assert (= n2_5367 n_4598))
(assert (= n1_5363 n_4487))
(assert (= v_int_118_5356 (+ 1 n_4598)))
;Negation of Consequence
(assert (not (or (and (= v_int_118_5356 (+ 1 n1_5363)) (<= n2_5367 n1_5363)) (and (= v_int_118_5356 (+ 1 n2_5367)) (< n1_5363 n2_5367)))))
(check-sat)