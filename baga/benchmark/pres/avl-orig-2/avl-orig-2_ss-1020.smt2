...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6080 Int)) (= (+ flted_76_6080 n2_6049) (+ 1 n1_6045))))
(assert (exists ((max_6079 Int)) (and (= v_int_118_6038 (+ max_6079 1)) (or (and (= max_6079 n1_6045) (>= n1_6045 n2_6049)) (and (= max_6079 n2_6049) (< n1_6045 n2_6049))))))
...
(assert (exists ((max_6078 Int)) (and (= tn (+ max_6078 1)) (or (and (= max_6078 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6078 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
