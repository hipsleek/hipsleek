...
(assert (<= 0 n2_4322))
(assert (= cn n2_4322))
(assert (exists ((max_4336 Int)) (and (= n_4239 (+ max_4336 1)) (or (and (= max_4336 n1_4318) (>= n1_4318 n2_4322)) (and (= max_4336 n2_4322) (< n1_4318 n2_4322))))))
(assert (<= (+ 0 n2_4322) (+ n1_4318 1)))
(assert (<= n1_4318 (+ 1 n2_4322)))
(assert (= (+ b_4240 n2_4322) (+ 1 n1_4318)))
(assert (exists ((max_4337 Int)) (and (= n (+ max_4337 1)) (or (and (= max_4337 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4337 n2_4215) (< n1_4211 n2_4215))))))
(assert (= n_4207 n))
(assert (exists ((max_4338 Int)) (and (= tn (+ max_4338 1)) (or (and (= max_4338 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4338 n2_3758) (< n1_3754 n2_3758))))))
