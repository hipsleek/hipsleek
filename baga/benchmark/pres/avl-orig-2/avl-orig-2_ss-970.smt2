...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5949 Int)) (= (+ flted_76_5949 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5948 Int)) (and (= v_int_118_5881 (+ max_5948 1)) (or (and (= max_5948 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5948 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5945 Int)) (and (= n_4239 (+ max_5945 1)) (or (and (= max_5945 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5945 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5946 Int)) (and (= n (+ max_5946 1)) (or (and (= max_5946 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5946 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5947 Int)) (and (= tn (+ max_5947 1)) (or (and (= max_5947 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5947 n2_3758) (< n1_3754 n2_3758))))))
