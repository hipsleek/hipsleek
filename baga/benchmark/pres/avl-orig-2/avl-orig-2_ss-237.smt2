...
(assert (exists ((max_3618 Int)) (and (= cn_3521 (+ max_3618 1)) (or (and (= max_3618 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3618 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (or (and (= resln_3577 (+ 1 n1_3598)) (<= n2_3602 n1_3598)) (and (= resln_3577 (+ 1 n2_3602)) (< n1_3598 n2_3602)))))
(check-sat)