...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5201 Int)) (= (+ flted_76_5201 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5200 Int)) (and (= v_int_118_5138 (+ max_5200 1)) (or (and (= max_5200 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5200 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5197 Int)) (and (= n_3945 (+ max_5197 1)) (or (and (= max_5197 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5197 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5198 Int)) (and (= n (+ max_5198 1)) (or (and (= max_5198 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5198 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_5199 Int)) (and (= tn (+ max_5199 1)) (or (and (= max_5199 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5199 n2_3758) (< n1_3754 n2_3758))))))
