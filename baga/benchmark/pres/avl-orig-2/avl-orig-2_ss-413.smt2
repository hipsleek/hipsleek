...
(declare-fun right_109_2193_primed () Int)
(declare-fun left_109_2192_primed () Int)
(declare-fun height_109_2191_primed () Int)
(declare-fun ele_109_2190_primed () Int)
(declare-fun Anon_4208 () Int)
(declare-fun v_node_109_2189_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_109_2193_primed q_4213))
(assert (= left_109_2192_primed p_4209))
(assert (= height_109_2191_primed n_4207))
(assert (= ele_109_2190_primed Anon_4208))
(assert (= v_node_109_2189_primed v_node_107_4102))
(assert (<= b_4221 2))
(assert (<= 0 b_4221))
(assert (<= 0 n_4220))
(assert (<= 0 m_4219))
