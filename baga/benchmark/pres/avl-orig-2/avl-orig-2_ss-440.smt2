...
(declare-fun n_4494 () Int)
(declare-fun b_4495 () Int)
(declare-fun m_4493 () Int)
...
(assert (<= Anon_4416 2))
(assert (= res n_4487))
(assert (= m_4493 m_4486))
(assert (= n_4494 n_4487))
(assert (= b_4495 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4493 0)) (= n_4494 0)) (= b_4495 1)) (and (and (and (and (and (<= 0 b_4495) (<= (+ (- 0 n_4494) 2) b_4495)) (<= b_4495 n_4494)) (<= b_4495 2)) (<= 1 m_4493)) (> v_node_118_2219_primed 0))))
(assert (not (= t_primed resr_4417)))
