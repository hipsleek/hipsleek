...
(assert (exists ((flted_76_5566 Int)) (= (+ flted_76_5566 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5565 Int)) (and (= v_int_118_5533 (+ max_5565 1)) (or (and (= max_5565 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5565 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5564 Int)) (and (= tn (+ max_5564 1)) (or (and (= max_5564 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5564 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
