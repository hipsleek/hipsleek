...
(declare-fun n_4653 () Int)
(declare-fun b_4654 () Int)
(declare-fun m_4652 () Int)
...
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
(assert (= v_node_118_2227_primed ss2_4433))
...
(assert (<= Anon_4434 2))
(assert (= res n_4598))
(assert (= m_4652 m_4597))
(assert (= n_4653 n_4598))
(assert (= b_4654 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4652 0)) (= n_4653 0)) (= b_4654 1)) (and (and (and (and (and (<= 0 b_4654) (<= (+ (- 0 n_4653) 2) b_4654)) (<= b_4654 n_4653)) (<= b_4654 2)) (<= 1 m_4652)) (> v_node_118_2227_primed 0))))
