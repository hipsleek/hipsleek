...
(declare-fun n_4677 () Int)
(declare-fun b_4678 () Int)
(declare-fun m_4676 () Int)
...
(assert (<= b_4108 2))
(assert (= res n_4598))
(assert (= m_4676 m_4597))
(assert (= n_4677 n_4598))
(assert (= b_4678 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4676 0)) (= n_4677 0)) (= b_4678 1)) (and (and (and (and (and (<= 0 b_4678) (<= (+ (- 0 n_4677) 2) b_4678)) (<= b_4678 n_4677)) (<= b_4678 2)) (<= 1 m_4676)) (> v_node_118_2227_primed 0))))
