...
(assert (exists ((max_4638 Int)) (and (= n (+ max_4638 1)) (or (and (= max_4638 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4638 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4637 Int)) (and (= tn (+ max_4637 1)) (or (and (= max_4637 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4637 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= bn n_3945))
(assert (= cn n_3834))
(assert (exists ((max_4639 Int)) (and (= n_4598 (+ max_4639 1)) (or (and (= max_4639 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4639 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (not (or (and (= n_4598 (+ n1_4605 1)) (<= n2_4609 n1_4605)) (and (= n_4598 (+ n2_4609 1)) (< n1_4605 n2_4609)))))
(check-sat)