...
(assert (exists ((max_5498 Int)) (and (= tn (+ max_5498 1)) (or (and (= max_5498 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5498 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (= m_4486 0) (or (= n_4487 0) (< v_node_87_3810 1)))))
(check-sat)