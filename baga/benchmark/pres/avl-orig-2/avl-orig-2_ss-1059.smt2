...
(assert (exists ((resb_6269 Int)) (= (+ resb_6269 n2_6229) (+ 1 n1_6225))))
(assert (exists ((max_6268 Int)) (and (= v_int_118_6218 (+ max_6268 1)) (or (and (= max_6268 n1_6225) (>= n1_6225 n2_6229)) (and (= max_6268 n2_6229) (< n1_6225 n2_6229))))))
(assert (= n2_6229 n_4598))
(assert (= n1_6225 n_4487))
(assert (exists ((max_6267 Int)) (and (= tn (+ max_6267 1)) (or (and (= max_6267 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6267 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_6218 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_6229 n1_6225)) (= (+ 1 tn) v_int_118_6218)) (= tn v_int_118_6218))))
(check-sat)