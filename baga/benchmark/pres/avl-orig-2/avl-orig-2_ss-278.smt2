...
(declare-fun n_3823 () Int)
(declare-fun b_3824 () Int)
(declare-fun m_3822 () Int)
...
(assert (= t_primed 1))
(assert (or (and (and (and (< v_node_89_2075_primed 1) (= m_3822 0)) (= n_3823 0)) (= b_3824 1)) (and (and (and (and (and (<= 0 b_3824) (<= (+ (- 0 n_3823) 2) b_3824)) (<= b_3824 n_3823)) (<= b_3824 2)) (<= 1 m_3822)) (> v_node_89_2075_primed 0))))
