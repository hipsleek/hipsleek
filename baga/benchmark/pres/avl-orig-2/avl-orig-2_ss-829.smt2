...
(assert (exists ((max_79 Int)) (and (= v_int_118_5414 (+ max_79 1)) (or (and (= max_79 n1_5421) (>= n1_5421 n2_5425)) (and (= max_79 n2_5425) (< n1_5421 n2_5425))))))
(assert (exists ((flted_76_5415 Int)) (= (+ flted_76_5415 n2_5425) (+ 1 n1_5421))))
(assert (= (+ n2_5425 1) (+ n1_5421 1)))
(assert (= v_int_118_5414 1))
(assert (or (and (= v_int_118_5414 (+ 1 n1_5421)) (<= n2_5425 n1_5421)) (and (= v_int_118_5414 (+ 1 n2_5425)) (< n1_5421 n2_5425))))
