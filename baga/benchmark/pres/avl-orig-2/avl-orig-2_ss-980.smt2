...
(assert (exists ((max_6065 Int)) (and (= tn (+ max_6065 1)) (or (and (= max_6065 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6065 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_6038 (+ 1 n1_6045)) (<= n2_6049 n1_6045)) (and (= v_int_118_6038 (+ 1 n2_6049)) (< n1_6045 n2_6049)))))
(check-sat)