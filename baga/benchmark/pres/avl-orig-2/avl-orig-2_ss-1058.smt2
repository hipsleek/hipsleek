...
(assert (exists ((resb_6266 Int)) (= (+ resb_6266 n2_6229) (+ 1 n1_6225))))
(assert (exists ((max_6265 Int)) (and (= v_int_118_6218 (+ max_6265 1)) (or (and (= max_6265 n1_6225) (>= n1_6225 n2_6229)) (and (= max_6265 n2_6229) (< n1_6225 n2_6229))))))
...
(assert (exists ((max_6264 Int)) (and (= tn (+ max_6264 1)) (or (and (= max_6264 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6264 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
