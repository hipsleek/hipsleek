...
(declare-fun right_203_1686_primed () Int)
(declare-fun left_203_1685_primed () Int)
(declare-fun height_203_1684_primed () Int)
(declare-fun ele_203_1683_primed () Int)
(declare-fun Anon_44 () Int)
(declare-fun v_int_203_1690_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_203_1686_primed r))
(assert (= left_203_1685_primed lr))
(assert (= height_203_1684_primed v_int_202_2659))
(assert (= ele_203_1683_primed Anon_44))
(assert (<= b_2665 2))
(assert (<= 0 b_2665))
(assert (<= 0 n_2664))
(assert (<= 0 m_2663))
(assert (= v_int_203_1690_primed n_2664))
(assert (<= Anon_49 2))
(assert (<= 0 Anon_49))
(assert (<= 0 an))
(assert (<= 0 am))
