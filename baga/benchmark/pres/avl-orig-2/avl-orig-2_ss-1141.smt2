...
(assert (exists ((max_6373 Int)) (and (= tn (+ max_6373 1)) (or (and (= max_6373 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6373 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= n_4598 n))
(assert (exists ((resb_6375 Int)) (= (+ resb_6375 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6374 Int)) (and (= v_int_118_6337 (+ max_6374 1)) (or (and (= max_6374 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6374 n2_6348) (< n1_6344 n2_6348))))))
