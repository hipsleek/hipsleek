...
(assert (exists ((max_6388 Int)) (and (= tn (+ max_6388 1)) (or (and (= max_6388 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6388 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= n_4598 n))
(assert (exists ((resb_6390 Int)) (= (+ resb_6390 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6389 Int)) (and (= v_int_118_6337 (+ max_6389 1)) (or (and (= max_6389 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6389 n2_6348) (< n1_6344 n2_6348))))))
