...
(assert (exists ((flted_76_5979 Int)) (= (+ flted_76_5979 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5978 Int)) (and (= v_int_118_5881 (+ max_5978 1)) (or (and (= max_5978 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5978 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5975 Int)) (and (= n_4239 (+ max_5975 1)) (or (and (= max_5975 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5975 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5976 Int)) (and (= n (+ max_5976 1)) (or (and (= max_5976 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5976 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5977 Int)) (and (= tn (+ max_5977 1)) (or (and (= max_5977 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5977 n2_3758) (< n1_3754 n2_3758))))))
