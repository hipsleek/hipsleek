...
(assert (exists ((max_3281 Int)) (and (= an_3256 (+ max_3281 1)) (or (and (= max_3281 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3281 n2_3269) (< n1_3265 n2_3269))))))
...
(assert (not (= (+ n2_3269 Anon_49) (+ n1_3265 1))))
(check-sat)