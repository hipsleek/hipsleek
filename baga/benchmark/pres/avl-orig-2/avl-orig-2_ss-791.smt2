...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5453 Int)) (= (+ flted_76_5453 n2_5425) (+ 1 n1_5421))))
(assert (exists ((max_5452 Int)) (and (= v_int_118_5414 (+ max_5452 1)) (or (and (= max_5452 n1_5421) (>= n1_5421 n2_5425)) (and (= max_5452 n2_5425) (< n1_5421 n2_5425))))))
...
(assert (exists ((max_5451 Int)) (and (= tn (+ max_5451 1)) (or (and (= max_5451 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5451 n2_3758) (< n1_3754 n2_3758))))))
