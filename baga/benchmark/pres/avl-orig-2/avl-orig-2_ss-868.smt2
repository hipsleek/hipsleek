...
(assert (= Anon_5606 b_4599))
(assert (exists ((max_79 Int)) (and (= v_int_118_5594 (+ max_79 1)) (or (and (= max_79 n1_5601) (>= n1_5601 n2_5605)) (and (= max_79 n2_5605) (< n1_5601 n2_5605))))))
(assert (exists ((resb_5597 Int)) (= (+ resb_5597 n2_5605) (+ 1 n1_5601))))
