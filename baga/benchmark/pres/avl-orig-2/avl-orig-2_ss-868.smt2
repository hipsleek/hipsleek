...
(assert (exists ((flted_76_5578 Int)) (= (+ flted_76_5578 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5577 Int)) (and (= v_int_118_5533 (+ max_5577 1)) (or (and (= max_5577 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5577 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5576 Int)) (and (= tn (+ max_5576 1)) (or (and (= max_5576 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5576 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
