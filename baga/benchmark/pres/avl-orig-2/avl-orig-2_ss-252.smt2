...
(assert (or (and (and (and (< v_node_87_2063_primed 1) (= flted_76_3801 0)) (= flted_76_3800 0)) (= flted_76_3799 1)) (and (and (and (and (and (<= 0 flted_76_3799) (<= (+ (- 0 flted_76_3800) 2) flted_76_3799)) (<= flted_76_3799 flted_76_3800)) (<= flted_76_3799 2)) (<= 1 flted_76_3801)) (> v_node_87_2063_primed 0))))
