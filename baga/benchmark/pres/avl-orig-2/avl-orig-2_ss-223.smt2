...
(assert (<= cn (+ dn 1)))
(assert (= am_3459 bm))
(assert (exists ((Anon_3621 Int)) (= (+ Anon_3621 n2_3602) (+ 1 n1_3598))))
...
(assert (exists ((max_3620 Int)) (and (= resln_3577 (+ max_3620 1)) (or (and (= max_3620 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3620 n2_3602) (< n1_3598 n2_3602))))))
(assert (<= 0 cn_3521))
(assert (<= 0 cm_3520))
(assert (or (and (= tmp2_3576 resln_3577) (>= resln_3577 cn_3521)) (and (= tmp2_3576 cn_3521) (< resln_3577 cn_3521))))
(assert (= resrn_3512 cn_3521))
(assert (exists ((max_3619 Int)) (and (= cn_3521 (+ max_3619 1)) (or (and (= max_3619 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3619 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (or (= cm_3520 0) (or (= cn_3521 0) (< resr_3568 1)))))
(check-sat)