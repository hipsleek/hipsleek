...
(assert (exists ((resb_6031 Int)) (= (+ resb_6031 n2_5991) (+ 1 n1_5987))))
(assert (exists ((max_6030 Int)) (and (= v_int_118_5980 (+ max_6030 1)) (or (and (= max_6030 n1_5987) (>= n1_5987 n2_5991)) (and (= max_6030 n2_5991) (< n1_5987 n2_5991))))))
(assert (= n2_5991 n_4598))
(assert (= n1_5987 n_4487))
(assert (exists ((max_6029 Int)) (and (= tn (+ max_6029 1)) (or (and (= max_6029 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6029 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_5980 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5991 n1_5987)) (= (+ 1 tn) v_int_118_5980)) (= tn v_int_118_5980))))
(check-sat)