...
(assert (<= 0 n2_4322))
(assert (= cn n2_4322))
(assert (exists ((max_4339 Int)) (and (= n_4239 (+ max_4339 1)) (or (and (= max_4339 n1_4318) (>= n1_4318 n2_4322)) (and (= max_4339 n2_4322) (< n1_4318 n2_4322))))))
(assert (<= (+ 0 n2_4322) (+ n1_4318 1)))
(assert (<= n1_4318 (+ 1 n2_4322)))
(assert (= (+ b_4240 n2_4322) (+ 1 n1_4318)))
(assert (exists ((max_4340 Int)) (and (= n (+ max_4340 1)) (or (and (= max_4340 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4340 n2_4215) (< n1_4211 n2_4215))))))
(assert (= n_4207 n))
(assert (exists ((max_4341 Int)) (and (= tn (+ max_4341 1)) (or (and (= max_4341 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4341 n2_3758) (< n1_3754 n2_3758))))))
