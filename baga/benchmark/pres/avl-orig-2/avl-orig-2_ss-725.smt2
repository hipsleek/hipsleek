...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5196 Int)) (= (+ flted_76_5196 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5195 Int)) (and (= v_int_118_5138 (+ max_5195 1)) (or (and (= max_5195 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5195 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5192 Int)) (and (= n_3945 (+ max_5192 1)) (or (and (= max_5192 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5192 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5193 Int)) (and (= n (+ max_5193 1)) (or (and (= max_5193 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5193 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_5194 Int)) (and (= tn (+ max_5194 1)) (or (and (= max_5194 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5194 n2_3758) (< n1_3754 n2_3758))))))
