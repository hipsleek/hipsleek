...
(assert (exists ((resb_4909 Int)) (= (+ resb_4909 n2_4862) (+ 1 n1_4858))))
(assert (exists ((max_4908 Int)) (and (= v_int_118_4851 (+ max_4908 1)) (or (and (= max_4908 n1_4858) (>= n1_4858 n2_4862)) (and (= max_4908 n2_4862) (< n1_4858 n2_4862))))))
(assert (= Anon_4863 b_4599))
(assert (= n2_4862 n_4598))
(assert (exists ((max_4907 Int)) (and (= n_4598 (+ max_4907 1)) (or (and (= max_4907 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4907 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4906 Int)) (and (= n (+ max_4906 1)) (or (and (= max_4906 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4906 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4905 Int)) (and (= tn (+ max_4905 1)) (or (and (= max_4905 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4905 n2_3758) (< n1_3754 n2_3758))))))
