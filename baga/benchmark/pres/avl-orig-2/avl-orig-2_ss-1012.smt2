...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6132 Int)) (= (+ resb_6132 n2_6110) (+ 1 n1_6106))))
(assert (exists ((max_6131 Int)) (and (= v_int_118_6099 (+ max_6131 1)) (or (and (= max_6131 n1_6106) (>= n1_6106 n2_6110)) (and (= max_6131 n2_6110) (< n1_6106 n2_6110))))))
...
(assert (exists ((max_6130 Int)) (and (= tn (+ max_6130 1)) (or (and (= max_6130 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6130 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
