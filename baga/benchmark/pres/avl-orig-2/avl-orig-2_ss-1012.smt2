...
(assert (exists ((max_6063 Int)) (and (= tn (+ max_6063 1)) (or (and (= max_6063 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6063 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6049 0) (+ 1 n1_6045))))
(check-sat)