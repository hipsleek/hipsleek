...
(declare-fun right_150_1930_primed () Int)
(declare-fun left_150_1929_primed () Int)
(declare-fun height_150_1928_primed () Int)
(declare-fun Anon_19 () Int)
(declare-fun ele_150_1927_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_150_1930_primed d))
(assert (= left_150_1929_primed k1))
(assert (= height_150_1928_primed Anon_19))
(assert (= ele_150_1927_primed Anon_18))
(assert (= k3_primed k3))
(assert (<= bn (+ an 1)))
(assert (<= an (+ bn 1)))
(assert (<= cn (+ dn 1)))
