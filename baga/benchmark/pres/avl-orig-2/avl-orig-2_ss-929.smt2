...
(assert (exists ((max_5923 Int)) (and (= n (+ max_5923 1)) (or (and (= max_5923 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5923 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_5922 Int)) (and (= tn (+ max_5922 1)) (or (and (= max_5922 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5922 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5924 Int)) (and (= n_4239 (+ max_5924 1)) (or (and (= max_5924 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5924 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
...
(assert (not (or (and (= v_int_118_5881 (+ 1 n1_5888)) (<= n2_5892 n1_5888)) (and (= v_int_118_5881 (+ 1 n2_5892)) (< n1_5888 n2_5892)))))
(check-sat)