...
(assert (exists ((resb_5514 Int)) (= (+ resb_5514 n2_5486) (+ 1 n1_5482))))
(assert (exists ((max_5513 Int)) (and (= v_int_118_5475 (+ max_5513 1)) (or (and (= max_5513 n1_5482) (>= n1_5482 n2_5486)) (and (= max_5513 n2_5486) (< n1_5482 n2_5486))))))
...
(assert (exists ((max_5512 Int)) (and (= tn (+ max_5512 1)) (or (and (= max_5512 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5512 n2_3758) (< n1_3754 n2_3758))))))
