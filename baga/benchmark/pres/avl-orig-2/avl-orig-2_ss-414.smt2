...
(assert (exists ((max_4243 Int)) (and (= tn (+ max_4243 1)) (or (and (= max_4243 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4243 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4244 Int)) (and (= n (+ max_4244 1)) (or (and (= max_4244 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4244 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (or (= m1_4210 0) (or (= n1_4211 0) (< p_4209 1)))))
(check-sat)