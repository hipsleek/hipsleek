...
(declare-fun flted_76_3784 () Int)
(declare-fun flted_76_3783 () Int)
(declare-fun flted_76_3785 () Int)
(declare-fun res () Int)
...
(assert (<= 0 Anon_3755))
(assert (<= Anon_3755 2))
(assert (= flted_76_3785 1))
(assert (= flted_76_3784 1))
(assert (= flted_76_3783 1))
(assert (= tn_3773 0))
(assert (= tm_3772 0))
(assert (< v_node_87_2062_primed 1))
(assert (<= 0 tm_3772))
(assert (<= 0 tn_3773))
(assert (<= 0 b_3774))
(assert (<= b_3774 2))
...
(assert (or (and (and (and (< res 1) (= flted_76_3785 0)) (= flted_76_3784 0)) (= flted_76_3783 1)) (and (and (and (and (and (<= 0 flted_76_3783) (<= (+ (- 0 flted_76_3784) 2) flted_76_3783)) (<= flted_76_3783 flted_76_3784)) (<= flted_76_3783 2)) (<= 1 flted_76_3785)) (> res 0))))
