...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6193 Int)) (= (+ flted_76_6193 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6192 Int)) (and (= v_int_118_6157 (+ max_6192 1)) (or (and (= max_6192 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6192 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6191 Int)) (and (= tn (+ max_6191 1)) (or (and (= max_6191 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6191 n2_3758) (< n1_3754 n2_3758))))))
