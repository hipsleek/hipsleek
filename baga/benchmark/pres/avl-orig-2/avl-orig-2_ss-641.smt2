...
(assert (exists ((flted_76_5003 Int)) (= (+ flted_76_5003 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5002 Int)) (and (= v_int_118_4945 (+ max_5002 1)) (or (and (= max_5002 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5002 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5001 Int)) (and (= n_4598 (+ max_5001 1)) (or (and (= max_5001 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5001 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5000 Int)) (and (= n (+ max_5000 1)) (or (and (= max_5000 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5000 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4999 Int)) (and (= tn (+ max_4999 1)) (or (and (= max_4999 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4999 n2_3758) (< n1_3754 n2_3758))))))
