...
(assert (exists ((resb_5657 Int)) (= (+ resb_5657 n2_5605) (+ 1 n1_5601))))
(assert (exists ((max_5656 Int)) (and (= v_int_118_5594 (+ max_5656 1)) (or (and (= max_5656 n1_5601) (>= n1_5601 n2_5605)) (and (= max_5656 n2_5605) (< n1_5601 n2_5605))))))
(assert (= Anon_5602 b_4488))
(assert (= n1_5601 n_4487))
(assert (exists ((max_5655 Int)) (and (= n_4487 (+ max_5655 1)) (or (and (= max_5655 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5655 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5654 Int)) (and (= n (+ max_5654 1)) (or (and (= max_5654 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5654 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5653 Int)) (and (= tn (+ max_5653 1)) (or (and (= max_5653 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5653 n2_3758) (< n1_3754 n2_3758))))))
