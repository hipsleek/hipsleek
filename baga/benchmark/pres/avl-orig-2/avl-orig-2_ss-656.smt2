...
(assert (exists ((max_4931 Int)) (and (= n (+ max_4931 1)) (or (and (= max_4931 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4931 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4932 Int)) (and (= n_4598 (+ max_4932 1)) (or (and (= max_4932 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4932 n2_4609) (< n1_4605 n2_4609))))))
(assert (exists ((resb_4934 Int)) (= (+ resb_4934 n2_4862) (+ 1 n1_4858))))
(assert (exists ((max_4933 Int)) (and (= v_int_118_4851 (+ max_4933 1)) (or (and (= max_4933 n1_4858) (>= n1_4858 n2_4862)) (and (= max_4933 n2_4862) (< n1_4858 n2_4862))))))
(assert (= n2_4862 n_4598))
(assert (= n1_4858 n_4487))
(assert (exists ((max_4930 Int)) (and (= tn (+ max_4930 1)) (or (and (= max_4930 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4930 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_4851 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_4862 n1_4858)) (= (+ 1 tn) v_int_118_4851)) (= tn v_int_118_4851))))
(check-sat)