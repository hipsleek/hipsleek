...
(assert (exists ((Anon_3417 Int)) (= (+ Anon_3417 n2_3344) (+ 1 n1_3340))))
(assert (exists ((max_3416 Int)) (and (= resrn_3315 (+ max_3416 1)) (or (and (= max_3416 n1_3340) (>= n1_3340 n2_3344)) (and (= max_3416 n2_3344) (< n1_3340 n2_3344))))))
...
(assert (exists ((max_3415 Int)) (and (= an_3256 (+ max_3415 1)) (or (and (= max_3415 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3415 n2_3269) (< n1_3265 n2_3269))))))
(assert (<= 0 an_3256))
;Negation of Consequence
(assert (not (or (and (= (+ an_3256 1) resn_3313) (< resrn_3315 resn_3313)) (and (= (+ resrn_3315 1) resn_3313) (<= (+ an_3256 2) resn_3313)))))
(check-sat)