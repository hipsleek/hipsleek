...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5331 Int)) (= (+ flted_76_5331 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5330 Int)) (and (= v_int_118_5295 (+ max_5330 1)) (or (and (= max_5330 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5330 n2_5306) (< n1_5302 n2_5306))))))
...
(assert (exists ((max_5329 Int)) (and (= tn (+ max_5329 1)) (or (and (= max_5329 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5329 n2_3758) (< n1_3754 n2_3758))))))
