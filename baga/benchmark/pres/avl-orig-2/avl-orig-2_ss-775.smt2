...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5395 Int)) (= (+ resb_5395 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5394 Int)) (and (= v_int_118_5356 (+ max_5394 1)) (or (and (= max_5394 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5394 n2_5367) (< n1_5363 n2_5367))))))
...
(assert (exists ((max_5393 Int)) (and (= tn (+ max_5393 1)) (or (and (= max_5393 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5393 n2_3758) (< n1_3754 n2_3758))))))
