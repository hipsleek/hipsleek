...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5762 Int)) (and (= tn (+ max_5762 1)) (or (and (= max_5762 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5762 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((flted_76_5766 Int)) (= (+ flted_76_5766 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5765 Int)) (and (= v_int_118_5688 (+ max_5765 1)) (or (and (= max_5765 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5765 n2_5699) (< n1_5695 n2_5699))))))
...
(assert (exists ((max_5764 Int)) (and (= n_4487 (+ max_5764 1)) (or (and (= max_5764 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5764 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5763 Int)) (and (= n (+ max_5763 1)) (or (and (= max_5763 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5763 n2_4215) (< n1_4211 n2_4215))))))
