...
(assert (exists ((flted_76_5771 Int)) (= (+ flted_76_5771 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5770 Int)) (and (= v_int_118_5688 (+ max_5770 1)) (or (and (= max_5770 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5770 n2_5699) (< n1_5695 n2_5699))))))
(assert (= Anon_5696 b_4488))
(assert (= n1_5695 n_4487))
(assert (exists ((max_5769 Int)) (and (= n_4487 (+ max_5769 1)) (or (and (= max_5769 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5769 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5768 Int)) (and (= n (+ max_5768 1)) (or (and (= max_5768 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5768 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5767 Int)) (and (= tn (+ max_5767 1)) (or (and (= max_5767 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5767 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
