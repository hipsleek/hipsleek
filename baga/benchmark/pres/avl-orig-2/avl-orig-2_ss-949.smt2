...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5845 Int)) (= (+ resb_5845 n2_5798) (+ 1 n1_5794))))
(assert (exists ((max_5844 Int)) (and (= v_int_118_5787 (+ max_5844 1)) (or (and (= max_5844 n1_5794) (>= n1_5794 n2_5798)) (and (= max_5844 n2_5798) (< n1_5794 n2_5798))))))
...
(assert (exists ((max_5841 Int)) (and (= n_4239 (+ max_5841 1)) (or (and (= max_5841 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5841 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5842 Int)) (and (= n (+ max_5842 1)) (or (and (= max_5842 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5842 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_5843 Int)) (and (= tn (+ max_5843 1)) (or (and (= max_5843 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5843 n2_3758) (< n1_3754 n2_3758))))))
