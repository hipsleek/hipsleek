...
(assert (exists ((flted_76_5008 Int)) (= (+ flted_76_5008 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5007 Int)) (and (= v_int_118_4945 (+ max_5007 1)) (or (and (= max_5007 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5007 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5006 Int)) (and (= n_4598 (+ max_5006 1)) (or (and (= max_5006 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5006 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5005 Int)) (and (= n (+ max_5005 1)) (or (and (= max_5005 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5005 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_5004 Int)) (and (= tn (+ max_5004 1)) (or (and (= max_5004 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5004 n2_3758) (< n1_3754 n2_3758))))))
