...
(assert (exists ((flted_76_5969 Int)) (= (+ flted_76_5969 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5968 Int)) (and (= v_int_118_5881 (+ max_5968 1)) (or (and (= max_5968 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5968 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5965 Int)) (and (= n_4239 (+ max_5965 1)) (or (and (= max_5965 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5965 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5966 Int)) (and (= n (+ max_5966 1)) (or (and (= max_5966 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5966 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_5967 Int)) (and (= tn (+ max_5967 1)) (or (and (= max_5967 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5967 n2_3758) (< n1_3754 n2_3758))))))
