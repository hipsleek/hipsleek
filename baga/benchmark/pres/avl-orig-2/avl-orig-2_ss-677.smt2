...
(assert (exists ((flted_76_5033 Int)) (= (+ flted_76_5033 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5032 Int)) (and (= v_int_118_4945 (+ max_5032 1)) (or (and (= max_5032 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5032 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5031 Int)) (and (= n_4598 (+ max_5031 1)) (or (and (= max_5031 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5031 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5030 Int)) (and (= n (+ max_5030 1)) (or (and (= max_5030 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5030 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_5029 Int)) (and (= tn (+ max_5029 1)) (or (and (= max_5029 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5029 n2_3758) (< n1_3754 n2_3758))))))
