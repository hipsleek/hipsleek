...
(assert (exists ((max_5500 Int)) (and (= tn (+ max_5500 1)) (or (and (= max_5500 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5500 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5486 0) (+ 1 n1_5482))))
(check-sat)