...
(assert (exists ((max_4979 Int)) (and (= tn (+ max_4979 1)) (or (and (= max_4979 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4979 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4978 Int)) (and (= n (+ max_4978 1)) (or (and (= max_4978 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4978 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4977 Int)) (and (= n_4598 (+ max_4977 1)) (or (and (= max_4977 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4977 n2_4609) (< n1_4605 n2_4609))))))
