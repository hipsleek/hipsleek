...
;Axioms assertions
;Antecedent
(assert (= right_118_2242_primed resr_4417))
(assert (= left_118_2241_primed resl_4415))
(assert (= height_118_2240_primed resn_4424))
(assert (= ele_118_2239_primed Anon_4414))
