...
(declare-fun n_3933 () Int)
(declare-fun b_3934 () Int)
(declare-fun m_3932 () Int)
(declare-fun v_node_90_2106_primed () Int)
...
(assert (<= b_3835 2))
(assert (= (+ 2 n_3834) n))
(assert (= v_node_90_2106_primed p_3915))
...
(assert (<= Anon_3918 2))
(assert (= res n_3926))
(assert (= m_3932 m_3925))
(assert (= n_3933 n_3926))
(assert (= b_3934 b_3927))
(assert (<= 0 m_3925))
(assert (<= 0 n_3926))
(assert (<= 0 b_3927))
(assert (<= b_3927 2))
...
(assert (or (and (and (and (< v_node_90_2106_primed 1) (= m_3932 0)) (= n_3933 0)) (= b_3934 1)) (and (and (and (and (and (<= 0 b_3934) (<= (+ (- 0 n_3933) 2) b_3934)) (<= b_3934 n_3933)) (<= b_3934 2)) (<= 1 m_3932)) (> v_node_90_2106_primed 0))))
