...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5206 Int)) (= (+ flted_76_5206 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5205 Int)) (and (= v_int_118_5138 (+ max_5205 1)) (or (and (= max_5205 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5205 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5202 Int)) (and (= n_3945 (+ max_5202 1)) (or (and (= max_5202 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5202 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5203 Int)) (and (= n (+ max_5203 1)) (or (and (= max_5203 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5203 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5204 Int)) (and (= tn (+ max_5204 1)) (or (and (= max_5204 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5204 n2_3758) (< n1_3754 n2_3758))))))
