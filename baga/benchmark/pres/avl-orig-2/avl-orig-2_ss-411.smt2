...
(assert (exists ((max_4261 Int)) (and (= tn (+ max_4261 1)) (or (and (= max_4261 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4261 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4262 Int)) (and (= n (+ max_4262 1)) (or (and (= max_4262 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4262 n2_4215) (< n1_4211 n2_4215))))))
