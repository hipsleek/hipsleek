...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6211 Int)) (= (+ flted_76_6211 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6210 Int)) (and (= v_int_118_6157 (+ max_6210 1)) (or (and (= max_6210 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6210 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6209 Int)) (and (= tn (+ max_6209 1)) (or (and (= max_6209 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6209 n2_3758) (< n1_3754 n2_3758))))))
