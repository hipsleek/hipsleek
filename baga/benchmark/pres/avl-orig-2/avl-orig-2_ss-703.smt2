...
(assert (exists ((flted_76_5236 Int)) (= (+ flted_76_5236 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5235 Int)) (and (= v_int_118_5138 (+ max_5235 1)) (or (and (= max_5235 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5235 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5232 Int)) (and (= n_3945 (+ max_5232 1)) (or (and (= max_5232 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5232 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5233 Int)) (and (= n (+ max_5233 1)) (or (and (= max_5233 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5233 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5234 Int)) (and (= tn (+ max_5234 1)) (or (and (= max_5234 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5234 n2_3758) (< n1_3754 n2_3758))))))
