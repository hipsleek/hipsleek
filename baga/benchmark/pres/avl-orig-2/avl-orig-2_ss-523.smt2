...
(declare-fun n_4673 () Int)
(declare-fun b_4674 () Int)
(declare-fun m_4672 () Int)
...
(assert (<= Anon_4466 2))
(assert (= res n_4598))
(assert (= m_4672 m_4597))
(assert (= n_4673 n_4598))
(assert (= b_4674 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4672 0)) (= n_4673 0)) (= b_4674 1)) (and (and (and (and (and (<= 0 b_4674) (<= (+ (- 0 n_4673) 2) b_4674)) (<= b_4674 n_4673)) (<= b_4674 2)) (<= 1 m_4672)) (> v_node_118_2227_primed 0))))
