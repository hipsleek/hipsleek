...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6202 Int)) (= (+ flted_76_6202 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6201 Int)) (and (= v_int_118_6157 (+ max_6201 1)) (or (and (= max_6201 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6201 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6200 Int)) (and (= tn (+ max_6200 1)) (or (and (= max_6200 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6200 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
