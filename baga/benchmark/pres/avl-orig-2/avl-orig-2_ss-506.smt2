...
(declare-fun right_118_2223_primed () Int)
(declare-fun left_118_2222_primed () Int)
(declare-fun height_118_2221_primed () Int)
(declare-fun ele_118_2220_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_118_2223_primed v_node_107_4102))
(assert (= left_118_2222_primed p_3752))
(assert (= height_118_2221_primed n_3750))
(assert (= ele_118_2220_primed Anon_3751))
(assert (<= b_4488 2))
(assert (<= 0 b_4488))
(assert (<= 0 n_4487))
(assert (<= 0 m_4486))
