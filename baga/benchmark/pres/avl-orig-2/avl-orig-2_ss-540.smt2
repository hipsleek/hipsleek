...
(assert (exists ((max_4670 Int)) (and (= n (+ max_4670 1)) (or (and (= max_4670 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4670 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (exists ((max_4671 Int)) (and (= tn (+ max_4671 1)) (or (and (= max_4671 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4671 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4669 Int)) (and (= n_4239 (+ max_4669 1)) (or (and (= max_4669 n1_4318) (>= n1_4318 n2_4322)) (and (= max_4669 n2_4322) (< n1_4318 n2_4322))))))
...
(assert (not (or (= flted_175_4460 0) (or (= h2_4471 0) (< ss3_4465 1)))))
(check-sat)