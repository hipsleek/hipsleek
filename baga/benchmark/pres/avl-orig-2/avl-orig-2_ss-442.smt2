...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_4335 Int)) (and (= tn (+ max_4335 1)) (or (and (= max_4335 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4335 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4333 Int)) (and (= n_4239 (+ max_4333 1)) (or (and (= max_4333 n1_4318) (>= n1_4318 n2_4322)) (and (= max_4333 n2_4322) (< n1_4318 n2_4322))))))
...
(assert (exists ((max_4334 Int)) (and (= n (+ max_4334 1)) (or (and (= max_4334 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4334 n2_4215) (< n1_4211 n2_4215))))))
