...
(declare-fun Anon_5307 () Int)
(declare-fun n2_5306 () Int)
(declare-fun m2_5305 () Int)
(declare-fun Anon_5303 () Int)
(declare-fun n1_5302 () Int)
(declare-fun m1_5301 () Int)
...
(assert (< 0 tm_3772))
(assert (<= 0 m1_3753))
(assert (exists ((flted_76_5355 Int)) (= (+ flted_76_5355 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5354 Int)) (and (= v_int_118_5295 (+ max_5354 1)) (or (and (= max_5354 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5354 n2_5306) (< n1_5302 n2_5306))))))
(assert (= Anon_5307 b_4599))
(assert (= n2_5306 n_4598))
(assert (= m2_5305 m_4597))
(assert (= Anon_5303 b_4488))
(assert (= n1_5302 n_4487))
(assert (= m1_5301 m_4486))
...
(assert (exists ((max_5353 Int)) (and (= tn (+ max_5353 1)) (or (and (= max_5353 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5353 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
