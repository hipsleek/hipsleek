...
(declare-fun right_108_2157_primed () Int)
(declare-fun left_108_2156_primed () Int)
(declare-fun height_108_2155_primed () Int)
(declare-fun ele_108_2154_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_108_2157_primed v_node_107_4102))
(assert (= left_108_2156_primed p_3752))
(assert (= height_108_2155_primed n_3750))
(assert (= ele_108_2154_primed Anon_3751))
(assert (<= b_4108 2))
(assert (<= 0 b_4108))
(assert (<= 0 n))
(assert (<= 0 m))
