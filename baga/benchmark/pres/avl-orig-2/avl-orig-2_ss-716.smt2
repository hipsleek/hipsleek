...
(assert (exists ((max_5168 Int)) (and (= n (+ max_5168 1)) (or (and (= max_5168 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5168 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (exists ((max_5167 Int)) (and (= tn (+ max_5167 1)) (or (and (= max_5167 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5167 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5169 Int)) (and (= n_3945 (+ max_5169 1)) (or (and (= max_5169 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5169 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (not (or (= m_4486 0) (or (= n_4487 0) (< ss1_4431 1)))))
(check-sat)