...
(assert (exists ((max_79 Int)) (and (= v_int_83_4745 (+ max_79 1)) (or (and (= max_79 n1_4753) (>= n1_4753 n2_4757)) (and (= max_79 n2_4757) (< n1_4753 n2_4757))))))
(assert (exists ((resb_4749 Int)) (= (+ resb_4749 n2_4757) (+ 1 n1_4753))))
