...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5191 Int)) (= (+ flted_76_5191 n2_5149) (+ 1 n1_5145))))
(assert (exists ((max_5190 Int)) (and (= v_int_118_5138 (+ max_5190 1)) (or (and (= max_5190 n1_5145) (>= n1_5145 n2_5149)) (and (= max_5190 n2_5149) (< n1_5145 n2_5149))))))
...
(assert (exists ((max_5187 Int)) (and (= n_3945 (+ max_5187 1)) (or (and (= max_5187 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5187 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5188 Int)) (and (= n (+ max_5188 1)) (or (and (= max_5188 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5188 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5189 Int)) (and (= tn (+ max_5189 1)) (or (and (= max_5189 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5189 n2_3758) (< n1_3754 n2_3758))))))
