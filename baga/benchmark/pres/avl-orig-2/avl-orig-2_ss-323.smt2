...
(assert (exists ((max_3992 Int)) (and (= tn (+ max_3992 1)) (or (and (= max_3992 n1_3754) (>= n1_3754 n2_3758)) (and (= max_3992 n2_3758) (< n1_3754 n2_3758))))))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (= n_3913 n))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (exists ((max_3993 Int)) (and (= n (+ max_3993 1)) (or (and (= max_3993 n1_3917) (>= n1_3917 n2_3921)) (and (= max_3993 n2_3921) (< n1_3917 n2_3921))))))
