...
(assert (exists ((max_5129 Int)) (and (= n (+ max_5129 1)) (or (and (= max_5129 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5129 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_5130 Int)) (and (= tn (+ max_5130 1)) (or (and (= max_5130 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5130 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5128 Int)) (and (= n_3945 (+ max_5128 1)) (or (and (= max_5128 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5128 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (exists ((resb_5132 Int)) (= (+ resb_5132 n2_5055) (+ 1 n1_5051))))
(assert (exists ((max_5131 Int)) (and (= v_int_118_5044 (+ max_5131 1)) (or (and (= max_5131 n1_5051) (>= n1_5051 n2_5055)) (and (= max_5131 n2_5055) (< n1_5051 n2_5055))))))
