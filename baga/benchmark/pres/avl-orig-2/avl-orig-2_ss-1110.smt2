...
(assert (exists ((max_6397 Int)) (and (= tn (+ max_6397 1)) (or (and (= max_6397 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6397 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((resb_6399 Int)) (= (+ resb_6399 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6398 Int)) (and (= v_int_118_6337 (+ max_6398 1)) (or (and (= max_6398 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6398 n2_6348) (< n1_6344 n2_6348))))))
(assert (= n2_6348 n_4598))
(assert (= v_int_118_6337 (+ 1 n_4598)))
(assert (= n1_6344 0))
;Negation of Consequence
(assert (not (or (and (= v_int_118_6337 (+ 1 n1_6344)) (<= n2_6348 n1_6344)) (and (= v_int_118_6337 (+ 1 n2_6348)) (< n1_6344 n2_6348)))))
(check-sat)