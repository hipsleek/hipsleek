...
(assert (exists ((Anon_3642 Int)) (= (+ Anon_3642 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3641 Int)) (and (= resln_3577 (+ max_3641 1)) (or (and (= max_3641 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3641 n2_3602) (< n1_3598 n2_3602))))))
...
(assert (<= 0 cn_3521))
(assert (exists ((max_3640 Int)) (and (= cn_3521 (+ max_3640 1)) (or (and (= max_3640 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3640 n2_3532) (< n1_3528 n2_3532))))))
