...
(declare-fun n_4138 () Int)
(declare-fun b_4139 () Int)
(declare-fun m_4137 () Int)
...
(assert (<= Anon_3755 2))
(assert (= res n_4128))
(assert (= m_4137 m_4127))
(assert (= n_4138 n_4128))
(assert (= b_4139 b_4129))
(assert (<= 0 m_4127))
(assert (<= 0 n_4128))
(assert (<= 0 b_4129))
(assert (<= b_4129 2))
...
(assert (or (and (and (and (< v_node_108_2161_primed 1) (= m_4137 0)) (= n_4138 0)) (= b_4139 1)) (and (and (and (and (and (<= 0 b_4139) (<= (+ (- 0 n_4138) 2) b_4139)) (<= b_4139 n_4138)) (<= b_4139 2)) (<= 1 m_4137)) (> v_node_108_2161_primed 0))))
