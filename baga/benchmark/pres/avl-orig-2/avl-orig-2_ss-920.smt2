...
(assert (exists ((flted_76_5776 Int)) (= (+ flted_76_5776 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5775 Int)) (and (= v_int_118_5688 (+ max_5775 1)) (or (and (= max_5775 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5775 n2_5699) (< n1_5695 n2_5699))))))
(assert (= Anon_5696 b_4488))
(assert (= n1_5695 n_4487))
(assert (exists ((max_5774 Int)) (and (= n_4487 (+ max_5774 1)) (or (and (= max_5774 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5774 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5773 Int)) (and (= n (+ max_5773 1)) (or (and (= max_5773 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5773 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5772 Int)) (and (= tn (+ max_5772 1)) (or (and (= max_5772 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5772 n2_3758) (< n1_3754 n2_3758))))))
