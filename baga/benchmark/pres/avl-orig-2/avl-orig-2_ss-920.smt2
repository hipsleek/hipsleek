...
(assert (exists ((max_5872 Int)) (and (= n (+ max_5872 1)) (or (and (= max_5872 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5872 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_5873 Int)) (and (= tn (+ max_5873 1)) (or (and (= max_5873 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5873 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5871 Int)) (and (= n_4239 (+ max_5871 1)) (or (and (= max_5871 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5871 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
...
(assert (exists ((resb_5875 Int)) (= (+ resb_5875 n2_5798) (+ 1 n1_5794))))
(assert (exists ((max_5874 Int)) (and (= v_int_118_5787 (+ max_5874 1)) (or (and (= max_5874 n1_5794) (>= n1_5794 n2_5798)) (and (= max_5874 n2_5798) (< n1_5794 n2_5798))))))
(assert (= n2_5798 n_4598))
(assert (= n1_5794 n_4487))
(assert (= v_int_118_5787 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (= v_int_118_5787 (+ 1 n1_5794)) (<= n2_5798 n1_5794)) (and (= v_int_118_5787 (+ 1 n2_5798)) (< n1_5794 n2_5798)))))
(check-sat)