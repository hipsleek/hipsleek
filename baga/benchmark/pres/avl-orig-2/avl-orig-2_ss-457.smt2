...
(assert (exists ((max_4536 Int)) (and (= n (+ max_4536 1)) (or (and (= max_4536 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4536 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_4537 Int)) (and (= tn (+ max_4537 1)) (or (and (= max_4537 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4537 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_4517 0) (+ 1 n1_4513))))
(check-sat)