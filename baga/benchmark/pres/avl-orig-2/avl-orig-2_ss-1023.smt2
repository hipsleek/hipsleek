...
(assert (exists ((max_6182 Int)) (and (= tn (+ max_6182 1)) (or (and (= max_6182 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6182 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6168 0) (+ 1 n1_6164))))
(check-sat)