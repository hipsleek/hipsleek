...
(assert (exists ((flted_76_5954 Int)) (= (+ flted_76_5954 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5953 Int)) (and (= v_int_118_5881 (+ max_5953 1)) (or (and (= max_5953 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5953 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5950 Int)) (and (= n_4239 (+ max_5950 1)) (or (and (= max_5950 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5950 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5951 Int)) (and (= n (+ max_5951 1)) (or (and (= max_5951 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5951 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5952 Int)) (and (= tn (+ max_5952 1)) (or (and (= max_5952 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5952 n2_3758) (< n1_3754 n2_3758))))))
