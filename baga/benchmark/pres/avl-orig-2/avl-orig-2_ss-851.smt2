...
(assert (exists ((resb_5523 Int)) (= (+ resb_5523 n2_5486) (+ 1 n1_5482))))
(assert (exists ((max_5522 Int)) (and (= v_int_118_5475 (+ max_5522 1)) (or (and (= max_5522 n1_5482) (>= n1_5482 n2_5486)) (and (= max_5522 n2_5486) (< n1_5482 n2_5486))))))
...
(assert (exists ((max_5521 Int)) (and (= tn (+ max_5521 1)) (or (and (= max_5521 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5521 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
