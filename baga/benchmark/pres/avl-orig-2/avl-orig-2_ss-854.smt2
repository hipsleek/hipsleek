...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5631 Int)) (and (= tn (+ max_5631 1)) (or (and (= max_5631 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5631 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5629 Int)) (and (= n_4487 (+ max_5629 1)) (or (and (= max_5629 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5629 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5630 Int)) (and (= n (+ max_5630 1)) (or (and (= max_5630 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5630 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (<= (+ n2_5605 0) (+ 1 n1_5601))))
(check-sat)