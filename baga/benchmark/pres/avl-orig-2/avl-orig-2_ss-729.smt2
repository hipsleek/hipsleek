...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5273 Int)) (= (+ resb_5273 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5272 Int)) (and (= v_int_118_5237 (+ max_5272 1)) (or (and (= max_5272 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5272 n2_5248) (< n1_5244 n2_5248))))))
...
(assert (exists ((max_5271 Int)) (and (= tn (+ max_5271 1)) (or (and (= max_5271 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5271 n2_3758) (< n1_3754 n2_3758))))))
