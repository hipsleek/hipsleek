...
(assert (exists ((max_5722 Int)) (and (= tn (+ max_5722 1)) (or (and (= max_5722 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5722 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5720 Int)) (and (= n_4487 (+ max_5720 1)) (or (and (= max_5720 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5720 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5721 Int)) (and (= n (+ max_5721 1)) (or (and (= max_5721 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5721 n2_4215) (< n1_4211 n2_4215))))))
