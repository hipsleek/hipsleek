...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5725 Int)) (and (= tn (+ max_5725 1)) (or (and (= max_5725 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5725 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5723 Int)) (and (= n_4487 (+ max_5723 1)) (or (and (= max_5723 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5723 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5724 Int)) (and (= n (+ max_5724 1)) (or (and (= max_5724 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5724 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (<= (+ n2_5699 0) (+ 1 n1_5695))))
(check-sat)