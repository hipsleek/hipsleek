...
(assert (exists ((max_5820 Int)) (and (= n (+ max_5820 1)) (or (and (= max_5820 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5820 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (exists ((max_5819 Int)) (and (= tn (+ max_5819 1)) (or (and (= max_5819 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5819 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5821 Int)) (and (= n_4239 (+ max_5821 1)) (or (and (= max_5821 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5821 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
