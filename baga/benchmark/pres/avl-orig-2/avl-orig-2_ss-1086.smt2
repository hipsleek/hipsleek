...
(assert (exists ((max_6243 Int)) (and (= tn (+ max_6243 1)) (or (and (= max_6243 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6243 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6229 0) (+ 1 n1_6225))))
(check-sat)