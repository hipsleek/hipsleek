...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5102 Int)) (= (+ resb_5102 n2_5055) (+ 1 n1_5051))))
(assert (exists ((max_5101 Int)) (and (= v_int_118_5044 (+ max_5101 1)) (or (and (= max_5101 n1_5051) (>= n1_5051 n2_5055)) (and (= max_5101 n2_5055) (< n1_5051 n2_5055))))))
...
(assert (exists ((max_5098 Int)) (and (= n_3945 (+ max_5098 1)) (or (and (= max_5098 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5098 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5099 Int)) (and (= n (+ max_5099 1)) (or (and (= max_5099 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5099 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_3834))
(assert (exists ((max_5100 Int)) (and (= tn (+ max_5100 1)) (or (and (= max_5100 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5100 n2_3758) (< n1_3754 n2_3758))))))
