...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5328 Int)) (= (+ flted_76_5328 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5327 Int)) (and (= v_int_118_5295 (+ max_5327 1)) (or (and (= max_5327 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5327 n2_5306) (< n1_5302 n2_5306))))))
...
(assert (exists ((max_5326 Int)) (and (= tn (+ max_5326 1)) (or (and (= max_5326 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5326 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
