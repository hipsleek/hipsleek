...
(declare-fun n_4667 () Int)
(declare-fun b_4668 () Int)
(declare-fun m_4666 () Int)
...
(assert (<= Anon_4450 2))
(assert (= res n_4598))
(assert (= m_4666 m_4597))
(assert (= n_4667 n_4598))
(assert (= b_4668 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4666 0)) (= n_4667 0)) (= b_4668 1)) (and (and (and (and (and (<= 0 b_4668) (<= (+ (- 0 n_4667) 2) b_4668)) (<= b_4668 n_4667)) (<= b_4668 2)) (<= 1 m_4666)) (> v_node_118_2227_primed 0))))
