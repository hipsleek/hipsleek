...
(assert (exists ((max_4552 Int)) (and (= n (+ max_4552 1)) (or (and (= max_4552 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4552 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_4551 Int)) (and (= tn (+ max_4551 1)) (or (and (= max_4551 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4551 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4553 Int)) (and (= n_4487 (+ max_4553 1)) (or (and (= max_4553 n1_4513) (>= n1_4513 n2_4517)) (and (= max_4553 n2_4517) (< n1_4513 n2_4517))))))
