...
;Axioms assertions
;Antecedent
(assert (= right_118_2223_primed resr_4449))
(assert (= left_118_2222_primed resl_4447))
(assert (= height_118_2221_primed resn_4456))
(assert (= ele_118_2220_primed Anon_4446))
(assert (<= b_4488 2))
(assert (<= 0 b_4488))
(assert (<= 0 n_4487))
(assert (<= 0 m_4486))
