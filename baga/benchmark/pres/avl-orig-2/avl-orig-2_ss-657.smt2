...
(assert (exists ((max_4936 Int)) (and (= n (+ max_4936 1)) (or (and (= max_4936 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4936 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4935 Int)) (and (= tn (+ max_4935 1)) (or (and (= max_4935 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4935 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4937 Int)) (and (= n_4598 (+ max_4937 1)) (or (and (= max_4937 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4937 n2_4609) (< n1_4605 n2_4609))))))
(assert (exists ((resb_4939 Int)) (= (+ resb_4939 n2_4862) (+ 1 n1_4858))))
(assert (exists ((max_4938 Int)) (and (= v_int_118_4851 (+ max_4938 1)) (or (and (= max_4938 n1_4858) (>= n1_4858 n2_4862)) (and (= max_4938 n2_4862) (< n1_4858 n2_4862))))))
