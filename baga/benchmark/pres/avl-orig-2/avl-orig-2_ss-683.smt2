...
(assert (= Anon_5056 b_4599))
(assert (exists ((max_79 Int)) (and (= v_int_118_5044 (+ max_79 1)) (or (and (= max_79 n1_5051) (>= n1_5051 n2_5055)) (and (= max_79 n2_5055) (< n1_5051 n2_5055))))))
(assert (exists ((resb_5047 Int)) (= (+ resb_5047 n2_5055) (+ 1 n1_5051))))
