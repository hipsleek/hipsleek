...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6016 Int)) (= (+ resb_6016 n2_5991) (+ 1 n1_5987))))
(assert (exists ((max_6015 Int)) (and (= v_int_118_5980 (+ max_6015 1)) (or (and (= max_6015 n1_5987) (>= n1_5987 n2_5991)) (and (= max_6015 n2_5991) (< n1_5987 n2_5991))))))
...
(assert (exists ((max_6014 Int)) (and (= tn (+ max_6014 1)) (or (and (= max_6014 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6014 n2_3758) (< n1_3754 n2_3758))))))
