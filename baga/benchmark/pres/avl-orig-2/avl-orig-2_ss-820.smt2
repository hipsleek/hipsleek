...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_5450 Int)) (= (+ flted_76_5450 n2_5425) (+ 1 n1_5421))))
(assert (exists ((max_5449 Int)) (and (= v_int_118_5414 (+ max_5449 1)) (or (and (= max_5449 n1_5421) (>= n1_5421 n2_5425)) (and (= max_5449 n2_5425) (< n1_5421 n2_5425))))))
...
(assert (exists ((max_5448 Int)) (and (= tn (+ max_5448 1)) (or (and (= max_5448 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5448 n2_3758) (< n1_3754 n2_3758))))))
