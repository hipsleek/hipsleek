...
(declare-fun n1_4308 () Int)
(declare-fun Anon_4309 () Int)
(declare-fun m1_4307 () Int)
(declare-fun p_4306 () Int)
(declare-fun n2_4312 () Int)
(declare-fun Anon_4313 () Int)
(declare-fun m2_4311 () Int)
(declare-fun q_4310 () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= m_4238 (+ (+ m2_4311 1) m1_4307)))
(assert (exists ((max_79 Int)) (and (= n_4239 (+ max_79 1)) (or (and (= max_79 n1_4308) (>= n1_4308 n2_4312)) (and (= max_79 n2_4312) (< n1_4308 n2_4312))))))
(assert (<= (+ 0 n2_4312) (+ n1_4308 1)))
(assert (<= n1_4308 (+ 1 n2_4312)))
(assert (= (+ b_4240 n2_4312) (+ 1 n1_4308)))
(assert (= n_4304 n_4239))
...
(assert (= p_4209 1))
(assert (or (and (and (and (< p_4306 1) (= m1_4307 0)) (= n1_4308 0)) (= Anon_4309 1)) (and (and (and (and (and (<= 0 Anon_4309) (<= (+ (- 0 n1_4308) 2) Anon_4309)) (<= Anon_4309 n1_4308)) (<= Anon_4309 2)) (<= 1 m1_4307)) (> p_4306 0))))
(assert (or (and (and (and (< q_4310 1) (= m2_4311 0)) (= n2_4312 0)) (= Anon_4313 1)) (and (and (and (and (and (<= 0 Anon_4313) (<= (+ (- 0 n2_4312) 2) Anon_4313)) (<= Anon_4313 n2_4312)) (<= Anon_4313 2)) (<= 1 m2_4311)) (> q_4310 0))))
