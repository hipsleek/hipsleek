...
(assert (exists ((resb_5647 Int)) (= (+ resb_5647 n2_5605) (+ 1 n1_5601))))
(assert (exists ((max_5646 Int)) (and (= v_int_118_5594 (+ max_5646 1)) (or (and (= max_5646 n1_5601) (>= n1_5601 n2_5605)) (and (= max_5646 n2_5605) (< n1_5601 n2_5605))))))
(assert (= Anon_5602 b_4488))
(assert (= n1_5601 n_4487))
(assert (exists ((max_5645 Int)) (and (= n_4487 (+ max_5645 1)) (or (and (= max_5645 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5645 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5644 Int)) (and (= n (+ max_5644 1)) (or (and (= max_5644 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5644 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5643 Int)) (and (= tn (+ max_5643 1)) (or (and (= max_5643 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5643 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
