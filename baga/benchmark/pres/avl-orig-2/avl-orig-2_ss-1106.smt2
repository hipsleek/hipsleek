...
(assert (exists ((resb_6384 Int)) (= (+ resb_6384 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6383 Int)) (and (= v_int_118_6337 (+ max_6383 1)) (or (and (= max_6383 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6383 n2_6348) (< n1_6344 n2_6348))))))
...
(assert (= tn_4067 0))
(assert (= n_3750 tn))
(assert (exists ((max_6382 Int)) (and (= tn (+ max_6382 1)) (or (and (= max_6382 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6382 n2_3758) (< n1_3754 n2_3758))))))
