...
;Axioms assertions
;Antecedent
(assert (= right_118_2223_primed resr_4417))
(assert (= left_118_2222_primed resl_4415))
(assert (= height_118_2221_primed resn_4424))
(assert (= ele_118_2220_primed Anon_4414))
(assert (<= b_4488 2))
(assert (<= 0 b_4488))
(assert (<= 0 n_4487))
(assert (<= 0 m_4486))
