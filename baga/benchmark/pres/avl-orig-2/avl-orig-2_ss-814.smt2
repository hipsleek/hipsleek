...
(assert (exists ((max_5439 Int)) (and (= tn (+ max_5439 1)) (or (and (= max_5439 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5439 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5425 0) (+ 1 n1_5421))))
(check-sat)