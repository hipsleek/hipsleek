...
(declare-fun right_109_2188_primed () Int)
(declare-fun left_109_2187_primed () Int)
(declare-fun height_109_2186_primed () Int)
(declare-fun ele_109_2185_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_109_2188_primed v_node_107_4102))
(assert (= left_109_2187_primed p_3752))
(assert (= height_109_2186_primed n_3750))
(assert (= ele_109_2185_primed Anon_3751))
(assert (<= b_4221 2))
(assert (<= 0 b_4221))
(assert (<= 0 n_4220))
(assert (<= 0 m_4219))
