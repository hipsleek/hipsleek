...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6208 Int)) (= (+ flted_76_6208 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6207 Int)) (and (= v_int_118_6157 (+ max_6207 1)) (or (and (= max_6207 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6207 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6206 Int)) (and (= tn (+ max_6206 1)) (or (and (= max_6206 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6206 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
