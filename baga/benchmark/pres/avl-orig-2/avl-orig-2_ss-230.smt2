...
(assert (exists ((Anon_3684 Int)) (= (+ Anon_3684 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3683 Int)) (and (= resln_3577 (+ max_3683 1)) (or (and (= max_3683 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3683 n2_3602) (< n1_3598 n2_3602))))))
...
(assert (exists ((max_3682 Int)) (and (= cn_3521 (+ max_3682 1)) (or (and (= max_3682 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3682 n2_3532) (< n1_3528 n2_3532))))))
(assert (<= 0 cn_3521))
;Negation of Consequence
(assert (not (or (and (= (+ resln_3577 1) resn_3575) (< cn_3521 resn_3575)) (and (= (+ cn_3521 1) resn_3575) (<= (+ resln_3577 2) resn_3575)))))
(check-sat)