...
(assert (exists ((max_5322 Int)) (and (= tn (+ max_5322 1)) (or (and (= max_5322 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5322 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_5295 (+ 1 n1_5302)) (<= n2_5306 n1_5302)) (and (= v_int_118_5295 (+ 1 n2_5306)) (< n1_5302 n2_5306)))))
(check-sat)