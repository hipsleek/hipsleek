...
(assert (exists ((flted_76_6315 Int)) (= (+ flted_76_6315 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6314 Int)) (and (= v_int_118_6276 (+ max_6314 1)) (or (and (= max_6314 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6314 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6313 Int)) (and (= tn (+ max_6313 1)) (or (and (= max_6313 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6313 n2_3758) (< n1_3754 n2_3758))))))
