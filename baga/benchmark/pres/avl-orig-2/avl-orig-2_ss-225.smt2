...
(assert (exists ((max_3543 Int)) (and (= cn_3521 (+ max_3543 1)) (or (and (= max_3543 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3543 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (= (+ n2_3532 Anon_62) (+ n1_3528 1))))
(check-sat)