...
(declare-fun n_4657 () Int)
(declare-fun b_4658 () Int)
(declare-fun m_4656 () Int)
...
(assert (<= b_3835 2))
(assert (= res n_4598))
(assert (= m_4656 m_4597))
(assert (= n_4657 n_4598))
(assert (= b_4658 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4656 0)) (= n_4657 0)) (= b_4658 1)) (and (and (and (and (and (<= 0 b_4658) (<= (+ (- 0 n_4657) 2) b_4658)) (<= b_4658 n_4657)) (<= b_4658 2)) (<= 1 m_4656)) (> v_node_118_2227_primed 0))))
