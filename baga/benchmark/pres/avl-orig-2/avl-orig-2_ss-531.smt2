...
(declare-fun n_4681 () Int)
(declare-fun b_4682 () Int)
(declare-fun m_4680 () Int)
...
(assert (<= b_4108 2))
(assert (= res n_4598))
(assert (= m_4680 m_4597))
(assert (= n_4681 n_4598))
(assert (= b_4682 b_4599))
(assert (<= 0 m_4597))
(assert (<= 0 n_4598))
(assert (<= 0 b_4599))
(assert (<= b_4599 2))
...
(assert (or (and (and (and (< v_node_118_2227_primed 1) (= m_4680 0)) (= n_4681 0)) (= b_4682 1)) (and (and (and (and (and (<= 0 b_4682) (<= (+ (- 0 n_4681) 2) b_4682)) (<= b_4682 n_4681)) (<= b_4682 2)) (<= 1 m_4680)) (> v_node_118_2227_primed 0))))
