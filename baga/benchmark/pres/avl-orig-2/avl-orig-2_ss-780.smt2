...
(assert (< 0 tm_3772))
(assert (<= 0 m1_3753))
(assert (exists ((flted_76_5346 Int)) (= (+ flted_76_5346 n2_5306) (+ 1 n1_5302))))
(assert (exists ((max_5345 Int)) (and (= v_int_118_5295 (+ max_5345 1)) (or (and (= max_5345 n1_5302) (>= n1_5302 n2_5306)) (and (= max_5345 n2_5306) (< n1_5302 n2_5306))))))
...
(assert (exists ((max_5344 Int)) (and (= tn (+ max_5344 1)) (or (and (= max_5344 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5344 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
