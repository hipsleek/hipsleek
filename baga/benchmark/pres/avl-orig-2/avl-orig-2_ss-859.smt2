...
(assert (exists ((max_5558 Int)) (and (= tn (+ max_5558 1)) (or (and (= max_5558 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5558 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5544 0) (+ 1 n1_5540))))
(check-sat)