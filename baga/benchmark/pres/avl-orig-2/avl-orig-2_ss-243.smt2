...
(assert (exists ((Anon_3654 Int)) (= (+ Anon_3654 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3653 Int)) (and (= resln_3577 (+ max_3653 1)) (or (and (= max_3653 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3653 n2_3602) (< n1_3598 n2_3602))))))
...
(assert (<= 0 bn_3519))
(assert (<= 0 cn_3521))
(assert (exists ((max_3652 Int)) (and (= cn_3521 (+ max_3652 1)) (or (and (= max_3652 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3652 n2_3532) (< n1_3528 n2_3532))))))
