...
(declare-fun n_4227 () Int)
(declare-fun b_4228 () Int)
(declare-fun m_4226 () Int)
...
(assert (<= Anon_4216 2))
(assert (= res n_4220))
(assert (= m_4226 m_4219))
(assert (= n_4227 n_4220))
(assert (= b_4228 b_4221))
(assert (<= 0 m_4219))
(assert (<= 0 n_4220))
(assert (<= 0 b_4221))
(assert (<= b_4221 2))
...
(assert (or (and (and (and (< v_node_109_2184_primed 1) (= m_4226 0)) (= n_4227 0)) (= b_4228 1)) (and (and (and (and (and (<= 0 b_4228) (<= (+ (- 0 n_4227) 2) b_4228)) (<= b_4228 n_4227)) (<= b_4228 2)) (<= 1 m_4226)) (> v_node_109_2184_primed 0))))
