...
(declare-fun n_4508 () Int)
(declare-fun b_4509 () Int)
(declare-fun m_4507 () Int)
...
(assert (<= b_3814 2))
(assert (= res n_4487))
(assert (= m_4507 m_4486))
(assert (= n_4508 n_4487))
(assert (= b_4509 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4507 0)) (= n_4508 0)) (= b_4509 1)) (and (and (and (and (and (<= 0 b_4509) (<= (+ (- 0 n_4508) 2) b_4509)) (<= b_4509 n_4508)) (<= b_4509 2)) (<= 1 m_4507)) (> v_node_118_2219_primed 0))))
