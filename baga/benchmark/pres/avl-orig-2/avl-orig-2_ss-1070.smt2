...
(assert (exists ((flted_76_6312 Int)) (= (+ flted_76_6312 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6311 Int)) (and (= v_int_118_6276 (+ max_6311 1)) (or (and (= max_6311 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6311 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6310 Int)) (and (= tn (+ max_6310 1)) (or (and (= max_6310 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6310 n2_3758) (< n1_3754 n2_3758))))))
