...
(assert (< 0 tm_4066))
(assert (<= 0 m2_3757))
(assert (exists ((flted_76_6214 Int)) (= (+ flted_76_6214 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6213 Int)) (and (= v_int_118_6157 (+ max_6213 1)) (or (and (= max_6213 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6213 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6212 Int)) (and (= tn (+ max_6212 1)) (or (and (= max_6212 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6212 n2_3758) (< n1_3754 n2_3758))))))
