...
(assert (exists ((max_4650 Int)) (and (= n (+ max_4650 1)) (or (and (= max_4650 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4650 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4651 Int)) (and (= tn (+ max_4651 1)) (or (and (= max_4651 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4651 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4649 Int)) (and (= n_3945 (+ max_4649 1)) (or (and (= max_4649 n1_4024) (>= n1_4024 n2_4028)) (and (= max_4649 n2_4028) (< n1_4024 n2_4028))))))
...
(assert (not (or (= flted_138_4428 0) (or (= h2_4439 0) (< ss2_4433 1)))))
(check-sat)