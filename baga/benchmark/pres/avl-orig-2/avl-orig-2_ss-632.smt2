...
(assert (exists ((max_4976 Int)) (and (= tn (+ max_4976 1)) (or (and (= max_4976 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4976 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4974 Int)) (and (= n_4598 (+ max_4974 1)) (or (and (= max_4974 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4974 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4975 Int)) (and (= n (+ max_4975 1)) (or (and (= max_4975 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4975 n2_3921) (< n1_3917 n2_3921))))))
