...
(assert (exists ((max_4259 Int)) (and (= tn (+ max_4259 1)) (or (and (= max_4259 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4259 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4260 Int)) (and (= n (+ max_4260 1)) (or (and (= max_4260 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4260 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (not (or (= m_4238 0) (or (= n_4239 0) (< p_4209 1)))))
(check-sat)