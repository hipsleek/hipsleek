...
(assert (exists ((max_5123 Int)) (and (= n_3945 (+ max_5123 1)) (or (and (= max_5123 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5123 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (exists ((max_5124 Int)) (and (= n (+ max_5124 1)) (or (and (= max_5124 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5124 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((resb_5127 Int)) (= (+ resb_5127 n2_5055) (+ 1 n1_5051))))
(assert (exists ((max_5126 Int)) (and (= v_int_118_5044 (+ max_5126 1)) (or (and (= max_5126 n1_5051) (>= n1_5051 n2_5055)) (and (= max_5126 n2_5055) (< n1_5051 n2_5055))))))
(assert (= n2_5055 n_4598))
(assert (= n1_5051 n_4487))
(assert (= n_3750 tn))
(assert (exists ((max_5125 Int)) (and (= tn (+ max_5125 1)) (or (and (= max_5125 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5125 n2_3758) (< n1_3754 n2_3758))))))
(assert (= v_int_118_5044 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5055 n1_5051)) (= (+ 1 tn) v_int_118_5044)) (= tn v_int_118_5044))))
(check-sat)