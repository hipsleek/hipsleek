...
(declare-fun n_4504 () Int)
(declare-fun b_4505 () Int)
(declare-fun m_4503 () Int)
...
(assert (<= b_3814 2))
(assert (= res n_4487))
(assert (= m_4503 m_4486))
(assert (= n_4504 n_4487))
(assert (= b_4505 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4503 0)) (= n_4504 0)) (= b_4505 1)) (and (and (and (and (and (<= 0 b_4505) (<= (+ (- 0 n_4504) 2) b_4505)) (<= b_4505 n_4504)) (<= b_4505 2)) (<= 1 m_4503)) (> v_node_118_2219_primed 0))))
