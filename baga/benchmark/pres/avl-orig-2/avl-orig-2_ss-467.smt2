...
(declare-fun n_4555 () Int)
(declare-fun b_4556 () Int)
(declare-fun m_4554 () Int)
...
(assert (> resl_4447 0))
(assert (= res n_4487))
(assert (= m_4554 m_4486))
(assert (= n_4555 n_4487))
(assert (= b_4556 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4554 0)) (= n_4555 0)) (= b_4556 1)) (and (and (and (and (and (<= 0 b_4556) (<= (+ (- 0 n_4555) 2) b_4556)) (<= b_4556 n_4555)) (<= b_4556 2)) (<= 1 m_4554)) (> v_node_118_2219_primed 0))))
