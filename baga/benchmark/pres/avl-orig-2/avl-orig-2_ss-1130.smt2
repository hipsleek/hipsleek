...
(assert (exists ((flted_76_6450 Int)) (= (+ flted_76_6450 n2_6414) (+ 1 n1_6410))))
(assert (exists ((max_6449 Int)) (and (= v_int_118_6403 (+ max_6449 1)) (or (and (= max_6449 n1_6410) (>= n1_6410 n2_6414)) (and (= max_6449 n2_6414) (< n1_6410 n2_6414))))))
...
(assert (= tn_4067 0))
(assert (= n_3750 tn))
(assert (exists ((max_6448 Int)) (and (= tn (+ max_6448 1)) (or (and (= max_6448 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6448 n2_3758) (< n1_3754 n2_3758))))))
