...
(assert (exists ((flted_76_5756 Int)) (= (+ flted_76_5756 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5755 Int)) (and (= v_int_118_5688 (+ max_5755 1)) (or (and (= max_5755 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5755 n2_5699) (< n1_5695 n2_5699))))))
(assert (= Anon_5696 b_4488))
(assert (= n1_5695 n_4487))
(assert (exists ((max_5754 Int)) (and (= n_4487 (+ max_5754 1)) (or (and (= max_5754 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5754 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5753 Int)) (and (= n (+ max_5753 1)) (or (and (= max_5753 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5753 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5752 Int)) (and (= tn (+ max_5752 1)) (or (and (= max_5752 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5752 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
