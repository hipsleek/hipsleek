...
(declare-fun n_4565 () Int)
(declare-fun b_4566 () Int)
(declare-fun m_4564 () Int)
...
(assert (<= b_4129 2))
(assert (= res n_4487))
(assert (= m_4564 m_4486))
(assert (= n_4565 n_4487))
(assert (= b_4566 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4564 0)) (= n_4565 0)) (= b_4566 1)) (and (and (and (and (and (<= 0 b_4566) (<= (+ (- 0 n_4565) 2) b_4566)) (<= b_4566 n_4565)) (<= b_4566 2)) (<= 1 m_4564)) (> v_node_118_2219_primed 0))))
