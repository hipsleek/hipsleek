...
(assert (exists ((max_5866 Int)) (and (= n_4239 (+ max_5866 1)) (or (and (= max_5866 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5866 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
(assert (= cn n2_4322))
...
(assert (exists ((max_5867 Int)) (and (= n (+ max_5867 1)) (or (and (= max_5867 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5867 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((resb_5870 Int)) (= (+ resb_5870 n2_5798) (+ 1 n1_5794))))
(assert (exists ((max_5869 Int)) (and (= v_int_118_5787 (+ max_5869 1)) (or (and (= max_5869 n1_5794) (>= n1_5794 n2_5798)) (and (= max_5869 n2_5798) (< n1_5794 n2_5798))))))
(assert (= n2_5798 n_4598))
(assert (= n1_5794 n_4487))
(assert (= n_3750 tn))
(assert (exists ((max_5868 Int)) (and (= tn (+ max_5868 1)) (or (and (= max_5868 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5868 n2_3758) (< n1_3754 n2_3758))))))
(assert (= v_int_118_5787 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5798 n1_5794)) (= (+ 1 tn) v_int_118_5787)) (= tn v_int_118_5787))))
(check-sat)