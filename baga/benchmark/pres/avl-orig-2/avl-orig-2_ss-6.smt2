...
(assert (exists ((max_2560 Int)) (and (= n (+ max_2560 1)) (or (and (= max_2560 n1_2523) (>= n1_2523 n2_2527)) (and (= max_2560 n2_2527) (< n1_2523 n2_2527))))))
...
(assert (not (or (= m1_2522 0) (or (= n1_2523 0) (< p_2521 1)))))
(check-sat)