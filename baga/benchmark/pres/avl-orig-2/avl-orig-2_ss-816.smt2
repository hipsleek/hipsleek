...
(assert (exists ((max_5441 Int)) (and (= tn (+ max_5441 1)) (or (and (= max_5441 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5441 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_5414 (+ 1 n1_5421)) (<= n2_5425 n1_5421)) (and (= v_int_118_5414 (+ 1 n2_5425)) (< n1_5421 n2_5425)))))
(check-sat)