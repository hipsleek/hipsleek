...
(declare-fun right_90_2097_primed () Int)
(declare-fun left_90_2096_primed () Int)
(declare-fun height_90_2095_primed () Int)
(declare-fun ele_90_2094_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_90_2097_primed q_3756))
(assert (= left_90_2096_primed v_node_87_3808))
(assert (= height_90_2095_primed n_3750))
(assert (= ele_90_2094_primed Anon_3751))
(assert (= (+ 2 n_3834) n))
(assert (<= b_3835 2))
(assert (<= 0 b_3835))
(assert (<= 0 n_3834))
