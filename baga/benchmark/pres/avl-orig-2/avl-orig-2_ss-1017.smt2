...
(assert (exists ((max_6151 Int)) (and (= tn (+ max_6151 1)) (or (and (= max_6151 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6151 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((resb_6153 Int)) (= (+ resb_6153 n2_6110) (+ 1 n1_6106))))
(assert (exists ((max_6152 Int)) (and (= v_int_118_6099 (+ max_6152 1)) (or (and (= max_6152 n1_6106) (>= n1_6106 n2_6110)) (and (= max_6152 n2_6110) (< n1_6106 n2_6110))))))
(assert (= n2_6110 n_4598))
(assert (= n1_6106 n_4487))
(assert (= v_int_118_6099 (+ 1 n_4598)))
;Negation of Consequence
(assert (not (or (and (= v_int_118_6099 (+ 1 n1_6106)) (<= n2_6110 n1_6106)) (and (= v_int_118_6099 (+ 1 n2_6110)) (< n1_6106 n2_6110)))))
(check-sat)