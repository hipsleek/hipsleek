...
(assert (<= 0 n2_3758))
(assert (= n_3750 tn))
(assert (exists ((max_5634 Int)) (and (= tn (+ max_5634 1)) (or (and (= max_5634 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5634 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5632 Int)) (and (= n_4487 (+ max_5632 1)) (or (and (= max_5632 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5632 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5633 Int)) (and (= n (+ max_5633 1)) (or (and (= max_5633 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5633 n2_4215) (< n1_4211 n2_4215))))))
