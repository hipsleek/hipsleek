...
(assert (exists ((flted_76_5964 Int)) (= (+ flted_76_5964 n2_5892) (+ 1 n1_5888))))
(assert (exists ((max_5963 Int)) (and (= v_int_118_5881 (+ max_5963 1)) (or (and (= max_5963 n1_5888) (>= n1_5888 n2_5892)) (and (= max_5963 n2_5892) (< n1_5888 n2_5892))))))
...
(assert (exists ((max_5960 Int)) (and (= n_4239 (+ max_5960 1)) (or (and (= max_5960 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5960 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5961 Int)) (and (= n (+ max_5961 1)) (or (and (= max_5961 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5961 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5962 Int)) (and (= tn (+ max_5962 1)) (or (and (= max_5962 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5962 n2_3758) (< n1_3754 n2_3758))))))
