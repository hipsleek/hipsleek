...
(declare-fun right_90_2115_primed () Int)
(declare-fun left_90_2114_primed () Int)
(declare-fun height_90_2113_primed () Int)
(declare-fun ele_90_2112_primed () Int)
(declare-fun Anon_3914 () Int)
(declare-fun v_node_90_2111_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_90_2115_primed q_3919))
(assert (= left_90_2114_primed p_3915))
(assert (= height_90_2113_primed n_3913))
(assert (= ele_90_2112_primed Anon_3914))
(assert (= v_node_90_2111_primed v_node_87_3808))
(assert (<= b_3927 2))
(assert (<= 0 b_3927))
(assert (<= 0 n_3926))
(assert (<= 0 m_3925))
