...
(assert (exists ((max_4632 Int)) (and (= n (+ max_4632 1)) (or (and (= max_4632 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4632 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4633 Int)) (and (= tn (+ max_4633 1)) (or (and (= max_4633 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4633 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= resrn_4426 (+ 1 n1_4605)) (<= n2_4609 n1_4605)) (and (= resrn_4426 (+ 1 n2_4609)) (< n1_4605 n2_4609)))))
(check-sat)