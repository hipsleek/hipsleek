...
(assert (exists ((resb_6254 Int)) (= (+ resb_6254 n2_6229) (+ 1 n1_6225))))
(assert (exists ((max_6253 Int)) (and (= v_int_118_6218 (+ max_6253 1)) (or (and (= max_6253 n1_6225) (>= n1_6225 n2_6229)) (and (= max_6253 n2_6229) (< n1_6225 n2_6229))))))
...
(assert (exists ((max_6252 Int)) (and (= tn (+ max_6252 1)) (or (and (= max_6252 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6252 n2_3758) (< n1_3754 n2_3758))))))
