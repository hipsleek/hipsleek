...
(assert (exists ((max_6007 Int)) (and (= tn (+ max_6007 1)) (or (and (= max_6007 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6007 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_5980 (+ 1 n1_5987)) (<= n2_5991 n1_5987)) (and (= v_int_118_5980 (+ 1 n2_5991)) (< n1_5987 n2_5991)))))
(check-sat)