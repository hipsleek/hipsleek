...
(assert (exists ((flted_76_5587 Int)) (= (+ flted_76_5587 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5586 Int)) (and (= v_int_118_5533 (+ max_5586 1)) (or (and (= max_5586 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5586 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5585 Int)) (and (= tn (+ max_5585 1)) (or (and (= max_5585 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5585 n2_3758) (< n1_3754 n2_3758))))))
