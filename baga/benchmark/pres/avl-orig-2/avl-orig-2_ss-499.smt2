...
(declare-fun n_4569 () Int)
(declare-fun b_4570 () Int)
(declare-fun m_4568 () Int)
...
(assert (= v_node_118_2219_primed p_3752))
...
(assert (<= b_4129 2))
(assert (= res n_4487))
(assert (= m_4568 m_4486))
(assert (= n_4569 n_4487))
(assert (= b_4570 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4568 0)) (= n_4569 0)) (= b_4570 1)) (and (and (and (and (and (<= 0 b_4570) (<= (+ (- 0 n_4569) 2) b_4570)) (<= b_4570 n_4569)) (<= b_4570 2)) (<= 1 m_4568)) (> v_node_118_2219_primed 0))))
