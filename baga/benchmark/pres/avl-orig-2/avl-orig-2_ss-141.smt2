...
(declare-fun right_240_1528_primed () Int)
(declare-fun left_240_1527_primed () Int)
(declare-fun height_240_1526_primed () Int)
(declare-fun Anon_60 () Int)
(declare-fun ele_240_1525_primed () Int)
(declare-fun Anon_59 () Int)
(declare-fun v_int_240_1524_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_240_1528_primed rr))
(assert (= left_240_1527_primed k1_primed))
(assert (= height_240_1526_primed Anon_60))
(assert (= ele_240_1525_primed Anon_59))
(assert (= v_int_240_1524_primed (+ 1 v_int_239_2953)))
