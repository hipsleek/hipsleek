...
(assert (= Anon_5799 b_4599))
(assert (exists ((max_79 Int)) (and (= v_int_118_5787 (+ max_79 1)) (or (and (= max_79 n1_5794) (>= n1_5794 n2_5798)) (and (= max_79 n2_5798) (< n1_5794 n2_5798))))))
(assert (exists ((resb_5790 Int)) (= (+ resb_5790 n2_5798) (+ 1 n1_5794))))
