...
(declare-fun an_3284 () Int)
(declare-fun Anon_3291 () Int)
(declare-fun am_3283 () Int)
(declare-fun resl_3290 () Int)
(declare-fun bn_3286 () Int)
(declare-fun Anon_3295 () Int)
(declare-fun bm_3285 () Int)
(declare-fun resrl_3294 () Int)
(declare-fun cn_3288 () Int)
(declare-fun Anon_3297 () Int)
(declare-fun cm_3287 () Int)
...
(assert (= am_3283 am_3255))
(assert (= an_3284 an_3256))
(assert (= bm_3285 bm_3257))
(assert (= bn_3286 bn_3258))
(assert (= cm_3287 cm_3252))
(assert (= cn_3288 cn_3253))
(assert (<= 0 cm_3252))
(assert (<= 0 cn_3253))
(assert (<= 0 Anon_46))
(assert (<= Anon_46 2))
...
(assert (<= Anon_50 2))
(assert (= res 1))
(assert (or (and (and (and (< resl_3290 1) (= am_3283 0)) (= an_3284 0)) (= Anon_3291 1)) (and (and (and (and (and (<= 0 Anon_3291) (<= (+ (- 0 an_3284) 2) Anon_3291)) (<= Anon_3291 an_3284)) (<= Anon_3291 2)) (<= 1 am_3283)) (> resl_3290 0))))
(assert (= resr_3292 2))
(assert (or (and (and (and (< resrl_3294 1) (= bm_3285 0)) (= bn_3286 0)) (= Anon_3295 1)) (and (and (and (and (and (<= 0 Anon_3295) (<= (+ (- 0 bn_3286) 2) Anon_3295)) (<= Anon_3295 bn_3286)) (<= Anon_3295 2)) (<= 1 bm_3285)) (> resrl_3294 0))))
(assert (or (and (and (and (< resrr_3296 1) (= cm_3287 0)) (= cn_3288 0)) (= Anon_3297 1)) (and (and (and (and (and (<= 0 Anon_3297) (<= (+ (- 0 cn_3288) 2) Anon_3297)) (<= Anon_3297 cn_3288)) (<= Anon_3297 2)) (<= 1 cm_3287)) (> resrr_3296 0))))
