...
(declare-fun v_node_109_2184_primed () Int)
...
(assert (exists ((max_4224 Int)) (and (= tn (+ max_4224 1)) (or (and (= max_4224 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4224 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (or (and (and (and (< p_4209 1) (= m1_4210 0)) (= n1_4211 0)) (= Anon_4212 1)) (and (and (and (and (and (<= 0 Anon_4212) (<= (+ (- 0 n1_4211) 2) Anon_4212)) (<= Anon_4212 n1_4211)) (<= Anon_4212 2)) (<= 1 m1_4210)) (> p_4209 0))))
(assert (= (+ 2 n_4128) n))
(assert (<= b_4108 2))
(assert (<= 0 b_4108))
(assert (<= 0 n))
...
(assert (exists ((max_4225 Int)) (and (= n (+ max_4225 1)) (or (and (= max_4225 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4225 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= v_node_109_2184_primed q_4213))
(assert (or (and (and (and (< q_4213 1) (= m2_4214 0)) (= n2_4215 0)) (= Anon_4216 1)) (and (and (and (and (and (<= 0 Anon_4216) (<= (+ (- 0 n2_4215) 2) Anon_4216)) (<= Anon_4216 n2_4215)) (<= Anon_4216 2)) (<= 1 m2_4214)) (> q_4213 0))))
;Negation of Consequence
(assert (not (or (= m2_4214 0) (or (= n2_4215 0) (< q_4213 1)))))
(check-sat)