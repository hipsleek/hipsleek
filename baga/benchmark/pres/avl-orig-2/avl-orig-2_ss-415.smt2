...
(assert (exists ((max_4286 Int)) (and (= tn (+ max_4286 1)) (or (and (= max_4286 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4286 n2_3758) (< n1_3754 n2_3758))))))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (= n_4207 n))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (exists ((max_4287 Int)) (and (= n (+ max_4287 1)) (or (and (= max_4287 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4287 n2_4215) (< n1_4211 n2_4215))))))
