...
(assert (exists ((flted_76_5572 Int)) (= (+ flted_76_5572 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5571 Int)) (and (= v_int_118_5533 (+ max_5571 1)) (or (and (= max_5571 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5571 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5570 Int)) (and (= tn (+ max_5570 1)) (or (and (= max_5570 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5570 n2_3758) (< n1_3754 n2_3758))))))
