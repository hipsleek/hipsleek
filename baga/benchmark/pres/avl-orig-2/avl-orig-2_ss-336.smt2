...
(declare-fun h_4055 () Int)
(declare-fun t_4056 () Int)
(declare-fun t1_4058 () Int)
(declare-fun t2_4060 () Int)
(declare-fun dm () Int)
(declare-fun dn () Int)
...
(declare-fun res () Int)
(declare-fun h1_4057 () Int)
(declare-fun Anon_4052 () Int)
(declare-fun flted_137_4049 () Int)
(declare-fun ss1_4051 () Int)
(declare-fun h2_4059 () Int)
(declare-fun Anon_4054 () Int)
(declare-fun flted_138_4048 () Int)
(declare-fun ss2_4053 () Int)
...
(assert (<= b_3835 2))
(assert (> t_primed 0))
(assert (= flted_137_4049 (+ (+ 1 am) bm)))
(assert (= flted_138_4048 (+ (+ 1 cm) dm)))
(assert (= h_4055 (+ t_4056 1)))
(assert (or (and (= t_4056 h1_4057) (>= h1_4057 h2_4059)) (and (= t_4056 h2_4059) (< h1_4057 h2_4059))))
(assert (= h1_4057 (+ t1_4058 1)))
(assert (or (and (= t1_4058 an) (>= an bn)) (and (= t1_4058 bn) (< an bn))))
(assert (= h2_4059 (+ t2_4060 1)))
(assert (or (and (= t2_4060 cn) (>= cn dn)) (and (= t2_4060 dn) (< cn dn))))
(assert (<= 0 dm))
(assert (<= 0 dn))
(assert (<= 0 Anon_20))
(assert (<= Anon_20 2))
...
(assert (<= Anon_27 2))
(assert (= res 1))
(assert (or (and (and (and (< ss1_4051 1) (= flted_137_4049 0)) (= h1_4057 0)) (= Anon_4052 1)) (and (and (and (and (and (<= 0 Anon_4052) (<= (+ (- 0 h1_4057) 2) Anon_4052)) (<= Anon_4052 h1_4057)) (<= Anon_4052 2)) (<= 1 flted_137_4049)) (> ss1_4051 0))))
(assert (or (and (and (and (< ss2_4053 1) (= flted_138_4048 0)) (= h2_4059 0)) (= Anon_4054 1)) (and (and (and (and (and (<= 0 Anon_4054) (<= (+ (- 0 h2_4059) 2) Anon_4054)) (<= Anon_4054 h2_4059)) (<= Anon_4054 2)) (<= 1 flted_138_4048)) (> ss2_4053 0))))
