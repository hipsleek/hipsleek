...
(assert (exists ((max_3965 Int)) (and (= tn (+ max_3965 1)) (or (and (= max_3965 n1_3754) (>= n1_3754 n2_3758)) (and (= max_3965 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_3966 Int)) (and (= n (+ max_3966 1)) (or (and (= max_3966 n1_3917) (>= n1_3917 n2_3921)) (and (= max_3966 n2_3921) (< n1_3917 n2_3921))))))
