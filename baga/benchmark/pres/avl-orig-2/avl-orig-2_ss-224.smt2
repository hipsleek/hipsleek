...
(assert (= bn_3462 cn))
(assert (= cn_3458 dn))
(assert (exists ((max_3542 Int)) (and (= cn_3521 (+ max_3542 1)) (or (and (= max_3542 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3542 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (or (and (= cn_3521 (+ n1_3528 1)) (<= n2_3532 n1_3528)) (and (= cn_3521 (+ n2_3532 1)) (< n1_3528 n2_3532)))))
(check-sat)