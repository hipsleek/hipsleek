...
(assert (exists ((Anon_3630 Int)) (= (+ Anon_3630 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3629 Int)) (and (= resln_3577 (+ max_3629 1)) (or (and (= max_3629 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3629 n2_3602) (< n1_3598 n2_3602))))))
...
(assert (<= 0 bn_3519))
(assert (<= 0 cn_3521))
(assert (exists ((max_3628 Int)) (and (= cn_3521 (+ max_3628 1)) (or (and (= max_3628 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3628 n2_3532) (< n1_3528 n2_3532))))))
