...
(assert (exists ((flted_76_5781 Int)) (= (+ flted_76_5781 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5780 Int)) (and (= v_int_118_5688 (+ max_5780 1)) (or (and (= max_5780 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5780 n2_5699) (< n1_5695 n2_5699))))))
(assert (= Anon_5696 b_4488))
(assert (= n1_5695 n_4487))
(assert (exists ((max_5779 Int)) (and (= n_4487 (+ max_5779 1)) (or (and (= max_5779 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5779 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5778 Int)) (and (= n (+ max_5778 1)) (or (and (= max_5778 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5778 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5777 Int)) (and (= tn (+ max_5777 1)) (or (and (= max_5777 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5777 n2_3758) (< n1_3754 n2_3758))))))
