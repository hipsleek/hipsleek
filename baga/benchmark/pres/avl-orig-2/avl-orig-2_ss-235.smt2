...
(assert (exists ((max_3616 Int)) (and (= cn_3521 (+ max_3616 1)) (or (and (= max_3616 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3616 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (not (<= (+ n2_3602 0) (+ 1 n1_3598))))
(check-sat)