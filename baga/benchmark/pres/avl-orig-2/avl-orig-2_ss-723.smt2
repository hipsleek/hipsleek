...
(assert (exists ((max_5262 Int)) (and (= tn (+ max_5262 1)) (or (and (= max_5262 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5262 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5248 0) (+ 1 n1_5244))))
(check-sat)