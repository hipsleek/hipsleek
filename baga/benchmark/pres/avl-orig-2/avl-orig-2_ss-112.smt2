...
(declare-fun rl () Int)
(declare-fun n_2968 () Int)
(declare-fun b_2969 () Int)
(declare-fun m_2967 () Int)
...
(assert (<= Anon_62 2))
(assert (= res n_2960))
(assert (= m_2967 m_2959))
(assert (= n_2968 n_2960))
(assert (= b_2969 b_2961))
(assert (<= 0 m_2959))
(assert (<= 0 n_2960))
(assert (<= 0 b_2961))
(assert (<= b_2961 2))
...
(assert (= k1_primed 2))
(assert (or (and (and (and (< v_node_240_1511_primed 1) (= m_2967 0)) (= n_2968 0)) (= b_2969 1)) (and (and (and (and (and (<= 0 b_2969) (<= (+ (- 0 n_2968) 2) b_2969)) (<= b_2969 n_2968)) (<= b_2969 2)) (<= 1 m_2967)) (> v_node_240_1511_primed 0))))
