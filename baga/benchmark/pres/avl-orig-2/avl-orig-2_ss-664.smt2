...
(assert (<= 0 n1_3754))
(assert (= n_3750 tn))
(assert (exists ((max_4982 Int)) (and (= tn (+ max_4982 1)) (or (and (= max_4982 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4982 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4980 Int)) (and (= n_4598 (+ max_4980 1)) (or (and (= max_4980 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4980 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4981 Int)) (and (= n (+ max_4981 1)) (or (and (= max_4981 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4981 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (not (<= (+ n2_4956 0) (+ 1 n1_4952))))
(check-sat)