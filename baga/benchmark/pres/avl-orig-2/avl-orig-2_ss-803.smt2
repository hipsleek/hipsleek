...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5389 Int)) (= (+ resb_5389 n2_5367) (+ 1 n1_5363))))
(assert (exists ((max_5388 Int)) (and (= v_int_118_5356 (+ max_5388 1)) (or (and (= max_5388 n1_5363) (>= n1_5363 n2_5367)) (and (= max_5388 n2_5367) (< n1_5363 n2_5367))))))
...
(assert (exists ((max_5387 Int)) (and (= tn (+ max_5387 1)) (or (and (= max_5387 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5387 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
