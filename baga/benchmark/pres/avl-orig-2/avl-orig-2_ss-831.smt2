...
(assert (exists ((flted_76_5569 Int)) (= (+ flted_76_5569 n2_5544) (+ 1 n1_5540))))
(assert (exists ((max_5568 Int)) (and (= v_int_118_5533 (+ max_5568 1)) (or (and (= max_5568 n1_5540) (>= n1_5540 n2_5544)) (and (= max_5568 n2_5544) (< n1_5540 n2_5544))))))
...
(assert (exists ((max_5567 Int)) (and (= tn (+ max_5567 1)) (or (and (= max_5567 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5567 n2_3758) (< n1_3754 n2_3758))))))
