...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5850 Int)) (= (+ resb_5850 n2_5798) (+ 1 n1_5794))))
(assert (exists ((max_5849 Int)) (and (= v_int_118_5787 (+ max_5849 1)) (or (and (= max_5849 n1_5794) (>= n1_5794 n2_5798)) (and (= max_5849 n2_5798) (< n1_5794 n2_5798))))))
...
(assert (exists ((max_5846 Int)) (and (= n_4239 (+ max_5846 1)) (or (and (= max_5846 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5846 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5847 Int)) (and (= n (+ max_5847 1)) (or (and (= max_5847 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5847 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (<= 0 n_4128))
(assert (exists ((max_5848 Int)) (and (= tn (+ max_5848 1)) (or (and (= max_5848 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5848 n2_3758) (< n1_3754 n2_3758))))))
