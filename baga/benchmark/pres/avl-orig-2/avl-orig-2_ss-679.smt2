...
(assert (exists ((flted_76_5043 Int)) (= (+ flted_76_5043 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5042 Int)) (and (= v_int_118_4945 (+ max_5042 1)) (or (and (= max_5042 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5042 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5041 Int)) (and (= n_4598 (+ max_5041 1)) (or (and (= max_5041 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5041 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5040 Int)) (and (= n (+ max_5040 1)) (or (and (= max_5040 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5040 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_5039 Int)) (and (= tn (+ max_5039 1)) (or (and (= max_5039 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5039 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
