...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5122 Int)) (= (+ resb_5122 n2_5055) (+ 1 n1_5051))))
(assert (exists ((max_5121 Int)) (and (= v_int_118_5044 (+ max_5121 1)) (or (and (= max_5121 n1_5051) (>= n1_5051 n2_5055)) (and (= max_5121 n2_5055) (< n1_5051 n2_5055))))))
...
(assert (exists ((max_5118 Int)) (and (= n_3945 (+ max_5118 1)) (or (and (= max_5118 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5118 n2_4028) (< n1_4024 n2_4028))))))
(assert (= cn n2_4028))
...
(assert (exists ((max_5119 Int)) (and (= n (+ max_5119 1)) (or (and (= max_5119 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5119 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5120 Int)) (and (= tn (+ max_5120 1)) (or (and (= max_5120 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5120 n2_3758) (< n1_3754 n2_3758))))))
