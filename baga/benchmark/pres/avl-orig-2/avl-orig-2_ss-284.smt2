...
(declare-fun n_3840 () Int)
(declare-fun b_3841 () Int)
(declare-fun m_3839 () Int)
...
(assert (<= Anon_3759 2))
(assert (= res n_3834))
(assert (= m_3839 m_3833))
(assert (= n_3840 n_3834))
(assert (= b_3841 b_3835))
(assert (<= 0 m_3833))
(assert (<= 0 n_3834))
(assert (<= 0 b_3835))
(assert (<= b_3835 2))
...
(assert (or (and (and (and (< v_node_89_2083_primed 1) (= m_3839 0)) (= n_3840 0)) (= b_3841 1)) (and (and (and (and (and (<= 0 b_3841) (<= (+ (- 0 n_3840) 2) b_3841)) (<= b_3841 n_3840)) (<= b_3841 2)) (<= 1 m_3839)) (> v_node_89_2083_primed 0))))
