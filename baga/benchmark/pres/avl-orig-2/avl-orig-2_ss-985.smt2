...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6077 Int)) (= (+ flted_76_6077 n2_6049) (+ 1 n1_6045))))
(assert (exists ((max_6076 Int)) (and (= v_int_118_6038 (+ max_6076 1)) (or (and (= max_6076 n1_6045) (>= n1_6045 n2_6049)) (and (= max_6076 n2_6049) (< n1_6045 n2_6049))))))
...
(assert (exists ((max_6075 Int)) (and (= tn (+ max_6075 1)) (or (and (= max_6075 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6075 n2_3758) (< n1_3754 n2_3758))))))
