...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6190 Int)) (= (+ flted_76_6190 n2_6168) (+ 1 n1_6164))))
(assert (exists ((max_6189 Int)) (and (= v_int_118_6157 (+ max_6189 1)) (or (and (= max_6189 n1_6164) (>= n1_6164 n2_6168)) (and (= max_6189 n2_6168) (< n1_6164 n2_6168))))))
...
(assert (exists ((max_6188 Int)) (and (= tn (+ max_6188 1)) (or (and (= max_6188 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6188 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
