...
(assert (exists ((max_6005 Int)) (and (= tn (+ max_6005 1)) (or (and (= max_6005 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6005 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_5991 0) (+ 1 n1_5987))))
(check-sat)