...
(declare-fun flted_76_4078 () Int)
(declare-fun flted_76_4077 () Int)
(declare-fun flted_76_4079 () Int)
(declare-fun res () Int)
...
(assert (<= 0 Anon_3759))
(assert (<= Anon_3759 2))
(assert (= flted_76_4079 1))
(assert (= flted_76_4078 1))
(assert (= flted_76_4077 1))
(assert (= tn_4067 0))
(assert (= tm_4066 0))
(assert (< v_node_107_2140_primed 1))
(assert (<= 0 tm_4066))
(assert (<= 0 tn_4067))
(assert (<= 0 b_4068))
(assert (<= b_4068 2))
...
(assert (or (and (and (and (< res 1) (= flted_76_4079 0)) (= flted_76_4078 0)) (= flted_76_4077 1)) (and (and (and (and (and (<= 0 flted_76_4077) (<= (+ (- 0 flted_76_4078) 2) flted_76_4077)) (<= flted_76_4077 flted_76_4078)) (<= flted_76_4077 2)) (<= 1 flted_76_4079)) (> res 0))))
