...
(assert (exists ((Anon_3666 Int)) (= (+ Anon_3666 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3665 Int)) (and (= resln_3577 (+ max_3665 1)) (or (and (= max_3665 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3665 n2_3602) (< n1_3598 n2_3602))))))
...
(assert (<= 0 cn_3521))
(assert (exists ((max_3664 Int)) (and (= cn_3521 (+ max_3664 1)) (or (and (= max_3664 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3664 n2_3532) (< n1_3528 n2_3532))))))
