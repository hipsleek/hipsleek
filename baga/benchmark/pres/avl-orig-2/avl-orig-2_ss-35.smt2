...
(assert (= k2_primed 2))
(assert (or (and (and (and (< v_node_203_1682_primed 1) (= m_2668 0)) (= n_2669 0)) (= b_2670 1)) (and (and (and (and (and (<= 0 b_2670) (<= (+ (- 0 n_2669) 2) b_2670)) (<= b_2670 n_2669)) (<= b_2670 2)) (<= 1 m_2668)) (> v_node_203_1682_primed 0))))
