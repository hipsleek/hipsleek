...
(declare-fun right_202_1675_primed () Int)
(declare-fun left_202_1674_primed () Int)
(declare-fun height_202_1673_primed () Int)
(declare-fun Anon_45 () Int)
(declare-fun ele_202_1672_primed () Int)
(declare-fun Anon_44 () Int)
(declare-fun v_int_202_1671_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_202_1675_primed r))
(assert (= left_202_1674_primed lr))
(assert (= height_202_1673_primed Anon_45))
(assert (= ele_202_1672_primed Anon_44))
(assert (= v_int_202_1671_primed (+ 1 n_2627)))
(assert (< n n_2627))
(assert (<= b_2628 2))
(assert (<= 0 b_2628))
(assert (<= 0 n_2627))
