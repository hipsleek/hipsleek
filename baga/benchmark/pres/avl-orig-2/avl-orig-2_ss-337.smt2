...
(declare-fun right_107_2136_primed () Int)
(declare-fun left_107_2135_primed () Int)
(declare-fun height_107_2134_primed () Int)
(declare-fun ele_107_2133_primed () Int)
(declare-fun t () Int)
(declare-fun x () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_107_2136_primed q_3756))
(assert (= left_107_2135_primed p_3752))
(assert (= height_107_2134_primed n_3750))
(assert (= ele_107_2133_primed Anon_3751))
(assert (= t_primed t))
(assert (= x_primed x))
(assert (< tmp_primed 1))
(assert (> t_primed 0))
