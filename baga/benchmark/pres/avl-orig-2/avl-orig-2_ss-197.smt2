...
(assert (exists ((Anon_3378 Int)) (= (+ Anon_3378 n2_3344) (+ 1 n1_3340))))
(assert (exists ((max_3377 Int)) (and (= resrn_3315 (+ max_3377 1)) (or (and (= max_3377 n1_3340) (>= n1_3340 n2_3344)) (and (= max_3377 n2_3344) (< n1_3340 n2_3344))))))
...
(assert (<= 0 an_3256))
(assert (exists ((max_3376 Int)) (and (= an_3256 (+ max_3376 1)) (or (and (= max_3376 n1_3265) (>= n1_3265 n2_3269)) (and (= max_3376 n2_3269) (< n1_3265 n2_3269))))))
