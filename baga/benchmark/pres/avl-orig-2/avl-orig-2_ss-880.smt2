...
(assert (exists ((flted_76_5746 Int)) (= (+ flted_76_5746 n2_5699) (+ 1 n1_5695))))
(assert (exists ((max_5745 Int)) (and (= v_int_118_5688 (+ max_5745 1)) (or (and (= max_5745 n1_5695) (>= n1_5695 n2_5699)) (and (= max_5745 n2_5699) (< n1_5695 n2_5699))))))
(assert (= Anon_5696 b_4488))
(assert (= n1_5695 n_4487))
(assert (exists ((max_5744 Int)) (and (= n_4487 (+ max_5744 1)) (or (and (= max_5744 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5744 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (exists ((max_5743 Int)) (and (= n (+ max_5743 1)) (or (and (= max_5743 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5743 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (exists ((max_5742 Int)) (and (= tn (+ max_5742 1)) (or (and (= max_5742 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5742 n2_3758) (< n1_3754 n2_3758))))))
