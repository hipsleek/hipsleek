...
(assert (exists ((max_5560 Int)) (and (= tn (+ max_5560 1)) (or (and (= max_5560 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5560 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (and (= v_int_118_5533 (+ 1 n1_5540)) (<= n2_5544 n1_5540)) (and (= v_int_118_5533 (+ 1 n2_5544)) (< n1_5540 n2_5544)))))
(check-sat)