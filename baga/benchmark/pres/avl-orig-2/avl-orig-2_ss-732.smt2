...
(assert (exists ((resb_5288 Int)) (= (+ resb_5288 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5287 Int)) (and (= v_int_118_5237 (+ max_5287 1)) (or (and (= max_5287 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5287 n2_5248) (< n1_5244 n2_5248))))))
(assert (= n2_5248 n_4598))
(assert (= n1_5244 n_4487))
(assert (exists ((max_5286 Int)) (and (= tn (+ max_5286 1)) (or (and (= max_5286 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5286 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
(assert (= v_int_118_5237 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5248 n1_5244)) (= (+ 1 tn) v_int_118_5237)) (= tn v_int_118_5237))))
(check-sat)