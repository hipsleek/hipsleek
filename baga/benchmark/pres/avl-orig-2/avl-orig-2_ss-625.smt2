...
(assert (exists ((resb_4929 Int)) (= (+ resb_4929 n2_4862) (+ 1 n1_4858))))
(assert (exists ((max_4928 Int)) (and (= v_int_118_4851 (+ max_4928 1)) (or (and (= max_4928 n1_4858) (>= n1_4858 n2_4862)) (and (= max_4928 n2_4862) (< n1_4858 n2_4862))))))
(assert (= Anon_4863 b_4599))
(assert (= n2_4862 n_4598))
(assert (exists ((max_4927 Int)) (and (= n_4598 (+ max_4927 1)) (or (and (= max_4927 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4927 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4926 Int)) (and (= n (+ max_4926 1)) (or (and (= max_4926 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4926 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_4925 Int)) (and (= tn (+ max_4925 1)) (or (and (= max_4925 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4925 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
