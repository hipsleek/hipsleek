...
(assert (exists ((max_5679 Int)) (and (= n (+ max_5679 1)) (or (and (= max_5679 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5679 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_5678 Int)) (and (= tn (+ max_5678 1)) (or (and (= max_5678 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5678 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5680 Int)) (and (= n_4487 (+ max_5680 1)) (or (and (= max_5680 n1_4513) (>= n1_4513 n2_4517)) (and (= max_5680 n2_4517) (< n1_4513 n2_4517))))))
(assert (exists ((resb_5682 Int)) (= (+ resb_5682 n2_5605) (+ 1 n1_5601))))
(assert (exists ((max_5681 Int)) (and (= v_int_118_5594 (+ max_5681 1)) (or (and (= max_5681 n1_5601) (>= n1_5601 n2_5605)) (and (= max_5681 n2_5605) (< n1_5601 n2_5605))))))
(assert (= n2_5605 n_4598))
(assert (= n1_5601 n_4487))
(assert (= v_int_118_5594 (+ 1 n_4487)))
;Negation of Consequence
(assert (not (or (and (= v_int_118_5594 (+ 1 n1_5601)) (<= n2_5605 n1_5601)) (and (= v_int_118_5594 (+ 1 n2_5605)) (< n1_5601 n2_5605)))))
(check-sat)