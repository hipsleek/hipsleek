...
(assert (exists ((max_4624 Int)) (and (= n (+ max_4624 1)) (or (and (= max_4624 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4624 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_4625 Int)) (and (= tn (+ max_4625 1)) (or (and (= max_4625 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4625 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (= bm 0) (or (= bn 0) (< resrl_4419 1)))))
(check-sat)