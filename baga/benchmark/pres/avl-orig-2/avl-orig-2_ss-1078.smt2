...
(assert (exists ((flted_76_6336 Int)) (= (+ flted_76_6336 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6335 Int)) (and (= v_int_118_6276 (+ max_6335 1)) (or (and (= max_6335 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6335 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6334 Int)) (and (= tn (+ max_6334 1)) (or (and (= max_6334 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6334 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
