...
(assert (exists ((max_4626 Int)) (and (= n (+ max_4626 1)) (or (and (= max_4626 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4626 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (= tm (+ (+ m2_3757 1) m1_3753)))
(assert (exists ((max_4627 Int)) (and (= tn (+ max_4627 1)) (or (and (= max_4627 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4627 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (or (= cm 0) (or (= cn 0) (< resrr_4421 1)))))
(check-sat)