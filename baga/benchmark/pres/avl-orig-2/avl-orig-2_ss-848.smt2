...
(assert (exists ((resb_5508 Int)) (= (+ resb_5508 n2_5486) (+ 1 n1_5482))))
(assert (exists ((max_5507 Int)) (and (= v_int_118_5475 (+ max_5507 1)) (or (and (= max_5507 n1_5482) (>= n1_5482 n2_5486)) (and (= max_5507 n2_5486) (< n1_5482 n2_5486))))))
...
(assert (exists ((max_5506 Int)) (and (= tn (+ max_5506 1)) (or (and (= max_5506 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5506 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
