...
(assert (<= Anon_4432 2))
(assert (= res n_4487))
(assert (= m_4499 m_4486))
(assert (= n_4500 n_4487))
(assert (= b_4501 b_4488))
(assert (<= 0 m_4486))
(assert (<= 0 n_4487))
(assert (<= 0 b_4488))
(assert (<= b_4488 2))
...
(assert (or (and (and (and (< v_node_118_2219_primed 1) (= m_4499 0)) (= n_4500 0)) (= b_4501 1)) (and (and (and (and (and (<= 0 b_4501) (<= (+ (- 0 n_4500) 2) b_4501)) (<= b_4501 n_4500)) (<= b_4501 2)) (<= 1 m_4499)) (> v_node_118_2219_primed 0))))
