...
(assert (exists ((max_4549 Int)) (and (= n (+ max_4549 1)) (or (and (= max_4549 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4549 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_4548 Int)) (and (= tn (+ max_4548 1)) (or (and (= max_4548 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4548 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4550 Int)) (and (= n_4487 (+ max_4550 1)) (or (and (= max_4550 n1_4513) (>= n1_4513 n2_4517)) (and (= max_4550 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (not (= (+ n2_4517 b_4488) (+ n1_4513 1))))
(check-sat)