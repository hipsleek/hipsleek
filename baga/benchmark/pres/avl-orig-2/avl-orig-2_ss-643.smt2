...
(assert (exists ((max_4882 Int)) (and (= tn (+ max_4882 1)) (or (and (= max_4882 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4882 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4880 Int)) (and (= n_4598 (+ max_4880 1)) (or (and (= max_4880 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4880 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4881 Int)) (and (= n (+ max_4881 1)) (or (and (= max_4881 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4881 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (not (or (= m_4486 0) (or (= n_4487 0) (< resl_4415 1)))))
(check-sat)