...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5840 Int)) (= (+ resb_5840 n2_5798) (+ 1 n1_5794))))
(assert (exists ((max_5839 Int)) (and (= v_int_118_5787 (+ max_5839 1)) (or (and (= max_5839 n1_5794) (>= n1_5794 n2_5798)) (and (= max_5839 n2_5798) (< n1_5794 n2_5798))))))
...
(assert (exists ((max_5836 Int)) (and (= n_4239 (+ max_5836 1)) (or (and (= max_5836 n1_4318) (>= n1_4318 n2_4322)) (and (= max_5836 n2_4322) (< n1_4318 n2_4322))))))
(assert (= bn n1_4318))
...
(assert (exists ((max_5837 Int)) (and (= n (+ max_5837 1)) (or (and (= max_5837 n1_4211) (>= n1_4211 n2_4215)) (and (= max_5837 n2_4215) (< n1_4211 n2_4215))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_5838 Int)) (and (= tn (+ max_5838 1)) (or (and (= max_5838 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5838 n2_3758) (< n1_3754 n2_3758))))))
