...
(assert (exists ((max_4546 Int)) (and (= n (+ max_4546 1)) (or (and (= max_4546 n1_4211) (>= n1_4211 n2_4215)) (and (= max_4546 n2_4215) (< n1_4211 n2_4215))))))
(assert (<= (+ 0 n2_4215) (+ n1_4211 1)))
(assert (<= n1_4211 (+ 1 n2_4215)))
(assert (= (+ b_4108 n2_4215) (+ 1 n1_4211)))
(assert (= n_4207 n))
(assert (exists ((max_4545 Int)) (and (= tn (+ max_4545 1)) (or (and (= max_4545 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4545 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= bn n_4239))
(assert (= an n_4128))
(assert (exists ((max_4547 Int)) (and (= n_4487 (+ max_4547 1)) (or (and (= max_4547 n1_4513) (>= n1_4513 n2_4517)) (and (= max_4547 n2_4517) (< n1_4513 n2_4517))))))
...
(assert (not (or (and (= n_4487 (+ n1_4513 1)) (<= n2_4517 n1_4513)) (and (= n_4487 (+ n2_4517 1)) (< n1_4513 n2_4517)))))
(check-sat)