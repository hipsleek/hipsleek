...
(assert (<= 0 bn_3519))
(assert (<= 0 cn_3521))
(assert (exists ((max_3685 Int)) (and (= cn_3521 (+ max_3685 1)) (or (and (= max_3685 n1_3528) (>= n1_3528 n2_3532)) (and (= max_3685 n2_3532) (< n1_3528 n2_3532))))))
...
(assert (exists ((Anon_3687 Int)) (= (+ Anon_3687 n2_3602) (+ 1 n1_3598))))
(assert (exists ((max_3686 Int)) (and (= resln_3577 (+ max_3686 1)) (or (and (= max_3686 n1_3598) (>= n1_3598 n2_3602)) (and (= max_3686 n2_3602) (< n1_3598 n2_3602))))))
