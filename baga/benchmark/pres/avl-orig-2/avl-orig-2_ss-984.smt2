...
;Axioms assertions
;Antecedent
(assert (exists ((flted_76_6074 Int)) (= (+ flted_76_6074 n2_6049) (+ 1 n1_6045))))
(assert (exists ((max_6073 Int)) (and (= v_int_118_6038 (+ max_6073 1)) (or (and (= max_6073 n1_6045) (>= n1_6045 n2_6049)) (and (= max_6073 n2_6049) (< n1_6045 n2_6049))))))
...
(assert (exists ((max_6072 Int)) (and (= tn (+ max_6072 1)) (or (and (= max_6072 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6072 n2_3758) (< n1_3754 n2_3758))))))
