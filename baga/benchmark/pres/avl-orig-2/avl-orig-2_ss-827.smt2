...
(assert (< 0 tm_3772))
(assert (<= 0 m1_3753))
(assert (exists ((flted_76_5471 Int)) (= (+ flted_76_5471 n2_5425) (+ 1 n1_5421))))
(assert (exists ((max_5470 Int)) (and (= v_int_118_5414 (+ max_5470 1)) (or (and (= max_5470 n1_5421) (>= n1_5421 n2_5425)) (and (= max_5470 n2_5425) (< n1_5421 n2_5425))))))
...
(assert (exists ((max_5469 Int)) (and (= tn (+ max_5469 1)) (or (and (= max_5469 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5469 n2_3758) (< n1_3754 n2_3758))))))
