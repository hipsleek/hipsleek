...
(assert (<= 0 Anon_62))
(assert (<= Anon_62 2))
(assert (= v_int_240_1519_primed n_2960))
(assert (<= 0 m_2959))
(assert (<= 0 n_2960))
(assert (<= 0 b_2961))
(assert (<= b_2961 2))
(assert (= v_int_240_1518_primed v_int_239_2953))
(assert (= res v_int_240_1519_primed))
(assert (<= v_int_240_1518_primed v_int_240_1519_primed))
(assert (= k2_primed 1))
