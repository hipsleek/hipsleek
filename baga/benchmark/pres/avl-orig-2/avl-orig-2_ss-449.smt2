...
(assert (exists ((max_4506 Int)) (and (= tn (+ max_4506 1)) (or (and (= max_4506 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4506 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (= v_node_118_2219_primed v_node_87_3810))
...
(assert (not (or (= m 0) (or (= n 0) (< v_node_87_3810 1)))))
(check-sat)