...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6013 Int)) (= (+ resb_6013 n2_5991) (+ 1 n1_5987))))
(assert (exists ((max_6012 Int)) (and (= v_int_118_5980 (+ max_6012 1)) (or (and (= max_6012 n1_5987) (>= n1_5987 n2_5991)) (and (= max_6012 n2_5991) (< n1_5987 n2_5991))))))
...
(assert (exists ((max_6011 Int)) (and (= tn (+ max_6011 1)) (or (and (= max_6011 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6011 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
