...
(declare-fun p_5049 () Int)
(declare-fun m1_5050 () Int)
(declare-fun Anon_5052 () Int)
...
(assert (exists ((max_5077 Int)) (and (= n (+ max_5077 1)) (or (and (= max_5077 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5077 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_5076 Int)) (and (= tn (+ max_5076 1)) (or (and (= max_5076 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5076 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5078 Int)) (and (= n_3945 (+ max_5078 1)) (or (and (= max_5078 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5078 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (= p_5049 ss1_4431))
(assert (= m1_5050 m_4486))
(assert (= Anon_5052 b_4488))
