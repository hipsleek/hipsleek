...
(declare-fun right_203_1699_primed () Int)
(declare-fun left_203_1698_primed () Int)
(declare-fun height_203_1697_primed () Int)
(declare-fun Anon_48 () Int)
(declare-fun ele_203_1696_primed () Int)
(declare-fun Anon_47 () Int)
(declare-fun v_int_203_1695_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_203_1699_primed k2_primed))
(assert (= left_203_1698_primed ll))
(assert (= height_203_1697_primed Anon_48))
(assert (= ele_203_1696_primed Anon_47))
(assert (= v_int_203_1695_primed (+ 1 n_2664)))
(assert (<= v_int_202_2659 n_2664))
(assert (<= b_2665 2))
(assert (<= 0 b_2665))
(assert (<= 0 n_2664))
(assert (<= 0 m_2663))
