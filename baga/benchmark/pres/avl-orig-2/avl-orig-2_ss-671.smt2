...
(assert (exists ((max_5086 Int)) (and (= n (+ max_5086 1)) (or (and (= max_5086 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5086 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_5085 Int)) (and (= tn (+ max_5085 1)) (or (and (= max_5085 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5085 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5087 Int)) (and (= n_3945 (+ max_5087 1)) (or (and (= max_5087 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5087 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (not (or (and (= v_int_118_5044 (+ 1 n1_5051)) (<= n2_5055 n1_5051)) (and (= v_int_118_5044 (+ 1 n2_5055)) (< n1_5051 n2_5055)))))
(check-sat)