...
(assert (<= 0 n1_3754))
(assert (= n_3750 tn))
(assert (exists ((max_4891 Int)) (and (= tn (+ max_4891 1)) (or (and (= max_4891 n1_3754) (>= n1_3754 n2_3758)) (and (= max_4891 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_4889 Int)) (and (= n_4598 (+ max_4889 1)) (or (and (= max_4889 n1_4605) (>= n1_4605 n2_4609)) (and (= max_4889 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_4890 Int)) (and (= n (+ max_4890 1)) (or (and (= max_4890 n1_3917) (>= n1_3917 n2_3921)) (and (= max_4890 n2_3921) (< n1_3917 n2_3921))))))
