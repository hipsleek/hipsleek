...
(assert (exists ((flted_76_5028 Int)) (= (+ flted_76_5028 n2_4956) (+ 1 n1_4952))))
(assert (exists ((max_5027 Int)) (and (= v_int_118_4945 (+ max_5027 1)) (or (and (= max_5027 n1_4952) (>= n1_4952 n2_4956)) (and (= max_5027 n2_4956) (< n1_4952 n2_4956))))))
(assert (= Anon_4957 b_4599))
(assert (= n2_4956 n_4598))
(assert (exists ((max_5026 Int)) (and (= n_4598 (+ max_5026 1)) (or (and (= max_5026 n1_4605) (>= n1_4605 n2_4609)) (and (= max_5026 n2_4609) (< n1_4605 n2_4609))))))
...
(assert (exists ((max_5025 Int)) (and (= n (+ max_5025 1)) (or (and (= max_5025 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5025 n2_3921) (< n1_3917 n2_3921))))))
...
(assert (exists ((max_5024 Int)) (and (= tn (+ max_5024 1)) (or (and (= max_5024 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5024 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
