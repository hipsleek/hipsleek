...
(assert (exists ((resb_6393 Int)) (= (+ resb_6393 n2_6348) (+ 1 n1_6344))))
(assert (exists ((max_6392 Int)) (and (= v_int_118_6337 (+ max_6392 1)) (or (and (= max_6392 n1_6344) (>= n1_6344 n2_6348)) (and (= max_6392 n2_6348) (< n1_6344 n2_6348))))))
...
(assert (= n_3750 tn))
(assert (exists ((max_6391 Int)) (and (= tn (+ max_6391 1)) (or (and (= max_6391 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6391 n2_3758) (< n1_3754 n2_3758))))))
