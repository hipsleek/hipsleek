...
(assert (exists ((max_6367 Int)) (and (= tn (+ max_6367 1)) (or (and (= max_6367 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6367 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (not (<= (+ n2_6348 0) (+ 1 n1_6344))))
(check-sat)