...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5285 Int)) (= (+ resb_5285 n2_5248) (+ 1 n1_5244))))
(assert (exists ((max_5284 Int)) (and (= v_int_118_5237 (+ max_5284 1)) (or (and (= max_5284 n1_5244) (>= n1_5244 n2_5248)) (and (= max_5284 n2_5248) (< n1_5244 n2_5248))))))
...
(assert (exists ((max_5283 Int)) (and (= tn (+ max_5283 1)) (or (and (= max_5283 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5283 n2_3758) (< n1_3754 n2_3758))))))
(assert (= n_3750 tn))
