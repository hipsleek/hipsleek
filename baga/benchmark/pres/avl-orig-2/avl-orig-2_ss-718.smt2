...
(assert (exists ((max_5174 Int)) (and (= n (+ max_5174 1)) (or (and (= max_5174 n1_3917) (>= n1_3917 n2_3921)) (and (= max_5174 n2_3921) (< n1_3917 n2_3921))))))
(assert (<= (+ 0 n2_3921) (+ n1_3917 1)))
(assert (<= n1_3917 (+ 1 n2_3921)))
(assert (= (+ b_3814 n2_3921) (+ 1 n1_3917)))
(assert (= n_3913 n))
(assert (exists ((max_5173 Int)) (and (= tn (+ max_5173 1)) (or (and (= max_5173 n1_3754) (>= n1_3754 n2_3758)) (and (= max_5173 n2_3758) (< n1_3754 n2_3758))))))
...
(assert (exists ((max_5175 Int)) (and (= n_3945 (+ max_5175 1)) (or (and (= max_5175 n1_4024) (>= n1_4024 n2_4028)) (and (= max_5175 n2_4028) (< n1_4024 n2_4028))))))
(assert (= bn n1_4024))
(assert (= cn n2_4028))
...
(assert (not (<= (+ n2_5149 0) (+ 1 n1_5145))))
(check-sat)