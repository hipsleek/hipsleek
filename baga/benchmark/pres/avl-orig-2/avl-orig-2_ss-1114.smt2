...
(assert (exists ((flted_76_6330 Int)) (= (+ flted_76_6330 n2_6287) (+ 1 n1_6283))))
(assert (exists ((max_6329 Int)) (and (= v_int_118_6276 (+ max_6329 1)) (or (and (= max_6329 n1_6283) (>= n1_6283 n2_6287)) (and (= max_6329 n2_6287) (< n1_6283 n2_6287))))))
...
(assert (exists ((max_6328 Int)) (and (= tn (+ max_6328 1)) (or (and (= max_6328 n1_3754) (>= n1_3754 n2_3758)) (and (= max_6328 n2_3758) (< n1_3754 n2_3758))))))
