...
(assert (= xs_primed 1))
(assert (or (and (and (= bgres_2072 smres_2071) (= n_2064 1)) (> tmp_2078 0)) (and (and (<= smres_2071 bgres_2072) (<= 2 n_2064)) (> tmp_2078 0))))
(assert (= tmp_primed 2))
(assert (not (= xs_primed tmp_primed)))
(assert (not (= xs_primed tmp_2078)))
(assert (not (= tmp_2078 tmp_primed)))
