...
(assert (= n_2074 n_2064))
(assert (<= 0 n_2064))
(assert (or (and (< xsnext_1973 1) (= a_1971 0)) (and (and (< sm_1952 v_primed) (<= 1 a_1971)) (> xsnext_1973 0))))
(assert (= xs_primed 1))
(assert (or (and (and (= bgres_2076 smres_2075) (= n_2074 1)) (> tmp_primed 0)) (and (and (<= smres_2075 bgres_2076) (<= 2 n_2074)) (> tmp_primed 0))))
