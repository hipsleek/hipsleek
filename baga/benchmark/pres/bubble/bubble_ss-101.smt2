...
(declare-fun Anon_1777 () Int)
(declare-fun sm_1578 () Int)
(declare-fun r_1778 () Int)
...
(assert (= Anon_1777 sm_1578))
(assert (= r_1778 q_1581))
(assert (or (and (< q_1581 1) (= flted_10_1580 0)) (and (<= 1 flted_10_1580) (> q_1581 0))))
