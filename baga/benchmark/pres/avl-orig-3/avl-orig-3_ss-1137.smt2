...
(assert (exists ((flted_44_6482 Int)) (= (+ flted_44_6482 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6481 Int)) (and (= v_int_79_6414 (+ 1 max_6481)) (or (and (= max_6481 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6481 n2_6425) (< n1_6421 n2_6425))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_6480 Int)) (and (= tn (+ 1 max_6480)) (or (and (= max_6480 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6480 n2_3783) (< n1_3779 n2_3783))))))
