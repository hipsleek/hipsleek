...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5217 Int)) (= (+ flted_44_5217 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5216 Int)) (and (= v_int_79_5149 (+ 1 max_5216)) (or (and (= max_5216 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5216 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5213 Int)) (and (= n_3970 (+ 1 max_5213)) (or (and (= max_5213 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5213 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5214 Int)) (and (= n (+ 1 max_5214)) (or (and (= max_5214 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5214 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5215 Int)) (and (= tn (+ 1 max_5215)) (or (and (= max_5215 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5215 n2_3783) (< n1_3779 n2_3783))))))
