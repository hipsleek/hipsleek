...
(assert (exists ((resb_6268 Int)) (= (+ resb_6268 n2_6240) (+ 1 n1_6236))))
(assert (exists ((max_6267 Int)) (and (= v_int_79_6229 (+ 1 max_6267)) (or (and (= max_6267 n1_6236) (>= n1_6236 n2_6240)) (and (= max_6267 n2_6240) (< n1_6236 n2_6240))))))
...
(assert (exists ((max_6266 Int)) (and (= tn (+ 1 max_6266)) (or (and (= max_6266 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6266 n2_3783) (< n1_3779 n2_3783))))))
