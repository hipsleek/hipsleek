...
(declare-fun m2_6239 () Int)
(declare-fun m_4610 () Int)
(declare-fun n_4611 () Int)
(declare-fun Anon_6241 () Int)
...
(assert (= Anon_6233 Anon_3776))
(assert (= p_6234 p_3777))
(assert (= q_6238 v_node_68_4129))
(assert (= m1_6235 m_4499))
(assert (= n1_6236 n_4500))
(assert (= Anon_6237 b_4501))
(assert (= m2_6239 m_4610))
(assert (= n2_6240 n_4611))
(assert (= Anon_6241 b_4612))
(assert (exists ((max_63 Int)) (and (= v_int_79_6229 (+ 1 max_63)) (or (and (= max_63 n1_6236) (>= n1_6236 n2_6240)) (and (= max_63 n2_6240) (< n1_6236 n2_6240))))))
(assert (exists ((resb_6232 Int)) (= (+ resb_6232 n2_6240) (+ 1 n1_6236))))
