...
(assert (exists ((max_5928 Int)) (and (= n (+ 1 max_5928)) (or (and (= max_5928 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5928 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5927 Int)) (and (= tn (+ 1 max_5927)) (or (and (= max_5927 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5927 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5929 Int)) (and (= n_4264 (+ 1 max_5929)) (or (and (= max_5929 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5929 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
