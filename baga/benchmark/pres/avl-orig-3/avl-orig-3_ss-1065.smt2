...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6210 Int)) (= (+ flted_44_6210 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6209 Int)) (and (= v_int_79_6168 (+ 1 max_6209)) (or (and (= max_6209 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6209 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6208 Int)) (and (= tn (+ 1 max_6208)) (or (and (= max_6208 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6208 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
