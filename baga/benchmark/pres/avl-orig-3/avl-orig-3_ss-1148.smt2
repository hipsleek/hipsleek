...
(assert (exists ((max_6408 Int)) (and (= tn (+ 1 max_6408)) (or (and (= max_6408 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6408 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((resb_6410 Int)) (= (+ resb_6410 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6409 Int)) (and (= v_int_79_6348 (+ 1 max_6409)) (or (and (= max_6409 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6409 n2_6359) (< n1_6355 n2_6359))))))
(assert (= n2_6359 n_4611))
(assert (= v_int_79_6348 (+ 1 n_4611)))
(assert (= n1_6355 0))
;Negation of Consequence
(assert (not (or (and (= v_int_79_6348 (+ 1 n1_6355)) (<= n2_6359 n1_6355)) (and (= v_int_79_6348 (+ 1 n2_6359)) (< n1_6355 n2_6359)))))
(check-sat)