...
(assert (exists ((max_6256 Int)) (and (= tn (+ 1 max_6256)) (or (and (= max_6256 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6256 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_6229 (+ 1 n1_6236)) (<= n2_6240 n1_6236)) (and (= v_int_79_6229 (+ 1 n2_6240)) (< n1_6236 n2_6240)))))
(check-sat)