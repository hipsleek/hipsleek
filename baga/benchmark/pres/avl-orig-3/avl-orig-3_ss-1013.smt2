...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6146 Int)) (= (+ resb_6146 n2_6121) (+ 1 n1_6117))))
(assert (exists ((max_6145 Int)) (and (= v_int_79_6110 (+ 1 max_6145)) (or (and (= max_6145 n1_6117) (>= n1_6117 n2_6121)) (and (= max_6145 n2_6121) (< n1_6117 n2_6121))))))
...
(assert (exists ((max_6144 Int)) (and (= tn (+ 1 max_6144)) (or (and (= max_6144 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6144 n2_3783) (< n1_3779 n2_3783))))))
