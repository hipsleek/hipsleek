...
(declare-fun r () Int)
(declare-fun n_2709 () Int)
(declare-fun b_2710 () Int)
(declare-fun m_2708 () Int)
...
(assert (<= ba1 2))
(assert (= res n_2701))
(assert (= m_2708 m_2700))
(assert (= n_2709 n_2701))
(assert (= b_2710 b_2702))
(assert (<= 0 m_2700))
(assert (<= 0 n_2701))
(assert (<= 0 b_2702))
(assert (<= b_2702 2))
...
(assert (= k2_primed 2))
(assert (or (and (and (and (< v_node_136_1719_primed 1) (= m_2708 0)) (= n_2709 0)) (= b_2710 1)) (and (and (and (and (and (<= 0 b_2710) (<= (+ (- 0 n_2709) 2) b_2710)) (<= b_2710 n_2709)) (<= b_2710 2)) (<= 1 m_2708)) (> v_node_136_1719_primed 0))))
