...
(assert (exists ((max_4313 Int)) (and (= tn (+ 1 max_4313)) (or (and (= max_4313 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4313 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4314 Int)) (and (= n (+ 1 max_4314)) (or (and (= max_4314 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4314 n2_4240) (< n1_4236 n2_4240))))))
