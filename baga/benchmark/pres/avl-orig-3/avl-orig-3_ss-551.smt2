...
(declare-fun n_4694 () Int)
(declare-fun b_4695 () Int)
(declare-fun m_4693 () Int)
...
(assert (<= b_4133 2))
(assert (= res n_4611))
(assert (= m_4693 m_4610))
(assert (= n_4694 n_4611))
(assert (= b_4695 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4693 0)) (= n_4694 0)) (= b_4695 1)) (and (and (and (and (and (<= 0 b_4695) (<= (+ (- 0 n_4694) 2) b_4695)) (<= b_4695 n_4694)) (<= b_4695 2)) (<= 1 m_4693)) (> v_node_79_2265_primed 0))))
