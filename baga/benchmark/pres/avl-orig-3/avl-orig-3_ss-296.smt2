...
(declare-fun right_55_2139_primed () Int)
(declare-fun left_55_2138_primed () Int)
(declare-fun height_55_2137_primed () Int)
(declare-fun ele_55_2136_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_55_2139_primed q_3944))
(assert (= left_55_2138_primed p_3940))
(assert (= height_55_2137_primed n_3938))
(assert (= ele_55_2136_primed Anon_3939))
...
(assert (= t_primed 1))
(assert (or (and (and (and (< p_3940 1) (= m1_3941 0)) (= n1_3942 0)) (= Anon_3943 1)) (and (and (and (and (and (<= 0 Anon_3943) (<= (+ (- 0 n1_3942) 2) Anon_3943)) (<= Anon_3943 n1_3942)) (<= Anon_3943 2)) (<= 1 m1_3941)) (> p_3940 0))))
