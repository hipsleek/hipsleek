...
(declare-fun right_68_2173_primed () Int)
(declare-fun left_68_2172_primed () Int)
(declare-fun height_68_2171_primed () Int)
(declare-fun ele_68_2170_primed () Int)
(declare-fun t () Int)
(declare-fun x () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_68_2173_primed q_3781))
(assert (= left_68_2172_primed p_3777))
(assert (= height_68_2171_primed n_3775))
(assert (= ele_68_2170_primed Anon_3776))
(assert (= t_primed t))
(assert (= x_primed x))
(assert (< tmp_primed 1))
(assert (> t_primed 0))
