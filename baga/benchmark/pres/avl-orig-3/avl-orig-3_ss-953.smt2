...
(assert (exists ((max_5877 Int)) (and (= n_4264 (+ 1 max_5877)) (or (and (= max_5877 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5877 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (exists ((max_5878 Int)) (and (= n (+ 1 max_5878)) (or (and (= max_5878 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5878 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((resb_5881 Int)) (= (+ resb_5881 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5880 Int)) (and (= v_int_79_5798 (+ 1 max_5880)) (or (and (= max_5880 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5880 n2_5809) (< n1_5805 n2_5809))))))
(assert (= n2_5809 n_4611))
(assert (= n1_5805 n_4500))
(assert (= n_3775 tn))
(assert (exists ((max_5879 Int)) (and (= tn (+ 1 max_5879)) (or (and (= max_5879 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5879 n2_3783) (< n1_3779 n2_3783))))))
(assert (= v_int_79_5798 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5809 n1_5805)) (= (+ 1 tn) v_int_79_5798)) (= tn v_int_79_5798))))
(check-sat)