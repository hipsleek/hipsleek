...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5861 Int)) (= (+ resb_5861 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5860 Int)) (and (= v_int_79_5798 (+ 1 max_5860)) (or (and (= max_5860 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5860 n2_5809) (< n1_5805 n2_5809))))))
...
(assert (exists ((max_5857 Int)) (and (= n_4264 (+ 1 max_5857)) (or (and (= max_5857 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5857 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5858 Int)) (and (= n (+ 1 max_5858)) (or (and (= max_5858 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5858 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_4153))
(assert (exists ((max_5859 Int)) (and (= tn (+ 1 max_5859)) (or (and (= max_5859 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5859 n2_3783) (< n1_3779 n2_3783))))))
