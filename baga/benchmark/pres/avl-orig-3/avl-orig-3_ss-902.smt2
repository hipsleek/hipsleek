...
(assert (= Anon_5617 b_4612))
(assert (exists ((max_63 Int)) (and (= v_int_79_5605 (+ 1 max_63)) (or (and (= max_63 n1_5612) (>= n1_5612 n2_5616)) (and (= max_63 n2_5616) (< n1_5612 n2_5616))))))
(assert (exists ((resb_5608 Int)) (= (+ resb_5608 n2_5616) (+ 1 n1_5612))))
