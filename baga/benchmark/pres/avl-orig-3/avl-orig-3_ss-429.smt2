...
(assert (exists ((max_4284 Int)) (and (= tn (+ 1 max_4284)) (or (and (= max_4284 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4284 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4285 Int)) (and (= n (+ 1 max_4285)) (or (and (= max_4285 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4285 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (not (or (= m_4263 0) (or (= n_4264 0) (< p_4234 1)))))
(check-sat)