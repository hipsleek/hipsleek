...
(declare-fun n_4163 () Int)
(declare-fun b_4164 () Int)
(declare-fun m_4162 () Int)
...
(assert (<= Anon_3780 2))
(assert (= res n_4153))
(assert (= m_4162 m_4152))
(assert (= n_4163 n_4153))
(assert (= b_4164 b_4154))
(assert (<= 0 m_4152))
(assert (<= 0 n_4153))
(assert (<= 0 b_4154))
(assert (<= b_4154 2))
...
(assert (or (and (and (and (< v_node_69_2198_primed 1) (= m_4162 0)) (= n_4163 0)) (= b_4164 1)) (and (and (and (and (and (<= 0 b_4164) (<= (+ (- 0 n_4163) 2) b_4164)) (<= b_4164 n_4163)) (<= b_4164 2)) (<= 1 m_4162)) (> v_node_69_2198_primed 0))))
