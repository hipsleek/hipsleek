...
(declare-fun res () Int)
(declare-fun v_int_136_1730_primed () Int)
(declare-fun v_int_136_1731_primed () Int)
(declare-fun n () Int)
(declare-fun b () Int)
(declare-fun m () Int)
(declare-fun lr () Int)
...
(assert (<= 0 b_2702))
(assert (<= b_2702 2))
(assert (= v_int_136_1731_primed n_2701))
(assert (<= v_int_135_2696 n_2701))
(assert (= v_int_136_1730_primed 1))
(assert (= res (+ v_int_136_1730_primed v_int_136_1731_primed)))
(assert (= k1_primed 1))
