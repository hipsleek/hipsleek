...
(assert (exists ((resb_6392 Int)) (= (+ resb_6392 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6391 Int)) (and (= v_int_79_6348 (+ 1 max_6391)) (or (and (= max_6391 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6391 n2_6359) (< n1_6355 n2_6359))))))
...
(assert (= tn_4092 0))
(assert (= n_3775 tn))
(assert (exists ((max_6390 Int)) (and (= tn (+ 1 max_6390)) (or (and (= max_6390 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6390 n2_3783) (< n1_3779 n2_3783))))))
