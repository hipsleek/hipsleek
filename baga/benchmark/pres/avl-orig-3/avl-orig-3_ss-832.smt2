...
(assert (exists ((flted_44_5583 Int)) (= (+ flted_44_5583 n2_5555) (+ 1 n1_5551))))
(assert (exists ((max_5582 Int)) (and (= v_int_79_5544 (+ 1 max_5582)) (or (and (= max_5582 n1_5551) (>= n1_5551 n2_5555)) (and (= max_5582 n2_5555) (< n1_5551 n2_5555))))))
...
(assert (exists ((max_5581 Int)) (and (= tn (+ 1 max_5581)) (or (and (= max_5581 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5581 n2_3783) (< n1_3779 n2_3783))))))
