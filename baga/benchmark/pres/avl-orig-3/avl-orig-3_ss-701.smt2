...
(assert (exists ((flted_44_5237 Int)) (= (+ flted_44_5237 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5236 Int)) (and (= v_int_79_5149 (+ 1 max_5236)) (or (and (= max_5236 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5236 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5233 Int)) (and (= n_3970 (+ 1 max_5233)) (or (and (= max_5233 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5233 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5234 Int)) (and (= n (+ 1 max_5234)) (or (and (= max_5234 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5234 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_3859))
(assert (exists ((max_5235 Int)) (and (= tn (+ 1 max_5235)) (or (and (= max_5235 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5235 n2_3783) (< n1_3779 n2_3783))))))
