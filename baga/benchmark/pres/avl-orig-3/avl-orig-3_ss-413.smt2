...
(declare-fun right_70_2230_primed () Int)
(declare-fun left_70_2229_primed () Int)
(declare-fun height_70_2228_primed () Int)
(declare-fun ele_70_2227_primed () Int)
(declare-fun Anon_4233 () Int)
(declare-fun v_node_70_2226_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_70_2230_primed q_4238))
(assert (= left_70_2229_primed p_4234))
(assert (= height_70_2228_primed n_4232))
(assert (= ele_70_2227_primed Anon_4233))
(assert (= v_node_70_2226_primed v_node_68_4127))
(assert (<= b_4246 2))
(assert (<= 0 b_4246))
(assert (<= 0 n_4245))
(assert (<= 0 m_4244))
