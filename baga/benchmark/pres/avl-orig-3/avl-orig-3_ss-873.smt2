...
(assert (exists ((flted_44_5604 Int)) (= (+ flted_44_5604 n2_5555) (+ 1 n1_5551))))
(assert (exists ((max_5603 Int)) (and (= v_int_79_5544 (+ 1 max_5603)) (or (and (= max_5603 n1_5551) (>= n1_5551 n2_5555)) (and (= max_5603 n2_5555) (< n1_5551 n2_5555))))))
...
(assert (exists ((max_5602 Int)) (and (= tn (+ 1 max_5602)) (or (and (= max_5602 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5602 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
