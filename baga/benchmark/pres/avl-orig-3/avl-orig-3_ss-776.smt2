...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5345 Int)) (= (+ flted_44_5345 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5344 Int)) (and (= v_int_79_5306 (+ 1 max_5344)) (or (and (= max_5344 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5344 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5343 Int)) (and (= tn (+ 1 max_5343)) (or (and (= max_5343 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5343 n2_3783) (< n1_3779 n2_3783))))))
