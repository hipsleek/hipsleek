...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5360 Int)) (= (+ flted_44_5360 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5359 Int)) (and (= v_int_79_5306 (+ 1 max_5359)) (or (and (= max_5359 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5359 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5358 Int)) (and (= tn (+ 1 max_5358)) (or (and (= max_5358 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5358 n2_3783) (< n1_3779 n2_3783))))))
