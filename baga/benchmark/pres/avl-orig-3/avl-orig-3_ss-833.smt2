...
(assert (exists ((flted_44_5586 Int)) (= (+ flted_44_5586 n2_5555) (+ 1 n1_5551))))
(assert (exists ((max_5585 Int)) (and (= v_int_79_5544 (+ 1 max_5585)) (or (and (= max_5585 n1_5551) (>= n1_5551 n2_5555)) (and (= max_5585 n2_5555) (< n1_5551 n2_5555))))))
...
(assert (exists ((max_5584 Int)) (and (= tn (+ 1 max_5584)) (or (and (= max_5584 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5584 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
