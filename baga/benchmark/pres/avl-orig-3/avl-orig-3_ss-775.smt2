...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5406 Int)) (= (+ resb_5406 n2_5378) (+ 1 n1_5374))))
(assert (exists ((max_5405 Int)) (and (= v_int_79_5367 (+ 1 max_5405)) (or (and (= max_5405 n1_5374) (>= n1_5374 n2_5378)) (and (= max_5405 n2_5378) (< n1_5374 n2_5378))))))
...
(assert (exists ((max_5404 Int)) (and (= tn (+ 1 max_5404)) (or (and (= max_5404 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5404 n2_3783) (< n1_3779 n2_3783))))))
