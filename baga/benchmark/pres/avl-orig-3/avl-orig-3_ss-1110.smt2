...
(assert (exists ((flted_44_6329 Int)) (= (+ flted_44_6329 n2_6298) (+ 1 n1_6294))))
(assert (exists ((max_6328 Int)) (and (= v_int_79_6287 (+ 1 max_6328)) (or (and (= max_6328 n1_6294) (>= n1_6294 n2_6298)) (and (= max_6328 n2_6298) (< n1_6294 n2_6298))))))
...
(assert (exists ((max_6327 Int)) (and (= tn (+ 1 max_6327)) (or (and (= max_6327 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6327 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
