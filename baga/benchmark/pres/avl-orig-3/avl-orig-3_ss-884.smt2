...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5773 Int)) (and (= tn (+ 1 max_5773)) (or (and (= max_5773 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5773 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((flted_44_5777 Int)) (= (+ flted_44_5777 n2_5710) (+ 1 n1_5706))))
(assert (exists ((max_5776 Int)) (and (= v_int_79_5699 (+ 1 max_5776)) (or (and (= max_5776 n1_5706) (>= n1_5706 n2_5710)) (and (= max_5776 n2_5710) (< n1_5706 n2_5710))))))
...
(assert (exists ((max_5775 Int)) (and (= n_4500 (+ 1 max_5775)) (or (and (= max_5775 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5775 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5774 Int)) (and (= n (+ 1 max_5774)) (or (and (= max_5774 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5774 n2_4240) (< n1_4236 n2_4240))))))
