...
(assert (exists ((flted_44_5014 Int)) (= (+ flted_44_5014 n2_4967) (+ 1 n1_4963))))
(assert (exists ((max_5013 Int)) (and (= v_int_79_4956 (+ 1 max_5013)) (or (and (= max_5013 n1_4963) (>= n1_4963 n2_4967)) (and (= max_5013 n2_4967) (< n1_4963 n2_4967))))))
(assert (= Anon_4968 b_4612))
(assert (= n2_4967 n_4611))
(assert (exists ((max_5012 Int)) (and (= n_4611 (+ 1 max_5012)) (or (and (= max_5012 n1_4618) (>= n1_4618 n2_4622)) (and (= max_5012 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_5011 Int)) (and (= n (+ 1 max_5011)) (or (and (= max_5011 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5011 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_5010 Int)) (and (= tn (+ 1 max_5010)) (or (and (= max_5010 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5010 n2_3783) (< n1_3779 n2_3783))))))
