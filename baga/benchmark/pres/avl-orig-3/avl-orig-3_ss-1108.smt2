...
(assert (exists ((resb_6404 Int)) (= (+ resb_6404 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6403 Int)) (and (= v_int_79_6348 (+ 1 max_6403)) (or (and (= max_6403 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6403 n2_6359) (< n1_6355 n2_6359))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_6402 Int)) (and (= tn (+ 1 max_6402)) (or (and (= max_6402 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6402 n2_3783) (< n1_3779 n2_3783))))))
