...
(assert (exists ((max_63 Int)) (and (= v_int_79_6110 (+ 1 max_63)) (or (and (= max_63 n1_6117) (>= n1_6117 n2_6121)) (and (= max_63 n2_6121) (< n1_6117 n2_6121))))))
(assert (exists ((resb_6113 Int)) (= (+ resb_6113 n2_6121) (+ 1 n1_6117))))
