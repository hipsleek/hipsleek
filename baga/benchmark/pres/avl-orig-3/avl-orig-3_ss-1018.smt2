...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6085 Int)) (= (+ flted_44_6085 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6084 Int)) (and (= v_int_79_6049 (+ 1 max_6084)) (or (and (= max_6084 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6084 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6083 Int)) (and (= tn (+ 1 max_6083)) (or (and (= max_6083 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6083 n2_3783) (< n1_3779 n2_3783))))))
