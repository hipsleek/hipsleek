...
(assert (exists ((max_4505 Int)) (and (= n (+ 1 max_4505)) (or (and (= max_4505 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4505 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (exists ((max_4504 Int)) (and (= tn (+ 1 max_4504)) (or (and (= max_4504 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4504 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (<= 0 am))
(assert (<= 0 an))
(assert (= v_node_79_2257_primed resl_4434))
(assert (or (and (and (and (< resl_4434 1) (= am 0)) (= an 0)) (= ba1 1)) (and (and (and (and (and (<= 0 ba1) (<= (+ (- 0 an) 2) ba1)) (<= ba1 an)) (<= ba1 2)) (<= 1 am)) (> resl_4434 0))))
;Negation of Consequence
(assert (not (or (= am 0) (or (= an 0) (< resl_4434 1)))))
(check-sat)