...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5464 Int)) (= (+ flted_44_5464 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5463 Int)) (and (= v_int_79_5425 (+ 1 max_5463)) (or (and (= max_5463 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5463 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5462 Int)) (and (= tn (+ 1 max_5462)) (or (and (= max_5462 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5462 n2_3783) (< n1_3779 n2_3783))))))
