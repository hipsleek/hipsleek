...
(assert (exists ((max_4990 Int)) (and (= tn (+ 1 max_4990)) (or (and (= max_4990 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4990 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4989 Int)) (and (= n (+ 1 max_4989)) (or (and (= max_4989 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4989 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4988 Int)) (and (= n_4611 (+ 1 max_4988)) (or (and (= max_4988 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4988 n2_4622) (< n1_4618 n2_4622))))))
