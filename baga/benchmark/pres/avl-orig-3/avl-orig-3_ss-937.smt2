...
(assert (exists ((flted_44_5965 Int)) (= (+ flted_44_5965 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5964 Int)) (and (= v_int_79_5892 (+ 1 max_5964)) (or (and (= max_5964 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5964 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5961 Int)) (and (= n_4264 (+ 1 max_5961)) (or (and (= max_5961 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5961 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5962 Int)) (and (= n (+ 1 max_5962)) (or (and (= max_5962 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5962 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5963 Int)) (and (= tn (+ 1 max_5963)) (or (and (= max_5963 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5963 n2_3783) (< n1_3779 n2_3783))))))
