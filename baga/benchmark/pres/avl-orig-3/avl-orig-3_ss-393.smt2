...
(declare-fun res () Int)
(declare-fun v_int_69_2208_primed () Int)
(declare-fun v_int_69_2207_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= v_int_69_2207_primed 2))
(assert (= (+ v_int_69_2208_primed n_4153) n))
(assert (<= b_4154 2))
(assert (<= 0 b_4154))
(assert (<= 0 n_4153))
(assert (<= 0 m_4152))
...
(assert (not (> res 0)))
(assert (not (= v_int_69_2208_primed v_int_69_2207_primed)))
(assert (= t_primed 1))
