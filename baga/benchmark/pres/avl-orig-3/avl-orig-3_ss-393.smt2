...
(declare-fun right_70_2225_primed () Int)
(declare-fun left_70_2224_primed () Int)
(declare-fun height_70_2223_primed () Int)
(declare-fun ele_70_2222_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_70_2225_primed v_node_68_4127))
(assert (= left_70_2224_primed p_3777))
(assert (= height_70_2223_primed n_3775))
(assert (= ele_70_2222_primed Anon_3776))
(assert (<= b_4246 2))
(assert (<= 0 b_4246))
(assert (<= 0 n_4245))
(assert (<= 0 m_4244))
