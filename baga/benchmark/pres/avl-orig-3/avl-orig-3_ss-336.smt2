...
(assert (exists ((max_3990 Int)) (and (= tn (+ 1 max_3990)) (or (and (= max_3990 n1_3779) (>= n1_3779 n2_3783)) (and (= max_3990 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_3991 Int)) (and (= n (+ 1 max_3991)) (or (and (= max_3991 n1_3942) (>= n1_3942 n2_3946)) (and (= max_3991 n2_3946) (< n1_3942 n2_3946))))))
