...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5351 Int)) (= (+ flted_44_5351 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5350 Int)) (and (= v_int_79_5306 (+ 1 max_5350)) (or (and (= max_5350 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5350 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5349 Int)) (and (= tn (+ 1 max_5349)) (or (and (= max_5349 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5349 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
