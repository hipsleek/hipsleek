...
(assert (exists ((bb1_3655 Int)) (= (+ bb1_3655 n2_3627) (+ 1 n1_3623))))
(assert (exists ((max_3654 Int)) (and (= resln_3602 (+ 1 max_3654)) (or (and (= max_3654 n1_3623) (>= n1_3623 n2_3627)) (and (= max_3654 n2_3627) (< n1_3623 n2_3627))))))
...
(assert (<= 0 ba3_3549))
(assert (<= 0 cn_3548))
(assert (exists ((max_3653 Int)) (and (= cn_3548 (+ 1 max_3653)) (or (and (= max_3653 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3653 n2_3560) (< n1_3556 n2_3560))))))
