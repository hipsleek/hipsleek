...
(declare-fun right_54_2116_primed () Int)
(declare-fun left_54_2115_primed () Int)
(declare-fun height_54_2114_primed () Int)
(declare-fun ele_54_2113_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_54_2116_primed q_3781))
(assert (= left_54_2115_primed v_node_52_3835))
(assert (= height_54_2114_primed n_3775))
(assert (= ele_54_2113_primed Anon_3776))
(assert (<= b_3839 2))
(assert (<= 0 b_3839))
(assert (<= 0 n))
(assert (<= 0 m))
