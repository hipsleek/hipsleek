...
(assert (exists ((max_63 Int)) (and (= v_int_79_4862 (+ 1 max_63)) (or (and (= max_63 n1_4869) (>= n1_4869 n2_4873)) (and (= max_63 n2_4873) (< n1_4869 n2_4873))))))
(assert (exists ((resb_4865 Int)) (= (+ resb_4865 n2_4873) (+ 1 n1_4869))))
