...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5400 Int)) (= (+ resb_5400 n2_5378) (+ 1 n1_5374))))
(assert (exists ((max_5399 Int)) (and (= v_int_79_5367 (+ 1 max_5399)) (or (and (= max_5399 n1_5374) (>= n1_5374 n2_5378)) (and (= max_5399 n2_5378) (< n1_5374 n2_5378))))))
...
(assert (exists ((max_5398 Int)) (and (= tn (+ 1 max_5398)) (or (and (= max_5398 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5398 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
