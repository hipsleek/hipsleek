...
(assert (exists ((resb_6389 Int)) (= (+ resb_6389 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6388 Int)) (and (= v_int_79_6348 (+ 1 max_6388)) (or (and (= max_6388 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6388 n2_6359) (< n1_6355 n2_6359))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_6387 Int)) (and (= tn (+ 1 max_6387)) (or (and (= max_6387 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6387 n2_3783) (< n1_3779 n2_3783))))))
