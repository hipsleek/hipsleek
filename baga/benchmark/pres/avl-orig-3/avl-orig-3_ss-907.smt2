...
(declare-fun p_5803 () Int)
(declare-fun m1_5804 () Int)
(declare-fun Anon_5806 () Int)
...
(assert (exists ((max_5831 Int)) (and (= n (+ 1 max_5831)) (or (and (= max_5831 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5831 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (exists ((max_5830 Int)) (and (= tn (+ 1 max_5830)) (or (and (= max_5830 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5830 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5832 Int)) (and (= n_4264 (+ 1 max_5832)) (or (and (= max_5832 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5832 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (= p_5803 ss1_4476))
(assert (= m1_5804 m_4499))
(assert (= Anon_5806 b_4501))
