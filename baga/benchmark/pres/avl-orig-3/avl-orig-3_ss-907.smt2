...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5736 Int)) (and (= tn (+ 1 max_5736)) (or (and (= max_5736 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5736 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5734 Int)) (and (= n_4500 (+ 1 max_5734)) (or (and (= max_5734 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5734 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5735 Int)) (and (= n (+ 1 max_5735)) (or (and (= max_5735 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5735 n2_4240) (< n1_4236 n2_4240))))))
