...
(declare-fun n_3865 () Int)
(declare-fun b_3866 () Int)
(declare-fun m_3864 () Int)
...
(assert (<= Anon_3784 2))
(assert (= res n_3859))
(assert (= m_3864 m_3858))
(assert (= n_3865 n_3859))
(assert (= b_3866 b_3860))
(assert (<= 0 m_3858))
(assert (<= 0 n_3859))
(assert (<= 0 b_3860))
(assert (<= b_3860 2))
...
(assert (or (and (and (and (< v_node_54_2120_primed 1) (= m_3864 0)) (= n_3865 0)) (= b_3866 1)) (and (and (and (and (and (<= 0 b_3866) (<= (+ (- 0 n_3865) 2) b_3866)) (<= b_3866 n_3865)) (<= b_3866 2)) (<= 1 m_3864)) (> v_node_54_2120_primed 0))))
