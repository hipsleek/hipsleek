...
(assert (exists ((max_4651 Int)) (and (= n (+ 1 max_4651)) (or (and (= max_4651 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4651 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_4650 Int)) (and (= tn (+ 1 max_4650)) (or (and (= max_4650 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4650 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= bn n_3970))
(assert (= cn n_3859))
(assert (exists ((max_4652 Int)) (and (= n_4611 (+ 1 max_4652)) (or (and (= max_4652 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4652 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (not (or (and (= n_4611 (+ n1_4618 1)) (<= n2_4622 n1_4618)) (and (= n_4611 (+ n2_4622 1)) (< n1_4618 n2_4622)))))
(check-sat)