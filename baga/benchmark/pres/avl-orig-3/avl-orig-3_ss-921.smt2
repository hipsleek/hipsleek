...
(assert (exists ((flted_44_5792 Int)) (= (+ flted_44_5792 n2_5710) (+ 1 n1_5706))))
(assert (exists ((max_5791 Int)) (and (= v_int_79_5699 (+ 1 max_5791)) (or (and (= max_5791 n1_5706) (>= n1_5706 n2_5710)) (and (= max_5791 n2_5710) (< n1_5706 n2_5710))))))
(assert (= Anon_5707 b_4501))
(assert (= n1_5706 n_4500))
(assert (exists ((max_5790 Int)) (and (= n_4500 (+ 1 max_5790)) (or (and (= max_5790 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5790 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5789 Int)) (and (= n (+ 1 max_5789)) (or (and (= max_5789 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5789 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5788 Int)) (and (= tn (+ 1 max_5788)) (or (and (= max_5788 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5788 n2_3783) (< n1_3779 n2_3783))))))
