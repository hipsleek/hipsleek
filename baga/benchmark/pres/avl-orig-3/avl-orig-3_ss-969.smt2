...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5955 Int)) (= (+ flted_44_5955 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5954 Int)) (and (= v_int_79_5892 (+ 1 max_5954)) (or (and (= max_5954 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5954 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5951 Int)) (and (= n_4264 (+ 1 max_5951)) (or (and (= max_5951 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5951 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5952 Int)) (and (= n (+ 1 max_5952)) (or (and (= max_5952 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5952 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_4153))
(assert (exists ((max_5953 Int)) (and (= tn (+ 1 max_5953)) (or (and (= max_5953 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5953 n2_3783) (< n1_3779 n2_3783))))))
