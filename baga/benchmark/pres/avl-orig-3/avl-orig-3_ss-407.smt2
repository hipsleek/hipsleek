...
(declare-fun right_70_2217_primed () Int)
(declare-fun left_70_2216_primed () Int)
(declare-fun height_70_2215_primed () Int)
(declare-fun ele_70_2214_primed () Int)
(declare-fun Anon_4233 () Int)
(declare-fun v_node_70_2213_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_70_2217_primed q_4238))
(assert (= left_70_2216_primed p_4234))
(assert (= height_70_2215_primed n_4232))
(assert (= ele_70_2214_primed Anon_4233))
(assert (= v_node_70_2213_primed v_node_68_4127))
(assert (= (+ 2 n_4153) n))
(assert (<= b_4154 2))
(assert (<= 0 b_4154))
(assert (<= 0 n_4153))
