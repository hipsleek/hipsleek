...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5202 Int)) (= (+ flted_44_5202 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5201 Int)) (and (= v_int_79_5149 (+ 1 max_5201)) (or (and (= max_5201 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5201 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5198 Int)) (and (= n_3970 (+ 1 max_5198)) (or (and (= max_5198 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5198 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5199 Int)) (and (= n (+ 1 max_5199)) (or (and (= max_5199 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5199 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5200 Int)) (and (= tn (+ 1 max_5200)) (or (and (= max_5200 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5200 n2_3783) (< n1_3779 n2_3783))))))
