...
(assert (exists ((flted_44_6458 Int)) (= (+ flted_44_6458 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6457 Int)) (and (= v_int_79_6414 (+ 1 max_6457)) (or (and (= max_6457 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6457 n2_6425) (< n1_6421 n2_6425))))))
...
(assert (= tn_4092 0))
(assert (= n_3775 tn))
(assert (exists ((max_6456 Int)) (and (= tn (+ 1 max_6456)) (or (and (= max_6456 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6456 n2_3783) (< n1_3779 n2_3783))))))
