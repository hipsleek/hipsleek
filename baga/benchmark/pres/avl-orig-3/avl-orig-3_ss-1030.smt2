...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6207 Int)) (= (+ flted_44_6207 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6206 Int)) (and (= v_int_79_6168 (+ 1 max_6206)) (or (and (= max_6206 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6206 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6205 Int)) (and (= tn (+ 1 max_6205)) (or (and (= max_6205 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6205 n2_3783) (< n1_3779 n2_3783))))))
