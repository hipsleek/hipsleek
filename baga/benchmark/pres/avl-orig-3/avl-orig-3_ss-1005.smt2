...
(assert (exists ((resb_6042 Int)) (= (+ resb_6042 n2_6002) (+ 1 n1_5998))))
(assert (exists ((max_6041 Int)) (and (= v_int_79_5991 (+ 1 max_6041)) (or (and (= max_6041 n1_5998) (>= n1_5998 n2_6002)) (and (= max_6041 n2_6002) (< n1_5998 n2_6002))))))
(assert (= n2_6002 n_4611))
(assert (= n1_5998 n_4500))
(assert (exists ((max_6040 Int)) (and (= tn (+ 1 max_6040)) (or (and (= max_6040 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6040 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_5991 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_6002 n1_5998)) (= (+ 1 tn) v_int_79_5991)) (= tn v_int_79_5991))))
(check-sat)