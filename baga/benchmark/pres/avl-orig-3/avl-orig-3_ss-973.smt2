...
(assert (exists ((flted_44_5975 Int)) (= (+ flted_44_5975 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5974 Int)) (and (= v_int_79_5892 (+ 1 max_5974)) (or (and (= max_5974 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5974 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5971 Int)) (and (= n_4264 (+ 1 max_5971)) (or (and (= max_5971 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5971 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5972 Int)) (and (= n (+ 1 max_5972)) (or (and (= max_5972 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5972 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5973 Int)) (and (= tn (+ 1 max_5973)) (or (and (= max_5973 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5973 n2_3783) (< n1_3779 n2_3783))))))
