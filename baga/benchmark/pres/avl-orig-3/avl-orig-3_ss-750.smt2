...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5357 Int)) (= (+ flted_44_5357 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5356 Int)) (and (= v_int_79_5306 (+ 1 max_5356)) (or (and (= max_5356 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5356 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5355 Int)) (and (= tn (+ 1 max_5355)) (or (and (= max_5355 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5355 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
