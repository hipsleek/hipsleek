...
(assert (exists ((max_4692 Int)) (and (= tn (+ 1 max_4692)) (or (and (= max_4692 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4692 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= v_node_79_2265_primed v_node_68_4129))
...
(assert (not (or (= m 0) (or (= n 0) (< v_node_68_4129 1)))))
(check-sat)