...
(declare-fun n_4521 () Int)
(declare-fun b_4522 () Int)
(declare-fun m_4520 () Int)
...
(assert (<= b_3839 2))
(assert (= res n_4500))
(assert (= m_4520 m_4499))
(assert (= n_4521 n_4500))
(assert (= b_4522 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4520 0)) (= n_4521 0)) (= b_4522 1)) (and (and (and (and (and (<= 0 b_4522) (<= (+ (- 0 n_4521) 2) b_4522)) (<= b_4522 n_4521)) (<= b_4522 2)) (<= 1 m_4520)) (> v_node_79_2257_primed 0))))
