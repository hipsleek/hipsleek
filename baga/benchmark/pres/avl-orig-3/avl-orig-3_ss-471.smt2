...
(declare-fun n_4574 () Int)
(declare-fun b_4575 () Int)
(declare-fun m_4573 () Int)
...
(assert (<= bb1_4477 2))
(assert (= res n_4500))
(assert (= m_4573 m_4499))
(assert (= n_4574 n_4500))
(assert (= b_4575 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4573 0)) (= n_4574 0)) (= b_4575 1)) (and (and (and (and (and (<= 0 b_4575) (<= (+ (- 0 n_4574) 2) b_4575)) (<= b_4575 n_4574)) (<= b_4575 2)) (<= 1 m_4573)) (> v_node_79_2257_primed 0))))
