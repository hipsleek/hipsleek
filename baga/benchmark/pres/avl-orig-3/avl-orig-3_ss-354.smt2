...
(declare-fun right_69_2194_primed () Int)
(declare-fun left_69_2193_primed () Int)
(declare-fun height_69_2192_primed () Int)
(declare-fun ele_69_2191_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_69_2194_primed v_node_68_4127))
(assert (= left_69_2193_primed p_3777))
(assert (= height_69_2192_primed n_3775))
(assert (= ele_69_2191_primed Anon_3776))
(assert (<= b_4133 2))
(assert (<= 0 b_4133))
(assert (<= 0 n))
(assert (<= 0 m))
