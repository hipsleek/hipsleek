...
(declare-fun n_4660 () Int)
(declare-fun b_4661 () Int)
(declare-fun m_4659 () Int)
...
(assert (> resr_4435 0))
(assert (= res n_4611))
(assert (= m_4659 m_4610))
(assert (= n_4660 n_4611))
(assert (= b_4661 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4659 0)) (= n_4660 0)) (= b_4661 1)) (and (and (and (and (and (<= 0 b_4661) (<= (+ (- 0 n_4660) 2) b_4661)) (<= b_4661 n_4660)) (<= b_4661 2)) (<= 1 m_4659)) (> v_node_79_2265_primed 0))))
