...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6039 Int)) (= (+ resb_6039 n2_6002) (+ 1 n1_5998))))
(assert (exists ((max_6038 Int)) (and (= v_int_79_5991 (+ 1 max_6038)) (or (and (= max_6038 n1_5998) (>= n1_5998 n2_6002)) (and (= max_6038 n2_6002) (< n1_5998 n2_6002))))))
...
(assert (exists ((max_6037 Int)) (and (= tn (+ 1 max_6037)) (or (and (= max_6037 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6037 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
