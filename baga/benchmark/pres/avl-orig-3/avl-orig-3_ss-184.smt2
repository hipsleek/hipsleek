...
(assert (exists ((max_63 Int)) (and (= resrn_3346 (+ 1 max_63)) (or (and (= max_63 n1_3371) (>= n1_3371 n2_3375)) (and (= max_63 n2_3375) (< n1_3371 n2_3375))))))
(assert (exists ((bb2_3353 Int)) (= (+ bb2_3353 n2_3375) (+ 1 n1_3371))))
