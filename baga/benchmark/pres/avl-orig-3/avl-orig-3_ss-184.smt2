...
(declare-fun an_3318 () Int)
(declare-fun ba1_3319 () Int)
(declare-fun am_3317 () Int)
(declare-fun resl_3327 () Int)
(declare-fun bn_3321 () Int)
(declare-fun ba2_3322 () Int)
(declare-fun bm_3320 () Int)
(declare-fun resrl_3330 () Int)
(declare-fun cn_3324 () Int)
(declare-fun ba3_3325 () Int)
(declare-fun cm_3323 () Int)
...
(assert (= am_3317 am_3287))
(assert (= an_3318 an_3288))
(assert (= ba1_3319 ba1_3289))
(assert (= bm_3320 bm_3290))
(assert (= bn_3321 bn_3291))
(assert (= ba2_3322 ba2_3292))
(assert (= cm_3323 cm_3283))
(assert (= cn_3324 cn_3284))
(assert (= ba3_3325 ba3_3285))
(assert (<= 0 cm_3283))
(assert (<= 0 cn_3284))
(assert (<= 0 ba3_3285))
(assert (<= ba3_3285 2))
...
(assert (<= ba2_3292 2))
(assert (= res 1))
(assert (or (and (and (and (< resl_3327 1) (= am_3317 0)) (= an_3318 0)) (= ba1_3319 1)) (and (and (and (and (and (<= 0 ba1_3319) (<= (+ (- 0 an_3318) 2) ba1_3319)) (<= ba1_3319 an_3318)) (<= ba1_3319 2)) (<= 1 am_3317)) (> resl_3327 0))))
(assert (= resr_3328 2))
(assert (or (and (and (and (< resrl_3330 1) (= bm_3320 0)) (= bn_3321 0)) (= ba2_3322 1)) (and (and (and (and (and (<= 0 ba2_3322) (<= (+ (- 0 bn_3321) 2) ba2_3322)) (<= ba2_3322 bn_3321)) (<= ba2_3322 2)) (<= 1 bm_3320)) (> resrl_3330 0))))
(assert (or (and (and (and (< resrr_3331 1) (= cm_3323 0)) (= cn_3324 0)) (= ba3_3325 1)) (and (and (and (and (and (<= 0 ba3_3325) (<= (+ (- 0 cn_3324) 2) ba3_3325)) (<= ba3_3325 cn_3324)) (<= ba3_3325 2)) (<= 1 cm_3323)) (> resrr_3331 0))))
