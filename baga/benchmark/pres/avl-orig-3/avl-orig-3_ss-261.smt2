...
(declare-fun n_3848 () Int)
(declare-fun b_3849 () Int)
(declare-fun m_3847 () Int)
...
(assert (= t_primed 1))
(assert (or (and (and (and (< v_node_54_2112_primed 1) (= m_3847 0)) (= n_3848 0)) (= b_3849 1)) (and (and (and (and (and (<= 0 b_3849) (<= (+ (- 0 n_3848) 2) b_3849)) (<= b_3849 n_3848)) (<= b_3849 2)) (<= 1 m_3847)) (> v_node_54_2112_primed 0))))
