...
(assert (exists ((max_63 Int)) (and (= v_int_79_5486 (+ 1 max_63)) (or (and (= max_63 n1_5493) (>= n1_5493 n2_5497)) (and (= max_63 n2_5497) (< n1_5493 n2_5497))))))
(assert (exists ((resb_5489 Int)) (= (+ resb_5489 n2_5497) (+ 1 n1_5493))))
