...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5742 Int)) (and (= tn (+ 1 max_5742)) (or (and (= max_5742 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5742 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5740 Int)) (and (= n_4500 (+ 1 max_5740)) (or (and (= max_5740 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5740 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5741 Int)) (and (= n (+ 1 max_5741)) (or (and (= max_5741 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5741 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (not (or (and (= v_int_79_5699 (+ 1 n1_5706)) (<= n2_5710 n1_5706)) (and (= v_int_79_5699 (+ 1 n2_5710)) (< n1_5706 n2_5710)))))
(check-sat)