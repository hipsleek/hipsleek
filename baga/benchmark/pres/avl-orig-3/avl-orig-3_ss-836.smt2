...
(assert (exists ((flted_44_5595 Int)) (= (+ flted_44_5595 n2_5555) (+ 1 n1_5551))))
(assert (exists ((max_5594 Int)) (and (= v_int_79_5544 (+ 1 max_5594)) (or (and (= max_5594 n1_5551) (>= n1_5551 n2_5555)) (and (= max_5594 n2_5555) (< n1_5551 n2_5555))))))
...
(assert (exists ((max_5593 Int)) (and (= tn (+ 1 max_5593)) (or (and (= max_5593 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5593 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
