...
(declare-fun n_3977 () Int)
(declare-fun b_3978 () Int)
(declare-fun m_3976 () Int)
...
(assert (<= Anon_3947 2))
(assert (= res n_3970))
(assert (= m_3976 m_3969))
(assert (= n_3977 n_3970))
(assert (= b_3978 b_3971))
(assert (<= 0 m_3969))
(assert (<= 0 n_3970))
(assert (<= 0 b_3971))
(assert (<= b_3971 2))
(assert (= t_primed 1))
(assert (= v_node_52_3833 2))
...
(assert (or (and (and (and (< v_node_55_2156_primed 1) (= m_3976 0)) (= n_3977 0)) (= b_3978 1)) (and (and (and (and (and (<= 0 b_3978) (<= (+ (- 0 n_3977) 2) b_3978)) (<= b_3978 n_3977)) (<= b_3978 2)) (<= 1 m_3976)) (> v_node_55_2156_primed 0))))
(assert (not (= t_primed v_node_52_3833)))
