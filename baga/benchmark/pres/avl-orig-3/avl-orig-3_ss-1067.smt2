...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((flted_44_6216 Int)) (= (+ flted_44_6216 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6215 Int)) (and (= v_int_79_6168 (+ 1 max_6215)) (or (and (= max_6215 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6215 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6214 Int)) (and (= tn (+ 1 max_6214)) (or (and (= max_6214 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6214 n2_3783) (< n1_3779 n2_3783))))))
