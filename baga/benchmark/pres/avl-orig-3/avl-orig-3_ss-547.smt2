...
(declare-fun n_4690 () Int)
(declare-fun b_4691 () Int)
(declare-fun m_4689 () Int)
...
(assert (<= b_4133 2))
(assert (= res n_4611))
(assert (= m_4689 m_4610))
(assert (= n_4690 n_4611))
(assert (= b_4691 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4689 0)) (= n_4690 0)) (= b_4691 1)) (and (and (and (and (and (<= 0 b_4691) (<= (+ (- 0 n_4690) 2) b_4691)) (<= b_4691 n_4690)) (<= b_4691 2)) (<= 1 m_4689)) (> v_node_79_2265_primed 0))))
