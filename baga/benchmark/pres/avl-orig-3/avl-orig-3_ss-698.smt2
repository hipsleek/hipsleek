...
(assert (exists ((flted_44_5222 Int)) (= (+ flted_44_5222 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5221 Int)) (and (= v_int_79_5149 (+ 1 max_5221)) (or (and (= max_5221 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5221 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5218 Int)) (and (= n_3970 (+ 1 max_5218)) (or (and (= max_5218 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5218 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5219 Int)) (and (= n (+ 1 max_5219)) (or (and (= max_5219 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5219 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5220 Int)) (and (= tn (+ 1 max_5220)) (or (and (= max_5220 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5220 n2_3783) (< n1_3779 n2_3783))))))
