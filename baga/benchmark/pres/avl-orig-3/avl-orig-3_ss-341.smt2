...
(assert (exists ((max_4017 Int)) (and (= tn (+ 1 max_4017)) (or (and (= max_4017 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4017 n2_3783) (< n1_3779 n2_3783))))))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (= n_3938 n))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (exists ((max_4018 Int)) (and (= n (+ 1 max_4018)) (or (and (= max_4018 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4018 n2_3946) (< n1_3942 n2_3946))))))
