...
(assert (exists ((flted_44_6467 Int)) (= (+ flted_44_6467 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6466 Int)) (and (= v_int_79_6414 (+ 1 max_6466)) (or (and (= max_6466 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6466 n2_6425) (< n1_6421 n2_6425))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_6465 Int)) (and (= tn (+ 1 max_6465)) (or (and (= max_6465 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6465 n2_3783) (< n1_3779 n2_3783))))))
