...
(assert (exists ((max_5179 Int)) (and (= n (+ 1 max_5179)) (or (and (= max_5179 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5179 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (exists ((max_5178 Int)) (and (= tn (+ 1 max_5178)) (or (and (= max_5178 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5178 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5180 Int)) (and (= n_3970 (+ 1 max_5180)) (or (and (= max_5180 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5180 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
