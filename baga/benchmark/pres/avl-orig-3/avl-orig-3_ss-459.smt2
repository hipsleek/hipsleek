...
(declare-fun n_4507 () Int)
(declare-fun b_4508 () Int)
(declare-fun m_4506 () Int)
...
(assert (<= ba1 2))
(assert (= res n_4500))
(assert (= m_4506 m_4499))
(assert (= n_4507 n_4500))
(assert (= b_4508 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4506 0)) (= n_4507 0)) (= b_4508 1)) (and (and (and (and (and (<= 0 b_4508) (<= (+ (- 0 n_4507) 2) b_4508)) (<= b_4508 n_4507)) (<= b_4508 2)) (<= 1 m_4506)) (> v_node_79_2257_primed 0))))
(assert (not (= t_primed resr_4435)))
