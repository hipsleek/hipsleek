...
(assert (exists ((flted_44_6344 Int)) (= (+ flted_44_6344 n2_6298) (+ 1 n1_6294))))
(assert (exists ((max_6343 Int)) (and (= v_int_79_6287 (+ 1 max_6343)) (or (and (= max_6343 n1_6294) (>= n1_6294 n2_6298)) (and (= max_6343 n2_6298) (< n1_6294 n2_6298))))))
...
(assert (exists ((max_6342 Int)) (and (= tn (+ 1 max_6342)) (or (and (= max_6342 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6342 n2_3783) (< n1_3779 n2_3783))))))
