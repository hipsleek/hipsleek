...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6030 Int)) (= (+ resb_6030 n2_6002) (+ 1 n1_5998))))
(assert (exists ((max_6029 Int)) (and (= v_int_79_5991 (+ 1 max_6029)) (or (and (= max_6029 n1_5998) (>= n1_5998 n2_6002)) (and (= max_6029 n2_6002) (< n1_5998 n2_6002))))))
...
(assert (exists ((max_6028 Int)) (and (= tn (+ 1 max_6028)) (or (and (= max_6028 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6028 n2_3783) (< n1_3779 n2_3783))))))
