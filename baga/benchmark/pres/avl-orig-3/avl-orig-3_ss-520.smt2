...
(assert (exists ((max_4683 Int)) (and (= n (+ 1 max_4683)) (or (and (= max_4683 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4683 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (exists ((max_4684 Int)) (and (= tn (+ 1 max_4684)) (or (and (= max_4684 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4684 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4682 Int)) (and (= n_4264 (+ 1 max_4682)) (or (and (= max_4682 n1_4343) (>= n1_4343 n2_4347)) (and (= max_4682 n2_4347) (< n1_4343 n2_4347))))))
...
(assert (not (or (= flted_115_4473 0) (or (= h2_4484 0) (< ss3_4478 1)))))
(check-sat)