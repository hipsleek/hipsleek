...
(assert (exists ((resb_6277 Int)) (= (+ resb_6277 n2_6240) (+ 1 n1_6236))))
(assert (exists ((max_6276 Int)) (and (= v_int_79_6229 (+ 1 max_6276)) (or (and (= max_6276 n1_6236) (>= n1_6236 n2_6240)) (and (= max_6276 n2_6240) (< n1_6236 n2_6240))))))
...
(assert (exists ((max_6275 Int)) (and (= tn (+ 1 max_6275)) (or (and (= max_6275 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6275 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
