...
(assert (exists ((max_6162 Int)) (and (= tn (+ 1 max_6162)) (or (and (= max_6162 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6162 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((resb_6164 Int)) (= (+ resb_6164 n2_6121) (+ 1 n1_6117))))
(assert (exists ((max_6163 Int)) (and (= v_int_79_6110 (+ 1 max_6163)) (or (and (= max_6163 n1_6117) (>= n1_6117 n2_6121)) (and (= max_6163 n2_6121) (< n1_6117 n2_6121))))))
(assert (= n2_6121 n_4611))
(assert (= n1_6117 n_4500))
(assert (= v_int_79_6110 (+ 1 n_4611)))
;Negation of Consequence
(assert (not (or (and (= v_int_79_6110 (+ 1 n1_6117)) (<= n2_6121 n1_6117)) (and (= v_int_79_6110 (+ 1 n2_6121)) (< n1_6117 n2_6121)))))
(check-sat)