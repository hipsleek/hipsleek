...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5960 Int)) (= (+ flted_44_5960 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5959 Int)) (and (= v_int_79_5892 (+ 1 max_5959)) (or (and (= max_5959 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5959 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5956 Int)) (and (= n_4264 (+ 1 max_5956)) (or (and (= max_5956 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5956 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5957 Int)) (and (= n (+ 1 max_5957)) (or (and (= max_5957 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5957 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5958 Int)) (and (= tn (+ 1 max_5958)) (or (and (= max_5958 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5958 n2_3783) (< n1_3779 n2_3783))))))
