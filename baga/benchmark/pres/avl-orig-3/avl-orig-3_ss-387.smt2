...
(declare-fun n1_4225 () Int)
(declare-fun Anon_4226 () Int)
(declare-fun m1_4224 () Int)
(declare-fun p_4223 () Int)
(declare-fun n2_4229 () Int)
(declare-fun Anon_4230 () Int)
(declare-fun m2_4228 () Int)
(declare-fun q_4227 () Int)
...
;Axioms assertions
;Antecedent
(assert (= m (+ (+ m2_4228 1) m1_4224)))
(assert (exists ((max_63 Int)) (and (= n (+ 1 max_63)) (or (and (= max_63 n1_4225) (>= n1_4225 n2_4229)) (and (= max_63 n2_4229) (< n1_4225 n2_4229))))))
(assert (= (+ b_4133 n2_4229) (+ 1 n1_4225)))
(assert (<= n2_4229 (+ 1 n1_4225)))
(assert (<= n1_4225 (+ n2_4229 1)))
(assert (= n_4221 n))
...
(assert (= t_primed 1))
(assert (= v_node_70_2213_primed 2))
(assert (or (and (and (and (< p_4223 1) (= m1_4224 0)) (= n1_4225 0)) (= Anon_4226 1)) (and (and (and (and (and (<= 0 Anon_4226) (<= (+ (- 0 n1_4225) 2) Anon_4226)) (<= Anon_4226 n1_4225)) (<= Anon_4226 2)) (<= 1 m1_4224)) (> p_4223 0))))
(assert (or (and (and (and (< q_4227 1) (= m2_4228 0)) (= n2_4229 0)) (= Anon_4230 1)) (and (and (and (and (and (<= 0 Anon_4230) (<= (+ (- 0 n2_4229) 2) Anon_4230)) (<= Anon_4230 n2_4229)) (<= Anon_4230 2)) (<= 1 m2_4228)) (> q_4227 0))))
...
(assert (not (= t_primed v_node_70_2213_primed)))
