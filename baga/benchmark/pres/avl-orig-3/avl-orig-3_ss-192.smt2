...
(assert (exists ((max_3390 Int)) (and (= an_3288 (+ 1 max_3390)) (or (and (= max_3390 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3390 n2_3303) (< n1_3299 n2_3303))))))
