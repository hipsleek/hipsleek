...
;Axioms assertions
;Antecedent
(assert (exists ((bb2_3454 Int)) (= (+ bb2_3454 n2_3375) (+ 1 n1_3371))))
(assert (<= 0 dn))
(assert (<= 0 cn_3236))
...
(assert (exists ((max_3453 Int)) (and (= resrn_3346 (+ 1 max_3453)) (or (and (= max_3453 n1_3371) (>= n1_3371 n2_3375)) (and (= max_3453 n2_3375) (< n1_3371 n2_3375))))))
...
(assert (exists ((max_3452 Int)) (and (= an_3288 (+ 1 max_3452)) (or (and (= max_3452 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3452 n2_3303) (< n1_3299 n2_3303))))))
(assert (<= 0 an_3288))
;Negation of Consequence
(assert (not (or (and (= (+ an 1) an_3288) (< bn an_3288)) (and (= (+ bn 1) an_3288) (<= (+ an 2) an_3288)))))
(check-sat)