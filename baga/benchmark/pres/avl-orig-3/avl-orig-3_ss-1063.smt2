...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6204 Int)) (= (+ flted_44_6204 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6203 Int)) (and (= v_int_79_6168 (+ 1 max_6203)) (or (and (= max_6203 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6203 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6202 Int)) (and (= tn (+ 1 max_6202)) (or (and (= max_6202 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6202 n2_3783) (< n1_3779 n2_3783))))))
