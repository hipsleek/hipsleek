...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5856 Int)) (= (+ resb_5856 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5855 Int)) (and (= v_int_79_5798 (+ 1 max_5855)) (or (and (= max_5855 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5855 n2_5809) (< n1_5805 n2_5809))))))
...
(assert (exists ((max_5852 Int)) (and (= n_4264 (+ 1 max_5852)) (or (and (= max_5852 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5852 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5853 Int)) (and (= n (+ 1 max_5853)) (or (and (= max_5853 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5853 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_4153))
(assert (exists ((max_5854 Int)) (and (= tn (+ 1 max_5854)) (or (and (= max_5854 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5854 n2_3783) (< n1_3779 n2_3783))))))
