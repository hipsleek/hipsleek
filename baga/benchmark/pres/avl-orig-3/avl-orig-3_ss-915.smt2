...
(assert (exists ((flted_44_5762 Int)) (= (+ flted_44_5762 n2_5710) (+ 1 n1_5706))))
(assert (exists ((max_5761 Int)) (and (= v_int_79_5699 (+ 1 max_5761)) (or (and (= max_5761 n1_5706) (>= n1_5706 n2_5710)) (and (= max_5761 n2_5710) (< n1_5706 n2_5710))))))
(assert (= Anon_5707 b_4501))
(assert (= n1_5706 n_4500))
(assert (exists ((max_5760 Int)) (and (= n_4500 (+ 1 max_5760)) (or (and (= max_5760 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5760 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5759 Int)) (and (= n (+ 1 max_5759)) (or (and (= max_5759 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5759 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5758 Int)) (and (= tn (+ 1 max_5758)) (or (and (= max_5758 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5758 n2_3783) (< n1_3779 n2_3783))))))
