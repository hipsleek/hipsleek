...
(assert (exists ((max_3642 Int)) (and (= cn_3548 (+ 1 max_3642)) (or (and (= max_3642 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3642 n2_3560) (< n1_3556 n2_3560))))))
