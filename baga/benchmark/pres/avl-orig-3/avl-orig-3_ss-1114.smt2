...
(assert (exists ((flted_44_6341 Int)) (= (+ flted_44_6341 n2_6298) (+ 1 n1_6294))))
(assert (exists ((max_6340 Int)) (and (= v_int_79_6287 (+ 1 max_6340)) (or (and (= max_6340 n1_6294) (>= n1_6294 n2_6298)) (and (= max_6340 n2_6298) (< n1_6294 n2_6298))))))
...
(assert (exists ((max_6339 Int)) (and (= tn (+ 1 max_6339)) (or (and (= max_6339 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6339 n2_3783) (< n1_3779 n2_3783))))))
