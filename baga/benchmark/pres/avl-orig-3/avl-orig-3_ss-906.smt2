...
(assert (exists ((max_5828 Int)) (and (= n (+ 1 max_5828)) (or (and (= max_5828 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5828 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5827 Int)) (and (= tn (+ 1 max_5827)) (or (and (= max_5827 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5827 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5829 Int)) (and (= n_4264 (+ 1 max_5829)) (or (and (= max_5829 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5829 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (not (or (= m_4499 0) (or (= n_4500 0) (< ss1_4476 1)))))
(check-sat)