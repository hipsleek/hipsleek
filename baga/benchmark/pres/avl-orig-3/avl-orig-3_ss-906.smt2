...
(assert (exists ((max_5733 Int)) (and (= tn (+ 1 max_5733)) (or (and (= max_5733 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5733 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5731 Int)) (and (= n_4500 (+ 1 max_5731)) (or (and (= max_5731 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5731 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5732 Int)) (and (= n (+ 1 max_5732)) (or (and (= max_5732 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5732 n2_4240) (< n1_4236 n2_4240))))))
