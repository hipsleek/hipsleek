...
(assert (exists ((flted_44_6464 Int)) (= (+ flted_44_6464 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6463 Int)) (and (= v_int_79_6414 (+ 1 max_6463)) (or (and (= max_6463 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6463 n2_6425) (< n1_6421 n2_6425))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_6462 Int)) (and (= tn (+ 1 max_6462)) (or (and (= max_6462 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6462 n2_3783) (< n1_3779 n2_3783))))))
