...
(declare-fun h_4374 () Int)
(declare-fun t_4375 () Int)
(declare-fun t1_4377 () Int)
(declare-fun t2_4379 () Int)
(declare-fun am () Int)
(declare-fun an () Int)
...
(declare-fun res () Int)
(declare-fun h1_4376 () Int)
(declare-fun bb1_4371 () Int)
(declare-fun flted_114_4368 () Int)
(declare-fun ss1_4370 () Int)
(declare-fun h2_4378 () Int)
(declare-fun bb2_4373 () Int)
(declare-fun flted_115_4367 () Int)
(declare-fun ss3_4372 () Int)
...
(assert (<= b_4154 2))
(assert (> t_primed 0))
(assert (= flted_114_4368 (+ (+ 1 am) bm)))
(assert (= flted_115_4367 (+ (+ 1 cm) dm)))
(assert (= h_4374 (+ t_4375 1)))
(assert (or (and (= t_4375 h1_4376) (>= h1_4376 h2_4378)) (and (= t_4375 h2_4378) (< h1_4376 h2_4378))))
(assert (= h1_4376 (+ t1_4377 1)))
(assert (or (and (= t1_4377 an) (>= an bn)) (and (= t1_4377 bn) (< an bn))))
(assert (= h2_4378 (+ t2_4379 1)))
(assert (or (and (= t2_4379 cn) (>= cn dn)) (and (= t2_4379 dn) (< cn dn))))
(assert (<= 0 am))
(assert (<= 0 an))
(assert (<= 0 Anon_31))
(assert (<= Anon_31 2))
...
(assert (<= Anon_38 2))
(assert (= res 1))
(assert (or (and (and (and (< ss1_4370 1) (= flted_114_4368 0)) (= h1_4376 0)) (= bb1_4371 1)) (and (and (and (and (and (<= 0 bb1_4371) (<= (+ (- 0 h1_4376) 2) bb1_4371)) (<= bb1_4371 h1_4376)) (<= bb1_4371 2)) (<= 1 flted_114_4368)) (> ss1_4370 0))))
(assert (or (and (and (and (< ss3_4372 1) (= flted_115_4367 0)) (= h2_4378 0)) (= bb2_4373 1)) (and (and (and (and (and (<= 0 bb2_4373) (<= (+ (- 0 h2_4378) 2) bb2_4373)) (<= bb2_4373 h2_4378)) (<= bb2_4373 2)) (<= 1 flted_115_4367)) (> ss3_4372 0))))
