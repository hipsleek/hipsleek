...
(assert (exists ((max_3315 Int)) (and (= an_3288 (+ 1 max_3315)) (or (and (= max_3315 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3315 n2_3303) (< n1_3299 n2_3303))))))
...
(assert (not (= (+ n2_3303 ba1_3289) (+ n1_3299 1))))
(check-sat)