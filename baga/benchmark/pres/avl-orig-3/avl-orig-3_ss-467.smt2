...
(declare-fun n_4517 () Int)
(declare-fun b_4518 () Int)
(declare-fun m_4516 () Int)
...
(assert (= v_node_79_2257_primed v_node_52_3833))
(assert (= m_4499 m))
(assert (= n_4500 n))
...
(assert (<= b_3839 2))
(assert (= res n_4500))
(assert (= m_4516 m_4499))
(assert (= n_4517 n_4500))
(assert (= b_4518 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4516 0)) (= n_4517 0)) (= b_4518 1)) (and (and (and (and (and (<= 0 b_4518) (<= (+ (- 0 n_4517) 2) b_4518)) (<= b_4518 n_4517)) (<= b_4518 2)) (<= 1 m_4516)) (> v_node_79_2257_primed 0))))
