...
(assert (<= 0 n1_3779))
(assert (= n_3775 tn))
(assert (exists ((max_4996 Int)) (and (= tn (+ 1 max_4996)) (or (and (= max_4996 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4996 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4994 Int)) (and (= n_4611 (+ 1 max_4994)) (or (and (= max_4994 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4994 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4995 Int)) (and (= n (+ 1 max_4995)) (or (and (= max_4995 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4995 n2_3946) (< n1_3942 n2_3946))))))
