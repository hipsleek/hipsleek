...
(assert (exists ((max_4654 Int)) (and (= n (+ 1 max_4654)) (or (and (= max_4654 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4654 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_4653 Int)) (and (= tn (+ 1 max_4653)) (or (and (= max_4653 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4653 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4655 Int)) (and (= n_4611 (+ 1 max_4655)) (or (and (= max_4655 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4655 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (not (= (+ n2_4622 b_4612) (+ n1_4618 1))))
(check-sat)