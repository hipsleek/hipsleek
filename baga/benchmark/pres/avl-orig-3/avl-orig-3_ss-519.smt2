...
(declare-fun n_4680 () Int)
(declare-fun b_4681 () Int)
(declare-fun m_4679 () Int)
...
(assert (<= ba3 2))
(assert (= res n_4611))
(assert (= m_4679 m_4610))
(assert (= n_4680 n_4611))
(assert (= b_4681 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4679 0)) (= n_4680 0)) (= b_4681 1)) (and (and (and (and (and (<= 0 b_4681) (<= (+ (- 0 n_4680) 2) b_4681)) (<= b_4681 n_4680)) (<= b_4681 2)) (<= 1 m_4679)) (> v_node_79_2265_primed 0))))
