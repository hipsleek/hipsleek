...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5739 Int)) (and (= tn (+ 1 max_5739)) (or (and (= max_5739 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5739 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5737 Int)) (and (= n_4500 (+ 1 max_5737)) (or (and (= max_5737 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5737 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5738 Int)) (and (= n (+ 1 max_5738)) (or (and (= max_5738 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5738 n2_4240) (< n1_4236 n2_4240))))))
