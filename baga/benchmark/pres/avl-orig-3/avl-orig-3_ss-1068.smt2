...
(assert (< 0 tm_4091))
(assert (<= 0 m2_3782))
(assert (exists ((flted_44_6219 Int)) (= (+ flted_44_6219 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6218 Int)) (and (= v_int_79_6168 (+ 1 max_6218)) (or (and (= max_6218 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6218 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6217 Int)) (and (= tn (+ 1 max_6217)) (or (and (= max_6217 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6217 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
