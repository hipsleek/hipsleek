...
(assert (= n_3775 tn))
(assert (<= 0 n_3859))
(assert (exists ((max_4069 Int)) (and (= tn (+ 1 max_4069)) (or (and (= max_4069 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4069 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4067 Int)) (and (= n_3970 (+ 1 max_4067)) (or (and (= max_4067 n1_4049) (>= n1_4049 n2_4053)) (and (= max_4067 n2_4053) (< n1_4049 n2_4053))))))
(assert (= (+ b_3971 n2_4053) (+ 1 n1_4049)))
(assert (<= n2_4053 (+ 1 n1_4049)))
(assert (<= n1_4049 (+ n2_4053 1)))
(assert (= n_4045 n_3970))
(assert (<= n_3951 n_3970))
(assert (exists ((max_4068 Int)) (and (= n (+ 1 max_4068)) (or (and (= max_4068 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4068 n2_3946) (< n1_3942 n2_3946))))))
