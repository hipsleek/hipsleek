...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5645 Int)) (and (= tn (+ 1 max_5645)) (or (and (= max_5645 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5645 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5643 Int)) (and (= n_4500 (+ 1 max_5643)) (or (and (= max_5643 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5643 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5644 Int)) (and (= n (+ 1 max_5644)) (or (and (= max_5644 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5644 n2_4240) (< n1_4236 n2_4240))))))
