...
(assert (exists ((flted_44_6332 Int)) (= (+ flted_44_6332 n2_6298) (+ 1 n1_6294))))
(assert (exists ((max_6331 Int)) (and (= v_int_79_6287 (+ 1 max_6331)) (or (and (= max_6331 n1_6294) (>= n1_6294 n2_6298)) (and (= max_6331 n2_6298) (< n1_6294 n2_6298))))))
...
(assert (exists ((max_6330 Int)) (and (= tn (+ 1 max_6330)) (or (and (= max_6330 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6330 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
