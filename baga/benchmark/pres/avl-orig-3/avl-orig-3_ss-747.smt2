...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5348 Int)) (= (+ flted_44_5348 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5347 Int)) (and (= v_int_79_5306 (+ 1 max_5347)) (or (and (= max_5347 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5347 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5346 Int)) (and (= tn (+ 1 max_5346)) (or (and (= max_5346 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5346 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
