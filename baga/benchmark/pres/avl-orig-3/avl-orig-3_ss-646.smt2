...
(assert (exists ((flted_44_5039 Int)) (= (+ flted_44_5039 n2_4967) (+ 1 n1_4963))))
(assert (exists ((max_5038 Int)) (and (= v_int_79_4956 (+ 1 max_5038)) (or (and (= max_5038 n1_4963) (>= n1_4963 n2_4967)) (and (= max_5038 n2_4967) (< n1_4963 n2_4967))))))
(assert (= Anon_4968 b_4612))
(assert (= n2_4967 n_4611))
(assert (exists ((max_5037 Int)) (and (= n_4611 (+ 1 max_5037)) (or (and (= max_5037 n1_4618) (>= n1_4618 n2_4622)) (and (= max_5037 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_5036 Int)) (and (= n (+ 1 max_5036)) (or (and (= max_5036 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5036 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_5035 Int)) (and (= tn (+ 1 max_5035)) (or (and (= max_5035 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5035 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
