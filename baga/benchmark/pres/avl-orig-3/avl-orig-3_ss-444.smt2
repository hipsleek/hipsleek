...
(declare-fun n_4513 () Int)
(declare-fun b_4514 () Int)
(declare-fun m_4512 () Int)
...
(assert (<= bb1_4448 2))
(assert (= res n_4500))
(assert (= m_4512 m_4499))
(assert (= n_4513 n_4500))
(assert (= b_4514 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4512 0)) (= n_4513 0)) (= b_4514 1)) (and (and (and (and (and (<= 0 b_4514) (<= (+ (- 0 n_4513) 2) b_4514)) (<= b_4514 n_4513)) (<= b_4514 2)) (<= 1 m_4512)) (> v_node_79_2257_primed 0))))
