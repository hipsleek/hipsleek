...
(assert (exists ((resb_5683 Int)) (= (+ resb_5683 n2_5616) (+ 1 n1_5612))))
(assert (exists ((max_5682 Int)) (and (= v_int_79_5605 (+ 1 max_5682)) (or (and (= max_5682 n1_5612) (>= n1_5612 n2_5616)) (and (= max_5682 n2_5616) (< n1_5612 n2_5616))))))
(assert (= Anon_5613 b_4501))
(assert (= n1_5612 n_4500))
(assert (exists ((max_5681 Int)) (and (= n_4500 (+ 1 max_5681)) (or (and (= max_5681 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5681 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5680 Int)) (and (= n (+ 1 max_5680)) (or (and (= max_5680 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5680 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5679 Int)) (and (= tn (+ 1 max_5679)) (or (and (= max_5679 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5679 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
