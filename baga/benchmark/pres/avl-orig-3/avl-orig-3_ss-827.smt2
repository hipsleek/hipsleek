...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5482 Int)) (= (+ flted_44_5482 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5481 Int)) (and (= v_int_79_5425 (+ 1 max_5481)) (or (and (= max_5481 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5481 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5480 Int)) (and (= tn (+ 1 max_5480)) (or (and (= max_5480 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5480 n2_3783) (< n1_3779 n2_3783))))))
