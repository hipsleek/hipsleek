...
(assert (exists ((max_5571 Int)) (and (= tn (+ 1 max_5571)) (or (and (= max_5571 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5571 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_5544 (+ 1 n1_5551)) (<= n2_5555 n1_5551)) (and (= v_int_79_5544 (+ 1 n2_5555)) (< n1_5551 n2_5555)))))
(check-sat)