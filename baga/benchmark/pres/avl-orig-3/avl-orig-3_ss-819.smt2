...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5458 Int)) (= (+ flted_44_5458 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5457 Int)) (and (= v_int_79_5425 (+ 1 max_5457)) (or (and (= max_5457 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5457 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5456 Int)) (and (= tn (+ 1 max_5456)) (or (and (= max_5456 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5456 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
