...
(assert (exists ((resb_5534 Int)) (= (+ resb_5534 n2_5497) (+ 1 n1_5493))))
(assert (exists ((max_5533 Int)) (and (= v_int_79_5486 (+ 1 max_5533)) (or (and (= max_5533 n1_5493) (>= n1_5493 n2_5497)) (and (= max_5533 n2_5497) (< n1_5493 n2_5497))))))
...
(assert (exists ((max_5532 Int)) (and (= tn (+ 1 max_5532)) (or (and (= max_5532 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5532 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
