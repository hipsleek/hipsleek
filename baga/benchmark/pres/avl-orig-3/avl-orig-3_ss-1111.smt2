...
(assert (exists ((max_6411 Int)) (and (= tn (+ 1 max_6411)) (or (and (= max_6411 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6411 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= n_4611 n))
(assert (exists ((resb_6413 Int)) (= (+ resb_6413 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6412 Int)) (and (= v_int_79_6348 (+ 1 max_6412)) (or (and (= max_6412 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6412 n2_6359) (< n1_6355 n2_6359))))))
...
(assert (not (= (+ (+ m1_6354 m2_6358) 1) (+ tm 1))))
(check-sat)