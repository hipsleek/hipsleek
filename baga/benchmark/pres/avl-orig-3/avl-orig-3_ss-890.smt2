...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5648 Int)) (and (= tn (+ 1 max_5648)) (or (and (= max_5648 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5648 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5646 Int)) (and (= n_4500 (+ 1 max_5646)) (or (and (= max_5646 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5646 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5647 Int)) (and (= n (+ 1 max_5647)) (or (and (= max_5647 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5647 n2_4240) (< n1_4236 n2_4240))))))
