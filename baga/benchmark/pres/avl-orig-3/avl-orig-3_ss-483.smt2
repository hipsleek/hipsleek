...
(assert (exists ((max_4562 Int)) (and (= n (+ 1 max_4562)) (or (and (= max_4562 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4562 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_4561 Int)) (and (= tn (+ 1 max_4561)) (or (and (= max_4561 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4561 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4563 Int)) (and (= n_4500 (+ 1 max_4563)) (or (and (= max_4563 n1_4526) (>= n1_4526 n2_4530)) (and (= max_4563 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (not (= (+ n2_4530 b_4501) (+ n1_4526 1))))
(check-sat)