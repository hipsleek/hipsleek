...
(assert (exists ((max_5333 Int)) (and (= tn (+ 1 max_5333)) (or (and (= max_5333 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5333 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_5306 (+ 1 n1_5313)) (<= n2_5317 n1_5313)) (and (= v_int_79_5306 (+ 1 n2_5317)) (< n1_5313 n2_5317)))))
(check-sat)