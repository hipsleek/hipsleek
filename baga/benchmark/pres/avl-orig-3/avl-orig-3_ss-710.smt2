...
(assert (exists ((max_5134 Int)) (and (= n_3970 (+ 1 max_5134)) (or (and (= max_5134 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5134 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
...
(assert (exists ((max_5135 Int)) (and (= n (+ 1 max_5135)) (or (and (= max_5135 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5135 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((resb_5138 Int)) (= (+ resb_5138 n2_5066) (+ 1 n1_5062))))
(assert (exists ((max_5137 Int)) (and (= v_int_79_5055 (+ 1 max_5137)) (or (and (= max_5137 n1_5062) (>= n1_5062 n2_5066)) (and (= max_5137 n2_5066) (< n1_5062 n2_5066))))))
(assert (= n2_5066 n_4611))
(assert (= n1_5062 n_4500))
(assert (= n_3775 tn))
(assert (exists ((max_5136 Int)) (and (= tn (+ 1 max_5136)) (or (and (= max_5136 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5136 n2_3783) (< n1_3779 n2_3783))))))
(assert (= v_int_79_5055 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5066 n1_5062)) (= (+ 1 tn) v_int_79_5055)) (= tn v_int_79_5055))))
(check-sat)