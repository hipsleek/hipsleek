...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6091 Int)) (= (+ flted_44_6091 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6090 Int)) (and (= v_int_79_6049 (+ 1 max_6090)) (or (and (= max_6090 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6090 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6089 Int)) (and (= tn (+ 1 max_6089)) (or (and (= max_6089 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6089 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
