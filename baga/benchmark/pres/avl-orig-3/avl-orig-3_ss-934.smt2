...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5950 Int)) (= (+ flted_44_5950 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5949 Int)) (and (= v_int_79_5892 (+ 1 max_5949)) (or (and (= max_5949 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5949 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5946 Int)) (and (= n_4264 (+ 1 max_5946)) (or (and (= max_5946 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5946 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5947 Int)) (and (= n (+ 1 max_5947)) (or (and (= max_5947 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5947 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_4153))
(assert (exists ((max_5948 Int)) (and (= tn (+ 1 max_5948)) (or (and (= max_5948 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5948 n2_3783) (< n1_3779 n2_3783))))))
