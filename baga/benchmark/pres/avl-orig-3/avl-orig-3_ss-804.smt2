...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5403 Int)) (= (+ resb_5403 n2_5378) (+ 1 n1_5374))))
(assert (exists ((max_5402 Int)) (and (= v_int_79_5367 (+ 1 max_5402)) (or (and (= max_5402 n1_5374) (>= n1_5374 n2_5378)) (and (= max_5402 n2_5378) (< n1_5374 n2_5378))))))
...
(assert (exists ((max_5401 Int)) (and (= tn (+ 1 max_5401)) (or (and (= max_5401 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5401 n2_3783) (< n1_3779 n2_3783))))))
