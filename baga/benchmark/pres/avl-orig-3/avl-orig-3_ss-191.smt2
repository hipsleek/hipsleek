...
(assert (<= 0 bn_3291))
(assert (<= 0 cn_3284))
(assert (exists ((max_3449 Int)) (and (= an_3288 (+ 1 max_3449)) (or (and (= max_3449 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3449 n2_3303) (< n1_3299 n2_3303))))))
...
(assert (exists ((bb2_3451 Int)) (= (+ bb2_3451 n2_3375) (+ 1 n1_3371))))
(assert (exists ((max_3450 Int)) (and (= resrn_3346 (+ 1 max_3450)) (or (and (= max_3450 n1_3371) (>= n1_3371 n2_3375)) (and (= max_3450 n2_3375) (< n1_3371 n2_3375))))))
...
(assert (not (or (and (= resrn_3346 (+ 1 n1_3371)) (<= n2_3375 n1_3371)) (and (= resrn_3346 (+ 1 n2_3375)) (< n1_3371 n2_3375)))))
(check-sat)