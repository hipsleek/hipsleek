...
(assert (exists ((max_3389 Int)) (and (= an_3288 (+ 1 max_3389)) (or (and (= max_3389 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3389 n2_3303) (< n1_3299 n2_3303))))))
