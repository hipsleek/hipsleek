...
(declare-fun n_4674 () Int)
(declare-fun b_4675 () Int)
(declare-fun m_4673 () Int)
...
(assert (<= b_3860 2))
(assert (= res n_4611))
(assert (= m_4673 m_4610))
(assert (= n_4674 n_4611))
(assert (= b_4675 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4673 0)) (= n_4674 0)) (= b_4675 1)) (and (and (and (and (and (<= 0 b_4675) (<= (+ (- 0 n_4674) 2) b_4675)) (<= b_4675 n_4674)) (<= b_4675 2)) (<= 1 m_4673)) (> v_node_79_2265_primed 0))))
