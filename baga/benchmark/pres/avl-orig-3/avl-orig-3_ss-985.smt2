...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6088 Int)) (= (+ flted_44_6088 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6087 Int)) (and (= v_int_79_6049 (+ 1 max_6087)) (or (and (= max_6087 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6087 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6086 Int)) (and (= tn (+ 1 max_6086)) (or (and (= max_6086 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6086 n2_3783) (< n1_3779 n2_3783))))))
