...
(assert (exists ((bb1_3667 Int)) (= (+ bb1_3667 n2_3627) (+ 1 n1_3623))))
(assert (exists ((max_3666 Int)) (and (= resln_3602 (+ 1 max_3666)) (or (and (= max_3666 n1_3623) (>= n1_3623 n2_3627)) (and (= max_3666 n2_3627) (< n1_3623 n2_3627))))))
...
(assert (<= 0 ba3_3549))
(assert (<= 0 cn_3548))
(assert (exists ((max_3665 Int)) (and (= cn_3548 (+ 1 max_3665)) (or (and (= max_3665 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3665 n2_3560) (< n1_3556 n2_3560))))))
