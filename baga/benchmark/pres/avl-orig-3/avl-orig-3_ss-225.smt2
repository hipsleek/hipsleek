...
(assert (exists ((max_3571 Int)) (and (= cn_3548 (+ 1 max_3571)) (or (and (= max_3571 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3571 n2_3560) (< n1_3556 n2_3560))))))
...
(assert (not (= (+ n2_3560 ba3_3549) (+ n1_3556 1))))
(check-sat)