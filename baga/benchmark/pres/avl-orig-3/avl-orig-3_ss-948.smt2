...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5851 Int)) (= (+ resb_5851 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5850 Int)) (and (= v_int_79_5798 (+ 1 max_5850)) (or (and (= max_5850 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5850 n2_5809) (< n1_5805 n2_5809))))))
...
(assert (exists ((max_5847 Int)) (and (= n_4264 (+ 1 max_5847)) (or (and (= max_5847 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5847 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5848 Int)) (and (= n (+ 1 max_5848)) (or (and (= max_5848 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5848 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5849 Int)) (and (= tn (+ 1 max_5849)) (or (and (= max_5849 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5849 n2_3783) (< n1_3779 n2_3783))))))
