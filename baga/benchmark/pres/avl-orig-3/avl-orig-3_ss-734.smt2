...
(assert (exists ((max_63 Int)) (and (= v_int_79_5248 (+ 1 max_63)) (or (and (= max_63 n1_5255) (>= n1_5255 n2_5259)) (and (= max_63 n2_5259) (< n1_5255 n2_5259))))))
(assert (exists ((resb_5251 Int)) (= (+ resb_5251 n2_5259) (+ 1 n1_5255))))
