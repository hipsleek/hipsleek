...
(declare-fun resn_4100 () Int)
(declare-fun resb_4101 () Int)
(declare-fun flted_43_4099 () Int)
(declare-fun res () Int)
...
(assert (<= 0 Anon_3784))
(assert (<= Anon_3784 2))
(assert (= flted_43_4099 (+ 1 tm_4091)))
(assert (> v_node_68_2177_primed 0))
(assert (< 0 tm_4091))
(assert (< 0 tn_4092))
(assert (or (= tn_4092 resn_4100) (and (= resn_4100 (+ 1 tn_4092)) (not (= resb_4101 1)))))
(assert (<= 0 tm_4091))
(assert (<= 0 tn_4092))
(assert (<= 0 b_4093))
(assert (<= b_4093 2))
...
(assert (or (and (and (and (< res 1) (= flted_43_4099 0)) (= resn_4100 0)) (= resb_4101 1)) (and (and (and (and (and (<= 0 resb_4101) (<= (+ (- 0 resn_4100) 2) resb_4101)) (<= resb_4101 resn_4100)) (<= resb_4101 2)) (<= 1 flted_43_4099)) (> res 0))))
