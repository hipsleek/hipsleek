...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5287 Int)) (= (+ resb_5287 n2_5259) (+ 1 n1_5255))))
(assert (exists ((max_5286 Int)) (and (= v_int_79_5248 (+ 1 max_5286)) (or (and (= max_5286 n1_5255) (>= n1_5255 n2_5259)) (and (= max_5286 n2_5259) (< n1_5255 n2_5259))))))
...
(assert (exists ((max_5285 Int)) (and (= tn (+ 1 max_5285)) (or (and (= max_5285 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5285 n2_3783) (< n1_3779 n2_3783))))))
