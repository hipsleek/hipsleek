...
(declare-fun right_136_1716_primed () Int)
(declare-fun left_136_1715_primed () Int)
(declare-fun height_136_1714_primed () Int)
(declare-fun Anon_43 () Int)
(declare-fun ele_136_1713_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_136_1716_primed k2_primed))
(assert (= left_136_1715_primed ll))
(assert (= height_136_1714_primed Anon_43))
(assert (= ele_136_1713_primed Anon_42))
