...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5284 Int)) (= (+ resb_5284 n2_5259) (+ 1 n1_5255))))
(assert (exists ((max_5283 Int)) (and (= v_int_79_5248 (+ 1 max_5283)) (or (and (= max_5283 n1_5255) (>= n1_5255 n2_5259)) (and (= max_5283 n2_5259) (< n1_5255 n2_5259))))))
...
(assert (exists ((max_5282 Int)) (and (= tn (+ 1 max_5282)) (or (and (= max_5282 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5282 n2_3783) (< n1_3779 n2_3783))))))
