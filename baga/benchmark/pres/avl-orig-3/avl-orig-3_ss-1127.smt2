...
(assert (exists ((max_6450 Int)) (and (= tn (+ 1 max_6450)) (or (and (= max_6450 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6450 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= n_4611 n))
(assert (exists ((flted_44_6452 Int)) (= (+ flted_44_6452 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6451 Int)) (and (= v_int_79_6414 (+ 1 max_6451)) (or (and (= max_6451 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6451 n2_6425) (< n1_6421 n2_6425))))))
