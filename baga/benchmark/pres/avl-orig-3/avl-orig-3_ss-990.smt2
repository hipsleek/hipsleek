...
(assert (< 0 tm_4091))
(assert (<= 0 m2_3782))
(assert (exists ((flted_44_6103 Int)) (= (+ flted_44_6103 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6102 Int)) (and (= v_int_79_6049 (+ 1 max_6102)) (or (and (= max_6102 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6102 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6101 Int)) (and (= tn (+ 1 max_6101)) (or (and (= max_6101 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6101 n2_3783) (< n1_3779 n2_3783))))))
