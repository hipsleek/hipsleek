...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((flted_44_6097 Int)) (= (+ flted_44_6097 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6096 Int)) (and (= v_int_79_6049 (+ 1 max_6096)) (or (and (= max_6096 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6096 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6095 Int)) (and (= tn (+ 1 max_6095)) (or (and (= max_6095 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6095 n2_3783) (< n1_3779 n2_3783))))))
