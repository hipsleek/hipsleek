...
(declare-fun right_135_1712_primed () Int)
(declare-fun left_135_1711_primed () Int)
(declare-fun height_135_1710_primed () Int)
(declare-fun Anon_41 () Int)
(declare-fun ele_135_1709_primed () Int)
(declare-fun Anon_40 () Int)
(declare-fun v_int_135_1708_primed () Int)
(declare-fun ba3 () Int)
(declare-fun cn () Int)
(declare-fun cm () Int)
(declare-fun ba2 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_135_1712_primed r))
(assert (= left_135_1711_primed lr))
(assert (= height_135_1710_primed Anon_41))
(assert (= ele_135_1709_primed Anon_40))
(assert (= v_int_135_1708_primed (+ 1 n_2664)))
(assert (< n n_2664))
(assert (<= b_2665 2))
(assert (<= 0 b_2665))
(assert (<= 0 n_2664))
