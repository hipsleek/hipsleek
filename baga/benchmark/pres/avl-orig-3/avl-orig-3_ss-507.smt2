...
(declare-fun n_4666 () Int)
(declare-fun b_4667 () Int)
(declare-fun m_4665 () Int)
...
(assert (<= bb2_4450 2))
(assert (= res n_4611))
(assert (= m_4665 m_4610))
(assert (= n_4666 n_4611))
(assert (= b_4667 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4665 0)) (= n_4666 0)) (= b_4667 1)) (and (and (and (and (and (<= 0 b_4667) (<= (+ (- 0 n_4666) 2) b_4667)) (<= b_4667 n_4666)) (<= b_4667 2)) (<= 1 m_4665)) (> v_node_79_2265_primed 0))))
