...
(assert (exists ((max_63 Int)) (and (= v_int_79_5055 (+ 1 max_63)) (or (and (= max_63 n1_5062) (>= n1_5062 n2_5066)) (and (= max_63 n2_5066) (< n1_5062 n2_5066))))))
(assert (exists ((resb_5058 Int)) (= (+ resb_5058 n2_5066) (+ 1 n1_5062))))
