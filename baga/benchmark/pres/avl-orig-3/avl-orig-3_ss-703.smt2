...
(assert (exists ((flted_44_5247 Int)) (= (+ flted_44_5247 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5246 Int)) (and (= v_int_79_5149 (+ 1 max_5246)) (or (and (= max_5246 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5246 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5243 Int)) (and (= n_3970 (+ 1 max_5243)) (or (and (= max_5243 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5243 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5244 Int)) (and (= n (+ 1 max_5244)) (or (and (= max_5244 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5244 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5245 Int)) (and (= tn (+ 1 max_5245)) (or (and (= max_5245 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5245 n2_3783) (< n1_3779 n2_3783))))))
