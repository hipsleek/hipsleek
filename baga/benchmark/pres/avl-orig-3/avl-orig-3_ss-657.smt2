...
(assert (exists ((max_4947 Int)) (and (= n (+ 1 max_4947)) (or (and (= max_4947 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4947 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_4946 Int)) (and (= tn (+ 1 max_4946)) (or (and (= max_4946 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4946 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4948 Int)) (and (= n_4611 (+ 1 max_4948)) (or (and (= max_4948 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4948 n2_4622) (< n1_4618 n2_4622))))))
(assert (exists ((resb_4950 Int)) (= (+ resb_4950 n2_4873) (+ 1 n1_4869))))
(assert (exists ((max_4949 Int)) (and (= v_int_79_4862 (+ 1 max_4949)) (or (and (= max_4949 n1_4869) (>= n1_4869 n2_4873)) (and (= max_4949 n2_4873) (< n1_4869 n2_4873))))))
