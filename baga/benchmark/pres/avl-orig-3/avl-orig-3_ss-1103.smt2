...
(assert (exists ((max_6384 Int)) (and (= tn (+ 1 max_6384)) (or (and (= max_6384 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6384 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= n_4611 n))
(assert (exists ((resb_6386 Int)) (= (+ resb_6386 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6385 Int)) (and (= v_int_79_6348 (+ 1 max_6385)) (or (and (= max_6385 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6385 n2_6359) (< n1_6355 n2_6359))))))
