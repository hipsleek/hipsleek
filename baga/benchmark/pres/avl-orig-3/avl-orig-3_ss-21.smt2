...
(declare-fun v_int_135_1702_primed () Int)
(declare-fun an () Int)
(declare-fun ba1 () Int)
(declare-fun am () Int)
(declare-fun ll () Int)
...
(assert (<= 0 ba3))
(assert (<= ba3 2))
(assert (= v_int_135_1702_primed n_2664))
(assert (<= 0 m_2663))
(assert (<= 0 n_2664))
(assert (<= 0 b_2665))
(assert (<= b_2665 2))
(assert (= res v_int_135_1702_primed))
(assert (< v_int_135_1703_primed v_int_135_1702_primed))
