...
(declare-fun n_4271 () Int)
(declare-fun b_4272 () Int)
(declare-fun m_4270 () Int)
(declare-fun v_node_70_2234_primed () Int)
...
(assert (<= 0 b_4246))
(assert (<= b_4246 2))
(assert (= v_node_70_2234_primed p_4234))
...
(assert (<= Anon_4237 2))
(assert (= res n_4264))
(assert (= m_4270 m_4263))
(assert (= n_4271 n_4264))
(assert (= b_4272 b_4265))
(assert (<= 0 m_4263))
(assert (<= 0 n_4264))
(assert (<= 0 b_4265))
(assert (<= b_4265 2))
...
(assert (or (and (and (and (< v_node_70_2234_primed 1) (= m_4270 0)) (= n_4271 0)) (= b_4272 1)) (and (and (and (and (and (<= 0 b_4272) (<= (+ (- 0 n_4271) 2) b_4272)) (<= b_4272 n_4271)) (<= b_4272 2)) (<= 1 m_4270)) (> v_node_70_2234_primed 0))))
