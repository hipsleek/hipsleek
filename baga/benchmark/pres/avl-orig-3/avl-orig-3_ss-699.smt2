...
(assert (exists ((max_5091 Int)) (and (= n (+ 1 max_5091)) (or (and (= max_5091 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5091 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_5090 Int)) (and (= tn (+ 1 max_5090)) (or (and (= max_5090 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5090 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5092 Int)) (and (= n_3970 (+ 1 max_5092)) (or (and (= max_5092 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5092 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
