...
(assert (exists ((max_5224 Int)) (and (= n (+ 1 max_5224)) (or (and (= max_5224 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5224 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_5225 Int)) (and (= tn (+ 1 max_5225)) (or (and (= max_5225 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5225 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5223 Int)) (and (= n_3970 (+ 1 max_5223)) (or (and (= max_5223 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5223 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
...
(assert (<= 0 m2_4052))
(assert (= bm m1_4048))
(assert (exists ((flted_44_5227 Int)) (= (+ flted_44_5227 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5226 Int)) (and (= v_int_79_5149 (+ 1 max_5226)) (or (and (= max_5226 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5226 n2_5160) (< n1_5156 n2_5160))))))
