...
(declare-fun n_4142 () Int)
(declare-fun b_4143 () Int)
(declare-fun m_4141 () Int)
...
(assert (= v_node_69_2190_primed v_node_68_4129))
...
(assert (= t_primed 1))
(assert (or (and (and (and (< v_node_69_2190_primed 1) (= m_4141 0)) (= n_4142 0)) (= b_4143 1)) (and (and (and (and (and (<= 0 b_4143) (<= (+ (- 0 n_4142) 2) b_4143)) (<= b_4143 n_4142)) (<= b_4143 2)) (<= 1 m_4141)) (> v_node_69_2190_primed 0))))
