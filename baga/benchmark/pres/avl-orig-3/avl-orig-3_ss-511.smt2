...
(declare-fun n_4670 () Int)
(declare-fun b_4671 () Int)
(declare-fun m_4669 () Int)
...
(assert (<= b_3860 2))
(assert (= res n_4611))
(assert (= m_4669 m_4610))
(assert (= n_4670 n_4611))
(assert (= b_4671 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4669 0)) (= n_4670 0)) (= b_4671 1)) (and (and (and (and (and (<= 0 b_4671) (<= (+ (- 0 n_4670) 2) b_4671)) (<= b_4671 n_4670)) (<= b_4671 2)) (<= 1 m_4669)) (> v_node_79_2265_primed 0))))
