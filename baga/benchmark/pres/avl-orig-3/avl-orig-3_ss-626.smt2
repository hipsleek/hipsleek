...
(assert (exists ((max_4942 Int)) (and (= n (+ 1 max_4942)) (or (and (= max_4942 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4942 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4943 Int)) (and (= n_4611 (+ 1 max_4943)) (or (and (= max_4943 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4943 n2_4622) (< n1_4618 n2_4622))))))
(assert (exists ((resb_4945 Int)) (= (+ resb_4945 n2_4873) (+ 1 n1_4869))))
(assert (exists ((max_4944 Int)) (and (= v_int_79_4862 (+ 1 max_4944)) (or (and (= max_4944 n1_4869) (>= n1_4869 n2_4873)) (and (= max_4944 n2_4873) (< n1_4869 n2_4873))))))
(assert (= n2_4873 n_4611))
(assert (= n1_4869 n_4500))
(assert (exists ((max_4941 Int)) (and (= tn (+ 1 max_4941)) (or (and (= max_4941 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4941 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_4862 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_4873 n1_4869)) (= (+ tn 1) v_int_79_4862)) (= tn v_int_79_4862))))
(check-sat)