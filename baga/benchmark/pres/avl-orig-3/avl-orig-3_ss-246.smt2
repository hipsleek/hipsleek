...
(assert (<= 0 ba3_3549))
(assert (<= 0 cn_3548))
(assert (exists ((max_3704 Int)) (and (= cn_3548 (+ 1 max_3704)) (or (and (= max_3704 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3704 n2_3560) (< n1_3556 n2_3560))))))
...
(assert (exists ((bb1_3706 Int)) (= (+ bb1_3706 n2_3627) (+ 1 n1_3623))))
(assert (exists ((max_3705 Int)) (and (= resln_3602 (+ 1 max_3705)) (or (and (= max_3705 n1_3623) (>= n1_3623 n2_3627)) (and (= max_3705 n2_3627) (< n1_3623 n2_3627))))))
...
(assert (not (or (and (= resln_3602 (+ 1 an)) (<= bn an)) (and (= resln_3602 (+ 1 bn)) (< an bn)))))
(check-sat)