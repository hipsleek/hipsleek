...
(assert (exists ((resb_4925 Int)) (= (+ resb_4925 n2_4873) (+ 1 n1_4869))))
(assert (exists ((max_4924 Int)) (and (= v_int_79_4862 (+ 1 max_4924)) (or (and (= max_4924 n1_4869) (>= n1_4869 n2_4873)) (and (= max_4924 n2_4873) (< n1_4869 n2_4873))))))
(assert (= Anon_4874 b_4612))
(assert (= n2_4873 n_4611))
(assert (exists ((max_4923 Int)) (and (= n_4611 (+ 1 max_4923)) (or (and (= max_4923 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4923 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4922 Int)) (and (= n (+ 1 max_4922)) (or (and (= max_4922 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4922 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4921 Int)) (and (= tn (+ 1 max_4921)) (or (and (= max_4921 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4921 n2_3783) (< n1_3779 n2_3783))))))
