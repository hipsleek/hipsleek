...
(assert (exists ((max_63 Int)) (and (= v_int_79_5367 (+ 1 max_63)) (or (and (= max_63 n1_5374) (>= n1_5374 n2_5378)) (and (= max_63 n2_5378) (< n1_5374 n2_5378))))))
(assert (exists ((resb_5370 Int)) (= (+ resb_5370 n2_5378) (+ 1 n1_5374))))
