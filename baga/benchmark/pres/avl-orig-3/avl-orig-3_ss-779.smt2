...
(assert (<= 0 n1_3779))
(assert (= n_3775 tn))
(assert (exists ((flted_44_5354 Int)) (= (+ flted_44_5354 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5353 Int)) (and (= v_int_79_5306 (+ 1 max_5353)) (or (and (= max_5353 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5353 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5352 Int)) (and (= tn (+ 1 max_5352)) (or (and (= max_5352 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5352 n2_3783) (< n1_3779 n2_3783))))))
