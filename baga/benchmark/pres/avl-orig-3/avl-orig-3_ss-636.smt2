...
(assert (<= 0 n1_3779))
(assert (= n_3775 tn))
(assert (exists ((max_4999 Int)) (and (= tn (+ 1 max_4999)) (or (and (= max_4999 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4999 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4997 Int)) (and (= n_4611 (+ 1 max_4997)) (or (and (= max_4997 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4997 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4998 Int)) (and (= n (+ 1 max_4998)) (or (and (= max_4998 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4998 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (not (or (and (= v_int_79_4956 (+ 1 n1_4963)) (<= n2_4967 n1_4963)) (and (= v_int_79_4956 (+ 1 n2_4967)) (< n1_4963 n2_4967)))))
(check-sat)