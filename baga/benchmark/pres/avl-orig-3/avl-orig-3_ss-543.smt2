...
(declare-fun n_4686 () Int)
(declare-fun b_4687 () Int)
(declare-fun m_4685 () Int)
...
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
(assert (= v_node_79_2265_primed ss3_4478))
...
(assert (<= bb2_4479 2))
(assert (= res n_4611))
(assert (= m_4685 m_4610))
(assert (= n_4686 n_4611))
(assert (= b_4687 b_4612))
(assert (<= 0 m_4610))
(assert (<= 0 n_4611))
(assert (<= 0 b_4612))
(assert (<= b_4612 2))
...
(assert (or (and (and (and (< v_node_79_2265_primed 1) (= m_4685 0)) (= n_4686 0)) (= b_4687 1)) (and (and (and (and (and (<= 0 b_4687) (<= (+ (- 0 n_4686) 2) b_4687)) (<= b_4687 n_4686)) (<= b_4687 2)) (<= 1 m_4685)) (> v_node_79_2265_primed 0))))
