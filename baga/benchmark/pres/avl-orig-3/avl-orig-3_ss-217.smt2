...
(assert (exists ((max_3640 Int)) (and (= cn_3548 (+ 1 max_3640)) (or (and (= max_3640 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3640 n2_3560) (< n1_3556 n2_3560))))))
...
(assert (not (or (= bm_3544 0) (or (= bn_3545 0) (< reslr_3598 1)))))
(check-sat)