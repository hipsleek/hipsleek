...
(assert (exists ((max_5934 Int)) (and (= n (+ 1 max_5934)) (or (and (= max_5934 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5934 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5933 Int)) (and (= tn (+ 1 max_5933)) (or (and (= max_5933 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5933 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5935 Int)) (and (= n_4264 (+ 1 max_5935)) (or (and (= max_5935 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5935 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (not (or (and (= v_int_79_5892 (+ 1 n1_5899)) (<= n2_5903 n1_5899)) (and (= v_int_79_5892 (+ 1 n2_5903)) (< n1_5899 n2_5903)))))
(check-sat)