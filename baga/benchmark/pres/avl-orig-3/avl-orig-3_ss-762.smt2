...
(assert (exists ((resb_5299 Int)) (= (+ resb_5299 n2_5259) (+ 1 n1_5255))))
(assert (exists ((max_5298 Int)) (and (= v_int_79_5248 (+ 1 max_5298)) (or (and (= max_5298 n1_5255) (>= n1_5255 n2_5259)) (and (= max_5298 n2_5259) (< n1_5255 n2_5259))))))
(assert (= n2_5259 n_4611))
(assert (= n1_5255 n_4500))
(assert (exists ((max_5297 Int)) (and (= tn (+ 1 max_5297)) (or (and (= max_5297 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5297 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_5248 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5259 n1_5255)) (= (+ 1 tn) v_int_79_5248)) (= tn v_int_79_5248))))
(check-sat)