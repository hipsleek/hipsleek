...
(assert (exists ((bb2_3421 Int)) (= (+ bb2_3421 n2_3375) (+ 1 n1_3371))))
(assert (exists ((max_3420 Int)) (and (= resrn_3346 (+ 1 max_3420)) (or (and (= max_3420 n1_3371) (>= n1_3371 n2_3375)) (and (= max_3420 n2_3375) (< n1_3371 n2_3375))))))
...
(assert (<= 0 ba1_3289))
(assert (<= 0 an_3288))
(assert (exists ((max_3419 Int)) (and (= an_3288 (+ 1 max_3419)) (or (and (= max_3419 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3419 n2_3303) (< n1_3299 n2_3303))))))
