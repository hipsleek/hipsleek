...
(assert (exists ((max_5452 Int)) (and (= tn (+ 1 max_5452)) (or (and (= max_5452 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5452 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_5425 (+ 1 n1_5432)) (<= n2_5436 n1_5432)) (and (= v_int_79_5425 (+ 1 n2_5436)) (< n1_5432 n2_5436)))))
(check-sat)