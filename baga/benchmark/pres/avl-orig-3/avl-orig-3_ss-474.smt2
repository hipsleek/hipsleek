...
(assert (exists ((max_4545 Int)) (and (= n (+ 1 max_4545)) (or (and (= max_4545 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4545 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (exists ((max_4546 Int)) (and (= tn (+ 1 max_4546)) (or (and (= max_4546 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4546 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (= am 0) (or (= an 0) (< resll_4466 1)))))
(check-sat)