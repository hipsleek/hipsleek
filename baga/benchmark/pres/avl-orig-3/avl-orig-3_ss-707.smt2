...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5118 Int)) (= (+ resb_5118 n2_5066) (+ 1 n1_5062))))
(assert (exists ((max_5117 Int)) (and (= v_int_79_5055 (+ 1 max_5117)) (or (and (= max_5117 n1_5062) (>= n1_5062 n2_5066)) (and (= max_5117 n2_5066) (< n1_5062 n2_5066))))))
...
(assert (exists ((max_5114 Int)) (and (= n_3970 (+ 1 max_5114)) (or (and (= max_5114 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5114 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5115 Int)) (and (= n (+ 1 max_5115)) (or (and (= max_5115 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5115 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (<= 0 n_3859))
(assert (exists ((max_5116 Int)) (and (= tn (+ 1 max_5116)) (or (and (= max_5116 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5116 n2_3783) (< n1_3779 n2_3783))))))
