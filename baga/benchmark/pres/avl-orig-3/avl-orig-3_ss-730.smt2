...
(assert (exists ((flted_44_5232 Int)) (= (+ flted_44_5232 n2_5160) (+ 1 n1_5156))))
(assert (exists ((max_5231 Int)) (and (= v_int_79_5149 (+ 1 max_5231)) (or (and (= max_5231 n1_5156) (>= n1_5156 n2_5160)) (and (= max_5231 n2_5160) (< n1_5156 n2_5160))))))
...
(assert (exists ((max_5228 Int)) (and (= n_3970 (+ 1 max_5228)) (or (and (= max_5228 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5228 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5229 Int)) (and (= n (+ 1 max_5229)) (or (and (= max_5229 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5229 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5230 Int)) (and (= tn (+ 1 max_5230)) (or (and (= max_5230 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5230 n2_3783) (< n1_3779 n2_3783))))))
