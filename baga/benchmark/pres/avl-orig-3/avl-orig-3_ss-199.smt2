...
(assert (exists ((bb2_3433 Int)) (= (+ bb2_3433 n2_3375) (+ 1 n1_3371))))
(assert (exists ((max_3432 Int)) (and (= resrn_3346 (+ 1 max_3432)) (or (and (= max_3432 n1_3371) (>= n1_3371 n2_3375)) (and (= max_3432 n2_3375) (< n1_3371 n2_3375))))))
...
(assert (<= 0 bn_3291))
(assert (<= 0 cn_3284))
(assert (exists ((max_3431 Int)) (and (= an_3288 (+ 1 max_3431)) (or (and (= max_3431 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3431 n2_3303) (< n1_3299 n2_3303))))))
