...
(declare-fun right_69_2186_primed () Int)
(declare-fun left_69_2185_primed () Int)
(declare-fun height_69_2184_primed () Int)
(declare-fun ele_69_2183_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_69_2186_primed v_node_68_4129))
(assert (= left_69_2185_primed p_3777))
(assert (= height_69_2184_primed n_3775))
(assert (= ele_69_2183_primed Anon_3776))
...
(assert (or (and (and (and (< v_node_68_4129 1) (= flted_44_4120 0)) (= flted_44_4119 0)) (= flted_44_4118 1)) (and (and (and (and (and (<= 0 flted_44_4118) (<= (+ (- 0 flted_44_4119) 2) flted_44_4118)) (<= flted_44_4118 flted_44_4119)) (<= flted_44_4118 2)) (<= 1 flted_44_4120)) (> v_node_68_4129 0))))
