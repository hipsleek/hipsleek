...
(assert (exists ((resb_4915 Int)) (= (+ resb_4915 n2_4873) (+ 1 n1_4869))))
(assert (exists ((max_4914 Int)) (and (= v_int_79_4862 (+ 1 max_4914)) (or (and (= max_4914 n1_4869) (>= n1_4869 n2_4873)) (and (= max_4914 n2_4873) (< n1_4869 n2_4873))))))
(assert (= Anon_4874 b_4612))
(assert (= n2_4873 n_4611))
(assert (exists ((max_4913 Int)) (and (= n_4611 (+ 1 max_4913)) (or (and (= max_4913 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4913 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4912 Int)) (and (= n (+ 1 max_4912)) (or (and (= max_4912 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4912 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4911 Int)) (and (= tn (+ 1 max_4911)) (or (and (= max_4911 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4911 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
