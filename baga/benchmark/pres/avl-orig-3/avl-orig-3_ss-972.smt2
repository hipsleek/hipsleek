...
(assert (exists ((max_5967 Int)) (and (= n (+ 1 max_5967)) (or (and (= max_5967 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5967 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5968 Int)) (and (= tn (+ 1 max_5968)) (or (and (= max_5968 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5968 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5966 Int)) (and (= n_4264 (+ 1 max_5966)) (or (and (= max_5966 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5966 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (<= 0 m2_4346))
(assert (= cm m2_4346))
(assert (exists ((flted_44_5970 Int)) (= (+ flted_44_5970 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5969 Int)) (and (= v_int_79_5892 (+ 1 max_5969)) (or (and (= max_5969 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5969 n2_5903) (< n1_5899 n2_5903))))))
