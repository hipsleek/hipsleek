...
(assert (exists ((max_4551 Int)) (and (= n (+ 1 max_4551)) (or (and (= max_4551 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4551 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_4552 Int)) (and (= tn (+ 1 max_4552)) (or (and (= max_4552 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4552 n2_3783) (< n1_3779 n2_3783))))))
