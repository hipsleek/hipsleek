...
(declare-fun right_55_2152_primed () Int)
(declare-fun left_55_2151_primed () Int)
(declare-fun height_55_2150_primed () Int)
(declare-fun ele_55_2149_primed () Int)
(declare-fun Anon_3939 () Int)
(declare-fun v_node_55_2148_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_55_2152_primed q_3944))
(assert (= left_55_2151_primed p_3940))
(assert (= height_55_2150_primed n_3938))
(assert (= ele_55_2149_primed Anon_3939))
(assert (= v_node_55_2148_primed v_node_52_3833))
(assert (<= b_3952 2))
(assert (<= 0 b_3952))
(assert (<= 0 n_3951))
(assert (<= 0 m_3950))
