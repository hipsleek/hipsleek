...
(declare-fun v_int_54_2130_primed () Int)
(declare-fun v_int_54_2129_primed () Int)
...
(assert (<= 0 b_3860))
(assert (<= b_3860 2))
(assert (= (+ v_int_54_2130_primed n_3859) n))
(assert (= v_int_54_2129_primed 2))
(assert (not (= v_int_54_2130_primed v_int_54_2129_primed)))
(assert (= t_primed 1))
