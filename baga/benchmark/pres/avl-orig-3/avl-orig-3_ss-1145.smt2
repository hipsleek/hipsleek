...
(assert (exists ((max_6399 Int)) (and (= tn (+ 1 max_6399)) (or (and (= max_6399 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6399 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (= n_4611 n))
(assert (exists ((resb_6401 Int)) (= (+ resb_6401 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6400 Int)) (and (= v_int_79_6348 (+ 1 max_6400)) (or (and (= max_6400 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6400 n2_6359) (< n1_6355 n2_6359))))))
