...
(assert (= res 1))
(assert (= resl_3583 2))
(assert (or (and (and (and (< resr_3585 1) (= cm_3547 0)) (= cn_3548 0)) (= ba3_3549 1)) (and (and (and (and (and (<= 0 ba3_3549) (<= (+ (- 0 cn_3548) 2) ba3_3549)) (<= ba3_3549 cn_3548)) (<= ba3_3549 2)) (<= 1 cm_3547)) (> resr_3585 0))))
(assert (or (and (and (and (< resll_3586 1) (= am_3540 0)) (= an_3541 0)) (= ba1_3542 1)) (and (and (and (and (and (<= 0 ba1_3542) (<= (+ (- 0 an_3541) 2) ba1_3542)) (<= ba1_3542 an_3541)) (<= ba1_3542 2)) (<= 1 am_3540)) (> resll_3586 0))))
(assert (or (and (and (and (< reslr_3587 1) (= bm_3544 0)) (= bn_3545 0)) (= ba2_3546 1)) (and (and (and (and (and (<= 0 ba2_3546) (<= (+ (- 0 bn_3545) 2) ba2_3546)) (<= ba2_3546 bn_3545)) (<= ba2_3546 2)) (<= 1 bm_3544)) (> reslr_3587 0))))
