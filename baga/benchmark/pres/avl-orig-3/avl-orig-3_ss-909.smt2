...
(assert (exists ((max_5837 Int)) (and (= n (+ 1 max_5837)) (or (and (= max_5837 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5837 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5836 Int)) (and (= tn (+ 1 max_5836)) (or (and (= max_5836 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5836 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5838 Int)) (and (= n_4264 (+ 1 max_5838)) (or (and (= max_5838 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5838 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
