...
(assert (exists ((max_3572 Int)) (and (= cn_3548 (+ 1 max_3572)) (or (and (= max_3572 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3572 n2_3560) (< n1_3556 n2_3560))))))
