...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5876 Int)) (= (+ resb_5876 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5875 Int)) (and (= v_int_79_5798 (+ 1 max_5875)) (or (and (= max_5875 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5875 n2_5809) (< n1_5805 n2_5809))))))
...
(assert (exists ((max_5872 Int)) (and (= n_4264 (+ 1 max_5872)) (or (and (= max_5872 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5872 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5873 Int)) (and (= n (+ 1 max_5873)) (or (and (= max_5873 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5873 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5874 Int)) (and (= tn (+ 1 max_5874)) (or (and (= max_5874 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5874 n2_3783) (< n1_3779 n2_3783))))))
