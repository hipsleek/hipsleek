...
(assert (exists ((flted_44_6461 Int)) (= (+ flted_44_6461 n2_6425) (+ 1 n1_6421))))
(assert (exists ((max_6460 Int)) (and (= v_int_79_6414 (+ 1 max_6460)) (or (and (= max_6460 n1_6421) (>= n1_6421 n2_6425)) (and (= max_6460 n2_6425) (< n1_6421 n2_6425))))))
...
(assert (= tn_4092 0))
(assert (= n_3775 tn))
(assert (exists ((max_6459 Int)) (and (= tn (+ 1 max_6459)) (or (and (= max_6459 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6459 n2_3783) (< n1_3779 n2_3783))))))
