...
(declare-fun n_4582 () Int)
(declare-fun b_4583 () Int)
(declare-fun m_4581 () Int)
...
(assert (<= b_4154 2))
(assert (= res n_4500))
(assert (= m_4581 m_4499))
(assert (= n_4582 n_4500))
(assert (= b_4583 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4581 0)) (= n_4582 0)) (= b_4583 1)) (and (and (and (and (and (<= 0 b_4583) (<= (+ (- 0 n_4582) 2) b_4583)) (<= b_4583 n_4582)) (<= b_4583 2)) (<= 1 m_4581)) (> v_node_79_2257_primed 0))))
