...
(assert (exists ((max_5685 Int)) (and (= n (+ 1 max_5685)) (or (and (= max_5685 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5685 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5686 Int)) (and (= n_4500 (+ 1 max_5686)) (or (and (= max_5686 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5686 n2_4530) (< n1_4526 n2_4530))))))
(assert (exists ((resb_5688 Int)) (= (+ resb_5688 n2_5616) (+ 1 n1_5612))))
(assert (exists ((max_5687 Int)) (and (= v_int_79_5605 (+ 1 max_5687)) (or (and (= max_5687 n1_5612) (>= n1_5612 n2_5616)) (and (= max_5687 n2_5616) (< n1_5612 n2_5616))))))
(assert (= n2_5616 n_4611))
(assert (= n1_5612 n_4500))
(assert (exists ((max_5684 Int)) (and (= tn (+ 1 max_5684)) (or (and (= max_5684 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5684 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_5605 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5616 n1_5612)) (= (+ tn 1) v_int_79_5605)) (= tn v_int_79_5605))))
(check-sat)