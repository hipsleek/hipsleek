...
(declare-fun right_161_1520_primed () Int)
(declare-fun left_161_1519_primed () Int)
(declare-fun height_161_1518_primed () Int)
(declare-fun Anon_47 () Int)
(declare-fun ele_161_1517_primed () Int)
(declare-fun Anon_46 () Int)
(declare-fun v_int_161_1516_primed () Int)
(declare-fun ba2 () Int)
(declare-fun bn () Int)
(declare-fun bm () Int)
(declare-fun ba1 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_161_1520_primed rl))
(assert (= left_161_1519_primed l))
(assert (= height_161_1518_primed Anon_47))
(assert (= ele_161_1517_primed Anon_46))
(assert (= v_int_161_1516_primed (+ 1 n_2960)))
(assert (< n n_2960))
(assert (<= b_2961 2))
(assert (<= 0 b_2961))
(assert (<= 0 n_2960))
