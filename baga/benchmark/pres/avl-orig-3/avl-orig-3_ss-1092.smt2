...
(assert (exists ((resb_6265 Int)) (= (+ resb_6265 n2_6240) (+ 1 n1_6236))))
(assert (exists ((max_6264 Int)) (and (= v_int_79_6229 (+ 1 max_6264)) (or (and (= max_6264 n1_6236) (>= n1_6236 n2_6240)) (and (= max_6264 n2_6240) (< n1_6236 n2_6240))))))
...
(assert (exists ((max_6263 Int)) (and (= tn (+ 1 max_6263)) (or (and (= max_6263 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6263 n2_3783) (< n1_3779 n2_3783))))))
