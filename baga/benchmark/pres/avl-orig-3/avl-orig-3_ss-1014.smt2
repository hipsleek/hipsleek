...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6149 Int)) (= (+ resb_6149 n2_6121) (+ 1 n1_6117))))
(assert (exists ((max_6148 Int)) (and (= v_int_79_6110 (+ 1 max_6148)) (or (and (= max_6148 n1_6117) (>= n1_6117 n2_6121)) (and (= max_6148 n2_6121) (< n1_6117 n2_6121))))))
...
(assert (exists ((max_6147 Int)) (and (= tn (+ 1 max_6147)) (or (and (= max_6147 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6147 n2_3783) (< n1_3779 n2_3783))))))
