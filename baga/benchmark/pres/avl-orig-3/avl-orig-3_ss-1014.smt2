...
(assert (exists ((max_6076 Int)) (and (= tn (+ 1 max_6076)) (or (and (= max_6076 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6076 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_6049 (+ 1 n1_6056)) (<= n2_6060 n1_6056)) (and (= v_int_79_6049 (+ 1 n2_6060)) (< n1_6056 n2_6060)))))
(check-sat)