...
(assert (exists ((resb_5537 Int)) (= (+ resb_5537 n2_5497) (+ 1 n1_5493))))
(assert (exists ((max_5536 Int)) (and (= v_int_79_5486 (+ 1 max_5536)) (or (and (= max_5536 n1_5493) (>= n1_5493 n2_5497)) (and (= max_5536 n2_5497) (< n1_5493 n2_5497))))))
(assert (= n2_5497 n_4611))
(assert (= n1_5493 n_4500))
(assert (exists ((max_5535 Int)) (and (= tn (+ 1 max_5535)) (or (and (= max_5535 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5535 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_5486 (+ 1 n_4500)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5497 n1_5493)) (= (+ tn 1) v_int_79_5486)) (= tn v_int_79_5486))))
(check-sat)