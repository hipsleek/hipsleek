...
(assert (<= 0 n1_3779))
(assert (= n_3775 tn))
(assert (exists ((max_4899 Int)) (and (= tn (+ 1 max_4899)) (or (and (= max_4899 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4899 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4897 Int)) (and (= n_4611 (+ 1 max_4897)) (or (and (= max_4897 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4897 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4898 Int)) (and (= n (+ 1 max_4898)) (or (and (= max_4898 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4898 n2_3946) (< n1_3942 n2_3946))))))
