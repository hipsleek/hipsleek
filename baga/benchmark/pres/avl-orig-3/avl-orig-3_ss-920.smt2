...
(assert (exists ((max_5883 Int)) (and (= n (+ 1 max_5883)) (or (and (= max_5883 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5883 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_5884 Int)) (and (= tn (+ 1 max_5884)) (or (and (= max_5884 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5884 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5882 Int)) (and (= n_4264 (+ 1 max_5882)) (or (and (= max_5882 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5882 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
(assert (= cn n2_4347))
...
(assert (exists ((resb_5886 Int)) (= (+ resb_5886 n2_5809) (+ 1 n1_5805))))
(assert (exists ((max_5885 Int)) (and (= v_int_79_5798 (+ 1 max_5885)) (or (and (= max_5885 n1_5805) (>= n1_5805 n2_5809)) (and (= max_5885 n2_5809) (< n1_5805 n2_5809))))))
