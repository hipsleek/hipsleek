...
(assert (exists ((flted_44_5787 Int)) (= (+ flted_44_5787 n2_5710) (+ 1 n1_5706))))
(assert (exists ((max_5786 Int)) (and (= v_int_79_5699 (+ 1 max_5786)) (or (and (= max_5786 n1_5706) (>= n1_5706 n2_5710)) (and (= max_5786 n2_5710) (< n1_5706 n2_5710))))))
(assert (= Anon_5707 b_4501))
(assert (= n1_5706 n_4500))
(assert (exists ((max_5785 Int)) (and (= n_4500 (+ 1 max_5785)) (or (and (= max_5785 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5785 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5784 Int)) (and (= n (+ 1 max_5784)) (or (and (= max_5784 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5784 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5783 Int)) (and (= tn (+ 1 max_5783)) (or (and (= max_5783 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5783 n2_3783) (< n1_3779 n2_3783))))))
