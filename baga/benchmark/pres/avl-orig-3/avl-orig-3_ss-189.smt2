...
(assert (exists ((max_3387 Int)) (and (= an_3288 (+ 1 max_3387)) (or (and (= max_3387 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3387 n2_3303) (< n1_3299 n2_3303))))))
...
(assert (not (or (= bm_3290 0) (or (= bn_3291 0) (< resrl_3341 1)))))
(check-sat)