...
(assert (<= 0 bn_3291))
(assert (<= 0 cn_3284))
(assert (exists ((max_3443 Int)) (and (= an_3288 (+ 1 max_3443)) (or (and (= max_3443 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3443 n2_3303) (< n1_3299 n2_3303))))))
...
(assert (exists ((bb2_3445 Int)) (= (+ bb2_3445 n2_3375) (+ 1 n1_3371))))
(assert (exists ((max_3444 Int)) (and (= resrn_3346 (+ 1 max_3444)) (or (and (= max_3444 n1_3371) (>= n1_3371 n2_3375)) (and (= max_3444 n2_3375) (< n1_3371 n2_3375))))))
...
(assert (not (or (and (= resrn_3346 (+ 1 cn)) (<= dn cn)) (and (= resrn_3346 (+ 1 dn)) (< cn dn)))))
(check-sat)