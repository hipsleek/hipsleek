...
(assert (exists ((max_3312 Int)) (and (= an_3288 (+ 1 max_3312)) (or (and (= max_3312 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3312 n2_3303) (< n1_3299 n2_3303))))))
...
(assert (not (or (= cm_3235 0) (or (= cn_3236 0) (< resr_3274 1)))))
(check-sat)