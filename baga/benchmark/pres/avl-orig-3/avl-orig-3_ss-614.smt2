...
(assert (exists ((max_4896 Int)) (and (= tn (+ 1 max_4896)) (or (and (= max_4896 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4896 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4895 Int)) (and (= n (+ 1 max_4895)) (or (and (= max_4895 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4895 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4894 Int)) (and (= n_4611 (+ 1 max_4894)) (or (and (= max_4894 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4894 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (not (or (= m_4610 0) (or (= n_4611 0) (< resr_4435 1)))))
(check-sat)