...
(assert (exists ((max_5185 Int)) (and (= n (+ 1 max_5185)) (or (and (= max_5185 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5185 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_5184 Int)) (and (= tn (+ 1 max_5184)) (or (and (= max_5184 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5184 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5186 Int)) (and (= n_3970 (+ 1 max_5186)) (or (and (= max_5186 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5186 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
