...
(assert (exists ((max_3992 Int)) (and (= tn (+ 1 max_3992)) (or (and (= max_3992 n1_3779) (>= n1_3779 n2_3783)) (and (= max_3992 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_3993 Int)) (and (= n (+ 1 max_3993)) (or (and (= max_3993 n1_3942) (>= n1_3942 n2_3946)) (and (= max_3993 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (not (or (= m_3969 0) (or (= n_3970 0) (< q_3944 1)))))
(check-sat)