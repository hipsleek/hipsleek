...
(assert (exists ((resb_4920 Int)) (= (+ resb_4920 n2_4873) (+ 1 n1_4869))))
(assert (exists ((max_4919 Int)) (and (= v_int_79_4862 (+ 1 max_4919)) (or (and (= max_4919 n1_4869) (>= n1_4869 n2_4873)) (and (= max_4919 n2_4873) (< n1_4869 n2_4873))))))
(assert (= Anon_4874 b_4612))
(assert (= n2_4873 n_4611))
(assert (exists ((max_4918 Int)) (and (= n_4611 (+ 1 max_4918)) (or (and (= max_4918 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4918 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4917 Int)) (and (= n (+ 1 max_4917)) (or (and (= max_4917 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4917 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4916 Int)) (and (= tn (+ 1 max_4916)) (or (and (= max_4916 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4916 n2_3783) (< n1_3779 n2_3783))))))
