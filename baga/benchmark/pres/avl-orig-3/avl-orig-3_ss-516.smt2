...
(assert (exists ((max_4678 Int)) (and (= n_4500 (+ 1 max_4678)) (or (and (= max_4678 n1_4526) (>= n1_4526 n2_4530)) (and (= max_4678 n2_4530) (< n1_4526 n2_4530))))))
(assert (= (+ b_4501 n2_4530) (+ 1 n1_4526)))
(assert (= m (+ (+ m2_4239 1) m1_4235)))
(assert (exists ((max_4677 Int)) (and (= n (+ 1 max_4677)) (or (and (= max_4677 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4677 n2_4240) (< n1_4236 n2_4240))))))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (= n_4232 n))
(assert (exists ((max_4676 Int)) (and (= tn (+ 1 max_4676)) (or (and (= max_4676 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4676 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (= cm 0) (or (= cn 0) (< resr_4465 1)))))
(check-sat)