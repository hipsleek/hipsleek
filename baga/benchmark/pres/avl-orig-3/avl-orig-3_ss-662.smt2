...
(assert (exists ((max_4987 Int)) (and (= tn (+ 1 max_4987)) (or (and (= max_4987 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4987 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4985 Int)) (and (= n_4611 (+ 1 max_4985)) (or (and (= max_4985 n1_4618) (>= n1_4618 n2_4622)) (and (= max_4985 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_4986 Int)) (and (= n (+ 1 max_4986)) (or (and (= max_4986 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4986 n2_3946) (< n1_3942 n2_3946))))))
