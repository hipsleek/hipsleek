...
(assert (exists ((max_5419 Int)) (and (= tn (+ 1 max_5419)) (or (and (= max_5419 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5419 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (<= 0 n))
(assert (= n_4500 n))
(assert (exists ((resb_5421 Int)) (= (+ resb_5421 n2_5378) (+ 1 n1_5374))))
(assert (exists ((max_5420 Int)) (and (= v_int_79_5367 (+ 1 max_5420)) (or (and (= max_5420 n1_5374) (>= n1_5374 n2_5378)) (and (= max_5420 n2_5378) (< n1_5374 n2_5378))))))
(assert (= n2_5378 n_4611))
(assert (= n1_5374 n_4500))
(assert (= v_int_79_5367 (+ 1 n_4611)))
;Negation of Consequence
(assert (not (or (and (= v_int_79_5367 (+ 1 n1_5374)) (<= n2_5378 n1_5374)) (and (= v_int_79_5367 (+ 1 n2_5378)) (< n1_5374 n2_5378)))))
(check-sat)