...
(assert (exists ((max_6449 Int)) (and (= tn (+ 1 max_6449)) (or (and (= max_6449 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6449 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_6414 (+ 1 n1_6421)) (<= n2_6425 n1_6421)) (and (= v_int_79_6414 (+ 1 n2_6425)) (< n1_6421 n2_6425)))))
(check-sat)