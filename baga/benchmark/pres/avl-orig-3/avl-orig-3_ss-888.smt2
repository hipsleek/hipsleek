...
(assert (<= 0 n2_3783))
(assert (= n_3775 tn))
(assert (exists ((max_5642 Int)) (and (= tn (+ 1 max_5642)) (or (and (= max_5642 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5642 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5640 Int)) (and (= n_4500 (+ 1 max_5640)) (or (and (= max_5640 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5640 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5641 Int)) (and (= n (+ 1 max_5641)) (or (and (= max_5641 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5641 n2_4240) (< n1_4236 n2_4240))))))
