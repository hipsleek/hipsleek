...
(assert (exists ((flted_44_5797 Int)) (= (+ flted_44_5797 n2_5710) (+ 1 n1_5706))))
(assert (exists ((max_5796 Int)) (and (= v_int_79_5699 (+ 1 max_5796)) (or (and (= max_5796 n1_5706) (>= n1_5706 n2_5710)) (and (= max_5796 n2_5710) (< n1_5706 n2_5710))))))
(assert (= Anon_5707 b_4501))
(assert (= n1_5706 n_4500))
(assert (exists ((max_5795 Int)) (and (= n_4500 (+ 1 max_5795)) (or (and (= max_5795 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5795 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5794 Int)) (and (= n (+ 1 max_5794)) (or (and (= max_5794 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5794 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5793 Int)) (and (= tn (+ 1 max_5793)) (or (and (= max_5793 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5793 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
