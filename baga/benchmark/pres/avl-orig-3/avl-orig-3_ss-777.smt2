...
(assert (exists ((resb_5418 Int)) (= (+ resb_5418 n2_5378) (+ 1 n1_5374))))
(assert (exists ((max_5417 Int)) (and (= v_int_79_5367 (+ 1 max_5417)) (or (and (= max_5417 n1_5374) (>= n1_5374 n2_5378)) (and (= max_5417 n2_5378) (< n1_5374 n2_5378))))))
(assert (= n2_5378 n_4611))
(assert (= n1_5374 n_4500))
(assert (exists ((max_5416 Int)) (and (= tn (+ 1 max_5416)) (or (and (= max_5416 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5416 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
(assert (= v_int_79_5367 (+ 1 n_4611)))
;Negation of Consequence
(assert (not (or (and (not (= n2_5378 n1_5374)) (= (+ tn 1) v_int_79_5367)) (= tn v_int_79_5367))))
(check-sat)