...
(assert (exists ((max_63 Int)) (and (= v_int_79_5798 (+ 1 max_63)) (or (and (= max_63 n1_5805) (>= n1_5805 n2_5809)) (and (= max_63 n2_5809) (< n1_5805 n2_5809))))))
(assert (exists ((resb_5801 Int)) (= (+ resb_5801 n2_5809) (+ 1 n1_5805))))
