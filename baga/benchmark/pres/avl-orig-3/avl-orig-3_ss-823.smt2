...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5470 Int)) (= (+ flted_44_5470 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5469 Int)) (and (= v_int_79_5425 (+ 1 max_5469)) (or (and (= max_5469 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5469 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5468 Int)) (and (= tn (+ 1 max_5468)) (or (and (= max_5468 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5468 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
