...
(assert (or (and (and (and (< v_node_161_1507_primed 1) (= m_2964 0)) (= n_2965 0)) (= b_2966 1)) (and (and (and (and (and (<= 0 b_2966) (<= (+ (- 0 n_2965) 2) b_2966)) (<= b_2966 n_2965)) (<= b_2966 2)) (<= 1 m_2964)) (> v_node_161_1507_primed 0))))
