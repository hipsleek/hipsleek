...
(assert (< 0 tm_3797))
(assert (<= 0 m1_3778))
(assert (exists ((flted_44_5485 Int)) (= (+ flted_44_5485 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5484 Int)) (and (= v_int_79_5425 (+ 1 max_5484)) (or (and (= max_5484 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5484 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5483 Int)) (and (= tn (+ 1 max_5483)) (or (and (= max_5483 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5483 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
