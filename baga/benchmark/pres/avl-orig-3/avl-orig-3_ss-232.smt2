...
(assert (exists ((max_63 Int)) (and (= resln_3602 (+ 1 max_63)) (or (and (= max_63 n1_3623) (>= n1_3623 n2_3627)) (and (= max_63 n2_3627) (< n1_3623 n2_3627))))))
(assert (exists ((bb1_3607 Int)) (= (+ bb1_3607 n2_3627) (+ 1 n1_3623))))
