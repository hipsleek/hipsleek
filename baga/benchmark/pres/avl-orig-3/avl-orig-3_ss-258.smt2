...
(assert (= t_primed 1))
(assert (or (and (and (and (< v_node_54_2112_primed 1) (= m_3843 0)) (= n_3844 0)) (= b_3845 1)) (and (and (and (and (and (<= 0 b_3845) (<= (+ (- 0 n_3844) 2) b_3845)) (<= b_3845 n_3844)) (<= b_3845 2)) (<= 1 m_3843)) (> v_node_54_2112_primed 0))))
