...
(declare-fun n_4568 () Int)
(declare-fun b_4569 () Int)
(declare-fun m_4567 () Int)
...
(assert (<= 0 ba3))
(assert (<= ba3 2))
(assert (= v_node_79_2257_primed resl_4463))
(assert (<= 0 bm))
(assert (<= 0 bn))
(assert (<= 0 ba2))
(assert (<= ba2 2))
...
(assert (> resl_4463 0))
(assert (= res n_4500))
(assert (= m_4567 m_4499))
(assert (= n_4568 n_4500))
(assert (= b_4569 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4567 0)) (= n_4568 0)) (= b_4569 1)) (and (and (and (and (and (<= 0 b_4569) (<= (+ (- 0 n_4568) 2) b_4569)) (<= b_4569 n_4568)) (<= b_4569 2)) (<= 1 m_4567)) (> v_node_79_2257_primed 0))))
