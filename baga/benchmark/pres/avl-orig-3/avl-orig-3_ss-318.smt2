...
(declare-fun n_3958 () Int)
(declare-fun b_3959 () Int)
(declare-fun m_3957 () Int)
(declare-fun v_node_55_2143_primed () Int)
...
(assert (<= b_3860 2))
(assert (= (+ 2 n_3859) n))
(assert (= v_node_55_2143_primed p_3940))
...
(assert (<= Anon_3943 2))
(assert (= res n_3951))
(assert (= m_3957 m_3950))
(assert (= n_3958 n_3951))
(assert (= b_3959 b_3952))
(assert (<= 0 m_3950))
(assert (<= 0 n_3951))
(assert (<= 0 b_3952))
(assert (<= b_3952 2))
...
(assert (or (and (and (and (< v_node_55_2143_primed 1) (= m_3957 0)) (= n_3958 0)) (= b_3959 1)) (and (and (and (and (and (<= 0 b_3959) (<= (+ (- 0 n_3958) 2) b_3959)) (<= b_3959 n_3958)) (<= b_3959 2)) (<= 1 m_3957)) (> v_node_55_2143_primed 0))))
