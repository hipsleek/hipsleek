...
(declare-fun n_4159 () Int)
(declare-fun b_4160 () Int)
(declare-fun m_4158 () Int)
...
(assert (<= Anon_3780 2))
(assert (= res n_4153))
(assert (= m_4158 m_4152))
(assert (= n_4159 n_4153))
(assert (= b_4160 b_4154))
(assert (<= 0 m_4152))
(assert (<= 0 n_4153))
(assert (<= 0 b_4154))
(assert (<= b_4154 2))
...
(assert (or (and (and (and (< v_node_69_2198_primed 1) (= m_4158 0)) (= n_4159 0)) (= b_4160 1)) (and (and (and (and (and (<= 0 b_4160) (<= (+ (- 0 n_4159) 2) b_4160)) (<= b_4160 n_4159)) (<= b_4160 2)) (<= 1 m_4158)) (> v_node_69_2198_primed 0))))
