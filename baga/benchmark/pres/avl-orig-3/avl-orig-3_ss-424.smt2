...
(assert (<= 0 n2_4347))
(assert (= cn n2_4347))
(assert (exists ((max_4361 Int)) (and (= n_4264 (+ 1 max_4361)) (or (and (= max_4361 n1_4343) (>= n1_4343 n2_4347)) (and (= max_4361 n2_4347) (< n1_4343 n2_4347))))))
(assert (= (+ b_4265 n2_4347) (+ 1 n1_4343)))
(assert (<= n2_4347 (+ 1 n1_4343)))
(assert (<= n1_4343 (+ n2_4347 1)))
(assert (exists ((max_4362 Int)) (and (= n (+ 1 max_4362)) (or (and (= max_4362 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4362 n2_4240) (< n1_4236 n2_4240))))))
(assert (= n_4232 n))
(assert (exists ((max_4363 Int)) (and (= tn (+ 1 max_4363)) (or (and (= max_4363 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4363 n2_3783) (< n1_3779 n2_3783))))))
