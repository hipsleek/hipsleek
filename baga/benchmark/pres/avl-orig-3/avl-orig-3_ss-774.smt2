...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5339 Int)) (= (+ flted_44_5339 n2_5317) (+ 1 n1_5313))))
(assert (exists ((max_5338 Int)) (and (= v_int_79_5306 (+ 1 max_5338)) (or (and (= max_5338 n1_5313) (>= n1_5313 n2_5317)) (and (= max_5338 n2_5317) (< n1_5313 n2_5317))))))
...
(assert (exists ((max_5337 Int)) (and (= tn (+ 1 max_5337)) (or (and (= max_5337 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5337 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
