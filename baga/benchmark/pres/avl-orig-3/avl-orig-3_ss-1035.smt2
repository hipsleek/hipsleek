...
(assert (< 0 tm_4091))
(assert (<= 0 m2_3782))
(assert (exists ((flted_44_6222 Int)) (= (+ flted_44_6222 n2_6179) (+ 1 n1_6175))))
(assert (exists ((max_6221 Int)) (and (= v_int_79_6168 (+ 1 max_6221)) (or (and (= max_6221 n1_6175) (>= n1_6175 n2_6179)) (and (= max_6221 n2_6179) (< n1_6175 n2_6179))))))
...
(assert (exists ((max_6220 Int)) (and (= tn (+ 1 max_6220)) (or (and (= max_6220 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6220 n2_3783) (< n1_3779 n2_3783))))))
