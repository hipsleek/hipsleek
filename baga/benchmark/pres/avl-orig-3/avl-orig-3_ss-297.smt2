...
(assert (exists ((max_3955 Int)) (and (= tn (+ 1 max_3955)) (or (and (= max_3955 n1_3779) (>= n1_3779 n2_3783)) (and (= max_3955 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_3956 Int)) (and (= n (+ 1 max_3956)) (or (and (= max_3956 n1_3942) (>= n1_3942 n2_3946)) (and (= max_3956 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (not (or (= m1_3941 0) (or (= n1_3942 0) (< p_3940 1)))))
(check-sat)