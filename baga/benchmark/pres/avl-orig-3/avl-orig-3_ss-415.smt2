...
(assert (exists ((max_4311 Int)) (and (= tn (+ 1 max_4311)) (or (and (= max_4311 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4311 n2_3783) (< n1_3779 n2_3783))))))
(assert (= tm (+ (+ m2_3782 1) m1_3778)))
(assert (= n_4232 n))
(assert (<= n1_4236 (+ n2_4240 1)))
(assert (<= n2_4240 (+ 1 n1_4236)))
(assert (= (+ b_4133 n2_4240) (+ 1 n1_4236)))
(assert (exists ((max_4312 Int)) (and (= n (+ 1 max_4312)) (or (and (= max_4312 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4312 n2_4240) (< n1_4236 n2_4240))))))
