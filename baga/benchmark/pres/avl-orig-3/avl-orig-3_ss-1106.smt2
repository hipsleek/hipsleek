...
(assert (exists ((resb_6395 Int)) (= (+ resb_6395 n2_6359) (+ 1 n1_6355))))
(assert (exists ((max_6394 Int)) (and (= v_int_79_6348 (+ 1 max_6394)) (or (and (= max_6394 n1_6355) (>= n1_6355 n2_6359)) (and (= max_6394 n2_6359) (< n1_6355 n2_6359))))))
...
(assert (= tn_4092 0))
(assert (= n_3775 tn))
(assert (exists ((max_6393 Int)) (and (= tn (+ 1 max_6393)) (or (and (= max_6393 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6393 n2_3783) (< n1_3779 n2_3783))))))
