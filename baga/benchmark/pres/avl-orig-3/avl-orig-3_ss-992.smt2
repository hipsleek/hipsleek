...
(assert (< 0 tm_4091))
(assert (<= 0 m2_3782))
(assert (exists ((flted_44_6109 Int)) (= (+ flted_44_6109 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6108 Int)) (and (= v_int_79_6049 (+ 1 max_6108)) (or (and (= max_6108 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6108 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6107 Int)) (and (= tn (+ 1 max_6107)) (or (and (= max_6107 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6107 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
