...
(assert (exists ((max_5191 Int)) (and (= n (+ 1 max_5191)) (or (and (= max_5191 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5191 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_5190 Int)) (and (= tn (+ 1 max_5190)) (or (and (= max_5190 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5190 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5192 Int)) (and (= n_3970 (+ 1 max_5192)) (or (and (= max_5192 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5192 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
...
(assert (not (or (and (= v_int_79_5149 (+ 1 n1_5156)) (<= n2_5160 n1_5156)) (and (= v_int_79_5149 (+ 1 n2_5160)) (< n1_5156 n2_5160)))))
(check-sat)