...
(assert (exists ((max_4645 Int)) (and (= n (+ 1 max_4645)) (or (and (= max_4645 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4645 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_4646 Int)) (and (= tn (+ 1 max_4646)) (or (and (= max_4646 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4646 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= resrn_4442 (+ 1 n1_4618)) (<= n2_4622 n1_4618)) (and (= resrn_4442 (+ 1 n2_4622)) (< n1_4618 n2_4622)))))
(check-sat)