...
(assert (exists ((flted_44_5044 Int)) (= (+ flted_44_5044 n2_4967) (+ 1 n1_4963))))
(assert (exists ((max_5043 Int)) (and (= v_int_79_4956 (+ 1 max_5043)) (or (and (= max_5043 n1_4963) (>= n1_4963 n2_4967)) (and (= max_5043 n2_4967) (< n1_4963 n2_4967))))))
(assert (= Anon_4968 b_4612))
(assert (= n2_4967 n_4611))
(assert (exists ((max_5042 Int)) (and (= n_4611 (+ 1 max_5042)) (or (and (= max_5042 n1_4618) (>= n1_4618 n2_4622)) (and (= max_5042 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_5041 Int)) (and (= n (+ 1 max_5041)) (or (and (= max_5041 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5041 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_5040 Int)) (and (= tn (+ 1 max_5040)) (or (and (= max_5040 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5040 n2_3783) (< n1_3779 n2_3783))))))
