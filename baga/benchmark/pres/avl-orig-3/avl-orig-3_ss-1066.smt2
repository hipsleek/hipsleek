...
(assert (exists ((max_6314 Int)) (and (= tn (+ 1 max_6314)) (or (and (= max_6314 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6314 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (not (or (and (= v_int_79_6287 (+ 1 n1_6294)) (<= n2_6298 n1_6294)) (and (= v_int_79_6287 (+ 1 n2_6298)) (< n1_6294 n2_6298)))))
(check-sat)