...
(assert (exists ((max_4268 Int)) (and (= tn (+ 1 max_4268)) (or (and (= max_4268 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4268 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4269 Int)) (and (= n (+ 1 max_4269)) (or (and (= max_4269 n1_4236) (>= n1_4236 n2_4240)) (and (= max_4269 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (not (or (= m1_4235 0) (or (= n1_4236 0) (< p_4234 1)))))
(check-sat)