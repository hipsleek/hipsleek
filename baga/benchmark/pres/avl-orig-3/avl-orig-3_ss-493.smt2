...
(assert (exists ((max_4643 Int)) (and (= n (+ 1 max_4643)) (or (and (= max_4643 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4643 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_4644 Int)) (and (= tn (+ 1 max_4644)) (or (and (= max_4644 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4644 n2_3783) (< n1_3779 n2_3783))))))
