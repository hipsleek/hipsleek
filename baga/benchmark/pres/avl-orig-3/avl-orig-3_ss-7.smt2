...
(assert (exists ((max_2598 Int)) (and (= n (+ 1 max_2598)) (or (and (= max_2598 n1_2560) (>= n1_2560 n2_2564)) (and (= max_2598 n2_2564) (< n1_2560 n2_2564))))))
...
(assert (not (or (= m2_2563 0) (or (= n2_2564 0) (< q_2562 1)))))
(check-sat)