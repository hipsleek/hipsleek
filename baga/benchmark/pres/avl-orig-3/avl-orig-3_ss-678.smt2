...
(assert (exists ((flted_44_5049 Int)) (= (+ flted_44_5049 n2_4967) (+ 1 n1_4963))))
(assert (exists ((max_5048 Int)) (and (= v_int_79_4956 (+ 1 max_5048)) (or (and (= max_5048 n1_4963) (>= n1_4963 n2_4967)) (and (= max_5048 n2_4967) (< n1_4963 n2_4967))))))
(assert (= Anon_4968 b_4612))
(assert (= n2_4967 n_4611))
(assert (exists ((max_5047 Int)) (and (= n_4611 (+ 1 max_5047)) (or (and (= max_5047 n1_4618) (>= n1_4618 n2_4622)) (and (= max_5047 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_5046 Int)) (and (= n (+ 1 max_5046)) (or (and (= max_5046 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5046 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_5045 Int)) (and (= tn (+ 1 max_5045)) (or (and (= max_5045 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5045 n2_3783) (< n1_3779 n2_3783))))))
