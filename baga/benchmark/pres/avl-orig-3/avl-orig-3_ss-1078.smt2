...
(assert (exists ((flted_44_6347 Int)) (= (+ flted_44_6347 n2_6298) (+ 1 n1_6294))))
(assert (exists ((max_6346 Int)) (and (= v_int_79_6287 (+ 1 max_6346)) (or (and (= max_6346 n1_6294) (>= n1_6294 n2_6298)) (and (= max_6346 n2_6298) (< n1_6294 n2_6298))))))
...
(assert (exists ((max_6345 Int)) (and (= tn (+ 1 max_6345)) (or (and (= max_6345 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6345 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
