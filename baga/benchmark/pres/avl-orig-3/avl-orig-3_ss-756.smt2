...
(declare-fun Anon_5260 () Int)
(declare-fun n2_5259 () Int)
(declare-fun m2_5258 () Int)
(declare-fun Anon_5256 () Int)
(declare-fun n1_5255 () Int)
(declare-fun m1_5254 () Int)
(declare-fun q_5257 () Int)
(declare-fun q_3781 () Int)
(declare-fun p_5253 () Int)
(declare-fun v_node_52_3833 () Int)
(declare-fun Anon_5252 () Int)
...
;Axioms assertions
;Antecedent
(assert (= Anon_5260 b_4612))
(assert (= n2_5259 n_4611))
(assert (= m2_5258 m_4610))
(assert (= Anon_5256 b_4501))
(assert (= n1_5255 n_4500))
(assert (= m1_5254 m_4499))
(assert (= q_5257 q_3781))
(assert (= p_5253 v_node_52_3833))
(assert (= Anon_5252 Anon_3776))
