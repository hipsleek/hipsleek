...
(declare-fun n_4578 () Int)
(declare-fun b_4579 () Int)
(declare-fun m_4577 () Int)
...
(assert (<= b_4154 2))
(assert (= res n_4500))
(assert (= m_4577 m_4499))
(assert (= n_4578 n_4500))
(assert (= b_4579 b_4501))
(assert (<= 0 m_4499))
(assert (<= 0 n_4500))
(assert (<= 0 b_4501))
(assert (<= b_4501 2))
...
(assert (or (and (and (and (< v_node_79_2257_primed 1) (= m_4577 0)) (= n_4578 0)) (= b_4579 1)) (and (and (and (and (and (<= 0 b_4579) (<= (+ (- 0 n_4578) 2) b_4579)) (<= b_4579 n_4578)) (<= b_4579 2)) (<= 1 m_4577)) (> v_node_79_2257_primed 0))))
