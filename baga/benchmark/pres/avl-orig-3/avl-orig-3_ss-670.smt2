...
(assert (exists ((flted_44_5009 Int)) (= (+ flted_44_5009 n2_4967) (+ 1 n1_4963))))
(assert (exists ((max_5008 Int)) (and (= v_int_79_4956 (+ 1 max_5008)) (or (and (= max_5008 n1_4963) (>= n1_4963 n2_4967)) (and (= max_5008 n2_4967) (< n1_4963 n2_4967))))))
(assert (= Anon_4968 b_4612))
(assert (= n2_4967 n_4611))
(assert (exists ((max_5007 Int)) (and (= n_4611 (+ 1 max_5007)) (or (and (= max_5007 n1_4618) (>= n1_4618 n2_4622)) (and (= max_5007 n2_4622) (< n1_4618 n2_4622))))))
...
(assert (exists ((max_5006 Int)) (and (= n (+ 1 max_5006)) (or (and (= max_5006 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5006 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_5005 Int)) (and (= tn (+ 1 max_5005)) (or (and (= max_5005 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5005 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
