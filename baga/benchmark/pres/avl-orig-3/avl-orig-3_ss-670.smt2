...
(assert (exists ((max_5094 Int)) (and (= n (+ 1 max_5094)) (or (and (= max_5094 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5094 n2_3946) (< n1_3942 n2_3946))))))
(assert (= (+ b_3839 n2_3946) (+ 1 n1_3942)))
(assert (<= n2_3946 (+ 1 n1_3942)))
(assert (<= n1_3942 (+ n2_3946 1)))
(assert (= n_3938 n))
(assert (exists ((max_5093 Int)) (and (= tn (+ 1 max_5093)) (or (and (= max_5093 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5093 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_5095 Int)) (and (= n_3970 (+ 1 max_5095)) (or (and (= max_5095 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5095 n2_4053) (< n1_4049 n2_4053))))))
(assert (= bn n1_4049))
(assert (= cn n2_4053))
