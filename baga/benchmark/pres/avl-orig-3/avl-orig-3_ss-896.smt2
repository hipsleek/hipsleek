...
(assert (exists ((resb_5668 Int)) (= (+ resb_5668 n2_5616) (+ 1 n1_5612))))
(assert (exists ((max_5667 Int)) (and (= v_int_79_5605 (+ 1 max_5667)) (or (and (= max_5667 n1_5612) (>= n1_5612 n2_5616)) (and (= max_5667 n2_5616) (< n1_5612 n2_5616))))))
(assert (= Anon_5613 b_4501))
(assert (= n1_5612 n_4500))
(assert (exists ((max_5666 Int)) (and (= n_4500 (+ 1 max_5666)) (or (and (= max_5666 n1_4526) (>= n1_4526 n2_4530)) (and (= max_5666 n2_4530) (< n1_4526 n2_4530))))))
...
(assert (exists ((max_5665 Int)) (and (= n (+ 1 max_5665)) (or (and (= max_5665 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5665 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (exists ((max_5664 Int)) (and (= tn (+ 1 max_5664)) (or (and (= max_5664 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5664 n2_3783) (< n1_3779 n2_3783))))))
