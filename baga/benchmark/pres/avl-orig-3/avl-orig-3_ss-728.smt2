...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5281 Int)) (= (+ resb_5281 n2_5259) (+ 1 n1_5255))))
(assert (exists ((max_5280 Int)) (and (= v_int_79_5248 (+ 1 max_5280)) (or (and (= max_5280 n1_5255) (>= n1_5255 n2_5259)) (and (= max_5280 n2_5259) (< n1_5255 n2_5259))))))
...
(assert (exists ((max_5279 Int)) (and (= tn (+ 1 max_5279)) (or (and (= max_5279 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5279 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
