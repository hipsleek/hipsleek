...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_6082 Int)) (= (+ flted_44_6082 n2_6060) (+ 1 n1_6056))))
(assert (exists ((max_6081 Int)) (and (= v_int_79_6049 (+ 1 max_6081)) (or (and (= max_6081 n1_6056) (>= n1_6056 n2_6060)) (and (= max_6081 n2_6060) (< n1_6056 n2_6060))))))
...
(assert (exists ((max_6080 Int)) (and (= tn (+ 1 max_6080)) (or (and (= max_6080 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6080 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
