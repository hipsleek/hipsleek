...
;Axioms assertions
;Antecedent
(assert (exists ((resb_6158 Int)) (= (+ resb_6158 n2_6121) (+ 1 n1_6117))))
(assert (exists ((max_6157 Int)) (and (= v_int_79_6110 (+ 1 max_6157)) (or (and (= max_6157 n1_6117) (>= n1_6117 n2_6121)) (and (= max_6157 n2_6121) (< n1_6117 n2_6121))))))
...
(assert (exists ((max_6156 Int)) (and (= tn (+ 1 max_6156)) (or (and (= max_6156 n1_3779) (>= n1_3779 n2_3783)) (and (= max_6156 n2_3783) (< n1_3779 n2_3783))))))
(assert (= n_3775 tn))
