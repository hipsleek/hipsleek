...
(assert (exists ((resb_5522 Int)) (= (+ resb_5522 n2_5497) (+ 1 n1_5493))))
(assert (exists ((max_5521 Int)) (and (= v_int_79_5486 (+ 1 max_5521)) (or (and (= max_5521 n1_5493) (>= n1_5493 n2_5497)) (and (= max_5521 n2_5497) (< n1_5493 n2_5497))))))
...
(assert (exists ((max_5520 Int)) (and (= tn (+ 1 max_5520)) (or (and (= max_5520 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5520 n2_3783) (< n1_3779 n2_3783))))))
