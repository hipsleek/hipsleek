...
(declare-fun resn_3806 () Int)
(declare-fun resb_3807 () Int)
(declare-fun flted_43_3805 () Int)
(declare-fun res () Int)
...
(assert (<= 0 Anon_3780))
(assert (<= Anon_3780 2))
(assert (= flted_43_3805 (+ 1 tm_3797)))
(assert (> v_node_52_2099_primed 0))
(assert (< 0 tm_3797))
(assert (< 0 tn_3798))
(assert (or (= tn_3798 resn_3806) (and (= resn_3806 (+ 1 tn_3798)) (not (= resb_3807 1)))))
(assert (<= 0 tm_3797))
(assert (<= 0 tn_3798))
(assert (<= 0 b_3799))
(assert (<= b_3799 2))
...
(assert (or (and (and (and (< res 1) (= flted_43_3805 0)) (= resn_3806 0)) (= resb_3807 1)) (and (and (and (and (and (<= 0 resb_3807) (<= (+ (- 0 resn_3806) 2) resb_3807)) (<= resb_3807 resn_3806)) (<= resb_3807 2)) (<= 1 flted_43_3805)) (> res 0))))
