...
(assert (exists ((max_4057 Int)) (and (= tn (+ 1 max_4057)) (or (and (= max_4057 n1_3779) (>= n1_3779 n2_3783)) (and (= max_4057 n2_3783) (< n1_3779 n2_3783))))))
...
(assert (exists ((max_4056 Int)) (and (= n (+ 1 max_4056)) (or (and (= max_4056 n1_3942) (>= n1_3942 n2_3946)) (and (= max_4056 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (exists ((max_4055 Int)) (and (= n_3970 (+ 1 max_4055)) (or (and (= max_4055 n1_4049) (>= n1_4049 n2_4053)) (and (= max_4055 n2_4053) (< n1_4049 n2_4053))))))
...
(assert (not (or (= m1_4048 0) (or (= n1_4049 0) (< p_4047 1)))))
(check-sat)