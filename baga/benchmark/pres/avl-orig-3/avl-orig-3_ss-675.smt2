...
;Axioms assertions
;Antecedent
(assert (exists ((resb_5108 Int)) (= (+ resb_5108 n2_5066) (+ 1 n1_5062))))
(assert (exists ((max_5107 Int)) (and (= v_int_79_5055 (+ 1 max_5107)) (or (and (= max_5107 n1_5062) (>= n1_5062 n2_5066)) (and (= max_5107 n2_5066) (< n1_5062 n2_5066))))))
...
(assert (exists ((max_5104 Int)) (and (= n_3970 (+ 1 max_5104)) (or (and (= max_5104 n1_4049) (>= n1_4049 n2_4053)) (and (= max_5104 n2_4053) (< n1_4049 n2_4053))))))
(assert (= cn n2_4053))
...
(assert (exists ((max_5105 Int)) (and (= n (+ 1 max_5105)) (or (and (= max_5105 n1_3942) (>= n1_3942 n2_3946)) (and (= max_5105 n2_3946) (< n1_3942 n2_3946))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5106 Int)) (and (= tn (+ 1 max_5106)) (or (and (= max_5106 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5106 n2_3783) (< n1_3779 n2_3783))))))
