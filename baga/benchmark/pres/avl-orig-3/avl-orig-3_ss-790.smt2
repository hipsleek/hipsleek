...
;Axioms assertions
;Antecedent
(assert (exists ((flted_44_5461 Int)) (= (+ flted_44_5461 n2_5436) (+ 1 n1_5432))))
(assert (exists ((max_5460 Int)) (and (= v_int_79_5425 (+ 1 max_5460)) (or (and (= max_5460 n1_5432) (>= n1_5432 n2_5436)) (and (= max_5460 n2_5436) (< n1_5432 n2_5436))))))
...
(assert (exists ((max_5459 Int)) (and (= tn (+ 1 max_5459)) (or (and (= max_5459 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5459 n2_3783) (< n1_3779 n2_3783))))))
