...
(assert (exists ((max_3316 Int)) (and (= an_3288 (+ 1 max_3316)) (or (and (= max_3316 n1_3299) (>= n1_3299 n2_3303)) (and (= max_3316 n2_3303) (< n1_3299 n2_3303))))))
