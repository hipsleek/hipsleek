...
(declare-fun right_52_2095_primed () Int)
(declare-fun left_52_2094_primed () Int)
(declare-fun height_52_2093_primed () Int)
(declare-fun ele_52_2092_primed () Int)
(declare-fun t () Int)
(declare-fun x () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_52_2095_primed q_3781))
(assert (= left_52_2094_primed p_3777))
(assert (= height_52_2093_primed n_3775))
(assert (= ele_52_2092_primed Anon_3776))
(assert (= t_primed t))
(assert (= x_primed x))
(assert (< tmp_primed 1))
(assert (> t_primed 0))
