...
;Axioms assertions
;Antecedent
(assert (exists ((bb1_3703 Int)) (= (+ bb1_3703 n2_3627) (+ 1 n1_3623))))
(assert (<= 0 an))
(assert (<= 0 an_3491))
...
(assert (exists ((max_3702 Int)) (and (= resln_3602 (+ 1 max_3702)) (or (and (= max_3702 n1_3623) (>= n1_3623 n2_3627)) (and (= max_3702 n2_3627) (< n1_3623 n2_3627))))))
...
(assert (exists ((max_3701 Int)) (and (= cn_3548 (+ 1 max_3701)) (or (and (= max_3701 n1_3556) (>= n1_3556 n2_3560)) (and (= max_3701 n2_3560) (< n1_3556 n2_3560))))))
(assert (<= 0 cn_3548))
;Negation of Consequence
(assert (not (or (and (= (+ cn 1) cn_3548) (< dn cn_3548)) (and (= (+ dn 1) cn_3548) (<= (+ cn 2) cn_3548)))))
(check-sat)