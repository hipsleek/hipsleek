...
(assert (exists ((flted_44_5990 Int)) (= (+ flted_44_5990 n2_5903) (+ 1 n1_5899))))
(assert (exists ((max_5989 Int)) (and (= v_int_79_5892 (+ 1 max_5989)) (or (and (= max_5989 n1_5899) (>= n1_5899 n2_5903)) (and (= max_5989 n2_5903) (< n1_5899 n2_5903))))))
...
(assert (exists ((max_5986 Int)) (and (= n_4264 (+ 1 max_5986)) (or (and (= max_5986 n1_4343) (>= n1_4343 n2_4347)) (and (= max_5986 n2_4347) (< n1_4343 n2_4347))))))
(assert (= bn n1_4343))
...
(assert (exists ((max_5987 Int)) (and (= n (+ 1 max_5987)) (or (and (= max_5987 n1_4236) (>= n1_4236 n2_4240)) (and (= max_5987 n2_4240) (< n1_4236 n2_4240))))))
...
(assert (= n_3775 tn))
(assert (exists ((max_5988 Int)) (and (= tn (+ 1 max_5988)) (or (and (= max_5988 n1_3779) (>= n1_3779 n2_3783)) (and (= max_5988 n2_3783) (< n1_3779 n2_3783))))))
