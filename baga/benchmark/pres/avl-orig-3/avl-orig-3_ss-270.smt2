...
(declare-fun n_3869 () Int)
(declare-fun b_3870 () Int)
(declare-fun m_3868 () Int)
...
(assert (<= Anon_3784 2))
(assert (= res n_3859))
(assert (= m_3868 m_3858))
(assert (= n_3869 n_3859))
(assert (= b_3870 b_3860))
(assert (<= 0 m_3858))
(assert (<= 0 n_3859))
(assert (<= 0 b_3860))
(assert (<= b_3860 2))
...
(assert (or (and (and (and (< v_node_54_2120_primed 1) (= m_3868 0)) (= n_3869 0)) (= b_3870 1)) (and (and (and (and (and (<= 0 b_3870) (<= (+ (- 0 n_3869) 2) b_3870)) (<= b_3870 n_3869)) (<= b_3870 2)) (<= 1 m_3868)) (> v_node_54_2120_primed 0))))
