...
(declare-fun right_109_1570_primed () Int)
(declare-fun left_109_1569_primed () Int)
(declare-fun val_109_1568_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_109_1570_primed q_2213))
(assert (= left_109_1569_primed p_2210))
(assert (= val_109_1568_primed Anon_2209))
(assert (<= 0 n_2232))
(assert (<= 0 m_2231))
(assert (< q_2241 1))
(assert (<= 0 n2_2215))
