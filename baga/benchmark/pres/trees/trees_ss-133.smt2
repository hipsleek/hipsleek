...
(declare-fun right_111_1584_primed () Int)
(declare-fun q_2213 () Int)
(declare-fun left_111_1583_primed () Int)
(declare-fun val_111_1582_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_111_1584_primed q_2213))
(assert (= left_111_1583_primed v_null_type_110_2270))
(assert (= val_111_1582_primed Anon_2209))
