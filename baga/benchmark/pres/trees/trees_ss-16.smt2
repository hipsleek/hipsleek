...
(declare-fun p_1799 () Int)
(declare-fun r_1779 () Int)
(declare-fun self_1800 () Int)
...
(declare-fun n1_1803 () Int)
(declare-fun q_1802 () Int)
(declare-fun z_primed () Int)
(declare-fun x_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_40_1778 (+ 1 n1_1803)))
(assert (= p_1799 r_1779))
(assert (= self_1800 z_primed))
...
(assert (= z_primed 1))
(assert (or (and (< q_1802 1) (= n1_1803 0)) (and (<= 1 n1_1803) (> q_1802 0))))
(assert (= x_primed 2))
(assert (not (= z_primed x_primed)))
