...
(declare-fun right_110_1581_primed () Int)
(declare-fun q_2213 () Int)
(declare-fun left_110_1580_primed () Int)
(declare-fun p_2210 () Int)
(declare-fun val_110_1579_primed () Int)
(declare-fun Anon_2209 () Int)
(declare-fun v_null_type_110_1578_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_110_1581_primed q_2213))
(assert (= left_110_1580_primed p_2210))
(assert (= val_110_1579_primed Anon_2209))
(assert (< v_null_type_110_1578_primed 1))
(assert (<= 0 n_2249))
(assert (<= 0 m_2248))
