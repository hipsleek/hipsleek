...
(declare-fun p_2290 () Int)
(declare-fun r_2265 () Int)
(declare-fun self_2291 () Int)
...
(declare-fun n1_2294 () Int)
(declare-fun q_2293 () Int)
(declare-fun tmp_primed () Int)
(declare-fun x_primed () Int)
;Relations declarations
;Axioms assertions
;Antecedent
(assert (= flted_40_2264 (+ 1 n1_2294)))
(assert (= p_2290 r_2265))
(assert (= self_2291 tmp_primed))
...
(assert (= tmp_primed 1))
(assert (or (and (< q_2293 1) (= n1_2294 0)) (and (<= 1 n1_2294) (> q_2293 0))))
(assert (= x_primed 2))
