...
(declare-fun right_52_1679_primed () Int)
(declare-fun left_52_1678_primed () Int)
(declare-fun val_52_1677_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_52_1679_primed q_1808))
(assert (= left_52_1678_primed p_1805))
(assert (= val_52_1677_primed Anon_1807))
