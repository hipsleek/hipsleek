...
(declare-fun right_113_1589_primed () Int)
(declare-fun left_113_1588_primed () Int)
(declare-fun val_113_1587_primed () Int)
(declare-fun Anon_2298 () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_113_1589_primed q_2299))
(assert (= left_113_1588_primed p_2296))
(assert (= val_113_1587_primed Anon_2298))
