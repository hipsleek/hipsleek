...
(declare-fun Anon_2318 () Int)
(declare-fun Anon_2298 () Int)
(declare-fun q_2319 () Int)
(declare-fun q_2299 () Int)
(declare-fun n1_2300 () Int)
(declare-fun n1_2306 () Int)
(declare-fun n1_2320 () Int)
...
(assert (= Anon_2318 Anon_2298))
(assert (= q_2319 q_2299))
(assert (= n1_2320 n1_2300))
(assert (= n1_2306 (+ 1 n1_2320)))
