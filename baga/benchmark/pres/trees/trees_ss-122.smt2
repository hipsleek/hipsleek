...
(declare-fun right_108_1564_primed () Int)
(declare-fun left_108_1563_primed () Int)
(declare-fun val_108_1562_primed () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_108_1564_primed q_2213))
(assert (= left_108_1563_primed p_2210))
(assert (= val_108_1562_primed Anon_2209))
(assert (<= 0 n_2219))
(assert (<= 0 m_2218))
(assert (< q_2228 1))
(assert (<= 0 n1_2212))
