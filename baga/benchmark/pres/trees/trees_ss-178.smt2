...
(declare-fun right_166_1507_primed () Int)
(declare-fun left_166_1506_primed () Int)
(declare-fun val_166_1505_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_166_1507_primed q_2410))
(assert (= left_166_1506_primed p_2409))
(assert (= val_166_1505_primed v_2408))
(assert (= x_primed x))
(assert (= a_primed a))
