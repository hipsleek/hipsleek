...
(declare-fun right_172_1518_primed () Int)
(declare-fun left_172_1517_primed () Int)
(declare-fun val_172_1516_primed () Int)
(declare-fun x () Int)
(declare-fun a () Int)
...
;Axioms assertions
;Antecedent
(assert (= right_172_1518_primed q_2410))
(assert (= left_172_1517_primed p_2409))
(assert (= val_172_1516_primed v_2408))
(assert (= x_primed x))
(assert (= a_primed a))
