...
(declare-fun Anon_875 () node)
(declare-fun flted7_874 () node)
(declare-fun flted6_873 () node)
(declare-fun n () Int)
...
(assert 
(exists ((flted6 node)(flted7 node)(Anon node))(and 
;lexvar(= flted7 nil)
(= flted6 nil)
(= n 1)
(= xprm x)
(= tprm t)
(tobool  
(pto xprm (sref (ref left flted7) (ref right flted6) (ref next Anon) ))
 )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref left left7prm) (ref right right7prm) (ref next next7prm) ))
 )
)
))
