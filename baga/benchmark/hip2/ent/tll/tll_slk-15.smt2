...
(declare-fun l2_898 () node)
(declare-fun r4_900 () node)
(declare-fun flted8_897 () node)
(declare-fun n () Int)
(declare-fun n9_901 () Int)
(declare-fun n8_899 () Int)
...
(assert 
(exists ((flted8 node)(l2 node)(n8 Int)(r4 node)(n9 Int))(and 
;lexvar(= flted8 nil)
(= n (+ (+ 1 n8) n9))
(= xprm x)
(= tprm t)
(tobool (ssep 
(tree l2 n8)
(pto xprm (sref (ref left l2) (ref right r4) (ref next flted8) ))
(tree r4 n9)
) )
))
)
