...
(declare-fun Anon12_2038 () Int)
(declare-fun q12_2039 () node2)
...
(declare-fun m12 () Int)
(declare-fun m11 () Int)
(declare-fun self5_2037 () node2)
(declare-fun tmpprm () node2)
(declare-fun p8_2036 () node2)
(declare-fun r4 () node2)
(declare-fun flted4 () Int)
(declare-fun n13_2040 () Int)


(assert 
(exists ((p8 node2)(self5 node2)(Anon12 Int)(q12 node2)(n13 Int))(and 
;lexvar(= right1 q7)
(= left1 p7)
(= v1 nil)
(<= 0 n12)
...
(= flted4 (+ 1 n13))
(tobool (ssep 
(pto tmpprm (sref (ref val Anon12) (ref left p8) (ref right q12) ))
(dll q12 self5 n13)
...
(and 
(tobool  
(pto tmpprm (sref (ref val val11prm) (ref left left11prm) (ref right right11prm) ))
 )
)
))
