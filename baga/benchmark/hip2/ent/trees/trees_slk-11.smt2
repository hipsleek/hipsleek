...
(declare-fun Anon2_232 () Int)
(declare-fun q_233 () node2)
(declare-fun Anon1 () node2)
(declare-fun n () Int)
(declare-fun x () node2)
(declare-fun yprm () node2)
(declare-fun y () node2)
(declare-fun self1_231 () node2)
(declare-fun xprm () node2)
(declare-fun p_230 () node2)
(declare-fun Anon () node2)
(declare-fun m () Int)
(declare-fun n1_234 () Int)


(assert 
(exists ((p node2)(self1 node2)(Anon2 Int)(q node2)(n1 Int))(and 
;lexvar(= xprm x)
(= yprm y)
(distinct xprm nil)
(not )(= self1 xprm)
...
(= m (+ 1 n1))
(tobool (ssep 
(pto xprm (sref (ref val Anon2) (ref left p) (ref right q) ))
(dll q self1 n1)
(dll y Anon1 n)
) )
))
...
(and 
(tobool  
(pto xprm (sref (ref val valprm) (ref left leftprm) (ref right rightprm) ))
 )
)
))
