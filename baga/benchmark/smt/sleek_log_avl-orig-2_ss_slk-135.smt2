...
(avl v11 flted11 flted10 flted9)
(pto tprm (sref (ref ele Anon97) (ref height n21) (ref left v11) (ref right q5) ))
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref ele ele28prm) (ref height height28prm) (ref left left28prm) (ref right right28prm) ))
 )
)
))
