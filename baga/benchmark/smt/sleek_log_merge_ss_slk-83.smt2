...
(declare-fun s2prm () node)
(declare-fun bgres_3287 () Int)
(declare-fun smres_3286 () Int)
...
(assert 
(exists ((smres Int)(bgres Int))(and 
;lexvar(<= 0 n12)
(<= bgres bg16)
(<= sm24 smres)
(<= 0 n14)
