...
(<= bn (+ an 1))
(tobool (ssep 
(pto tprm (sref (ref ele Anon30) (ref height Anon31) (ref left k1) (ref right d) ))
(pto k1 (sref (ref ele Anon33) (ref height Anon34) (ref left a) (ref right k2) ))
(avl d dm dn Anon32)
(avl a am an Anon35)
(pto k2 (sref (ref ele Anon36) (ref height Anon37) (ref left b11) (ref right c) ))
(avl b11 bm bn Anon38)
(avl c cm cn Anon39)
) )
)
))
