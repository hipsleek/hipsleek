...
(avl l m n b)
(avl rl m8 n10 b4)
(pto k1prm (sref (ref ele Anon18) (ref height v4) (ref left l) (ref right rl) ))
) )
))
)
...
(and 
(tobool  
(pto k2prm (sref (ref ele ele18prm) (ref height height18prm) (ref left left18prm) (ref right right18prm) ))
 )
)
))
