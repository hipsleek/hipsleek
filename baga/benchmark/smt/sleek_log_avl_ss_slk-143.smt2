...
(declare-fun Anon20_11253 () Int)
(declare-fun p14_11254 () node)
(declare-fun q14_11257 () node)
...
(declare-fun n15 () Int)
(declare-fun n16 () Int)
(declare-fun height40_11252 () Int)
(declare-fun n18 () Int)
(declare-fun height42_11259 () Int)
(declare-fun height41_11256 () Int)
(declare-fun m18 () Int)
(declare-fun size29_11255 () Int)
(declare-fun size30_11258 () Int)


(assert 
(exists ((height40 Int)(Anon20 Int)(p14 node)(size29 Int)(height41 Int)(q14 node)(size30 Int)(height42 Int))(and 
;lexvar(= v73prm q13)
(= v71prm p13)
(= (+ n17 1) n18)
(<= 0 n18)
...
(avl q11 m14 n14)
(pto v73prm (sref (ref val Anon20) (ref height height40) (ref left p14) (ref right q14) ))
(avl p14 size29 height41)
(avl q14 size30 height42)
) )
))
)
...
(and 
(tobool  
(pto v73prm (sref (ref val val28prm) (ref height height28prm) (ref left left28prm) (ref right right28prm) ))
 )
)
))
