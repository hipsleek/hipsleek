...
(declare-fun q25_27165 () node)
(declare-fun q25 () node)
(declare-fun p25_27166 () node)
...
(avl q21 m28 n30)
(avl p23 m34 n36)
(pto k2prm (sref (ref val Anon34) (ref height height74) (ref left p25) (ref right q25) ))
(avl p25 size52 height76)
(avl q25 size51 height75)
...
(and 
(tobool  
(pto k2prm (sref (ref val val82prm) (ref height height82prm) (ref left left82prm) (ref right right82prm) ))
 )
)
))
