...
(declare-fun v82_26978 () node)
(declare-fun h34_26977 () Int)
(declare-fun bh28_26976 () Int)
(declare-fun flted323_26974 () Int)
(declare-fun flted324_26975 () Int)
...
(assert 
(exists ((flted323 Int)(flted324 Int)(bh28 Int)(h34 Int)(v82 node))(and 
;lexvar(<= cl19 1)
(<= 0 cl19)
(<= 1 bh26)
(<= 0 n14)
