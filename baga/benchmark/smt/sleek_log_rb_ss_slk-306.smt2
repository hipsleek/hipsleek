...
(rb v95 flted343 Anon37 bh37)
(pto xprm (sref (ref val v93) (ref color flted337) (ref left v95) (ref right r44) ))
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val50prm) (ref color color51prm) (ref left left50prm) (ref right right50prm) ))
 )
)
))
