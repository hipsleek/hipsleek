...
(tobool (ssep 
(pq l10 m62 mx39)
(pto tprm (sref (ref val d17) (ref nleft m65) (ref nright m64) (ref left l10) (ref right r10) ))
(pq r10 m61 mx38)
) )
)
)
...
(and 
(tobool  
(pto tprm (sref (ref val val23prm) (ref nleft nleft23prm) (ref nright nright23prm) (ref left left23prm) (ref right right23prm) ))
 )
)
))
