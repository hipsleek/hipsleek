...
(avl lr m n b)
(avl r m6 n8 b2)
(pto k2prm (sref (ref ele Anon6) (ref height v2) (ref left lr) (ref right r) ))
(avl ll m7 n9 b3)
) )
)
)
...
(and 
(tobool  
(pto k1prm (sref (ref ele ele10prm) (ref height height10prm) (ref left left10prm) (ref right right10prm) ))
 )
)
))
