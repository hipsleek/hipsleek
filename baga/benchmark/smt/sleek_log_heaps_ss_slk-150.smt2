...
(declare-fun ma6_10376 () Int)
(declare-fun n11_10375 () Int)
...
(and 
(tobool  
(pto tprm (sref (ref val val46prm) (ref nleft nleft46prm) (ref nright nright46prm) (ref left left46prm) (ref right right46prm) ))
 )
)
))
