...
(avl q21 m32 n34)
(avl p23 m29 n31)
(pto xprm (sref (ref val Anon30) (ref height height63) (ref left q23) (ref right q21) ))
(avl q23 m31 n33)
(pto k1prm (sref (ref val Anon32) (ref height height67) (ref left p23) (ref right xprm) ))
) )
)
)
...
(and 
(tobool  
(pto xprm (sref (ref val val72prm) (ref height height72prm) (ref left left72prm) (ref right right72prm) ))
 )
)
))
