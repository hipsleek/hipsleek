...
(declare-fun v69_25499 () node)
(declare-fun h29_25498 () Int)
(declare-fun bh22_25497 () Int)
(declare-fun flted310_25495 () Int)
(declare-fun flted311_25496 () Int)
...
(assert 
(exists ((flted310 Int)(flted311 Int)(bh22 Int)(h29 Int)(v69 node))(and 
;lexvar(<= cl16 1)
(<= 0 cl16)
(<= 1 bh21)
(<= 0 n13)
