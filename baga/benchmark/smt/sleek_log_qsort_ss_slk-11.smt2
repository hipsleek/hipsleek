...
(declare-fun lg1_291 () Int)
(declare-fun b0 () Int)
(declare-fun sm1_290 () Int)
(declare-fun s0 () Int)
(declare-fun qs_294 () Int)
(declare-fun flted1_292 () Int)
(declare-fun nn () Int)


(assert 
(exists ((sm1 Int)(lg1 Int)(flted1 Int)(q node)(qs Int))(and 
;lexvar(= xprm x)
(= yprm y)
(<= b0 s2)
(distinct xprm nil)
...
(tobool (ssep 
(sll q flted1 qs lg1)
(pto xprm (sref (ref val sm1) (ref next q) ))
(sll y m s2 b2)
) )
))
)
