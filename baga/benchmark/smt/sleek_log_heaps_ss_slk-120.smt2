...
(pq v26 n3 ma1)
(pq r12 m74 mx58)
(pto tprm (sref (ref val d19) (ref nleft m73) (ref nright m75) (ref left v26) (ref right r12) ))
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref val val31prm) (ref nleft nleft31prm) (ref nright nright31prm) (ref left left31prm) (ref right right31prm) ))
 )
)
))
