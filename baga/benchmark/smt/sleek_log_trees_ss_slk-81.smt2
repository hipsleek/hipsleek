...
(declare-fun Anon10_2442 () Int)
(declare-fun p10_2443 () node2)
(declare-fun q10_2446 () node2)
(declare-fun x () node2)
(declare-fun xprm () node2)
(declare-fun n () Int)
(declare-fun n6_2445 () Int)
(declare-fun n7_2448 () Int)
(declare-fun m () Int)
(declare-fun m9_2444 () Int)
(declare-fun m10_2447 () Int)


(assert 
(exists ((Anon10 Int)(p10 node2)(m9 Int)(n6 Int)(q10 node2)(m10 Int)(n7 Int))(and 
;lexvar(= xprm x)
(distinct xprm nil)
(= m (+ (+ m10 1) m9))
(tobool (ssep 
(pto xprm (sref (ref val Anon10) (ref left p10) (ref right q10) ))
(tree p10 m9 n6)
(tree q10 m10 n7)
) )
))
