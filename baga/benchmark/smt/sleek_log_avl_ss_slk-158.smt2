...
(avl v4 flted21 Anon23)
(pto xprm (sref (ref val Anon15) (ref height height33) (ref left p11) (ref right v4) ))
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val35prm) (ref height height35prm) (ref left left35prm) (ref right right35prm) ))
 )
)
))
