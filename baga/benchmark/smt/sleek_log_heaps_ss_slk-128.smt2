...
(declare-fun ma2_9020 () Int)
(declare-fun n5_9019 () Int)
...
(and 
(tobool  
(pto tprm (sref (ref val val35prm) (ref nleft nleft35prm) (ref nright nright35prm) (ref left left35prm) (ref right right35prm) ))
 )
)
))
