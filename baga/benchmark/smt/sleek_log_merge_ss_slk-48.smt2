...
(declare-fun lres4_1598 () Int)
(declare-fun sres4_1597 () Int)
(declare-fun flted14_1596 () Int)
(declare-fun xl () Int)
(declare-fun b1 () NUM)
(declare-fun xs () Int)
(declare-fun s1 () NUM)
...
(assert 
(exists ((flted14 Int)(sres4 Int)(lres4 Int))(and 
;lexvar(distinct x2 nil)
(<= xs xl)
(<= 1 n)
;eqmax;eqmin(= flted14 (+ 1 n))
(distinct x1 nil)
(<= s1 b1)
(<= 1 n1)
(= xl b1)
