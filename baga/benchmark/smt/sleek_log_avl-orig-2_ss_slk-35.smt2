...
(avl lr m n b)
(avl r m6 n8 b2)
(pto k2prm (sref (ref ele Anon6) (ref height v1) (ref left lr) (ref right r) ))
) )
))
)
...
(and 
(tobool  
(pto k1prm (sref (ref ele ele8prm) (ref height height8prm) (ref left left8prm) (ref right right8prm) ))
 )
)
))
