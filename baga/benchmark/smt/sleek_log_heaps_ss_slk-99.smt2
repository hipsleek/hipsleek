...
(declare-fun tmpprm () NUM)
(declare-fun maxi5_7187 () NUM)
(declare-fun mx47_7186 () Int)
(declare-fun mx46_7185 () Int)
(declare-fun mx2 () Int)
(declare-fun mx1 () Int)
...
(assert 
(exists ((mx46 Int)(mx47 Int)(maxi5 NUM))(and 
...
(distinct m64 0)
(tobool (ssep 
(pq tleftprm tnleftprm mx46)
(pq trightprm tnrightprm mx47)
) )
))
)
