...
(declare-fun p31_42243 () node)
(declare-fun p31 () node)
(declare-fun q31_42244 () node)
...
(and 
(tobool  
(pto k2prm (sref (ref val val115prm) (ref height height115prm) (ref left left115prm) (ref right right115prm) ))
 )
)
))
