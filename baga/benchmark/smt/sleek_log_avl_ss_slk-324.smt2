...
(avl v12 flted34 n45)
(pto xprm (sref (ref val Anon30) (ref height height63) (ref left p21) (ref right v12) ))
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val94prm) (ref height height94prm) (ref left left94prm) (ref right right94prm) ))
 )
)
))
