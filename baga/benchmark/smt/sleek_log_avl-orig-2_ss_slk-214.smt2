...
(< n30 n29)
(tobool (ssep 
(pto tprm (sref (ref ele Anon132) (ref height resn14) (ref left resl10) (ref right resr10) ))
(pto resr10 (sref (ref ele Anon134) (ref height resrn5) (ref left resrl5) (ref right resrr5) ))
(avl resrl5 bm bn Anon135)
(avl resrr5 cm cn Anon136)
) )
)
)
