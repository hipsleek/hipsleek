...
(declare-fun ma_8456 () Int)
(declare-fun n2_8455 () Int)
...
(and 
(tobool  
(pto tprm (sref (ref val val30prm) (ref nleft nleft30prm) (ref nright nright30prm) (ref left left30prm) (ref right right30prm) ))
 )
)
))
