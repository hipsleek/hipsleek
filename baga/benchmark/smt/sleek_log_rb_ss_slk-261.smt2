...
(declare-fun v79_26766 () node)
(declare-fun h33_26765 () Int)
(declare-fun bh27_26764 () Int)
(declare-fun flted320_26762 () Int)
(declare-fun flted321_26763 () Int)
...
(assert 
(exists ((flted320 Int)(flted321 Int)(bh27 Int)(h33 Int)(v79 node))(and 
;lexvar(<= cl19 1)
(<= 0 cl19)
(<= 1 bh26)
(<= 0 n14)
