...
(declare-fun p6_1232 () node2)
(declare-fun q6_1233 () node2)
(declare-fun pl_1229 () Int)
(declare-fun v_1231 () Int)
(declare-fun qs_1230 () Int)
(declare-fun sm1_1227 () Int)
(declare-fun s () Int)
(declare-fun lg1_1228 () Int)
(declare-fun b () Int)
...
(assert 
(exists ((sm1 Int)(lg1 Int)(pl Int)(qs Int)(v Int)(p6 node2)(q6 node2))(and 
;lexvar(<= pl v)
(<= v qs)
(= sm1 s)
(= lg1 b)
...
(tobool (ssep 
(bst p6 sm1 pl)
(pto xprm (sref (ref val v) (ref left p6) (ref right q6) ))
(bst q6 qs lg1)
) )
))
)
