...
(declare-fun right2 () node2)
(declare-fun q20 () node2)
(declare-fun ma4 () Int)
(declare-fun mi4 () Int)
(declare-fun v28_4187 () node2)
(declare-fun lg10 () Int)
...
(assert 
(exists ((v28prm node2))(and 
;lexvar(= res xprm)
(= right2 q20)
(<= sm10 lg10)
;eqmax;eqmin(distinct v28prm nil)
(<= qs5 lg8)
(= lg10 lg8)
(= sm10 qs5)
(= xprm x)
...
(bst p15 sm8 pl5)
(bst v28prm mi4 ma4)
(pto xprm (sref (ref val v7) (ref left p15) (ref right v28prm) ))
) )
))
)
