...
(declare-fun Anon4_2493 () Int)
(declare-fun Anon5_2494 () Int)
...
(assert 
(exists ((Anon4 Int)(Anon5 Int)(bprm boolean))(and 
;lexvar(<= 0 n)
(= n4 n)
(= xsprm xs)
(< 0 n)
...
(<= 0 n5)
(tobool  
(sll xsprm n5 Anon4 Anon5)
 )
))
)

(assert (not 
(exists ((n6 Int)(Anon6 Int)(Anon7 Int))(and 
(= n6 n)
(<= 0 n)
(tobool  
(sll xs n6 Anon6 Anon7)
 )
))
))
