...
(declare-fun Anon129_19418 () Int)
(declare-fun ss6_19419 () node)
(declare-fun Anon130_19420 () Int)
(declare-fun ss7_19421 () node)
(declare-fun Anon131_19422 () Int)
(declare-fun t16_19428 () Int)
(declare-fun t15_19426 () Int)
(declare-fun h10_19425 () Int)
(declare-fun h11_19427 () Int)
(declare-fun h9_19423 () Int)
(declare-fun t14_19424 () Int)
(declare-fun flted22_19416 () Int)
(declare-fun flted23_19417 () Int)
...
(assert 
(exists ((flted22 Int)(flted23 Int)(Anon129 Int)(ss6 node)(Anon130 Int)(ss7 node)(Anon131 Int)(h9 Int)(t14 Int)(h10 Int)(t15 Int)(h11 Int)(t16 Int))(and 
;lexvar(<= Anon70 2)
(<= 0 Anon70)
(<= 0 cn)
(<= 0 cm)
...
(= Anon66 b15)
(tobool (ssep 
(pto tprm (sref (ref ele Anon129) (ref height h9) (ref left ss6) (ref right ss7) ))
(avl ss6 flted23 h10 Anon130)
(avl ss7 flted22 h11 Anon131)
) )
))
)
