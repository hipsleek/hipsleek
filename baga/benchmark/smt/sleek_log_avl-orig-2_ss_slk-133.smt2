...
(declare-fun p5 () node)
(declare-fun flted5_9711 () Int)
(declare-fun flted6_9712 () Int)
(declare-fun flted7_9713 () Int)
(declare-fun b6 () Int)
...
(assert 
(exists ((flted5 Int)(flted6 Int)(flted7 Int))(and 
;lexvar(<= b6 2)
(<= 0 b6)
(<= 0 tn1)
(<= 0 tm1)
...
(avl v39prm flted7 flted6 flted5)
) )
))
)
