...
(<= bn (+ an 1))
(tobool (ssep 
(pto tprm (sref (ref ele Anon61) (ref height Anon62) (ref left a) (ref right k2) ))
(avl a am an Anon63)
(pto k2 (sref (ref ele Anon64) (ref height Anon65) (ref left k3) (ref right d) ))
(avl d dm dn Anon66)
(pto k3 (sref (ref ele Anon67) (ref height Anon68) (ref left b17) (ref right c) ))
(avl b17 bm bn Anon69)
(avl c cm cn Anon70)
) )
)
))
