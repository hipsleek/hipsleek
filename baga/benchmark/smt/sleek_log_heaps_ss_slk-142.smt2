...
(declare-fun ma4_9878 () Int)
(declare-fun n8_9877 () Int)
...
(and 
(tobool  
(pto tprm (sref (ref val val42prm) (ref nleft nleft42prm) (ref nright nright42prm) (ref left left42prm) (ref right right42prm) ))
 )
)
))
