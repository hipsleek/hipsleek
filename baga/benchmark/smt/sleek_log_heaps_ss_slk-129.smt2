...
(pq l12 m72 mx57)
(pq v28 n6 ma3)
(pto tprm (sref (ref val d19) (ref nleft m73) (ref nright m75) (ref left l12) (ref right v28) ))
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref val val36prm) (ref nleft nleft36prm) (ref nright nright36prm) (ref left left36prm) (ref right right36prm) ))
 )
)
))
