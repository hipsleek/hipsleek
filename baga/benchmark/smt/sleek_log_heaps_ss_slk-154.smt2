...
(pq l12 m72 mx57)
(pq v35 n12 ma7)
(pto tprm (sref (ref val d19) (ref nleft m73) (ref nright m75) (ref left l12) (ref right v35) ))
) )
)
)
...
(and 
(tobool  
(pto tprm (sref (ref val val48prm) (ref nleft nleft48prm) (ref nright nright48prm) (ref left left48prm) (ref right right48prm) ))
 )
)
))
