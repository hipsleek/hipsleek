...
(declare-fun v170prm () Int)
(declare-fun v169prm () Int)
(declare-fun height78 () Int)
(declare-fun hprm () Int)
(declare-fun h17 () Int)
(declare-fun hrprm () Int)
(declare-fun n41 () Int)
(declare-fun m39 () Int)
(declare-fun height77 () Int)
(declare-fun h15 () Int)
...
(declare-fun h16 () Int)
(declare-fun n42 () Int)
(declare-fun height79 () Int)
(declare-fun height80 () Int)
(declare-fun m40 () Int)
(declare-fun size54 () Int)
(declare-fun size53 () Int)
...
(avl q21 m39 n41)
(pto xprm (sref (ref val Anon30) (ref height hprm) (ref left q25) (ref right q21) ))
(avl k1prm m40 n42)
) )
)
)
