...
(declare-fun qs3 () Int)
(declare-fun lg4 () Int)
(declare-fun s6_2250 () Int)
(declare-fun l1_2251 () Int)
(declare-fun sm5 () Int)
(declare-fun lg5 () Int)
(declare-fun sm () Int)
(declare-fun lg () Int)
...
(assert 
(exists ((s6 Int)(l1 Int)(xrightprm node2))(and 
;lexvar(< v3 aprm)
(distinct v3 aprm)
(<= pl3 v3)
(<= v3 qs3)
...
(bst p9 sm4 pl3)
(bst xrightprm s6 l1)
(pto xprm (sref (ref val v3) (ref left p9) (ref right xrightprm) ))
) )
))
)
