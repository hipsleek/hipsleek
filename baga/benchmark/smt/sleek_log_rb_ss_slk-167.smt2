...
(declare-fun v51_21334 () node)
(declare-fun bh10_21333 () Int)
(declare-fun flted276_21331 () Int)
(declare-fun flted277_21332 () Int)
(declare-fun bh8 () Int)
(declare-fun cl8 () Int)
...
(assert 
(exists ((flted276 Int)(flted277 Int)(bh10 Int)(v51 node))(and 
;lexvar(<= cl8 1)
(<= 0 cl8)
(<= 1 bh8)
(<= 0 n10)
