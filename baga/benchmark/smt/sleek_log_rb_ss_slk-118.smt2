...
(declare-fun bh () Int)
(declare-fun cl () Int)
(declare-fun flted228_17700 () Int)
(declare-fun flted229_17701 () Int)
(declare-fun flted230_17702 () Int)
(declare-fun na9 () Int)
(declare-fun h22 () Int)
(declare-fun nb9 () Int)
(declare-fun nc9 () Int)
(declare-fun nd () Int)
(declare-fun v81_17703 () Int)
(declare-fun v82_17704 () Int)
...
(assert 
(exists ((flted228 Int)(flted229 Int)(flted230 Int)(v81prm Int)(v82prm Int)(tmpprm node))(and 
;lexvar(= flted223 1)
(= flted222 0)
(= flted221 0)
(= n4 (+ (+ nr25 1) nl25))
