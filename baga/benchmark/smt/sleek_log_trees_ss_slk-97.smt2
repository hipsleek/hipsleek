...
(declare-fun Anon12_3269 () Int)
(declare-fun q16_3270 () node2)
...
(declare-fun m12 () Int)
(declare-fun m11 () Int)
(declare-fun self5_3268 () node2)
(declare-fun tmpprm () node2)
(declare-fun p12_3267 () node2)
(declare-fun r4 () node2)
(declare-fun flted4 () Int)
(declare-fun n13_3271 () Int)


(assert 
(exists ((p12 node2)(self5 node2)(Anon12 Int)(q16 node2)(n13 Int))(and 
;lexvar(= right1 q11)
(= left1 p11)
(= v5 nil)
(<= 0 n12)
...
(= flted4 (+ 1 n13))
(tobool (ssep 
(pto tmpprm (sref (ref val Anon12) (ref left p12) (ref right q16) ))
(dll q16 self5 n13)
...
(and 
(tobool  
(pto tmpprm (sref (ref val val14prm) (ref left left14prm) (ref right right14prm) ))
 )
)
))
