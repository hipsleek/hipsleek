...
(pq v32 n9 ma5)
(pq r12 m74 mx58)
(pto tprm (sref (ref val d19) (ref nleft m73) (ref nright m75) (ref left v32) (ref right r12) ))
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref val val43prm) (ref nleft nleft43prm) (ref nright nright43prm) (ref left left43prm) (ref right right43prm) ))
 )
)
))
