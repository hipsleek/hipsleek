...
(declare-fun v5 () node)
(declare-fun Anon26_17460 () Int)
(declare-fun p18_17461 () node)
(declare-fun q18_17464 () node)
...
(declare-fun n22 () Int)
(declare-fun n23 () Int)
(declare-fun height52_17459 () Int)
(declare-fun n24 () Int)
(declare-fun height54_17466 () Int)
(declare-fun height53_17463 () Int)
(declare-fun m24 () Int)
(declare-fun size37_17462 () Int)
(declare-fun size38_17465 () Int)


(assert 
(exists ((height52 Int)(Anon26 Int)(p18 node)(size37 Int)(height53 Int)(q18 node)(size38 Int)(height54 Int))(and 
;lexvar(= v113prm p17)
(= v111prm p11)
(<= 0 n25)
(<= 0 m25)
...
(avl p11 m21 n21)
(pto v113prm (sref (ref val Anon26) (ref height height52) (ref left p18) (ref right q18) ))
(avl p18 size37 height53)
(avl q18 size38 height54)
) )
))
)
...
(and 
(tobool  
(pto v113prm (sref (ref val val53prm) (ref height height53prm) (ref left left53prm) (ref right right53prm) ))
 )
)
))
