...
(declare-fun n () Int)
(declare-fun r1 () node)
(declare-fun lg1_468 () Int)
(declare-fun l1 () Int)
(declare-fun sm2_467 () Int)
(declare-fun s1 () Int)
(declare-fun qs_471 () Int)
(declare-fun q_470 () node)
(declare-fun flted3_469 () Int)
(declare-fun n1 () Int)


(assert 
(exists ((sm2 Int)(lg1 Int)(flted3 Int)(q node)(qs Int))(and 
;lexvar(= v3prm r1)
(= xvprm Anon1)
(<= 0 n1)
(<= 0 flted1)
...
(= (+ flted3 1) n1)
(tobool (ssep 
(pto v3prm (sref (ref val sm2) (ref next q) ))
(sll q flted3 qs lg1)
