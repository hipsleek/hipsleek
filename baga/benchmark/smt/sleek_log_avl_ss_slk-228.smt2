...
(pto xprm (sref (ref val Anon30) (ref height height63) (ref left v8) (ref right q21) ))
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val62prm) (ref height height62prm) (ref left left62prm) (ref right right62prm) ))
 )
)
))
