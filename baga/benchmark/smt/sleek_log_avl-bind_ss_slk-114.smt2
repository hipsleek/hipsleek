...
(declare-fun m44 () Int)
(declare-fun m43 () Int)
(declare-fun xleftrightprm () __Exc)
(declare-fun q13 () __Exc)
(declare-fun xleftleftprm () __Exc)
(declare-fun p13 () __Exc)
(declare-fun xleftheightprm () Int)
(declare-fun xleftvalprm () __Exc)
...
(declare-fun xrightprm () __Exc)
(declare-fun q11 () __Exc)
(declare-fun xleft () __Exc)
