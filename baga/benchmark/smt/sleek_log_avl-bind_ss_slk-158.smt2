...
(declare-fun Anon26_13295 () Int)
(declare-fun p18_13296 () node)
(declare-fun q18_13299 () node)
(declare-fun m61 () Int)
(declare-fun n75 () Int)
(declare-fun m59 () Int)
(declare-fun m58 () Int)
...
(declare-fun n72 () Int)
(declare-fun n73 () Int)
(declare-fun n76_13294 () Int)
(declare-fun n74 () Int)
(declare-fun n78_13301 () Int)
(declare-fun n77_13298 () Int)
(declare-fun m60 () Int)
(declare-fun m62_13297 () Int)
(declare-fun m63_13300 () Int)


(assert 
(exists ((n76 Int)(Anon26 Int)(p18 node)(m62 Int)(n77 Int)(q18 node)(m63 Int)(n78 Int))(and 
;lexvar(<= 0 n75)
(<= 0 m61)
(<= 0 n72)
(<= 0 m58)
...
(pto xrightleftprm (sref (ref val Anon26) (ref height n76) (ref left p18) (ref right q18) ))
(avl p18 m62 n77)
(avl q18 m63 n78)
...
(and 
(tobool  
(pto xrightleftprm (sref (ref val val8prm) (ref height height8prm) (ref left left8prm) (ref right right8prm) ))
 )
)
))
