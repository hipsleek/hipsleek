...
(declare-fun q17 () node2)
(declare-fun left2 () node2)
...
(declare-fun m12 () Int)
(declare-fun m11 () Int)
(declare-fun p13 () node2)
(declare-fun r4 () node2)
(declare-fun flted4 () Int)
(declare-fun n14 () Int)
(declare-fun self6_3353 () node2)
...
(tobool (ssep 
(dll q17 self6 n14)
(pto xprm (sref (ref val Anon11) (ref left v5) (ref right self6) ))
(pto self6 (sref (ref val Anon13) (ref left xprm) (ref right q17) ))
) )
)
)

(assert (not 
(exists ((m16 Int)(q18 node2))(and 
(= m16 m)
(= q18 nil)
(<= 0 n)
(<= 0 m)
