...
(declare-fun nmin47_6132 () Int)
(declare-fun flted24_6131 () Int)
...
(assert 
(exists ((flted24 Int)(nmin47 Int))(and 
;lexvar(<= nmin46 n18)
(<= 0 nmin46)
(= flted24 (+ 1 n18))
(<= nmin44 n16)
...
(complete auxprm flted24 nmin47)
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref val val16prm) (ref left left16prm) (ref right right16prm) ))
 )
)
))
