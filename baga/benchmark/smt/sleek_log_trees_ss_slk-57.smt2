...
(declare-fun p8_1658 () node2)
(declare-fun q8_1659 () node2)
(declare-fun x () node2)
(declare-fun aprm () node2)
(declare-fun a () node2)
(declare-fun xprm () node2)
(declare-fun lg3_1654 () Int)
(declare-fun lg () Int)
(declare-fun sm3_1653 () Int)
(declare-fun sm () Int)
(declare-fun qs2_1656 () Int)
(declare-fun pl2_1655 () Int)
(declare-fun v2_1657 () Int)


(assert 
(exists ((sm3 Int)(lg3 Int)(pl2 Int)(qs2 Int)(v2 Int)(p8 node2)(q8 node2))(and 
;lexvar(= xprm x)
(= aprm a)
(distinct xprm nil)
(= lg3 lg)
...
(tobool (ssep 
(bst p8 sm3 pl2)
(pto xprm (sref (ref val v2) (ref left p8) (ref right q8) ))
(bst q8 qs2 lg3)
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val xvalprm) (ref left xleftprm) (ref right xrightprm) ))
 )
)
))
