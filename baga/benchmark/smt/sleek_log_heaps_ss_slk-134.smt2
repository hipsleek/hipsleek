...
(pq l12 m72 mx57)
(pq v29 n6 ma3)
(pto tprm (sref (ref val d19) (ref nleft m73) (ref nright v31) (ref left l12) (ref right v29) ))
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref val val38prm) (ref nleft nleft38prm) (ref nright nright38prm) (ref left left38prm) (ref right right38prm) ))
 )
)
))
