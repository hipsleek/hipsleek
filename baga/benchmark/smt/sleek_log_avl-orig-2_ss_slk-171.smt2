...
(declare-fun p5 () node)
(declare-fun v55prm () node)
(declare-fun q5 () node)
(declare-fun flted13_14180 () Int)
(declare-fun flted14_14181 () Int)
(declare-fun flted15_14182 () Int)
(declare-fun b12 () Int)
...
(assert 
(exists ((flted13 Int)(flted14 Int)(flted15 Int))(and 
;lexvar(<= b12 2)
(<= 0 b12)
(<= 0 tn2)
(<= 0 tm2)
...
(avl v55prm flted15 flted14 flted13)
) )
))
)
...
(and 
(tobool  
(pto tprm (sref (ref ele ele35prm) (ref height height35prm) (ref left left35prm) (ref right right35prm) ))
 )
)
))
