...
(declare-fun Anon47_50988 () Int)
(declare-fun tmpprm () node)
(declare-fun flted38_50987 () Int)
(declare-fun h30 () Int)
(declare-fun h29 () Int)
...
(assert 
(exists ((flted38 Int)(Anon47 Int))(and 
;lexvar(<= 0 h30)
(<= 0 s2)
(<= 0 h29)
(<= 0 s1)
...
(and 
(tobool  
(pto t1prm (sref (ref val val125prm) (ref height height125prm) (ref left left125prm) (ref right right125prm) ))
 )
)
))
