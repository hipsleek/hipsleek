...
(rb v101 flted353 Anon42 bh45)
(pto xprm (sref (ref val v93) (ref color flted337) (ref left l44) (ref right v101) ))
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val58prm) (ref color color59prm) (ref left left58prm) (ref right right58prm) ))
 )
)
))
