...
(declare-fun r3_2867 () node2)
(declare-fun v21prm () node2)
(declare-fun flted3_2866 () Int)
(declare-fun n12 () Int)
...
(= m (+ (+ m11 1) m12))
(tobool (ssep 
(pto xprm (sref (ref val Anon11) (ref left p11) (ref right q11) ))
...
(and 
(tobool  
(pto xprm (sref (ref val val12prm) (ref left left12prm) (ref right right12prm) ))
 )
)
))
