...
(declare-fun bg2 () Int)
(declare-fun flted5_891 () Int)
(declare-fun mi5_892 () Int)
(declare-fun xnext_893 () node)
(declare-fun n1 () Int)
(declare-fun s1 () Int)
(declare-fun mi3 () Int)
(declare-fun l1 () Int)
...
(assert 
(exists ((flted5 Int)(mi5 Int)(xnextprm node))(and 
...
(distinct p1 nil)
(tobool (ssep 
(bnd1 xnextprm flted5 s1 l1 mi5)
