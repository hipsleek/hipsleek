...
(declare-fun Anon41_32102 () Int)
(declare-fun bh44_32103 () Int)
(declare-fun v141prm () node)
(declare-fun flted352_32101 () Int)
...
(assert 
(exists ((flted352 Int)(Anon41 Int)(bh44 Int))(and 
;lexvar(<= Anon39 1)
(<= 0 Anon39)
(<= 1 bh42)
(<= 0 n20)
...
(rb v141prm flted352 Anon41 bh44)
) )
))
)
...
(and 
(tobool  
(pto xprm (sref (ref val val57prm) (ref color color58prm) (ref left left57prm) (ref right right57prm) ))
 )
)
))
