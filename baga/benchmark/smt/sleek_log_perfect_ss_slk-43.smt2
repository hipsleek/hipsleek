...
(perfect l3 flted6)
(perfect r3 flted7)
(pto tprm (sref (ref val aprm) (ref flag Anon7) (ref left l3) (ref right r3) ))
) )
)
)
...
(and 
(tobool  
(pto tprm (sref (ref val val4prm) (ref flag flag4prm) (ref left left4prm) (ref right right4prm) ))
 )
)
))
