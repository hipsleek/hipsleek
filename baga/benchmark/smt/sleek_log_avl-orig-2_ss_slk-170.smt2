...
(declare-fun resn10_14099 () Int)
(declare-fun resb2_14100 () Int)
(declare-fun q5 () node)
(declare-fun flted12_14098 () Int)
(declare-fun b12 () Int)
...
(assert 
(exists ((flted12 Int)(resn10 Int)(resb2 Int))(and 
;lexvar(<= b12 2)
(<= 0 b12)
(<= 0 tn2)
(<= 0 tm2)
...
(avl v55prm flted12 resn10 resb2)
) )
))
)
