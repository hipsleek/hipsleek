...
(declare-fun Anon6_1381 () Int)
(declare-fun q6_1382 () node)
(declare-fun b () Int)
(declare-fun flted8_1380 () Int)
(declare-fun n () Int)
(declare-fun p1_1379 () node)
(declare-fun r () node)
(declare-fun xprm () node)
(declare-fun x () node)
(declare-fun yprm () node)
(declare-fun y () node)
(declare-fun flted7_1383 () node)


(assert 
(exists ((p1 node)(flted8 Int)(Anon6 Int)(q6 node)(flted7 node))(and 
;lexvar(= (+ flted8 1) n)
(= p1 r)
(= xprm x)
(= yprm y)
(= flted7 nil)
(tobool (ssep 
(pto xprm (sref (ref val Anon6) (ref next q6) ))
(lseg q6 p1 flted8)
(pto r (sref (ref val b) (ref next flted7) ))
) )
))
)
