...
/* $Id: zlib.c,v 1.1 2005/11/20 04:34:54 stse Exp $ */
                      ...
                      value vflush)
{
  ...
  zs->next_in = (Bytef *)&Byte(srcbuf, Long_val(srcpos));
  zs->avail_in = Long_val(srclen);
  zs->next_out = (Bytef *)&Byte(dstbuf, Long_val(dstpos));
