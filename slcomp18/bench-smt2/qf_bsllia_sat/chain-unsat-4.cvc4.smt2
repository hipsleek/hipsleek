...
(define-fun neg3 ((z Loc) (b Loc) (j Int)) Bool (or (and (pto z b) (= j 0)) (sep (not (pto z b)) (or (and (pto b t) (= (- j 1) 0)) (sep (not (pto b t)) (or (and (pto t t0) (= (- (- j 1) 1) 0)) (sep (not (pto t t0)) (or (and (pto t0 t00) (= (- (- (- j 1) 1) 1) 0)) (sep (not (pto t0 t00)) (and (pto t00 t000) (= (- (- (- (- j 1) 1) 1) 1) 0)))))))))))
