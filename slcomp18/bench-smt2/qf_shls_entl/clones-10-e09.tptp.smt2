...
(assert 
		(and 
			...
			(distinct (as nil RefSll_t) x27)
			(distinct x25 x26)
			(distinct x26 x27)
			(distinct (as nil RefSll_t) x29)
			(distinct (as nil RefSll_t) x30)
			(distinct (as nil RefSll_t) x31)
			(distinct x29 x30)
			(distinct x30 x31)
			(distinct (as nil RefSll_t) x33)
			(distinct (as nil RefSll_t) x34)
			(distinct (as nil RefSll_t) x35)
			(distinct x33 x34)
			(distinct x34 x35)
			(distinct (as nil RefSll_t) x37)
			(distinct (as nil RefSll_t) x38)
			(distinct (as nil RefSll_t) x39)
			(distinct x37 x38)
			(distinct x38 x39)
		(sep 
			(ls x39 x37 )
