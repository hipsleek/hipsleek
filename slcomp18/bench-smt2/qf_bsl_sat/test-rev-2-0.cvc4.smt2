...
(assert (not (and (sep (pto u (node c0 nx3)) true) (and (sep (pto u (node dt1 nx1)) (wand (pto u (node dt1 v)) (sep (pto nx2 (node c0 (as nil Loc))) (pto u (node c0 (as nil Loc)))))) (sep (pto u (node dt2 nx2)) true)))))
