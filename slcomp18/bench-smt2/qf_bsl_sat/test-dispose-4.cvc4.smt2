...
(assert (not (and (sep (pto w (node c0 nx2)) true) (and (sep (sep (pto nx1 (node c0 u2)) (pto u2 (node c0 u3)) (pto u3 (node c0 (as nil Loc)))) (pto w node0)) (sep (pto w (node dt1 nx1)) true)))))
