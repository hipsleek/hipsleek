...
(declare-const z0 RefTll_t)
(declare-const z1 RefTll_t)
(declare-const z2 RefTll_t)
(declare-const z3 RefTll_t)
(declare-const z4 RefTll_t)
(declare-const z5 RefTll_t)
(declare-const z6 RefTll_t)
(declare-const z7 RefTll_t)
(declare-const z8 RefTll_t)
