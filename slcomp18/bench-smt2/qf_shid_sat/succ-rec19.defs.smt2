...
(define-funs-rec (
	...
	(exists ((x1 RefGTyp)(x2 RefGTyp)(x3 RefGTyp)(x4 RefGTyp)(x5 RefGTyp)(x6 RefGTyp)(x7 RefGTyp)(x8 RefGTyp)(x9 RefGTyp)(x10 RefGTyp)(x11 RefGTyp)(x12 RefGTyp)(x13 RefGTyp)(x14 RefGTyp)(x15 RefGTyp)(x16 RefGTyp)(x17 RefGTyp)(x18 RefGTyp)(x19 RefGTyp))
		...
		(sep 
			(succ19rec x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19 )
	...
	(or 
		...
		(sep 
			(succ18rec x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 x16 x17 x18 x19 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19 )
			(one x1 )
			(zero y1 )
		)
