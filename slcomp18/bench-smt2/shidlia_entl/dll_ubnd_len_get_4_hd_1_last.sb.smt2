...
;; entailment: dll(x,y,z,t,n) & 1000<=n |- (exists u1,u2,u3,u4,u5. u1->node{u2,x} * u2->node{u3,u1} * u3->node{u4,u2} * x->node{u1,y} * z->node{t,u5} * dll(u4,u3,u5,z,n-5))
