...
;; entailment: dllnull(x,y,n) & 100<=n & n1<20 & 1<=n1 |- (exists z,t,u,v,n2. v->node{nil,u} * dll(t,z,u,v,n2) * dll_rev(x,y,z,t,n1) & 80<=n2)
...
(assert
 (not
  (exists
   ((z Refnode) (t Refnode) (u Refnode) (v Refnode) (n2 Int))
   (and
    (sep
