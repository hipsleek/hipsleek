...
;; entailment: dll(x,y,z,t,1000) |- (exists u1,u2,u3,u4,u5. u1->node{u2,x} * u4->node{u5,u3} * u5->node{z,u4} * x->node{u1,y} * z->node{t,u5} * dll(u2,u1,u3,u4,995))
