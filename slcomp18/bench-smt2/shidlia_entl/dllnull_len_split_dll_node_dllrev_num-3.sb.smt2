...
;; entailment: dllnull(x,y,101) |- (exists z,t,u,v. t->node{v,z} * dll(x,y,z,t,20) * dll_rev(v,t,u,nil,80))
...
(assert
 (and (= k101 101) (= k80 80) (= k20 20)
 (dllnull x y k101)))

(assert
 (not
  (exists
   ((z Refnode) (t Refnode) (u Refnode) (v Refnode))
   (sep
    (pto t (c_node v z))
    (dll x y z t k20)
    (dll_rev v t u (as nil Refnode) k80)))))
