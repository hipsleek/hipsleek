...
;; entailment: sls(x,y,l1,100) * sls(y,z,l2,200) * sls(z,t,201,u3) & 100<=l2 |- (exists r,s,l3,l4,l5. s->node{t,l5} * sls(r,s,l3,l4) & l4<=l5)
...
(assert
 (not
  (exists
   ((r Refnode) (s Refnode) (l3 Int) (l4 Int) (l5 Int))
   (and
    (sep
     (pto s (c_node t l5))
     (sls r s l3 l4))
