...
;; entailment: ls(x,x1) * ls(x1,x2) * ls(x10,x11) * ls(x2,x3) * ls(x3,x4) * ls(x4,x5) * ls(x5,x6) * ls(x6,x7) * ls(x7,x8) * ls(x8,x9) * ls(x9,x10) |- ls_nonrec(x,x11)

(declare-const x Refnode)
(declare-const x1 Refnode)
(declare-const x2 Refnode)
(declare-const x10 Refnode)
(declare-const x11 Refnode)
