...
(assert (not (exists (
                     (hd1 RefDLL_t) (tl1 RefDLL_t)
                     (hd2 RefDLL_t) (tl2 RefDLL_t)
                     (hd3 RefDLL_t) (tl3 RefDLL_t)
                     (hd4 RefDLL_t) (tl4 RefDLL_t)
                     (hd5 RefDLL_t) (tl5 RefDLL_t)
                     (hd6 RefDLL_t) (tl6 RefDLL_t)
                     (hd7 RefDLL_t) (tl7 RefDLL_t)
                     (hd8 RefDLL_t) (tl8 RefDLL_t)
                     (hd9 RefDLL_t) (tl9 RefDLL_t)
                     (hd10 RefDLL_t) (tl10 RefDLL_t)
                     (hd11 RefDLL_t) (tl11 RefDLL_t)
                     (hd12 RefDLL_t) (tl12 RefDLL_t)
                     (hd13 RefDLL_t) (tl13 RefDLL_t)
                     (hd14 RefDLL_t) (tl14 RefDLL_t)
                     (hd15 RefDLL_t) (tl15 RefDLL_t)
                     (hd16 RefDLL_t) (tl16 RefDLL_t)
                     (hd17 RefDLL_t) (tl17 RefDLL_t)
                     (hd18 RefDLL_t) (tl18 RefDLL_t)
                     (hd19 RefDLL_t) (tl19 RefDLL_t)
                     )
		(sep 
