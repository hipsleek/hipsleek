...
(assert (not (exists ((root0 RefTLL_t) (ll0 RefTLL_t) (tr0 RefTLL_t)
                      (root1 RefTLL_t) (ll1 RefTLL_t) (tr1 RefTLL_t)
                      (root2 RefTLL_t) (ll2 RefTLL_t) (tr2 RefTLL_t)
                      (root3 RefTLL_t) (ll3 RefTLL_t) (tr3 RefTLL_t)
                      (root4 RefTLL_t) (ll4 RefTLL_t) (tr4 RefTLL_t)
                      (root5 RefTLL_t) (ll5 RefTLL_t) (tr5 RefTLL_t)
                      (root6 RefTLL_t) (ll6 RefTLL_t) (tr6 RefTLL_t)
                      (root7 RefTLL_t) (ll7 RefTLL_t) (tr7 RefTLL_t)
                      (root8 RefTLL_t) (ll8 RefTLL_t) (tr8 RefTLL_t)
                      (root9 RefTLL_t) (ll9 RefTLL_t) (tr9 RefTLL_t)
                      (root10 RefTLL_t) (ll10 RefTLL_t) (tr10 RefTLL_t)
                      (root11 RefTLL_t) (ll11 RefTLL_t) (tr11 RefTLL_t)
                      (root12 RefTLL_t) (ll12 RefTLL_t) (tr12 RefTLL_t)
                      (root13 RefTLL_t) (ll13 RefTLL_t) (tr13 RefTLL_t)
                      (root14 RefTLL_t) (ll14 RefTLL_t) (tr14 RefTLL_t)
                      (root15 RefTLL_t) (ll15 RefTLL_t) (tr15 RefTLL_t)
                      (root16 RefTLL_t) (ll16 RefTLL_t) (tr16 RefTLL_t)
                      (root17 RefTLL_t) (ll17 RefTLL_t) (tr17 RefTLL_t)
                      (root18 RefTLL_t) (ll18 RefTLL_t) (tr18 RefTLL_t)
                      (root19 RefTLL_t) (ll19 RefTLL_t) (tr19 RefTLL_t)
                      )
		(sep 
			(TLL_tail root0 (as nil RefTLL_t) ll0 tr0 root1 )
			(TLL_tail root2 tr1 ll2 tr2 root3 )
