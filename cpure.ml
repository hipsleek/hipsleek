...
and e_apply_subs sst e = match e with
  | Null _ | IConst _ | FConst _ | SConst _ | CConst _
  | AConst _ | InfConst _ | NegInfConst _ |Tsconst _ -> e
...
and e_apply_one (fr, t) e = match e with
  | Null _ | IConst _ | InfConst _ | NegInfConst _ | FConst _
  | SConst _ | CConst _
  | AConst _ | Tsconst _ -> e
  | Bptriple ((ec,et,ea),pos) ->
...
and e_apply_one_exp (fr, t) e = match e with
  | Null _ | IConst _ | InfConst _ | NegInfConst _ | FConst _
  | SConst _ | CConst _ | AConst _ | Tsconst _ -> e
  | Bptriple _ -> e
  | Var (sv, pos) -> if eq_spec_var sv fr then t else e
