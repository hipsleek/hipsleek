 ...
 */
public class Kernel68 {
    /**
     * A reference to the next list element.
     */
    private Kernel68 next;
     ...
     */
    public Kernel68(final Kernel68 n) {
        this.next = n;
    }
     ...
     */
    public static Kernel68 create(int x) {
        Kernel68 last, current;
