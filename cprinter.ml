...
let pr_estate (es : entail_state) =
  ...
  pr_vwrap "es_var_src_ctx: " pr_pure_formula es.es_var_src_ctx;
  pr_vwrap "es_var_dst_ctx: " pr_pure_formula es.es_var_dst_ctx;
  pr_vwrap "es_var_orig_ctx: " pr_formula  es.es_var_orig_ctx; 
	pr_wrap_test "es_var_unreachable_ctx: " Gen.is_empty (pr_seq "" pr_formula)  es.es_var_unreachable_ctx; 
