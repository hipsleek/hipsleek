...
let pr_context_short (ctx : context) = 
  let rec f xs = match xs with
    | Ctx e -> [(e.es_formula,e.es_heap,e.es_pure,e.es_infer_vars@e.es_infer_vars_rel,e.es_infer_heap,e.es_infer_pure,e.es_infer_rel,
  ...
  let pr (f,eh,ep,(* ac, *)iv,ih,ip,ir,vm,vperms,trace,ecp, ptraces,evars(* , vars_ref *)) =
    fmt_open_vbox 0;
    let f1 = f
