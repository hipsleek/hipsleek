...
let fmt_sym x = pp_print_float (!fmt) x
...
Matlab.print_formula := string_of_pure_formula;;
...
Matlab.print_b_formula := string_of_b_formula;;
Matlab.print_p_formula := string_of_p_formula;;
Matlab.print_exp := string_of_formula_exp;;
Matlab.print_formula := string_of_pure_formula;;
Matlab.print_svl := string_of_spec_var_list;;
Matlab.print_sv := string_of_spec_var;;
Mathematica.print_b_formula := string_of_b_formula;;
Mathematica.print_p_formula := string_of_p_formula;;
