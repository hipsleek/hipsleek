...
/*
  requires cur::ls<M1,null> * prev::ls<M2,sentinel> & cur!=null
  ensures prev'::ls<M3,null> & cur'=sentinel & M3=union(M2,M2);
requires cur::ls<M1,sentinel> * prev::ls<M2,null> & cur!=sentinel
ensures prev'::ls<M3,null> & cur'=sentinel  & M3=union(M2,M2);
*/
requires cur::lseg<null> * prev::lseg<sentinel> & cur!=null & cur!=sentinel
ensures prev'::lseg<null> & cur'=sentinel ;
requires cur::lseg<sentinel> * prev::lseg<null> & cur!=sentinel & cur!=sentinel
ensures prev'::lseg<null> & cur'=sentinel ;
