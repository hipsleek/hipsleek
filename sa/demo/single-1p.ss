...
// Is it useful to automatically detect that G is
// a post-pred? rather than the need to declare
// using PostPred for hip?
// result of shape inference is the same though.
/*
requires x::ll<> & x!=null
