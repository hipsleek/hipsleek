...
but this seem to require @NI annotation.
...
[ H1(c,p)&c!=null --> c::node<val_21_807,prev_21_808,next_21_809>@M * 
  HP_810(prev_21_808,p@NI) * HP_811(next_21_809,p@NI) * HP_812(p,c@NI),

 HP_811(next_21_809,p@NI) * HP_812(p,c@NI) * 
  c::node<val_21_807,p,next_21_809>@M --> H1(next_21_809,c),

 G1(next_21_809,c)&c!=null --> G1(c,p),
...
[ H1(c_845,p_846) ::=  
 c_845::node<val_21_807,prev_21_808,next_21_809>@M * 
 HP_810(prev_21_808,p_846) * HP_811(next_21_809,p_846) * HP_812(p_846,c_845)
 or HP_822(p_846)&c_845=null
 ,
 G1(c_847,p_848) ::=  
 HP_822(p_848)&c_847=null
 or G1(next_21_809,c_847)&c_847!=null
 ,
 HP_810(prev_21_808,p) ::= NONE,
 HP_822(p) ::= NONE]
