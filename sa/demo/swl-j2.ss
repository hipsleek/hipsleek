...
/*
HP_995<sent_1086> ==  emp&self=sent_1086
 or emp&self!=sent_1086 & self=null
   or p::HP_995<sent_1086> *
   self::node<val_36_1076,p>@M&self!=sent_1086
   inv true;
*/
/*
H<prev_936,sent> == self::node<val_36_900,next_36_901>@M *
  next_36_901::HP_994<sent> * prev_936::HP_995<sent>;
*/
H<p,sent> == self::node<v,n>@M * n::HP_994<sent> * p::HP_995<sent>;

//lemma self::node<_,p> * p::lx<_,s> -> self::node<_,p> * p::lx<_,s> & self!=s;
//lemma self::HP_994<s> <-> self::HP_995<s>;
...
*/
  requires cur::H<prev,sent> & cur!=sent
     ensures prev'::node<_,p>@M * p::HP_994<sent> & cur'=sent & prev'!=sent;//'
/*
