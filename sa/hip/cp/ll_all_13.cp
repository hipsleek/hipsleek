HeapPred HP_673(node a,node b).
HeapPred HP_634(node a).
HeapPred HP_670(node a).

delete1[
ass [H1,G2]:{
    x::node<v_int_65_656,next_65_644> * G2(next_65_644,v_node_66_672) * v_node_66_567'::node<v_int_65_656,v_node_66_672>&
          true --> G2(x,v_node_66_567') * HP_673(v_node_66_672,v_node_66_567');
    HP_634(next_65_642) * x::node<a,next_65_642>& v_node_65_559'=next_65_642 --> G2(x,v_node_65_559') * HP_670(next_65_642);
