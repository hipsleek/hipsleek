...
ass [H1,G2]:{ 
 ...
 y::node<a,flted_34_587> * HP_2(v_node_37_605,x) * 
  x::node<val_37_594,y>&flted_34_587=null & v_node_37_605=null --> G2(x,y);
 HP_2(v_node_37_611,x)& v_node_37_611!=null --> H1(v_node_37_611);
 H1(x) --> x::node<val_37_566',next_37_567'> * HP_2(next_37_567',x)}
