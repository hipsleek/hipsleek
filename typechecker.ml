...
and gen_cpfile prog proc hp_lst_assume ls_inferred_hps dropped_hps old_hpdecls sel_hp_rels cout_option = 
...
and cp_test proc hp_lst_assume  ls_inferred_hps sel_hp_rels =
