...
let check_coercion (prog : prog_decl) =
  ...
  let check_left_coercion coer =
    ...
    let rhs = unfold_nth "c2" (prog,None) coer.coercion_body_unstruc (CP.SpecVar (CP.OType "", self, Unprimed)) true pos in
  ...
  let check_right_coercion coer =
    ...
    let lhs = unfold_nth "c4" (prog,None) coer.coercion_body_unstruc (CP.SpecVar (CP.OType "", self, Unprimed)) true pos in
