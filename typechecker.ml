	  ...
	  | CF.EBase b ->
	        ...
	        let nctx = 
	          ...
	          then (CF.transform_context (CF.normalize_es ext_base b.CF.formula_struc_pos false) ctx) (*apply normalize_es into ctx.es_state*)
                ...
                let (c,pre,rels,hprels, sel_hps,r) = match b.CF.formula_struc_continuation with | None -> (None,[],[],[], [],true) | Some l -> let r1,r2,r3,r4,r5,r6 = helper nctx l in (Some r1,r2,r3,r4,r5,r6) in
