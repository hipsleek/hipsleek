                      ...
                      begin
                        let new_spec = 
                          if rels = [] then new_spec
                            ...
                            let pres, posts = CF.get_pre_post_vars proc.proc_static_specs in
                            ...
                            if inf_post_flag then fst (Solver.simplify_relation new_spec (Some triples) pre_vars post_vars prog)
                            else new_spec
                        in
