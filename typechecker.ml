...
(*                              new_args,new_formula_inf_continuation*)
            ...
            let _ = 
              if old_vars=[] then 
                ...
                let _ = Debug.ninfo_hprint (add_str "TRANSLATED SPECS" pr_spec) einfer no_pos in
                  ...
                  if (not b) then res (*do not have permission for variable v*)
                    ...
                    *)
	                ...
	                if (Gen.is_empty unfolded) then unfolded
	                  ...
	                  let rs_prim, prf = heap_entail_struc_list_failesc_context_init prog false  true unfolded struc_vheap None pos (Some pid) in
