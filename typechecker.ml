    ...
    begin
      match proc.proc_body with
	    ...
	    | Some body ->
		    ...
		    let _ = if(!Globals.cp_test || !Globals.cp_prefile) then CAU.cp_test proc hp_lst_assume ls_inferred_hps sel_hp_rels in
		    let str1 = "" in 
		    let str2 = "" in 
		     let _ = if(!Globals.gen_cpfile) then 
		        CAU.gen_cpfile prog proc hp_lst_assume ls_inferred_hps dropped_hps old_hpdecls sel_hp_rels str1 str2 cout_option  in 
