...
bool helper()
case {
  Cur_Vertical_Sep > 600 -> ensures res &  Cur_Vertical_Sep'=  Cur_Vertical_Sep;
  Cur_Vertical_Sep <= 600 -> ensures res &  Cur_Vertical_Sep'=  Cur_Vertical_Sep;
}
{
  if (Cur_Vertical_Sep > 600) return true;
  else return true;
}
...
}
{
    ...
    enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 600) && helper()/*(Cur_Vertical_Sep > 600)*/;
