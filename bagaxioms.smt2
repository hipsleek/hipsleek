...
(assert (= (select s1 0) 5))
(assert (= (select s2 0) 3))
(assert (= (select s2 2) 4))
(assert (= (select s3 0) 8))
(assert (= (select s3 2) 4))
(assert (= (select s4 0) 3))
(assert (= (select s5 0) 2))
(assert (= (select s6 0) 1))
(assert (= (select s6 0) 1))
(assert (bag-isset s6))
(check-sat)
(get-model)
